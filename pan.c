...
/*** From source: /Users/nicolasdilley/go/src/github.com/nicolasdilley/gomela/results/test/main_main0.pml ***/
...
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "/Users/nicolasdilley/go/src/github.com/nicolasdilley/gomela/results/test/main_main0.pml", 1, 4 },
	{ "-", 5, 6 }
};
uchar reached2 [] = {
	  0,   0,   0,   1,   0,   0, };
...
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "/Users/nicolasdilley/go/src/github.com/nicolasdilley/gomela/results/test/main_main0.pml", 1, 3 },
	{ "-", 4, 5 }
};
uchar reached1 [] = {
	  0,   0,   1,   0,   0, };
...
short src_ln0 [] = {
	  0,  17,  18,  18,  19,  20,  22,  23, 
	 18,  24,  24,  24,  25,  24,  25,  25, 
	 26,  25,  27,  27,  27,  28,  27,  29, 
	 29,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "/Users/nicolasdilley/go/src/github.com/nicolasdilley/gomela/results/test/main_main0.pml", 1, 24 },
	{ "-", 25, 26 }
};
uchar reached0 [] = {
	  0,   0,   0,   1,   0,   0,   0,   0, 
...
#endif
int
addproc(int calling_pid, int priority, int n, int par0, int par1, int par2, int par3, int par4)
{	int j = 0, h = now._nr_pr;
	...
	case 2:	/* mainworker3 */
		...
		/* params: */
		((P2 *)pptr(h))->a.in = par0;
		((P2 *)pptr(h))->a.sending = par1;
		((P2 *)pptr(h))->a.closing = par2;
		((P2 *)pptr(h))->a.is_closed = par3;
		((P2 *)pptr(h))->child = par4;
		/* locals: */
		((P2 *)pptr(h))->closed = 0;
		((P2 *)pptr(h))->i = 0;
#ifdef VAR_RANGES
		logval("mainworker3:closed", ((P2 *)pptr(h))->closed);
		logval("mainworker3:i", ((P2 *)pptr(h))->i);
		logval("mainworker3:a.in", ((P2 *)pptr(h))->a.in);
		logval("mainworker3:a.sending", ((P2 *)pptr(h))->a.sending);
		logval("mainworker3:a.closing", ((P2 *)pptr(h))->a.closing);
		logval("mainworker3:a.is_closed", ((P2 *)pptr(h))->a.is_closed);
#endif
#ifdef HAS_CODE
		locinit2(h);
#endif
		break;
	case 1:	/* go_mainworker3 */
		((P1 *)pptr(h))->_t = 1;
		((P1 *)pptr(h))->_p = 1;
#ifdef HAS_PRIORITY
		...
		/* params: */
		((P1 *)pptr(h))->a.in = par0;
		((P1 *)pptr(h))->a.sending = par1;
		((P1 *)pptr(h))->a.closing = par2;
		((P1 *)pptr(h))->a.is_closed = par3;
		/* locals: */
		((P1 *)pptr(h))->closed = 0;
		((P1 *)pptr(h))->i = 0;
#ifdef VAR_RANGES
		logval("go_mainworker3:closed", ((P1 *)pptr(h))->closed);
		logval("go_mainworker3:i", ((P1 *)pptr(h))->i);
		logval("go_mainworker3:a.in", ((P1 *)pptr(h))->a.in);
		logval("go_mainworker3:a.sending", ((P1 *)pptr(h))->a.sending);
		logval("go_mainworker3:a.closing", ((P1 *)pptr(h))->a.closing);
		logval("go_mainworker3:a.is_closed", ((P1 *)pptr(h))->a.is_closed);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* :init: */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->_ch0_in = addqueue(calling_pid, 1, 0);
		((P0 *)pptr(h))->closed = 0;
		((P0 *)pptr(h))->i = 0;
		((P0 *)pptr(h))->_ch0.in = addqueue(calling_pid, 2, 1);
		((P0 *)pptr(h))->_ch0.sending = addqueue(calling_pid, 3, 1);
		((P0 *)pptr(h))->_ch0.closing = addqueue(calling_pid, 4, 1);
		((P0 *)pptr(h))->_ch0.is_closed = addqueue(calling_pid, 5, 1);
		((P0 *)pptr(h))->_2_6_child_mainworker30 = addqueue(calling_pid, 6, 1);
#ifdef VAR_RANGES
		logval(":init::closed", ((P0 *)pptr(h))->closed);
		logval(":init::i", ((P0 *)pptr(h))->i);
		logval(":init::_ch0.in", ((P0 *)pptr(h))->_ch0.in);
		logval(":init::_ch0.sending", ((P0 *)pptr(h))->_ch0.sending);
		logval(":init::_ch0.closing", ((P0 *)pptr(h))->_ch0.closing);
		logval(":init::_ch0.is_closed", ((P0 *)pptr(h))->_ch0.is_closed);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 5: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)_this)->_ch0_in) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)_this)->_ch0_in) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)_this)->_ch0_in) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)_this)->_ch0_in) )))
			    ) return 0; break;
		case 16: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P0 *)_this)->_ch0.in)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P0 *)_this)->_ch0.in)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P0 *)_this)->_ch0.in)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P0 *)_this)->_ch0.in)))
			    ) return 0; break;
		case 17: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P0 *)_this)->_ch0.sending)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P0 *)_this)->_ch0.sending)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P0 *)_this)->_ch0.sending)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P0 *)_this)->_ch0.sending)))
			    ) return 0; break;
		case 18: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P0 *)_this)->_ch0.closing)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P0 *)_this)->_ch0.closing)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P0 *)_this)->_ch0.closing)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P0 *)_this)->_ch0.closing)))
			    ) return 0; break;
		case 19: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P0 *)_this)->_ch0.is_closed)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P0 *)_this)->_ch0.is_closed)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P0 *)_this)->_ch0.is_closed)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P0 *)_this)->_ch0.is_closed)))
			    ) return 0; break;
		case 6: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)_this)->_2_6_child_mainworker30) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)_this)->_2_6_child_mainworker30) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)_this)->_2_6_child_mainworker30) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)_this)->_2_6_child_mainworker30) )))
			    ) return 0; break;
		case 12: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P1 *)_this)->a.in)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P1 *)_this)->a.in)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P1 *)_this)->a.in)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P1 *)_this)->a.in)))
			    ) return 0; break;
		case 13: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P1 *)_this)->a.sending)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P1 *)_this)->a.sending)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P1 *)_this)->a.sending)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P1 *)_this)->a.sending)))
			    ) return 0; break;
		case 14: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P1 *)_this)->a.closing)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P1 *)_this)->a.closing)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P1 *)_this)->a.closing)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P1 *)_this)->a.closing)))
			    ) return 0; break;
		case 15: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P1 *)_this)->a.is_closed)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P1 *)_this)->a.is_closed)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P1 *)_this)->a.is_closed)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P1 *)_this)->a.is_closed)))
			    ) return 0; break;
		case 8: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P2 *)_this)->a.in)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P2 *)_this)->a.in)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P2 *)_this)->a.in)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P2 *)_this)->a.in)))
			    ) return 0; break;
		case 9: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P2 *)_this)->a.sending)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P2 *)_this)->a.sending)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P2 *)_this)->a.sending)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P2 *)_this)->a.sending)))
			    ) return 0; break;
		case 10: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P2 *)_this)->a.closing)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P2 *)_this)->a.closing)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P2 *)_this)->a.closing)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P2 *)_this)->a.closing)))
			    ) return 0; break;
		case 11: if (	(t->ty[i] == Q_FULL_F && ( q_full(((P2 *)_this)->a.is_closed)))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full(((P2 *)_this)->a.is_closed)))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len(((P2 *)_this)->a.is_closed)))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len(((P2 *)_this)->a.is_closed)))
			    ) return 0; break;
		case 7: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P2 *)_this)->child) )))
...
{	/* int i; */
	switch(tp) {
	case 2:
		printf("local vars proc %d (mainworker3):\n", pid);
		printf("	(struct a)\n");
	printf("	chan in (=%d):	len %d:\t", ((P2 *)pptr(pid))->a.in, q_len(((P2 *)pptr(pid))->a.in));
	c_chandump(((P2 *)pptr(pid))->a.in);
	printf("	chan sending (=%d):	len %d:\t", ((P2 *)pptr(pid))->a.sending, q_len(((P2 *)pptr(pid))->a.sending));
	c_chandump(((P2 *)pptr(pid))->a.sending);
	printf("	chan closing (=%d):	len %d:\t", ((P2 *)pptr(pid))->a.closing, q_len(((P2 *)pptr(pid))->a.closing));
	c_chandump(((P2 *)pptr(pid))->a.closing);
	printf("	chan is_closed (=%d):	len %d:\t", ((P2 *)pptr(pid))->a.is_closed, q_len(((P2 *)pptr(pid))->a.is_closed));
	c_chandump(((P2 *)pptr(pid))->a.is_closed);
	...
	printf("	int    i:	%d\n", ((P2 *)pptr(pid))->i);
		break;
	case 1:
		printf("local vars proc %d (go_mainworker3):\n", pid);
		printf("	(struct a)\n");
	printf("	chan in (=%d):	len %d:\t", ((P1 *)pptr(pid))->a.in, q_len(((P1 *)pptr(pid))->a.in));
	c_chandump(((P1 *)pptr(pid))->a.in);
	printf("	chan sending (=%d):	len %d:\t", ((P1 *)pptr(pid))->a.sending, q_len(((P1 *)pptr(pid))->a.sending));
	c_chandump(((P1 *)pptr(pid))->a.sending);
	printf("	chan closing (=%d):	len %d:\t", ((P1 *)pptr(pid))->a.closing, q_len(((P1 *)pptr(pid))->a.closing));
	c_chandump(((P1 *)pptr(pid))->a.closing);
	printf("	chan is_closed (=%d):	len %d:\t", ((P1 *)pptr(pid))->a.is_closed, q_len(((P1 *)pptr(pid))->a.is_closed));
	c_chandump(((P1 *)pptr(pid))->a.is_closed);
	printf("	bit    closed:	%d\n", ((P1 *)pptr(pid))->closed);
	printf("	int    i:	%d\n", ((P1 *)pptr(pid))->i);
		break;
	case 0:
		printf("local vars proc %d (:init:):\n", pid);
	printf("	chan ch0_in (=%d):	len %d:\t", ((P0 *)pptr(pid))->_ch0_in, q_len(((P0 *)pptr(pid))->_ch0_in));
	c_chandump(((P0 *)pptr(pid))->_ch0_in);
	printf("	bit    closed:	%d\n", ((P0 *)pptr(pid))->closed);
	printf("	int    i:	%d\n", ((P0 *)pptr(pid))->i);
		printf("	(struct _ch0)\n");
	printf("	chan in (=%d):	len %d:\t", ((P0 *)pptr(pid))->_ch0.in, q_len(((P0 *)pptr(pid))->_ch0.in));
	c_chandump(((P0 *)pptr(pid))->_ch0.in);
	printf("	chan sending (=%d):	len %d:\t", ((P0 *)pptr(pid))->_ch0.sending, q_len(((P0 *)pptr(pid))->_ch0.sending));
	c_chandump(((P0 *)pptr(pid))->_ch0.sending);
	printf("	chan closing (=%d):	len %d:\t", ((P0 *)pptr(pid))->_ch0.closing, q_len(((P0 *)pptr(pid))->_ch0.closing));
	c_chandump(((P0 *)pptr(pid))->_ch0.closing);
	printf("	chan is_closed (=%d):	len %d:\t", ((P0 *)pptr(pid))->_ch0.is_closed, q_len(((P0 *)pptr(pid))->_ch0.is_closed));
	c_chandump(((P0 *)pptr(pid))->_ch0.is_closed);
	printf("	chan child_mainworker30 (=%d):	len %d:\t", ((P0 *)pptr(pid))->_2_6_child_mainworker30, q_len(((P0 *)pptr(pid))->_2_6_child_mainworker30));
	c_chandump(((P0 *)pptr(pid))->_2_6_child_mainworker30);
		break;
	}
}
void
