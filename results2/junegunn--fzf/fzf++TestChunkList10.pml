...
// git_link=https://github.com/junegunn/fzf/blob/4cd621e877cb3a8e44b12ba3a7ce58709862922f/src/chunklist_test.go#L10
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestChunkList100)
stop_process:skip
}
...
proctype TestChunkList10(chan child) {
	...
	Mutexdef cl_mutex;
	int var_chunkSizechunkSize = -2; // opt var_chunkSizechunkSize
	...
	if
	:: 0 != -2 && var_chunkSize * 2-1 != -3 -> 
				for(i : 0.. var_chunkSize * 2-1) {
			for11: skip;
