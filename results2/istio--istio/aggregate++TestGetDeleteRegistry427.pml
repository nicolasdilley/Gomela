...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/pilot/pkg/serviceregistry/aggregate/controller_test.go#L427
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestGetDeleteRegistry427(chan child) {
	...
	int var_registriesregistries = -2; // opt var_registriesregistries
...
proctype GetRegistries88(Mutexdef c_storeLock;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_registriesc_registries = -2; // opt var_c_registriesc_registries
