...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/pilot/pkg/grpc/grpc.go#L39
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype Send39(chan child) {
	...
	:: true -> 
		...
		run AnonymousSend4441(errChan_ch,child_AnonymousSend44410);
		run receiver(child_AnonymousSend44410);
		do
		:: true -> 
			goto stop_process
...
proctype AnonymousSend4441(Chandef errChan_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
