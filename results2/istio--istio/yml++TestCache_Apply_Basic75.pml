...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/pkg/test/util/yml/cache_test.go#L75
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestCache_Apply_Basic750 = [1] of {int};
	run TestCache_Apply_Basic75(child_TestCache_Apply_Basic750);
	run receiver(child_TestCache_Apply_Basic750)
stop_process:skip
}

proctype TestCache_Apply_Basic75(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
