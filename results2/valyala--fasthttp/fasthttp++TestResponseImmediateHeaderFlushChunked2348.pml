...
proctype TestResponseImmediateHeaderFlushChunked2348(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousTestResponseImmediateHeaderFlushChunked237023560 = [1] of {int};
	...
	run AnonymousTestResponseImmediateHeaderFlushChunked23702356(cb_ch,waitForIt_ch,ch_ch,child_AnonymousTestResponseImmediateHeaderFlushChunked237023560);
	run receiver(child_AnonymousTestResponseImmediateHeaderFlushChunked237023560);
...
proctype AnonymousTestResponseImmediateHeaderFlushChunked23702356(Chandef cb_ch;Chandef waitForIt_ch;Chandef ch_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
