...
// git_link=https://github.com/valyala/fasthttp/blob/19fcd408632d6dae8425ae95c6c62a25c823ff81/fasthttputil/pipeconns_test.go#L326
#define var_concurrency326  ?? // mand var_concurrency326
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run testConcurrency326(var_concurrency326,child_testConcurrency3260);
