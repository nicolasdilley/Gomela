...
#define var_images109  ?? // mand var_images109
#define pullImages_pullRefs  ??
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run pullImages109(var_images109,child_pullImages1090);
...
proctype pullImages109(int images;chan child) {
	...
	Chandef chErr_ch;
	Wgdef wg;
	int var_pullRefs = pullImages_pullRefs; // mand var_pullRefs
