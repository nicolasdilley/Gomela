...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/image/jpeg/reader_test.go#L210
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestLargeImageWithShortData210(chan child) {
	...
	run AnonymousTestLargeImageWithShortData251250(c,child_AnonymousTestLargeImageWithShortData2512500);
...
proctype AnonymousTestLargeImageWithShortData251250(Chandef c;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
