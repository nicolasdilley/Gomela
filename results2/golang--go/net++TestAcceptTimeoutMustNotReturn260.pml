...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/timeout_test.go#L260
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestAcceptTimeoutMustNotReturn260(chan child) {
	...
	run sync_monitor(ch);
	run AnonymousTestAcceptTimeoutMustNotReturn277276(ch,child_AnonymousTestAcceptTimeoutMustNotReturn2772760);
...
proctype AnonymousTestAcceptTimeoutMustNotReturn277276(Chandef ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
