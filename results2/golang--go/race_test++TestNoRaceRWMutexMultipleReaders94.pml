...
proctype TestNoRaceRWMutexMultipleReaders94(chan child) {
	...
	run AnonymousTestNoRaceRWMutexMultipleReaders9897(ch,mu,child_AnonymousTestNoRaceRWMutexMultipleReaders98970);
	run receiver(child_AnonymousTestNoRaceRWMutexMultipleReaders98970);
	run AnonymousTestNoRaceRWMutexMultipleReaders10497(ch,mu,child_AnonymousTestNoRaceRWMutexMultipleReaders104971);
	run receiver(child_AnonymousTestNoRaceRWMutexMultipleReaders104971);
	run AnonymousTestNoRaceRWMutexMultipleReaders11197(ch,mu,child_AnonymousTestNoRaceRWMutexMultipleReaders111972);
	run receiver(child_AnonymousTestNoRaceRWMutexMultipleReaders111972);
	run AnonymousTestNoRaceRWMutexMultipleReaders11897(ch,mu,child_AnonymousTestNoRaceRWMutexMultipleReaders118973);
...
proctype AnonymousTestNoRaceRWMutexMultipleReaders9897(Chandef ch;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestNoRaceRWMutexMultipleReaders10497(Chandef ch;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestNoRaceRWMutexMultipleReaders11197(Chandef ch;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestNoRaceRWMutexMultipleReaders11897(Chandef ch;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
