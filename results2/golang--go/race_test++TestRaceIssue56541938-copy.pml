...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/runtime/race/testdata/mop_test.go#L1938
...
proctype TestRaceIssue56541938(chan child) {
	...
	Chandef in;
	run sync_monitor(in);
	run AnonymousTestRaceIssue565419581956(in,child_AnonymousTestRaceIssue5654195819560);
...
proctype AnonymousTestRaceIssue565419581956(Chandef in;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
