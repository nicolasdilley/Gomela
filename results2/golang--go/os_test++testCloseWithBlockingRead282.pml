...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/os/pipe_test.go#L282
...
proctype testCloseWithBlockingRead282(chan child) {
	...
	run wgMonitor(wg);
	wg.update!1;
	run AnonymoustestCloseWithBlockingRead290290(c1,c2,wg,child_AnonymoustestCloseWithBlockingRead2902900);
	run receiver(child_AnonymoustestCloseWithBlockingRead2902900);
	wg.update!1;
	run AnonymoustestCloseWithBlockingRead304304(c2,c1,wg,child_AnonymoustestCloseWithBlockingRead3043041);
...
proctype AnonymoustestCloseWithBlockingRead290290(Chandef c;Chandef c2;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymoustestCloseWithBlockingRead304304(Chandef c;Chandef c1;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
