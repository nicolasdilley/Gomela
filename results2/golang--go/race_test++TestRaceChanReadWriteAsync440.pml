...
proctype TestRaceChanReadWriteAsync440(chan child) {
	...
	run AnonymousTestRaceChanReadWriteAsync446441(done_ch,c1_ch,c2_ch,child_AnonymousTestRaceChanReadWriteAsync4464410);
...
proctype AnonymousTestRaceChanReadWriteAsync446441(Chandef done_ch;Chandef c1_ch;Chandef c2_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
