...
proctype TestMutexFairness181(chan child) {
	...
	run AnonymousTestMutexFairness185183(stop,mu,child_AnonymousTestMutexFairness1851830);
	...
	run AnonymousTestMutexFairness198183(stop,done,mu,child_AnonymousTestMutexFairness1981831);
...
proctype AnonymousTestMutexFairness185183(Chandef stop;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestMutexFairness198183(Chandef stop;Chandef done;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
