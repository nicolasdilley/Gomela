...
proctype TestStoreLoadRelAcq641349(chan child) {
	...
	Chandef c;
	int int64_0_ = TestStoreLoadRelAcq64_int64_0_; // mand int64_0_
	...
	:: else -> 
		...
		for(i : 0.. 2-1) {
		for10: skip;
		run AnonymousTestStoreLoadRelAcq6413711371(c,child_AnonymousTestStoreLoadRelAcq64137113710);
...
proctype AnonymousTestStoreLoadRelAcq6413711371(Chandef c;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
