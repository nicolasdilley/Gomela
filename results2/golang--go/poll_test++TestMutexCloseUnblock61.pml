...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/internal/poll/fd_mutex_test.go#L61
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestMutexCloseUnblock61(chan child) {
	...
	:: else -> 
		...
		for(i : 0.. 4-1) {
		for10: skip;
		run AnonymousTestMutexCloseUnblock6662(c,child_AnonymousTestMutexCloseUnblock66620);
...
proctype AnonymousTestMutexCloseUnblock6662(Chandef c;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
