...
proctype TestTransportProxyHTTPSConnectLeak1474(chan child) {
	...
	Chandef listenerDone;
	run sync_monitor(listenerDone);
	run AnonymousTestTransportProxyHTTPSConnectLeak14841483(listenerDone,child_AnonymousTestTransportProxyHTTPSConnectLeak148414830);
	run receiver(child_AnonymousTestTransportProxyHTTPSConnectLeak148414830);
	

	if
	:: listenerDone.deq?state,num_msgs;
...
proctype AnonymousTestTransportProxyHTTPSConnectLeak14841483(Chandef listenerDone;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
