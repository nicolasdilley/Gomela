...
#define TestAcceptTimeout_acceptTimeoutTests  3
typedef Wgdef {
...
proctype TestAcceptTimeout157(chan child) {
	...
	Wgdef wg;
	int var_tt_xerrstt_xerrs = -2; // opt var_tt_xerrstt_xerrs
	int var_acceptTimeoutTests = TestAcceptTimeout_acceptTimeoutTests; // mand var_acceptTimeoutTests
	...
	run wgMonitor(wg);
		for(i : 0.. var_acceptTimeoutTests-1) {
		for10: skip;
