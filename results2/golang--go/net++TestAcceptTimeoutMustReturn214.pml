...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/timeout_test.go#L214
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestAcceptTimeoutMustReturn214(chan child) {
	...
	run sync_monitor(ch);
	run AnonymousTestAcceptTimeoutMustReturn231230(ch,child_AnonymousTestAcceptTimeoutMustReturn2312300);
...
proctype AnonymousTestAcceptTimeoutMustReturn231230(Chandef ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
