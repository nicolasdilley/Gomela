...
proctype TestNoRaceSelectReadWriteAsync421(chan child) {
	...
	run AnonymousTestNoRaceSelectReadWriteAsync426422(done_ch,c1_ch,c2_ch,child_AnonymousTestNoRaceSelectReadWriteAsync4264220);
...
proctype AnonymousTestNoRaceSelectReadWriteAsync426422(Chandef done_ch;Chandef c1_ch;Chandef c2_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
