...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/http/httptest/server_test.go#L55
typedef Wgdef {
...
init { 
	chan child_testServer550 = [1] of {int};
	run testServer55(child_testServer550);
	run receiver(child_testServer550)
stop_process:skip
}

proctype testServer55(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
