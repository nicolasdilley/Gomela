...
proctype blockSelectRecvAsync839(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousblockSelectRecvAsync8438420 = [1] of {int};
	Chandef c2;
	Chandef c;
	...
	run AnonymousblockSelectRecvAsync843842(c2,c,child_AnonymousblockSelectRecvAsync8438420);
	run receiver(child_AnonymousblockSelectRecvAsync8438420);
...
proctype AnonymousblockSelectRecvAsync843842(Chandef c2;Chandef c;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
