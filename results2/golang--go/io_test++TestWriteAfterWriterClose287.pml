...
proctype TestWriteAfterWriterClose287(chan child) {
	...
	run AnonymousTestWriteAfterWriterClose292290(done,r_p_wrMu,w_p_wrMu,child_AnonymousTestWriteAfterWriterClose2922900);
...
proctype AnonymousTestWriteAfterWriterClose292290(Chandef done;Mutexdef r_p_wrMu;Mutexdef w_p_wrMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
