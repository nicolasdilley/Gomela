...
proctype TestRaceWaitGroupReuse315(chan child) {
	...
	run wgMonitor(wg);
		...
		wg.update!3;
				for(i : 0.. 3-1) {
			for11: skip;
			run AnonymousTestRaceWaitGroupReuse324324(done,wg,child_AnonymousTestRaceWaitGroupReuse3243240);
			run receiver(child_AnonymousTestRaceWaitGroupReuse3243240);
			for11_end: skip
		};
		for11_exit: skip;
		run AnonymousTestRaceWaitGroupReuse330318(done,wg,child_AnonymousTestRaceWaitGroupReuse3303182);
...
proctype AnonymousTestRaceWaitGroupReuse324324(Chandef done;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestRaceWaitGroupReuse330318(Chandef done;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
