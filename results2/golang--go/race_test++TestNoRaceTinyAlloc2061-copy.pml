...
proctype TestNoRaceTinyAlloc2061(chan child) {
	...
	run sync_monitor(done);
		for(i : 0.. 4-1) {
		for10: skip;
		run AnonymousTestNoRaceTinyAlloc20682066(done,child_AnonymousTestNoRaceTinyAlloc206820660);
...
proctype AnonymousTestNoRaceTinyAlloc20682066(Chandef done;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
