...
proctype TestTCPReadWriteAllocs473(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousTestTCPReadWriteAllocs5225201 = [1] of {int};
	Chandef ch_ch;
	...
	run AnonymousTestTCPReadWriteAllocs522520(ch_ch,errc_ch,child_AnonymousTestTCPReadWriteAllocs5225201);
	run receiver(child_AnonymousTestTCPReadWriteAllocs5225201);
		defer1: skip;
	ch.closing!true;
	stop_process: skip;
	child!0
...
proctype AnonymousTestTCPReadWriteAllocs522520(Chandef ch_ch;Chandef errc_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
