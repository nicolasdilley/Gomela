...
proctype Test_NewGoRoutineMap_Positive_WaitWithExpBackoff422(chan child) {
	...
	run AnonymousTest_NewGoRoutineMap_Positive_WaitWithExpBackoff436427(operation1DoneCh_ch,waitDoneCh_ch,child_AnonymousTest_NewGoRoutineMap_Positive_WaitWithExpBackoff4364271);
	run receiver(child_AnonymousTest_NewGoRoutineMap_Positive_WaitWithExpBackoff4364271);
...
proctype AnonymousTest_NewGoRoutineMap_Positive_WaitWithExpBackoff436427(Chandef operation1DoneCh_ch;Chandef waitDoneCh_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
