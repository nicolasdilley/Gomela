...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/proxy/userspace/roundrobin_test.go#L312
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestStickyLoadBalanceWorksWithNewServiceCalledFirst312(chan child) {
	...
	run NextEndpoint136(loadBalancer_lock,child_NextEndpoint1367);
	child_NextEndpoint1367?0;
	...
	run NextEndpoint136(loadBalancer_lock,child_NextEndpoint13611);
	child_NextEndpoint13611?0;
