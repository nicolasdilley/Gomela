...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/util/manager/cache_based_manager_test.go#L177
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestSecretStoreGetNeverRefresh1770)
stop_process:skip
}
...
proctype TestSecretStoreGetNeverRefresh177(chan child) {
	...
	wg.update!100;
		...
		run receiver(child_AnonymousTestSecretStoreGetNeverRefresh1901902);
		for20_end: skip
	};
	for20_exit: skip;
	wg.wait?0;
