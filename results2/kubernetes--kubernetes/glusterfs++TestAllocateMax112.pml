...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/volume/glusterfs/glusterfs_minmax_test.go#L112
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype AllocateNext131(Mutexdef a_lock;chan child) {
	...
	int var_a_mina_min = -2; // opt var_a_mina_min
	int var_a_maxa_max = -2; // opt var_a_maxa_max
	a_lock.Lock!false;
