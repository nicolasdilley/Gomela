...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/volume/glusterfs/glusterfs_minmax_test.go#L43
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestSetRange430)
stop_process:skip
}
...
proctype SetRange83(Mutexdef a_lock;chan child) {
	...
	int var_a_useda_used = -2; // opt var_a_useda_used
