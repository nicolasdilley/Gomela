...
proctype TestUpdateNodeObjects715(chan child) {
	...
	Wgdef wg;
	int var_watchers = TestUpdateNodeObjects_watchers; // mand var_watchers
	int var_listers = TestUpdateNodeObjects_listers; // mand var_listers
	int var_nodes = TestUpdateNodeObjects_nodes; // mand var_nodes
	for20_exit: skip;
	for30_exit: skip;
	run wgMonitor(wg);
