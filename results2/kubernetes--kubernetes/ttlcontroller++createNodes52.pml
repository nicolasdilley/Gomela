...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/ttlcontroller/ttlcontroller_test.go#L52
#define var_endIndex52  ?? // mand var_endIndex52
#define var_startIndex52  ?? // mand var_startIndex52
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run createNodes52(var_endIndex52,var_startIndex52,child_createNodes520);
