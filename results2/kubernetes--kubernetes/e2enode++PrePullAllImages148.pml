...
proctype PrePullAllImages148(chan child) {
	...
	Wgdef wg;
	Chandef imageCh_ch;
	int var_parallelImagePullCount = PrePullAllImages_parallelImagePullCount; // mand var_parallelImagePullCount
	int var_images = PrePullAllImages_images; // mand var_images
