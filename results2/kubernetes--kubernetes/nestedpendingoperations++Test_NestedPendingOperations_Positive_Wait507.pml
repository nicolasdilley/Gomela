...
proctype Test_NestedPendingOperations_Positive_Wait507(chan child) {
	...
	run AnonymousTest_NestedPendingOperations_Positive_Wait521512(operation1DoneCh_ch,waitDoneCh_ch,child_AnonymousTest_NestedPendingOperations_Positive_Wait5215121);
	run receiver(child_AnonymousTest_NestedPendingOperations_Positive_Wait5215121);
...
proctype AnonymousTest_NestedPendingOperations_Positive_Wait521512(Chandef operation1DoneCh_ch;Chandef waitDoneCh_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
