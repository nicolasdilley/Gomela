...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/proxy/userspace/proxier_test.go#L850
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestOnServiceAddChangeMap850(chan child) {
	...
	Mutexdef p_mu;
	int var_test_changestest_changes = -2; // opt var_test_changestest_changes
