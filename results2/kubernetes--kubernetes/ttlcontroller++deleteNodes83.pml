...
#define var_endIndex83  ?? // mand var_endIndex83
#define var_startIndex83  ?? // mand var_startIndex83
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run deleteNodes83(var_endIndex83,var_startIndex83,child_deleteNodes830);
...
proctype deleteNodes83(int endIndex;int startIndex;chan child) {
	...
	if
	:: var_endIndex - startIndex > 0 -> 
		errs_ch.size = var_endIndex - startIndex;
