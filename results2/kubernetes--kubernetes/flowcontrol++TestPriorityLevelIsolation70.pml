...
proctype TestPriorityLevelIsolation70(chan child) {
	...
	int var_queueLength = TestPriorityLevelIsolation_queueLength; // mand var_queueLength
	int var_concurrencyShares = TestPriorityLevelIsolation_concurrencyShares; // mand var_concurrencyShares
