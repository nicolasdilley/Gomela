...
#define not_found_129  ?? // mand not_found_129
#define not_found_133  -2 // opt not_found_133
#define not_found_139  -2 // opt not_found_139
#define not_found_146  ?? // mand not_found_146
#define not_found_163  -2 // opt not_found_163
#define not_found_174  -2 // opt not_found_174
#define not_found_185  -2 // opt not_found_185
#define not_found_193  -2 // opt not_found_193
#define not_found_204  -2 // opt not_found_204
#define not_found_212  ?? // mand not_found_212
#define not_found_222  ?? // mand not_found_222
#define not_found_248  -2 // opt not_found_248
#define not_found_271  ?? // mand not_found_271
#define not_found_295  -2 // opt not_found_295
#define not_found_319  -2 // opt not_found_319
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype SyncServices76(Mutexdef hcs_lock;int newServices;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_AnonymousSyncServices1211210 = [1] of {int};
	int var_hcs_serviceshcs_services = -2; // opt var_hcs_serviceshcs_services
	hcs_lock.Lock!false;
...
proctype SyncEndpoints177(Mutexdef hcs_lock;int newEndpoints;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
