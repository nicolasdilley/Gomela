...
#define var_vSphereInstances62  -2 // opt var_vSphereInstances62
#define GenerateNodeMap_nodeList_Items  3
typedef Wgdef {
...
init { 
	...
	run GenerateNodeMap62(var_vSphereInstances62,child_GenerateNodeMap620);
...
proctype GenerateNodeMap62(int vSphereInstances;chan child) {
	...
	Wgdef wg;
	int var_nodeList_Items = GenerateNodeMap_nodeList_Items; // mand var_nodeList_Items
