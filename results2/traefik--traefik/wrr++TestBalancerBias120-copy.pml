...
// git_link=https://github.com/traefik/traefik/blob/080cf98e512f6fcb93838de76a6aa34ff147dee4/pkg/server/service/loadbalancer/wrr/wrr_test.go#L120
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBalancerBias1200 = [1] of {int};
	run TestBalancerBias120(child_TestBalancerBias1200);
	run receiver(child_TestBalancerBias1200)
stop_process:skip
}

proctype TestBalancerBias120(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
