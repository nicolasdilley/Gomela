...
// git_link=https://github.com/traefik/traefik/blob/080cf98e512f6fcb93838de76a6aa34ff147dee4/pkg/server/service/loadbalancer/wrr/wrr_test.go#L87
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestSticky870 = [1] of {int};
	run TestSticky87(child_TestSticky870);
	run receiver(child_TestSticky870)
stop_process:skip
}

proctype TestSticky87(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_recorder_Result___Cookies__recorder_Result___Cookies__ = -2; // opt var_recorder_Result___Cookies__recorder_Result___Cookies__
