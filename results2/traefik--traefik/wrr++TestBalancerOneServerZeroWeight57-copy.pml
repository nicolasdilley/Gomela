...
// git_link=https://github.com/traefik/traefik/blob/080cf98e512f6fcb93838de76a6aa34ff147dee4/pkg/server/service/loadbalancer/wrr/wrr_test.go#L57
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestBalancerOneServerZeroWeight570)
stop_process:skip
}
