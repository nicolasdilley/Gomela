...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/trie/stacktrie_test.go#L54
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestValLength56540 = [1] of {int};
	run TestValLength5654(child_TestValLength56540);
	run receiver(child_TestValLength56540)
stop_process:skip
}

proctype TestValLength5654(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
