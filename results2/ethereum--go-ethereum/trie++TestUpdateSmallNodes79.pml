...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/trie/stacktrie_test.go#L79
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestUpdateSmallNodes790 = [1] of {int};
	run TestUpdateSmallNodes79(child_TestUpdateSmallNodes790);
	run receiver(child_TestUpdateSmallNodes790)
stop_process:skip
}

proctype TestUpdateSmallNodes79(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
