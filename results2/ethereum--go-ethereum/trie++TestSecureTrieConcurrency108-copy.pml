...
#define TestSecureTrieConcurrency_threads  3
typedef Wgdef {
...
proctype TestSecureTrieConcurrency108(chan child) {
	...
	Wgdef pend;
	Mutexdef __lock;
	int threads = TestSecureTrieConcurrency_threads; // mand threads
...
proctype AnonymousTestSecureTrieConcurrency122122(Wgdef pend;Mutexdef __lock;chan child) {
	...
	bool state;
	int num_msgs;
	int byte_3_ = -2; // opt byte_3_
	int byte_0_ = -2; // opt byte_0_
		defer1: skip;
	pend.update!-1;
	stop_process: skip;
	child!0
