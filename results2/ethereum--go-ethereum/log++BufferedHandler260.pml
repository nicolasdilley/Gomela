...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/log/handler.go#L260
#define var_bufSize260  ?? // mand var_bufSize260
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run BufferedHandler260(var_bufSize260,child_BufferedHandler2600);
