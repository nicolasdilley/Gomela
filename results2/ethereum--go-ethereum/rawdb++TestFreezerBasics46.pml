...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/core/rawdb/freezer_table_test.go#L46
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestFreezerBasics460)
stop_process:skip
}
...
proctype Close397(Mutexdef t_lock;chan child) {
	...
	bool state;
	int num_msgs;
	int var_t_filest_files = -2; // opt var_t_filest_files
	t_lock.Lock!false;
