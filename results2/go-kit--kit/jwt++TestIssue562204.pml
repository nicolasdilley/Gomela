...
// git_link=https://github.com/go-kit/kit/blob/60e8424101af501c525efaf67c0a2edf08667f80/auth/jwt/middleware_test.go#L204
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestIssue5622040)
stop_process:skip
}
...
proctype TestIssue562204(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousTestIssue5622152120);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
