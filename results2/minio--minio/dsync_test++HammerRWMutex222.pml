...
#define var_numIterations222  -2 // opt var_numIterations222
#define var_numReaders222  ?? // mand var_numReaders222
#define ub_for234_2  ??
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run HammerRWMutex222(var_numIterations222,var_numReaders222,child_HammerRWMutex2220);
