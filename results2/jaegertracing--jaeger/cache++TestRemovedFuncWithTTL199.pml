...
// git_link=https://github.com/jaegertracing/jaeger/blob/12bba8c9b91cf4a29d314934bc08f4a80e43c042/pkg/cache/lru_test.go#L199
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestRemovedFuncWithTTL1990 = [1] of {int};
	run TestRemovedFuncWithTTL199(child_TestRemovedFuncWithTTL1990);
	run receiver(child_TestRemovedFuncWithTTL1990)
stop_process:skip
}

proctype TestRemovedFuncWithTTL199(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
