...
// git_link=https://github.com/prometheus/prometheus/blob/27b78c336e436e9eed8b55ab0b162b888ec641d8/promql/query_logger.go#L106
#define var_maxConcurrent106  ?? // mand var_maxConcurrent106
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run NewActiveQueryTracker106(var_maxConcurrent106,child_NewActiveQueryTracker1060);
...
proctype NewActiveQueryTracker106(int maxConcurrent;chan child) {
	...
	run generateIndices169(activeQueryTracker_getNextIndex_ch,maxConcurrent,child_generateIndices1690);
	child_generateIndices1690?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype generateIndices169(Chandef tracker_getNextIndex_ch;int maxConcurrent;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
