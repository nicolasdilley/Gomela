...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/internal/legacy/helper/schema/resource_diff_test.go#L1684
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype List98(Mutexdef s_once_m;chan child) {
	...
	bool state;
	int num_msgs;
	int var_s_listCode__s_listCode__ = -2; // opt var_s_listCode__s_listCode__
	goto stop_process;
	stop_process: skip;
	child!0
}
