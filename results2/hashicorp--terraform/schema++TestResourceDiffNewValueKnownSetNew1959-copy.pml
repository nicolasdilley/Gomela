...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/internal/legacy/helper/schema/resource_diff_test.go#L1959
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestResourceDiffNewValueKnownSetNew1959(chan child) {
	...
	run SetNew289(d_diff_mu,d_newWriter_lock,d_state_mu,child_SetNew2890);
	child_SetNew2890?0;
	run NewValueKnown419(d_diff_mu,d_newWriter_lock,d_state_mu,child_NewValueKnown4191);
	child_NewValueKnown4191?0;
	stop_process: skip;
	child!0
}
proctype SetNew289(Mutexdef d_diff_mu;Mutexdef d_newWriter_lock;Mutexdef d_state_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype clear241(Mutexdef d_diff_mu;Mutexdef d_newWriter_lock;Mutexdef d_state_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int d_diff_Attributes = -2; // opt d_diff_Attributes
...
proctype NewValueKnown419(Mutexdef d_diff_mu;Mutexdef d_newWriter_lock;Mutexdef d_state_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
