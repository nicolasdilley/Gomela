...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/states/remote/state_test.go#L25
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestStateRace250)
stop_process:skip
}
...
proctype TestStateRace25(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousTestStateRace36320);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
