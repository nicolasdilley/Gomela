...
// git_link=https://github.com/sirupsen/logrus/blob/b50299cfaaa1bca85be76c8984070e846c7abfd2/logrus_test.go#L553
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestGetSetLevelRace5530)
stop_process:skip
}
...
proctype TestGetSetLevelRace553(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousTestGetSetLevelRace5575570);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
