...
#define Discover_interfaces  ??
#define not_found_{"urn:schemas-upnp-org:device:InternetGatewayDevice:1""urn:schemas-upnp-org:device:InternetGatewayDevice:2"}10730  ??
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype Discover88(chan child) {
	...
	Wgdef wg;
	Chandef resultChan;
	int interfaces = Discover_interfaces; // mand interfaces
