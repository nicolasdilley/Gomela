...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/sync/sync_test.go#L229
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestTimeoutCond2290)
stop_process:skip
}
...
proctype TestTimeoutCond229(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousTestTimeoutCond2672630);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
