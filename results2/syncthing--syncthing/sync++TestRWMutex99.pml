...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/sync/sync_test.go#L99
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRWMutex99(chan child) {
	...
	run AnonymousTestRWMutex140136(wait,locking,clock_mut,msgmut,child_AnonymousTestRWMutex1401362);
...
proctype AnonymousTestRWMutex140136(Chandef wait;Chandef locking;Mutexdef clock_mut;Mutexdef msgmut;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
