...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/model/requests_test.go#L823
#define not_found_{ab}84320  -2
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRequestRemoteRenameConflict823(chan child) {
	...
	if
	:: not_found_{ab}84320-1 != -3 -> 
				for(i : 0.. not_found_{ab}84320-1) {
			for10: skip;
