...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/model/model_test.go#L3068
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestFolderRestartZombies30680)
stop_process:skip
}
...
proctype TestFolderRestartZombies3068(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousTestFolderRestartZombies309630930);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
