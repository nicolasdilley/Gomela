...
// git_link=https://github.com/caddyserver/caddy/blob/efe84497d7a333a8a6c7b658286121bad1b7f616/modules/caddyhttp/reverseproxy/fastcgi/client_test.go#L121
#define var_posts121  -2 // opt var_posts121
#define var_files121  -2 // opt var_files121
#define not_found_384  -2 // opt not_found_384
#define not_found_160  -2 // opt not_found_160
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run sendFcgi121(var_posts121,var_files121,child_sendFcgi1210);
...
proctype PostFile513(Mutexdef c_mutex;int data;int file;chan child) {
	...
	int var_valval = -2; // opt var_valval
