...
// git_link=https://github.com/go-gitea/gitea/blob/ed393779004335a0afcca0dfac48937db41fabd6/modules/log/conn_test.go#L29
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestConnLogger290)
stop_process:skip
}
...
proctype TestConnLogger29(chan child) {
	...
	run receiver(child_AnonymousTestConnLogger69670);
	run AnonymousTestConnLogger7367(wg,child_AnonymousTestConnLogger73671);
	run receiver(child_AnonymousTestConnLogger73671);
	wg.wait?0;
	wg.update!2;
	run AnonymousTestConnLogger8367(wg,child_AnonymousTestConnLogger83672);
	run receiver(child_AnonymousTestConnLogger83672);
