...
// git_link=https://github.com/dgraph-io/dgraph/blob/6b188f254202f9c38b16c4769b672dd0e9d596ac/worker/export.go#L876
#define ExportOverNetwork_gids  ??
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype ExportOverNetwork876(chan child) {
	...
	Chandef ch_ch;
	int var_gids = ExportOverNetwork_gids; // mand var_gids
