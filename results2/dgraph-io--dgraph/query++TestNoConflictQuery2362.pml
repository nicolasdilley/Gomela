...
// git_link=https://github.com/dgraph-io/dgraph/blob/6b188f254202f9c38b16c4769b672dd0e9d596ac/query/query4_test.go#L362
#define TestNoConflictQuery2_in  ??
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestNoConflictQuery2362(chan child) {
	...
	Chandef errChan;
	int errs = -2; // opt errs
	int in = TestNoConflictQuery2_in; // mand in
	run sync_monitor(errChan);
		for(i : 0.. in-1) {
		for20: skip;
		run AnonymousTestNoConflictQuery2399399(errChan,child_AnonymousTestNoConflictQuery23993990);
...
proctype AnonymousTestNoConflictQuery2399399(Chandef errChan;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
