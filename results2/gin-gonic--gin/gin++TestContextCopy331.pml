...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L331
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestContextCopy3310)
stop_process:skip
}
...
proctype Copy104(Mutexdef c_mu;chan child) {
	...
	int num_msgs;
	Mutexdef cp_mu;
	int var_c_Keysc_Keys = -2; // opt var_c_Keysc_Keys
	run mutexMonitor(cp_mu);
	goto stop_process;
	stop_process: skip;
	child!0
