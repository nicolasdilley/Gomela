...
// git_link=https://github.com/kubernetes/kops/blob/e3fbc2ad043e58cfdcf934e015ef8d5d9e42273e/pkg/instancegroups/instancegroups.go#L76
#define rollingUpdateInstanceGroup_update  ??
#define rollingUpdateInstanceGroup_maxConcurrency  ??
...
proctype rollingUpdateInstanceGroup76(chan child) {
	...
	int var_maxConcurrency = rollingUpdateInstanceGroup_maxConcurrency; // mand var_maxConcurrency
	int var_maxSurgemaxSurge = -2; // opt var_maxSurgemaxSurge
	int var_update = rollingUpdateInstanceGroup_update; // mand var_update
