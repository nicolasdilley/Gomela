...
proctype rollingUpdateInstanceGroup76(chan child) {
	...
	int maxConcurrency = rollingUpdateInstanceGroup_maxConcurrency; // mand maxConcurrency
	int maxSurge = -2; // opt maxSurge
	int update = rollingUpdateInstanceGroup_update; // mand update
