...
// git_link=https://github.com/hashicorp/packer/blob/a9c2283ee589b203c0ce16174a5747b7d2053d61/post-processor/digitalocean-import/post-processor.go#L312
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run receiver(child_waitUntilImageAvailable3120)
stop_process:skip
}
...
proctype waitUntilImageAvailable312(chan child) {
	...
	run AnonymouswaitUntilImageAvailable317313(done_ch,result_ch,child_AnonymouswaitUntilImageAvailable3173130);
...
proctype AnonymouswaitUntilImageAvailable317313(Chandef done_ch;Chandef result_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
