...
proctype waitForDropletState63(chan child) {
	...
	run AnonymouswaitForDropletState7066(done_ch,result_ch,child_AnonymouswaitForDropletState70660);
...
proctype AnonymouswaitForDropletState7066(Chandef done_ch;Chandef result_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
