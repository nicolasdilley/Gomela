...
proctype Provision217(Mutexdef p_lock;Mutexdef ui_l;Mutexdef comm_StartCmd_m;chan child) {
	...
	run AnonymousProvision222221(result,p_lock,ui_l,comm_StartCmd_m,child_AnonymousProvision2222211);
...
proctype AnonymousProvision222221(Chandef result;Mutexdef p_lock;Mutexdef ui_l;Mutexdef comm_StartCmd_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
