...
proctype rcResetStats184(chan child) {
	...
	:: true -> 
		...
		run ResetErrors554(stats_checking_mu,stats_inProgress_mu,stats_mu,stats_transferring_mu,child_ResetErrors5540);
		child_ResetErrors5540?0;
		run ResetCounters535(stats_checking_mu,stats_inProgress_mu,stats_mu,stats_transferring_mu,child_ResetCounters5351);
...
proctype ResetCounters535(Mutexdef s_checking_mu;Mutexdef s_inProgress_mu;Mutexdef s_mu;Mutexdef s_transferring_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
