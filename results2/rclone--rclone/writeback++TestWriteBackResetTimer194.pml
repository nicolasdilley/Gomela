...
// git_link=https://github.com/rclone/rclone/blob/6ef7178ee4465f2361b6e2cf483cef5bbfd9c95c/vfs/vfscache/writeback/writeback_test.go#L194
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestWriteBackResetTimer1940)
stop_process:skip
}
