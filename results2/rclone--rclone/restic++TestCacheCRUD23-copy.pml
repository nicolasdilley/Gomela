...
// git_link=https://github.com/rclone/rclone/blob/6ef7178ee4465f2361b6e2cf483cef5bbfd9c95c/cmd/serve/restic/cache_test.go#L23
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestCacheCRUD230)
stop_process:skip
}
...
proctype String12(Mutexdef c_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_itemsc_items = -2; // opt var_c_itemsc_items
	c_mu.Lock!false;
	c_mu.Unlock!false;
	goto stop_process;
	stop_process: skip;
