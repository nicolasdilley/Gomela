...
// git_link=https://github.com/rclone/rclone/blob/6ef7178ee4465f2361b6e2cf483cef5bbfd9c95c/lib/cache/cache_test.go#L40
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestGet400 = [1] of {int};
	run TestGet40(child_TestGet400);
	run receiver(child_TestGet400)
stop_process:skip
}

proctype TestGet40(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
