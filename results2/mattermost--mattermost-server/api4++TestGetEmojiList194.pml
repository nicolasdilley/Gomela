...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/emoji_test.go#L194
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetEmojiList1940 = [1] of {int};
	run TestGetEmojiList194(child_TestGetEmojiList1940);
	run receiver(child_TestGetEmojiList1940)
stop_process:skip
}

proctype TestGetEmojiList194(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_listEmojilistEmoji = -2; // opt var_listEmojilistEmoji
