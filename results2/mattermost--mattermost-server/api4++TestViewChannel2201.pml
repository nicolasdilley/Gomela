...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L2201
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestViewChannel22010 = [1] of {int};
	run TestViewChannel2201(child_TestViewChannel22010);
	run receiver(child_TestViewChannel22010)
stop_process:skip
}

proctype TestViewChannel2201(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
