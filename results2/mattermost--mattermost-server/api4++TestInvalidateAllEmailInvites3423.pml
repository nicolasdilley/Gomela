...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L3423
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestInvalidateAllEmailInvites34230 = [1] of {int};
	run TestInvalidateAllEmailInvites3423(child_TestInvalidateAllEmailInvites34230);
	run receiver(child_TestInvalidateAllEmailInvites34230)
stop_process:skip
}

proctype TestInvalidateAllEmailInvites3423(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
