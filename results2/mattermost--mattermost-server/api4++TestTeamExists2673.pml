...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L2673
#define not_found_2697  -2 // opt not_found_2697
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestTeamExists26730 = [1] of {int};
	run TestTeamExists2673(child_TestTeamExists26730);
	run receiver(child_TestTeamExists26730)
stop_process:skip
}

proctype TestTeamExists2673(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_CreateTeamWithClient4754 = [1] of {int};
	chan child_LinkUserToTeam7813 = [1] of {int};
	chan child_CreateTeamWithClient4752 = [1] of {int};
	chan child_CreateTeamWithClient4751 = [1] of {int};
	...
	run CreateTeamWithClient475(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateTeamWithClient4751);
	child_CreateTeamWithClient4751?0;
	run CreateTeamWithClient475(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateTeamWithClient4752);
	child_CreateTeamWithClient4752?0;
	...
	run CreateTeamWithClient475(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateTeamWithClient4754);
	child_CreateTeamWithClient4754?0;
	...
	child_AddPermissionToRole11908?0;
		defer2: skip;
	run RestoreDefaultRolePermissions1132(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,not_found_2697,child_RestoreDefaultRolePermissions11326);
