...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2318
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetRecentlyActiveUsersInTeam23180 = [1] of {int};
	run TestGetRecentlyActiveUsersInTeam2318(child_TestGetRecentlyActiveUsersInTeam23180);
	run receiver(child_TestGetRecentlyActiveUsersInTeam23180)
stop_process:skip
}

proctype TestGetRecentlyActiveUsersInTeam2318(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
