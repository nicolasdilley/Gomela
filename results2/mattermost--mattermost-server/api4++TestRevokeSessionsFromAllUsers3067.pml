...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L3067
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestRevokeSessionsFromAllUsers30670 = [1] of {int};
	run TestRevokeSessionsFromAllUsers3067(child_TestRevokeSessionsFromAllUsers30670);
	run receiver(child_TestRevokeSessionsFromAllUsers30670)
stop_process:skip
}

proctype TestRevokeSessionsFromAllUsers3067(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
