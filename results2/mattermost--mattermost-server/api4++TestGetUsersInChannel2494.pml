...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2494
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUsersInChannel24940 = [1] of {int};
	run TestGetUsersInChannel2494(child_TestGetUsersInChannel24940);
	run receiver(child_TestGetUsersInChannel24940)
stop_process:skip
}

proctype TestGetUsersInChannel2494(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
