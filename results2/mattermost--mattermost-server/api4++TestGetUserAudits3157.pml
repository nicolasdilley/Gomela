...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L3157
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUserAudits31570 = [1] of {int};
	run TestGetUserAudits3157(child_TestGetUserAudits31570);
	run receiver(child_TestGetUserAudits31570)
stop_process:skip
}

proctype TestGetUserAudits3157(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_auditsaudits = -2; // opt var_auditsaudits
