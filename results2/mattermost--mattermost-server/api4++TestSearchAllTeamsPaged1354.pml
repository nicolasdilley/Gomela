...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L1354
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSearchAllTeamsPaged13540 = [1] of {int};
	run TestSearchAllTeamsPaged1354(child_TestSearchAllTeamsPaged13540);
	run receiver(child_TestSearchAllTeamsPaged13540)
stop_process:skip
}

proctype TestSearchAllTeamsPaged1354(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
