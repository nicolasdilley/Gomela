...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/emoji_test.go#L424
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetEmoji4240 = [1] of {int};
	run TestGetEmoji424(child_TestGetEmoji4240);
	run receiver(child_TestGetEmoji4240)
stop_process:skip
}

proctype TestGetEmoji424(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
