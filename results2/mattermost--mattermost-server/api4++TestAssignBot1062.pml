...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/bot_test.go#L1062
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestAssignBot10620 = [1] of {int};
	run TestAssignBot1062(child_TestAssignBot10620);
	run receiver(child_TestAssignBot10620)
stop_process:skip
}

proctype TestAssignBot1062(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
