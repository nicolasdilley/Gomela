...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L3226
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestRemoveTeamIcon32260 = [1] of {int};
	run TestRemoveTeamIcon3226(child_TestRemoveTeamIcon32260);
	run receiver(child_TestRemoveTeamIcon32260)
stop_process:skip
}

proctype TestRemoveTeamIcon3226(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
