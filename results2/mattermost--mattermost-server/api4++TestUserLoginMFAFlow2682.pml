...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2682
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUserLoginMFAFlow26820 = [1] of {int};
	run TestUserLoginMFAFlow2682(child_TestUserLoginMFAFlow26820);
	run receiver(child_TestUserLoginMFAFlow26820)
stop_process:skip
}

proctype TestUserLoginMFAFlow2682(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
