...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/preference_test.go#L74
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetPreferencesByCategory740 = [1] of {int};
	run TestGetPreferencesByCategory74(child_TestGetPreferencesByCategory740);
	run receiver(child_TestGetPreferencesByCategory740)
stop_process:skip
}

proctype TestGetPreferencesByCategory74(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
