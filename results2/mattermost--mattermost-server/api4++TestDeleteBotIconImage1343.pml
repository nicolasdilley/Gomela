...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/bot_test.go#L1343
#define not_found_1347  -2 // opt not_found_1347
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestDeleteBotIconImage13430 = [1] of {int};
	run TestDeleteBotIconImage1343(child_TestDeleteBotIconImage13430);
	run receiver(child_TestDeleteBotIconImage13430)
stop_process:skip
}

proctype TestDeleteBotIconImage1343(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	child_AddPermissionToRole11904?0;
		defer2: skip;
	run RestoreDefaultRolePermissions1132(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,not_found_1347,child_RestoreDefaultRolePermissions11321);
