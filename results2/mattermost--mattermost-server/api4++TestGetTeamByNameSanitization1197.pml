...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L1197
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTeamByNameSanitization11970 = [1] of {int};
	run TestGetTeamByNameSanitization1197(child_TestGetTeamByNameSanitization11970);
	run receiver(child_TestGetTeamByNameSanitization11970)
stop_process:skip
}

proctype TestGetTeamByNameSanitization1197(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
