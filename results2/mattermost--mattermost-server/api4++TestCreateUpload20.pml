...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/upload_test.go#L20
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestCreateUpload200 = [1] of {int};
	run TestCreateUpload20(child_TestCreateUpload200);
	run receiver(child_TestCreateUpload200)
stop_process:skip
}

proctype TestCreateUpload20(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
