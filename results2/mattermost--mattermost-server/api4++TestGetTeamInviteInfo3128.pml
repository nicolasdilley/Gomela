...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L3128
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTeamInviteInfo31280 = [1] of {int};
	run TestGetTeamInviteInfo3128(child_TestGetTeamInviteInfo31280);
	run receiver(child_TestGetTeamInviteInfo31280)
stop_process:skip
}

proctype TestGetTeamInviteInfo3128(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
