...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/preference_test.go#L129
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetPreferenceByCategoryAndName1290 = [1] of {int};
	run TestGetPreferenceByCategoryAndName129(child_TestGetPreferenceByCategoryAndName1290);
	run receiver(child_TestGetPreferenceByCategoryAndName1290)
stop_process:skip
}

proctype TestGetPreferenceByCategoryAndName129(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
