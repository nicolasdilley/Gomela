...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L3484
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetChannelMembersTimezones34840 = [1] of {int};
	run TestGetChannelMembersTimezones3484(child_TestGetChannelMembersTimezones34840);
	run receiver(child_TestGetChannelMembersTimezones34840)
stop_process:skip
}

proctype TestGetChannelMembersTimezones3484(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
