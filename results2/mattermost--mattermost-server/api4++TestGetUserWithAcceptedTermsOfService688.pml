...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L688
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUserWithAcceptedTermsOfService6880 = [1] of {int};
	run TestGetUserWithAcceptedTermsOfService688(child_TestGetUserWithAcceptedTermsOfService6880);
	run receiver(child_TestGetUserWithAcceptedTermsOfService6880)
stop_process:skip
}

proctype TestGetUserWithAcceptedTermsOfService688(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
