...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L2161
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetChannelMembersForUser21610 = [1] of {int};
	run TestGetChannelMembersForUser2161(child_TestGetChannelMembersForUser21610);
	run receiver(child_TestGetChannelMembersForUser21610)
stop_process:skip
}

proctype TestGetChannelMembersForUser2161(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
