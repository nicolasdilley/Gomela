...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2342
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetActiveUsersInTeam23420 = [1] of {int};
	run TestGetActiveUsersInTeam2342(child_TestGetActiveUsersInTeam23420);
	run receiver(child_TestGetActiveUsersInTeam23420)
stop_process:skip
}

proctype TestGetActiveUsersInTeam2342(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
