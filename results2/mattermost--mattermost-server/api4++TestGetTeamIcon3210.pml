...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L3210
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTeamIcon32100 = [1] of {int};
	run TestGetTeamIcon3210(child_TestGetTeamIcon32100);
	run receiver(child_TestGetTeamIcon32100)
stop_process:skip
}

proctype TestGetTeamIcon3210(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
