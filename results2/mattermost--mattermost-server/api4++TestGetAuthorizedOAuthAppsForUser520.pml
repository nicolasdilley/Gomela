...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/oauth_test.go#L520
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetAuthorizedOAuthAppsForUser5200 = [1] of {int};
	run TestGetAuthorizedOAuthAppsForUser520(child_TestGetAuthorizedOAuthAppsForUser5200);
	run receiver(child_TestGetAuthorizedOAuthAppsForUser5200)
stop_process:skip
}

proctype TestGetAuthorizedOAuthAppsForUser520(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
