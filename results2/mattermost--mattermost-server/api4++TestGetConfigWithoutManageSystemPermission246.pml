...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/config_test.go#L246
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetConfigWithoutManageSystemPermission2460 = [1] of {int};
	run TestGetConfigWithoutManageSystemPermission246(child_TestGetConfigWithoutManageSystemPermission2460);
	run receiver(child_TestGetConfigWithoutManageSystemPermission2460)
stop_process:skip
}

proctype TestGetConfigWithoutManageSystemPermission246(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
