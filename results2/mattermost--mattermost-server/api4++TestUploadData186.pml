...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/upload_test.go#L186
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUploadData1860 = [1] of {int};
	run TestUploadData186(child_TestUploadData1860);
	run receiver(child_TestUploadData1860)
stop_process:skip
}

proctype TestUploadData186(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
