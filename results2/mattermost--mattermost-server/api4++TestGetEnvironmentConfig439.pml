...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/config_test.go#L439
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetEnvironmentConfig4390 = [1] of {int};
	run TestGetEnvironmentConfig439(child_TestGetEnvironmentConfig4390);
	run receiver(child_TestGetEnvironmentConfig4390)
stop_process:skip
}

proctype TestGetEnvironmentConfig439(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
