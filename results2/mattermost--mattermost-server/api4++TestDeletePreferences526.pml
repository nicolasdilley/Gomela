...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/preference_test.go#L526
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestDeletePreferences5260 = [1] of {int};
	run TestDeletePreferences526(child_TestDeletePreferences5260);
	run receiver(child_TestDeletePreferences5260)
stop_process:skip
}

proctype TestDeletePreferences526(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
