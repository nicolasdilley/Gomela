...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L553
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestPatchTeamSanitization5530 = [1] of {int};
	run TestPatchTeamSanitization553(child_TestPatchTeamSanitization5530);
	run receiver(child_TestPatchTeamSanitization5530)
stop_process:skip
}

proctype TestPatchTeamSanitization553(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
