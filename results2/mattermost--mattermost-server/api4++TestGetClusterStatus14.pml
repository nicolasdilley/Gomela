...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/cluster_test.go#L14
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetClusterStatus140 = [1] of {int};
	run TestGetClusterStatus14(child_TestGetClusterStatus140);
	run receiver(child_TestGetClusterStatus140)
stop_process:skip
}

proctype TestGetClusterStatus14(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
