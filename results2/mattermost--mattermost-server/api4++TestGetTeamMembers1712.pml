...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L1712
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTeamMembers17120 = [1] of {int};
	run TestGetTeamMembers1712(child_TestGetTeamMembers17120);
	run receiver(child_TestGetTeamMembers17120)
stop_process:skip
}

proctype TestGetTeamMembers1712(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_rmembers2rmembers2 = -2; // opt var_rmembers2rmembers2
	int var_rmembersrmembers = -2; // opt var_rmembersrmembers
