...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L4190
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSearchUserAccessToken41900 = [1] of {int};
	run TestSearchUserAccessToken4190(child_TestSearchUserAccessToken41900);
	run receiver(child_TestSearchUserAccessToken41900)
stop_process:skip
}

proctype TestSearchUserAccessToken4190(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
