...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L2467
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateTeamMemberRoles24670 = [1] of {int};
	run TestUpdateTeamMemberRoles2467(child_TestUpdateTeamMemberRoles24670);
	run receiver(child_TestUpdateTeamMemberRoles24670)
stop_process:skip
}

proctype TestUpdateTeamMemberRoles2467(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
