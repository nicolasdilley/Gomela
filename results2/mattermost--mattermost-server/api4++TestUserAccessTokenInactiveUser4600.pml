...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L4600
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUserAccessTokenInactiveUser46000 = [1] of {int};
	run TestUserAccessTokenInactiveUser4600(child_TestUserAccessTokenInactiveUser46000);
	run receiver(child_TestUserAccessTokenInactiveUser46000)
stop_process:skip
}

proctype TestUserAccessTokenInactiveUser4600(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
