...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/job_test.go#L78
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetJobs780 = [1] of {int};
	run TestGetJobs78(child_TestGetJobs780);
	run receiver(child_TestGetJobs780)
stop_process:skip
}

proctype TestGetJobs78(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
