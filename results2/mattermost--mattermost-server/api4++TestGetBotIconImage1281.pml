...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/bot_test.go#L1281
#define not_found_1285  -2 // opt not_found_1285
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetBotIconImage12810 = [1] of {int};
	run TestGetBotIconImage1281(child_TestGetBotIconImage12810);
	run receiver(child_TestGetBotIconImage12810)
stop_process:skip
}

proctype TestGetBotIconImage1281(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_TearDown2920 = [1] of {int};
	chan child_RestoreDefaultRolePermissions11321 = [1] of {int};
	chan child_cleanupTestFile10055 = [1] of {int};
	chan child_AddPermissionToRole11904 = [1] of {int};
	chan child_AddPermissionToRole11903 = [1] of {int};
	chan child_AddPermissionToRole11902 = [1] of {int};
	...
	child_cleanupTestFile10055?0;
		defer2: skip;
	run RestoreDefaultRolePermissions1132(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,not_found_1285,child_RestoreDefaultRolePermissions11321);
