...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L1379
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestAutocompleteUsers13790 = [1] of {int};
	run TestAutocompleteUsers1379(child_TestAutocompleteUsers13790);
	run receiver(child_TestAutocompleteUsers13790)
stop_process:skip
}

proctype TestAutocompleteUsers1379(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
