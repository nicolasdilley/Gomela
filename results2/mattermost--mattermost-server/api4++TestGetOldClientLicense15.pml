...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/license_test.go#L15
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetOldClientLicense150 = [1] of {int};
	run TestGetOldClientLicense15(child_TestGetOldClientLicense150);
	run receiver(child_TestGetOldClientLicense150)
stop_process:skip
}

proctype TestGetOldClientLicense15(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
