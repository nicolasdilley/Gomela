...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/elasticsearch_test.go#L12
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestElasticsearchTest120 = [1] of {int};
	run TestElasticsearchTest12(child_TestElasticsearchTest120);
	run receiver(child_TestElasticsearchTest120)
stop_process:skip
}

proctype TestElasticsearchTest12(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
