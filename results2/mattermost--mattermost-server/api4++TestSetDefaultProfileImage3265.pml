...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L3265
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSetDefaultProfileImage32650 = [1] of {int};
	run TestSetDefaultProfileImage3265(child_TestSetDefaultProfileImage32650);
	run receiver(child_TestSetDefaultProfileImage32650)
stop_process:skip
}

proctype TestSetDefaultProfileImage3265(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
