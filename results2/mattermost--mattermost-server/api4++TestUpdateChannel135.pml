...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L135
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateChannel1350 = [1] of {int};
	run TestUpdateChannel135(child_TestUpdateChannel1350);
	run receiver(child_TestUpdateChannel1350)
stop_process:skip
}

proctype TestUpdateChannel135(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
