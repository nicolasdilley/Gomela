...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/bot_test.go#L461
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetBot4610 = [1] of {int};
	run TestGetBot461(child_TestGetBot4610);
	run receiver(child_TestGetBot4610)
stop_process:skip
}

proctype TestGetBot461(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
