...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/job_test.go#L48
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetJob480 = [1] of {int};
	run TestGetJob48(child_TestGetJob480);
	run receiver(child_TestGetJob480)
stop_process:skip
}

proctype TestGetJob48(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
