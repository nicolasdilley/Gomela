...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L3302
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestLogin33020 = [1] of {int};
	run TestLogin3302(child_TestLogin33020);
	run receiver(child_TestLogin33020)
stop_process:skip
}

proctype TestLogin3302(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
