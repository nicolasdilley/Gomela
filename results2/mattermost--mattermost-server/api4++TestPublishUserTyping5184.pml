...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L5184
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestPublishUserTyping51840 = [1] of {int};
	run TestPublishUserTyping5184(child_TestPublishUserTyping51840);
	run receiver(child_TestPublishUserTyping51840)
stop_process:skip
}

proctype TestPublishUserTyping5184(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
