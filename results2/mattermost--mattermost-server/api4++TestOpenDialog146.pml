...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/integration_action_test.go#L146
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestOpenDialog1460 = [1] of {int};
	run TestOpenDialog146(child_TestOpenDialog1460);
	run receiver(child_TestOpenDialog1460)
stop_process:skip
}

proctype TestOpenDialog146(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
