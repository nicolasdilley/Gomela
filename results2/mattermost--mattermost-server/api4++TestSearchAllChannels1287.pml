...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L1287
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSearchAllChannels12870 = [1] of {int};
	run TestSearchAllChannels1287(child_TestSearchAllChannels12870);
	run receiver(child_TestSearchAllChannels12870)
stop_process:skip
}

proctype TestSearchAllChannels1287(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
