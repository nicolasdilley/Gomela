...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2942
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetSessions29420 = [1] of {int};
	run TestGetSessions2942(child_TestGetSessions29420);
	run receiver(child_TestGetSessions29420)
stop_process:skip
}

proctype TestGetSessions2942(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
