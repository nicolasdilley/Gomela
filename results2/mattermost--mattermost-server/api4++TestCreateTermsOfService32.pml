...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/terms_of_service_test.go#L32
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestCreateTermsOfService320 = [1] of {int};
	run TestCreateTermsOfService32(child_TestCreateTermsOfService320);
	run receiver(child_TestCreateTermsOfService320)
stop_process:skip
}

proctype TestCreateTermsOfService32(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
