...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/brand_test.go#L58
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestDeleteBrandImage580 = [1] of {int};
	run TestDeleteBrandImage58(child_TestDeleteBrandImage580);
	run receiver(child_TestDeleteBrandImage580)
stop_process:skip
}

proctype TestDeleteBrandImage58(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
