...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/commands_test.go#L299
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestMeCommand2990 = [1] of {int};
	run TestMeCommand299(child_TestMeCommand2990);
	run receiver(child_TestMeCommand2990)
stop_process:skip
}

proctype TestMeCommand299(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
