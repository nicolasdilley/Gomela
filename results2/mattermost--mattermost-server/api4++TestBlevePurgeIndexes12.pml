...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/bleve_test.go#L12
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestBlevePurgeIndexes120 = [1] of {int};
	run TestBlevePurgeIndexes12(child_TestBlevePurgeIndexes120);
	run receiver(child_TestBlevePurgeIndexes120)
stop_process:skip
}

proctype TestBlevePurgeIndexes12(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
