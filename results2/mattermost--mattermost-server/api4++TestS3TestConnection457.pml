...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/system_test.go#L457
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestS3TestConnection4570 = [1] of {int};
	run TestS3TestConnection457(child_TestS3TestConnection4570);
	run receiver(child_TestS3TestConnection4570)
stop_process:skip
}

proctype TestS3TestConnection457(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
