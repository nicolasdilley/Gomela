...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L3031
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestRevokeAllSessions30310 = [1] of {int};
	run TestRevokeAllSessions3031(child_TestRevokeAllSessions30310);
	run receiver(child_TestRevokeAllSessions30310)
stop_process:skip
}

proctype TestRevokeAllSessions3031(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
