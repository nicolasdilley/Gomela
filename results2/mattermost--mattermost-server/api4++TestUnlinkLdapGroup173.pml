...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/ldap_test.go#L173
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUnlinkLdapGroup1730 = [1] of {int};
	run TestUnlinkLdapGroup173(child_TestUnlinkLdapGroup1730);
	run receiver(child_TestUnlinkLdapGroup1730)
stop_process:skip
}

proctype TestUnlinkLdapGroup173(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
