...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L2580
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateChannelNotifyProps25800 = [1] of {int};
	run TestUpdateChannelNotifyProps2580(child_TestUpdateChannelNotifyProps25800);
	run receiver(child_TestUpdateChannelNotifyProps25800)
stop_process:skip
}

proctype TestUpdateChannelNotifyProps2580(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
