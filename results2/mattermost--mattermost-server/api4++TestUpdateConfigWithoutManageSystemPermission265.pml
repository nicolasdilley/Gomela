...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/config_test.go#L265
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateConfigWithoutManageSystemPermission2650 = [1] of {int};
	run TestUpdateConfigWithoutManageSystemPermission265(child_TestUpdateConfigWithoutManageSystemPermission2650);
	run receiver(child_TestUpdateConfigWithoutManageSystemPermission2650)
stop_process:skip
}

proctype TestUpdateConfigWithoutManageSystemPermission265(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_TearDown2920 = [1] of {int};
	chan child_RemovePermissionFromRole11582 = [1] of {int};
	chan child_AddPermissionToRole11901 = [1] of {int};
	...
	run AddPermissionToRole1190(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_AddPermissionToRole11901);
	child_AddPermissionToRole11901?0;
		defer2: skip;
	run RemovePermissionFromRole1158(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_RemovePermissionFromRole11582);
	child_RemovePermissionFromRole11582?0;
		defer1: skip;
