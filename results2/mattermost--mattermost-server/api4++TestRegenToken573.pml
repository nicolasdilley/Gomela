...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/command_test.go#L573
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestRegenToken5730 = [1] of {int};
	run TestRegenToken573(child_TestRegenToken5730);
	run receiver(child_TestRegenToken5730)
stop_process:skip
}

proctype TestRegenToken573(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
