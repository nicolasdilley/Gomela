...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L1548
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUsersByGroupChannelIds15480 = [1] of {int};
	run TestGetUsersByGroupChannelIds1548(child_TestGetUsersByGroupChannelIds15480);
	run receiver(child_TestGetUsersByGroupChannelIds15480)
stop_process:skip
}

proctype TestGetUsersByGroupChannelIds1548(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_usersusers = -2; // opt var_usersusers
