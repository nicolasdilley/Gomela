...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/status_test.go#L74
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUsersStatusesByIds740 = [1] of {int};
	run TestGetUsersStatusesByIds74(child_TestGetUsersStatusesByIds740);
	run receiver(child_TestGetUsersStatusesByIds740)
stop_process:skip
}

proctype TestGetUsersStatusesByIds74(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_usersStatusesusersStatuses = -2; // opt var_usersStatusesusersStatuses
