...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L2080
#define not_found_2088  -2 // opt not_found_2088
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestAddTeamMemberMyself20800 = [1] of {int};
	run TestAddTeamMemberMyself2080(child_TestAddTeamMemberMyself20800);
	run receiver(child_TestAddTeamMemberMyself20800)
stop_process:skip
}

proctype TestAddTeamMemberMyself2080(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	child_LoginBasic7053?0;
		defer2: skip;
	run RestoreDefaultRolePermissions1132(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,not_found_2088,child_RestoreDefaultRolePermissions11322);
