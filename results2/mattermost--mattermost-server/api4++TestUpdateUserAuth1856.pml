...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L1856
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateUserAuth18560 = [1] of {int};
	run TestUpdateUserAuth1856(child_TestUpdateUserAuth18560);
	run receiver(child_TestUpdateUserAuth18560)
stop_process:skip
}

proctype TestUpdateUserAuth1856(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype CreateUser467(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_CreateUserWithClient4932 = [1] of {int};
	run CreateUserWithClient493(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateUserWithClient4932);
	child_CreateUserWithClient4932?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
