...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/preference_test.go#L17
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetPreferences170 = [1] of {int};
	run TestGetPreferences17(child_TestGetPreferences170);
	run receiver(child_TestGetPreferences170)
stop_process:skip
}

proctype TestGetPreferences17(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_prefsprefs = -2; // opt var_prefsprefs
