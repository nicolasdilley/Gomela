...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/command_test.go#L19
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestCreateCommand190 = [1] of {int};
	run TestCreateCommand19(child_TestCreateCommand190);
	run receiver(child_TestCreateCommand190)
stop_process:skip
}

proctype TestCreateCommand19(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
