...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/emoji_test.go#L569
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSearchEmoji5690 = [1] of {int};
	run TestSearchEmoji569(child_TestSearchEmoji5690);
	run receiver(child_TestSearchEmoji5690)
stop_process:skip
}

proctype TestSearchEmoji569(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
