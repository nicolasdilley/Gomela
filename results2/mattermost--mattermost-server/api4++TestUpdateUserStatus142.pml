...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/status_test.go#L142
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateUserStatus1420 = [1] of {int};
	run TestUpdateUserStatus142(child_TestUpdateUserStatus1420);
	run receiver(child_TestUpdateUserStatus1420)
stop_process:skip
}

proctype TestUpdateUserStatus142(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
