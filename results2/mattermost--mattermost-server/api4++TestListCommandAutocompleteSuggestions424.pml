...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/command_test.go#L424
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestListCommandAutocompleteSuggestions4240 = [1] of {int};
	run TestListCommandAutocompleteSuggestions424(child_TestListCommandAutocompleteSuggestions4240);
	run receiver(child_TestListCommandAutocompleteSuggestions4240)
stop_process:skip
}

proctype TestListCommandAutocompleteSuggestions424(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_suggestionssuggestions = -2; // opt var_suggestionssuggestions
