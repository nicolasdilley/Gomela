...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/bot_test.go#L1211
#define not_found_1216  -2 // opt not_found_1216
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSetBotIconImage12110 = [1] of {int};
	run TestSetBotIconImage1211(child_TestSetBotIconImage12110);
	run receiver(child_TestSetBotIconImage12110)
stop_process:skip
}

proctype TestSetBotIconImage1211(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
