...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L4799
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUserTermsOfService47990 = [1] of {int};
	run TestGetUserTermsOfService4799(child_TestGetUserTermsOfService47990);
	run receiver(child_TestGetUserTermsOfService47990)
stop_process:skip
}

proctype TestGetUserTermsOfService4799(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
