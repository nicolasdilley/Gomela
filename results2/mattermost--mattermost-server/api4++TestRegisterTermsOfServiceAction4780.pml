...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L4780
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestRegisterTermsOfServiceAction47800 = [1] of {int};
	run TestRegisterTermsOfServiceAction4780(child_TestRegisterTermsOfServiceAction47800);
	run receiver(child_TestRegisterTermsOfServiceAction47800)
stop_process:skip
}

proctype TestRegisterTermsOfServiceAction4780(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
