...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L5748
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestThreadCounts57480 = [1] of {int};
	run TestThreadCounts5748(child_TestThreadCounts57480);
	run receiver(child_TestThreadCounts57480)
stop_process:skip
}

proctype TestThreadCounts5748(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
