...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/commands_test.go#L407
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestStatusCommands4070 = [1] of {int};
	run TestStatusCommands407(child_TestStatusCommands4070);
	run receiver(child_TestStatusCommands4070)
stop_process:skip
}

proctype TestStatusCommands407(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_TearDown2920 = [1] of {int};
	chan child_commandAndTest4163 = [1] of {int};
	chan child_commandAndTest4162 = [1] of {int};
	chan child_commandAndTest4161 = [1] of {int};
	...
	run commandAndTest416(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_commandAndTest4161);
	child_commandAndTest4161?0;
	run commandAndTest416(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_commandAndTest4162);
	child_commandAndTest4162?0;
	run commandAndTest416(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_commandAndTest4163);
	child_commandAndTest4163?0;
		defer1: skip;
...
proctype commandAndTest416(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
