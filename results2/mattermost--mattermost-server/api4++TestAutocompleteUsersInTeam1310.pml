...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L1310
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestAutocompleteUsersInTeam13100 = [1] of {int};
	run TestAutocompleteUsersInTeam1310(child_TestAutocompleteUsersInTeam13100);
	run receiver(child_TestAutocompleteUsersInTeam13100)
stop_process:skip
}

proctype TestAutocompleteUsersInTeam1310(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
