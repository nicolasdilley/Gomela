...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/file_test.go#L837
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetFileLink8370 = [1] of {int};
	run TestGetFileLink837(child_TestGetFileLink8370);
	run receiver(child_TestGetFileLink8370)
stop_process:skip
}

proctype TestGetFileLink837(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
