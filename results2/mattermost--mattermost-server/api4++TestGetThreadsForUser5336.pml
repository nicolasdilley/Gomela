...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L5336
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetThreadsForUser53360 = [1] of {int};
	run TestGetThreadsForUser5336(child_TestGetThreadsForUser53360);
	run receiver(child_TestGetThreadsForUser53360)
stop_process:skip
}

proctype TestGetThreadsForUser5336(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
