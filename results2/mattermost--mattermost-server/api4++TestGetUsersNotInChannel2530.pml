...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2530
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUsersNotInChannel25300 = [1] of {int};
	run TestGetUsersNotInChannel2530(child_TestGetUsersNotInChannel25300);
	run receiver(child_TestGetUsersNotInChannel25300)
stop_process:skip
}

proctype TestGetUsersNotInChannel2530(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_rusersrusers = -2; // opt var_rusersrusers
