...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2294
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetNewUsersInTeam22940 = [1] of {int};
	run TestGetNewUsersInTeam2294(child_TestGetNewUsersInTeam22940);
	run receiver(child_TestGetNewUsersInTeam22940)
stop_process:skip
}

proctype TestGetNewUsersInTeam2294(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
