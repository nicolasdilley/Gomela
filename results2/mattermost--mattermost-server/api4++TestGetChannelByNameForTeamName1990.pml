...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L1990
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetChannelByNameForTeamName19900 = [1] of {int};
	run TestGetChannelByNameForTeamName1990(child_TestGetChannelByNameForTeamName19900);
	run receiver(child_TestGetChannelByNameForTeamName19900)
stop_process:skip
}

proctype TestGetChannelByNameForTeamName1990(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
