...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L4821
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestLoginErrorMessage48210 = [1] of {int};
	run TestLoginErrorMessage4821(child_TestLoginErrorMessage48210);
	run receiver(child_TestLoginErrorMessage48210)
stop_process:skip
}

proctype TestLoginErrorMessage4821(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
