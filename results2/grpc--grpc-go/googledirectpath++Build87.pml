...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/googledirectpath/googlec2p.go#L87
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype Build87(chan child) {
	...
	run AnonymousBuild102100(ipv6CapableCh_ch,zoneCh_ch,child_AnonymousBuild1021001);
...
proctype AnonymousBuild102100(Chandef ipv6CapableCh_ch;Chandef zoneCh_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
