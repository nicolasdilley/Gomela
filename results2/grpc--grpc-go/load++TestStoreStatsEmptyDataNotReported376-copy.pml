...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/load/store_test.go#L376
#define not_found_421  -2 // opt not_found_421
#define not_found_442  -2 // opt not_found_442
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestStoreStatsEmptyDataNotReported3760)
stop_process:skip
}
...
proctype TestStoreStatsEmptyDataNotReported376(chan child) {
	...
	Mutexdef store_mu;
	int testServices = -2; // opt testServices
...
proctype Stats63(Mutexdef s_mu;int clusterNames;chan child) {
	...
	bool state;
	int num_msgs;
	int s_clusters = -2; // opt s_clusters
	s_mu.Lock!false;
