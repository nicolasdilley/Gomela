...
proctype pathCertWrite270(Mutexdef b_crlUpdateMutex;chan child) {
	...
	int parsedL0L_ExtKeyUsage = -2; // opt parsedL0L_ExtKeyUsage
...
proctype verifyCredentials171(Mutexdef b_crlUpdateMutex;chan child) {
	...
	int chain = -2; // opt chain
	int trustedChains = -2; // opt trustedChains
	int trust_Certificates = -2; // opt trust_Certificates
	int trusted = -2; // opt trusted
	int trustedNonCAs = -2; // opt trustedNonCAs
	...
	:: trusted-1 != -3 -> 
			...
			if
			:: trust_Certificates-1 != -3 -> 
								for(i : 0.. trust_Certificates-1) {
					for41: skip;
					

					if
					:: trustedChains-1 != -3 -> 
												for(i : 0.. trustedChains-1) {
							for42: skip;
...
proctype matchesNames259(Mutexdef b_crlUpdateMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int clientCert_EmailAddresses = -2; // opt clientCert_EmailAddresses
	int clientCert_DNSNames = -2; // opt clientCert_DNSNames
	int config_Entry_AllowedNames = -2; // opt config_Entry_AllowedNames
...
proctype matchesCommonName288(Mutexdef b_crlUpdateMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int config_Entry_AllowedCommonNames = -2; // opt config_Entry_AllowedCommonNames
...
proctype matchesDNSSANs305(Mutexdef b_crlUpdateMutex;chan child) {
	...
	int num_msgs;
	int clientCert_DNSNames = -2; // opt clientCert_DNSNames
	int config_Entry_AllowedDNSSANs = -2; // opt config_Entry_AllowedDNSSANs
...
proctype matchesEmailSANs324(Mutexdef b_crlUpdateMutex;chan child) {
	...
	int num_msgs;
	int clientCert_EmailAddresses = -2; // opt clientCert_EmailAddresses
	int config_Entry_AllowedEmailSANs = -2; // opt config_Entry_AllowedEmailSANs
...
proctype matchesURISANs343(Mutexdef b_crlUpdateMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int clientCert_URIs = -2; // opt clientCert_URIs
	int config_Entry_AllowedURISANs = -2; // opt config_Entry_AllowedURISANs
...
proctype matchesOrganizationalUnits361(Mutexdef b_crlUpdateMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int clientCert_Subject_OrganizationalUnit = -2; // opt clientCert_Subject_OrganizationalUnit
	int config_Entry_AllowedOrganizationalUnits = -2; // opt config_Entry_AllowedOrganizationalUnits
...
proctype matchesCertificateExtensions381(Mutexdef b_crlUpdateMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int config_Entry_RequiredExtensions = -2; // opt config_Entry_RequiredExtensions
	int clientCert_Extensions = -2; // opt clientCert_Extensions
