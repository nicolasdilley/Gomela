...
proctype TestRaft_Snapshot_Index141(chan child) {
	...
	run Snapshot742(raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_observersLock,raft_raft_shutdownLock,child_Snapshot7425);
	...
	:: 0 != -2 && 100-1 != -3 -> 
				for(i : 0.. 100-1) {
			for21: skip;
			run Put1178(raft_autopilot_execLock,raft_autopilot_stateLock,raft_followerStates_l,raft_fsm_l,raft_l,raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_observersLock,raft_raft_shutdownLock,raft_streamLayer_closeLock,child_Put11787);
			child_Put11787?0;
			for21_end: skip
		};
		for21_exit: skip
	:: else -> 
		...
		:: true -> 
			for20: skip;
			run Put1178(raft_autopilot_execLock,raft_autopilot_stateLock,raft_followerStates_l,raft_fsm_l,raft_l,raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_observersLock,raft_raft_shutdownLock,raft_streamLayer_closeLock,child_Put11786);
			child_Put11786?0;
			for20_end: skip
		:: true -> 
			break
...
proctype Snapshot742(Mutexdef f_lastContactLock;Mutexdef f_leaderLock;Mutexdef f_observersLock;Mutexdef f_shutdownLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
