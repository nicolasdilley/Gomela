...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/barrier_aes_gcm_test.go#L62
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestAESGCMBarrier_MissingRotateConfig620 = [1] of {int};
	run TestAESGCMBarrier_MissingRotateConfig62(child_TestAESGCMBarrier_MissingRotateConfig620);
	run receiver(child_TestAESGCMBarrier_MissingRotateConfig620)
stop_process:skip
}

proctype TestAESGCMBarrier_MissingRotateConfig62(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
