...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/barrier_view_test.go#L217
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBarrierView_CollectKeys2170 = [1] of {int};
	run TestBarrierView_CollectKeys217(child_TestBarrierView_CollectKeys2170);
	run receiver(child_TestBarrierView_CollectKeys2170)
stop_process:skip
}

proctype TestBarrierView_CollectKeys217(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_entent = -2; // opt var_entent
