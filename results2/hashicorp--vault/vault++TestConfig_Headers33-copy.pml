...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/ui_test.go#L33
#define not_found_57  -2 // opt not_found_57
#define not_found_97  -2 // opt not_found_97
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype HeaderKeys77(Mutexdef c_l;chan child) {
	...
	int var_config_Headersconfig_Headers = -2; // opt var_config_Headersconfig_Headers
	c_l.RLock!false;
