...
// git_link=https://github.com/go-delve/delve/blob/9ed4ba0c49d916bf128ecf69fcc109235aeed075/service/debugger/debugger_test.go#L35
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestDebugger_LaunchInvalidFormat350 = [1] of {int};
	run TestDebugger_LaunchInvalidFormat35(child_TestDebugger_LaunchInvalidFormat350);
	run receiver(child_TestDebugger_LaunchInvalidFormat350)
stop_process:skip
}

proctype TestDebugger_LaunchInvalidFormat35(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
