...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/logging/logfile_test.go#L16
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestLogFile_Rotation_MaxDuration160 = [1] of {int};
	run TestLogFile_Rotation_MaxDuration16(child_TestLogFile_Rotation_MaxDuration160);
	run receiver(child_TestLogFile_Rotation_MaxDuration160)
stop_process:skip
}

proctype TestLogFile_Rotation_MaxDuration16(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
