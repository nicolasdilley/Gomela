...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/logging/logfile_test.go#L65
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestLogFile_PruneFiles650 = [1] of {int};
	run TestLogFile_PruneFiles65(child_TestLogFile_PruneFiles650);
	run receiver(child_TestLogFile_PruneFiles650)
stop_process:skip
}

proctype TestLogFile_PruneFiles65(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
