...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/agent/consul/stream/event_buffer_test.go#L15
#define TestEventBufferFuzz_nReaders  ??
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestEventBufferFuzz15(chan child) {
	...
	Chandef errCh_ch;
	int var_nReaders = TestEventBufferFuzz_nReaders; // mand var_nReaders
