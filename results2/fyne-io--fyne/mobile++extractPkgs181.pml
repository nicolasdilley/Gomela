...
proctype extractPkgs181(chan child) {
	...
	run AnonymousextractPkgs192191(errc,r_p_wrMu,w_p_wrMu,cmd_Process_sigMu,child_AnonymousextractPkgs1921910);
...
proctype AnonymousextractPkgs192191(Chandef errc;Mutexdef r_p_wrMu;Mutexdef w_p_wrMu;Mutexdef cmd_Process_sigMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype Close139(Mutexdef w_p_wrMu;chan child) {
	...
	int w_manifest = -2; // opt w_manifest
