...
#define DeleteChart_qSize  ??
#define DeleteChart_allVersions  ??
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype DeleteChart37(chan child) {
	...
	int var_allVersions = DeleteChart_allVersions; // mand var_allVersions
	int var_qSize = DeleteChart_qSize; // mand var_qSize
	...
	run AnonymousDeleteChart7764(tokenQueue_ch,errChan_ch,errWrapper_ch,waitGroup,child_AnonymousDeleteChart77640);
	run receiver(child_AnonymousDeleteChart77640);
		...
		run AnonymousDeleteChart9898(errWrapper_ch,tokenQueue_ch,errChan_ch,waitGroup,child_AnonymousDeleteChart98981);
...
proctype AnonymousDeleteChart7764(Chandef tokenQueue_ch;Chandef errChan_ch;Chandef errWrapper_ch;Wgdef waitGroup;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousDeleteChart9898(Chandef errWrapper_ch;Chandef tokenQueue_ch;Chandef errChan_ch;Wgdef waitGroup;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
