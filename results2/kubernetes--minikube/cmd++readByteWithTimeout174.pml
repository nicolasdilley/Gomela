...
proctype readByteWithTimeout174(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousreadByteWithTimeout1771760 = [1] of {int};
	Chandef ec_ch;
	Chandef bc_ch;
	run sync_monitor(bc_ch);
	run sync_monitor(ec_ch);
	run AnonymousreadByteWithTimeout177176(ec_ch,bc_ch,child_AnonymousreadByteWithTimeout1771760);
	run receiver(child_AnonymousreadByteWithTimeout1771760);
	do
...
proctype AnonymousreadByteWithTimeout177176(Chandef ec_ch;Chandef bc_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
