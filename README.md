...
In [parseFiles](https://github.com/nicolasdilley/Gomela/blob/rewrite/examples/parseFiles.go#L9), The length of ```files``` determines the length of the channel ```ch``` and the
...
be found [here](https://github.com/nicolasdilley/Gomela/blob/rewrite/examples/parseFiles.pml#L19). At line 19, the value of the variable ```files``` has been given a value of 5.
