...
#define lb_for190_2  -1
#define ub_for190_3  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example617996428/apiserver/apiserver.go
typedef Chandef {
	chan sync = [0] of {int};
...
for30_exit:
		:: true -> 
			...
			if
			:: lb_for190_2 != -2 && ub_for190_3 != -2 -> 
								for(i : lb_for190_2.. ub_for190_3) {
for40:					
					if
					:: true -> 
...
for20:		do
		...
		od
	od;
for20_exit:stop_process:	workerDoneCh.closing!true
}
