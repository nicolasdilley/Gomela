...
// git_link=https://github.com/iawia002/annie/blob//request/request.go#L47
#define def_var_headers  -2 // opt headers line 47
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run Request47(def_var_headers,child_Request470);
	run receiver(child_Request470)
stop_process:skip
}

proctype Request47(int var_headers;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_cookies = -2; // opt var_cookies
	int var_config_FakeHeaders = -2; // opt var_config_FakeHeaders
