...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example244624373/eth/filters/api.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype Anonymous4(Chandef matchedLogs) {
	bool closed; 
	int i;
	do
	:: true -> 
