#define NewManager_backends  ??

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example440247525/accounts/manager.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: else -> 
		...
		for(i : 0.. backends-1) {
for20:		chan child_Subscribe0 = [0] of {int};
