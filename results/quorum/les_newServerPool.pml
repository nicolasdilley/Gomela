...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example244624373/les/serverpool.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: 100 > 0 -> 
		...
		run emptyChan(pool_adjustStats)
	:: else -> 
	...
	:: 1 > 0 -> 
		...
		run emptyChan(pool_enableRetry)
	:: else -> 
