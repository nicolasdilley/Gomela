...
#define lb_for198_6  -1
#define ub_for198_7  -1
#define lb_for244_8  -1
#define ub_for244_9  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example244624373/ethstats/ethstats.go
typedef Chandef {
	chan sync = [0] of {int};
...
for21:			
		...
		if
		:: lb_for244_8 != -1 && ub_for244_9 != -1 -> 
						for(i : lb_for244_8.. ub_for244_9) {
for22:				do
				:: quitCh.async_rcv?0 -> 
					goto stop_process
				:: quitCh.sync?0 -> 
