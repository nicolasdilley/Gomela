#define InitDatabaseFromFreezer_runtime_NumCPU4539  ??
#define InitDatabaseFromFreezer_runtime_NumCPU5018  ??
#define lb_for94_2  -1
#define ub_for94_3  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example440247525/core/rawdb/freezer_reinit.go
typedef Chandef {
	chan sync = [0] of {int};
...
for20:			
			...
			if
			:: lb_for94_2 != -2 && ub_for94_3 != -2 -> 
								for(i : lb_for94_2.. ub_for94_3) {
for21:					
					if
					:: true -> 
						break
