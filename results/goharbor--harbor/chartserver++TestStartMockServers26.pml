...
// https://github.com/goharbor/harbor/blob/master/src/chartserver/handler_proxy_traffic_test.go#L26
typedef Wgdef {
...
init { 
	chan child_TestStartMockServers260 = [1] of {int};
	run TestStartMockServers26(child_TestStartMockServers260)
stop_process:skip
}

proctype TestStartMockServers26(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
