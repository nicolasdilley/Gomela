...
// git_link=https://github.com/goharbor/harbor/blob//src/chartserver/handler_utility.go#L37
...
proctype DeleteChart37(chan child) {
	...
	chan child_AnonymousDeleteChart77760 = [1] of {int};
	...
	run AnonymousDeleteChart7776(errWrapper_ch,tokenQueue_ch,errChan_ch,waitGroup,child_AnonymousDeleteChart77760);
	run receiver(child_AnonymousDeleteChart77760);
...
proctype AnonymousDeleteChart7776(Chandef errWrapper_ch;Chandef tokenQueue_ch;Chandef errChan_ch;Wgdef waitGroup;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
