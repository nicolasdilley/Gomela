#define lb_for376_0  -1
#define ub_for376_1  -1
#define lb_for464_2  -1
#define ub_for464_3  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example794272187/api/agent/runner_client.go
typedef Chandef {
	chan sync = [0] of {int};
