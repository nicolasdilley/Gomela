...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example877977840/go/diff/summary.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype diffdiffSummaryValueChanged(Chandef ch;chan child) {
	...
	run diffreportChanges(ch,changeChan,changeChan,child_diffreportChanges1);
...
proctype diffreportChanges(Chandef ch;Chandef changeChan;int changeChan;chan child) {
	bool closed; 
	int i;
	do
