...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example877977840/go/merge/three_way_ordered_sequence.go
typedef Chandef {
	chan sync = [0] of {int};
...
for20_exit:	goto stop_process;
	run mergestopAndDrain(aStopChan,aChangeChan,aChangeChan,child_mergestopAndDrain2);
...
proctype mergestopAndDrain(Chandef stop;Chandef drain;int drain;chan child) {
	bool closed; 
	int i;
	stop.closing!true;
	do
