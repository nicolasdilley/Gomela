...
// git_link=https://github.com/syncthing/syncthing/blob//lib/model/requests_test.go#L29
#define def_var_fs47  ?? // mand fs line 47
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRequestSimple29(chan child) {
	...
	Chandef done_ch;
	Mutexdef fc_mut;
	int var_fs = def_var_fs47; // mand var_fs
