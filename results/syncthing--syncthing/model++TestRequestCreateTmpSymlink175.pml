#define TestRequestCreateTmpSymlink_fs  1

// https://github.com/syncthing/syncthing/blob/master/lib/model/requests_test.go#L175
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRequestCreateTmpSymlink175(chan child) {
	...
	Chandef goodIdx;
	Mutexdef fc_mut;
	int fs = TestRequestCreateTmpSymlink_fs;
