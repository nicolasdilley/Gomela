...
// git_link=https://github.com/syncthing/syncthing/blob//lib/upnp/upnp.go#L88
#define def_var_interfaces101  3 // mand interfaces line 101
#define not_found_10730  0
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
