...
// git_link=https://github.com/go-gorm/gorm/blob//schema/relationship_test.go#L11
#define def_var_relations  -2 // opt relations line 11
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run checkStructRelation11(def_var_relations,child_checkStructRelation110);
	run receiver(child_checkStructRelation110)
stop_process:skip
}

proctype checkStructRelation11(int var_relations;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
