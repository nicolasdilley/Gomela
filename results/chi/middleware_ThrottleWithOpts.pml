#define opts_Limit  5
#define opts_Limit + opts_BacklogLimit  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example955652139/middleware/throttle.go
typedef Chandef {
	chan sync = [0] of {int};
