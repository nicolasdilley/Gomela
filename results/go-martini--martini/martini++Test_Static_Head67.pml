...
// git_link=https://github.com/go-martini/martini/blob//static_test.go#L67
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_Test_Static_Head670 = [1] of {int};
	run Test_Static_Head67(child_Test_Static_Head670);
	run receiver(child_Test_Static_Head670)
stop_process:skip
}

proctype Test_Static_Head67(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
