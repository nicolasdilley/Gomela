...
// git_link=https://github.com/go-martini/martini/blob//static_test.go#L89
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_Test_Static_As_Post890 = [1] of {int};
	run Test_Static_As_Post89(child_Test_Static_As_Post890);
	run receiver(child_Test_Static_As_Post890)
stop_process:skip
}

proctype Test_Static_As_Post89(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
