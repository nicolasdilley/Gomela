...
// git_link=https://github.com/go-martini/martini/blob//martini_test.go#L39
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_Test_Martini_ServeHTTP390 = [1] of {int};
	run Test_Martini_ServeHTTP39(child_Test_Martini_ServeHTTP390);
	run receiver(child_Test_Martini_ServeHTTP390)
stop_process:skip
}

proctype Test_Martini_ServeHTTP39(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
