...
// git_link=https://github.com/go-martini/martini/blob//static_test.go#L40
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_Test_Static_Local_Path400 = [1] of {int};
	run Test_Static_Local_Path40(child_Test_Static_Local_Path400);
	run receiver(child_Test_Static_Local_Path400)
stop_process:skip
}

proctype Test_Static_Local_Path40(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
