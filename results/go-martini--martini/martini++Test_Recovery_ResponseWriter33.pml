...
// git_link=https://github.com/go-martini/martini/blob//recovery_test.go#L33
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_Test_Recovery_ResponseWriter330 = [1] of {int};
	run Test_Recovery_ResponseWriter33(child_Test_Recovery_ResponseWriter330);
	run receiver(child_Test_Recovery_ResponseWriter330)
stop_process:skip
}

proctype Test_Recovery_ResponseWriter33(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
