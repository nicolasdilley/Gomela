...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example885432928/diff/fd/gradient.go
typedef Chandef {
		...
		:: true -> 
			...
			:: else -> 
				...
				:: true -> 
					...
					for31_end378379: skip
				:: true -> 
					break
				od;
				for31_exit378379: skip
			fi;
			for30_end379: skip
		:: true -> 
			break
