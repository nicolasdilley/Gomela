...
#define laplacianConcurrent_nWorkers  3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example291430900/diff/fd/laplacian.go
typedef Chandef {
	chan sync = [0] of {int};
	...
	:: 0 != -2 && n-1 != -3 -> 
			...
			:: else -> 
				...
				:: true -> 
					...
					for21_end14571458: skip
				:: true -> 
					break
				od;
				for21_exit14571458: skip
			fi;
			for20_end1458: skip
		};
		for20_exit1458: skip
