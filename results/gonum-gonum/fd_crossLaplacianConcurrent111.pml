...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example885432928/diff/fd/crosslaplacian.go
typedef Chandef {
			...
			:: stencil-1 != -3 -> 
					...
					:: else -> 
						...
						:: true -> 
							...
							for22_end373375: skip
						:: true -> 
							break
						od;
						for22_exit373375: skip
					fi;
					for21_end375: skip
				};
				for21_exit375: skip
			:: else -> 
				...
				:: true -> 
					...
					:: stencil-1 != -3 -> 
							...
							for22_end374375: skip
						};
						for22_exit374375: skip
					:: else -> 
						do
						:: true -> 
							for22373374375: skip;
							...
							for22_end373374375: skip
						:: true -> 
							break
						od;
						for22_exit373374375: skip
					fi;
					for21_end374375: skip
				:: true -> 
					break
				od;
				for21_exit374375: skip
			fi;
			for20_end375: skip
		};
		for20_exit375: skip
				...
				:: true -> 
					...
					:: else -> 
						...
						:: true -> 
							...
							for22_end373374: skip
						:: true -> 
							break
						od;
						for22_exit373374: skip
					fi;
					for21_end374: skip
				:: true -> 
					break
