...
// git_link=https://github.com/hashicorp/consul/blob//command/operator/raft/listpeers/operator_raft_list.go#L34
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Run34(chan child) {
	...
	run raftListPeers61(client_config_Transport_altMu,client_config_Transport_connsPerHostMu,client_config_Transport_idleMu,client_config_Transport_nextProtoOnce_m,client_config_Transport_reqMu,client_config_Transport_TLSClientConfig_mutex,client_modifyLock,child_raftListPeers610);
