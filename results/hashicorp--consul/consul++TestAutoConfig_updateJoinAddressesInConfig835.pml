...
// git_link=https://github.com/hashicorp/consul/blob//agent/consul/auto_config_endpoint_test.go#L835
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestAutoConfig_updateJoinAddressesInConfig8350)
stop_process:skip
}
...
proctype TestAutoConfig_updateJoinAddressesInConfig835(chan child) {
	...
	run updateJoinAddressesInConfig229(ac_config_SerfLANConfig_Logger_mu,ac_config_SerfWANConfig_Logger_mu,child_updateJoinAddressesInConfig2290);
	child_updateJoinAddressesInConfig2290?0;
	stop_process: skip;
	child!0
}
proctype updateJoinAddressesInConfig229(Mutexdef ac_config_SerfLANConfig_Logger_mu;Mutexdef ac_config_SerfWANConfig_Logger_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
