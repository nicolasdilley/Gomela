...
// https://github.com/hashicorp/consul/blob/master/agent/rpc/subscribe/subscribe_test.go#L585
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestServer_Subscribe_IntegrationWithBackend_FilterEventsByACLToken585(chan child) {
	...
	run NewStateChangeSubscriptionClient618(conn_csMgr_mu,conn_blockingpicker_mu,conn_blockingpicker_connErrMu,conn_mu,conn_resolverWrapper_resolverMu,conn_resolverWrapper_done_o_m,conn_resolverWrapper_pollingMu,conn_balancerWrapper_balancerMu,conn_balancerWrapper_scBuffer_mu,conn_balancerWrapper_done_o_m,conn_balancerWrapper_mu,conn_firstResolveEvent_o_m,child_NewStateChangeSubscriptionClient6181);
