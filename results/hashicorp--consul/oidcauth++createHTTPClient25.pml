...
// https://github.com/hashicorp/consul/blob/master/internal/go-sso/oidcauth/oidcjwt.go#L25
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_createHTTPClient250 = [1] of {int};
	run createHTTPClient25(child_createHTTPClient250)
stop_process:skip
}

proctype createHTTPClient25(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
