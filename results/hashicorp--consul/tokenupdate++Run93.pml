...
// git_link=https://github.com/hashicorp/consul/blob//command/acl/token/update/token_update.go#L93
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Run93(chan child) {
	...
	int var_t_NodeIdentities = -2; // opt var_t_NodeIdentities
	int var_parsedNodeIdents = -2; // opt var_parsedNodeIdents
	int var_t_ServiceIdentities = -2; // opt var_t_ServiceIdentities
	int var_parsedServiceIdents = -2; // opt var_parsedServiceIdents
	int var_c_roleIDs = -2; // opt var_c_roleIDs
	int var_t_Roles = -2; // opt var_t_Roles
	int var_c_roleNames = -2; // opt var_c_roleNames
	int var_c_policyIDs = -2; // opt var_c_policyIDs
	int var_t_Policies = -2; // opt var_t_Policies
	int var_c_policyNames = -2; // opt var_c_policyNames
