...
// https://github.com/hashicorp/consul/blob/master/command/acl/policy/create/policy_create.go#L96
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Run96(chan child) {
	...
	run getRules73(client_modifyLock,client_config_Transport_idleMu,client_config_Transport_reqMu,client_config_Transport_altMu,client_config_Transport_connsPerHostMu,client_config_Transport_TLSClientConfig_mutex,client_config_Transport_nextProtoOnce_m,child_getRules730);
	child_getRules730?0;
