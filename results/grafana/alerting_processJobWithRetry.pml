#define setting_AlertingMaxAttempts * 2  5
#define lb_for125_1  -1
#define ub_for125_2  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example527390399/pkg/services/alerting/engine.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10:		do
		:: true -> 
			...
			:: true -> 
				...
				run eendJob(cancelChan,cancelChan,child_eendJob0);
				child_eendJob0?0;
				goto stop_process
...
proctype eendJob(Chandef cancelChan;int cancelChan;chan child) {
	bool closed; 
	int i;
