...
// git_link=https://github.com/golang/go/blob//io/pipe_test.go#L287
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestWriteAfterWriterClose287(chan child) {
	...
	run AnonymousTestWriteAfterWriterClose292290(done_ch,r_p_wrMu,r_p_once_m,w_p_wrMu,w_p_once_m,child_AnonymousTestWriteAfterWriterClose2922900);
...
proctype AnonymousTestWriteAfterWriterClose292290(Chandef done_ch;Mutexdef r_p_wrMu;Mutexdef r_p_once_m;Mutexdef w_p_wrMu;Mutexdef w_p_once_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
