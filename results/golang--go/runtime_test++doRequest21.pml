...
// git_link=https://github.com/golang/go/blob//runtime/chanbarrier_test.go#L21
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype doRequest21(chan child) {
	...
	:: true -> 
		run AnonymousdoRequest3726(ch_ch,done_ch,child_AnonymousdoRequest37261);
...
proctype AnonymousdoRequest3726(Chandef ch_ch;Chandef done_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
