...
// git_link=https://github.com/golang/go/blob//net/sendfile_test.go#L100
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestSendfileParts100(chan child) {
	...
	run AnonymousTestSendfileParts108108(errc_ch,child_AnonymousTestSendfileParts1081080);
...
proctype AnonymousTestSendfileParts108108(Chandef errc_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run AnonymousAnonymousTestSendfileParts108117107(errc_ch,child_AnonymousAnonymousTestSendfileParts1081171070);
	run receiver(child_AnonymousAnonymousTestSendfileParts1081171070);
	stop_process: skip;
	child!0
}
proctype AnonymousAnonymousTestSendfileParts108117107(Chandef errc_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
