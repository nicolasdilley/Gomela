...
// git_link=https://github.com/golang/go/blob//crypto/tls/tls_test.go#L1170
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype BuildNameToCertificate1278(Mutexdef c_mutex;chan child) {
	...
	bool state;
	int num_msgs;
	int var_x509Cert_DNSNames = -2; // opt var_x509Cert_DNSNames
	int var_c_Certificates = -2; // opt var_c_Certificates
	stop_process: skip;
	child!0
}
