...
// git_link=https://github.com/golang/go/blob//runtime/trace/trace_stack_test.go#L26
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestTraceSymbolize26(chan child) {
	...
	chan child_AnonymousTestTraceSymbolize88516 = [1] of {int};
	...
	Chandef done1_ch;
	int var_ev_Stk = -2; // opt var_ev_Stk
	...
	run mutexMonitor(mu);
	mu.Lock!false;
	run AnonymousTestTraceSymbolize6951(done1_ch,done2_ch,c1_ch,c2_ch,mu,child_AnonymousTestTraceSymbolize69513);
	run receiver(child_AnonymousTestTraceSymbolize69513);
	run wgMonitor(wg);
	wg.update!1;
	run AnonymousTestTraceSymbolize7551(done1_ch,done2_ch,c1_ch,c2_ch,wg,mu,child_AnonymousTestTraceSymbolize75514);
	...
	run AnonymousTestTraceSymbolize8851(done1_ch,done2_ch,c1_ch,c2_ch,wg,mu,child_AnonymousTestTraceSymbolize88516);
	run receiver(child_AnonymousTestTraceSymbolize88516);
...
proctype AnonymousTestTraceSymbolize6951(Chandef done1_ch;Chandef done2_ch;Chandef c1_ch;Chandef c2_ch;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestTraceSymbolize7551(Chandef done1_ch;Chandef done2_ch;Chandef c1_ch;Chandef c2_ch;Wgdef wg;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestTraceSymbolize8851(Chandef done1_ch;Chandef done2_ch;Chandef c1_ch;Chandef c2_ch;Wgdef wg;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
