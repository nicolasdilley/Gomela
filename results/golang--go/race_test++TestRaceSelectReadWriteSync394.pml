...
// git_link=https://github.com/golang/go/blob//runtime/race/testdata/chan_test.go#L394
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRaceSelectReadWriteSync394(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousTestRaceSelectReadWriteSync4073972 = [1] of {int};
	...
	run AnonymousTestRaceSelectReadWriteSync407397(c1_ch,c2_ch,c3_ch,done_ch,child_AnonymousTestRaceSelectReadWriteSync4073972);
	run receiver(child_AnonymousTestRaceSelectReadWriteSync4073972);
	do
...
proctype AnonymousTestRaceSelectReadWriteSync407397(Chandef c1_ch;Chandef c2_ch;Chandef c3_ch;Chandef done_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
