...
// git_link=https://github.com/golang/go/blob//sync/cond_test.go#L132
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRace132(chan child) {
	...
	run AnonymousTestRace136135(done_ch,child_AnonymousTestRace1361350);
	run receiver(child_AnonymousTestRace1361350);
	run AnonymousTestRace148135(done_ch,child_AnonymousTestRace1481351);
	run receiver(child_AnonymousTestRace1481351);
	run AnonymousTestRace163135(done_ch,child_AnonymousTestRace1631352);
...
proctype AnonymousTestRace136135(Chandef done_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestRace148135(Chandef done_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestRace163135(Chandef done_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
