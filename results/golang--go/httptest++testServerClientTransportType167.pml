...
// git_link=https://github.com/golang/go/blob//net/http/httptest/server_test.go#L167
typedef Wgdef {
...
init { 
	chan child_testServerClientTransportType1670 = [1] of {int};
	run testServerClientTransportType167(child_testServerClientTransportType1670);
	run receiver(child_testServerClientTransportType1670)
stop_process:skip
}

proctype testServerClientTransportType167(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Client300(ts_wg,ts_Config_ErrorLog_mu,ts_Config_mu,ts_Config_nextProtoOnce_m,ts_Config_TLSConfig_mutex,ts_mu,ts_TLS_mutex,child_Client3001);
	child_Client3001?0;
...
proctype Client300(Wgdef s_wg;Mutexdef s_Config_ErrorLog_mu;Mutexdef s_Config_mu;Mutexdef s_Config_nextProtoOnce_m;Mutexdef s_Config_TLSConfig_mutex;Mutexdef s_mu;Mutexdef s_TLS_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
