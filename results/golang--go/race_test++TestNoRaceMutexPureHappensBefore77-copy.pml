...
// git_link=https://github.com/golang/go/blob//runtime/race/testdata/mutex_test.go#L77
#define ub_for93_3  -2
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestNoRaceMutexPureHappensBefore77(chan child) {
	...
	run AnonymousTestNoRaceMutexPureHappensBefore8382(ch_ch,mu,child_AnonymousTestNoRaceMutexPureHappensBefore83820);
	run receiver(child_AnonymousTestNoRaceMutexPureHappensBefore83820);
	run AnonymousTestNoRaceMutexPureHappensBefore9082(ch_ch,mu,child_AnonymousTestNoRaceMutexPureHappensBefore90821);
...
proctype AnonymousTestNoRaceMutexPureHappensBefore8382(Chandef ch_ch;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestNoRaceMutexPureHappensBefore9082(Chandef ch_ch;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
