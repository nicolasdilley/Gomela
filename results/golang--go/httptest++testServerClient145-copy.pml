...
// git_link=https://github.com/golang/go/blob//net/http/httptest/server_test.go#L145
typedef Wgdef {
...
init { 
	chan child_testServerClient1450 = [1] of {int};
	run testServerClient145(child_testServerClient1450);
	run receiver(child_testServerClient1450)
stop_process:skip
}

proctype testServerClient145(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
