...
// git_link=https://github.com/golang/go/blob//os/pipe_test.go#L435
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestFdReadRace435(chan child) {
	...
	run wgMonitor(wg);
	wg.update!1;
	run AnonymousTestFdReadRace448445(c_ch,wg,child_AnonymousTestFdReadRace4484450);
	run receiver(child_AnonymousTestFdReadRace4484450);
	wg.update!1;
	run AnonymousTestFdReadRace459445(c_ch,wg,child_AnonymousTestFdReadRace4594451);
	run receiver(child_AnonymousTestFdReadRace4594451);
	wg.wait?0;
	stop_process: skip;
	child!0
}
proctype AnonymousTestFdReadRace448445(Chandef c_ch;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestFdReadRace459445(Chandef c_ch;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
