...
// git_link=https://github.com/golang/go/blob//runtime/rwmutex_test.go#L29
#define def_var_numReaders  ?? // mand numReaders line 29
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run doTestParallelReaders29(def_var_numReaders,child_doTestParallelReaders290);
	run receiver(child_doTestParallelReaders290)
stop_process:skip
}

proctype doTestParallelReaders29(int var_numReaders;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
