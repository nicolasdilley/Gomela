...
// git_link=https://github.com/golang/go/blob//runtime/stack_test.go#L81
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype AnonymousTestStackGrowth11893(Wgdef wg;chan child) {
	...
	run AnonymousAnonymousTestStackGrowth118123120(done_ch,wg,child_AnonymousAnonymousTestStackGrowth1181231202);
...
proctype AnonymousAnonymousTestStackGrowth118123120(Chandef done_ch;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
