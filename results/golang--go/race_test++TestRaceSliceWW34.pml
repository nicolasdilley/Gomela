...
// git_link=https://github.com/golang/go/blob//runtime/race/testdata/slice_test.go#L34
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRaceSliceWW34(chan child) {
	...
	run AnonymousTestRaceSliceWW3736(ch_ch,child_AnonymousTestRaceSliceWW37360);
...
proctype AnonymousTestRaceSliceWW3736(Chandef ch_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
