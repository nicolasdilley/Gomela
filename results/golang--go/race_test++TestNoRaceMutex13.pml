...
// git_link=https://github.com/golang/go/blob//runtime/race/testdata/mutex_test.go#L13
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestNoRaceMutex13(chan child) {
	...
	run AnonymousTestNoRaceMutex1817(ch_ch,mu,child_AnonymousTestNoRaceMutex18170);
	run receiver(child_AnonymousTestNoRaceMutex18170);
	run AnonymousTestNoRaceMutex2417(ch_ch,mu,child_AnonymousTestNoRaceMutex24171);
...
proctype AnonymousTestNoRaceMutex1817(Chandef ch_ch;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestNoRaceMutex2417(Chandef ch_ch;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
