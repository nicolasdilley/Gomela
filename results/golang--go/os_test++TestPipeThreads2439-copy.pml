...
// git_link=https://github.com/golang/go/blob//os/os_test.go#L2439
#define def_var_threads2462  1 // mand threads line 2462
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestPipeThreads2439(chan child) {
	...
	int var_threads = def_var_threads2462; // mand var_threads
	...
	:: else -> 
		...
		for20: skip;
		run AnonymousTestPipeThreads24802480(cdone_ch,creading_ch,child_AnonymousTestPipeThreads248024800);
...
proctype AnonymousTestPipeThreads24802480(Chandef cdone_ch;Chandef creading_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
