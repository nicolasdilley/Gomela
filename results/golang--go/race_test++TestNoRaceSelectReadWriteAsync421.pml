...
// git_link=https://github.com/golang/go/blob//runtime/race/testdata/chan_test.go#L421
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestNoRaceSelectReadWriteAsync421(chan child) {
	...
	run AnonymousTestNoRaceSelectReadWriteAsync426424(c1_ch,c2_ch,done_ch,child_AnonymousTestNoRaceSelectReadWriteAsync4264240);
...
proctype AnonymousTestNoRaceSelectReadWriteAsync426424(Chandef c1_ch;Chandef c2_ch;Chandef done_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
