...
// git_link=https://github.com/golang/go/blob//runtime/race/testdata/waitgroup_test.go#L60
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRaceWaitGroupAsMutex60(chan child) {
	...
	run AnonymousTestRaceWaitGroupAsMutex6564(c_ch,wg,child_AnonymousTestRaceWaitGroupAsMutex65640);
	run receiver(child_AnonymousTestRaceWaitGroupAsMutex65640);
	run AnonymousTestRaceWaitGroupAsMutex7364(c_ch,wg,child_AnonymousTestRaceWaitGroupAsMutex73641);
...
proctype AnonymousTestRaceWaitGroupAsMutex6564(Chandef c_ch;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestRaceWaitGroupAsMutex7364(Chandef c_ch;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
