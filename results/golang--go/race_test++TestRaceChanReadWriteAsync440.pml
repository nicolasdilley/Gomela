...
// git_link=https://github.com/golang/go/blob//runtime/race/testdata/chan_test.go#L440
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRaceChanReadWriteAsync440(chan child) {
	...
	run AnonymousTestRaceChanReadWriteAsync446442(c1_ch,c2_ch,done_ch,child_AnonymousTestRaceChanReadWriteAsync4464420);
...
proctype AnonymousTestRaceChanReadWriteAsync446442(Chandef c1_ch;Chandef c2_ch;Chandef done_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
