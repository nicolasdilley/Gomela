...
// git_link=https://github.com/golang/go/blob//runtime/race/testdata/select_test.go#L250
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRaceSelect5250(chan child) {
	...
	run AnonymousTestRaceSelect5255251(done_ch,c1_ch,c2_ch,child_AnonymousTestRaceSelect52552510);
...
proctype AnonymousTestRaceSelect5255251(Chandef done_ch;Chandef c1_ch;Chandef c2_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
