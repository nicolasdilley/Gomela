...
// git_link=https://github.com/grpc/grpc-go/blob//server_test.go#L124
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestStreamContext124(chan child) {
	...
	run NewContextWithServerTransportStream1585(expectedStream_buf_mu,expectedStream_ct_bdpEst_mu,expectedStream_ct_controlBuf_mu,expectedStream_ct_loopy_bdpEst_mu,expectedStream_ct_loopy_cbuf_mu,expectedStream_ct_mu,expectedStream_fc_mu,expectedStream_hdrMu,child_NewContextWithServerTransportStream15850);
...
proctype NewContextWithServerTransportStream1585(Mutexdef stream_buf_mu;Mutexdef stream_ct_bdpEst_mu;Mutexdef stream_ct_controlBuf_mu;Mutexdef stream_ct_loopy_bdpEst_mu;Mutexdef stream_ct_loopy_cbuf_mu;Mutexdef stream_ct_mu;Mutexdef stream_fc_mu;Mutexdef stream_hdrMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
