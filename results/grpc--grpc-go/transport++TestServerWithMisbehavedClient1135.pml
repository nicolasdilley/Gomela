...
// git_link=https://github.com/grpc/grpc-go/blob//internal/transport/transport_test.go#L1135
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestServerWithMisbehavedClient1135(chan child) {
	...
	run mutexMonitor(mu);
	run AnonymousTestServerWithMisbehavedClient11571151(success_ch,server_mu,server_h_t_controlBuf_mu,server_h_t_bdpEst_mu,server_h_t_mu,mu,child_AnonymousTestServerWithMisbehavedClient115711511);
...
proctype AnonymousTestServerWithMisbehavedClient11571151(Chandef success_ch;Mutexdef server_mu;Mutexdef server_h_t_controlBuf_mu;Mutexdef server_h_t_bdpEst_mu;Mutexdef server_h_t_mu;Mutexdef mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
