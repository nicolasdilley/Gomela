...
// git_link=https://github.com/grpc/grpc-go/blob//xds/internal/balancer/cdsbalancer/cdsbalancer_test.go#L547
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestUpdateSubConnState5470)
stop_process:skip
}
...
proctype TestUpdateSubConnState547(chan child) {
	...
	run UpdateSubConnState485(cdsB_ccw_xdsHI_mu,cdsB_closed_o_m,cdsB_updateCh_mu,cdsB_xdsHI_mu,child_UpdateSubConnState4852);
