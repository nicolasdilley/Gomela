...
// git_link=https://github.com/grpc/grpc-go/blob//benchmark/benchmark.go#L105
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_UnconstrainedStreamingCall1050)
stop_process:skip
}
...
proctype UnconstrainedStreamingCall105(chan child) {
	...
	run receiver(child_AnonymousUnconstrainedStreamingCall1221061);
	...
	run receiver(child_AnonymousUnconstrainedStreamingCall1361062);
	goto stop_process;
	stop_process: skip;
	child!0
}
