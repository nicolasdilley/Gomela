...
// git_link=https://github.com/grpc/grpc-go/blob//interop/test_utils.go#L398
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_DoGoogleDefaultCredentials3980 = [1] of {int};
	run DoGoogleDefaultCredentials398(child_DoGoogleDefaultCredentials3980);
	run receiver(child_DoGoogleDefaultCredentials3980)
stop_process:skip
}

proctype DoGoogleDefaultCredentials398(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
