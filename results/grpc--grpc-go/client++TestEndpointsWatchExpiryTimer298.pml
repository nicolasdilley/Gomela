...
// git_link=https://github.com/grpc/grpc-go/blob//xds/internal/client/watchers_endpoints_test.go#L298
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestEndpointsWatchExpiryTimer2980)
stop_process:skip
}
...
proctype TestEndpointsWatchExpiryTimer298(chan child) {
	...
	run WatchEndpoints287(client_cc_balancerWrapper_balancerMu,client_cc_balancerWrapper_mu,client_cc_balancerWrapper_scBuffer_mu,client_cc_blockingpicker_mu,client_cc_csMgr_mu,client_cc_firstResolveEvent_o_m,client_cc_lceMu,client_cc_mu,client_cc_resolverWrapper_pollingMu,client_cc_resolverWrapper_resolverMu,client_cc_safeConfigSelector_mu,client_done_o_m,client_lrsMu,client_mu,client_updateCh_mu,child_WatchEndpoints2871);
...
proctype WatchEndpoints287(Mutexdef c_cc_balancerWrapper_balancerMu;Mutexdef c_cc_balancerWrapper_mu;Mutexdef c_cc_balancerWrapper_scBuffer_mu;Mutexdef c_cc_blockingpicker_mu;Mutexdef c_cc_csMgr_mu;Mutexdef c_cc_firstResolveEvent_o_m;Mutexdef c_cc_lceMu;Mutexdef c_cc_mu;Mutexdef c_cc_resolverWrapper_pollingMu;Mutexdef c_cc_resolverWrapper_resolverMu;Mutexdef c_cc_safeConfigSelector_mu;Mutexdef c_done_o_m;Mutexdef c_lrsMu;Mutexdef c_mu;Mutexdef c_updateCh_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
