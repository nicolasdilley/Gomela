...
// git_link=https://github.com/grpc/grpc-go/blob//xds/internal/balancer/cdsbalancer/cdsbalancer_test.go#L618
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestClose618(chan child) {
	...
	run Close494(cdsB_ccw_xdsHI_mu,cdsB_closed_o_m,cdsB_updateCh_mu,cdsB_xdsHI_mu,child_Close4941);
	child_Close4941?0;
	...
	run InvokeWatchClusterCallback145(xdsC_loadStore_mu,cdsUpdate_Raw_state_atomicMessageInfo_initMu,child_InvokeWatchClusterCallback1453);
	child_InvokeWatchClusterCallback1453?0;
	run UpdateClientConnState452(cdsB_ccw_xdsHI_mu,cdsB_closed_o_m,cdsB_updateCh_mu,cdsB_xdsHI_mu,child_UpdateClientConnState4524);
	child_UpdateClientConnState4524?0;
	run UpdateSubConnState485(cdsB_ccw_xdsHI_mu,cdsB_closed_o_m,cdsB_updateCh_mu,cdsB_xdsHI_mu,child_UpdateSubConnState4855);
	child_UpdateSubConnState4855?0;
	run ResolverError476(cdsB_ccw_xdsHI_mu,cdsB_closed_o_m,cdsB_updateCh_mu,cdsB_xdsHI_mu,child_ResolverError4766);
...
proctype Close494(Mutexdef b_ccw_xdsHI_mu;Mutexdef b_closed_o_m;Mutexdef b_updateCh_mu;Mutexdef b_xdsHI_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype UpdateClientConnState452(Mutexdef b_ccw_xdsHI_mu;Mutexdef b_closed_o_m;Mutexdef b_updateCh_mu;Mutexdef b_xdsHI_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype UpdateSubConnState485(Mutexdef b_ccw_xdsHI_mu;Mutexdef b_closed_o_m;Mutexdef b_updateCh_mu;Mutexdef b_xdsHI_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype ResolverError476(Mutexdef b_ccw_xdsHI_mu;Mutexdef b_closed_o_m;Mutexdef b_updateCh_mu;Mutexdef b_xdsHI_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
