...
// git_link=https://github.com/grpc/grpc-go/blob//xds/internal/client/load/store_test.go#L45
#define def_var_drops63  ?? // mand drops line 63
#define def_var_count64  ?? // mand count line 64
typedef Wgdef {
...
proctype TestDrops45(chan child) {
	...
	int var_count = def_var_count64; // mand var_count
	int var_drops = def_var_drops63; // mand var_drops
