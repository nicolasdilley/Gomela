...
// git_link=https://github.com/grpc/grpc-go/blob//balancer/rls/internal/client_test.go#L95
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestLookupDeadlineExceeded95(chan child) {
	...
	run newRLSClient55(cc_balancerWrapper_balancerMu,cc_balancerWrapper_done_o_m,cc_balancerWrapper_mu,cc_balancerWrapper_scBuffer_mu,cc_blockingpicker_mu,cc_csMgr_mu,cc_firstResolveEvent_o_m,cc_lceMu,cc_mu,cc_resolverWrapper_done_o_m,cc_resolverWrapper_pollingMu,cc_resolverWrapper_resolverMu,cc_safeConfigSelector_mu,child_newRLSClient550);
	child_newRLSClient550?0;
	stop_process: skip;
	child!0
}
proctype newRLSClient55(Mutexdef cc_balancerWrapper_balancerMu;Mutexdef cc_balancerWrapper_done_o_m;Mutexdef cc_balancerWrapper_mu;Mutexdef cc_balancerWrapper_scBuffer_mu;Mutexdef cc_blockingpicker_mu;Mutexdef cc_csMgr_mu;Mutexdef cc_firstResolveEvent_o_m;Mutexdef cc_lceMu;Mutexdef cc_mu;Mutexdef cc_resolverWrapper_done_o_m;Mutexdef cc_resolverWrapper_pollingMu;Mutexdef cc_resolverWrapper_resolverMu;Mutexdef cc_safeConfigSelector_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
