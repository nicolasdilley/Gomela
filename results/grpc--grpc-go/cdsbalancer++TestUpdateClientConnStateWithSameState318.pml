...
// git_link=https://github.com/grpc/grpc-go/blob//xds/internal/balancer/cdsbalancer/cdsbalancer_test.go#L318
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestUpdateClientConnStateWithSameState318(chan child) {
	...
	run UpdateClientConnState452(cdsB_ccw_xdsHI_mu,cdsB_closed_o_m,cdsB_updateCh_mu,cdsB_xdsHI_mu,child_UpdateClientConnState4521);
