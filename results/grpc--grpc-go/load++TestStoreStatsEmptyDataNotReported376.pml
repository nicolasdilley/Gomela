...
// git_link=https://github.com/grpc/grpc-go/blob//xds/internal/client/load/store_test.go#L376
#define def_var_nil  -2 // opt clusterNames line 63
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestStoreStatsEmptyDataNotReported376(chan child) {
	...
	run Stats63(store_mu,var_nil,child_Stats630);
	child_Stats630?0;
	run Stats63(store_mu,var_nil,child_Stats631);
	child_Stats631?0;
	stop_process: skip;
	child!0
}
