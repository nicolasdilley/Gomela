...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example776515020/website/pk-web/pkweb.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run Anonymous1(emailErr,httpsErr);
	do
...
proctype Anonymous1(Chandef emailErr;Chandef httpsErr) {
	bool closed; 
	int i;
	bool state;
