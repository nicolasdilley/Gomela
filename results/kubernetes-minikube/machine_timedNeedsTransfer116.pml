...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example986923479/pkg/minikube/machine/cache_images.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run go_Anonymous0(timeout,transferFinished);
	do
...
proctype go_Anonymous0(Chandef timeout;Chandef transferFinished) {
	bool closed; 
	int i;
	bool state;
