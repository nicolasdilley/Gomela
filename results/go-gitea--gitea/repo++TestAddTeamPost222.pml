...
// https://github.com/go-gitea/gitea/blob/master/routers/repo/settings_test.go#L222
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestAddTeamPost2220 = [1] of {int};
	run TestAddTeamPost222(child_TestAddTeamPost2220)
stop_process:skip
}

proctype TestAddTeamPost222(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
