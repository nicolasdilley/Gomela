...
// https://github.com/go-gitea/gitea/blob/master/routers/repo/settings_test.go#L262
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestAddTeamPost_NotAllowed2620 = [1] of {int};
	run TestAddTeamPost_NotAllowed262(child_TestAddTeamPost_NotAllowed2620)
stop_process:skip
}

proctype TestAddTeamPost_NotAllowed262(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
