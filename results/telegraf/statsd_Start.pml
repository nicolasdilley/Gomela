#define s_AllowedPendingMessages  5
#define s_MaxTCPConnections  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example628089191/plugins/inputs/statsd/statsd.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Chandef s_done;
	int i;
	int s_MaxTCPConnections = 5;
	Chandef s_in;
	Chandef s_accept;
	int parserGoRoutines = 5;
	bool state = false;
