#define t_AllowedPendingMessages  5
#define t_MaxTCPConnections  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example628089191/plugins/inputs/tcp_listener/tcp_listener.go
typedef Chandef {
	chan sync = [0] of {int};
