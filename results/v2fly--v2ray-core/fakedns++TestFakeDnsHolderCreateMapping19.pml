...
// git_link=https://github.com/v2fly/v2ray-core/blob//app/dns/fakedns/fakedns_test.go#L19
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFakeDnsHolderCreateMapping190 = [1] of {int};
	run TestFakeDnsHolderCreateMapping19(child_TestFakeDnsHolderCreateMapping190);
	run receiver(child_TestFakeDnsHolderCreateMapping190)
stop_process:skip
}

proctype TestFakeDnsHolderCreateMapping19(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
