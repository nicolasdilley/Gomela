...
// git_link=https://github.com/cli/cli/blob//pkg/cmd/repo/clone/clone_test.go#L97
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype runCloneCommand97(chan child) {
	...
	run NewCmdClone28(fac_IOStreams_pagerProcess_sigMu,fac_IOStreams_progressIndicator_mu,child_NewCmdClone280);
...
proctype NewCmdClone28(Mutexdef f_IOStreams_pagerProcess_sigMu;Mutexdef f_IOStreams_progressIndicator_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
