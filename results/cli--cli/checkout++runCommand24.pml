...
// git_link=https://github.com/cli/cli/blob//pkg/cmd/pr/checkout/checkout_test.go#L24
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_runCommand240)
stop_process:skip
}
...
proctype runCommand24(chan child) {
	...
	run NewCmdCheckout37(factory_IOStreams_pagerProcess_sigMu,factory_IOStreams_progressIndicator_mu,child_NewCmdCheckout370);
