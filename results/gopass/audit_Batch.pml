...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example631289172/internal/audit/audit.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: else -> 
		...
		for(i : 0.. maxJobs-1) {
for10:		run go_auditaudit(pending,checked,done,pending)
	};
...
proctype go_auditaudit(Chandef secrets;Chandef checked;Chandef done;int secrets) {
	bool closed; 
	int i;
	do
