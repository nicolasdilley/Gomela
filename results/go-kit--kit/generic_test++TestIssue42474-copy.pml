...
// git_link=https://github.com/go-kit/kit/blob//metrics/generic/generic_test.go#L74
#define def_var_concurrency82  1 // mand concurrency line 82
typedef Wgdef {
...
proctype TestIssue42474(chan child) {
	...
	Wgdef wg;
	int var_concurrency = def_var_concurrency82; // mand var_concurrency
	run wgMonitor(wg);
...
proctype AnonymousTestIssue4248479(Wgdef wg;chan child) {
	...
	bool state;
	int num_msgs;
	int var_operations = -2; // opt var_operations
		defer1: skip;
	wg.update!-1;
	stop_process: skip;
	child!0
