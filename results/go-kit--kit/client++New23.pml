...
// git_link=https://github.com/go-kit/kit/blob//examples/profilesvc/client/client.go#L23
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype New23(chan child) {
	...
	run NewClient25(apiclient_config_Transport_altMu,apiclient_config_Transport_connsPerHostMu,apiclient_config_Transport_idleMu,apiclient_config_Transport_nextProtoOnce_m,apiclient_config_Transport_reqMu,apiclient_config_Transport_TLSClientConfig_mutex,child_NewClient250);
	child_NewClient250?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype NewClient25(Mutexdef c_config_Transport_altMu;Mutexdef c_config_Transport_connsPerHostMu;Mutexdef c_config_Transport_idleMu;Mutexdef c_config_Transport_nextProtoOnce_m;Mutexdef c_config_Transport_reqMu;Mutexdef c_config_Transport_TLSClientConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
