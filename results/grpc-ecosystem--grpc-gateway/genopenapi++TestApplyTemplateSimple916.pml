...
// git_link=https://github.com/grpc-ecosystem/grpc-gateway/blob//protoc-gen-openapiv2/internal/genopenapi/template_test.go#L916
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestApplyTemplateSimple9160 = [1] of {int};
	run TestApplyTemplateSimple916(child_TestApplyTemplateSimple9160);
	run receiver(child_TestApplyTemplateSimple9160)
stop_process:skip
}

proctype TestApplyTemplateSimple916(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
