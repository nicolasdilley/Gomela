...
// git_link=https://github.com/grpc-ecosystem/grpc-gateway/blob//protoc-gen-grpc-gateway/internal/gengateway/generator_test.go#L11
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_newExampleFileDescriptorWithGoPkg110 = [1] of {int};
	run newExampleFileDescriptorWithGoPkg11(child_newExampleFileDescriptorWithGoPkg110);
	run receiver(child_newExampleFileDescriptorWithGoPkg110)
stop_process:skip
}

proctype newExampleFileDescriptorWithGoPkg11(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
