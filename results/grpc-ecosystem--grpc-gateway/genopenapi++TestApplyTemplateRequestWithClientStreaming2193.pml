...
// git_link=https://github.com/grpc-ecosystem/grpc-gateway/blob//protoc-gen-openapiv2/internal/genopenapi/template_test.go#L2193
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestApplyTemplateRequestWithClientStreaming21930 = [1] of {int};
	run TestApplyTemplateRequestWithClientStreaming2193(child_TestApplyTemplateRequestWithClientStreaming21930);
	run receiver(child_TestApplyTemplateRequestWithClientStreaming21930)
stop_process:skip
}

proctype TestApplyTemplateRequestWithClientStreaming2193(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
