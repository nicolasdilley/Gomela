...
// git_link=https://github.com/grpc-ecosystem/grpc-gateway/blob//protoc-gen-openapiv2/internal/genopenapi/template_test.go#L2026
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestApplyTemplateRequestWithoutClientStreaming20260 = [1] of {int};
	run TestApplyTemplateRequestWithoutClientStreaming2026(child_TestApplyTemplateRequestWithoutClientStreaming20260);
	run receiver(child_TestApplyTemplateRequestWithoutClientStreaming20260)
stop_process:skip
}

proctype TestApplyTemplateRequestWithoutClientStreaming2026(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
