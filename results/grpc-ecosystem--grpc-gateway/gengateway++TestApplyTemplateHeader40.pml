...
// git_link=https://github.com/grpc-ecosystem/grpc-gateway/blob//protoc-gen-grpc-gateway/internal/gengateway/template_test.go#L40
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestApplyTemplateHeader400 = [1] of {int};
	run TestApplyTemplateHeader40(child_TestApplyTemplateHeader400);
	run receiver(child_TestApplyTemplateHeader400)
stop_process:skip
}

proctype TestApplyTemplateHeader40(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
