...
// git_link=https://github.com/grpc-ecosystem/grpc-gateway/blob//examples/internal/integration/integration_test.go#L458
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_testABECreateBody4580 = [1] of {int};
	run testABECreateBody458(child_testABECreateBody4580);
	run receiver(child_testABECreateBody4580)
stop_process:skip
}

proctype testABECreateBody458(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
