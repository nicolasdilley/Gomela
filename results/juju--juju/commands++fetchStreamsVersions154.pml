...
// https://github.com/juju/juju/blob/af21dceaf489e65417c11a49921a03bf188480cd/cmd/juju/commands/upgradecontroller.go#L154
typedef Chandef {
...
init { 
	...
	run go_Anonymous0(result,errChan);
	do
	:: true -> 
		goto stop_process
...
proctype go_Anonymous0(Chandef result;Chandef errChan) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
