...
// git_link=https://github.com/kubernetes/minikube/blob//pkg/minikube/service/service_test.go#L827
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestWaitAndMaybeOpenService8270)
stop_process:skip
}
...
proctype TestWaitAndMaybeOpenService827(chan child) {
	...
	int var_test_expected = -2; // opt var_test_expected
