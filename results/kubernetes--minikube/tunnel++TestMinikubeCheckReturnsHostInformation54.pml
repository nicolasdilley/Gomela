...
// git_link=https://github.com/kubernetes/minikube/blob//pkg/minikube/tunnel/cluster_inspector_test.go#L54
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestMinikubeCheckReturnsHostInformation540)
stop_process:skip
}
