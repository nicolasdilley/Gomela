...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example666849052/lib/model/folder_recvenc.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run go_pullScannerRoutine(scanChan);
		for(i : 0.. dirs-1) {
for30:		chan child_deleteDirOnDisk0 = [0] of {int};
