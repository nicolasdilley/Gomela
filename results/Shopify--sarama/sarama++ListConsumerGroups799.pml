...
// https://github.com/Shopify/sarama/blob/ceadf4f6b74eb2ca0b6108fd96778032b0fa404f/admin.go#L799
typedef Chandef {
...
init { 
	...
	:: true -> 
		...
		if
		:: groupMaps.async_rcv?state,num_msgs;
		:: groupMaps.sync?state,num_msgs;
		fi;
