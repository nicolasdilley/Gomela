...
// git_link=https://github.com/mattermost/mattermost-server/blob//model/post_test.go#L121
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype SanitizeProps370(Mutexdef o_propsMu;chan child) {
	...
	int var_o_Participants = -2; // opt var_o_Participants
	int var_membersToSanitize = -2; // opt var_membersToSanitize
