...
// https://github.com/mattermost/mattermost-server/blob/master/model/post_list_test.go#L109
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPostListSortByCreateAt1090 = [1] of {int};
	run TestPostListSortByCreateAt109(child_TestPostListSortByCreateAt1090)
stop_process:skip
}

proctype TestPostListSortByCreateAt109(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
