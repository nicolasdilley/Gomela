...
// https://github.com/mattermost/mattermost-server/blob/caeda90b246b2830ffc29901efce685a08d638fa/store/sqlstore/thread_store.go#L111
typedef Chandef {
...
init { 
	...
	if
	:: threadsChan.async_rcv?state,num_msgs;
	:: threadsChan.sync?state,num_msgs;
	fi;
	...
	if
	:: totalUnreadMentionsChan.async_rcv?state,num_msgs;
	:: totalUnreadMentionsChan.sync?state,num_msgs;
	fi;
	...
	if
	:: totalCountChan.async_rcv?state,num_msgs;
	:: totalCountChan.sync?state,num_msgs;
	fi;
	...
	if
	:: totalUnreadRepliesChan.async_rcv?state,num_msgs;
	:: totalUnreadRepliesChan.sync?state,num_msgs;
	fi;
