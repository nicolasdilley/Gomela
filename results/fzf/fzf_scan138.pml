#define scan_numSlices  ??
#define scan_numChunks  ??
#define scan_slices  ??

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example945873322/src/matcher.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10:		waitGroup.Add!1;
		run Anonymous0(resultChan,countChan,waitGroup)
	};
	do
...
proctype Anonymous0(Chandef resultChan;Chandef countChan;Wgdef waitGroup) {
	bool closed; 
	int i;
	bool state;
	do
