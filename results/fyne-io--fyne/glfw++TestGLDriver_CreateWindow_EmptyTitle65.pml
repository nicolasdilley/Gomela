...
// git_link=https://github.com/fyne-io/fyne/blob//internal/driver/glfw/window_test.go#L65
typedef Wgdef {
...
proctype TestGLDriver_CreateWindow_EmptyTitle65(chan child) {
	...
	run Title100(w_eventWait,w_canvas_dirtyMutex,w_canvas_overlays_propertyLock,w_canvas_shortcut_mu,w_createLock_m,w_driver_animation_animationMutex,w_driver_windowLock,w_eventLock,w_viewLock,child_Title1000);
	child_Title1000?0;
	stop_process: skip;
	child!0
}
proctype Title100(Wgdef w_eventWait;Mutexdef w_canvas_dirtyMutex;Mutexdef w_canvas_overlays_propertyLock;Mutexdef w_canvas_shortcut_mu;Mutexdef w_createLock_m;Mutexdef w_driver_animation_animationMutex;Mutexdef w_driver_windowLock;Mutexdef w_eventLock;Mutexdef w_viewLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
