...
// git_link=https://github.com/rclone/rclone/blob//backend/googlephotos/pattern_test.go#L402
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestPatternMonths402(chan child) {
	...
	run months259(f_albums_mu,f_t_context_match_mu,f_t_context_mu,child_months2590);
	child_months2590?0;
	stop_process: skip;
	child!0
}
proctype months259(Mutexdef f_albums_mu;Mutexdef f_t_context_match_mu;Mutexdef f_t_context_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
