...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example880097464/core/monitor/monitor.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype monitorRevisionPairs(Chandef revisions;Chandef pairs;int revisions;chan child) {
	bool closed; 
	int i;
	do
...
proctype Anonymous1(Chandef errc;Chandef revisions;Chandef pairs) {
	...
	run monitorRevisionPairs(revisions,pairs,revisions,child_monitorRevisionPairs0);
