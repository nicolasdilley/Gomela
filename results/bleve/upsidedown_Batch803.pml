#define Batch_batch_IndexOps  ??
#define lb_for871_1  -1
#define ub_for871_2  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example706356593/index/upsidedown/upsidedown.go
typedef Chandef {
	chan sync = [0] of {int};
...
for20:		
		if
		:: true -> 
			chan child_NewAnalysisWork0 = [0] of {int};
			run NewAnalysisWork(resultChan,child_NewAnalysisWork0);
			child_NewAnalysisWork0?0
		:: true;
		fi
	:: true -> 
		break
