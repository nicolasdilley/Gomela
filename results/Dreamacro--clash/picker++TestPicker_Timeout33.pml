...
// https://github.com/Dreamacro/clash/blob/master/common/picker/picker_test.go#L33
typedef Wgdef {
...
proctype TestPicker_Timeout33(chan child) {
	...
	child_Go610?0;
	run Wait46(picker_wg,picker_once_m,picker_errOnce_m,child_Wait461);
	child_Wait461?0;
	run Error55(picker_wg,picker_once_m,picker_errOnce_m,child_Error552);
	child_Error552?0;
	stop_process: skip;
	child!0
}
...
proctype Error55(Wgdef p_wg;Mutexdef p_once_m;Mutexdef p_errOnce_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
