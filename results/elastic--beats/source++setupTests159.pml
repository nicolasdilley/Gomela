...
// git_link=https://github.com/elastic/beats/blob//x-pack/heartbeat/monitors/browser/source/zipurl_test.go#L159
typedef Wgdef {
...
init { 
	chan child_setupTests1590 = [1] of {int};
	run setupTests159(child_setupTests1590);
	run receiver(child_setupTests1590)
stop_process:skip
}

proctype setupTests159(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
