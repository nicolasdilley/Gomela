...
// git_link=https://github.com/elastic/beats/blob//x-pack/elastic-agent/pkg/agent/operation/operator_test.go#L57
...
init { 
	chan child_TestNotSupported570 = [1] of {int};
	run TestNotSupported57(child_TestNotSupported570);
	run receiver(child_TestNotSupported570)
stop_process:skip
}

proctype TestNotSupported57(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
