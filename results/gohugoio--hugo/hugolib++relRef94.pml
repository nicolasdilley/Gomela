...
// https://github.com/gohugoio/hugo/blob/master/hugolib/page__ref.go#L94
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_relRef940 = [1] of {int};
	run relRef94(child_relRef940)
stop_process:skip
}

proctype relRef94(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
