#define hostCount  5
#define c_Options_HostBufferFactor * hostCount  5
#define c_Options_EnqueueChanBuffer  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example035249479/crawler.go
typedef Chandef {
	chan sync = [0] of {int};
