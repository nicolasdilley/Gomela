...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L666
typedef Wgdef {
...
init { 
	chan child_TestReserveBeginExecuteWithFailingPreQueriesAndCheckConnectionState6660 = [1] of {int};
	run TestReserveBeginExecuteWithFailingPreQueriesAndCheckConnectionState666(child_TestReserveBeginExecuteWithFailingPreQueriesAndCheckConnectionState6660);
	run receiver(child_TestReserveBeginExecuteWithFailingPreQueriesAndCheckConnectionState6660)
stop_process:skip
}

proctype TestReserveBeginExecuteWithFailingPreQueriesAndCheckConnectionState666(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Release3332 = [1] of {int};
	chan child_Commit1011 = [1] of {int};
