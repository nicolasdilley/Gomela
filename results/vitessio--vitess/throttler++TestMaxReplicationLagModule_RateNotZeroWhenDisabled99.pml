...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/throttler/max_replication_lag_module_test.go#L99
typedef Wgdef {
...
init { 
	chan child_TestMaxReplicationLagModule_RateNotZeroWhenDisabled990 = [1] of {int};
	run TestMaxReplicationLagModule_RateNotZeroWhenDisabled99(child_TestMaxReplicationLagModule_RateNotZeroWhenDisabled990);
	run receiver(child_TestMaxReplicationLagModule_RateNotZeroWhenDisabled990)
stop_process:skip
}

proctype TestMaxReplicationLagModule_RateNotZeroWhenDisabled99(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
