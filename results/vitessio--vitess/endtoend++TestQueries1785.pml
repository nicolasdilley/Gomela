...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/queries_test.go#L1785
typedef Wgdef {
...
init { 
	chan child_TestQueries17850 = [1] of {int};
	run TestQueries1785(child_TestQueries17850);
	run receiver(child_TestQueries17850)
stop_process:skip
}

proctype TestQueries1785(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_TestQueryCases = -2; // opt var_TestQueryCases
