...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vtgate/mysql_protocol_test.go#L64
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestMySQLProtocolStreamExecute640 = [1] of {int};
	run TestMySQLProtocolStreamExecute64(child_TestMySQLProtocolStreamExecute640);
	run receiver(child_TestMySQLProtocolStreamExecute640)
stop_process:skip
}

proctype TestMySQLProtocolStreamExecute64(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
