...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/proto/queryservice/queryservice_grpc.pb.go#L1048
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child__Query_VStreamResults_Handler10480 = [1] of {int};
	run _Query_VStreamResults_Handler1048(child__Query_VStreamResults_Handler10480);
	run receiver(child__Query_VStreamResults_Handler10480)
stop_process:skip
}

proctype _Query_VStreamResults_Handler1048(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
