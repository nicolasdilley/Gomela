...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/metadata_test.go#L103
typedef Wgdef {
...
init { 
	chan child_TestMetadataDefaultExecOptions1030 = [1] of {int};
	run TestMetadataDefaultExecOptions103(child_TestMetadataDefaultExecOptions1030);
	run receiver(child_TestMetadataDefaultExecOptions1030)
stop_process:skip
}

proctype TestMetadataDefaultExecOptions103(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_cleanup470 = [1] of {int};
