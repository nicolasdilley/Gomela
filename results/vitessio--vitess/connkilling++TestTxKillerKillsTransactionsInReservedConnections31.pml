...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/connkilling/connkiller_test.go#L31
typedef Wgdef {
...
init { 
	chan child_TestTxKillerKillsTransactionsInReservedConnections310 = [1] of {int};
	run TestTxKillerKillsTransactionsInReservedConnections31(child_TestTxKillerKillsTransactionsInReservedConnections310);
	run receiver(child_TestTxKillerKillsTransactionsInReservedConnections310)
stop_process:skip
}

proctype TestTxKillerKillsTransactionsInReservedConnections31(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Release3330 = [1] of {int};
	chan child_assertIsKilledWithin6Seconds972 = [1] of {int};
	chan child_ReserveBeginExecute3161 = [1] of {int};
