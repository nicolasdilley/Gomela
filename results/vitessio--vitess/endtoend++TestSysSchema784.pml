...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/misc_test.go#L784
typedef Wgdef {
...
init { 
	chan child_TestSysSchema7840 = [1] of {int};
	run TestSysSchema784(child_TestSysSchema7840);
	run receiver(child_TestSysSchema7840)
stop_process:skip
}

proctype TestSysSchema784(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
