...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L55
typedef Wgdef {
...
init { 
	chan child_TestReserveBeginRelease550 = [1] of {int};
	run TestReserveBeginRelease55(child_TestReserveBeginRelease550);
	run receiver(child_TestReserveBeginRelease550)
stop_process:skip
}

proctype TestReserveBeginRelease55(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
