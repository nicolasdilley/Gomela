...
// git_link=https://github.com/vitessio/vitess/blob//go/cache/lru_cache_test.go#L65
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestGetValueWithMultipleTypes650 = [1] of {int};
	run TestGetValueWithMultipleTypes65(child_TestGetValueWithMultipleTypes650);
	run receiver(child_TestGetValueWithMultipleTypes650)
stop_process:skip
}

proctype TestGetValueWithMultipleTypes65(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
