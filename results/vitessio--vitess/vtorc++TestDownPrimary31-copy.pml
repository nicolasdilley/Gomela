...
// git_link=https://github.com/vitessio/vitess/blob//go/test/endtoend/vtorc/primary_failure_test.go#L31
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestDownPrimary310 = [1] of {int};
	run TestDownPrimary31(child_TestDownPrimary310);
	run receiver(child_TestDownPrimary310)
stop_process:skip
}

proctype TestDownPrimary31(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
