...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/misc_test.go#L425
typedef Wgdef {
...
init { 
	chan child_TestQueryStats4250 = [1] of {int};
	run TestQueryStats425(child_TestQueryStats4250);
	run receiver(child_TestQueryStats4250)
stop_process:skip
}

proctype TestQueryStats425(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
