...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/savepoint_test.go#L134
typedef Wgdef {
...
init { 
	chan child_TestSavepointWithoutTransaction1340 = [1] of {int};
	run TestSavepointWithoutTransaction134(child_TestSavepointWithoutTransaction1340);
	run receiver(child_TestSavepointWithoutTransaction1340)
stop_process:skip
}

proctype TestSavepointWithoutTransaction134(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
