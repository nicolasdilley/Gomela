...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/compatibility_test.go#L709
typedef Wgdef {
...
init { 
	chan child_TestDBName7090 = [1] of {int};
	run TestDBName709(child_TestDBName7090);
	run receiver(child_TestDBName7090)
stop_process:skip
}

proctype TestDBName709(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_qr_Fields = -2; // opt var_qr_Fields
