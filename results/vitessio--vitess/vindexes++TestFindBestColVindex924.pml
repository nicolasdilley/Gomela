...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vtgate/vindexes/vschema_test.go#L924
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFindBestColVindex9240 = [1] of {int};
	run TestFindBestColVindex924(child_TestFindBestColVindex9240);
	run receiver(child_TestFindBestColVindex9240)
stop_process:skip
}

proctype TestFindBestColVindex924(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
