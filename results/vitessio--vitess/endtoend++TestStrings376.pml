...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/compatibility_test.go#L376
typedef Wgdef {
...
init { 
	chan child_TestStrings3760 = [1] of {int};
	run TestStrings376(child_TestStrings3760);
	run receiver(child_TestStrings3760)
stop_process:skip
}

proctype TestStrings376(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
