...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/compatibility_test.go#L284
typedef Wgdef {
...
init { 
	chan child_TestFractionals2840 = [1] of {int};
	run TestFractionals284(child_TestFractionals2840);
	run receiver(child_TestFractionals2840)
stop_process:skip
}

proctype TestFractionals284(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
