...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L487
typedef Wgdef {
...
init { 
	chan child_TestReserveBeginExecuteWithFailingQueryAndReserveConnAndTxRemainsOpen4870 = [1] of {int};
	run TestReserveBeginExecuteWithFailingQueryAndReserveConnAndTxRemainsOpen487(child_TestReserveBeginExecuteWithFailingQueryAndReserveConnAndTxRemainsOpen4870);
	run receiver(child_TestReserveBeginExecuteWithFailingQueryAndReserveConnAndTxRemainsOpen4870)
stop_process:skip
}

proctype TestReserveBeginExecuteWithFailingQueryAndReserveConnAndTxRemainsOpen487(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_Rollback1124 = [1] of {int};
