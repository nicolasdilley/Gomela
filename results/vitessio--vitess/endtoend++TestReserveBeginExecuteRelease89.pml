...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L89
typedef Wgdef {
...
init { 
	chan child_TestReserveBeginExecuteRelease890 = [1] of {int};
	run TestReserveBeginExecuteRelease89(child_TestReserveBeginExecuteRelease890);
	run receiver(child_TestReserveBeginExecuteRelease890)
stop_process:skip
}

proctype TestReserveBeginExecuteRelease89(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
