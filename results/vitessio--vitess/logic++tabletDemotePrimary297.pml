...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/orchestrator/logic/tablet_discovery.go#L297
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_tabletDemotePrimary2970 = [1] of {int};
	run tabletDemotePrimary297(child_tabletDemotePrimary2970);
	run receiver(child_tabletDemotePrimary2970)
stop_process:skip
}

proctype tabletDemotePrimary297(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
