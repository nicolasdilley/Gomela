...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/compatibility_test.go#L622
typedef Wgdef {
...
init { 
	chan child_TestNull6220 = [1] of {int};
	run TestNull622(child_TestNull6220);
	run receiver(child_TestNull6220)
stop_process:skip
}

proctype TestNull622(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
