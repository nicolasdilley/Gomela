...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L205
typedef Wgdef {
...
init { 
	chan child_TestReserveBeginCommitFailToReuseTxID2050 = [1] of {int};
	run TestReserveBeginCommitFailToReuseTxID205(child_TestReserveBeginCommitFailToReuseTxID2050);
	run receiver(child_TestReserveBeginCommitFailToReuseTxID2050)
stop_process:skip
}

proctype TestReserveBeginCommitFailToReuseTxID205(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_Commit1013 = [1] of {int};
