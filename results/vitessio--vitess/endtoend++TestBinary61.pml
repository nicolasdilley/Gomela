...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/misc_test.go#L61
typedef Wgdef {
...
init { 
	chan child_TestBinary610 = [1] of {int};
	run TestBinary61(child_TestBinary610);
	run receiver(child_TestBinary610)
stop_process:skip
}

proctype TestBinary61(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
