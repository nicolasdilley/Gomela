...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L651
typedef Wgdef {
...
init { 
	chan child_TestReserveExecuteWithFailingPreQueriesAndCheckConnectionState6510 = [1] of {int};
	run TestReserveExecuteWithFailingPreQueriesAndCheckConnectionState651(child_TestReserveExecuteWithFailingPreQueriesAndCheckConnectionState6510);
	run receiver(child_TestReserveExecuteWithFailingPreQueriesAndCheckConnectionState6510)
stop_process:skip
}

proctype TestReserveExecuteWithFailingPreQueriesAndCheckConnectionState651(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Release3331 = [1] of {int};
	chan child_ReserveExecute3030 = [1] of {int};
