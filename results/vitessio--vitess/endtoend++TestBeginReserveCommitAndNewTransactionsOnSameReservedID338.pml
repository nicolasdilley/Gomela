...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L338
typedef Wgdef {
...
init { 
	chan child_TestBeginReserveCommitAndNewTransactionsOnSameReservedID3380 = [1] of {int};
	run TestBeginReserveCommitAndNewTransactionsOnSameReservedID338(child_TestBeginReserveCommitAndNewTransactionsOnSameReservedID3380);
	run receiver(child_TestBeginReserveCommitAndNewTransactionsOnSameReservedID3380)
stop_process:skip
}

proctype TestBeginReserveCommitAndNewTransactionsOnSameReservedID338(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
