...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/call_test.go#L127
typedef Wgdef {
...
init { 
	chan child_TestCallProcedureLeakTx1270 = [1] of {int};
	run TestCallProcedureLeakTx127(child_TestCallProcedureLeakTx1270);
	run receiver(child_TestCallProcedureLeakTx1270)
stop_process:skip
}

proctype TestCallProcedureLeakTx127(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
