...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/metadata_test.go#L135
typedef Wgdef {
...
init { 
	chan child_TestMetadataNoExecOptions1350 = [1] of {int};
	run TestMetadataNoExecOptions135(child_TestMetadataNoExecOptions1350);
	run receiver(child_TestMetadataNoExecOptions1350)
stop_process:skip
}

proctype TestMetadataNoExecOptions135(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
