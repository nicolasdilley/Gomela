...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L855
typedef Wgdef {
...
init { 
	chan child_killConnection8550 = [1] of {int};
	run killConnection855(child_killConnection8550);
	run receiver(child_killConnection8550)
stop_process:skip
}

proctype killConnection855(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
