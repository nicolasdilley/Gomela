...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/connkilling/connkiller_test.go#L79
typedef Wgdef {
...
init { 
	chan child_TestTxKillerKillsTransactionThreeSecondsAfterCreation790 = [1] of {int};
	run TestTxKillerKillsTransactionThreeSecondsAfterCreation79(child_TestTxKillerKillsTransactionThreeSecondsAfterCreation790);
	run receiver(child_TestTxKillerKillsTransactionThreeSecondsAfterCreation790)
stop_process:skip
}

proctype TestTxKillerKillsTransactionThreeSecondsAfterCreation79(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
