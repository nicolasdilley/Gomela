...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L684
typedef Wgdef {
...
init { 
	chan child_TestBeginReserveExecuteWithFailingPreQueriesAndCheckConnectionState6840 = [1] of {int};
	run TestBeginReserveExecuteWithFailingPreQueriesAndCheckConnectionState684(child_TestBeginReserveExecuteWithFailingPreQueriesAndCheckConnectionState6840);
	run receiver(child_TestBeginReserveExecuteWithFailingPreQueriesAndCheckConnectionState6840)
stop_process:skip
}

proctype TestBeginReserveExecuteWithFailingPreQueriesAndCheckConnectionState684(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
