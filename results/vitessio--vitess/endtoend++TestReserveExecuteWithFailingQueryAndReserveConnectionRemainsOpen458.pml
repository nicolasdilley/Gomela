...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L458
typedef Wgdef {
...
init { 
	chan child_TestReserveExecuteWithFailingQueryAndReserveConnectionRemainsOpen4580 = [1] of {int};
	run TestReserveExecuteWithFailingQueryAndReserveConnectionRemainsOpen458(child_TestReserveExecuteWithFailingQueryAndReserveConnectionRemainsOpen4580);
	run receiver(child_TestReserveExecuteWithFailingQueryAndReserveConnectionRemainsOpen4580)
stop_process:skip
}

proctype TestReserveExecuteWithFailingQueryAndReserveConnectionRemainsOpen458(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
