...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L404
typedef Wgdef {
...
init { 
	chan child_TestBeginReserveReleaseAndFailToUseReservedIDAndTxIDAgain4040 = [1] of {int};
	run TestBeginReserveReleaseAndFailToUseReservedIDAndTxIDAgain404(child_TestBeginReserveReleaseAndFailToUseReservedIDAndTxIDAgain4040);
	run receiver(child_TestBeginReserveReleaseAndFailToUseReservedIDAndTxIDAgain4040)
stop_process:skip
}

proctype TestBeginReserveReleaseAndFailToUseReservedIDAndTxIDAgain404(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_ReserveExecute3031 = [1] of {int};
