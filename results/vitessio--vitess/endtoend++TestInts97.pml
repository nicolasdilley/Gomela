...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/compatibility_test.go#L97
typedef Wgdef {
...
init { 
	chan child_TestInts970 = [1] of {int};
	run TestInts97(child_TestInts970);
	run receiver(child_TestInts970)
stop_process:skip
}

proctype TestInts97(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
