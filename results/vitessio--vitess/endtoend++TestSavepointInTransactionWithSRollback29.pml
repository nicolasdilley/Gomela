...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/savepoint_test.go#L29
typedef Wgdef {
...
init { 
	chan child_TestSavepointInTransactionWithSRollback290 = [1] of {int};
	run TestSavepointInTransactionWithSRollback29(child_TestSavepointInTransactionWithSRollback290);
	run receiver(child_TestSavepointInTransactionWithSRollback290)
stop_process:skip
}

proctype TestSavepointInTransactionWithSRollback29(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_Commit1014 = [1] of {int};
	chan child_Execute1743 = [1] of {int};
	chan child_Execute1742 = [1] of {int};
	chan child_BeginExecuteBatch2001 = [1] of {int};
