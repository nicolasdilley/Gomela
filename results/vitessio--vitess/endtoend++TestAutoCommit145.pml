...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/transaction_test.go#L145
typedef Wgdef {
...
init { 
	chan child_TestAutoCommit1450 = [1] of {int};
	run TestAutoCommit145(child_TestAutoCommit1450);
	run receiver(child_TestAutoCommit1450)
stop_process:skip
}

proctype TestAutoCommit145(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
