...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/call_test.go#L134
typedef Wgdef {
...
init { 
	chan child_TestCallProcedureChangedTx1340 = [1] of {int};
	run TestCallProcedureChangedTx134(child_TestCallProcedureChangedTx1340);
	run receiver(child_TestCallProcedureChangedTx1340)
stop_process:skip
}

proctype TestCallProcedureChangedTx134(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
