...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/config_test.go#L234
typedef Wgdef {
...
init { 
	chan child_TestWarnResultSize2340 = [1] of {int};
	run TestWarnResultSize234(child_TestWarnResultSize2340);
	run receiver(child_TestWarnResultSize2340)
stop_process:skip
}

proctype TestWarnResultSize234(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
