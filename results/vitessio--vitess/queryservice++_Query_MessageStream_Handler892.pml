...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/proto/queryservice/queryservice_grpc.pb.go#L892
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child__Query_MessageStream_Handler8920 = [1] of {int};
	run _Query_MessageStream_Handler892(child__Query_MessageStream_Handler8920);
	run receiver(child__Query_MessageStream_Handler8920)
stop_process:skip
}

proctype _Query_MessageStream_Handler892(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
