...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L829
typedef Wgdef {
...
init { 
	chan child_TestReserveExecuteDDLWithTx8290 = [1] of {int};
	run TestReserveExecuteDDLWithTx829(child_TestReserveExecuteDDLWithTx8290);
	run receiver(child_TestReserveExecuteDDLWithTx8290)
stop_process:skip
}

proctype TestReserveExecuteDDLWithTx829(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
