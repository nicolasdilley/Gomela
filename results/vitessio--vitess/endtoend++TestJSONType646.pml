...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/compatibility_test.go#L646
typedef Wgdef {
...
init { 
	chan child_TestJSONType6460 = [1] of {int};
	run TestJSONType646(child_TestJSONType6460);
	run receiver(child_TestJSONType6460)
stop_process:skip
}

proctype TestJSONType646(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
