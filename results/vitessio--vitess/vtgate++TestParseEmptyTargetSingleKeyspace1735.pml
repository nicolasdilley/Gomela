...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vtgate/executor_test.go#L1735
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestParseEmptyTargetSingleKeyspace17350 = [1] of {int};
	run TestParseEmptyTargetSingleKeyspace1735(child_TestParseEmptyTargetSingleKeyspace17350);
	run receiver(child_TestParseEmptyTargetSingleKeyspace17350)
stop_process:skip
}

proctype TestParseEmptyTargetSingleKeyspace1735(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
