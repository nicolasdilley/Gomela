...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/misc_test.go#L565
typedef Wgdef {
...
init { 
	chan child_TestLogTruncation5650 = [1] of {int};
	run TestLogTruncation565(child_TestLogTruncation5650);
	run receiver(child_TestLogTruncation5650)
stop_process:skip
}

proctype TestLogTruncation565(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
