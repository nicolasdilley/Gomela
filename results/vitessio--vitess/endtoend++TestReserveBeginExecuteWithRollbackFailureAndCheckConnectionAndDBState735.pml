...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L735
typedef Wgdef {
...
init { 
	chan child_TestReserveBeginExecuteWithRollbackFailureAndCheckConnectionAndDBState7350 = [1] of {int};
	run TestReserveBeginExecuteWithRollbackFailureAndCheckConnectionAndDBState735(child_TestReserveBeginExecuteWithRollbackFailureAndCheckConnectionAndDBState7350);
	run receiver(child_TestReserveBeginExecuteWithRollbackFailureAndCheckConnectionAndDBState7350)
stop_process:skip
}

proctype TestReserveBeginExecuteWithRollbackFailureAndCheckConnectionAndDBState735(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
