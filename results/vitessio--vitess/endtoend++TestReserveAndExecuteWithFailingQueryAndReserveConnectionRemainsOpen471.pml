...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L471
typedef Wgdef {
...
init { 
	chan child_TestReserveAndExecuteWithFailingQueryAndReserveConnectionRemainsOpen4710 = [1] of {int};
	run TestReserveAndExecuteWithFailingQueryAndReserveConnectionRemainsOpen471(child_TestReserveAndExecuteWithFailingQueryAndReserveConnectionRemainsOpen4710);
	run receiver(child_TestReserveAndExecuteWithFailingQueryAndReserveConnectionRemainsOpen4710)
stop_process:skip
}

proctype TestReserveAndExecuteWithFailingQueryAndReserveConnectionRemainsOpen471(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
