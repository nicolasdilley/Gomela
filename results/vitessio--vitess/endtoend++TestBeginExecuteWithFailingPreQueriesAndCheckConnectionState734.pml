...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/misc_test.go#L734
typedef Wgdef {
...
init { 
	chan child_TestBeginExecuteWithFailingPreQueriesAndCheckConnectionState7340 = [1] of {int};
	run TestBeginExecuteWithFailingPreQueriesAndCheckConnectionState734(child_TestBeginExecuteWithFailingPreQueriesAndCheckConnectionState7340);
	run receiver(child_TestBeginExecuteWithFailingPreQueriesAndCheckConnectionState7340)
stop_process:skip
}

proctype TestBeginExecuteWithFailingPreQueriesAndCheckConnectionState734(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
