...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L131
typedef Wgdef {
...
init { 
	chan child_TestCommitOnReserveBeginConn1310 = [1] of {int};
	run TestCommitOnReserveBeginConn131(child_TestCommitOnReserveBeginConn1310);
	run receiver(child_TestCommitOnReserveBeginConn1310)
stop_process:skip
}

proctype TestCommitOnReserveBeginConn131(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
