...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L705
typedef Wgdef {
...
init { 
	chan child_TestReserveBeginExecuteWithCommitFailureAndCheckConnectionAndDBState7050 = [1] of {int};
	run TestReserveBeginExecuteWithCommitFailureAndCheckConnectionAndDBState705(child_TestReserveBeginExecuteWithCommitFailureAndCheckConnectionAndDBState7050);
	run receiver(child_TestReserveBeginExecuteWithCommitFailureAndCheckConnectionAndDBState7050)
stop_process:skip
}

proctype TestReserveBeginExecuteWithCommitFailureAndCheckConnectionAndDBState705(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
