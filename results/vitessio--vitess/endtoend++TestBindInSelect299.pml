...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/misc_test.go#L299
typedef Wgdef {
...
init { 
	chan child_TestBindInSelect2990 = [1] of {int};
	run TestBindInSelect299(child_TestBindInSelect2990);
	run receiver(child_TestBindInSelect2990)
stop_process:skip
}

proctype TestBindInSelect299(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
