...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/call_test.go#L100
typedef Wgdef {
...
init { 
	chan child_TestCallProcedureInsideTx1000 = [1] of {int};
	run TestCallProcedureInsideTx100(child_TestCallProcedureInsideTx1000);
	run receiver(child_TestCallProcedureInsideTx1000)
stop_process:skip
}

proctype TestCallProcedureInsideTx100(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
