...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/misc_test.go#L497
typedef Wgdef {
...
init { 
	chan child_TestDBAStatements4970 = [1] of {int};
	run TestDBAStatements497(child_TestDBAStatements4970);
	run receiver(child_TestDBAStatements4970)
stop_process:skip
}

proctype TestDBAStatements497(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
