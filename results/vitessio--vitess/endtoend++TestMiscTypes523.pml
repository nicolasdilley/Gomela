...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/compatibility_test.go#L523
typedef Wgdef {
...
init { 
	chan child_TestMiscTypes5230 = [1] of {int};
	run TestMiscTypes523(child_TestMiscTypes5230);
	run receiver(child_TestMiscTypes5230)
stop_process:skip
}

proctype TestMiscTypes523(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
