...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/misc_test.go#L123
typedef Wgdef {
...
init { 
	chan child_TestNocacheListArgs1230 = [1] of {int};
	run TestNocacheListArgs123(child_TestNocacheListArgs1230);
	run receiver(child_TestNocacheListArgs1230)
stop_process:skip
}

proctype TestNocacheListArgs123(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
