...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/config_test.go#L179
typedef Wgdef {
...
init { 
	chan child_TestQueryPlanCache1790 = [1] of {int};
	run TestQueryPlanCache179(child_TestQueryPlanCache1790);
	run receiver(child_TestQueryPlanCache1790)
stop_process:skip
}

proctype TestQueryPlanCache179(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
