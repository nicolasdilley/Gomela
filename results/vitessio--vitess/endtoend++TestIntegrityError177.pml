...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/misc_test.go#L177
typedef Wgdef {
...
init { 
	chan child_TestIntegrityError1770 = [1] of {int};
	run TestIntegrityError177(child_TestIntegrityError1770);
	run receiver(child_TestIntegrityError1770)
stop_process:skip
}

proctype TestIntegrityError177(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
