...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L314
typedef Wgdef {
...
init { 
	chan child_TestReserveAndFailToRunTwiceConcurrently3140 = [1] of {int};
	run TestReserveAndFailToRunTwiceConcurrently314(child_TestReserveAndFailToRunTwiceConcurrently3140);
	run receiver(child_TestReserveAndFailToRunTwiceConcurrently3140)
stop_process:skip
}

proctype TestReserveAndFailToRunTwiceConcurrently314(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_AnonymousTestReserveAndFailToRunTwiceConcurrently3263152 = [1] of {int};
	Wgdef wg;
