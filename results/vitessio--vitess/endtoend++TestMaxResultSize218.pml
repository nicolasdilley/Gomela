...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/config_test.go#L218
typedef Wgdef {
...
init { 
	chan child_TestMaxResultSize2180 = [1] of {int};
	run TestMaxResultSize218(child_TestMaxResultSize2180);
	run receiver(child_TestMaxResultSize2180)
stop_process:skip
}

proctype TestMaxResultSize218(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
