...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/metadata_test.go#L52
typedef Wgdef {
...
init { 
	chan child_TestMetadataSpecificExecOptions520 = [1] of {int};
	run TestMetadataSpecificExecOptions52(child_TestMetadataSpecificExecOptions520);
	run receiver(child_TestMetadataSpecificExecOptions520)
stop_process:skip
}

proctype TestMetadataSpecificExecOptions52(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
