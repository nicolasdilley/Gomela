...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L249
typedef Wgdef {
...
init { 
	chan child_TestReserveBeginCommitFailToReuseOldReservedID2490 = [1] of {int};
	run TestReserveBeginCommitFailToReuseOldReservedID249(child_TestReserveBeginCommitFailToReuseOldReservedID2490);
	run receiver(child_TestReserveBeginCommitFailToReuseOldReservedID2490)
stop_process:skip
}

proctype TestReserveBeginCommitFailToReuseOldReservedID249(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_Commit1012 = [1] of {int};
