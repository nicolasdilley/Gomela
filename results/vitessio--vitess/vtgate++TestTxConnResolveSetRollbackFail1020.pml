...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vtgate/tx_conn_test.go#L1020
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestTxConnResolveSetRollbackFail10200 = [1] of {int};
	run TestTxConnResolveSetRollbackFail1020(child_TestTxConnResolveSetRollbackFail10200);
	run receiver(child_TestTxConnResolveSetRollbackFail10200)
stop_process:skip
}

proctype TestTxConnResolveSetRollbackFail1020(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
