...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/tabletserver/vstreamer/local_vschema_test.go#L29
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFindColVindex290 = [1] of {int};
	run TestFindColVindex29(child_TestFindColVindex290);
	run receiver(child_TestFindColVindex290)
stop_process:skip
}

proctype TestFindColVindex29(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
