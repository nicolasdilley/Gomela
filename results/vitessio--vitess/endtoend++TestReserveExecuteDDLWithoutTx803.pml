...
// git_link=https://github.com/vitessio/vitess/blob//go/vt/vttablet/endtoend/reserve_test.go#L803
typedef Wgdef {
...
init { 
	chan child_TestReserveExecuteDDLWithoutTx8030 = [1] of {int};
	run TestReserveExecuteDDLWithoutTx803(child_TestReserveExecuteDDLWithoutTx8030);
	run receiver(child_TestReserveExecuteDDLWithoutTx8030)
stop_process:skip
}

proctype TestReserveExecuteDDLWithoutTx803(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
