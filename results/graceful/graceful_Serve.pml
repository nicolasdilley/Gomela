...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example225317746/graceful.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run go_srvhandleInterrupt(quitting,interrupt);
...
proctype go_srvhandleInterrupt(Chandef quitting;int interrupt) {
	bool closed; 
	int i;
		for(i : 1.. interrupt) {
