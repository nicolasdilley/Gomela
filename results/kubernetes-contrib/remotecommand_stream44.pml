...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example078125380/scale-demo/Godeps/_workspace/src/k8s.io/kubernetes/pkg/client/unversioned/remotecommand/v2.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	if
	:: true -> 
		run go_Anonymous0(errorChan,wg);
...
proctype go_Anonymous0(Chandef errorChan;Wgdef wg) {
	bool closed; 
	int i;
	bool state;
	stop_process: skip
