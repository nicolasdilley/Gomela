...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example689943956/scale-demo/Godeps/_workspace/src/k8s.io/kubernetes/pkg/client/unversioned/portforward/portforward.go
typedef Chandef {
...
init { 
	...
	run go_Anonymous0(errorChan,localError,remoteDone);
...
proctype go_Anonymous0(Chandef errorChan;Chandef localError;Chandef remoteDone) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
