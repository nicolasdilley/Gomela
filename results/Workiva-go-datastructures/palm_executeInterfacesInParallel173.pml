#define executeInterfacesInParallel_int1879  3
#define executeInterfacesInParallel_numCPU  0
#define executeInterfacesInParallel_uint6418911  0

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example917179335/btree/palm/action.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
