...
// git_link=https://github.com/containers/podman/blob//libpod/container_graph_test.go#L106
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBuildContainerGraphThreeCtrNoEdges1060 = [1] of {int};
	run TestBuildContainerGraphThreeCtrNoEdges106(child_TestBuildContainerGraphThreeCtrNoEdges1060);
	run receiver(child_TestBuildContainerGraphThreeCtrNoEdges1060)
stop_process:skip
}

proctype TestBuildContainerGraphThreeCtrNoEdges106(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
