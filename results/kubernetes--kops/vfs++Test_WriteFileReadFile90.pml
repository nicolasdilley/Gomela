...
// https://github.com/kubernetes/kops/blob/master/util/pkg/vfs/vaultfs_test.go#L90
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Test_WriteFileReadFile90(chan child) {
	...
	run ReadFile93(p_vaultClient_modifyLock,p_vaultClient_config_modifyLock,p_vaultClient_config_Limiter_mu,child_ReadFile932);
	child_ReadFile932?0;
	stop_process: skip;
	child!0
}
