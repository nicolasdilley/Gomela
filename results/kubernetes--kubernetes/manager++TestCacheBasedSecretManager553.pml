...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/kubelet/util/manager/cache_based_manager_test.go#L553
#define not_found_59326  -2
#define not_found_59221  -2
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestCacheBasedSecretManager553(chan child) {
	...
	if
	:: not_found_59221-1 != -3 -> 
				for(i : 0.. not_found_59221-1) {
			for10: skip;
			

			if
			:: not_found_59326-1 != -3 -> 
								for(i : 0.. not_found_59326-1) {
					for11: skip;
