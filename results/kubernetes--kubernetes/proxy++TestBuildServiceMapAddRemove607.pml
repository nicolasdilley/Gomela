...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/proxy/service_test.go#L607
...
proctype TestBuildServiceMapAddRemove607(chan child) {
	...
	int var_expectedStaleUDPServices = -2; // opt var_expectedStaleUDPServices
	...
	:: else -> 
		...
		:: true -> 
			for19: skip;
			run addService539(fp_endpointsChanges_endpointSliceCache_lock,fp_endpointsChanges_lock,fp_serviceChanges_lock,child_addService5391);
	...
	run Update323(fp_serviceChanges_lock,var_fp_serviceMap,child_Update3232);
	child_Update3232?0;
	run updateService543(fp_endpointsChanges_endpointSliceCache_lock,fp_endpointsChanges_lock,fp_serviceChanges_lock,child_updateService5433);
	child_updateService5433?0;
	run deleteService547(fp_endpointsChanges_endpointSliceCache_lock,fp_endpointsChanges_lock,fp_serviceChanges_lock,child_deleteService5474);
	child_deleteService5474?0;
	run deleteService547(fp_endpointsChanges_endpointSliceCache_lock,fp_endpointsChanges_lock,fp_serviceChanges_lock,child_deleteService5475);
	child_deleteService5475?0;
	run deleteService547(fp_endpointsChanges_endpointSliceCache_lock,fp_endpointsChanges_lock,fp_serviceChanges_lock,child_deleteService5476);
...
proctype deleteService547(Mutexdef fake_endpointsChanges_endpointSliceCache_lock;Mutexdef fake_endpointsChanges_lock;Mutexdef fake_serviceChanges_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
