...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/dualstack/dualstack_test.go#L1232
typedef Wgdef {
...
init { 
	chan child_TestPreferDualStack12320 = [1] of {int};
	run TestPreferDualStack1232(child_TestPreferDualStack12320);
	run receiver(child_TestPreferDualStack12320)
stop_process:skip
}

proctype TestPreferDualStack1232(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
