...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/dualstack/dualstack_test.go#L1318
typedef Wgdef {
...
init { 
	chan child_TestServiceUpdate13180 = [1] of {int};
	run TestServiceUpdate1318(child_TestServiceUpdate13180);
	run receiver(child_TestServiceUpdate13180)
stop_process:skip
}

proctype TestServiceUpdate1318(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
