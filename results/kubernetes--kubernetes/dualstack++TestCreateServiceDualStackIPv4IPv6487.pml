...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/dualstack/dualstack_test.go#L487
typedef Wgdef {
...
init { 
	chan child_TestCreateServiceDualStackIPv4IPv64870 = [1] of {int};
	run TestCreateServiceDualStackIPv4IPv6487(child_TestCreateServiceDualStackIPv4IPv64870);
	run receiver(child_TestCreateServiceDualStackIPv4IPv64870)
stop_process:skip
}

proctype TestCreateServiceDualStackIPv4IPv6487(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
