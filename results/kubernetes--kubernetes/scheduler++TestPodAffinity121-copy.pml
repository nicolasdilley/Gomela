...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/scheduler/priorities_test.go#L121
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestPodAffinity1210)
stop_process:skip
}
...
proctype TestPodAffinity121(chan child) {
	...
	int var_nodesInTopology = -2; // opt var_nodesInTopology
	...
	run createAndWaitForNodesInCache165(testCtx_HTTPServer_wg,testCtx_HTTPServer_Config_ErrorLog_mu,testCtx_HTTPServer_Config_mu,testCtx_HTTPServer_Config_nextProtoOnce_m,testCtx_HTTPServer_Config_TLSConfig_mutex,testCtx_HTTPServer_mu,testCtx_HTTPServer_TLS_mutex,child_createAndWaitForNodesInCache1651);
