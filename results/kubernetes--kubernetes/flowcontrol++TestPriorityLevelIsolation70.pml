...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/apiserver/flowcontrol/concurrency_test.go#L70
...
proctype TestPriorityLevelIsolation70(chan child) {
	...
	run streamRequests315(stopCh_ch,var_concurrencyShares+var_queueLength,child_streamRequests3150);
	child_streamRequests3150?0;
	run streamRequests315(stopCh_ch,3,child_streamRequests3151);
