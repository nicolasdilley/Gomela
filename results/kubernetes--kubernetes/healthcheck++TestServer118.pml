...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/proxy/healthcheck/healthcheck_test.go#L118
#define def_var_nil  ?? // mand newServices line 76
...
proctype TestServer118(chan child) {
	...
	run SyncServices76(hcs_lock,var_nil,child_SyncServices760);
	child_SyncServices760?0;
	run SyncEndpoints177(hcs_lock,var_nil,child_SyncEndpoints1771);
	...
	run SyncEndpoints177(hcs_lock,var_nil,child_SyncEndpoints17710);
	...
	run SyncServices76(hcs_lock,var_nil,child_SyncServices7613);
