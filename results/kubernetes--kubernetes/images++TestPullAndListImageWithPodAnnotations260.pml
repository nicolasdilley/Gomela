...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/kubelet/images/image_manager_test.go#L260
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestPullAndListImageWithPodAnnotations2600)
stop_process:skip
}
