...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/metrics/metrics_test.go#L90
typedef Wgdef {
...
init { 
	chan child_TestApiserverMetrics900 = [1] of {int};
	run TestApiserverMetrics90(child_TestApiserverMetrics900);
	run receiver(child_TestApiserverMetrics900)
stop_process:skip
}

proctype TestApiserverMetrics90(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run scrapeMetrics39(s_wg,s_Config_ErrorLog_mu,s_Config_mu,s_Config_nextProtoOnce_m,s_Config_TLSConfig_mutex,s_mu,s_TLS_mutex,child_scrapeMetrics390);
	child_scrapeMetrics390?0;
	stop_process: skip;
	child!0
}
proctype scrapeMetrics39(Wgdef s_wg;Mutexdef s_Config_ErrorLog_mu;Mutexdef s_Config_mu;Mutexdef s_Config_nextProtoOnce_m;Mutexdef s_Config_TLSConfig_mutex;Mutexdef s_mu;Mutexdef s_TLS_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
