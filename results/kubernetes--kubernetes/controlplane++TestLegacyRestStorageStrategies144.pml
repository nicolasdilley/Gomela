...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/controlplane/instance_test.go#L144
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestLegacyRestStorageStrategies1440)
stop_process:skip
}
...
proctype TestLegacyRestStorageStrategies144(chan child) {
	...
	int var_strategyErrors = -2; // opt var_strategyErrors
