...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/proxy/userspace/roundrobin_test.go#L423
...
proctype OnEndpointsUpdate248(Mutexdef lb_lock;chan child) {
	...
	:: var_portsToEndpoints-1 != -3 -> 
			...
			if
			:: true -> 
				run removeStaleAffinity205(lb_lock,var_newEndpoints,child_removeStaleAffinity2058);
