...
// https://github.com/kubernetes/kubernetes/blob/master/pkg/util/goroutinemap/goroutinemap_test.go#L393
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype Test_NewGoRoutineMap_Positive_Wait393(chan child) {
	...
	run AnonymousTest_NewGoRoutineMap_Positive_Wait407398(operation1DoneCh,waitDoneCh,child_AnonymousTest_NewGoRoutineMap_Positive_Wait4073981);
...
proctype AnonymousTest_NewGoRoutineMap_Positive_Wait407398(Chandef operation1DoneCh;Chandef waitDoneCh;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
