...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/proxy/winuserspace/roundrobin_test.go#L499
...
proctype OnEndpointsUpdate241(Mutexdef lb_lock;chan child) {
	...
	:: else -> 
		...
		:: true -> 
			...
			if
			:: true -> 
				run updateAffinityMap194(lb_lock,var_newEndpoints,child_updateAffinityMap19412);
