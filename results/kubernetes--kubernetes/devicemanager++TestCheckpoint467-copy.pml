...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/kubelet/cm/devicemanager/manager_test.go#L467
typedef Wgdef {
...
proctype TestCheckpoint467(chan child) {
	...
	run readCheckpoint593(testManager_server_serveWG,testManager_wg,testManager_mutex,testManager_server_channelzRemoveOnce_m,testManager_server_done_o_m,testManager_server_mu,testManager_server_quit_o_m,child_readCheckpoint5931);
