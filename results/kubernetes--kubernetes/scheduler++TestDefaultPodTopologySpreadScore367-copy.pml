...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/scheduler/priorities_test.go#L367
typedef Wgdef {
...
proctype TestDefaultPodTopologySpreadScore367(chan child) {
	...
	int var_zoneCnts = -2; // opt var_zoneCnts
	int var_pods = -2; // opt var_pods
	int var_podList_Items = -2; // opt var_podList_Items
	int var_nPods = -2; // opt var_nPods
