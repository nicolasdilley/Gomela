...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/dualstack/dualstack_test.go#L1059
typedef Wgdef {
...
init { 
	chan child_TestConvertToFromExternalName10590 = [1] of {int};
	run TestConvertToFromExternalName1059(child_TestConvertToFromExternalName10590);
	run receiver(child_TestConvertToFromExternalName10590)
stop_process:skip
}

proctype TestConvertToFromExternalName1059(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
