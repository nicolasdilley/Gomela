...
// https://github.com/kubernetes/kubernetes/blob/master/test/e2e/framework/providers/gce/ingress.go#L268
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype ListURLMaps268(chan child) {
	...
	run ListURLMaps268(gceCloud_ClusterID_idLock,gceCloud_subnetworkURLAndIsLegacyNetworkInitializer_m,gceCloud_computeNodeTagLock,gceCloud_nodeZonesLock,gceCloud_sharedResourceLock,child_ListURLMaps2680);
