...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/dualstack/dualstack_test.go#L1152
typedef Wgdef {
...
init { 
	chan child_TestExistingServiceDefaulting11520 = [1] of {int};
	run TestExistingServiceDefaulting1152(child_TestExistingServiceDefaulting11520);
	run receiver(child_TestExistingServiceDefaulting11520)
stop_process:skip
}

proctype TestExistingServiceDefaulting1152(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
