...
// https://github.com/kubernetes/kubernetes/blob/master/pkg/controlplane/instance_test.go#L362
typedef Wgdef {
...
init { 
	chan child_TestStorageVersionHashes3620 = [1] of {int};
	run TestStorageVersionHashes362(child_TestStorageVersionHashes3620)
stop_process:skip
}

proctype TestStorageVersionHashes362(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
