...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/controller/util/endpoint/trigger_time_tracker_test.go#L71
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestPodsUpdated710)
stop_process:skip
}
