...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/controlplane/instance_test.go#L406
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestStorageVersionHashEqualities4060)
stop_process:skip
}
...
proctype TestStorageVersionHashEqualities406(chan child) {
	...
	int var_batchv1beta1_APIResources = -2; // opt var_batchv1beta1_APIResources
	int var_batchv1_APIResources = -2; // opt var_batchv1_APIResources
	int var_appsList_APIResources = -2; // opt var_appsList_APIResources
	int var_extList_APIResources = -2; // opt var_extList_APIResources
