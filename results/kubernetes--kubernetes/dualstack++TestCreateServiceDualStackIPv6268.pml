...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/dualstack/dualstack_test.go#L268
typedef Wgdef {
...
init { 
	chan child_TestCreateServiceDualStackIPv62680 = [1] of {int};
	run TestCreateServiceDualStackIPv6268(child_TestCreateServiceDualStackIPv62680);
	run receiver(child_TestCreateServiceDualStackIPv62680)
stop_process:skip
}

proctype TestCreateServiceDualStackIPv6268(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
