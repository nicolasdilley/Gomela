...
// git_link=https://github.com/kubernetes/kubernetes/blob//test/integration/dualstack/dualstack_test.go#L944
typedef Wgdef {
...
init { 
	chan child_TestUpgradeDowngrade9440 = [1] of {int};
	run TestUpgradeDowngrade944(child_TestUpgradeDowngrade9440);
	run receiver(child_TestUpgradeDowngrade9440)
stop_process:skip
}

proctype TestUpgradeDowngrade944(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
