...
// git_link=https://github.com/kubernetes/kubernetes/blob//pkg/volume/azuredd/attacher_test.go#L44
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestWaitForAttach44(chan child) {
	...
	:: var_tests-1 != -3 -> 
				for(i : 0.. var_tests-1) {
			for10: skip;
			run WaitForAttach138(attacher_cloud_lbCache_Lock,attacher_cloud_metadata_imsCache_Lock,attacher_cloud_nodeCachesLock,attacher_cloud_nsgCache_Lock,attacher_cloud_routeCIDRsLock,attacher_cloud_routeUpdater_lock,attacher_cloud_rtCache_Lock,attacher_cloud_vmCache_Lock,child_WaitForAttach1380);
	...
	:: else -> 
		...
		:: true -> 
			for11: skip;
			run WaitForAttach138(attacher_cloud_lbCache_Lock,attacher_cloud_metadata_imsCache_Lock,attacher_cloud_nodeCachesLock,attacher_cloud_nsgCache_Lock,attacher_cloud_routeCIDRsLock,attacher_cloud_routeUpdater_lock,attacher_cloud_rtCache_Lock,attacher_cloud_vmCache_Lock,child_WaitForAttach1381);
...
proctype WaitForAttach138(Mutexdef a_cloud_lbCache_Lock;Mutexdef a_cloud_metadata_imsCache_Lock;Mutexdef a_cloud_nodeCachesLock;Mutexdef a_cloud_nsgCache_Lock;Mutexdef a_cloud_routeCIDRsLock;Mutexdef a_cloud_routeUpdater_lock;Mutexdef a_cloud_rtCache_Lock;Mutexdef a_cloud_vmCache_Lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
