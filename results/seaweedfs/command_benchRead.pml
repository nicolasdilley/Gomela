...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example243985870/weed/command/benchmark.go
typedef Chandef {
	chan sync = [0] of {int};
...
for50:		run go_commandreadFiles(fileIdLineChan,fileIdLineChan)
	};
for50_exit:	
	if
...
proctype go_commandreadFiles(Chandef fileIdLineChan;int fileIdLineChan) {
	bool closed; 
	int i;
	do
