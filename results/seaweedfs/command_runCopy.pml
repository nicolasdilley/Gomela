#define copy_concurrenctFiles  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example243985870/weed/command/filer_copy.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype workercopyFiles(Chandef fileCopyTaskChan;int fileCopyTaskChan;chan child) {
	bool closed; 
	int i;
	do
...
proctype Anonymous2(Chandef fileCopyTaskChan) {
	...
	run workercopyFiles(fileCopyTaskChan,fileCopyTaskChan,child_workercopyFiles2);
