...
proctype go_Anonymous0(Chandef versionChan;Chandef internalCancel;Wgdef wg) {
	...
	int i;
	bool state;
	chan child_announceServers0 = [0] of {int};
	run announceServers(versionChan,internalCancel,child_announceServers0);
	child_announceServers0?0;
	stop_process: skip;
	wg.Add!-1
}
proctype announceServers(Chandef versionChan;Chandef cancel;chan child) {
	bool closed; 
	int i;
	bool state;
	do
...
proctype go_Anonymous2(Chandef versionChan;Chandef internalCancel;Wgdef wg) {
	...
	int i;
	bool state;
	chan child_fillRoles0 = [0] of {int};
	int servers = Register_servers;
	run fillRoles(versionChan,internalCancel,servers,child_fillRoles0);
	child_fillRoles0?0;
	stop_process: skip;
	wg.Add!-1
}
proctype fillRoles(Chandef versionChan;Chandef cancel;int servers;chan child) {
	bool closed; 
	int i;
	bool state;
