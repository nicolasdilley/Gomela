...
// git_link=https://github.com/go-redis/redis/blob//example_test.go#L567
#define ub_for569_2  -2
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_ExampleScanIterator5670 = [1] of {int};
	run ExampleScanIterator567(child_ExampleScanIterator5670);
	run receiver(child_ExampleScanIterator5670)
stop_process:skip
}

proctype ExampleScanIterator567(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
