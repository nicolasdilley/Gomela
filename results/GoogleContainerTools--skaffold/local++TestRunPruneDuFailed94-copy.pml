...
// git_link=https://github.com/GoogleContainerTools/skaffold/blob//pkg/skaffold/build/local/prune_test.go#L94
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRunPruneDuFailed940 = [1] of {int};
	run TestRunPruneDuFailed94(child_TestRunPruneDuFailed940);
	run receiver(child_TestRunPruneDuFailed940)
stop_process:skip
}

proctype TestRunPruneDuFailed94(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
