...
// git_link=https://github.com/GoogleContainerTools/skaffold/blob//pkg/skaffold/build/local/prune_test.go#L104
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRunPruneDuFailed21040 = [1] of {int};
	run TestRunPruneDuFailed2104(child_TestRunPruneDuFailed21040);
	run receiver(child_TestRunPruneDuFailed21040)
stop_process:skip
}

proctype TestRunPruneDuFailed2104(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
