...
// git_link=https://github.com/tal-tech/go-zero/blob//core/mathx/unstable_test.go#L19
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestUnstable_AroundInt190 = [1] of {int};
	run TestUnstable_AroundInt19(child_TestUnstable_AroundInt190);
	run receiver(child_TestUnstable_AroundInt190)
stop_process:skip
}

proctype TestUnstable_AroundInt19(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
