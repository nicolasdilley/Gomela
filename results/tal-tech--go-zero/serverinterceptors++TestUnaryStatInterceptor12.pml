...
// git_link=https://github.com/tal-tech/go-zero/blob//zrpc/internal/serverinterceptors/statinterceptor_test.go#L12
typedef Wgdef {
...
init { 
	chan child_TestUnaryStatInterceptor120 = [1] of {int};
	run TestUnaryStatInterceptor12(child_TestUnaryStatInterceptor120);
	run receiver(child_TestUnaryStatInterceptor120)
stop_process:skip
}

proctype TestUnaryStatInterceptor12(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
