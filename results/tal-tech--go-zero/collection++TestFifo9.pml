...
// git_link=https://github.com/tal-tech/go-zero/blob//core/collection/fifo_test.go#L9
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFifo90 = [1] of {int};
	run TestFifo9(child_TestFifo90);
	run receiver(child_TestFifo90)
stop_process:skip
}

proctype TestFifo9(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
