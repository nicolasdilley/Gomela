...
// git_link=https://github.com/tal-tech/go-zero/blob//core/breaker/googlebreaker_test.go#L102
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestGoogleBreakerNotAcceptable1020 = [1] of {int};
	run TestGoogleBreakerNotAcceptable102(child_TestGoogleBreakerNotAcceptable1020);
	run receiver(child_TestGoogleBreakerNotAcceptable1020)
stop_process:skip
}

proctype TestGoogleBreakerNotAcceptable102(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
