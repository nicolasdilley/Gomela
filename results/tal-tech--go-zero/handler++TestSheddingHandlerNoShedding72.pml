...
// git_link=https://github.com/tal-tech/go-zero/blob//rest/handler/sheddinghandler_test.go#L72
typedef Wgdef {
...
init { 
	chan child_TestSheddingHandlerNoShedding720 = [1] of {int};
	run TestSheddingHandlerNoShedding72(child_TestSheddingHandlerNoShedding720);
	run receiver(child_TestSheddingHandlerNoShedding720)
stop_process:skip
}

proctype TestSheddingHandlerNoShedding72(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
