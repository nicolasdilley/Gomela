...
// git_link=https://github.com/tal-tech/go-zero/blob//core/collection/fifo_test.go#L47
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPutMore470 = [1] of {int};
	run TestPutMore47(child_TestPutMore470);
	run receiver(child_TestPutMore470)
stop_process:skip
}

proctype TestPutMore47(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
