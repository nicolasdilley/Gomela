...
// git_link=https://github.com/tal-tech/go-zero/blob//rest/handler/sheddinghandler_test.go#L56
typedef Wgdef {
...
init { 
	chan child_TestSheddingHandlerReject560 = [1] of {int};
	run TestSheddingHandlerReject56(child_TestSheddingHandlerReject560);
	run receiver(child_TestSheddingHandlerReject560)
stop_process:skip
}

proctype TestSheddingHandlerReject56(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
