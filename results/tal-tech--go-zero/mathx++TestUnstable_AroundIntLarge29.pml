...
// git_link=https://github.com/tal-tech/go-zero/blob//core/mathx/unstable_test.go#L29
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestUnstable_AroundIntLarge290 = [1] of {int};
	run TestUnstable_AroundIntLarge29(child_TestUnstable_AroundIntLarge290);
	run receiver(child_TestUnstable_AroundIntLarge290)
stop_process:skip
}

proctype TestUnstable_AroundIntLarge29(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
