...
// git_link=https://github.com/tal-tech/go-zero/blob//core/breaker/googlebreaker_test.go#L47
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestGoogleBreakerClose470 = [1] of {int};
	run TestGoogleBreakerClose47(child_TestGoogleBreakerClose470);
	run receiver(child_TestGoogleBreakerClose470)
stop_process:skip
}

proctype TestGoogleBreakerClose47(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
