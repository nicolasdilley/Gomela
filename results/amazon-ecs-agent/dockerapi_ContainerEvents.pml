...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example504932658/agent/dockerclient/dockerapi/docker_client.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run go_dghandleContainerEvents(events,changedContainers,events);
	goto stop_process
stop_process:}
...
proctype go_dghandleContainerEvents(Chandef events;Chandef changedContainers;int events) {
	bool closed; 
	int i;
	do
