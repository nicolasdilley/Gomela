#define Create_envfile_environmentFilesSource  ??

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example029465294/agent/taskresource/envFiles/envfile.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10:		wg.Add!1;
		run go_downloadEnvfileFromS3(wg,errorEvents)
	};
	wg.Wait?0;
...
proctype go_downloadEnvfileFromS3(Wgdef wg;Chandef errorEvents) {
	bool closed; 
	int i;
	bool state;
