...
// git_link=https://github.com/istio/istio/blob//pilot/pkg/networking/core/v1alpha3/cluster_test.go#L1419
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestClusterDiscoveryTypeAndLbPolicyRoundRobin14190)
stop_process:skip
}
