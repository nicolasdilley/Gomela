...
// https://github.com/istio/istio/blob/master/pilot/pkg/xds/ads_test.go#L89
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestAdsReconnectAfterRestart890 = [1] of {int};
	run TestAdsReconnectAfterRestart89(child_TestAdsReconnectAfterRestart890)
stop_process:skip
}

proctype TestAdsReconnectAfterRestart89(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
