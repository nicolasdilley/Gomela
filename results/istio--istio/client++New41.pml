...
// git_link=https://github.com/istio/istio/blob//pkg/test/echo/client/client.go#L41
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype New41(chan child) {
	...
	run NewEchoTestServiceClient503(conn_balancerWrapper_balancerMu,conn_balancerWrapper_done_o_m,conn_balancerWrapper_mu,conn_balancerWrapper_scBuffer_mu,conn_blockingpicker_mu,conn_csMgr_mu,conn_firstResolveEvent_o_m,conn_lceMu,conn_mu,conn_resolverWrapper_done_o_m,conn_resolverWrapper_pollingMu,conn_resolverWrapper_resolverMu,conn_safeConfigSelector_mu,child_NewEchoTestServiceClient5030);
	child_NewEchoTestServiceClient5030?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype NewEchoTestServiceClient503(Mutexdef cc_balancerWrapper_balancerMu;Mutexdef cc_balancerWrapper_done_o_m;Mutexdef cc_balancerWrapper_mu;Mutexdef cc_balancerWrapper_scBuffer_mu;Mutexdef cc_blockingpicker_mu;Mutexdef cc_csMgr_mu;Mutexdef cc_firstResolveEvent_o_m;Mutexdef cc_lceMu;Mutexdef cc_mu;Mutexdef cc_resolverWrapper_done_o_m;Mutexdef cc_resolverWrapper_pollingMu;Mutexdef cc_resolverWrapper_resolverMu;Mutexdef cc_safeConfigSelector_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
