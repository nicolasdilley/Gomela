...
// git_link=https://github.com/istio/istio/blob//pilot/pkg/networking/core/v1alpha3/route/retry/retry_test.go#L135
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRetryOnWithInvalidStatusCodesShouldAddToRetryOn1350 = [1] of {int};
	run TestRetryOnWithInvalidStatusCodesShouldAddToRetryOn135(child_TestRetryOnWithInvalidStatusCodesShouldAddToRetryOn1350);
	run receiver(child_TestRetryOnWithInvalidStatusCodesShouldAddToRetryOn1350)
stop_process:skip
}

proctype TestRetryOnWithInvalidStatusCodesShouldAddToRetryOn135(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
