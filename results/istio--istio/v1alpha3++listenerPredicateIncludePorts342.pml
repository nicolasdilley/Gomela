...
// git_link=https://github.com/istio/istio/blob//pilot/pkg/networking/core/v1alpha3/listener_builder.go#L342
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_listenerPredicateIncludePorts3420)
stop_process:skip
}
