...
// git_link=https://github.com/istio/istio/blob//pilot/pkg/networking/core/v1alpha3/route/route_internal_test.go#L282
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestTranslateCORSPolicy2820)
stop_process:skip
}
