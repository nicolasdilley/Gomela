...
// git_link=https://github.com/istio/istio/blob//security/pkg/stsservice/tokenmanager/sts_test.go#L44
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestStsFlow440)
stop_process:skip
}
...
proctype TestStsFlow44(chan child) {
	...
	run mutexMonitor(mockBackend_mutex);
		defer1: skip;
	run tearDownTest299(stsServer_stsServer_ErrorLog_mu,stsServer_stsServer_mu,stsServer_stsServer_nextProtoOnce_m,stsServer_stsServer_TLSConfig_mutex,mockBackend_mutex,mockBackend_server_ErrorLog_mu,mockBackend_server_mu,mockBackend_server_nextProtoOnce_m,mockBackend_server_TLSConfig_mutex,mockBackend_t_context_match_mu,mockBackend_t_context_mu,child_tearDownTest2990);
	child_tearDownTest2990?0;
	stop_process: skip;
	child!0
}
proctype tearDownTest299(Mutexdef stsServer_stsServer_ErrorLog_mu;Mutexdef stsServer_stsServer_mu;Mutexdef stsServer_stsServer_nextProtoOnce_m;Mutexdef stsServer_stsServer_TLSConfig_mutex;Mutexdef backend_mutex;Mutexdef backend_server_ErrorLog_mu;Mutexdef backend_server_mu;Mutexdef backend_server_nextProtoOnce_m;Mutexdef backend_server_TLSConfig_mutex;Mutexdef backend_t_context_match_mu;Mutexdef backend_t_context_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
