...
// git_link=https://github.com/istio/istio/blob//pilot/pkg/networking/core/v1alpha3/route/retry/retry_test.go#L152
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestMissingRetryOnShouldReturnDefaults1520 = [1] of {int};
	run TestMissingRetryOnShouldReturnDefaults152(child_TestMissingRetryOnShouldReturnDefaults1520);
	run receiver(child_TestMissingRetryOnShouldReturnDefaults1520)
stop_process:skip
}

proctype TestMissingRetryOnShouldReturnDefaults152(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
