...
// git_link=https://github.com/istio/istio/blob//galley/pkg/config/processing/snapshotter/strategy/debounce_test.go#L165
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestStrategy_NewWithDefaults1650)
stop_process:skip
}
