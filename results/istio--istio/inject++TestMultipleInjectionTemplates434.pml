...
// https://github.com/istio/istio/blob/master/pkg/kube/inject/inject_test.go#L434
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestMultipleInjectionTemplates434(chan child) {
	...
	run runWebhook555(webhook_mu,webhook_env_PushContext_proxyStatusMutex,webhook_env_PushContext_JwtKeyResolver_keyEntries_mu,webhook_env_PushContext_networksMu,webhook_env_PushContext_initializeMutex,webhook_env_TrustBundle_mutex,webhook_env_TrustBundle_endpointMutex,child_runWebhook5551);
