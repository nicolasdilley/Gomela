...
// git_link=https://github.com/istio/istio/blob//pilot/pkg/networking/core/v1alpha3/route/retry/retry_test.go#L168
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestMissingPerTryTimeoutShouldReturnNil1680 = [1] of {int};
	run TestMissingPerTryTimeoutShouldReturnNil168(child_TestMissingPerTryTimeoutShouldReturnNil1680);
	run receiver(child_TestMissingPerTryTimeoutShouldReturnNil1680)
stop_process:skip
}

proctype TestMissingPerTryTimeoutShouldReturnNil168(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
