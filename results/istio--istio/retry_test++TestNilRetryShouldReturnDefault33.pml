...
// git_link=https://github.com/istio/istio/blob//pilot/pkg/networking/core/v1alpha3/route/retry/retry_test.go#L33
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestNilRetryShouldReturnDefault330 = [1] of {int};
	run TestNilRetryShouldReturnDefault33(child_TestNilRetryShouldReturnDefault330);
	run receiver(child_TestNilRetryShouldReturnDefault330)
stop_process:skip
}

proctype TestNilRetryShouldReturnDefault33(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
