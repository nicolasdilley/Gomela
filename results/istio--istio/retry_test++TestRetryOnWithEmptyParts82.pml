...
// git_link=https://github.com/istio/istio/blob//pilot/pkg/networking/core/v1alpha3/route/retry/retry_test.go#L82
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRetryOnWithEmptyParts820 = [1] of {int};
	run TestRetryOnWithEmptyParts82(child_TestRetryOnWithEmptyParts820);
	run receiver(child_TestRetryOnWithEmptyParts820)
stop_process:skip
}

proctype TestRetryOnWithEmptyParts82(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
