...
// git_link=https://github.com/ipfs/go-ipfs/blob//core/corehttp/gateway_test.go#L709
typedef Wgdef {
...
init { 
	chan child_TestVersion7090 = [1] of {int};
	run TestVersion709(child_TestVersion7090);
	run receiver(child_TestVersion7090)
stop_process:skip
}

proctype TestVersion709(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
