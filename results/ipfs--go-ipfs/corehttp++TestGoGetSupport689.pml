...
// git_link=https://github.com/ipfs/go-ipfs/blob//core/corehttp/gateway_test.go#L689
typedef Wgdef {
...
init { 
	chan child_TestGoGetSupport6890 = [1] of {int};
	run TestGoGetSupport689(child_TestGoGetSupport6890);
	run receiver(child_TestGoGetSupport6890)
stop_process:skip
}

proctype TestGoGetSupport689(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
