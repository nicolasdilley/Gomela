...
// git_link=https://github.com/ipfs/go-ipfs/blob//core/corehttp/gateway_test.go#L664
typedef Wgdef {
...
init { 
	chan child_TestCacheControlImmutable6640 = [1] of {int};
	run TestCacheControlImmutable664(child_TestCacheControlImmutable6640);
	run receiver(child_TestCacheControlImmutable6640)
stop_process:skip
}

proctype TestCacheControlImmutable664(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
