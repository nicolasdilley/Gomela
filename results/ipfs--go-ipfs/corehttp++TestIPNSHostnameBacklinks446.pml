...
// git_link=https://github.com/ipfs/go-ipfs/blob//core/corehttp/gateway_test.go#L446
typedef Wgdef {
...
init { 
	chan child_TestIPNSHostnameBacklinks4460 = [1] of {int};
	run TestIPNSHostnameBacklinks446(child_TestIPNSHostnameBacklinks4460);
	run receiver(child_TestIPNSHostnameBacklinks4460)
stop_process:skip
}

proctype TestIPNSHostnameBacklinks446(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
