...
// git_link=https://github.com/ipfs/go-ipfs/blob//core/corehttp/gateway_test.go#L292
typedef Wgdef {
...
init { 
	chan child_TestPretty4042920 = [1] of {int};
	run TestPretty404292(child_TestPretty4042920);
	run receiver(child_TestPretty4042920)
stop_process:skip
}

proctype TestPretty404292(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
