...
// git_link=https://github.com/ipfs/go-ipfs/blob//core/corehttp/gateway_test.go#L212
typedef Wgdef {
...
init { 
	chan child_TestGatewayGet2120 = [1] of {int};
	run TestGatewayGet212(child_TestGatewayGet2120);
	run receiver(child_TestGatewayGet2120)
stop_process:skip
}

proctype TestGatewayGet212(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
