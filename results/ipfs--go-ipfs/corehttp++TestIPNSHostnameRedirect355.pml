...
// git_link=https://github.com/ipfs/go-ipfs/blob//core/corehttp/gateway_test.go#L355
typedef Wgdef {
...
init { 
	chan child_TestIPNSHostnameRedirect3550 = [1] of {int};
	run TestIPNSHostnameRedirect355(child_TestIPNSHostnameRedirect3550);
	run receiver(child_TestIPNSHostnameRedirect3550)
stop_process:skip
}

proctype TestIPNSHostnameRedirect355(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
