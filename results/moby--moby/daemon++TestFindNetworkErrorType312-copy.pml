...
// git_link=https://github.com/moby/moby/blob//daemon/daemon_test.go#L312
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestFindNetworkErrorType3120)
stop_process:skip
}
