...
// git_link=https://github.com/moby/moby/blob//daemon/logger/splunk/splunk_test.go#L1351
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestDeadlockOnBlockedEndpoint1351(chan child) {
	...
	run AnonymousTestDeadlockOnBlockedEndpoint13811380(done_ch,hec_mu,hec_test_context_match_mu,hec_test_context_mu,child_AnonymousTestDeadlockOnBlockedEndpoint138113802);
...
proctype AnonymousTestDeadlockOnBlockedEndpoint13811380(Chandef done_ch;Mutexdef hec_mu;Mutexdef hec_test_context_match_mu;Mutexdef hec_test_context_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
