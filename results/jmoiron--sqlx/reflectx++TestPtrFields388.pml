...
// git_link=https://github.com/jmoiron/sqlx/blob//reflectx/reflect_test.go#L388
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPtrFields3880 = [1] of {int};
	run TestPtrFields388(child_TestPtrFields3880);
	run receiver(child_TestPtrFields3880)
stop_process:skip
}

proctype TestPtrFields388(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
