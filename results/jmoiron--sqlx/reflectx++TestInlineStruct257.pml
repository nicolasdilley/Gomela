...
// git_link=https://github.com/jmoiron/sqlx/blob//reflectx/reflect_test.go#L257
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestInlineStruct2570 = [1] of {int};
	run TestInlineStruct257(child_TestInlineStruct2570);
	run receiver(child_TestInlineStruct2570)
stop_process:skip
}

proctype TestInlineStruct257(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
