...
// git_link=https://github.com/jmoiron/sqlx/blob//reflectx/reflect_test.go#L13
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBasic130 = [1] of {int};
	run TestBasic13(child_TestBasic130);
	run receiver(child_TestBasic130)
stop_process:skip
}

proctype TestBasic13(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
