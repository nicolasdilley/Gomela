...
// git_link=https://github.com/jmoiron/sqlx/blob//reflectx/reflect_test.go#L38
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBasicEmbedded380 = [1] of {int};
	run TestBasicEmbedded38(child_TestBasicEmbedded380);
	run receiver(child_TestBasicEmbedded380)
stop_process:skip
}

proctype TestBasicEmbedded38(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
