...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example247347044/cinterop/maximally_batched_work.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run go_cinteropwriteBatch(writeChan,writeChan);
	do
...
proctype go_cinteropwriteBatch(Chandef copyFrom;int copyFrom) {
	bool closed; 
	int i;
	do
