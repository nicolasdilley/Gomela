...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example201344943/worker/predicate_move.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype workerbatchAndProposeKeyValues(Chandef kvs;int kvs;chan child) {
	bool closed; 
	int i;
	do
	:: kvs.is_closed?state -> 
...
proctype Anonymous0(Chandef kvs;Chandef che) {
	...
	run workerbatchAndProposeKeyValues(kvs,kvs,child_workerbatchAndProposeKeyValues0);
