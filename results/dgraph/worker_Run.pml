#define lb_for947_0  -1
#define ub_for947_1  -1
#define lb_for1065_2  -1
#define ub_for1065_3  -1
#define lb_for1149_4  -1
#define ub_for1149_5  -1
...
init { 
	...
	run go_ncheckpointAndClose(done);
		for(i : lb_for1065_2.. ub_for1065_3) {
for20:		do
		:: done.async_rcv?0 -> 
			goto stop_process
		:: done.sync?0 -> 
