...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example218494222/gio/reporter.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	heartbeatWg.Add!1;
	run go_statusHeartbeat(heartbeatWg,finishedChan);
	run wgMonitor(wg);
	wg.Add!1;
...
proctype go_statusHeartbeat(Wgdef wg;Chandef finishedChan) {
	bool closed; 
	int i;
	bool state;
