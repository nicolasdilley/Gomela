#define NewFromConfig_conf_SpanChannelCapacity  0
#define NewFromConfig_ret_Workers  0

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example980743093/server.go
typedef Chandef {
	chan sync = [0] of {int};
