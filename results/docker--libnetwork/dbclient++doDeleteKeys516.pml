...
// https://github.com/docker/libnetwork/blob/954d1ddc998d8b6eb93afb628ae8ca122e53bca8/cmd/networkdb-test/dbclient/ndbClient.go#L516
typedef Chandef {
...
init { 
	...
	child_dbclientwaitWriters0?0;
		for(i : 0.. parallelWriters-1) {
		for30: skip;
		run go_deleteKeysNumber(doneCh,numberOfKeys);
		for30_end: skip
	};
	for30_exit: skip;
...
proctype go_deleteKeysNumber(Chandef doneCh;int number) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
