...
// git_link=https://github.com/grafana/loki/blob//pkg/ingester/flush_test.go#L42
#define def_var_testData  -2 // opt testData line 392
typedef Wgdef {
...
proctype TestChunkFlushingIdle42(chan child) {
	...
	int var_testData = def_var_testData;
	...
	run checkData392(store_mtx,var_testData,child_checkData3921);
