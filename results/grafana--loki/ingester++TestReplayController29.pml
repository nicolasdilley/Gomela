...
// git_link=https://github.com/grafana/loki/blob//pkg/ingester/replay_controller_test.go#L29
#define def_var_n46  ?? // mand n line 46
typedef Wgdef {
...
proctype TestReplayController29(chan child) {
	...
	Wgdef wg;
	Mutexdef opLock;
	int var_n = def_var_n46; // mand var_n
