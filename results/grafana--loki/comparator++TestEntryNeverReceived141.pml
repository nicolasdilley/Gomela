...
// git_link=https://github.com/grafana/loki/blob//pkg/canary/comparator/comparator_test.go#L141
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype confirmMissing427(Mutexdef c_entMtx;Mutexdef c_metTestMtx;Mutexdef c_missingMtx;Mutexdef c_pruneMtx;Mutexdef c_spotEntMtx;Mutexdef c_spotMtx;chan child) {
	...
	bool state;
	int num_msgs;
	int var_removed = -2; // opt var_removed
	int var_k = -2; // opt var_k
	int var_recvd = -2; // opt var_recvd
	int var_c_missingEntries = -2; // opt var_c_missingEntries
