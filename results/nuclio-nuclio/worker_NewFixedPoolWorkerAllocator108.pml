...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example327401396/pkg/processor/worker/allocator.go
typedef Chandef {
...
init { 
	...
	:: workers-1 != -3 -> 
			...
			:: newFixedPool_workerChan.sync!false,0 -> 
				newFixedPool_workerChan.sending?state
			fi;
			for10_end: skip
		};
		for10_exit: skip
