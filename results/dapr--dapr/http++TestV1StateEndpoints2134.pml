...
// https://github.com/dapr/dapr/blob/master/pkg/http/api_test.go#L2134
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestV1StateEndpoints21340 = [1] of {int};
	run TestV1StateEndpoints2134(child_TestV1StateEndpoints21340)
stop_process:skip
}

proctype TestV1StateEndpoints2134(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
