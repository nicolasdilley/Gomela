...
// git_link=https://github.com/dapr/dapr/blob//pkg/actors/actors_test.go#L248
typedef Wgdef {
...
proctype TestSetReminderTrack248(chan child) {
	...
	run updateReminderTrack594(testActorsRuntime_placement_shutdownConnLoop,testActorsRuntime_activeReminders_mu,testActorsRuntime_activeRemindersLock,testActorsRuntime_activeTimers_mu,testActorsRuntime_activeTimersLock,testActorsRuntime_actorsTable_mu,testActorsRuntime_evaluationLock,testActorsRuntime_placement_clientConn_balancerWrapper_balancerMu,testActorsRuntime_placement_clientConn_balancerWrapper_mu,testActorsRuntime_placement_clientConn_blockingpicker_mu,testActorsRuntime_placement_clientConn_csMgr_mu,testActorsRuntime_placement_clientConn_lceMu,testActorsRuntime_placement_clientConn_mu,testActorsRuntime_placement_clientConn_resolverWrapper_pollingMu,testActorsRuntime_placement_clientConn_resolverWrapper_resolverMu,testActorsRuntime_placement_clientConn_safeConfigSelector_mu,testActorsRuntime_placement_operationUpdateLock,testActorsRuntime_placement_placementTableLock,testActorsRuntime_remindersLock,child_updateReminderTrack5940);
	child_updateReminderTrack5940?0;
	stop_process: skip;
	child!0
}
proctype updateReminderTrack594(Wgdef a_placement_shutdownConnLoop;Mutexdef a_activeReminders_mu;Mutexdef a_activeRemindersLock;Mutexdef a_activeTimers_mu;Mutexdef a_activeTimersLock;Mutexdef a_actorsTable_mu;Mutexdef a_evaluationLock;Mutexdef a_placement_clientConn_balancerWrapper_balancerMu;Mutexdef a_placement_clientConn_balancerWrapper_mu;Mutexdef a_placement_clientConn_blockingpicker_mu;Mutexdef a_placement_clientConn_csMgr_mu;Mutexdef a_placement_clientConn_lceMu;Mutexdef a_placement_clientConn_mu;Mutexdef a_placement_clientConn_resolverWrapper_pollingMu;Mutexdef a_placement_clientConn_resolverWrapper_resolverMu;Mutexdef a_placement_clientConn_safeConfigSelector_mu;Mutexdef a_placement_operationUpdateLock;Mutexdef a_placement_placementTableLock;Mutexdef a_remindersLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
