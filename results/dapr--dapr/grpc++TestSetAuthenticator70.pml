...
// git_link=https://github.com/dapr/dapr/blob//pkg/grpc/grpc_test.go#L70
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestSetAuthenticator70(chan child) {
	...
	run SetAuthenticator51(m_AppClient_balancerWrapper_balancerMu,m_AppClient_balancerWrapper_mu,m_AppClient_balancerWrapper_scBuffer_mu,m_AppClient_blockingpicker_mu,m_AppClient_csMgr_mu,m_AppClient_firstResolveEvent_o_m,m_AppClient_lceMu,m_AppClient_mu,m_AppClient_resolverWrapper_pollingMu,m_AppClient_resolverWrapper_resolverMu,m_AppClient_safeConfigSelector_mu,m_lock,child_SetAuthenticator510);
	child_SetAuthenticator510?0;
	stop_process: skip;
	child!0
}
proctype SetAuthenticator51(Mutexdef g_AppClient_balancerWrapper_balancerMu;Mutexdef g_AppClient_balancerWrapper_mu;Mutexdef g_AppClient_balancerWrapper_scBuffer_mu;Mutexdef g_AppClient_blockingpicker_mu;Mutexdef g_AppClient_csMgr_mu;Mutexdef g_AppClient_firstResolveEvent_o_m;Mutexdef g_AppClient_lceMu;Mutexdef g_AppClient_mu;Mutexdef g_AppClient_resolverWrapper_pollingMu;Mutexdef g_AppClient_resolverWrapper_resolverMu;Mutexdef g_AppClient_safeConfigSelector_mu;Mutexdef g_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
