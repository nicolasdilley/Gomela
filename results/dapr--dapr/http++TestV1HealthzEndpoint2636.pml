...
// https://github.com/dapr/dapr/blob/master/pkg/http/api_test.go#L2636
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestV1HealthzEndpoint26360 = [1] of {int};
	run TestV1HealthzEndpoint2636(child_TestV1HealthzEndpoint26360)
stop_process:skip
}

proctype TestV1HealthzEndpoint2636(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
