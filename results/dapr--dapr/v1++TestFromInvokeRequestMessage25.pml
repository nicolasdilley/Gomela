...
// git_link=https://github.com/dapr/dapr/blob//pkg/messaging/v1/invoke_method_request_test.go#L25
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestFromInvokeRequestMessage250)
stop_process:skip
}
...
proctype TestFromInvokeRequestMessage25(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_GetVer1421 = [1] of {int};
	...
	run FromInvokeRequestMessage42(pb_Data_state_atomicMessageInfo_initMu,pb_HttpExtension_state_atomicMessageInfo_initMu,pb_state_atomicMessageInfo_initMu,child_FromInvokeRequestMessage420);
	child_FromInvokeRequestMessage420?0;
	run GetVer142(req_r_state_atomicMessageInfo_initMu,child_GetVer1421);
	child_GetVer1421?0;
	stop_process: skip;
	child!0
}
proctype FromInvokeRequestMessage42(Mutexdef pb_Data_state_atomicMessageInfo_initMu;Mutexdef pb_HttpExtension_state_atomicMessageInfo_initMu;Mutexdef pb_state_atomicMessageInfo_initMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
