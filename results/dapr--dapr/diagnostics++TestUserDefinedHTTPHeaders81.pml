...
// git_link=https://github.com/dapr/dapr/blob//pkg/diagnostics/http_tracing_test.go#L81
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestUserDefinedHTTPHeaders81(chan child) {
	...
	run userDefinedHTTPHeaders74(reqCtx_s_mu,reqCtx_s_perIPConnCounter_lock,reqCtx_s_tlsConfig_mutex,child_userDefinedHTTPHeaders740);
	child_userDefinedHTTPHeaders740?0;
	stop_process: skip;
	child!0
}
proctype userDefinedHTTPHeaders74(Mutexdef reqCtx_s_mu;Mutexdef reqCtx_s_perIPConnCounter_lock;Mutexdef reqCtx_s_tlsConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
