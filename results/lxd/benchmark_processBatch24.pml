#define processBatch_batches  ??
#define processBatch_batchSize  ??
#define processBatch_remainder  ??

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example969468586/lxd-benchmark/benchmark/batch.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
