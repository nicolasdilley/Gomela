...
// git_link=https://github.com/hyperledger/fabric/blob//core/ledger/kvledger/tests/v1x_test.go#L288
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestInitLedgerPanicWithV13Data2880 = [1] of {int};
	run TestInitLedgerPanicWithV13Data288(child_TestInitLedgerPanicWithV13Data2880);
	run receiver(child_TestInitLedgerPanicWithV13Data2880)
stop_process:skip
}

proctype TestInitLedgerPanicWithV13Data288(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
