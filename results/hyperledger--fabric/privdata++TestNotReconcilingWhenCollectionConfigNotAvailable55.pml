...
// git_link=https://github.com/hyperledger/fabric/blob//gossip/privdata/reconcile_test.go#L55
...
init { 
	chan child_TestNotReconcilingWhenCollectionConfigNotAvailable550 = [1] of {int};
	run TestNotReconcilingWhenCollectionConfigNotAvailable55(child_TestNotReconcilingWhenCollectionConfigNotAvailable550);
	run receiver(child_TestNotReconcilingWhenCollectionConfigNotAvailable550)
stop_process:skip
}

proctype TestNotReconcilingWhenCollectionConfigNotAvailable55(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
