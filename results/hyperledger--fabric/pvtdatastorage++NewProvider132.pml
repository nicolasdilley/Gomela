...
// git_link=https://github.com/hyperledger/fabric/blob//core/ledger/pvtdatastorage/store.go#L132
typedef Wgdef {
...
init { 
	chan child_NewProvider1320 = [1] of {int};
	run NewProvider132(child_NewProvider1320);
	run receiver(child_NewProvider1320)
stop_process:skip
}

proctype NewProvider132(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
