...
// git_link=https://github.com/hyperledger/fabric/blob//core/ledger/kvledger/txmgmt/statedb/stateleveldb/stateleveldb_test.go#L65
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestQueryOnLevelDB650 = [1] of {int};
	run TestQueryOnLevelDB65(child_TestQueryOnLevelDB650);
	run receiver(child_TestQueryOnLevelDB650)
stop_process:skip
}

proctype TestQueryOnLevelDB65(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
