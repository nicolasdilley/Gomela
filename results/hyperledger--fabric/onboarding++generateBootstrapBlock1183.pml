...
// git_link=https://github.com/hyperledger/fabric/blob//orderer/common/onboarding/onboarding_test.go#L1183
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_generateBootstrapBlock11830 = [1] of {int};
	run generateBootstrapBlock1183(child_generateBootstrapBlock11830);
	run receiver(child_generateBootstrapBlock11830)
stop_process:skip
}

proctype generateBootstrapBlock1183(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
