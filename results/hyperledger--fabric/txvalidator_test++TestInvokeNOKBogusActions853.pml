...
// git_link=https://github.com/hyperledger/fabric/blob//core/committer/txvalidator/v20/validator_test.go#L853
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestInvokeNOKBogusActions8530 = [1] of {int};
	run TestInvokeNOKBogusActions853(child_TestInvokeNOKBogusActions8530);
	run receiver(child_TestInvokeNOKBogusActions8530)
stop_process:skip
}

proctype TestInvokeNOKBogusActions853(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
