...
// git_link=https://github.com/hyperledger/fabric/blob//common/ledger/blockledger/fileledger/impl_test.go#L220
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBlockedRetrieval2200 = [1] of {int};
	run TestBlockedRetrieval220(child_TestBlockedRetrieval2200);
	run receiver(child_TestBlockedRetrieval2200)
stop_process:skip
}

proctype TestBlockedRetrieval220(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
