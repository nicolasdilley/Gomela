...
// git_link=https://github.com/hyperledger/fabric/blob//core/ledger/kvledger/txmgmt/statedb/stateleveldb/stateleveldb_test.go#L131
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestApplyUpdatesWithNilHeight1310 = [1] of {int};
	run TestApplyUpdatesWithNilHeight131(child_TestApplyUpdatesWithNilHeight1310);
	run receiver(child_TestApplyUpdatesWithNilHeight1310)
stop_process:skip
}

proctype TestApplyUpdatesWithNilHeight131(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Cleanup370 = [1] of {int};
	chan child_TestApplyUpdatesWithNilHeight10031 = [1] of {int};
	...
	run TestApplyUpdatesWithNilHeight1003(env_DBProvider_dbProvider_db_mutex,env_DBProvider_dbProvider_mux,child_TestApplyUpdatesWithNilHeight10031);
	child_TestApplyUpdatesWithNilHeight10031?0;
		defer1: skip;
