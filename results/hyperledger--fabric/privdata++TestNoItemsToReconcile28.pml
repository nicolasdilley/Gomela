...
// git_link=https://github.com/hyperledger/fabric/blob//gossip/privdata/reconcile_test.go#L28
...
init { 
	chan child_TestNoItemsToReconcile280 = [1] of {int};
	run TestNoItemsToReconcile28(child_TestNoItemsToReconcile280);
	run receiver(child_TestNoItemsToReconcile280)
stop_process:skip
}

proctype TestNoItemsToReconcile28(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
