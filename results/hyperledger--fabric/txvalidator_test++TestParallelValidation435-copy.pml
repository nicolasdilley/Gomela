...
// git_link=https://github.com/hyperledger/fabric/blob//core/committer/txvalidator/v20/validator_test.go#L435
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestParallelValidation4350 = [1] of {int};
	run TestParallelValidation435(child_TestParallelValidation4350);
	run receiver(child_TestParallelValidation4350)
stop_process:skip
}

proctype TestParallelValidation435(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
