...
// git_link=https://github.com/hyperledger/fabric/blob//core/ledger/kvledger/txmgmt/statedb/statecouchdb/couchdbutil.go#L44
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_createCouchInstance440 = [1] of {int};
	run createCouchInstance44(child_createCouchInstance440);
	run receiver(child_createCouchInstance440)
stop_process:skip
}

proctype createCouchInstance44(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
