...
// git_link=https://github.com/hyperledger/fabric/blob//core/ledger/kvledger/history/pkg_test.go#L105
typedef Wgdef {
...
init { 
	chan child_newBlockStorageTestEnv1050 = [1] of {int};
	run newBlockStorageTestEnv105(child_newBlockStorageTestEnv1050);
	run receiver(child_newBlockStorageTestEnv1050)
stop_process:skip
}

proctype newBlockStorageTestEnv105(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
