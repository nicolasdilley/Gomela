...
// git_link=https://github.com/hyperledger/fabric/blob//common/flogging/core_test.go#L98
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestCoreWrite980 = [1] of {int};
	run TestCoreWrite98(child_TestCoreWrite980);
	run receiver(child_TestCoreWrite980)
stop_process:skip
}

proctype TestCoreWrite98(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
