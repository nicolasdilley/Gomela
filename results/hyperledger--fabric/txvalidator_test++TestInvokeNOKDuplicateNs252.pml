...
// git_link=https://github.com/hyperledger/fabric/blob//core/committer/txvalidator/v20/validator_test.go#L252
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestInvokeNOKDuplicateNs2520 = [1] of {int};
	run TestInvokeNOKDuplicateNs252(child_TestInvokeNOKDuplicateNs2520);
	run receiver(child_TestInvokeNOKDuplicateNs2520)
stop_process:skip
}

proctype TestInvokeNOKDuplicateNs252(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
