...
// git_link=https://github.com/gocolly/colly/blob//unmarshal_test.go#L51
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestNestedUnmarshalMap510)
stop_process:skip
}
...
proctype TestNestedUnmarshalMap51(chan child) {
	...
	run UnmarshalWithMap31(e_Request_collector_wg,e_Response_Request_collector_wg,e_Request_Ctx_lock,e_Request_collector_backend_lock,e_Request_collector_lock,e_Response_Ctx_lock,e_Response_Request_Ctx_lock,e_Response_Request_collector_lock,child_UnmarshalWithMap310);
	child_UnmarshalWithMap310?0;
	run UnmarshalWithMap31(e2_Request_collector_wg,e2_Response_Request_collector_wg,e2_Request_Ctx_lock,e2_Request_collector_backend_lock,e2_Request_collector_lock,e2_Response_Ctx_lock,e2_Response_Request_Ctx_lock,e2_Response_Request_collector_lock,child_UnmarshalWithMap311);
	child_UnmarshalWithMap311?0;
	stop_process: skip;
	child!0
}
proctype UnmarshalWithMap31(Wgdef h_Request_collector_wg;Wgdef h_Response_Request_collector_wg;Mutexdef h_Request_Ctx_lock;Mutexdef h_Request_collector_backend_lock;Mutexdef h_Request_collector_lock;Mutexdef h_Response_Ctx_lock;Mutexdef h_Response_Request_Ctx_lock;Mutexdef h_Response_Request_collector_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
