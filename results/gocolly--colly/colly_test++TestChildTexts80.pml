...
// git_link=https://github.com/gocolly/colly/blob//xmlelement_test.go#L80
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestChildTexts800)
stop_process:skip
}
...
proctype TestChildTexts80(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_ChildTexts1572 = [1] of {int};
	chan child_ChildTexts1571 = [1] of {int};
	...
	run ChildTexts157(xmlElem_Request_collector_wg,xmlElem_Response_Request_collector_wg,xmlElem_Request_Ctx_lock,xmlElem_Request_collector_backend_lock,xmlElem_Request_collector_lock,xmlElem_Response_Ctx_lock,xmlElem_Response_Request_Ctx_lock,xmlElem_Response_Request_collector_lock,child_ChildTexts1571);
	child_ChildTexts1571?0;
	run ChildTexts157(xmlElem_Request_collector_wg,xmlElem_Response_Request_collector_wg,xmlElem_Request_Ctx_lock,xmlElem_Request_collector_backend_lock,xmlElem_Request_collector_lock,xmlElem_Response_Ctx_lock,xmlElem_Response_Request_Ctx_lock,xmlElem_Response_Request_collector_lock,child_ChildTexts1572);
	child_ChildTexts1572?0;
	stop_process: skip;
	child!0
}
...
proctype ChildTexts157(Wgdef h_Request_collector_wg;Wgdef h_Response_Request_collector_wg;Mutexdef h_Request_Ctx_lock;Mutexdef h_Request_collector_backend_lock;Mutexdef h_Request_collector_lock;Mutexdef h_Response_Ctx_lock;Mutexdef h_Response_Request_Ctx_lock;Mutexdef h_Response_Request_collector_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	int var_htmlquery_Find = -2; // opt var_htmlquery_Find
	goto stop_process;
	stop_process: skip;
	child!0
}
