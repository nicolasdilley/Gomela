...
// git_link=https://github.com/gocolly/colly/blob//colly_test.go#L1093
typedef Wgdef {
...
proctype TestHTMLElement1093(chan child) {
	...
	run Attr56(v_Request_collector_wg,v_Response_Request_collector_wg,v_Request_Ctx_lock,v_Request_collector_backend_lock,v_Request_collector_lock,v_Response_Ctx_lock,v_Response_Request_Ctx_lock,v_Response_Request_collector_lock,child_Attr560);
	child_Attr560?0;
	

	if
	:: true -> 
		run Attr56(v_Request_collector_wg,v_Response_Request_collector_wg,v_Request_Ctx_lock,v_Request_collector_backend_lock,v_Request_collector_lock,v_Response_Ctx_lock,v_Response_Request_Ctx_lock,v_Response_Request_collector_lock,child_Attr561);
		child_Attr561?0
	:: true;
	fi;
	stop_process: skip;
...
proctype Attr56(Wgdef h_Request_collector_wg;Wgdef h_Response_Request_collector_wg;Mutexdef h_Request_Ctx_lock;Mutexdef h_Request_collector_backend_lock;Mutexdef h_Request_collector_lock;Mutexdef h_Response_Ctx_lock;Mutexdef h_Response_Request_Ctx_lock;Mutexdef h_Response_Request_collector_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	int var_h_attributes = -2; // opt var_h_attributes
	goto stop_process;
	stop_process: skip;
	child!0
}
