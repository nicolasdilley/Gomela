...
// git_link=https://github.com/gocolly/colly/blob//xmlelement_test.go#L107
typedef Wgdef {
...
init { 
	chan child_TestChildAttrs1070 = [1] of {int};
	run TestChildAttrs107(child_TestChildAttrs1070);
	run receiver(child_TestChildAttrs1070)
stop_process:skip
}

proctype TestChildAttrs107(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_ChildAttrs1331 = [1] of {int};
	...
	run ChildAttrs133(xmlElem_Request_collector_wg,xmlElem_Response_Request_collector_wg,xmlElem_Request_Ctx_lock,xmlElem_Request_collector_backend_lock,xmlElem_Request_collector_lock,xmlElem_Response_Ctx_lock,xmlElem_Response_Request_Ctx_lock,xmlElem_Response_Request_collector_lock,child_ChildAttrs1331);
	child_ChildAttrs1331?0;
	stop_process: skip;
	child!0
}
...
proctype ChildAttrs133(Wgdef h_Request_collector_wg;Wgdef h_Response_Request_collector_wg;Mutexdef h_Request_Ctx_lock;Mutexdef h_Request_collector_backend_lock;Mutexdef h_Request_collector_lock;Mutexdef h_Response_Ctx_lock;Mutexdef h_Response_Request_Ctx_lock;Mutexdef h_Response_Request_collector_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
