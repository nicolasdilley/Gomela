...
// git_link=https://github.com/hashicorp/terraform/blob//plugin/grpc_provisioner_test.go#L131
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestGRPCProvisioner_Stop1310)
stop_process:skip
}
...
proctype TestGRPCProvisioner_Stop131(chan child) {
	...
	run Stop157(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_mu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,child_Stop1570);
	child_Stop1570?0;
	stop_process: skip;
	child!0
}
proctype Stop157(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Mutexdef p_mu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
