...
// git_link=https://github.com/hashicorp/terraform/blob//backend/remote-state/manta/backend_test.go#L35
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestBackend350)
stop_process:skip
}
...
proctype TestBackend35(chan child) {
	...
	run TestBackendStates74(b_data_diff_mu,b_data_newState_mu,b_data_once_m,b_data_setWriter_lock,b_data_state_mu,child_TestBackendStates740);
	child_TestBackendStates740?0;
	stop_process: skip;
	child!0
}
proctype TestBackendStates74(Mutexdef b_data_diff_mu;Mutexdef b_data_newState_mu;Mutexdef b_data_once_m;Mutexdef b_data_setWriter_lock;Mutexdef b_data_state_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
