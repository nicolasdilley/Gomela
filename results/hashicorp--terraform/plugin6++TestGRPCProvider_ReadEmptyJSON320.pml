...
// https://github.com/hashicorp/terraform/blob/master/plugin6/grpc_provider_test.go#L320
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ReadEmptyJSON3200 = [1] of {int};
	run TestGRPCProvider_ReadEmptyJSON320(child_TestGRPCProvider_ReadEmptyJSON3200)
stop_process:skip
}

proctype TestGRPCProvider_ReadEmptyJSON320(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
