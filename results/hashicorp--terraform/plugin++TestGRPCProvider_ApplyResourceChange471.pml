...
// https://github.com/hashicorp/terraform/blob/master/plugin/grpc_provider_test.go#L471
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ApplyResourceChange4710 = [1] of {int};
	run TestGRPCProvider_ApplyResourceChange471(child_TestGRPCProvider_ApplyResourceChange4710)
stop_process:skip
}

proctype TestGRPCProvider_ApplyResourceChange471(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype ApplyResourceChange444(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_PluginClient_config_Cmd_Process_sigMu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_mu;chan child) {
	...
	Mutexdef protoReq_PlannedState_state_atomicMessageInfo_initMu;
	...
	run getProviderMetaSchema113(p_TestServer_serveWG,p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_PluginClient_config_Cmd_Process_sigMu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_mu,p_TestServer_quit_o_m,p_TestServer_done_o_m,p_TestServer_channelzRemoveOnce_m,p_mu,child_getProviderMetaSchema1131);
	...
	run mutexMonitor(protoReq_PlannedState_state_atomicMessageInfo_initMu);
	...
	run mutexMonitor(protoResp_NewState_state_atomicMessageInfo_initMu);
	...
	run decodeDynamicValue606(protoResp_NewState_state_atomicMessageInfo_initMu,child_decodeDynamicValue6062);
...
proctype getProviderMetaSchema113(Wgdef p_TestServer_serveWG;Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Mutexdef p_PluginClient_config_Cmd_Process_sigMu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_mu;chan child) {
	...
	run getSchema69(p_TestServer_serveWG,p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_PluginClient_config_Cmd_Process_sigMu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_mu,p_TestServer_quit_o_m,p_TestServer_done_o_m,p_TestServer_channelzRemoveOnce_m,p_mu,child_getSchema691);
