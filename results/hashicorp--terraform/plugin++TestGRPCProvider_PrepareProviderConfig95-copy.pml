...
// git_link=https://github.com/hashicorp/terraform/blob//plugin/grpc_provider_test.go#L95
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_PrepareProviderConfig950 = [1] of {int};
	run TestGRPCProvider_PrepareProviderConfig95(child_TestGRPCProvider_PrepareProviderConfig950);
	run receiver(child_TestGRPCProvider_PrepareProviderConfig950)
stop_process:skip
}

proctype TestGRPCProvider_PrepareProviderConfig95(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_ValidateProviderConfig1690 = [1] of {int};
	Mutexdef p_mu;
...
proctype ValidateProviderConfig169(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_mu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;chan child) {
	...
	run mutexMonitor(protoResp_PreparedConfig_state_atomicMessageInfo_initMu);
	...
	run decodeDynamicValue606(protoResp_PreparedConfig_state_atomicMessageInfo_initMu,child_decodeDynamicValue6061);
