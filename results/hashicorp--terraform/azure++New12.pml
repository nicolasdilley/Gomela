...
// git_link=https://github.com/hashicorp/terraform/blob//backend/remote-state/azure/backend.go#L12
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run New12(child_New120);
	run receiver(child_New120)
stop_process:skip
}

proctype New12(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
