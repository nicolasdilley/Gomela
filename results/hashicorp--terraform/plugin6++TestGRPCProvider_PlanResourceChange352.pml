...
// https://github.com/hashicorp/terraform/blob/master/plugin6/grpc_provider_test.go#L352
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_PlanResourceChange3520 = [1] of {int};
	run TestGRPCProvider_PlanResourceChange352(child_TestGRPCProvider_PlanResourceChange3520)
stop_process:skip
}

proctype TestGRPCProvider_PlanResourceChange352(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype PlanResourceChange378(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_PluginClient_config_Cmd_Process_sigMu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_mu;chan child) {
	...
	:: protoResp_RequiresReplace-1 != -3 -> 
			...
			for30: skip;
			run AttributePathToPath82(p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_PluginClient_clientWaitGroup,p_PluginClient_config_Cmd_Process_sigMu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_mu,p_TestServer_quit_o_m,p_TestServer_done_o_m,p_TestServer_channelzRemoveOnce_m,p_mu,child_AttributePathToPath823);
