...
// git_link=https://github.com/hashicorp/terraform/blob//plugin/grpc_provider_test.go#L180
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_UpgradeResourceStateJSON1800 = [1] of {int};
	run TestGRPCProvider_UpgradeResourceStateJSON180(child_TestGRPCProvider_UpgradeResourceStateJSON1800);
	run receiver(child_TestGRPCProvider_UpgradeResourceStateJSON1800)
stop_process:skip
}

proctype TestGRPCProvider_UpgradeResourceStateJSON180(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_UpgradeResourceState2520 = [1] of {int};
	Mutexdef p_mu;
	...
	run UpgradeResourceState252(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_mu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_channelzRemoveOnce_m,p_TestServer_done_o_m,p_TestServer_mu,p_TestServer_quit_o_m,child_UpgradeResourceState2520);
	child_UpgradeResourceState2520?0;
	stop_process: skip;
	child!0
}
proctype UpgradeResourceState252(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_mu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_decodeDynamicValue6061 = [1] of {int};
	Mutexdef protoResp_UpgradedState_state_atomicMessageInfo_initMu;
	Mutexdef protoResp_state_atomicMessageInfo_initMu;
	Mutexdef protoReq_RawState_state_atomicMessageInfo_initMu;
	Mutexdef protoReq_state_atomicMessageInfo_initMu;
	chan child_getResourceSchema910 = [1] of {int};
	run getResourceSchema91(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_mu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_channelzRemoveOnce_m,p_TestServer_done_o_m,p_TestServer_mu,p_TestServer_quit_o_m,child_getResourceSchema910);
	child_getResourceSchema910?0;
	run mutexMonitor(protoReq_state_atomicMessageInfo_initMu);
	run mutexMonitor(protoReq_RawState_state_atomicMessageInfo_initMu);
	run mutexMonitor(protoResp_state_atomicMessageInfo_initMu);
	run mutexMonitor(protoResp_UpgradedState_state_atomicMessageInfo_initMu);
	...
	run decodeDynamicValue606(protoResp_UpgradedState_state_atomicMessageInfo_initMu,child_decodeDynamicValue6061);
	child_decodeDynamicValue6061?0;
...
proctype getResourceSchema91(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_mu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_getSchema690 = [1] of {int};
	run getSchema69(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_mu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_channelzRemoveOnce_m,p_TestServer_done_o_m,p_TestServer_mu,p_TestServer_quit_o_m,child_getSchema690);
...
proctype getSchema69(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_mu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;chan child) {
	...
	p_mu.Unlock!false;
	run GetProviderSchema118(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_mu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_channelzRemoveOnce_m,p_TestServer_done_o_m,p_TestServer_mu,p_TestServer_quit_o_m,child_GetProviderSchema1180);
