...
// git_link=https://github.com/hashicorp/terraform/blob//internal/moduletest/provider_test.go#L12
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestProvider12(chan child) {
	...
	Mutexdef p_mutex;
	int var_assertionConfig_Type_TestConformance = -2; // opt var_assertionConfig_Type_TestConformance
