...
// git_link=https://github.com/hashicorp/terraform/blob//plugin6/grpc_provider_test.go#L118
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ValidateResourceConfig1180 = [1] of {int};
	run TestGRPCProvider_ValidateResourceConfig118(child_TestGRPCProvider_ValidateResourceConfig1180);
	run receiver(child_TestGRPCProvider_ValidateResourceConfig1180)
stop_process:skip
}

proctype TestGRPCProvider_ValidateResourceConfig118(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
