...
// https://github.com/hashicorp/terraform/blob/master/plugin/grpc_provider_test.go#L345
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_PlanResourceChange3450 = [1] of {int};
	run TestGRPCProvider_PlanResourceChange345(child_TestGRPCProvider_PlanResourceChange3450)
stop_process:skip
}

proctype TestGRPCProvider_PlanResourceChange345(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype PlanResourceChange378(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_PluginClient_config_Cmd_Process_sigMu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_mu;chan child) {
	...
	run decodeDynamicValue606(protoResp_PlannedState_state_atomicMessageInfo_initMu,child_decodeDynamicValue6062);
