...
// https://github.com/hashicorp/terraform/blob/master/plugin/grpc_provider_test.go#L247
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ReadResource2470 = [1] of {int};
	run TestGRPCProvider_ReadResource247(child_TestGRPCProvider_ReadResource2470)
stop_process:skip
}

proctype TestGRPCProvider_ReadResource247(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
