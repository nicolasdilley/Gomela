...
// https://github.com/hashicorp/terraform/blob/master/plugin6/grpc_provider_test.go#L287
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ReadResourceJSON2870 = [1] of {int};
	run TestGRPCProvider_ReadResourceJSON287(child_TestGRPCProvider_ReadResourceJSON2870)
stop_process:skip
}

proctype TestGRPCProvider_ReadResourceJSON287(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
