...
// git_link=https://github.com/hashicorp/terraform/blob//plugin/grpc_provider_test.go#L230
typedef Wgdef {
...
proctype TestGRPCProvider_Stop230(chan child) {
	...
	run Stop319(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_mu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_channelzRemoveOnce_m,p_TestServer_done_o_m,p_TestServer_mu,p_TestServer_quit_o_m,child_Stop3190);
	child_Stop3190?0;
	stop_process: skip;
	child!0
}
