...
// git_link=https://github.com/hashicorp/terraform/blob//plugin/grpc_provider_test.go#L149
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_UpgradeResourceState1490 = [1] of {int};
	run TestGRPCProvider_UpgradeResourceState149(child_TestGRPCProvider_UpgradeResourceState1490);
	run receiver(child_TestGRPCProvider_UpgradeResourceState1490)
stop_process:skip
}

proctype TestGRPCProvider_UpgradeResourceState149(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
