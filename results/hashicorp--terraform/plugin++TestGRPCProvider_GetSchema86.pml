...
// git_link=https://github.com/hashicorp/terraform/blob//plugin/grpc_provider_test.go#L86
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_GetSchema860 = [1] of {int};
	run TestGRPCProvider_GetSchema86(child_TestGRPCProvider_GetSchema860);
	run receiver(child_TestGRPCProvider_GetSchema860)
stop_process:skip
}

proctype TestGRPCProvider_GetSchema86(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
