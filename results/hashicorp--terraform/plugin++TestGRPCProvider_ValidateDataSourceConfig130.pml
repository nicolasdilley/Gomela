...
// git_link=https://github.com/hashicorp/terraform/blob//plugin/grpc_provider_test.go#L130
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ValidateDataSourceConfig1300 = [1] of {int};
	run TestGRPCProvider_ValidateDataSourceConfig130(child_TestGRPCProvider_ValidateDataSourceConfig1300);
	run receiver(child_TestGRPCProvider_ValidateDataSourceConfig1300)
stop_process:skip
}

proctype TestGRPCProvider_ValidateDataSourceConfig130(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype ValidateDataResourceConfig227(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_mu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;chan child) {
	...
	run getDatasourceSchema102(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_mu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_channelzRemoveOnce_m,p_TestServer_done_o_m,p_TestServer_mu,p_TestServer_quit_o_m,child_getDatasourceSchema1020);
