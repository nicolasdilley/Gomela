...
// git_link=https://github.com/hashicorp/terraform/blob//internal/tfplugin5/tfplugin5.pb.go#L5238
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child__Provisioner_ProvisionResource_Handler52380)
stop_process:skip
}
