...
// git_link=https://github.com/hashicorp/terraform/blob//plugin/grpc_provisioner_test.go#L64
typedef Wgdef {
...
proctype TestGRPCProvisioner_ValidateProvisionerConfig64(chan child) {
	...
	run ValidateProvisionerConfig80(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_mu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,child_ValidateProvisionerConfig800);
	child_ValidateProvisionerConfig800?0;
	stop_process: skip;
	child!0
}
proctype ValidateProvisionerConfig80(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Mutexdef p_mu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
