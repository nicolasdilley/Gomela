...
// git_link=https://github.com/hashicorp/packer/blob//builder/digitalocean/wait.go#L63
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype waitForDropletState63(chan child) {
	...
	run AnonymouswaitForDropletState7069(result_ch,done_ch,child_AnonymouswaitForDropletState70690);
...
proctype AnonymouswaitForDropletState7069(Chandef result_ch;Chandef done_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
