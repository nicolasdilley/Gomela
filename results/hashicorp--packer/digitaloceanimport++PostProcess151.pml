...
// git_link=https://github.com/hashicorp/packer/blob//post-processor/digitalocean-import/post-processor.go#L151
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_PostProcess1510)
stop_process:skip
}
...
proctype PostProcess151(chan child) {
	...
	run uploadImageToSpaces269(sess_Config_Credentials_m,sess_Config_Credentials_sf_mu,sess_options_Config_Credentials_m,child_uploadImageToSpaces2690);
	...
	if
	:: true -> 
		run deleteImageFromSpaces381(sess_Config_Credentials_m,sess_Config_Credentials_sf_mu,sess_options_Config_Credentials_m,child_deleteImageFromSpaces3811);
...
proctype uploadImageToSpaces269(Mutexdef s_Config_Credentials_m;Mutexdef s_Config_Credentials_sf_mu;Mutexdef s_options_Config_Credentials_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype deleteImageFromSpaces381(Mutexdef s_Config_Credentials_m;Mutexdef s_Config_Credentials_sf_mu;Mutexdef s_options_Config_Credentials_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
