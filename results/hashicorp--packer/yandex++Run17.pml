...
// git_link=https://github.com/hashicorp/packer/blob//builder/yandex/step_instance_info.go#L17
typedef Wgdef {
...
proctype Run17(chan child) {
	...
	run getInstanceIPAddress47(instance_BootDisk_state_atomicMessageInfo_initMu,instance_CreatedAt_state_atomicMessageInfo_initMu,instance_NetworkSettings_state_atomicMessageInfo_initMu,instance_PlacementPolicy_state_atomicMessageInfo_initMu,instance_Resources_state_atomicMessageInfo_initMu,instance_SchedulingPolicy_state_atomicMessageInfo_initMu,instance_state_atomicMessageInfo_initMu,child_getInstanceIPAddress470);
...
proctype getInstanceIPAddress47(Mutexdef instance_BootDisk_state_atomicMessageInfo_initMu;Mutexdef instance_CreatedAt_state_atomicMessageInfo_initMu;Mutexdef instance_NetworkSettings_state_atomicMessageInfo_initMu;Mutexdef instance_PlacementPolicy_state_atomicMessageInfo_initMu;Mutexdef instance_Resources_state_atomicMessageInfo_initMu;Mutexdef instance_SchedulingPolicy_state_atomicMessageInfo_initMu;Mutexdef instance_state_atomicMessageInfo_initMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_instanceAddresses740 = [1] of {int};
	run instanceAddresses74(instance_BootDisk_state_atomicMessageInfo_initMu,instance_CreatedAt_state_atomicMessageInfo_initMu,instance_NetworkSettings_state_atomicMessageInfo_initMu,instance_PlacementPolicy_state_atomicMessageInfo_initMu,instance_Resources_state_atomicMessageInfo_initMu,instance_SchedulingPolicy_state_atomicMessageInfo_initMu,instance_state_atomicMessageInfo_initMu,child_instanceAddresses740);
...
proctype instanceAddresses74(Mutexdef instance_BootDisk_state_atomicMessageInfo_initMu;Mutexdef instance_CreatedAt_state_atomicMessageInfo_initMu;Mutexdef instance_NetworkSettings_state_atomicMessageInfo_initMu;Mutexdef instance_PlacementPolicy_state_atomicMessageInfo_initMu;Mutexdef instance_Resources_state_atomicMessageInfo_initMu;Mutexdef instance_SchedulingPolicy_state_atomicMessageInfo_initMu;Mutexdef instance_state_atomicMessageInfo_initMu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_instance_NetworkInterfaces = -2; // opt var_instance_NetworkInterfaces
