...
// git_link=https://github.com/hashicorp/packer/blob//builder/digitalocean/step_shutdown.go#L16
#define ub_for52_3  -2
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype Run16(chan child) {
	...
	run AnonymousRun4938(shutdownRetryDone_ch,done_ch,child_AnonymousRun49380);
...
proctype AnonymousRun4938(Chandef shutdownRetryDone_ch;Chandef done_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
