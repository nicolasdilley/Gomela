...
// git_link=https://github.com/hashicorp/packer/blob//packer/provisioner_test.go#L195
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestDebuggedProvisionerProvision195(chan child) {
	...
	run Provision217(prov_lock,ui_l,comm_StartCmd_exitChInit_m,comm_StartCmd_m,child_Provision2171);
...
proctype Provision217(Mutexdef p_lock;Mutexdef ui_l;Mutexdef comm_StartCmd_exitChInit_m;Mutexdef comm_StartCmd_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run AnonymousProvision222221(result_ch,p_lock,ui_l,comm_StartCmd_exitChInit_m,comm_StartCmd_m,child_AnonymousProvision2222211);
...
proctype AnonymousProvision222221(Chandef result_ch;Mutexdef p_lock;Mutexdef ui_l;Mutexdef comm_StartCmd_exitChInit_m;Mutexdef comm_StartCmd_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
