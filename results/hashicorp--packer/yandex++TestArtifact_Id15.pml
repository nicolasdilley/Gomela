...
// git_link=https://github.com/hashicorp/packer/blob//builder/yandex/artifact_test.go#L15
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestArtifact_Id150)
stop_process:skip
}
...
proctype TestArtifact_Id15(chan child) {
	...
	run Id24(a_Image_state_atomicMessageInfo_initMu,child_Id240);
	child_Id240?0;
	stop_process: skip;
	child!0
}
proctype Id24(Mutexdef a_Image_state_atomicMessageInfo_initMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
