...
// git_link=https://github.com/ethereum/go-ethereum/blob//light/lightchain_test.go#L233
typedef Wgdef {
...
proctype TestBrokenHeaderChain233(chan child) {
	...
	run testHeaderChainImport119(LightChain_wg,LightChain_blockCache_lock,LightChain_bodyCache_lock,LightChain_bodyRLPCache_lock,LightChain_chainFeed_mu,LightChain_chainFeed_once_m,LightChain_chainHeadFeed_mu,LightChain_chainHeadFeed_once_m,LightChain_chainmu,LightChain_chainSideFeed_mu,LightChain_chainSideFeed_once_m,LightChain_hc_headerCache_lock,LightChain_hc_numberCache_lock,LightChain_hc_tdCache_lock,LightChain_scope_mu,var_chain,child_testHeaderChainImport1190);
	child_testHeaderChainImport1190?0;
	stop_process: skip;
	child!0
}
proctype testHeaderChainImport119(Wgdef lightchain_wg;Mutexdef lightchain_blockCache_lock;Mutexdef lightchain_bodyCache_lock;Mutexdef lightchain_bodyRLPCache_lock;Mutexdef lightchain_chainFeed_mu;Mutexdef lightchain_chainFeed_once_m;Mutexdef lightchain_chainHeadFeed_mu;Mutexdef lightchain_chainHeadFeed_once_m;Mutexdef lightchain_chainmu;Mutexdef lightchain_chainSideFeed_mu;Mutexdef lightchain_chainSideFeed_once_m;Mutexdef lightchain_hc_headerCache_lock;Mutexdef lightchain_hc_numberCache_lock;Mutexdef lightchain_hc_tdCache_lock;Mutexdef lightchain_scope_mu;int var_chain;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	:: var_chain-1 != -3 -> 
			...
			run GetTdByHash435(lightchain_wg,lightchain_blockCache_lock,lightchain_bodyCache_lock,lightchain_bodyRLPCache_lock,lightchain_chainFeed_mu,lightchain_chainFeed_once_m,lightchain_chainHeadFeed_mu,lightchain_chainHeadFeed_once_m,lightchain_chainmu,lightchain_chainSideFeed_mu,lightchain_chainSideFeed_once_m,lightchain_hc_headerCache_lock,lightchain_hc_numberCache_lock,lightchain_hc_tdCache_lock,lightchain_scope_mu,child_GetTdByHash4350);
	...
	:: else -> 
		...
		:: true -> 
			...
			lightchain_chainmu.Lock!false;
			run GetTdByHash435(lightchain_wg,lightchain_blockCache_lock,lightchain_bodyCache_lock,lightchain_bodyRLPCache_lock,lightchain_chainFeed_mu,lightchain_chainFeed_once_m,lightchain_chainHeadFeed_mu,lightchain_chainHeadFeed_once_m,lightchain_chainmu,lightchain_chainSideFeed_mu,lightchain_chainSideFeed_once_m,lightchain_hc_headerCache_lock,lightchain_hc_numberCache_lock,lightchain_hc_tdCache_lock,lightchain_scope_mu,child_GetTdByHash4351);
