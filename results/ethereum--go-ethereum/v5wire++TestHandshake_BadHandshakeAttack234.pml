...
// git_link=https://github.com/ethereum/go-ethereum/blob//p2p/discover/v5wire/encoding_test.go#L234
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestHandshake_BadHandshakeAttack2340 = [1] of {int};
	run TestHandshake_BadHandshakeAttack234(child_TestHandshake_BadHandshakeAttack2340);
	run receiver(child_TestHandshake_BadHandshakeAttack2340)
stop_process:skip
}

proctype TestHandshake_BadHandshakeAttack234(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_close5060 = [1] of {int};
	chan child_expectDecodeErr5599 = [1] of {int};
	chan child_encodeWithChallenge5268 = [1] of {int};
	chan child_expectDecodeErr5597 = [1] of {int};
	chan child_expectDecodeErr5596 = [1] of {int};
	...
	run encode521(net_nodeB_c_localnode_mu,net_nodeB_ln_mu,net_nodeA_c_localnode_mu,net_nodeA_ln_mu,child_encode5213);
	child_encode5213?0;
	run expectDecode545(net_nodeA_c_localnode_mu,net_nodeA_ln_mu,child_expectDecode5454);
	child_expectDecode5454?0;
	run encodeWithChallenge526(net_nodeA_c_localnode_mu,net_nodeA_ln_mu,net_nodeB_c_localnode_mu,net_nodeB_ln_mu,child_encodeWithChallenge5265);
	child_encodeWithChallenge5265?0;
	run expectDecodeErr559(net_nodeB_c_localnode_mu,net_nodeB_ln_mu,child_expectDecodeErr5596);
	child_expectDecodeErr5596?0;
	run expectDecodeErr559(net_nodeB_c_localnode_mu,net_nodeB_ln_mu,child_expectDecodeErr5597);
	child_expectDecodeErr5597?0;
	run encodeWithChallenge526(net_nodeA_c_localnode_mu,net_nodeA_ln_mu,net_nodeB_c_localnode_mu,net_nodeB_ln_mu,child_encodeWithChallenge5268);
	child_encodeWithChallenge5268?0;
	run expectDecodeErr559(net_nodeB_c_localnode_mu,net_nodeB_ln_mu,child_expectDecodeErr5599);
	child_expectDecodeErr5599?0;
		defer1: skip;
