...
// git_link=https://github.com/ethereum/go-ethereum/blob//p2p/discover/v5wire/encoding_test.go#L71
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestHandshake710 = [1] of {int};
	run TestHandshake71(child_TestHandshake710);
	run receiver(child_TestHandshake710)
stop_process:skip
}

proctype TestHandshake71(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
