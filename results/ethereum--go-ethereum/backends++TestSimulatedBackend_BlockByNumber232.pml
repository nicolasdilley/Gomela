...
// https://github.com/ethereum/go-ethereum/blob/master/accounts/abi/bind/backends/simulated_test.go#L232
typedef Wgdef {
...
init { 
	chan child_TestSimulatedBackend_BlockByNumber2320 = [1] of {int};
	run TestSimulatedBackend_BlockByNumber232(child_TestSimulatedBackend_BlockByNumber2320)
stop_process:skip
}

proctype TestSimulatedBackend_BlockByNumber232(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Close1010 = [1] of {int};
	chan child_BlockByNumber2454 = [1] of {int};
	chan child_BlockByNumber2453 = [1] of {int};
	...
	child_Commit1082?0;
	run BlockByNumber245(sim_blockchain_wg,sim_blockchain_snaps_triedb_lock,sim_blockchain_snaps_lock,sim_blockchain_hc_headerCache_lock,sim_blockchain_hc_tdCache_lock,sim_blockchain_hc_numberCache_lock,sim_blockchain_rmLogsFeed_once_m,sim_blockchain_rmLogsFeed_mu,sim_blockchain_chainFeed_once_m,sim_blockchain_chainFeed_mu,sim_blockchain_chainSideFeed_once_m,sim_blockchain_chainSideFeed_mu,sim_blockchain_chainHeadFeed_once_m,sim_blockchain_chainHeadFeed_mu,sim_blockchain_logsFeed_once_m,sim_blockchain_logsFeed_mu,sim_blockchain_blockProcFeed_once_m,sim_blockchain_blockProcFeed_mu,sim_blockchain_scope_mu,sim_blockchain_chainmu,sim_blockchain_bodyCache_lock,sim_blockchain_bodyRLPCache_lock,sim_blockchain_receiptsCache_lock,sim_blockchain_blockCache_lock,sim_blockchain_txLookupCache_lock,sim_blockchain_futureBlocks_lock,sim_mu,sim_pendingState_snaps_triedb_lock,sim_pendingState_snaps_lock,child_BlockByNumber2453);
	child_BlockByNumber2453?0;
	run BlockByNumber245(sim_blockchain_wg,sim_blockchain_snaps_triedb_lock,sim_blockchain_snaps_lock,sim_blockchain_hc_headerCache_lock,sim_blockchain_hc_tdCache_lock,sim_blockchain_hc_numberCache_lock,sim_blockchain_rmLogsFeed_once_m,sim_blockchain_rmLogsFeed_mu,sim_blockchain_chainFeed_once_m,sim_blockchain_chainFeed_mu,sim_blockchain_chainSideFeed_once_m,sim_blockchain_chainSideFeed_mu,sim_blockchain_chainHeadFeed_once_m,sim_blockchain_chainHeadFeed_mu,sim_blockchain_logsFeed_once_m,sim_blockchain_logsFeed_mu,sim_blockchain_blockProcFeed_once_m,sim_blockchain_blockProcFeed_mu,sim_blockchain_scope_mu,sim_blockchain_chainmu,sim_blockchain_bodyCache_lock,sim_blockchain_bodyRLPCache_lock,sim_blockchain_receiptsCache_lock,sim_blockchain_blockCache_lock,sim_blockchain_txLookupCache_lock,sim_blockchain_futureBlocks_lock,sim_mu,sim_pendingState_snaps_triedb_lock,sim_pendingState_snaps_lock,child_BlockByNumber2454);
	child_BlockByNumber2454?0;
	stop_process: skip;
