...
// git_link=https://github.com/ethereum/go-ethereum/blob//p2p/discover/v4_udp_test.go#L363
typedef Wgdef {
...
init { 
	chan child_TestUDPv4_pingMatch3630 = [1] of {int};
	run TestUDPv4_pingMatch363(child_TestUDPv4_pingMatch3630);
	run receiver(child_TestUDPv4_pingMatch3630)
stop_process:skip
}

proctype TestUDPv4_pingMatch363(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
