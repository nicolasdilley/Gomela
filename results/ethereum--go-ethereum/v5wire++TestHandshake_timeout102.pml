...
// git_link=https://github.com/ethereum/go-ethereum/blob//p2p/discover/v5wire/encoding_test.go#L102
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestHandshake_timeout1020 = [1] of {int};
	run TestHandshake_timeout102(child_TestHandshake_timeout1020);
	run receiver(child_TestHandshake_timeout1020)
stop_process:skip
}

proctype TestHandshake_timeout102(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
