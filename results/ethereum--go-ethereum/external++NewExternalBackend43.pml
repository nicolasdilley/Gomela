...
// git_link=https://github.com/ethereum/go-ethereum/blob//accounts/external/backend.go#L43
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype NewExternalBackend43(chan child) {
	...
	Mutexdef signer_client_services_mu;
	run mutexMonitor(signer_client_services_mu);
