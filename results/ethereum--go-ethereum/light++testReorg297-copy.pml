...
// git_link=https://github.com/ethereum/go-ethereum/blob//light/lightchain_test.go#L297
...
proctype testReorg297(chan child) {
	...
	run InsertHeaderChain383(bc_wg,bc_blockCache_lock,bc_bodyCache_lock,bc_bodyRLPCache_lock,bc_chainFeed_mu,bc_chainFeed_once_m,bc_chainHeadFeed_mu,bc_chainHeadFeed_once_m,bc_chainmu,bc_chainSideFeed_mu,bc_chainSideFeed_once_m,bc_hc_headerCache_lock,bc_hc_numberCache_lock,bc_hc_tdCache_lock,bc_scope_mu,child_InsertHeaderChain3831);
	child_InsertHeaderChain3831?0;
	run CurrentHeader423(bc_wg,bc_blockCache_lock,bc_bodyCache_lock,bc_bodyRLPCache_lock,bc_chainFeed_mu,bc_chainFeed_once_m,bc_chainHeadFeed_mu,bc_chainHeadFeed_once_m,bc_chainmu,bc_chainSideFeed_mu,bc_chainSideFeed_once_m,bc_hc_headerCache_lock,bc_hc_numberCache_lock,bc_hc_tdCache_lock,bc_scope_mu,child_CurrentHeader4232);
	child_CurrentHeader4232?0;
	run GetHeaderByNumber490(bc_wg,bc_blockCache_lock,bc_bodyCache_lock,bc_bodyRLPCache_lock,bc_chainFeed_mu,bc_chainFeed_once_m,bc_chainHeadFeed_mu,bc_chainHeadFeed_once_m,bc_chainmu,bc_chainSideFeed_mu,bc_chainSideFeed_once_m,bc_hc_headerCache_lock,bc_hc_numberCache_lock,bc_hc_tdCache_lock,bc_scope_mu,child_GetHeaderByNumber4903);
	child_GetHeaderByNumber4903?0;
	run GetHeaderByNumber490(bc_wg,bc_blockCache_lock,bc_bodyCache_lock,bc_bodyRLPCache_lock,bc_chainFeed_mu,bc_chainFeed_once_m,bc_chainHeadFeed_mu,bc_chainHeadFeed_once_m,bc_chainmu,bc_chainSideFeed_mu,bc_chainSideFeed_once_m,bc_hc_headerCache_lock,bc_hc_numberCache_lock,bc_hc_tdCache_lock,bc_scope_mu,child_GetHeaderByNumber4904);
	child_GetHeaderByNumber4904?0;
	run GetTdByHash435(bc_wg,bc_blockCache_lock,bc_bodyCache_lock,bc_bodyRLPCache_lock,bc_chainFeed_mu,bc_chainFeed_once_m,bc_chainHeadFeed_mu,bc_chainHeadFeed_once_m,bc_chainmu,bc_chainSideFeed_mu,bc_chainSideFeed_once_m,bc_hc_headerCache_lock,bc_hc_numberCache_lock,bc_hc_tdCache_lock,bc_scope_mu,child_GetTdByHash4355);
...
proctype CurrentHeader423(Wgdef lc_wg;Mutexdef lc_blockCache_lock;Mutexdef lc_bodyCache_lock;Mutexdef lc_bodyRLPCache_lock;Mutexdef lc_chainFeed_mu;Mutexdef lc_chainFeed_once_m;Mutexdef lc_chainHeadFeed_mu;Mutexdef lc_chainHeadFeed_once_m;Mutexdef lc_chainmu;Mutexdef lc_chainSideFeed_mu;Mutexdef lc_chainSideFeed_once_m;Mutexdef lc_hc_headerCache_lock;Mutexdef lc_hc_numberCache_lock;Mutexdef lc_hc_tdCache_lock;Mutexdef lc_scope_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype GetHeaderByNumber490(Wgdef lc_wg;Mutexdef lc_blockCache_lock;Mutexdef lc_bodyCache_lock;Mutexdef lc_bodyRLPCache_lock;Mutexdef lc_chainFeed_mu;Mutexdef lc_chainFeed_once_m;Mutexdef lc_chainHeadFeed_mu;Mutexdef lc_chainHeadFeed_once_m;Mutexdef lc_chainmu;Mutexdef lc_chainSideFeed_mu;Mutexdef lc_chainSideFeed_once_m;Mutexdef lc_hc_headerCache_lock;Mutexdef lc_hc_numberCache_lock;Mutexdef lc_hc_tdCache_lock;Mutexdef lc_scope_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype GetTdByHash435(Wgdef lc_wg;Mutexdef lc_blockCache_lock;Mutexdef lc_bodyCache_lock;Mutexdef lc_bodyRLPCache_lock;Mutexdef lc_chainFeed_mu;Mutexdef lc_chainFeed_once_m;Mutexdef lc_chainHeadFeed_mu;Mutexdef lc_chainHeadFeed_once_m;Mutexdef lc_chainmu;Mutexdef lc_chainSideFeed_mu;Mutexdef lc_chainSideFeed_once_m;Mutexdef lc_hc_headerCache_lock;Mutexdef lc_hc_numberCache_lock;Mutexdef lc_hc_tdCache_lock;Mutexdef lc_scope_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
