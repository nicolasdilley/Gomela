...
// git_link=https://github.com/ethereum/go-ethereum/blob//eth/tracers/tracers_test.go#L123
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestPrestateTracerCreate2123(chan child) {
	...
	run NewEVM146(statedb_snaps_lock,statedb_snaps_triedb_lock,child_NewEVM1460);
	child_NewEVM1460?0;
	stop_process: skip;
	child!0
}
