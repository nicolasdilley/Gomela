...
// git_link=https://github.com/ethereum/go-ethereum/blob//p2p/discover/v4_udp_test.go#L135
typedef Wgdef {
...
proctype TestUDPv4_packetErrors135(chan child) {
	...
	child_packetIn882?0;
	run packetIn88(test_db_lvl_closeW,test_db_lvl_s_closeW,test_table_db_lvl_closeW,test_udp_db_lvl_closeW,test_udp_wg,test_db_lvl_compCommitLk,test_db_lvl_compStats_lk,test_db_lvl_memMu,test_db_lvl_s_vmu,test_db_lvl_snapsMu,test_db_lvl_tr_lk,test_db_runner_m,test_pipe_mu,test_t_context_match_mu,test_t_context_mu,test_table_db_lvl_compCommitLk,test_table_db_lvl_memMu,test_table_db_lvl_snapsMu,test_table_db_runner_m,test_table_mutex,test_udp_closeOnce_m,test_udp_db_lvl_compCommitLk,test_udp_db_lvl_memMu,test_udp_db_lvl_snapsMu,test_udp_db_runner_m,test_udp_localNode_mu,test_udp_tab_mutex,child_packetIn883);
	child_packetIn883?0;
	run packetIn88(test_db_lvl_closeW,test_db_lvl_s_closeW,test_table_db_lvl_closeW,test_udp_db_lvl_closeW,test_udp_wg,test_db_lvl_compCommitLk,test_db_lvl_compStats_lk,test_db_lvl_memMu,test_db_lvl_s_vmu,test_db_lvl_snapsMu,test_db_lvl_tr_lk,test_db_runner_m,test_pipe_mu,test_t_context_match_mu,test_t_context_mu,test_table_db_lvl_compCommitLk,test_table_db_lvl_memMu,test_table_db_lvl_snapsMu,test_table_db_runner_m,test_table_mutex,test_udp_closeOnce_m,test_udp_db_lvl_compCommitLk,test_udp_db_lvl_memMu,test_udp_db_lvl_snapsMu,test_udp_db_runner_m,test_udp_localNode_mu,test_udp_tab_mutex,child_packetIn884);
	child_packetIn884?0;
		defer1: skip;
