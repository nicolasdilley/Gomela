#define executeInterfacesInParallel_int1599  ??
#define executeInterfacesInParallel_numCPU  ??
#define executeInterfacesInParallel_uint6416111  ??

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example574640073/rtree/hilbert/action.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
