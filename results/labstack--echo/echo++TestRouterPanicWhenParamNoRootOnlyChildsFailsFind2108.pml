#define not_found_2112  -2
#define not_found_2113  -2
#define not_found_2114  -2

// https://github.com/labstack/echo/blob/master/router_test.go#L2108
typedef Mutexdef {
	chan Lock = [0] of {bool};
