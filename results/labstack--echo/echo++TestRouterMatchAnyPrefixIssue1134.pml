#define not_found_1139  -2
#define not_found_1143  -2

// https://github.com/labstack/echo/blob/master/router_test.go#L1134
typedef Mutexdef {
	chan Lock = [0] of {bool};
