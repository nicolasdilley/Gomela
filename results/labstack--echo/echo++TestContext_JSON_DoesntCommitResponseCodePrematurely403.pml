...
// git_link=https://github.com/labstack/echo/blob//context_test.go#L403
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContext_JSON_DoesntCommitResponseCodePrematurely4030 = [1] of {int};
	run TestContext_JSON_DoesntCommitResponseCodePrematurely403(child_TestContext_JSON_DoesntCommitResponseCodePrematurely4030);
	run receiver(child_TestContext_JSON_DoesntCommitResponseCodePrematurely4030)
stop_process:skip
}

proctype TestContext_JSON_DoesntCommitResponseCodePrematurely403(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run JSON489(c_echo_AutoTLSManager_Client_cacheMu,c_echo_AutoTLSManager_Client_noncesMu,c_echo_AutoTLSManager_challengeMu,c_echo_AutoTLSManager_client_cacheMu,c_echo_AutoTLSManager_client_noncesMu,c_echo_AutoTLSManager_clientMu,c_echo_AutoTLSManager_renewalMu,c_echo_AutoTLSManager_stateMu,c_echo_Server_ErrorLog_mu,c_echo_Server_mu,c_echo_Server_nextProtoOnce_m,c_echo_Server_TLSConfig_mutex,c_echo_StdLogger_mu,c_echo_startupMutex,c_echo_TLSServer_ErrorLog_mu,c_echo_TLSServer_mu,c_echo_TLSServer_nextProtoOnce_m,c_echo_TLSServer_TLSConfig_mutex,c_lock,c_response_echo_AutoTLSManager_challengeMu,c_response_echo_AutoTLSManager_clientMu,c_response_echo_AutoTLSManager_renewalMu,c_response_echo_AutoTLSManager_stateMu,c_response_echo_Server_mu,c_response_echo_StdLogger_mu,c_response_echo_startupMutex,c_response_echo_TLSServer_mu,child_JSON4891);
	child_JSON4891?0;
	stop_process: skip;
	child!0
}
...
proctype JSON489(Mutexdef c_echo_AutoTLSManager_Client_cacheMu;Mutexdef c_echo_AutoTLSManager_Client_noncesMu;Mutexdef c_echo_AutoTLSManager_challengeMu;Mutexdef c_echo_AutoTLSManager_client_cacheMu;Mutexdef c_echo_AutoTLSManager_client_noncesMu;Mutexdef c_echo_AutoTLSManager_clientMu;Mutexdef c_echo_AutoTLSManager_renewalMu;Mutexdef c_echo_AutoTLSManager_stateMu;Mutexdef c_echo_Server_ErrorLog_mu;Mutexdef c_echo_Server_mu;Mutexdef c_echo_Server_nextProtoOnce_m;Mutexdef c_echo_Server_TLSConfig_mutex;Mutexdef c_echo_StdLogger_mu;Mutexdef c_echo_startupMutex;Mutexdef c_echo_TLSServer_ErrorLog_mu;Mutexdef c_echo_TLSServer_mu;Mutexdef c_echo_TLSServer_nextProtoOnce_m;Mutexdef c_echo_TLSServer_TLSConfig_mutex;Mutexdef c_lock;Mutexdef c_response_echo_AutoTLSManager_challengeMu;Mutexdef c_response_echo_AutoTLSManager_clientMu;Mutexdef c_response_echo_AutoTLSManager_renewalMu;Mutexdef c_response_echo_AutoTLSManager_stateMu;Mutexdef c_response_echo_Server_mu;Mutexdef c_response_echo_StdLogger_mu;Mutexdef c_response_echo_startupMutex;Mutexdef c_response_echo_TLSServer_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_json4791 = [1] of {int};
	run json479(c_echo_AutoTLSManager_Client_cacheMu,c_echo_AutoTLSManager_Client_noncesMu,c_echo_AutoTLSManager_challengeMu,c_echo_AutoTLSManager_client_cacheMu,c_echo_AutoTLSManager_client_noncesMu,c_echo_AutoTLSManager_clientMu,c_echo_AutoTLSManager_renewalMu,c_echo_AutoTLSManager_stateMu,c_echo_Server_ErrorLog_mu,c_echo_Server_mu,c_echo_Server_nextProtoOnce_m,c_echo_Server_TLSConfig_mutex,c_echo_StdLogger_mu,c_echo_startupMutex,c_echo_TLSServer_ErrorLog_mu,c_echo_TLSServer_mu,c_echo_TLSServer_nextProtoOnce_m,c_echo_TLSServer_TLSConfig_mutex,c_lock,c_response_echo_AutoTLSManager_challengeMu,c_response_echo_AutoTLSManager_clientMu,c_response_echo_AutoTLSManager_renewalMu,c_response_echo_AutoTLSManager_stateMu,c_response_echo_Server_mu,c_response_echo_StdLogger_mu,c_response_echo_startupMutex,c_response_echo_TLSServer_mu,child_json4791);
	child_json4791?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype json479(Mutexdef c_echo_AutoTLSManager_Client_cacheMu;Mutexdef c_echo_AutoTLSManager_Client_noncesMu;Mutexdef c_echo_AutoTLSManager_challengeMu;Mutexdef c_echo_AutoTLSManager_client_cacheMu;Mutexdef c_echo_AutoTLSManager_client_noncesMu;Mutexdef c_echo_AutoTLSManager_clientMu;Mutexdef c_echo_AutoTLSManager_renewalMu;Mutexdef c_echo_AutoTLSManager_stateMu;Mutexdef c_echo_Server_ErrorLog_mu;Mutexdef c_echo_Server_mu;Mutexdef c_echo_Server_nextProtoOnce_m;Mutexdef c_echo_Server_TLSConfig_mutex;Mutexdef c_echo_StdLogger_mu;Mutexdef c_echo_startupMutex;Mutexdef c_echo_TLSServer_ErrorLog_mu;Mutexdef c_echo_TLSServer_mu;Mutexdef c_echo_TLSServer_nextProtoOnce_m;Mutexdef c_echo_TLSServer_TLSConfig_mutex;Mutexdef c_lock;Mutexdef c_response_echo_AutoTLSManager_challengeMu;Mutexdef c_response_echo_AutoTLSManager_clientMu;Mutexdef c_response_echo_AutoTLSManager_renewalMu;Mutexdef c_response_echo_AutoTLSManager_stateMu;Mutexdef c_response_echo_Server_mu;Mutexdef c_response_echo_StdLogger_mu;Mutexdef c_response_echo_startupMutex;Mutexdef c_response_echo_TLSServer_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_writeContentType2201 = [1] of {int};
	run writeContentType220(c_echo_AutoTLSManager_Client_cacheMu,c_echo_AutoTLSManager_Client_noncesMu,c_echo_AutoTLSManager_challengeMu,c_echo_AutoTLSManager_client_cacheMu,c_echo_AutoTLSManager_client_noncesMu,c_echo_AutoTLSManager_clientMu,c_echo_AutoTLSManager_renewalMu,c_echo_AutoTLSManager_stateMu,c_echo_Server_ErrorLog_mu,c_echo_Server_mu,c_echo_Server_nextProtoOnce_m,c_echo_Server_TLSConfig_mutex,c_echo_StdLogger_mu,c_echo_startupMutex,c_echo_TLSServer_ErrorLog_mu,c_echo_TLSServer_mu,c_echo_TLSServer_nextProtoOnce_m,c_echo_TLSServer_TLSConfig_mutex,c_lock,c_response_echo_AutoTLSManager_challengeMu,c_response_echo_AutoTLSManager_clientMu,c_response_echo_AutoTLSManager_renewalMu,c_response_echo_AutoTLSManager_stateMu,c_response_echo_Server_mu,c_response_echo_StdLogger_mu,c_response_echo_startupMutex,c_response_echo_TLSServer_mu,child_writeContentType2201);
	child_writeContentType2201?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype writeContentType220(Mutexdef c_echo_AutoTLSManager_Client_cacheMu;Mutexdef c_echo_AutoTLSManager_Client_noncesMu;Mutexdef c_echo_AutoTLSManager_challengeMu;Mutexdef c_echo_AutoTLSManager_client_cacheMu;Mutexdef c_echo_AutoTLSManager_client_noncesMu;Mutexdef c_echo_AutoTLSManager_clientMu;Mutexdef c_echo_AutoTLSManager_renewalMu;Mutexdef c_echo_AutoTLSManager_stateMu;Mutexdef c_echo_Server_ErrorLog_mu;Mutexdef c_echo_Server_mu;Mutexdef c_echo_Server_nextProtoOnce_m;Mutexdef c_echo_Server_TLSConfig_mutex;Mutexdef c_echo_StdLogger_mu;Mutexdef c_echo_startupMutex;Mutexdef c_echo_TLSServer_ErrorLog_mu;Mutexdef c_echo_TLSServer_mu;Mutexdef c_echo_TLSServer_nextProtoOnce_m;Mutexdef c_echo_TLSServer_TLSConfig_mutex;Mutexdef c_lock;Mutexdef c_response_echo_AutoTLSManager_challengeMu;Mutexdef c_response_echo_AutoTLSManager_clientMu;Mutexdef c_response_echo_AutoTLSManager_renewalMu;Mutexdef c_response_echo_AutoTLSManager_stateMu;Mutexdef c_response_echo_Server_mu;Mutexdef c_response_echo_StdLogger_mu;Mutexdef c_response_echo_startupMutex;Mutexdef c_response_echo_TLSServer_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
