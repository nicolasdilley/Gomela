...
// git_link=https://github.com/labstack/echo/blob//router_test.go#L677
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterParam6770 = [1] of {int};
	run TestRouterParam677(child_TestRouterParam6770);
	run receiver(child_TestRouterParam6770)
stop_process:skip
}

proctype TestRouterParam677(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
