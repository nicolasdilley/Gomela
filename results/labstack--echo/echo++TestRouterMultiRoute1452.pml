...
// git_link=https://github.com/labstack/echo/blob//router_test.go#L1452
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterMultiRoute14520 = [1] of {int};
	run TestRouterMultiRoute1452(child_TestRouterMultiRoute14520);
	run receiver(child_TestRouterMultiRoute14520)
stop_process:skip
}

proctype TestRouterMultiRoute1452(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	child_Add650?0;
	run Add65(r_echo_AutoTLSManager_Client_cacheMu,r_echo_AutoTLSManager_Client_noncesMu,r_echo_AutoTLSManager_challengeMu,r_echo_AutoTLSManager_client_cacheMu,r_echo_AutoTLSManager_client_noncesMu,r_echo_AutoTLSManager_clientMu,r_echo_AutoTLSManager_renewalMu,r_echo_AutoTLSManager_stateMu,r_echo_Server_ErrorLog_mu,r_echo_Server_mu,r_echo_Server_nextProtoOnce_m,r_echo_Server_TLSConfig_mutex,r_echo_StdLogger_mu,r_echo_startupMutex,r_echo_TLSServer_ErrorLog_mu,r_echo_TLSServer_mu,r_echo_TLSServer_nextProtoOnce_m,r_echo_TLSServer_TLSConfig_mutex,"/users/:id",child_Add651);
	child_Add651?0;
	stop_process: skip;
	child!0
}
