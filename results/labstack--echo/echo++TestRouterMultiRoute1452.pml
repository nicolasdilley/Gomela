#define not_found_1457  -2
#define not_found_1458  -2

// https://github.com/labstack/echo/blob/master/router_test.go#L1452
typedef Mutexdef {
	chan Lock = [0] of {bool};
