...
// git_link=https://github.com/labstack/echo/blob//response_test.go#L40
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestResponse_Write_UsesSetResponseCode400 = [1] of {int};
	run TestResponse_Write_UsesSetResponseCode40(child_TestResponse_Write_UsesSetResponseCode400);
	run receiver(child_TestResponse_Write_UsesSetResponseCode400)
stop_process:skip
}

proctype TestResponse_Write_UsesSetResponseCode40(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
