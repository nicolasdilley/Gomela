...
// git_link=https://github.com/labstack/echo/blob//router_test.go#L1903
#define def_var_api  -2 // opt api line 1903
#define def_var_route_Path  -2 // opt path line 65
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run testRouterAPI1903(def_var_api,child_testRouterAPI19030);
	run receiver(child_testRouterAPI19030)
stop_process:skip
}

proctype testRouterAPI1903(int var_api;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_route_Path = def_var_route_Path;
	...
	:: else -> 
		...
		:: true -> 
			for117: skip;
			run Add65(r_echo_AutoTLSManager_Client_cacheMu,r_echo_AutoTLSManager_Client_noncesMu,r_echo_AutoTLSManager_challengeMu,r_echo_AutoTLSManager_client_cacheMu,r_echo_AutoTLSManager_client_noncesMu,r_echo_AutoTLSManager_clientMu,r_echo_AutoTLSManager_renewalMu,r_echo_AutoTLSManager_stateMu,r_echo_Server_ErrorLog_mu,r_echo_Server_mu,r_echo_Server_nextProtoOnce_m,r_echo_Server_TLSConfig_mutex,r_echo_StdLogger_mu,r_echo_startupMutex,r_echo_TLSServer_ErrorLog_mu,r_echo_TLSServer_mu,r_echo_TLSServer_nextProtoOnce_m,r_echo_TLSServer_TLSConfig_mutex,var_route_Path,child_Add651);
			child_Add651?0;
			for117_end: skip
		:: true -> 
			break
