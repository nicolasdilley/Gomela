...
// git_link=https://github.com/labstack/echo/blob//bind_test.go#L389
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestBindParam389(chan child) {
	...
	Mutexdef e2_AutoTLSManager_client_noncesMu;
	Mutexdef e2_AutoTLSManager_client_cacheMu;
	Mutexdef e2_AutoTLSManager_clientMu;
	Mutexdef e2_AutoTLSManager_Client_noncesMu;
	Mutexdef e2_AutoTLSManager_Client_cacheMu;
	Mutexdef e2_TLSServer_mu;
	Mutexdef e2_TLSServer_nextProtoOnce_m;
	Mutexdef e2_TLSServer_ErrorLog_mu;
	Mutexdef e2_TLSServer_TLSConfig_mutex;
	Mutexdef e2_Server_mu;
	Mutexdef e2_Server_nextProtoOnce_m;
	Mutexdef e2_Server_ErrorLog_mu;
	Mutexdef e2_Server_TLSConfig_mutex;
	...
	run mutexMonitor(e2_Server_TLSConfig_mutex);
	run mutexMonitor(e2_Server_ErrorLog_mu);
	run mutexMonitor(e2_Server_nextProtoOnce_m);
	run mutexMonitor(e2_Server_mu);
	run mutexMonitor(e2_TLSServer_TLSConfig_mutex);
	run mutexMonitor(e2_TLSServer_ErrorLog_mu);
	run mutexMonitor(e2_TLSServer_nextProtoOnce_m);
	run mutexMonitor(e2_TLSServer_mu);
	run mutexMonitor(e2_AutoTLSManager_Client_cacheMu);
	run mutexMonitor(e2_AutoTLSManager_Client_noncesMu);
	...
	run NewContext329(e2_AutoTLSManager_Client_cacheMu,e2_AutoTLSManager_Client_noncesMu,e2_AutoTLSManager_challengeMu,e2_AutoTLSManager_client_cacheMu,e2_AutoTLSManager_client_noncesMu,e2_AutoTLSManager_clientMu,e2_AutoTLSManager_renewalMu,e2_AutoTLSManager_stateMu,e2_Server_ErrorLog_mu,e2_Server_mu,e2_Server_nextProtoOnce_m,e2_Server_TLSConfig_mutex,e2_StdLogger_mu,e2_startupMutex,e2_TLSServer_ErrorLog_mu,e2_TLSServer_mu,e2_TLSServer_nextProtoOnce_m,e2_TLSServer_TLSConfig_mutex,child_NewContext3292);
