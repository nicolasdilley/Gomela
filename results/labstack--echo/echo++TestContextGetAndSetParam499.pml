...
// git_link=https://github.com/labstack/echo/blob//context_test.go#L499
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Add65(Mutexdef r_echo_AutoTLSManager_Client_cacheMu;Mutexdef r_echo_AutoTLSManager_Client_noncesMu;Mutexdef r_echo_AutoTLSManager_challengeMu;Mutexdef r_echo_AutoTLSManager_client_cacheMu;Mutexdef r_echo_AutoTLSManager_client_noncesMu;Mutexdef r_echo_AutoTLSManager_clientMu;Mutexdef r_echo_AutoTLSManager_renewalMu;Mutexdef r_echo_AutoTLSManager_stateMu;Mutexdef r_echo_Server_ErrorLog_mu;Mutexdef r_echo_Server_mu;Mutexdef r_echo_Server_nextProtoOnce_m;Mutexdef r_echo_Server_TLSConfig_mutex;Mutexdef r_echo_StdLogger_mu;Mutexdef r_echo_startupMutex;Mutexdef r_echo_TLSServer_ErrorLog_mu;Mutexdef r_echo_TLSServer_mu;Mutexdef r_echo_TLSServer_nextProtoOnce_m;Mutexdef r_echo_TLSServer_TLSConfig_mutex;int var_path;chan child) {
	...
	run insert103(r_echo_AutoTLSManager_Client_cacheMu,r_echo_AutoTLSManager_Client_noncesMu,r_echo_AutoTLSManager_challengeMu,r_echo_AutoTLSManager_client_cacheMu,r_echo_AutoTLSManager_client_noncesMu,r_echo_AutoTLSManager_clientMu,r_echo_AutoTLSManager_renewalMu,r_echo_AutoTLSManager_stateMu,r_echo_Server_ErrorLog_mu,r_echo_Server_mu,r_echo_Server_nextProtoOnce_m,r_echo_Server_TLSConfig_mutex,r_echo_StdLogger_mu,r_echo_startupMutex,r_echo_TLSServer_ErrorLog_mu,r_echo_TLSServer_mu,r_echo_TLSServer_nextProtoOnce_m,r_echo_TLSServer_TLSConfig_mutex,child_insert10311);
	child_insert10311?0;
	stop_process: skip;
	child!0
}
