...
// git_link=https://github.com/labstack/echo/blob//response_test.go#L50
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Flush86(Mutexdef r_echo_AutoTLSManager_Client_cacheMu;Mutexdef r_echo_AutoTLSManager_Client_noncesMu;Mutexdef r_echo_AutoTLSManager_challengeMu;Mutexdef r_echo_AutoTLSManager_client_cacheMu;Mutexdef r_echo_AutoTLSManager_client_noncesMu;Mutexdef r_echo_AutoTLSManager_clientMu;Mutexdef r_echo_AutoTLSManager_renewalMu;Mutexdef r_echo_AutoTLSManager_stateMu;Mutexdef r_echo_Server_ErrorLog_mu;Mutexdef r_echo_Server_mu;Mutexdef r_echo_Server_nextProtoOnce_m;Mutexdef r_echo_Server_TLSConfig_mutex;Mutexdef r_echo_StdLogger_mu;Mutexdef r_echo_startupMutex;Mutexdef r_echo_TLSServer_ErrorLog_mu;Mutexdef r_echo_TLSServer_mu;Mutexdef r_echo_TLSServer_nextProtoOnce_m;Mutexdef r_echo_TLSServer_TLSConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
