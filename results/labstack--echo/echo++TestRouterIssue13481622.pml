#define not_found_1626  -2
#define not_found_1629  -2

// https://github.com/labstack/echo/blob/master/router_test.go#L1622
typedef Mutexdef {
	chan Lock = [0] of {bool};
