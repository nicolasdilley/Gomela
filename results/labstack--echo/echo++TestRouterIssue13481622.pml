...
// git_link=https://github.com/labstack/echo/blob//router_test.go#L1622
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterIssue134816220 = [1] of {int};
	run TestRouterIssue13481622(child_TestRouterIssue134816220);
	run receiver(child_TestRouterIssue134816220)
stop_process:skip
}

proctype TestRouterIssue13481622(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
