#define not_found_1640  -2
#define not_found_1641  -2

// https://github.com/labstack/echo/blob/master/router_test.go#L1635
typedef Mutexdef {
	chan Lock = [0] of {bool};
