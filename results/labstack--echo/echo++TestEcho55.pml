...
// git_link=https://github.com/labstack/echo/blob//echo_test.go#L55
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEcho550 = [1] of {int};
	run TestEcho55(child_TestEcho550);
	run receiver(child_TestEcho550)
stop_process:skip
}

proctype TestEcho55(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_DefaultHTTPErrorHandler3522 = [1] of {int};
	chan child_Router3411 = [1] of {int};
	...
	child_Router3411?0;
	run DefaultHTTPErrorHandler352(e_AutoTLSManager_Client_cacheMu,e_AutoTLSManager_Client_noncesMu,e_AutoTLSManager_challengeMu,e_AutoTLSManager_client_cacheMu,e_AutoTLSManager_client_noncesMu,e_AutoTLSManager_clientMu,e_AutoTLSManager_renewalMu,e_AutoTLSManager_stateMu,e_Server_ErrorLog_mu,e_Server_mu,e_Server_nextProtoOnce_m,e_Server_TLSConfig_mutex,e_StdLogger_mu,e_startupMutex,e_TLSServer_ErrorLog_mu,e_TLSServer_mu,e_TLSServer_nextProtoOnce_m,e_TLSServer_TLSConfig_mutex,child_DefaultHTTPErrorHandler3522);
	child_DefaultHTTPErrorHandler3522?0;
	stop_process: skip;
	child!0
}
...
proctype DefaultHTTPErrorHandler352(Mutexdef e_AutoTLSManager_Client_cacheMu;Mutexdef e_AutoTLSManager_Client_noncesMu;Mutexdef e_AutoTLSManager_challengeMu;Mutexdef e_AutoTLSManager_client_cacheMu;Mutexdef e_AutoTLSManager_client_noncesMu;Mutexdef e_AutoTLSManager_clientMu;Mutexdef e_AutoTLSManager_renewalMu;Mutexdef e_AutoTLSManager_stateMu;Mutexdef e_Server_ErrorLog_mu;Mutexdef e_Server_mu;Mutexdef e_Server_nextProtoOnce_m;Mutexdef e_Server_TLSConfig_mutex;Mutexdef e_StdLogger_mu;Mutexdef e_startupMutex;Mutexdef e_TLSServer_ErrorLog_mu;Mutexdef e_TLSServer_mu;Mutexdef e_TLSServer_nextProtoOnce_m;Mutexdef e_TLSServer_TLSConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
