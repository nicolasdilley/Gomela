...
// git_link=https://github.com/labstack/echo/blob//response_test.go#L11
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestResponse110)
stop_process:skip
}
...
proctype TestResponse11(chan child) {
	...
	run Before40(res_echo_AutoTLSManager_Client_cacheMu,res_echo_AutoTLSManager_Client_noncesMu,res_echo_AutoTLSManager_challengeMu,res_echo_AutoTLSManager_client_cacheMu,res_echo_AutoTLSManager_client_noncesMu,res_echo_AutoTLSManager_clientMu,res_echo_AutoTLSManager_renewalMu,res_echo_AutoTLSManager_stateMu,res_echo_Server_ErrorLog_mu,res_echo_Server_mu,res_echo_Server_nextProtoOnce_m,res_echo_Server_TLSConfig_mutex,res_echo_StdLogger_mu,res_echo_startupMutex,res_echo_TLSServer_ErrorLog_mu,res_echo_TLSServer_mu,res_echo_TLSServer_nextProtoOnce_m,res_echo_TLSServer_TLSConfig_mutex,child_Before401);
	child_Before401?0;
	run After46(res_echo_AutoTLSManager_Client_cacheMu,res_echo_AutoTLSManager_Client_noncesMu,res_echo_AutoTLSManager_challengeMu,res_echo_AutoTLSManager_client_cacheMu,res_echo_AutoTLSManager_client_noncesMu,res_echo_AutoTLSManager_clientMu,res_echo_AutoTLSManager_renewalMu,res_echo_AutoTLSManager_stateMu,res_echo_Server_ErrorLog_mu,res_echo_Server_mu,res_echo_Server_nextProtoOnce_m,res_echo_Server_TLSConfig_mutex,res_echo_StdLogger_mu,res_echo_startupMutex,res_echo_TLSServer_ErrorLog_mu,res_echo_TLSServer_mu,res_echo_TLSServer_nextProtoOnce_m,res_echo_TLSServer_TLSConfig_mutex,child_After462);
	child_After462?0;
	run Write68(res_echo_AutoTLSManager_Client_cacheMu,res_echo_AutoTLSManager_Client_noncesMu,res_echo_AutoTLSManager_challengeMu,res_echo_AutoTLSManager_client_cacheMu,res_echo_AutoTLSManager_client_noncesMu,res_echo_AutoTLSManager_clientMu,res_echo_AutoTLSManager_renewalMu,res_echo_AutoTLSManager_stateMu,res_echo_Server_ErrorLog_mu,res_echo_Server_mu,res_echo_Server_nextProtoOnce_m,res_echo_Server_TLSConfig_mutex,res_echo_StdLogger_mu,res_echo_startupMutex,res_echo_TLSServer_ErrorLog_mu,res_echo_TLSServer_mu,res_echo_TLSServer_nextProtoOnce_m,res_echo_TLSServer_TLSConfig_mutex,child_Write683);
	child_Write683?0;
	stop_process: skip;
	child!0
}
...
proctype After46(Mutexdef r_echo_AutoTLSManager_Client_cacheMu;Mutexdef r_echo_AutoTLSManager_Client_noncesMu;Mutexdef r_echo_AutoTLSManager_challengeMu;Mutexdef r_echo_AutoTLSManager_client_cacheMu;Mutexdef r_echo_AutoTLSManager_client_noncesMu;Mutexdef r_echo_AutoTLSManager_clientMu;Mutexdef r_echo_AutoTLSManager_renewalMu;Mutexdef r_echo_AutoTLSManager_stateMu;Mutexdef r_echo_Server_ErrorLog_mu;Mutexdef r_echo_Server_mu;Mutexdef r_echo_Server_nextProtoOnce_m;Mutexdef r_echo_Server_TLSConfig_mutex;Mutexdef r_echo_StdLogger_mu;Mutexdef r_echo_startupMutex;Mutexdef r_echo_TLSServer_ErrorLog_mu;Mutexdef r_echo_TLSServer_mu;Mutexdef r_echo_TLSServer_nextProtoOnce_m;Mutexdef r_echo_TLSServer_TLSConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype Write68(Mutexdef r_echo_AutoTLSManager_Client_cacheMu;Mutexdef r_echo_AutoTLSManager_Client_noncesMu;Mutexdef r_echo_AutoTLSManager_challengeMu;Mutexdef r_echo_AutoTLSManager_client_cacheMu;Mutexdef r_echo_AutoTLSManager_client_noncesMu;Mutexdef r_echo_AutoTLSManager_clientMu;Mutexdef r_echo_AutoTLSManager_renewalMu;Mutexdef r_echo_AutoTLSManager_stateMu;Mutexdef r_echo_Server_ErrorLog_mu;Mutexdef r_echo_Server_mu;Mutexdef r_echo_Server_nextProtoOnce_m;Mutexdef r_echo_Server_TLSConfig_mutex;Mutexdef r_echo_StdLogger_mu;Mutexdef r_echo_startupMutex;Mutexdef r_echo_TLSServer_ErrorLog_mu;Mutexdef r_echo_TLSServer_mu;Mutexdef r_echo_TLSServer_nextProtoOnce_m;Mutexdef r_echo_TLSServer_TLSConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype WriteHeader54(Mutexdef r_echo_AutoTLSManager_Client_cacheMu;Mutexdef r_echo_AutoTLSManager_Client_noncesMu;Mutexdef r_echo_AutoTLSManager_challengeMu;Mutexdef r_echo_AutoTLSManager_client_cacheMu;Mutexdef r_echo_AutoTLSManager_client_noncesMu;Mutexdef r_echo_AutoTLSManager_clientMu;Mutexdef r_echo_AutoTLSManager_renewalMu;Mutexdef r_echo_AutoTLSManager_stateMu;Mutexdef r_echo_Server_ErrorLog_mu;Mutexdef r_echo_Server_mu;Mutexdef r_echo_Server_nextProtoOnce_m;Mutexdef r_echo_Server_TLSConfig_mutex;Mutexdef r_echo_StdLogger_mu;Mutexdef r_echo_startupMutex;Mutexdef r_echo_TLSServer_ErrorLog_mu;Mutexdef r_echo_TLSServer_mu;Mutexdef r_echo_TLSServer_nextProtoOnce_m;Mutexdef r_echo_TLSServer_TLSConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
