#define Read_inbox_ConvsUnverified  0

// /tmp/clone-example545132187/go/chat/inboxsource.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	Chandef localizeCb;
	bool state = false;
	chan child_screateConversationLocalizer0 = [0] of {int};
	int i;
	...
	child_screateConversationLocalizer0?0;
