#define ExecuteTaskGroup_lastTask_OutputShards  0

// /tmp/clone-example115657414/distributed/driver/scheduler/scheduler_execute_task_group.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10:
	...
	:: 1 > 0 -> 
		...
		run AsyncChan(pickedServerChan)
	:: else -> 
