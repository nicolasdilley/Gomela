...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example131909709/go/kbfs/libkbfs/journal_manager_util.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int storedBytes = 5;
	int statusesToFetch = 5;
	bool state = false;
	Chandef unflushedBytes;
	int unflushedPaths = 5;
	int endEstimates = 5;
