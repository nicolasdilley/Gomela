...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example131909709/go/chat/flip/replay.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	bool state = false;
	int msg_CommitmentComplete_Players = 5;
	Chandef summaryCh;
	int players = 5;
	Chandef errCh;
	int game_gameUpdateCh = 5;
	int ret_Players = 5;
	int i;
