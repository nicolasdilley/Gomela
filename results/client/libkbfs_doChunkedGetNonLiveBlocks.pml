#define numChunks  5
#define numChunks  5
#define lb_for1400_2  -1
#define ub_for1400_3  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example131909709/go/kbfs/libkbfs/folder_block_manager.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10_exit:	
	if
	:: lb_for1400_2 != -1 && ub_for1400_3 != -1 -> 
				for(i : lb_for1400_2.. ub_for1400_3) {
for20:			
			if
			:: chunks.async_send!0;
			:: chunks.sync!0 -> 
