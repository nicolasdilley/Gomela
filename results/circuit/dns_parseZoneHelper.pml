...
#define lb_for62_4  -1
#define ub_for62_5  -1
#define lb_for1466_6  -1
#define ub_for1466_7  -1
#define lb_for1498_8  -1
#define ub_for1498_9  -1
#define lb_for1080_10  -1
#define ub_for1080_11  -1
#define lb_for201_12  -1
#define ub_for201_13  -1
#define lb_for1335_14  -1
#define ub_for1335_15  -1
#define lb_for1400_16  -1
#define ub_for1400_17  -1
#define lb_for1554_18  -1
#define ub_for1554_19  -1
#define lb_for225_20  -1
#define ub_for225_21  -1
#define lb_for251_22  -1
#define ub_for251_23  -1
#define lb_for1141_24  -1
#define ub_for1141_25  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example613354818/github.com/miekg/dns/zscan.go
typedef Chandef {
	chan sync = [0] of {int};
...
BuildRR:		
	...
	if
	:: lb_for62_4 != -1 && ub_for62_5 != -1 -> 
				for(i : lb_for62_4.. ub_for62_5) {
for21:			
			if
			:: 0 != -1 && s-1 != -1 -> 
								for(i : 0.. s-1) {
...
proctype dnssetEUI48(Chandef c;chan child) {
	...
	if
	:: lb_for1466_6 != -1 && ub_for1466_7 != -1 -> 
				for(i : lb_for1466_6.. ub_for1466_7) {
for24:			
			if
			:: true -> 
				goto stop_process
...
proctype dnssetEUI64(Chandef c;chan child) {
	...
	if
	:: lb_for1498_8 != -1 && ub_for1498_9 != -1 -> 
				for(i : lb_for1498_8.. ub_for1498_9) {
for25:			
			if
			:: true -> 
				goto stop_process
...
Altitude:		
	...
	if
	:: lb_for1080_10 != -1 && ub_for1080_11 != -1 -> 
				for(i : lb_for1080_10.. ub_for1080_11) {
for26:			
...
proctype dnsendingToString(Chandef c;chan child) {
	...
	if
	:: lb_for201_12 != -1 && ub_for201_13 != -1 -> 
				for(i : lb_for201_12.. ub_for201_13) {
for27:			
...
proctype dnssetNSEC(Chandef c;chan child) {
	...
	if
	:: lb_for1335_14 != -1 && ub_for1335_15 != -1 -> 
				for(i : lb_for1335_14.. ub_for1335_15) {
for28:			
...
proctype dnssetNSEC3(Chandef c;chan child) {
	...
	if
	:: lb_for1400_16 != -1 && ub_for1400_17 != -1 -> 
				for(i : lb_for1400_16.. ub_for1400_17) {
for29:			
...
proctype dnssetWKS(Chandef c;chan child) {
	...
	if
	:: lb_for1554_18 != -1 && ub_for1554_19 != -1 -> 
				for(i : lb_for1554_18.. ub_for1554_19) {
for210:			
...
proctype dnsendingToTxtSlice(Chandef c;chan child) {
	...
	:: true -> 
		...
		if
		:: lb_for225_20 != -1 && ub_for225_21 != -1 -> 
						for(i : lb_for225_20.. ub_for225_21) {
for211:				
...
for211_exit:		
	...
	:: true -> 
		...
		if
		:: lb_for251_22 != -1 && ub_for251_23 != -1 -> 
						for(i : lb_for251_22.. ub_for251_23) {
for212:				
				if
				:: c.async_rcv?0;
				:: c.sync?0;
...
proctype dnssetHIP(Chandef c;chan child) {
	...
	if
	:: lb_for1141_24 != -1 && ub_for1141_25 != -1 -> 
				for(i : lb_for1141_24.. ub_for1141_25) {
for213:			
