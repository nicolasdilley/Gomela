...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example006988768/go/nbs/fs_table_cache.go
typedef Chandef {
...
proctype go_Anonymous0(Chandef infos;Chandef errc;Wgdef wg) {
	...
	:: true -> 
		...
		if
		:: infos.async_rcv?state,num_msgs;
		:: infos.sync?state,num_msgs;
		fi;
