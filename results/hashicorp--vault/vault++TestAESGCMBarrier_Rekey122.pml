...
// https://github.com/hashicorp/vault/blob/master/vault/barrier_aes_gcm_test.go#L122
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestAESGCMBarrier_Rekey122(chan child) {
	...
	run testBarrier_Rekey358(b_l,b_cacheLock,child_testBarrier_Rekey3580);
	child_testBarrier_Rekey3580?0;
	stop_process: skip;
	child!0
}
proctype testBarrier_Rekey358(Mutexdef b_l;Mutexdef b_cacheLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	child_Put7803?0;
	run VerifyMaster297(b_l,b_cacheLock,child_VerifyMaster2974);
	child_VerifyMaster2974?0;
	run GenerateKey274(b_l,b_cacheLock,child_GenerateKey2745);
	child_GenerateKey2745?0;
	run Rekey724(b_l,b_cacheLock,child_Rekey7246);
	child_Rekey7246?0;
	run VerifyMaster297(b_l,b_cacheLock,child_VerifyMaster2977);
	child_VerifyMaster2977?0;
	run VerifyMaster297(b_l,b_cacheLock,child_VerifyMaster2978);
	...
	child_Unseal42211?0;
	run Unseal422(b_l,b_cacheLock,child_Unseal42212);
	child_Unseal42212?0;
...
proctype Rekey724(Mutexdef b_l;Mutexdef b_cacheLock;chan child) {
	...
	b_l.Lock!false;
	run updateMasterKeyCommon765(b_l,b_cacheLock,child_updateMasterKeyCommon7656);
	...
	run persistKeyring210(b_l,b_cacheLock,child_persistKeyring2107);
...
proctype updateMasterKeyCommon765(Mutexdef b_l;Mutexdef b_cacheLock;chan child) {
	...
	run KeyLength283(b_l,b_cacheLock,child_KeyLength2836);
...
proctype Get812(Mutexdef b_l;Mutexdef b_cacheLock;chan child) {
	...
	run lockSwitchedGet816(b_l,b_cacheLock,child_lockSwitchedGet8169);
...
proctype lockSwitchedGet816(Mutexdef b_l;Mutexdef b_cacheLock;chan child) {
	...
	run aeadForTerm909(b_l,b_cacheLock,child_aeadForTerm9099);
