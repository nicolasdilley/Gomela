...
// https://github.com/hashicorp/vault/blob/master/vault/acl.go#L275
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_Capabilities2750 = [1] of {int};
	run Capabilities275(child_Capabilities2750)
stop_process:skip
}

proctype Capabilities275(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run AllowOperation318(req_Auth_Alias_state_atomicMessageInfo_initMu,child_AllowOperation3180);
