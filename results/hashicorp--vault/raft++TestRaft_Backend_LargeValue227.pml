...
// git_link=https://github.com/hashicorp/vault/blob//physical/raft/raft_test.go#L227
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Put1178(Mutexdef b_autopilot_execLock;Mutexdef b_autopilot_leaderLock_mu;Mutexdef b_autopilot_stateLock;Mutexdef b_followerStates_l;Mutexdef b_fsm_db_batchMu;Mutexdef b_fsm_db_freelistLoad_m;Mutexdef b_fsm_db_metalock;Mutexdef b_fsm_db_mmaplock;Mutexdef b_fsm_db_rwlock;Mutexdef b_fsm_db_statlock;Mutexdef b_fsm_l;Mutexdef b_l;Mutexdef b_raft_lastContactLock;Mutexdef b_raft_leaderLock;Mutexdef b_raft_observersLock;Mutexdef b_raft_shutdownLock;Mutexdef b_streamLayer_closeLock;chan child) {
	...
	b_l.RLock!false;
	run applyLog1248(b_autopilot_execLock,b_autopilot_leaderLock_mu,b_autopilot_stateLock,b_followerStates_l,b_fsm_db_batchMu,b_fsm_db_freelistLoad_m,b_fsm_db_metalock,b_fsm_db_mmaplock,b_fsm_db_rwlock,b_fsm_db_statlock,b_fsm_l,b_l,b_raft_lastContactLock,b_raft_leaderLock,b_raft_observersLock,b_raft_shutdownLock,b_streamLayer_closeLock,command_state_atomicMessageInfo_initMu,child_applyLog12480);
...
proctype applyLog1248(Mutexdef b_autopilot_execLock;Mutexdef b_autopilot_leaderLock_mu;Mutexdef b_autopilot_stateLock;Mutexdef b_followerStates_l;Mutexdef b_fsm_db_batchMu;Mutexdef b_fsm_db_freelistLoad_m;Mutexdef b_fsm_db_metalock;Mutexdef b_fsm_db_mmaplock;Mutexdef b_fsm_db_rwlock;Mutexdef b_fsm_db_statlock;Mutexdef b_fsm_l;Mutexdef b_l;Mutexdef b_raft_lastContactLock;Mutexdef b_raft_leaderLock;Mutexdef b_raft_observersLock;Mutexdef b_raft_shutdownLock;Mutexdef b_streamLayer_closeLock;Mutexdef command_state_atomicMessageInfo_initMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype Get1152(Mutexdef b_autopilot_execLock;Mutexdef b_autopilot_leaderLock_mu;Mutexdef b_autopilot_stateLock;Mutexdef b_followerStates_l;Mutexdef b_fsm_db_batchMu;Mutexdef b_fsm_db_freelistLoad_m;Mutexdef b_fsm_db_metalock;Mutexdef b_fsm_db_mmaplock;Mutexdef b_fsm_db_rwlock;Mutexdef b_fsm_db_statlock;Mutexdef b_fsm_l;Mutexdef b_l;Mutexdef b_raft_lastContactLock;Mutexdef b_raft_leaderLock;Mutexdef b_raft_observersLock;Mutexdef b_raft_shutdownLock;Mutexdef b_streamLayer_closeLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Get436(b_fsm_db_batchMu,b_fsm_db_freelistLoad_m,b_fsm_db_metalock,b_fsm_db_mmaplock,b_fsm_db_rwlock,b_fsm_db_statlock,b_fsm_l,child_Get4361);
	child_Get4361?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype Get436(Mutexdef f_db_batchMu;Mutexdef f_db_freelistLoad_m;Mutexdef f_db_metalock;Mutexdef f_db_mmaplock;Mutexdef f_db_rwlock;Mutexdef f_db_statlock;Mutexdef f_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
