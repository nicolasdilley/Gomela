...
// git_link=https://github.com/hashicorp/vault/blob//vault/identity_store_oidc_test.go#L546
...
proctype TestOIDC_PeriodicFunc546(chan child) {
	...
	int var_testSet_testCases = -2; // opt var_testSet_testCases
	int var_testSets = -2; // opt var_testSets
	...
	:: var_testSets-1 != -3 -> 
			...
			:: 0 != -2 && ub_for610_3 != -2 -> 
								for(i : 0.. ub_for610_3) {
					for114: skip;
					run oidcPeriodicFunc1566(c_identityStore_db_writer,c_identityStore_groupLock,c_identityStore_lock,c_identityStore_oidcLock,child_oidcPeriodicFunc15662);
			...
			:: else -> 
				...
				:: true -> 
					for11: skip;
					run oidcPeriodicFunc1566(c_identityStore_db_writer,c_identityStore_groupLock,c_identityStore_lock,c_identityStore_oidcLock,child_oidcPeriodicFunc15661);
	...
	:: else -> 
		...
		:: true -> 
			...
			:: 0 != -2 && ub_for610_3 != -2 -> 
								for(i : 0.. ub_for610_3) {
					for119: skip;
					run oidcPeriodicFunc1566(c_identityStore_db_writer,c_identityStore_groupLock,c_identityStore_lock,c_identityStore_oidcLock,child_oidcPeriodicFunc15665);
			...
			:: else -> 
				...
				:: true -> 
					for118: skip;
					run oidcPeriodicFunc1566(c_identityStore_db_writer,c_identityStore_groupLock,c_identityStore_lock,c_identityStore_oidcLock,child_oidcPeriodicFunc15664);
...
proctype oidcPeriodicFunc1566(Mutexdef i_db_writer;Mutexdef i_groupLock;Mutexdef i_lock;Mutexdef i_oidcLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_i_listNamespaces = -2; // opt var_i_listNamespaces
	...
	:: true -> 
		...
		if
		:: var_i_listNamespaces-1 != -3 -> 
						for(i : 0.. var_i_listNamespaces-1) {
				for12: skip;
				...
				run oidcKeyRotation1512(i_db_writer,i_groupLock,i_lock,i_oidcLock,child_oidcKeyRotation15121);
				child_oidcKeyRotation15121?0;
				run expireOIDCPublicKeys1411(i_db_writer,i_groupLock,i_lock,i_oidcLock,child_expireOIDCPublicKeys14112);
		...
		:: else -> 
			...
			:: true -> 
				...
				run oidcKeyRotation1512(i_db_writer,i_groupLock,i_lock,i_oidcLock,child_oidcKeyRotation15123);
				child_oidcKeyRotation15123?0;
				run expireOIDCPublicKeys1411(i_db_writer,i_groupLock,i_lock,i_oidcLock,child_expireOIDCPublicKeys14114);
...
proctype oidcKeyRotation1512(Mutexdef i_db_writer;Mutexdef i_groupLock;Mutexdef i_lock;Mutexdef i_oidcLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype expireOIDCPublicKeys1411(Mutexdef i_db_writer;Mutexdef i_groupLock;Mutexdef i_lock;Mutexdef i_oidcLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	int var_publicKeyIDs = -2; // opt var_publicKeyIDs
	int var_keyRing = -2; // opt var_keyRing
	int var_namedKeys = -2; // opt var_namedKeys
	i_oidcLock.Lock!false;
