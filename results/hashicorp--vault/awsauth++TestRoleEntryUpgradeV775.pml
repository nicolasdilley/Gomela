...
// git_link=https://github.com/hashicorp/vault/blob//builtin/credential/aws/path_role_test.go#L775
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRoleEntryUpgradeV775(chan child) {
	...
	run upgradeRole446(b_configMutex,b_denyListMutex,b_deprecatedTerms_once_m,b_roleMutex,storage_once_m,child_upgradeRole4460);
