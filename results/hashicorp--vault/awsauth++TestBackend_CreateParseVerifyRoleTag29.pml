...
// https://github.com/hashicorp/vault/blob/master/builtin/credential/aws/backend_test.go#L29
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestBackend_CreateParseVerifyRoleTag29(chan child) {
	...
	run role240(b_configMutex,b_roleMutex,b_denyListMutex,b_deprecatedTerms_once_m,storage_once_m,child_role2400);
	child_role2400?0;
	run parseAndVerifyRoleTagValue293(b_configMutex,b_roleMutex,b_denyListMutex,b_deprecatedTerms_once_m,storage_once_m,child_parseAndVerifyRoleTagValue2931);
	child_parseAndVerifyRoleTagValue2931?0;
	run role240(b_configMutex,b_roleMutex,b_denyListMutex,b_deprecatedTerms_once_m,storage_once_m,child_role2402);
	child_role2402?0;
	stop_process: skip;
	child!0
}
...
proctype parseAndVerifyRoleTagValue293(Mutexdef b_configMutex;Mutexdef b_roleMutex;Mutexdef b_denyListMutex;Mutexdef b_deprecatedTerms_once_m;Mutexdef s_once_m;chan child) {
	...
	run role240(b_configMutex,b_roleMutex,b_denyListMutex,b_deprecatedTerms_once_m,s_once_m,child_role2401);
	child_role2401?0;
