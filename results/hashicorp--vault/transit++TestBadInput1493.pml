...
// https://github.com/hashicorp/vault/blob/master/builtin/logical/transit/backend_test.go#L1493
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBadInput14930 = [1] of {int};
	run TestBadInput1493(child_TestBadInput14930)
stop_process:skip
}

proctype TestBadInput1493(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
