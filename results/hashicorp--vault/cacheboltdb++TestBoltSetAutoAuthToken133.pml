...
// git_link=https://github.com/hashicorp/vault/blob//command/agent/cache/cacheboltdb/bolt_test.go#L133
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestBoltSetAutoAuthToken133(chan child) {
	...
	run GetAutoAuthToken214(b_db_batch_start_m,b_db_batchMu,b_db_freelistLoad_m,b_db_metalock,b_db_mmaplock,b_db_rwlock,b_db_statlock,child_GetAutoAuthToken2140);
	...
	run GetAutoAuthToken214(b_db_batch_start_m,b_db_batchMu,b_db_freelistLoad_m,b_db_metalock,b_db_mmaplock,b_db_rwlock,b_db_statlock,child_GetAutoAuthToken2143);
	...
	run GetAutoAuthToken214(b_db_batch_start_m,b_db_batchMu,b_db_freelistLoad_m,b_db_metalock,b_db_mmaplock,b_db_rwlock,b_db_statlock,child_GetAutoAuthToken2146);
	child_GetAutoAuthToken2146?0;
	stop_process: skip;
	child!0
}
proctype GetAutoAuthToken214(Mutexdef b_db_batch_start_m;Mutexdef b_db_batchMu;Mutexdef b_db_freelistLoad_m;Mutexdef b_db_metalock;Mutexdef b_db_mmaplock;Mutexdef b_db_rwlock;Mutexdef b_db_statlock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run decrypt180(b_db_batch_start_m,b_db_batchMu,b_db_freelistLoad_m,b_db_metalock,b_db_mmaplock,b_db_rwlock,b_db_statlock,child_decrypt1800);
	child_decrypt1800?0;
...
proctype decrypt180(Mutexdef b_db_batch_start_m;Mutexdef b_db_batchMu;Mutexdef b_db_freelistLoad_m;Mutexdef b_db_metalock;Mutexdef b_db_mmaplock;Mutexdef b_db_rwlock;Mutexdef b_db_statlock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
