...
// git_link=https://github.com/hashicorp/vault/blob//helper/storagepacker/storagepacker_test.go#L115
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestStoragePacker_SerializeDeserializeComplexItem1150)
stop_process:skip
}
