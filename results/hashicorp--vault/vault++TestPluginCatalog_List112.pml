...
// git_link=https://github.com/hashicorp/vault/blob//vault/plugin_catalog_test.go#L112
typedef Wgdef {
...
proctype TestPluginCatalog_List112(chan child) {
	...
	run List358(core_pluginCatalog_catalogView_readOnlyErrLock,core_pluginCatalog_lock,child_List3580);
	child_List3580?0;
	run Set258(core_pluginCatalog_catalogView_readOnlyErrLock,core_pluginCatalog_lock,child_Set2581);
	child_Set2581?0;
	run Set258(core_pluginCatalog_catalogView_readOnlyErrLock,core_pluginCatalog_lock,child_Set2582);
	child_Set2582?0;
	run List358(core_pluginCatalog_catalogView_readOnlyErrLock,core_pluginCatalog_lock,child_List3583);
	child_List3583?0;
	stop_process: skip;
	child!0
}
proctype List358(Mutexdef c_catalogView_readOnlyErrLock;Mutexdef c_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	:: else -> 
		...
		:: true -> 
			for11: skip;
			run get212(c_catalogView_readOnlyErrLock,c_lock,child_get2121);
			child_get2121?0;
			for11_end: skip
		:: true -> 
			break
