...
// https://github.com/hashicorp/vault/blob/master/vault/barrier_aes_gcm_test.go#L548
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestAESGCMBarrier_ReloadKeyring548(chan child) {
	...
	run ReloadKeyring312(b_l,b_cacheLock,child_ReloadKeyring3124);
	child_ReloadKeyring3124?0;
	run Encrypt1035(b_l,b_cacheLock,child_Encrypt10355);
	child_Encrypt10355?0;
	run ReloadKeyring312(b_l,b_cacheLock,child_ReloadKeyring3126);
...
proctype ReloadKeyring312(Mutexdef b_l;Mutexdef b_cacheLock;chan child) {
	...
	run recoverKeyring359(b_l,b_cacheLock,child_recoverKeyring3596);
