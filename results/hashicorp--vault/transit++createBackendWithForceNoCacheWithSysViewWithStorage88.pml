...
// git_link=https://github.com/hashicorp/vault/blob//builtin/logical/transit/backend_test.go#L88
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_createBackendWithForceNoCacheWithSysViewWithStorage880)
stop_process:skip
}
