...
// git_link=https://github.com/hashicorp/vault/blob//command/agent/cache/cache_test.go#L214
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestCache_AutoAuthTokenStripping214(chan child) {
	...
	run HandleCacheClear565(leaseCache_client_config_Limiter_mu,leaseCache_client_config_modifyLock,leaseCache_client_modifyLock,leaseCache_l,leaseCache_ps_db_batchMu,leaseCache_ps_db_freelistLoad_m,leaseCache_ps_db_metalock,leaseCache_ps_db_mmaplock,leaseCache_ps_db_rwlock,leaseCache_ps_db_statlock,child_HandleCacheClear5650);
	child_HandleCacheClear5650?0;
	run Handler23(leaseCache_client_config_Limiter_mu,leaseCache_client_config_modifyLock,leaseCache_client_modifyLock,leaseCache_l,leaseCache_ps_db_batchMu,leaseCache_ps_db_freelistLoad_m,leaseCache_ps_db_metalock,leaseCache_ps_db_mmaplock,leaseCache_ps_db_rwlock,leaseCache_ps_db_statlock,child_Handler231);
	child_Handler231?0;
...
proctype Handler23(Mutexdef proxier_client_config_Limiter_mu;Mutexdef proxier_client_config_modifyLock;Mutexdef proxier_client_modifyLock;Mutexdef proxier_l;Mutexdef proxier_ps_db_batchMu;Mutexdef proxier_ps_db_freelistLoad_m;Mutexdef proxier_ps_db_metalock;Mutexdef proxier_ps_db_mmaplock;Mutexdef proxier_ps_db_rwlock;Mutexdef proxier_ps_db_statlock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
