...
// git_link=https://github.com/hashicorp/vault/blob//vault/external_tests/sealmigration/testshared.go#L739
typedef Wgdef {
...
proctype runAutoseal739(chan child) {
	...
	run WaitForNCoresUnsealed269(cluster_base_MetricsHelper_inMemSink_intervalLock,cluster_base_ReloadFuncsLock,child_WaitForNCoresUnsealed2690);
	...
	run DeriveActiveCore235(cluster_base_MetricsHelper_inMemSink_intervalLock,cluster_base_ReloadFuncsLock,child_DeriveActiveCore2351);
...
proctype WaitForNCoresUnsealed269(Mutexdef cluster_base_MetricsHelper_inMemSink_intervalLock;Mutexdef cluster_base_ReloadFuncsLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype DeriveActiveCore235(Mutexdef cluster_base_MetricsHelper_inMemSink_intervalLock;Mutexdef cluster_base_ReloadFuncsLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
