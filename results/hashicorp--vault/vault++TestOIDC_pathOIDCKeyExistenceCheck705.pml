...
// git_link=https://github.com/hashicorp/vault/blob//vault/identity_store_oidc_test.go#L705
typedef Wgdef {
...
init { 
	chan child_TestOIDC_pathOIDCKeyExistenceCheck7050 = [1] of {int};
	run TestOIDC_pathOIDCKeyExistenceCheck705(child_TestOIDC_pathOIDCKeyExistenceCheck7050);
	run receiver(child_TestOIDC_pathOIDCKeyExistenceCheck7050)
stop_process:skip
}

proctype TestOIDC_pathOIDCKeyExistenceCheck705(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_pathOIDCKeyExistenceCheck6821 = [1] of {int};
	chan child_pathOIDCKeyExistenceCheck6820 = [1] of {int};
	...
	run pathOIDCKeyExistenceCheck682(c_identityStore_db_writer,c_identityStore_groupLock,c_identityStore_lock,c_identityStore_oidcLock,child_pathOIDCKeyExistenceCheck6820);
	child_pathOIDCKeyExistenceCheck6820?0;
	run pathOIDCKeyExistenceCheck682(c_identityStore_db_writer,c_identityStore_groupLock,c_identityStore_lock,c_identityStore_oidcLock,child_pathOIDCKeyExistenceCheck6821);
	child_pathOIDCKeyExistenceCheck6821?0;
	stop_process: skip;
	child!0
}
proctype pathOIDCKeyExistenceCheck682(Mutexdef i_db_writer;Mutexdef i_groupLock;Mutexdef i_lock;Mutexdef i_oidcLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	i_oidcLock.RLock!false;
