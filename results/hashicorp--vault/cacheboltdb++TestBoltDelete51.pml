...
// git_link=https://github.com/hashicorp/vault/blob//command/agent/cache/cacheboltdb/bolt_test.go#L51
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestBoltDelete51(chan child) {
	...
	run Delete162(b_db_batch_start_m,b_db_batchMu,b_db_freelistLoad_m,b_db_metalock,b_db_mmaplock,b_db_rwlock,b_db_statlock,child_Delete1623);
	child_Delete1623?0;
	run GetByType190(b_db_batch_start_m,b_db_batchMu,b_db_freelistLoad_m,b_db_metalock,b_db_mmaplock,b_db_rwlock,b_db_statlock,child_GetByType1904);
...
proctype Delete162(Mutexdef b_db_batch_start_m;Mutexdef b_db_batchMu;Mutexdef b_db_freelistLoad_m;Mutexdef b_db_metalock;Mutexdef b_db_mmaplock;Mutexdef b_db_rwlock;Mutexdef b_db_statlock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
