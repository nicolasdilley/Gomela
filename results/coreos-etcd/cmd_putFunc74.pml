#define putFunc_totalClients  0
#define putFunc_clients  0

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example420310086/tools/benchmark/cmd/put.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype go_Anonymous2(Chandef requests) {
	bool closed; 
	int i;
	bool state;
	stop_process: skip
