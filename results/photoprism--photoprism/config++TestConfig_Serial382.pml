...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/config_test.go#L382
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_Serial3820 = [1] of {int};
	run TestConfig_Serial382(child_TestConfig_Serial3820);
	run receiver(child_TestConfig_Serial3820)
stop_process:skip
}

proctype TestConfig_Serial382(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
