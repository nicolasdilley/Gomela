...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/db_test.go#L42
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_DatabasePort420 = [1] of {int};
	run TestConfig_DatabasePort42(child_TestConfig_DatabasePort420);
	run receiver(child_TestConfig_DatabasePort420)
stop_process:skip
}

proctype TestConfig_DatabasePort42(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
