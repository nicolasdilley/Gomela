...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/fs_test.go#L324
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_AssetsPath23240 = [1] of {int};
	run TestConfig_AssetsPath2324(child_TestConfig_AssetsPath23240);
	run receiver(child_TestConfig_AssetsPath23240)
stop_process:skip
}

proctype TestConfig_AssetsPath2324(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
