...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/fs_test.go#L81
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_StoragePath810 = [1] of {int};
	run TestConfig_StoragePath81(child_TestConfig_StoragePath810);
	run receiver(child_TestConfig_StoragePath810)
stop_process:skip
}

proctype TestConfig_StoragePath81(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
