...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/config_test.go#L95
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_PIDFilename950 = [1] of {int};
	run TestConfig_PIDFilename95(child_TestConfig_PIDFilename950);
	run receiver(child_TestConfig_PIDFilename950)
stop_process:skip
}

proctype TestConfig_PIDFilename95(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
