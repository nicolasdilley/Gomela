...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/config_test.go#L224
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_StaticPath2240 = [1] of {int};
	run TestConfig_StaticPath224(child_TestConfig_StaticPath2240);
	run receiver(child_TestConfig_StaticPath2240)
stop_process:skip
}

proctype TestConfig_StaticPath224(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
