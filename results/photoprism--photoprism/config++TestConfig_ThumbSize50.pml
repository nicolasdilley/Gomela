...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/resample_test.go#L50
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_ThumbSize500 = [1] of {int};
	run TestConfig_ThumbSize50(child_TestConfig_ThumbSize500);
	run receiver(child_TestConfig_ThumbSize500)
stop_process:skip
}

proctype TestConfig_ThumbSize50(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
