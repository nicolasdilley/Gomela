...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/config_test.go#L128
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_HttpServerMode1280 = [1] of {int};
	run TestConfig_HttpServerMode128(child_TestConfig_HttpServerMode1280);
	run receiver(child_TestConfig_HttpServerMode1280)
stop_process:skip
}

proctype TestConfig_HttpServerMode128(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
