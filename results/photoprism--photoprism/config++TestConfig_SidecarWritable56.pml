...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/fs_test.go#L56
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_SidecarWritable560 = [1] of {int};
	run TestConfig_SidecarWritable56(child_TestConfig_SidecarWritable560);
	run receiver(child_TestConfig_SidecarWritable560)
stop_process:skip
}

proctype TestConfig_SidecarWritable56(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
