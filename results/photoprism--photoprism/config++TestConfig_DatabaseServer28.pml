...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/db_test.go#L28
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_DatabaseServer280 = [1] of {int};
	run TestConfig_DatabaseServer28(child_TestConfig_DatabaseServer280);
	run receiver(child_TestConfig_DatabaseServer280)
stop_process:skip
}

proctype TestConfig_DatabaseServer28(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
