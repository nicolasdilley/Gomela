...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/fs_test.go#L310
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_OriginalsPath23100 = [1] of {int};
	run TestConfig_OriginalsPath2310(child_TestConfig_OriginalsPath23100);
	run receiver(child_TestConfig_OriginalsPath23100)
stop_process:skip
}

proctype TestConfig_OriginalsPath2310(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
