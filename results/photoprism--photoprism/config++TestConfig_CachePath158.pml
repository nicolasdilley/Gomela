...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/config_test.go#L158
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_CachePath1580 = [1] of {int};
	run TestConfig_CachePath158(child_TestConfig_CachePath1580);
	run receiver(child_TestConfig_CachePath1580)
stop_process:skip
}

proctype TestConfig_CachePath158(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
