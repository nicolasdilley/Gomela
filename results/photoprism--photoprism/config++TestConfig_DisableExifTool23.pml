...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/disable_test.go#L23
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_DisableExifTool230 = [1] of {int};
	run TestConfig_DisableExifTool23(child_TestConfig_DisableExifTool230);
	run receiver(child_TestConfig_DisableExifTool230)
stop_process:skip
}

proctype TestConfig_DisableExifTool23(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
