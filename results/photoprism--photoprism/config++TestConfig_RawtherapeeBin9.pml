...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/raw_test.go#L9
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_RawtherapeeBin90 = [1] of {int};
	run TestConfig_RawtherapeeBin9(child_TestConfig_RawtherapeeBin90);
	run receiver(child_TestConfig_RawtherapeeBin90)
stop_process:skip
}

proctype TestConfig_RawtherapeeBin9(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
