...
// git_link=https://github.com/photoprism/photoprism/blob//internal/config/config_test.go#L77
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestConfig_ConfigFile770 = [1] of {int};
	run TestConfig_ConfigFile77(child_TestConfig_ConfigFile770);
	run receiver(child_TestConfig_ConfigFile770)
stop_process:skip
}

proctype TestConfig_ConfigFile77(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
