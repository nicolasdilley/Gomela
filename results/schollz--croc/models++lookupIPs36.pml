...
// git_link=https://github.com/schollz/croc/blob//src/models/constants.go#L36
#define def_var_publicDns38  ?? // mand publicDns line 38
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype lookupIPs36(chan child) {
	...
	Chandef result_ch;
	int var_publicDns = def_var_publicDns38; // mand var_publicDns
