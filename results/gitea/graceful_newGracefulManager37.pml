#define newGracefulManager_numberOfServersToCreate  ??

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example071832406/modules/graceful/manager_unix.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
