...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/vsphere/vsphere_test.go#L198
...
init { 
	chan child_TestAlignMetrics1980 = [1] of {int};
	run TestAlignMetrics198(child_TestAlignMetrics1980);
	run receiver(child_TestAlignMetrics1980)
stop_process:skip
}

proctype TestAlignMetrics198(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
