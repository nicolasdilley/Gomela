...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L128
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPSNoClientAuth1280 = [1] of {int};
	run TestWriteHTTPSNoClientAuth128(child_TestWriteHTTPSNoClientAuth1280);
	run receiver(child_TestWriteHTTPSNoClientAuth1280)
stop_process:skip
}

proctype TestWriteHTTPSNoClientAuth128(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
