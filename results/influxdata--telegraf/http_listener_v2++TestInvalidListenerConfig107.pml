...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L107
typedef Wgdef {
...
init { 
	chan child_TestInvalidListenerConfig1070 = [1] of {int};
	run TestInvalidListenerConfig107(child_TestInvalidListenerConfig1070);
	run receiver(child_TestInvalidListenerConfig1070)
stop_process:skip
}

proctype TestInvalidListenerConfig107(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
