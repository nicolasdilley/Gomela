...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/solr/solr_test.go#L14
typedef Wgdef {
...
init { 
	chan child_TestGatherStats140 = [1] of {int};
	run TestGatherStats14(child_TestGatherStats140);
	run receiver(child_TestGatherStats140)
stop_process:skip
}

proctype TestGatherStats14(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
