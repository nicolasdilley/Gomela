...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/outputs/cloud_pubsub/pubsub_test.go#L104
typedef Wgdef {
...
init { 
	chan child_TestPubSub_WriteOverByteThreshold1040 = [1] of {int};
	run TestPubSub_WriteOverByteThreshold104(child_TestPubSub_WriteOverByteThreshold1040);
	run receiver(child_TestPubSub_WriteOverByteThreshold1040)
stop_process:skip
}

proctype TestPubSub_WriteOverByteThreshold104(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
