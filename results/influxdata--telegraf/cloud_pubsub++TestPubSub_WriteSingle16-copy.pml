...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/outputs/cloud_pubsub/pubsub_test.go#L16
typedef Wgdef {
...
init { 
	chan child_TestPubSub_WriteSingle160 = [1] of {int};
	run TestPubSub_WriteSingle16(child_TestPubSub_WriteSingle160);
	run receiver(child_TestPubSub_WriteSingle160)
stop_process:skip
}

proctype TestPubSub_WriteSingle16(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
