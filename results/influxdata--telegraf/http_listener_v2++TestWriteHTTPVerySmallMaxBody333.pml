...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L333
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPVerySmallMaxBody3330 = [1] of {int};
	run TestWriteHTTPVerySmallMaxBody333(child_TestWriteHTTPVerySmallMaxBody3330);
	run receiver(child_TestWriteHTTPVerySmallMaxBody3330)
stop_process:skip
}

proctype TestWriteHTTPVerySmallMaxBody333(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
