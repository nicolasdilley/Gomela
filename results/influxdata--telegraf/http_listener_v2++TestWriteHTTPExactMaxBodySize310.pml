...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L310
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPExactMaxBodySize3100 = [1] of {int};
	run TestWriteHTTPExactMaxBodySize310(child_TestWriteHTTPExactMaxBodySize3100);
	run receiver(child_TestWriteHTTPExactMaxBodySize3100)
stop_process:skip
}

proctype TestWriteHTTPExactMaxBodySize310(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
