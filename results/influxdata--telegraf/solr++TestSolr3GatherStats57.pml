...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/solr/solr_test.go#L57
typedef Wgdef {
...
init { 
	chan child_TestSolr3GatherStats570 = [1] of {int};
	run TestSolr3GatherStats57(child_TestSolr3GatherStats570);
	run receiver(child_TestSolr3GatherStats570)
stop_process:skip
}

proctype TestSolr3GatherStats57(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
