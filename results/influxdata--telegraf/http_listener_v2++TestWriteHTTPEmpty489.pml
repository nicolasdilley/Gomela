...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L489
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPEmpty4890 = [1] of {int};
	run TestWriteHTTPEmpty489(child_TestWriteHTTPEmpty4890);
	run receiver(child_TestWriteHTTPEmpty4890)
stop_process:skip
}

proctype TestWriteHTTPEmpty489(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
