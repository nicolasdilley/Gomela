...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/aerospike/aerospike_test.go#L421
...
init { 
	chan child_TestParseHistogramNamespace4210 = [1] of {int};
	run TestParseHistogramNamespace421(child_TestParseHistogramNamespace4210);
	run receiver(child_TestParseHistogramNamespace4210)
stop_process:skip
}

proctype TestParseHistogramNamespace421(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
