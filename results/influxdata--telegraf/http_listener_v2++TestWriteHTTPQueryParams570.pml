...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L570
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPQueryParams5700 = [1] of {int};
	run TestWriteHTTPQueryParams570(child_TestWriteHTTPQueryParams5700);
	run receiver(child_TestWriteHTTPQueryParams5700)
stop_process:skip
}

proctype TestWriteHTTPQueryParams570(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
