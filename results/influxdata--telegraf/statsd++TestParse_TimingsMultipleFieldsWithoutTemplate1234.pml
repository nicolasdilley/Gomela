...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/statsd/statsd_test.go#L1234
typedef Wgdef {
...
init { 
	chan child_TestParse_TimingsMultipleFieldsWithoutTemplate12340 = [1] of {int};
	run TestParse_TimingsMultipleFieldsWithoutTemplate1234(child_TestParse_TimingsMultipleFieldsWithoutTemplate12340);
	run receiver(child_TestParse_TimingsMultipleFieldsWithoutTemplate12340)
stop_process:skip
}

proctype TestParse_TimingsMultipleFieldsWithoutTemplate1234(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Gather2922 = [1] of {int};
	...
	run Gather292(s_wg,s_cleanup,child_Gather2922);
	child_Gather2922?0;
	stop_process: skip;
	child!0
}
...
proctype Gather292(Wgdef s_wg;Mutexdef s_cleanup;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_expireCachedMetrics10422 = [1] of {int};
	...
	run expireCachedMetrics1042(s_wg,s_cleanup,child_expireCachedMetrics10422);
	child_expireCachedMetrics10422?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
