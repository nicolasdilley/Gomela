...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L256
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPWithMultiplePaths2560 = [1] of {int};
	run TestWriteHTTPWithMultiplePaths256(child_TestWriteHTTPWithMultiplePaths2560);
	run receiver(child_TestWriteHTTPWithMultiplePaths2560)
stop_process:skip
}

proctype TestWriteHTTPWithMultiplePaths256(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
