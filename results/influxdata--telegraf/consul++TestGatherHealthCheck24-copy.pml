...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/consul/consul_test.go#L24
...
init { 
	chan child_TestGatherHealthCheck240 = [1] of {int};
	run TestGatherHealthCheck24(child_TestGatherHealthCheck240);
	run receiver(child_TestGatherHealthCheck240)
stop_process:skip
}

proctype TestGatherHealthCheck24(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
