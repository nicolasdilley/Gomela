...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/solr/solr_test.go#L46
typedef Wgdef {
...
init { 
	chan child_TestSolr7MbeansStats460 = [1] of {int};
	run TestSolr7MbeansStats46(child_TestSolr7MbeansStats460);
	run receiver(child_TestSolr7MbeansStats460)
stop_process:skip
}

proctype TestSolr7MbeansStats46(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
