...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L475
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPInvalid4750 = [1] of {int};
	run TestWriteHTTPInvalid475(child_TestWriteHTTPInvalid4750);
	run receiver(child_TestWriteHTTPInvalid4750)
stop_process:skip
}

proctype TestWriteHTTPInvalid475(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
