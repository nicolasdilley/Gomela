...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/processors/aws/ec2/ec2_test.go#L22
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBasicStartupWithEC2Tags220 = [1] of {int};
	run TestBasicStartupWithEC2Tags22(child_TestBasicStartupWithEC2Tags220);
	run receiver(child_TestBasicStartupWithEC2Tags220)
stop_process:skip
}

proctype TestBasicStartupWithEC2Tags22(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
