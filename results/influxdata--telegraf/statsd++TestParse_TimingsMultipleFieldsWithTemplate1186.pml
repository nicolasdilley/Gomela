...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/statsd/statsd_test.go#L1186
typedef Wgdef {
...
init { 
	chan child_TestParse_TimingsMultipleFieldsWithTemplate11860 = [1] of {int};
	run TestParse_TimingsMultipleFieldsWithTemplate1186(child_TestParse_TimingsMultipleFieldsWithTemplate11860);
	run receiver(child_TestParse_TimingsMultipleFieldsWithTemplate11860)
stop_process:skip
}

proctype TestParse_TimingsMultipleFieldsWithTemplate1186(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
