...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/ping/ping_test.go#L517
typedef Wgdef {
...
init { 
	chan child_TestDNSLookupError5170 = [1] of {int};
	run TestDNSLookupError517(child_TestDNSLookupError5170);
	run receiver(child_TestDNSLookupError5170)
stop_process:skip
}

proctype TestDNSLookupError517(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
