...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/consul/consul_test.go#L51
...
init { 
	chan child_TestGatherHealthCheckWithDelimitedTags510 = [1] of {int};
	run TestGatherHealthCheckWithDelimitedTags51(child_TestGatherHealthCheckWithDelimitedTags510);
	run receiver(child_TestGatherHealthCheckWithDelimitedTags510)
stop_process:skip
}

proctype TestGatherHealthCheckWithDelimitedTags51(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
