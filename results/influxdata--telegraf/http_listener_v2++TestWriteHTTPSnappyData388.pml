...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L388
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPSnappyData3880 = [1] of {int};
	run TestWriteHTTPSnappyData388(child_TestWriteHTTPSnappyData3880);
	run receiver(child_TestWriteHTTPSnappyData3880)
stop_process:skip
}

proctype TestWriteHTTPSnappyData388(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
