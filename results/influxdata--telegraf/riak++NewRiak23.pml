...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/riak/riak.go#L23
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_NewRiak230 = [1] of {int};
	run NewRiak23(child_NewRiak230);
	run receiver(child_NewRiak230)
stop_process:skip
}

proctype NewRiak23(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
