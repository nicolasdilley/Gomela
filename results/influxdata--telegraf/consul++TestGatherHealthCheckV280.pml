...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/consul/consul_test.go#L80
...
init { 
	chan child_TestGatherHealthCheckV2800 = [1] of {int};
	run TestGatherHealthCheckV280(child_TestGatherHealthCheckV2800);
	run receiver(child_TestGatherHealthCheckV2800)
stop_process:skip
}

proctype TestGatherHealthCheckV280(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
