...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/outputs/cloud_pubsub/pubsub_test.go#L35
typedef Wgdef {
...
init { 
	chan child_TestPubSub_WriteWithAttribute350 = [1] of {int};
	run TestPubSub_WriteWithAttribute35(child_TestPubSub_WriteWithAttribute350);
	run receiver(child_TestPubSub_WriteWithAttribute350)
stop_process:skip
}

proctype TestPubSub_WriteWithAttribute35(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
