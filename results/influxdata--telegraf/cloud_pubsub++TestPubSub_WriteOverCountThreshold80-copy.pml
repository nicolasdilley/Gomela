...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/outputs/cloud_pubsub/pubsub_test.go#L80
typedef Wgdef {
...
init { 
	chan child_TestPubSub_WriteOverCountThreshold800 = [1] of {int};
	run TestPubSub_WriteOverCountThreshold80(child_TestPubSub_WriteOverCountThreshold800);
	run receiver(child_TestPubSub_WriteOverCountThreshold800)
stop_process:skip
}

proctype TestPubSub_WriteOverCountThreshold80(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
