...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/statsd/statsd_test.go#L1016
typedef Wgdef {
...
init { 
	chan child_TestParse_MeasurementsWithSameName10160 = [1] of {int};
	run TestParse_MeasurementsWithSameName1016(child_TestParse_MeasurementsWithSameName10160);
	run receiver(child_TestParse_MeasurementsWithSameName10160)
stop_process:skip
}

proctype TestParse_MeasurementsWithSameName1016(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
