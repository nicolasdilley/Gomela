...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L167
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPBasicAuth1670 = [1] of {int};
	run TestWriteHTTPBasicAuth167(child_TestWriteHTTPBasicAuth1670);
	run receiver(child_TestWriteHTTPBasicAuth1670)
stop_process:skip
}

proctype TestWriteHTTPBasicAuth167(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
