...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L461
typedef Wgdef {
...
init { 
	chan child_TestReceive404ForInvalidEndpoint4610 = [1] of {int};
	run TestReceive404ForInvalidEndpoint461(child_TestReceive404ForInvalidEndpoint4610);
	run receiver(child_TestReceive404ForInvalidEndpoint4610)
stop_process:skip
}

proctype TestReceive404ForInvalidEndpoint461(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
