...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/solr/solr_test.go#L88
typedef Wgdef {
...
init { 
	chan child_TestNoCoreDataHandling880 = [1] of {int};
	run TestNoCoreDataHandling88(child_TestNoCoreDataHandling880);
	run receiver(child_TestNoCoreDataHandling880)
stop_process:skip
}

proctype TestNoCoreDataHandling88(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
