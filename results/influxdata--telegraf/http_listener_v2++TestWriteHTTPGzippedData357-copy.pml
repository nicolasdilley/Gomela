...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L357
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPGzippedData3570 = [1] of {int};
	run TestWriteHTTPGzippedData357(child_TestWriteHTTPGzippedData3570);
	run receiver(child_TestWriteHTTPGzippedData3570)
stop_process:skip
}

proctype TestWriteHTTPGzippedData357(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
