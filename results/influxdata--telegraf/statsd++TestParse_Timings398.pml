...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/statsd/statsd_test.go#L398
typedef Wgdef {
...
init { 
	chan child_TestParse_Timings3980 = [1] of {int};
	run TestParse_Timings398(child_TestParse_Timings3980);
	run receiver(child_TestParse_Timings3980)
stop_process:skip
}

proctype TestParse_Timings398(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
