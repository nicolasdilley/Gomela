...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L234
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPWithPathTag2340 = [1] of {int};
	run TestWriteHTTPWithPathTag234(child_TestWriteHTTPWithPathTag2340);
	run receiver(child_TestWriteHTTPWithPathTag2340)
stop_process:skip
}

proctype TestWriteHTTPWithPathTag234(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
