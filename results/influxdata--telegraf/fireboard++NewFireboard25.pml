...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/fireboard/fireboard.go#L25
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_NewFireboard250 = [1] of {int};
	run NewFireboard25(child_NewFireboard250);
	run receiver(child_NewFireboard250)
stop_process:skip
}

proctype NewFireboard25(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
