...
// git_link=https://github.com/influxdata/telegraf/blob//plugins/inputs/http_listener_v2/http_listener_v2_test.go#L290
typedef Wgdef {
...
init { 
	chan child_TestWriteHTTPNoNewline2900 = [1] of {int};
	run TestWriteHTTPNoNewline290(child_TestWriteHTTPNoNewline2900);
	run receiver(child_TestWriteHTTPNoNewline2900)
stop_process:skip
}

proctype TestWriteHTTPNoNewline290(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
