...
// git_link=https://github.com/gravitational/teleport/blob//lib/auth/accountrecovery_test.go#L912
typedef Wgdef {
...
init { 
	chan child_TestAccountRecoveryFlow9120 = [1] of {int};
	run TestAccountRecoveryFlow912(child_TestAccountRecoveryFlow9120);
	run receiver(child_TestAccountRecoveryFlow9120)
stop_process:skip
}

proctype TestAccountRecoveryFlow912(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
