...
// git_link=https://github.com/gravitational/teleport/blob//lib/auth/accountrecovery_test.go#L1102
typedef Wgdef {
...
init { 
	chan child_TestGetAccountRecoveryToken11020 = [1] of {int};
	run TestGetAccountRecoveryToken1102(child_TestGetAccountRecoveryToken11020);
	run receiver(child_TestGetAccountRecoveryToken11020)
stop_process:skip
}

proctype TestGetAccountRecoveryToken1102(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
