...
// git_link=https://github.com/gravitational/teleport/blob//lib/auth/password_test.go#L313
typedef Wgdef {
...
init { 
	chan child_TestChangeUserAuthentication3130 = [1] of {int};
	run TestChangeUserAuthentication313(child_TestChangeUserAuthentication3130);
	run receiver(child_TestChangeUserAuthentication3130)
stop_process:skip
}

proctype TestChangeUserAuthentication313(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
