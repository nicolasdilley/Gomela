...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example978719051/commands.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run formatterformatZoneList(zones,zones,child_formatterformatZoneList0);
...
proctype formatterformatZoneList(Chandef zones;int zones;chan child) {
	bool closed; 
	int i;
	do
