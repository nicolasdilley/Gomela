...
#define lb_for73_3  -1
#define ub_for73_4  -1
#define lb_for228_5  -1
#define ub_for228_6  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example506785681/anycast/anycast.go
typedef Chandef {
	chan sync = [0] of {int};
...
for80:
	...
	if
	:: lb_for228_5 != -1 && ub_for228_6 != -1 -> 
				for(i : lb_for228_5.. ub_for228_6) {
for90:			
			if
...
proctype go_anycastwatchRoutes(Chandef stop;Wgdef wg) {
	...
	if
	:: lb_for49_1 != -1 && ub_for49_2 != -1 -> 
				for(i : lb_for49_1.. ub_for49_2) {
for10:			do
			:: stop.async_rcv?0 -> 
				goto for10_exit
			:: stop.sync?0 -> 
...
proctype go_anycastwatchPeerState(Chandef stop;Wgdef wg) {
	...
	if
	:: lb_for73_3 != -1 && ub_for73_4 != -1 -> 
				for(i : lb_for73_3.. ub_for73_4) {
for20:			do
			:: stop.async_rcv?0 -> 
				goto for20_exit
			:: stop.sync?0 -> 
