...
// git_link=https://github.com/Netflix/chaosmonkey/blob//config/monkey_test.go#L55
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestDefaultCronForStartHourOneAM550 = [1] of {int};
	run TestDefaultCronForStartHourOneAM55(child_TestDefaultCronForStartHourOneAM550);
	run receiver(child_TestDefaultCronForStartHourOneAM550)
stop_process:skip
}

proctype TestDefaultCronForStartHourOneAM55(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
