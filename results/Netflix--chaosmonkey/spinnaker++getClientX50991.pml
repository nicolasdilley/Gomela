...
// git_link=https://github.com/Netflix/chaosmonkey/blob//spinnaker/spinnaker.go#L91
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_getClientX509910 = [1] of {int};
	run getClientX50991(child_getClientX509910);
	run receiver(child_getClientX509910)
stop_process:skip
}

proctype getClientX50991(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
