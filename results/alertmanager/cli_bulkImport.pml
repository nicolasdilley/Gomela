...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example686752549/cli/silence_import.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype cliaddSilenceWorker(Chandef silencec;Chandef errc;int silencec;chan child) {
	bool closed; 
	int i;
	do
...
proctype Anonymous0(Chandef silencec;Chandef errc;Wgdef wg) {
	...
	run cliaddSilenceWorker(silencec,errc,silencec,child_cliaddSilenceWorker0);
