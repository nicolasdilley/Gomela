...
// git_link=https://github.com/minio/minio/blob//cmd/gateway/s3/gateway-s3.go#L208
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_NewGatewayLayer2080)
stop_process:skip
}
...
proctype NewGatewayLayer208(chan child) {
	...
	run newS3165(t_Transport_altMu,t_Transport_connsPerHostMu,t_Transport_idleMu,t_Transport_nextProtoOnce_m,t_Transport_reqMu,t_Transport_TLSClientConfig_mutex,child_newS31650);
	child_newS31650?0;
...
proctype newS3165(Mutexdef tripper_Transport_altMu;Mutexdef tripper_Transport_connsPerHostMu;Mutexdef tripper_Transport_idleMu;Mutexdef tripper_Transport_nextProtoOnce_m;Mutexdef tripper_Transport_reqMu;Mutexdef tripper_Transport_TLSClientConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
