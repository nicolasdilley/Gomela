...
// git_link=https://github.com/minio/minio/blob//cmd/gateway/azure/gateway-azure.go#L141
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_NewGatewayLayer1410 = [1] of {int};
	run NewGatewayLayer141(child_NewGatewayLayer1410);
	run receiver(child_NewGatewayLayer1410)
stop_process:skip
}

proctype NewGatewayLayer141(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
