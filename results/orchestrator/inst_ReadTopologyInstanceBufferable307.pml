...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example471388622/go/inst/instance_dao.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: true -> 
		waitGroup.Add!1;
		run Anonymous10(errorChan,waitGroup,serverUuidWaitGroup)
	:: true;
	fi;
...
proctype Anonymous10(Chandef errorChan;Wgdef waitGroup;Wgdef serverUuidWaitGroup) {
	bool closed; 
	int i;
	bool state;
stop_process:	waitGroup.Add!-1
