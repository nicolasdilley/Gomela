...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example635258250/pkg/manifest1/exec.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Chandef done;
	int i;
	chan child_manifest1RunAsync1 = [0] of {int};
	bool state = false;
