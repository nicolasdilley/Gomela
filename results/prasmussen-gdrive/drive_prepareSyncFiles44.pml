...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example714043170/drive/sync.go
typedef Chandef {
...
init { 
	...
	run go_Anonymous0(localCh,remoteCh);
...
proctype go_Anonymous0(Chandef localCh;Chandef remoteCh) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
