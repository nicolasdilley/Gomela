#define config_GetRuntime_MaxCount  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example489184064/server/runtime_lua.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	bool state = false;
	int config_GetRuntime_MinCount = 5;
