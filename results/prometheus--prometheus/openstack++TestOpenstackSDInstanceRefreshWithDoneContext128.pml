...
// https://github.com/prometheus/prometheus/blob/master/discovery/openstack/instance_test.go#L128
typedef Wgdef {
...
init { 
	chan child_TestOpenstackSDInstanceRefreshWithDoneContext1280 = [1] of {int};
	run TestOpenstackSDInstanceRefreshWithDoneContext128(child_TestOpenstackSDInstanceRefreshWithDoneContext1280)
stop_process:skip
}

proctype TestOpenstackSDInstanceRefreshWithDoneContext128(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
