...
// https://github.com/prometheus/prometheus/blob/master/discovery/moby/services_test.go#L27
typedef Wgdef {
...
init { 
	chan child_TestDockerSwarmSDServicesRefresh270 = [1] of {int};
	run TestDockerSwarmSDServicesRefresh27(child_TestDockerSwarmSDServicesRefresh270)
stop_process:skip
}

proctype TestDockerSwarmSDServicesRefresh27(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
