...
// https://github.com/prometheus/prometheus/blob/master/discovery/hetzner/robot_test.go#L38
typedef Wgdef {
...
init { 
	chan child_TestRobotSDRefresh380 = [1] of {int};
	run TestRobotSDRefresh38(child_TestRobotSDRefresh380)
stop_process:skip
}

proctype TestRobotSDRefresh38(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
