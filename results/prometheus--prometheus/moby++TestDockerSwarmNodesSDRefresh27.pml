...
// https://github.com/prometheus/prometheus/blob/master/discovery/moby/nodes_test.go#L27
typedef Wgdef {
...
init { 
	chan child_TestDockerSwarmNodesSDRefresh270 = [1] of {int};
	run TestDockerSwarmNodesSDRefresh27(child_TestDockerSwarmNodesSDRefresh270)
stop_process:skip
}

proctype TestDockerSwarmNodesSDRefresh27(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
