...
// git_link=https://github.com/prometheus/prometheus/blob//tsdb/wal.go#L867
...
proctype Read867(chan child) {
	...
	Chandef datac_ch;
	Chandef donec_ch;
	int var_s_Intervals = -2; // opt var_s_Intervals
	int var_deletes = -2; // opt var_deletes
	int var_samples = -2; // opt var_samples
	int var_series = -2; // opt var_series
