...
// git_link=https://github.com/dgraph-io/dgraph/blob//graphql/resolve/auth_test.go#L739
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_checkAddUpdateCase7390)
stop_process:skip
}
...
proctype checkAddUpdateCase739(chan child) {
	...
	int var_tcase_JWTVar = -2; // opt var_tcase_JWTVar
