...
// git_link=https://github.com/dgraph-io/dgraph/blob//raftwal/storage_test.go#L351
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestTruncateStorage351(chan child) {
	...
	Mutexdef ds_lock;
	int var_numEntriesNew = -2; // opt var_numEntriesNew
	int var_uint64 = -2; // opt var_uint64
	int var_numEntries = -2; // opt var_numEntries
