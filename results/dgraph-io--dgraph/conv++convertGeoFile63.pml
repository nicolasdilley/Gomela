...
// git_link=https://github.com/dgraph-io/dgraph/blob//dgraph/cmd/conv/conv.go#L63
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype convertGeoFile63(chan child) {
	...
	Chandef chb_ch;
	Chandef che_ch;
	int var_f_Properties = -2; // opt var_f_Properties
	int var_fc_Features = -2; // opt var_fc_Features
