...
// git_link=https://github.com/dgraph-io/dgraph/blob//worker/worker_test.go#L245
...
init { 
	...
	run receiver(child_TestProcessTaskIndexMLayer2450)
stop_process:skip
}
...
proctype TestProcessTaskIndexMLayer245(chan child) {
	...
	run runQuery207(dg_jwtMutex,var_nil,child_runQuery2079);
