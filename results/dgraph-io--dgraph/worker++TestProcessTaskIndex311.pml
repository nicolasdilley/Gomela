...
// git_link=https://github.com/dgraph-io/dgraph/blob//worker/worker_test.go#L311
#define def_var_nil  -2 // opt uids line 207
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestProcessTaskIndex311(chan child) {
	...
	run runQuery207(dg_jwtMutex,var_nil,child_runQuery2070);
	...
	run runQuery207(dg_jwtMutex,var_nil,child_runQuery2073);
	...
	run runQuery207(dg_jwtMutex,var_nil,child_runQuery2078);
