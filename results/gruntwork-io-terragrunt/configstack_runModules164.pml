#define runModules_parallelism  3
#define runModules_modules  3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example765408886/configstack/running_module.go
typedef Chandef {
	chan sync = [0] of {int};
