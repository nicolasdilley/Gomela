...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example778389005/services/telemetry/telemetry.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run go_Anonymous0(activeUsersDailyCountChan,activeUsersMonthlyCountChan)
stop_process:skip
}

proctype go_Anonymous0(Chandef activeUsersDailyCountChan;Chandef activeUsersMonthlyCountChan) {
	bool closed; 
	int i;
	bool state;
