...
// git_link=https://github.com/traefik/traefik/blob//pkg/server/router/router_test.go#L24
typedef Wgdef {
...
proctype TestRouterManager_Get24(chan child) {
	...
	int var_test_expected_RequestHeaders = -2; // opt var_test_expected_RequestHeaders
