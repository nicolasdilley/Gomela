...
// git_link=https://github.com/traefik/traefik/blob//pkg/middlewares/auth/forward_test.go#L143
typedef Wgdef {
...
proctype TestForwardAuthRemoveHopByHopHeaders143(chan child) {
	...
	int var_forward_HopHeaders = -2; // opt var_forward_HopHeaders
	int var_hopHeaders = -2; // opt var_hopHeaders
