...
// git_link=https://github.com/traefik/traefik/blob//pkg/middlewares/requestdecorator/hostresolver.go#L76
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype cnameResolve76(chan child) {
	...
	:: var_config_Servers-1 != -3 -> 
			...
			for10: skip;
			run getRecord105(client_Dialer_Resolver_lookupGroup_mu,client_TLSConfig_mutex,child_getRecord1050);
	...
	:: else -> 
		...
		:: true -> 
			for11: skip;
			run getRecord105(client_Dialer_Resolver_lookupGroup_mu,client_TLSConfig_mutex,child_getRecord1051);
...
proctype getRecord105(Mutexdef client_Dialer_Resolver_lookupGroup_mu;Mutexdef client_TLSConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
