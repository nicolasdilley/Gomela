...
// https://github.com/traefik/traefik/blob/master/pkg/middlewares/auth/forward.go#L53
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_NewForward530 = [1] of {int};
	run NewForward53(child_NewForward530)
stop_process:skip
}

proctype NewForward53(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
