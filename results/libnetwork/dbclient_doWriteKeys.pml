#define parallelWriters  5
#define lb_for169_1  -1
#define ub_for169_2  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example215817652/cmd/networkdb-test/dbclient/ndbClient.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10_exit:	run dbclientwaitWriters(doneCh,parallelWriters,child_dbclientwaitWriters0);
	child_dbclientwaitWriters0?0;
		for(i : 0.. parallelWriters-1) {
for30:		run go_dbclientwriteKeysNumber(doneCh,servicePort)
	};
...
proctype go_dbclientwriteKeysNumber(Chandef doneCh;int number) {
	bool closed; 
	int i;
	
	if
	:: lb_for169_1 != -1 && ub_for169_2 != -1 -> 
				for(i : lb_for169_1.. ub_for169_2) {
for31:
		}
	:: else -> 
		do
