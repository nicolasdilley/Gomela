...
// git_link=https://github.com/rancher/rancher/blob//pkg/kontainer-engine/types/rpc_client.go#L14
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype NewClient14(chan child) {
	...
	run NewDriverClient1259(conn_balancerWrapper_balancerMu,conn_balancerWrapper_done_o_m,conn_balancerWrapper_mu,conn_balancerWrapper_scBuffer_mu,conn_blockingpicker_mu,conn_csMgr_mu,conn_firstResolveEvent_o_m,conn_mu,conn_resolverWrapper_done_o_m,conn_resolverWrapper_pollingMu,conn_resolverWrapper_resolverMu,child_NewDriverClient12590);
	child_NewDriverClient12590?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype NewDriverClient1259(Mutexdef cc_balancerWrapper_balancerMu;Mutexdef cc_balancerWrapper_done_o_m;Mutexdef cc_balancerWrapper_mu;Mutexdef cc_balancerWrapper_scBuffer_mu;Mutexdef cc_blockingpicker_mu;Mutexdef cc_csMgr_mu;Mutexdef cc_firstResolveEvent_o_m;Mutexdef cc_mu;Mutexdef cc_resolverWrapper_done_o_m;Mutexdef cc_resolverWrapper_pollingMu;Mutexdef cc_resolverWrapper_resolverMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
