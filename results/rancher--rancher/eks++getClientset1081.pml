...
// git_link=https://github.com/rancher/rancher/blob//pkg/kontainer-engine/drivers/eks/eks_driver.go#L1081
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_getClientset10810 = [1] of {int};
	run getClientset1081(child_getClientset10810);
	run receiver(child_getClientset10810)
stop_process:skip
}

proctype getClientset1081(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
