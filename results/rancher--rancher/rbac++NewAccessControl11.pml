...
// git_link=https://github.com/rancher/rancher/blob//pkg/rbac/access_control.go#L11
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype NewAccessControl11(chan child) {
	...
	run NewAccessControlWithASL16(asl_cache_cache_lock,asl_cache_lock,asl_groups_revisions_roleRevisions_mu,asl_users_revisions_roleRevisions_mu,child_NewAccessControlWithASL160);
	child_NewAccessControlWithASL160?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype NewAccessControlWithASL16(Mutexdef asl_cache_cache_lock;Mutexdef asl_cache_lock;Mutexdef asl_groups_revisions_roleRevisions_mu;Mutexdef asl_users_revisions_roleRevisions_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
