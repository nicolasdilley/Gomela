...
// git_link=https://github.com/rancher/rancher/blob//pkg/controllers/management/auth/role_template_lifecycle_test.go#L17
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestEnqueuePrtbsOnRoleTemplateUpdate170)
stop_process:skip
}
...
proctype TestEnqueuePrtbsOnRoleTemplateUpdate17(chan child) {
	...
	int var_existingPrtbs = -2; // opt var_existingPrtbs
