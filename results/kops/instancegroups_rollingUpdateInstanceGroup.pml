#define maxConcurrency  5
#define lb_for256_1  -1
#define ub_for256_2  -1
#define lb_for205_3  -1
#define ub_for205_4  -1
#define lb_for219_5  -1
#define ub_for219_6  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example744841960/pkg/instancegroups/instancegroups.go
typedef Chandef {
	chan sync = [0] of {int};
...
sweep:				
		if
		:: lb_for205_3 != -1 && ub_for205_4 != -1 -> 
						for(i : lb_for205_3.. ub_for205_4) {
for22:				do
				:: true -> 
					goto sweep;
					break
...
for22_exit:
	...
	:: true -> 
		...
		if
		:: lb_for219_5 != -1 && ub_for219_6 != -1 -> 
						for(i : lb_for219_5.. ub_for219_6) {
for30:				
				if
				:: terminateChan.async_rcv?0;
				:: terminateChan.sync?0;
...
proctype instancegroupswaitForPendingBeforeReturningError(Chandef terminateChan;chan child) {
	...
	if
	:: lb_for256_1 != -1 && ub_for256_2 != -1 -> 
				for(i : lb_for256_1.. ub_for256_2) {
for21:			
			if
			:: terminateChan.async_rcv?0;
			:: terminateChan.sync?0;
