...
// git_link=https://github.com/kataras/iris/blob//iris.go#L366
typedef Wgdef {
...
proctype Minify366(chan child) {
	...
	run SetWriter184(w_writer_wg,w_m_mutex,w_writer_pw_p_wrMu,child_SetWriter1840);
	child_SetWriter1840?0;
	stop_process: skip;
	child!0
}
proctype SetWriter184(Wgdef underline_writer_wg;Mutexdef underline_m_mutex;Mutexdef underline_writer_pw_p_wrMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
