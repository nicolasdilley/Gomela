...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example983313288/go/vt/wrangler/reparent.go
typedef Chandef {
...
init { 
	...
	run wgMonitor(wgReplicas);
		...
		wgReplicas.Add!1;
		run go_Anonymous0(positions,wgStopAll,wgReplicas);
		for40_end: skip
	};
	for40_exit: skip;
...
proctype go_Anonymous0(Chandef positions;Wgdef wgStopAll;Wgdef wgReplicas) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
