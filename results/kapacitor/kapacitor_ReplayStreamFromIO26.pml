...
init { 
	...
	run Anonymous1(allErrs,errC,points);
...
proctype Anonymous1(Chandef allErrs;Chandef errC;Chandef points) {
	bool closed; 
	int i;
	bool state;
	chan child_kapacitorreadPointsFromIO0 = [0] of {int};
	run kapacitorreadPointsFromIO(points,child_kapacitorreadPointsFromIO0);
	child_kapacitorreadPointsFromIO0?0;
