...
// https://github.com/helm/helm/blob/master/pkg/action/list_test.go#L70
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestList_OneNamespace700 = [1] of {int};
	run TestList_OneNamespace70(child_TestList_OneNamespace700)
stop_process:skip
}

proctype TestList_OneNamespace70(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
