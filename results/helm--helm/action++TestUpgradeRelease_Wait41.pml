...
// https://github.com/helm/helm/blob/master/pkg/action/upgrade_test.go#L41
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestUpgradeRelease_Wait410 = [1] of {int};
	run TestUpgradeRelease_Wait41(child_TestUpgradeRelease_Wait410)
stop_process:skip
}

proctype TestUpgradeRelease_Wait41(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
