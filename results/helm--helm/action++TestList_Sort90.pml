...
// https://github.com/helm/helm/blob/master/pkg/action/list_test.go#L90
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestList_Sort900 = [1] of {int};
	run TestList_Sort90(child_TestList_Sort900)
stop_process:skip
}

proctype TestList_Sort90(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
