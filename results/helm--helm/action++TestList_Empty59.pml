...
// https://github.com/helm/helm/blob/master/pkg/action/list_test.go#L59
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestList_Empty590 = [1] of {int};
	run TestList_Empty59(child_TestList_Empty590)
stop_process:skip
}

proctype TestList_Empty59(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
