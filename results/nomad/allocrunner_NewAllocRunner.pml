...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example542209901/client/allocrunner/alloc_runner.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: 1 > 0 -> 
		...
		run emptyChan(ar_taskStateUpdatedCh)
	:: else -> 
	...
	:: 1 > 0 -> 
		...
		run emptyChan(ar_allocUpdatedCh)
	:: else -> 
