...
// git_link=https://github.com/pingcap/tidb/blob//planner/core/logical_plans.go#L867
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype deriveIndexPathStats867(chan child) {
	...
	:: var_path_Ranges-1 != -3 -> 
			...
			for20: skip;
			run IsPoint55(sc_DiskTracker_actionMu,sc_DiskTracker_mu,sc_DiskTracker_parMu,sc_digestMemo_m,sc_MemTracker_actionMu,sc_MemTracker_mu,sc_MemTracker_parMu,sc_mu,sc_RuntimeStatsColl_mu,child_IsPoint550);
			child_IsPoint550?0;
	...
	:: else -> 
		...
		:: true -> 
			for25: skip;
			run IsPoint55(sc_DiskTracker_actionMu,sc_DiskTracker_mu,sc_DiskTracker_parMu,sc_digestMemo_m,sc_MemTracker_actionMu,sc_MemTracker_mu,sc_MemTracker_parMu,sc_mu,sc_RuntimeStatsColl_mu,child_IsPoint551);
			child_IsPoint551?0;
...
proctype IsPoint55(Mutexdef sc_DiskTracker_actionMu;Mutexdef sc_DiskTracker_mu;Mutexdef sc_DiskTracker_parMu;Mutexdef sc_digestMemo_m;Mutexdef sc_MemTracker_actionMu;Mutexdef sc_MemTracker_mu;Mutexdef sc_MemTracker_parMu;Mutexdef sc_mu;Mutexdef sc_RuntimeStatsColl_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
