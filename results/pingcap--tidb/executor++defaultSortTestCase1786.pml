...
// https://github.com/pingcap/tidb/blob/master/executor/benchmark_test.go#L1786
typedef Wgdef {
...
init { 
	chan child_defaultSortTestCase17860 = [1] of {int};
	run defaultSortTestCase1786(child_defaultSortTestCase17860)
stop_process:skip
}

proctype defaultSortTestCase1786(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
