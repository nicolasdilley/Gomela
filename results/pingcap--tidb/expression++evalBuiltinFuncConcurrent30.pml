...
// git_link=https://github.com/pingcap/tidb/blob//expression/builtin_test.go#L30
#define def_var_concurrency33  ?? // mand concurrency line 33
typedef Wgdef {
...
proctype evalBuiltinFuncConcurrent30(chan child) {
	...
	Mutexdef lock;
	Wgdef wg;
	int var_concurrency = def_var_concurrency33; // mand var_concurrency
	run wgMonitor(wg);
