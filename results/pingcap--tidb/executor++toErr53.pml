...
// git_link=https://github.com/pingcap/tidb/blob//executor/ddl.go#L53
typedef Wgdef {
...
proctype NewSchemaChecker45(Wgdef do_wg;Mutexdef do_bindHandle_bindInfo;Mutexdef do_bindHandle_sctx;Mutexdef do_etcdClient_cfg_TLS_mutex;Mutexdef do_etcdClient_conn_balancerWrapper_balancerMu;Mutexdef do_etcdClient_conn_balancerWrapper_mu;Mutexdef do_etcdClient_conn_blockingpicker_mu;Mutexdef do_etcdClient_conn_csMgr_mu;Mutexdef do_etcdClient_conn_mu;Mutexdef do_etcdClient_conn_resolverWrapper_pollingMu;Mutexdef do_etcdClient_conn_resolverWrapper_resolverMu;Mutexdef do_etcdClient_mu;Mutexdef do_etcdClient_resolverGroup_mu;Mutexdef do_gvc_SingleFight_mu;Mutexdef do_info_etcdCli_conn_mu;Mutexdef do_info_etcdCli_mu;Mutexdef do_info_etcdCli_resolverGroup_mu;Mutexdef do_info_session_client_mu;Mutexdef do_info_topologySession_client_mu;Mutexdef do_m;Mutexdef do_serverIDSession_client_conn_mu;Mutexdef do_serverIDSession_client_mu;Mutexdef do_serverIDSession_client_resolverGroup_mu;Mutexdef do_slowQuery_mu;Mutexdef do_sysSessionPool_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
