...
// git_link=https://github.com/pingcap/tidb/blob//executor/builder.go#L1620
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_buildTopN16200 = [1] of {int};
	run buildTopN1620(child_buildTopN16200);
	run receiver(child_buildTopN16200)
stop_process:skip
}

proctype buildTopN1620(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
