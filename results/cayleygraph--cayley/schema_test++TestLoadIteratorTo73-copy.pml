...
// git_link=https://github.com/cayleygraph/cayley/blob//schema/loader_test.go#L73
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestLoadIteratorTo73(chan child) {
	...
	int var_c_from = -2; // opt var_c_from
	int var_testFillValueCases = -2; // opt var_testFillValueCases
