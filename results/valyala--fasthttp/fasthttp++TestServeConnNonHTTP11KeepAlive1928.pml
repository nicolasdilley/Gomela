...
// https://github.com/valyala/fasthttp/blob/master/server_test.go#L1928
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestServeConnNonHTTP11KeepAlive1928(chan child) {
	...
	Chandef ch;
	run sync_monitor(ch);
	run AnonymousTestServeConnNonHTTP11KeepAlive19391938(ch,child_AnonymousTestServeConnNonHTTP11KeepAlive193919380);
	do
...
proctype AnonymousTestServeConnNonHTTP11KeepAlive19391938(Chandef ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
