...
// git_link=https://github.com/valyala/fasthttp/blob//workerpool_test.go#L18
#define def_var_concurrency22  ?? // mand concurrency line 22
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestWorkerPoolStartStopConcurrent18(chan child) {
	...
	Chandef ch_ch;
	int var_concurrency = def_var_concurrency22; // mand var_concurrency
	...
	:: else -> 
		...
		for10: skip;
		run AnonymousTestWorkerPoolStartStopConcurrent2422(ch_ch,child_AnonymousTestWorkerPoolStartStopConcurrent24220);
...
proctype AnonymousTestWorkerPoolStartStopConcurrent2422(Chandef ch_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
