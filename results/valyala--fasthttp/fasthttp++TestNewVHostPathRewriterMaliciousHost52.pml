...
// https://github.com/valyala/fasthttp/blob/master/fs_test.go#L52
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestNewVHostPathRewriterMaliciousHost520 = [1] of {int};
	run TestNewVHostPathRewriterMaliciousHost52(child_TestNewVHostPathRewriterMaliciousHost520)
stop_process:skip
}

proctype TestNewVHostPathRewriterMaliciousHost52(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
