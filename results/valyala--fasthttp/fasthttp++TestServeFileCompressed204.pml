...
// https://github.com/valyala/fasthttp/blob/master/fs_test.go#L204
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestServeFileCompressed2040 = [1] of {int};
	run TestServeFileCompressed204(child_TestServeFileCompressed2040)
stop_process:skip
}

proctype TestServeFileCompressed204(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
