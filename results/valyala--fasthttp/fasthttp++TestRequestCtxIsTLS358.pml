...
// git_link=https://github.com/valyala/fasthttp/blob//server_test.go#L358
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRequestCtxIsTLS358(chan child) {
	...
	run IsTLS703(ctx_s_mu,ctx_s_perIPConnCounter_lock,ctx_s_tlsConfig_mutex,child_IsTLS7030);
	child_IsTLS7030?0;
	run IsTLS703(ctx_s_mu,ctx_s_perIPConnCounter_lock,ctx_s_tlsConfig_mutex,child_IsTLS7031);
	child_IsTLS7031?0;
	run IsTLS703(ctx_s_mu,ctx_s_perIPConnCounter_lock,ctx_s_tlsConfig_mutex,child_IsTLS7032);
	child_IsTLS7032?0;
	stop_process: skip;
	child!0
}
proctype IsTLS703(Mutexdef ctx_s_mu;Mutexdef ctx_s_perIPConnCounter_lock;Mutexdef ctx_s_tlsConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
