...
// git_link=https://github.com/valyala/fasthttp/blob//client_test.go#L121
#define def_var_attempts143  ?? // mand attempts line 143
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype AnonymousTestPipelineClientIssue832142124(Mutexdef ln_lock;Mutexdef client_TLSConfig_mutex;Mutexdef client_connClientsLock;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousAnonymousTestPipelineClientIssue8321421491240 = [1] of {int};
	int var_attempts = def_var_attempts143; // mand var_attempts
		...
		if
		:: true -> 
			run AnonymousAnonymousTestPipelineClientIssue832142149124(ln_lock,client_TLSConfig_mutex,client_connClientsLock,child_AnonymousAnonymousTestPipelineClientIssue8321421491240);
			run receiver(child_AnonymousAnonymousTestPipelineClientIssue8321421491240)
		:: true;
		fi;
		for10_end: skip
	};
...
proctype AnonymousTestPipelineClientIssue832158157(Chandef done_ch;Mutexdef ln_lock;Mutexdef client_TLSConfig_mutex;Mutexdef client_connClientsLock;chan child) {
	...
	int var_attempts = -2; // opt var_attempts
