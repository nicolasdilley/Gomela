...
// https://github.com/valyala/fasthttp/blob/master/fs_test.go#L270
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestServeFileUncompressed2700 = [1] of {int};
	run TestServeFileUncompressed270(child_TestServeFileUncompressed2700)
stop_process:skip
}

proctype TestServeFileUncompressed270(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
