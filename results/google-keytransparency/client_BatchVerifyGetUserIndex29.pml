...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example138612200/core/client/batch_get_and_verify.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run wgMonitor(wg);
		...
		for10: skip;
		wg.Add!1;
		run go_Anonymous0(proofs,done,results,wg);
		for10_end: skip
	};
	for10_exit: skip;
...
proctype go_Anonymous0(Chandef proofs;Chandef done;Chandef results;Wgdef wg) {
	bool closed; 
	int i;
	bool state;
	do
