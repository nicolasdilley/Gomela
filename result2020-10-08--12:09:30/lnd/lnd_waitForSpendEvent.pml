...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example975776158/breacharbiter.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype Anonymous0(Chandef anySpend;Chandef allSpends;Chandef exit;Wgdef wg) {
	...
	:: true -> 
		...
		if
		:: allSpends.async_send!0;
		:: allSpends.sync!0 -> 
			allSpends.sending?0
		fi;
		
		if
		:: anySpend.async_send!0;
		:: anySpend.sync!0 -> 
			anySpend.sending?0
		fi
	:: exit.async_rcv?0 -> 
