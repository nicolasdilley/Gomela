...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/daemon/logger/splunk/splunk.go#L155
...
proctype New155(chan child) {
	...
	if
	:: true -> 
		run verifySplunkConnection623(logger_stream_ch,logger_lock,logger_transport_altMu,logger_transport_connsPerHostMu,logger_transport_idleMu,logger_transport_reqMu,child_verifySplunkConnection6230);
...
proctype verifySplunkConnection623(Chandef l_stream_ch;Mutexdef l_lock;Mutexdef l_transport_altMu;Mutexdef l_transport_connsPerHostMu;Mutexdef l_transport_idleMu;Mutexdef l_transport_reqMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
