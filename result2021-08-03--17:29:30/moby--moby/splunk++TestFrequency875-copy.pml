...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/daemon/logger/splunk/splunk_test.go#L875
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFrequency8750 = [1] of {int};
	run TestFrequency875(child_TestFrequency8750);
	run receiver(child_TestFrequency8750)
stop_process:skip
}

proctype TestFrequency875(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
