...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/daemon/logger/splunk/splunk_test.go#L118
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestDefault1180 = [1] of {int};
	run TestDefault118(child_TestDefault1180);
	run receiver(child_TestDefault1180)
stop_process:skip
}

proctype TestDefault118(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
