...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/daemon/logger/splunk/splunk_test.go#L349
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestJsonFormat3490 = [1] of {int};
	run TestJsonFormat349(child_TestJsonFormat3490);
	run receiver(child_TestJsonFormat3490)
stop_process:skip
}

proctype TestJsonFormat349(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
