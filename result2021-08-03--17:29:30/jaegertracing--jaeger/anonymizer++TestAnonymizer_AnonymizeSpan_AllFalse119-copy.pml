...
// git_link=https://github.com/jaegertracing/jaeger/blob/12bba8c9b91cf4a29d314934bc08f4a80e43c042/cmd/anonymizer/app/anonymizer/anonymizer_test.go#L119
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestAnonymizer_AnonymizeSpan_AllFalse1190)
stop_process:skip
}
...
proctype AnonymizeSpan145(Mutexdef a_lock;chan child) {
	...
	int var_span_Logs = -2; // opt var_span_Logs
