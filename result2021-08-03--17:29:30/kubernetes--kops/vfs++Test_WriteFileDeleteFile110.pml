...
// git_link=https://github.com/kubernetes/kops/blob/e3fbc2ad043e58cfdcf934e015ef8d5d9e42273e/util/pkg/vfs/vaultfs_test.go#L110
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Test_WriteFileDeleteFile110(chan child) {
	...
	run Remove109(p_vaultClient_modifyLock,child_Remove1092);
	child_Remove1092?0;
	run ReadFile93(p_vaultClient_modifyLock,child_ReadFile933);
	child_ReadFile933?0;
	stop_process: skip;
	child!0
}
...
proctype Remove109(Mutexdef p_vaultClient_modifyLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype ReadFile93(Mutexdef p_vaultClient_modifyLock;chan child) {
	...
	run dataPath221(p_vaultClient_modifyLock,child_dataPath2213);
