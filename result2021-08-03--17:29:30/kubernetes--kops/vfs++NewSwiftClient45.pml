...
// git_link=https://github.com/kubernetes/kops/blob/e3fbc2ad043e58cfdcf934e015ef8d5d9e42273e/util/pkg/vfs/swiftfs.go#L45
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_NewSwiftClient450 = [1] of {int};
	run NewSwiftClient45(child_NewSwiftClient450);
	run receiver(child_NewSwiftClient450)
stop_process:skip
}

proctype NewSwiftClient45(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
