...
// git_link=https://github.com/kubernetes/kops/blob/e3fbc2ad043e58cfdcf934e015ef8d5d9e42273e/dnsprovider/pkg/dnsprovider/providers/openstack/designate/designate.go#L43
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_newDesignate430 = [1] of {int};
	run newDesignate43(child_newDesignate430);
	run receiver(child_newDesignate430)
stop_process:skip
}

proctype newDesignate43(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
