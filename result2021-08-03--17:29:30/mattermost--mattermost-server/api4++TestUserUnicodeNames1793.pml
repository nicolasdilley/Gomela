...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L1793
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUserUnicodeNames17930 = [1] of {int};
	run TestUserUnicodeNames1793(child_TestUserUnicodeNames17930);
	run receiver(child_TestUserUnicodeNames17930)
stop_process:skip
}

proctype TestUserUnicodeNames1793(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
