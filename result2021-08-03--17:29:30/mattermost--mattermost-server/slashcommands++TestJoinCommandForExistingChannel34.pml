...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/app/slashcommands/command_join_test.go#L34
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestJoinCommandForExistingChannel340 = [1] of {int};
	run TestJoinCommandForExistingChannel34(child_TestJoinCommandForExistingChannel340);
	run receiver(child_TestJoinCommandForExistingChannel340)
stop_process:skip
}

proctype TestJoinCommandForExistingChannel34(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
