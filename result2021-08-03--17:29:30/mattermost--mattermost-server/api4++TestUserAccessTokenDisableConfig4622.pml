...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L4622
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUserAccessTokenDisableConfig46220 = [1] of {int};
	run TestUserAccessTokenDisableConfig4622(child_TestUserAccessTokenDisableConfig46220);
	run receiver(child_TestUserAccessTokenDisableConfig46220)
stop_process:skip
}

proctype TestUserAccessTokenDisableConfig4622(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
