...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/file_test.go#L1067
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSearchFiles10670 = [1] of {int};
	run TestSearchFiles1067(child_TestSearchFiles10670);
	run receiver(child_TestSearchFiles10670)
stop_process:skip
}

proctype TestSearchFiles1067(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_LoginBasic7051 = [1] of {int};
	...
	run LoginBasic705(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginBasic7051);
	child_LoginBasic7051?0;
...
proctype LoginBasic705(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_LoginBasicWithClient7251 = [1] of {int};
	run LoginBasicWithClient725(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginBasicWithClient7251);
	child_LoginBasicWithClient7251?0;
	stop_process: skip;
	child!0
}
...
proctype CreateChannelWithClient594(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_CreateChannelWithClientAndTeam5982 = [1] of {int};
	run CreateChannelWithClientAndTeam598(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateChannelWithClientAndTeam5982);
	child_CreateChannelWithClientAndTeam5982?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
