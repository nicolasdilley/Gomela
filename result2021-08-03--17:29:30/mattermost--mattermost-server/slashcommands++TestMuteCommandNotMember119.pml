...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/app/slashcommands/command_mute_test.go#L119
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestMuteCommandNotMember1190 = [1] of {int};
	run TestMuteCommandNotMember119(child_TestMuteCommandNotMember1190);
	run receiver(child_TestMuteCommandNotMember1190)
stop_process:skip
}

proctype TestMuteCommandNotMember119(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
