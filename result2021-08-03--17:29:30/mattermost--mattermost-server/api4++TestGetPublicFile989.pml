...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/file_test.go#L989
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetPublicFile9890 = [1] of {int};
	run TestGetPublicFile989(child_TestGetPublicFile9890);
	run receiver(child_TestGetPublicFile9890)
stop_process:skip
}

proctype TestGetPublicFile989(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_TearDown2920 = [1] of {int};
	chan child_cleanupTestFile10052 = [1] of {int};
	chan child_cleanupTestFile10051 = [1] of {int};
	...
	run cleanupTestFile1005(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_cleanupTestFile10051);
	child_cleanupTestFile10051?0;
	run cleanupTestFile1005(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_cleanupTestFile10052);
	child_cleanupTestFile10052?0;
		defer1: skip;
