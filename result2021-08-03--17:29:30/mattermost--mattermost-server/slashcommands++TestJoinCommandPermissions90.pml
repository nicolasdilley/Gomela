...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/app/slashcommands/command_join_test.go#L90
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestJoinCommandPermissions900 = [1] of {int};
	run TestJoinCommandPermissions90(child_TestJoinCommandPermissions900);
	run receiver(child_TestJoinCommandPermissions900)
stop_process:skip
}

proctype TestJoinCommandPermissions90(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
