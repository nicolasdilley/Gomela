...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L5616
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestFollowThreads56160 = [1] of {int};
	run TestFollowThreads5616(child_TestFollowThreads56160);
	run receiver(child_TestFollowThreads56160)
stop_process:skip
}

proctype TestFollowThreads5616(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
