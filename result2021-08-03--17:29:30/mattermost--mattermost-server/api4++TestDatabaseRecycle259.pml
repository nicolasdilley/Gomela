...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/system_test.go#L259
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestDatabaseRecycle2590 = [1] of {int};
	run TestDatabaseRecycle259(child_TestDatabaseRecycle2590);
	run receiver(child_TestDatabaseRecycle2590)
stop_process:skip
}

proctype TestDatabaseRecycle259(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
