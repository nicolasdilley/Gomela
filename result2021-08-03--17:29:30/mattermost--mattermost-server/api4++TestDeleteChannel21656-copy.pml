...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L1656
#define not_found_1665  -2 // opt data line 1132
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestDeleteChannel216560 = [1] of {int};
	run TestDeleteChannel21656(child_TestDeleteChannel216560);
	run receiver(child_TestDeleteChannel216560)
stop_process:skip
}

proctype TestDeleteChannel21656(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_CreateChannelWithClient59418 = [1] of {int};
	chan child_CreateChannelWithClient59417 = [1] of {int};
	chan child_RemovePermissionFromRole115816 = [1] of {int};
	chan child_RemovePermissionFromRole115815 = [1] of {int};
	chan child_MakeUserChannelAdmin105514 = [1] of {int};
	chan child_MakeUserChannelAdmin105513 = [1] of {int};
	chan child_CreateChannelWithClient59412 = [1] of {int};
	chan child_CreateChannelWithClient59411 = [1] of {int};
	chan child_AddPermissionToRole119010 = [1] of {int};
	chan child_AddPermissionToRole11909 = [1] of {int};
	chan child_RemovePermissionFromRole11588 = [1] of {int};
	chan child_RemovePermissionFromRole11587 = [1] of {int};
	chan child_CreateChannelWithClient5946 = [1] of {int};
	chan child_CreateChannelWithClient5945 = [1] of {int};
	...
	run CreateChannelWithClient594(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateChannelWithClient5945);
	child_CreateChannelWithClient5945?0;
	run CreateChannelWithClient594(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateChannelWithClient5946);
	child_CreateChannelWithClient5946?0;
	run RemovePermissionFromRole1158(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_RemovePermissionFromRole11587);
	child_RemovePermissionFromRole11587?0;
	...
	run AddPermissionToRole1190(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_AddPermissionToRole119010);
	child_AddPermissionToRole119010?0;
	run CreateChannelWithClient594(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateChannelWithClient59411);
	child_CreateChannelWithClient59411?0;
	run CreateChannelWithClient594(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateChannelWithClient59412);
	child_CreateChannelWithClient59412?0;
	run MakeUserChannelAdmin1055(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_MakeUserChannelAdmin105513);
	child_MakeUserChannelAdmin105513?0;
	run MakeUserChannelAdmin1055(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_MakeUserChannelAdmin105514);
	child_MakeUserChannelAdmin105514?0;
	run RemovePermissionFromRole1158(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_RemovePermissionFromRole115815);
	child_RemovePermissionFromRole115815?0;
	...
	run CreateChannelWithClient594(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateChannelWithClient59417);
	child_CreateChannelWithClient59417?0;
	run CreateChannelWithClient594(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateChannelWithClient59418);
	child_CreateChannelWithClient59418?0;
		defer2: skip;
	run RestoreDefaultRolePermissions1132(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,not_found_1665,child_RestoreDefaultRolePermissions11322);
...
proctype CreateChannelWithClient594(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_CreateChannelWithClientAndTeam5985 = [1] of {int};
	run CreateChannelWithClientAndTeam598(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateChannelWithClientAndTeam5985);
	child_CreateChannelWithClientAndTeam5985?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
...
proctype MakeUserChannelAdmin1055(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
