...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/scheme_test.go#L581
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestDeleteScheme5810 = [1] of {int};
	run TestDeleteScheme581(child_TestDeleteScheme5810);
	run receiver(child_TestDeleteScheme5810)
stop_process:skip
}

proctype TestDeleteScheme581(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
