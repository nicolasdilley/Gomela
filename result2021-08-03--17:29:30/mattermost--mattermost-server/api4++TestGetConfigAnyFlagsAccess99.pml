...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/config_test.go#L99
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetConfigAnyFlagsAccess990 = [1] of {int};
	run TestGetConfigAnyFlagsAccess99(child_TestGetConfigAnyFlagsAccess990);
	run receiver(child_TestGetConfigAnyFlagsAccess990)
stop_process:skip
}

proctype TestGetConfigAnyFlagsAccess99(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
