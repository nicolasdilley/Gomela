...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L3330
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestTeamMembersMinusGroupMembers33300 = [1] of {int};
	run TestTeamMembersMinusGroupMembers3330(child_TestTeamMembersMinusGroupMembers33300);
	run receiver(child_TestTeamMembersMinusGroupMembers33300)
stop_process:skip
}

proctype TestTeamMembersMinusGroupMembers3330(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_TearDown2920 = [1] of {int};
	chan child_CreateGroup8123 = [1] of {int};
	chan child_CreateGroup8122 = [1] of {int};
	chan child_CreateTeam4711 = [1] of {int};
	...
	run CreateTeam471(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateTeam4711);
	child_CreateTeam4711?0;
	run CreateGroup812(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateGroup8122);
	child_CreateGroup8122?0;
	run CreateGroup812(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateGroup8123);
	child_CreateGroup8123?0;
		defer1: skip;
...
proctype CreateGroup812(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
