...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/integration_action_test.go#L43
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestPostActionCookies430 = [1] of {int};
	run TestPostActionCookies43(child_TestPostActionCookies430);
	run receiver(child_TestPostActionCookies430)
stop_process:skip
}

proctype TestPostActionCookies43(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
