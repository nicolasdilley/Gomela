...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L3363
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestLoginWithLag33630 = [1] of {int};
	run TestLoginWithLag3363(child_TestLoginWithLag33630);
	run receiver(child_TestLoginWithLag33630)
stop_process:skip
}

proctype TestLoginWithLag3363(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
