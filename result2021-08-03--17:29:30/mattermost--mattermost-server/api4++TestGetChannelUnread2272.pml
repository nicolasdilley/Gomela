...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L2272
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetChannelUnread22720 = [1] of {int};
	run TestGetChannelUnread2272(child_TestGetChannelUnread22720);
	run receiver(child_TestGetChannelUnread22720)
stop_process:skip
}

proctype TestGetChannelUnread2272(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
