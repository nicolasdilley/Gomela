...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/file_test.go#L700
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetFile7000 = [1] of {int};
	run TestGetFile700(child_TestGetFile7000);
	run receiver(child_TestGetFile7000)
stop_process:skip
}

proctype TestGetFile700(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
