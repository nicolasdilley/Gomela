...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/web/oauth_test.go#L136
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestNilAuthorizeOAuthApp1360 = [1] of {int};
	run TestNilAuthorizeOAuthApp136(child_TestNilAuthorizeOAuthApp1360);
	run receiver(child_TestNilAuthorizeOAuthApp1360)
stop_process:skip
}

proctype TestNilAuthorizeOAuthApp136(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
