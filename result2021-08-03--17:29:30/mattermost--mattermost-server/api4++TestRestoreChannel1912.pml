...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L1912
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestRestoreChannel19120 = [1] of {int};
	run TestRestoreChannel1912(child_TestRestoreChannel19120);
	run receiver(child_TestRestoreChannel19120)
stop_process:skip
}

proctype TestRestoreChannel1912(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_CreatePrivateChannel5902 = [1] of {int};
	...
	run CreatePrivateChannel590(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreatePrivateChannel5902);
	child_CreatePrivateChannel5902?0;
