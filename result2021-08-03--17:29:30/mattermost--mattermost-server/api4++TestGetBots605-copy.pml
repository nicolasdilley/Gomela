...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/bot_test.go#L605
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetBots6050 = [1] of {int};
	run TestGetBots605(child_TestGetBots6050);
	run receiver(child_TestGetBots6050)
stop_process:skip
}

proctype TestGetBots605(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
