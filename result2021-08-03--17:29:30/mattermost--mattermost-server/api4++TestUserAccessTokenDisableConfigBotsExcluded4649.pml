...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L4649
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUserAccessTokenDisableConfigBotsExcluded46490 = [1] of {int};
	run TestUserAccessTokenDisableConfigBotsExcluded4649(child_TestUserAccessTokenDisableConfigBotsExcluded46490);
	run receiver(child_TestUserAccessTokenDisableConfigBotsExcluded46490)
stop_process:skip
}

proctype TestUserAccessTokenDisableConfigBotsExcluded4649(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
