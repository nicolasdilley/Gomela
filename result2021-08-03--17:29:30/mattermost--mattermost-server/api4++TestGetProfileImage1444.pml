...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L1444
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetProfileImage14440 = [1] of {int};
	run TestGetProfileImage1444(child_TestGetProfileImage14440);
	run receiver(child_TestGetProfileImage14440)
stop_process:skip
}

proctype TestGetProfileImage1444(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
