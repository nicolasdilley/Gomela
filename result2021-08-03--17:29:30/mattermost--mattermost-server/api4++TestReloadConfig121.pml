...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/config_test.go#L121
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestReloadConfig1210 = [1] of {int};
	run TestReloadConfig121(child_TestReloadConfig1210);
	run receiver(child_TestReloadConfig1210)
stop_process:skip
}

proctype TestReloadConfig121(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
