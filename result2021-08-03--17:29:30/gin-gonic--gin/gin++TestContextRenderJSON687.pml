...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L687
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextRenderJSON6870 = [1] of {int};
	run TestContextRenderJSON687(child_TestContextRenderJSON6870);
	run receiver(child_TestContextRenderJSON6870)
stop_process:skip
}

proctype TestContextRenderJSON687(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
