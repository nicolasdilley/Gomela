...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1395
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestContextClientIP13950)
stop_process:skip
}
...
proctype ClientIP733(Mutexdef c_mu;chan child) {
	...
	int var_c_engine_RemoteIPHeaders = -2; // opt var_c_engine_RemoteIPHeaders
...
proctype RemoteIP760(Mutexdef c_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_engine_trustedCIDRs = -2; // opt var_c_engine_trustedCIDRs
