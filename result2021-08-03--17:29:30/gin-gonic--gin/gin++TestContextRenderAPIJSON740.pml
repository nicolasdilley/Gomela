...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L740
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextRenderAPIJSON7400 = [1] of {int};
	run TestContextRenderAPIJSON740(child_TestContextRenderAPIJSON7400);
	run receiver(child_TestContextRenderAPIJSON7400)
stop_process:skip
}

proctype TestContextRenderAPIJSON740(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
