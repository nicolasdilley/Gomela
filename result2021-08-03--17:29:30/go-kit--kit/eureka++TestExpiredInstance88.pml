...
// git_link=https://github.com/go-kit/kit/blob/60e8424101af501c525efaf67c0a2edf08667f80/sd/eureka/registrar_test.go#L88
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestExpiredInstance880)
stop_process:skip
}
