...
// git_link=https://github.com/helm/helm/blob/43853ea772e779b617b011a8d4e69205636fa4f9/pkg/engine/engine_test.go#L203
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestParallelRenderInternals2030)
stop_process:skip
}
...
proctype TestParallelRenderInternals203(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousTestParallelRenderInternals2092090);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
