...
// git_link=https://github.com/kubernetes/minikube/blob/ce01c06fef829245cf1b940ca59cc55f4fc9c658/pkg/minikube/machine/start.go#L183
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype timedCreateHost183(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymoustimedCreateHost1921901 = [1] of {int};
	...
	run AnonymoustimedCreateHost192190(createFinished_ch,timeout_ch,child_AnonymoustimedCreateHost1921901);
	run receiver(child_AnonymoustimedCreateHost1921901);
	do
...
proctype AnonymoustimedCreateHost192190(Chandef createFinished_ch;Chandef timeout_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
