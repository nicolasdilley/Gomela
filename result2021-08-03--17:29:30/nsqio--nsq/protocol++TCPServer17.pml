...
// git_link=https://github.com/nsqio/nsq/blob/a1da1173d3bfa0ea41b73a3b75ec447a32287c52/internal/protocol/tcp_server.go#L17
#define ub_for22_2  ??
typedef Wgdef {
...
init { 
	...
	run receiver(child_TCPServer170)
stop_process:skip
}
...
proctype TCPServer17(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousTCPServer38200);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
