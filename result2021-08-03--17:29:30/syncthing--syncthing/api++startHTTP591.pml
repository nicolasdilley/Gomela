...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/api/api_test.go#L591
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run receiver(child_startHTTP5910)
stop_process:skip
}
...
proctype startHTTP591(chan child) {
	...
	if
	:: addrChan_ch.deq?state,num_msgs;
	:: addrChan_ch.sync?state -> 
		addrChan_ch.rcving!false
	fi;
