...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/db/backend/leveldb_open.go#L68
typedef Wgdef {
...
init { 
	chan child_OpenLevelDBMemory680 = [1] of {int};
	run OpenLevelDBMemory68(child_OpenLevelDBMemory680);
	run receiver(child_OpenLevelDBMemory680)
stop_process:skip
}

proctype OpenLevelDBMemory68(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
