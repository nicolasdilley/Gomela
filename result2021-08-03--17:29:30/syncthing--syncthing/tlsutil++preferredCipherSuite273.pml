...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/tlsutil/tlsutil.go#L273
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_preferredCipherSuite2730)
stop_process:skip
}
...
proctype preferredCipherSuite273(chan child) {
	...
	run receiver(child_AnonymouspreferredCipherSuite3132990);
