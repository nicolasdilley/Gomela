...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_aliases_test.go#L305
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_AliasRegister3050 = [1] of {int};
	run TestIdentityStore_AliasRegister305(child_TestIdentityStore_AliasRegister3050);
	run receiver(child_TestIdentityStore_AliasRegister3050)
stop_process:skip
}

proctype TestIdentityStore_AliasRegister305(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
