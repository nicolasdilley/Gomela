...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/barrier_aes_gcm_test.go#L548
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestAESGCMBarrier_ReloadKeyring5480 = [1] of {int};
	run TestAESGCMBarrier_ReloadKeyring548(child_TestAESGCMBarrier_ReloadKeyring5480);
	run receiver(child_TestAESGCMBarrier_ReloadKeyring5480)
stop_process:skip
}

proctype TestAESGCMBarrier_ReloadKeyring548(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_ReloadKeyring3126 = [1] of {int};
	chan child_Encrypt10355 = [1] of {int};
	chan child_ReloadKeyring3124 = [1] of {int};
	...
	child_Unseal4222?0;
	run Encrypt1035(b_cacheLock,b_l,child_Encrypt10353);
	child_Encrypt10353?0;
	run ReloadKeyring312(b_cacheLock,b_l,child_ReloadKeyring3124);
	child_ReloadKeyring3124?0;
	run Encrypt1035(b_cacheLock,b_l,child_Encrypt10355);
	child_Encrypt10355?0;
	run ReloadKeyring312(b_cacheLock,b_l,child_ReloadKeyring3126);
	child_ReloadKeyring3126?0;
	stop_process: skip;
	child!0
}
...
proctype Encrypt1035(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype ReloadKeyring312(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_recoverKeyring3596 = [1] of {int};
	chan child_decrypt10135 = [1] of {int};
	chan child_aeadFromKey9444 = [1] of {int};
	b_l.Lock!false;
	run aeadFromKey944(b_cacheLock,b_l,child_aeadFromKey9444);
	...
	run recoverKeyring359(b_cacheLock,b_l,child_recoverKeyring3596);
	child_recoverKeyring3596?0;
	goto defer1;
		defer1: skip;
	b_l.Unlock!false;
	stop_process: skip;
