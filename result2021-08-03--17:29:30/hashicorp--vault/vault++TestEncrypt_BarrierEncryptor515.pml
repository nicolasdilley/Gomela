...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/barrier_aes_gcm_test.go#L515
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestEncrypt_BarrierEncryptor5150)
stop_process:skip
}
...
proctype TestEncrypt_BarrierEncryptor515(chan child) {
	...
	run Decrypt1058(b_cacheLock,b_l,child_Decrypt10584);
...
proctype Decrypt1058(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
