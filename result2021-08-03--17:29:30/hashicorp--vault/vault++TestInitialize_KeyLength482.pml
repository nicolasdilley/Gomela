...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/barrier_aes_gcm_test.go#L482
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestInitialize_KeyLength4820)
stop_process:skip
}
...
proctype TestInitialize_KeyLength482(chan child) {
	...
	run Initialize153(b_cacheLock,b_l,child_Initialize1530);
	child_Initialize1530?0;
	run Initialize153(b_cacheLock,b_l,child_Initialize1531);
	child_Initialize1531?0;
	run Initialize153(b_cacheLock,b_l,child_Initialize1532);
...
proctype Initialize153(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run KeyLength283(b_cacheLock,b_l,child_KeyLength2830);
	...
	run Initialized127(b_cacheLock,b_l,child_Initialized1271);
	...
	run GenerateKey274(b_cacheLock,b_l,child_GenerateKey2742);
	...
	run persistKeyring210(b_cacheLock,b_l,child_persistKeyring2103);
	...
	:: true -> 
		...
		run putInternal798(b_cacheLock,b_l,child_putInternal7985);
...
proctype encryptTracked1123(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run encrypt960(b_cacheLock,b_l,child_encrypt9606);
	child_encrypt9606?0;
...
proctype putInternal798(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run encryptTracked1123(b_cacheLock,b_l,child_encryptTracked11235);
