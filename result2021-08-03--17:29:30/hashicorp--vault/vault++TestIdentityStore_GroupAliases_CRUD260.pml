...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_group_aliases_test.go#L260
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_GroupAliases_CRUD2600 = [1] of {int};
	run TestIdentityStore_GroupAliases_CRUD260(child_TestIdentityStore_GroupAliases_CRUD2600);
	run receiver(child_TestIdentityStore_GroupAliases_CRUD2600)
stop_process:skip
}

proctype TestIdentityStore_GroupAliases_CRUD260(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
