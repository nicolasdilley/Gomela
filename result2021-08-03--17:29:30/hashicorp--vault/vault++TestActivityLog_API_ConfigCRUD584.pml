...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/activity_log_test.go#L584
typedef Wgdef {
...
init { 
	chan child_TestActivityLog_API_ConfigCRUD5840 = [1] of {int};
	run TestActivityLog_API_ConfigCRUD584(child_TestActivityLog_API_ConfigCRUD5840);
	run receiver(child_TestActivityLog_API_ConfigCRUD5840)
stop_process:skip
}

proctype TestActivityLog_API_ConfigCRUD584(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
