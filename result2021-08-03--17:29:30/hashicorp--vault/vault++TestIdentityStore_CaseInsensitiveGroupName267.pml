...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_groups_test.go#L267
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_CaseInsensitiveGroupName2670 = [1] of {int};
	run TestIdentityStore_CaseInsensitiveGroupName267(child_TestIdentityStore_CaseInsensitiveGroupName2670);
	run receiver(child_TestIdentityStore_CaseInsensitiveGroupName2670)
stop_process:skip
}

proctype TestIdentityStore_CaseInsensitiveGroupName267(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
