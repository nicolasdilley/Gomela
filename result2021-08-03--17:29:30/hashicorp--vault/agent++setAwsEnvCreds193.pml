...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/command/agent/aws_end_to_end_test.go#L193
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_setAwsEnvCreds1930)
stop_process:skip
}
