...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_groups_test.go#L653
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_GroupsCreateUpdate6530 = [1] of {int};
	run TestIdentityStore_GroupsCreateUpdate653(child_TestIdentityStore_GroupsCreateUpdate6530);
	run receiver(child_TestIdentityStore_GroupsCreateUpdate6530)
stop_process:skip
}

proctype TestIdentityStore_GroupsCreateUpdate653(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
