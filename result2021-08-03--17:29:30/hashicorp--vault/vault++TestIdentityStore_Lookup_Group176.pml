...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_lookup_test.go#L176
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_Lookup_Group1760 = [1] of {int};
	run TestIdentityStore_Lookup_Group176(child_TestIdentityStore_Lookup_Group1760);
	run receiver(child_TestIdentityStore_Lookup_Group1760)
stop_process:skip
}

proctype TestIdentityStore_Lookup_Group176(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
