...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/token_store_test.go#L1767
typedef Wgdef {
...
init { 
	chan child_TestTokenStore_HandleRequest_CreateToken17670 = [1] of {int};
	run TestTokenStore_HandleRequest_CreateToken1767(child_TestTokenStore_HandleRequest_CreateToken17670);
	run receiver(child_TestTokenStore_HandleRequest_CreateToken17670)
stop_process:skip
}

proctype TestTokenStore_HandleRequest_CreateToken1767(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
