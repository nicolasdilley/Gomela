...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_aliases_test.go#L355
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_AliasUpdate3550 = [1] of {int};
	run TestIdentityStore_AliasUpdate355(child_TestIdentityStore_AliasUpdate3550);
	run receiver(child_TestIdentityStore_AliasUpdate3550)
stop_process:skip
}

proctype TestIdentityStore_AliasUpdate355(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
