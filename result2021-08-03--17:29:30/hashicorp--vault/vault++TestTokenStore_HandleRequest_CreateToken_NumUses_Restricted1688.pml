...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/token_store_test.go#L1688
typedef Wgdef {
...
init { 
	chan child_TestTokenStore_HandleRequest_CreateToken_NumUses_Restricted16880 = [1] of {int};
	run TestTokenStore_HandleRequest_CreateToken_NumUses_Restricted1688(child_TestTokenStore_HandleRequest_CreateToken_NumUses_Restricted16880);
	run receiver(child_TestTokenStore_HandleRequest_CreateToken_NumUses_Restricted16880)
stop_process:skip
}

proctype TestTokenStore_HandleRequest_CreateToken_NumUses_Restricted1688(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
