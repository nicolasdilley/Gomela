...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/helper/fairshare/jobmanager_test.go#L506
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestFairshare_nilLoggerJobManager5060)
stop_process:skip
}
