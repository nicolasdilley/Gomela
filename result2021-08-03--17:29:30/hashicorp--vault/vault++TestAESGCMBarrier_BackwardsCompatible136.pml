...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/barrier_aes_gcm_test.go#L136
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestAESGCMBarrier_BackwardsCompatible1360)
stop_process:skip
}
...
proctype TestAESGCMBarrier_BackwardsCompatible136(chan child) {
	...
	run GenerateKey274(b_cacheLock,b_l,child_GenerateKey2741);
	child_GenerateKey2741?0;
	run aeadFromKey944(b_cacheLock,b_l,child_aeadFromKey9442);
	child_aeadFromKey9442?0;
	run encrypt960(b_cacheLock,b_l,child_encrypt9603);
	child_encrypt9603?0;
	...
	child_encrypt9605?0;
	run Initialized127(b_cacheLock,b_l,child_Initialized1276);
	child_Initialized1276?0;
	run Unseal422(b_cacheLock,b_l,child_Unseal4227);
	child_Unseal4227?0;
...
proctype Unseal422(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run aeadFromKey944(b_cacheLock,b_l,child_aeadFromKey9447);
	...
	:: true -> 
		...
		run decrypt1013(b_cacheLock,b_l,child_decrypt10138);
		...
		run recoverKeyring359(b_cacheLock,b_l,child_recoverKeyring3599);
	...
	run persistKeyring210(b_cacheLock,b_l,child_persistKeyring21011);
...
proctype persistKeyring210(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run aeadFromKey944(b_cacheLock,b_l,child_aeadFromKey94411);
	...
	run encrypt960(b_cacheLock,b_l,child_encrypt96012);
	...
	run encryptTracked1123(b_cacheLock,b_l,child_encryptTracked112314);
...
proctype Get812(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run lockSwitchedGet816(b_cacheLock,b_l,child_lockSwitchedGet8168);
...
proctype lockSwitchedGet816(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run aeadForTerm909(b_cacheLock,b_l,child_aeadForTerm9098);
	...
	run decrypt1013(b_cacheLock,b_l,child_decrypt10139);
...
proctype aeadForTerm909(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run aeadFromKey944(b_cacheLock,b_l,child_aeadFromKey9448);
