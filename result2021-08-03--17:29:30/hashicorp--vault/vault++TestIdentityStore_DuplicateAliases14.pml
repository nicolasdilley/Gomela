...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_aliases_test.go#L14
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_DuplicateAliases140 = [1] of {int};
	run TestIdentityStore_DuplicateAliases14(child_TestIdentityStore_DuplicateAliases140);
	run receiver(child_TestIdentityStore_DuplicateAliases140)
stop_process:skip
}

proctype TestIdentityStore_DuplicateAliases14(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
