...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_entities_test.go#L272
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_EntityReadGroupIDs2720 = [1] of {int};
	run TestIdentityStore_EntityReadGroupIDs272(child_TestIdentityStore_EntityReadGroupIDs2720);
	run receiver(child_TestIdentityStore_EntityReadGroupIDs2720)
stop_process:skip
}

proctype TestIdentityStore_EntityReadGroupIDs272(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
