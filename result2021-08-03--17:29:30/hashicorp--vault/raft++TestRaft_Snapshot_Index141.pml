...
proctype TestRaft_Snapshot_Index141(chan child) {
	...
	:: else -> 
		...
		:: true -> 
			for20: skip;
			run Put1178(raft_autopilot_execLock,raft_autopilot_stateLock,raft_followerStates_l,raft_fsm_l,raft_l,raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_observersLock,raft_raft_shutdownLock,raft_streamLayer_closeLock,child_Put11785);
			child_Put11785?0;
			for20_end: skip
		:: true -> 
			break
