...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/command/base_predict_test.go#L224
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPredict_Audits2240 = [1] of {int};
	run TestPredict_Audits224(child_TestPredict_Audits2240);
	run receiver(child_TestPredict_Audits2240)
stop_process:skip
}

proctype TestPredict_Audits224(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
