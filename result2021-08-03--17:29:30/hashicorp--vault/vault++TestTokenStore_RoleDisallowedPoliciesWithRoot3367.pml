...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/token_store_test.go#L3367
typedef Wgdef {
...
init { 
	chan child_TestTokenStore_RoleDisallowedPoliciesWithRoot33670 = [1] of {int};
	run TestTokenStore_RoleDisallowedPoliciesWithRoot3367(child_TestTokenStore_RoleDisallowedPoliciesWithRoot33670);
	run receiver(child_TestTokenStore_RoleDisallowedPoliciesWithRoot33670)
stop_process:skip
}

proctype TestTokenStore_RoleDisallowedPoliciesWithRoot3367(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
