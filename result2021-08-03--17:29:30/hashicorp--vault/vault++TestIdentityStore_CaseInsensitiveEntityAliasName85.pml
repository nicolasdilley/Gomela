...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_aliases_test.go#L85
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_CaseInsensitiveEntityAliasName850 = [1] of {int};
	run TestIdentityStore_CaseInsensitiveEntityAliasName85(child_TestIdentityStore_CaseInsensitiveEntityAliasName850);
	run receiver(child_TestIdentityStore_CaseInsensitiveEntityAliasName850)
stop_process:skip
}

proctype TestIdentityStore_CaseInsensitiveEntityAliasName85(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
