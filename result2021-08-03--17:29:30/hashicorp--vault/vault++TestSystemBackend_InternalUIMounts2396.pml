...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/logical_system_test.go#L2396
typedef Wgdef {
...
init { 
	chan child_TestSystemBackend_InternalUIMounts23960 = [1] of {int};
	run TestSystemBackend_InternalUIMounts2396(child_TestSystemBackend_InternalUIMounts23960);
	run receiver(child_TestSystemBackend_InternalUIMounts23960)
stop_process:skip
}

proctype TestSystemBackend_InternalUIMounts2396(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
