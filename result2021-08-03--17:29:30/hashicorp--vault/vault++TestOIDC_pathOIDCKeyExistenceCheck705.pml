...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_oidc_test.go#L705
typedef Wgdef {
...
proctype TestOIDC_pathOIDCKeyExistenceCheck705(chan child) {
	...
	run pathOIDCKeyExistenceCheck682(c_identityStore_groupLock,c_identityStore_lock,c_identityStore_oidcLock,child_pathOIDCKeyExistenceCheck6820);
	child_pathOIDCKeyExistenceCheck6820?0;
	run pathOIDCKeyExistenceCheck682(c_identityStore_groupLock,c_identityStore_lock,c_identityStore_oidcLock,child_pathOIDCKeyExistenceCheck6821);
	child_pathOIDCKeyExistenceCheck6821?0;
	stop_process: skip;
	child!0
}
proctype pathOIDCKeyExistenceCheck682(Mutexdef i_groupLock;Mutexdef i_lock;Mutexdef i_oidcLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
