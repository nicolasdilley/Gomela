...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_aliases_test.go#L170
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_AliasSameAliasNames1700 = [1] of {int};
	run TestIdentityStore_AliasSameAliasNames170(child_TestIdentityStore_AliasSameAliasNames1700);
	run receiver(child_TestIdentityStore_AliasSameAliasNames1700)
stop_process:skip
}

proctype TestIdentityStore_AliasSameAliasNames170(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
