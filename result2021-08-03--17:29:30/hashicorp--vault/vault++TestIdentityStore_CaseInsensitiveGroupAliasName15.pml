...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_group_aliases_test.go#L15
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_CaseInsensitiveGroupAliasName150 = [1] of {int};
	run TestIdentityStore_CaseInsensitiveGroupAliasName15(child_TestIdentityStore_CaseInsensitiveGroupAliasName150);
	run receiver(child_TestIdentityStore_CaseInsensitiveGroupAliasName150)
stop_process:skip
}

proctype TestIdentityStore_CaseInsensitiveGroupAliasName15(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
