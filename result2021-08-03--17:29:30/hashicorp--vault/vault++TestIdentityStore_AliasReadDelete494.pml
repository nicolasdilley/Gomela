...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_aliases_test.go#L494
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_AliasReadDelete4940 = [1] of {int};
	run TestIdentityStore_AliasReadDelete494(child_TestIdentityStore_AliasReadDelete4940);
	run receiver(child_TestIdentityStore_AliasReadDelete4940)
stop_process:skip
}

proctype TestIdentityStore_AliasReadDelete494(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
