...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/logical_system_test.go#L2625
typedef Wgdef {
...
init { 
	chan child_TestSystemBackend_OpenAPI26250 = [1] of {int};
	run TestSystemBackend_OpenAPI2625(child_TestSystemBackend_OpenAPI26250);
	run receiver(child_TestSystemBackend_OpenAPI26250)
stop_process:skip
}

proctype TestSystemBackend_OpenAPI2625(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	Mutexdef __router_l;
	int var_pathSamples = -2; // opt var_pathSamples
