...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/token_store_test.go#L4890
typedef Wgdef {
...
init { 
	chan child_TestTokenStore_AllowedDisallowedPolicies48900 = [1] of {int};
	run TestTokenStore_AllowedDisallowedPolicies4890(child_TestTokenStore_AllowedDisallowedPolicies48900);
	run receiver(child_TestTokenStore_AllowedDisallowedPolicies48900)
stop_process:skip
}

proctype TestTokenStore_AllowedDisallowedPolicies4890(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
