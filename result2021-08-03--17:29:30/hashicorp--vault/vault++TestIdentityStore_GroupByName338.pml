...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_groups_test.go#L338
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_GroupByName3380 = [1] of {int};
	run TestIdentityStore_GroupByName338(child_TestIdentityStore_GroupByName3380);
	run receiver(child_TestIdentityStore_GroupByName3380)
stop_process:skip
}

proctype TestIdentityStore_GroupByName338(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
