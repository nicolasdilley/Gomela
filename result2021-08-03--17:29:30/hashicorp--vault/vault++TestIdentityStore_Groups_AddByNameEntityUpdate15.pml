...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_groups_test.go#L15
typedef Wgdef {
...
init { 
	chan child_TestIdentityStore_Groups_AddByNameEntityUpdate150 = [1] of {int};
	run TestIdentityStore_Groups_AddByNameEntityUpdate15(child_TestIdentityStore_Groups_AddByNameEntityUpdate150);
	run receiver(child_TestIdentityStore_Groups_AddByNameEntityUpdate150)
stop_process:skip
}

proctype TestIdentityStore_Groups_AddByNameEntityUpdate15(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
