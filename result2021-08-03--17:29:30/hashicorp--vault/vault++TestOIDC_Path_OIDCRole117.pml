...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/identity_store_oidc_test.go#L117
typedef Wgdef {
...
init { 
	chan child_TestOIDC_Path_OIDCRole1170 = [1] of {int};
	run TestOIDC_Path_OIDCRole117(child_TestOIDC_Path_OIDCRole1170);
	run receiver(child_TestOIDC_Path_OIDCRole1170)
stop_process:skip
}

proctype TestOIDC_Path_OIDCRole117(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
