...
// git_link=https://github.com/grafana/loki/blob/aa544a9dffdb8e78f7d7ed8edafce466d333b0a8/pkg/ingester/flush_test.go#L42
#define not_found_54  -2 // opt testData line 392
typedef Wgdef {
...
init { 
	chan child_TestChunkFlushingIdle420 = [1] of {int};
	run TestChunkFlushingIdle42(child_TestChunkFlushingIdle420);
	run receiver(child_TestChunkFlushingIdle420)
stop_process:skip
}

proctype TestChunkFlushingIdle42(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run checkData392(store_mtx,not_found_54,child_checkData3921);
