...
// git_link=https://github.com/grafana/loki/blob/aa544a9dffdb8e78f7d7ed8edafce466d333b0a8/pkg/ingester/flush_test.go#L131
#define not_found_141  -2 // opt testData line 392
typedef Wgdef {
...
init { 
	chan child_TestWALFullFlush1310 = [1] of {int};
	run TestWALFullFlush131(child_TestWALFullFlush1310);
	run receiver(child_TestWALFullFlush1310)
stop_process:skip
}

proctype TestWALFullFlush131(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run checkData392(store_mtx,not_found_141,child_checkData3921);
