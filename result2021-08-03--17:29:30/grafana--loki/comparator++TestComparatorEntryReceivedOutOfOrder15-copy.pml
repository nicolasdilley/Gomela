...
// git_link=https://github.com/grafana/loki/blob/aa544a9dffdb8e78f7d7ed8edafce466d333b0a8/pkg/canary/comparator/comparator_test.go#L15
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestComparatorEntryReceivedOutOfOrder150 = [1] of {int};
	run TestComparatorEntryReceivedOutOfOrder15(child_TestComparatorEntryReceivedOutOfOrder150);
	run receiver(child_TestComparatorEntryReceivedOutOfOrder150)
stop_process:skip
}

proctype TestComparatorEntryReceivedOutOfOrder15(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype entryReceived204(Mutexdef c_entMtx;Mutexdef c_metTestMtx;Mutexdef c_missingMtx;Mutexdef c_pruneMtx;Mutexdef c_spotEntMtx;Mutexdef c_spotMtx;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_ackdEntries = -2; // opt var_c_ackdEntries
	c_entMtx.Lock!false;
		defer1: skip;
	c_entMtx.Unlock!false;
	stop_process: skip;
