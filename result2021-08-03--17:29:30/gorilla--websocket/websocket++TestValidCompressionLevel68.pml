...
// git_link=https://github.com/gorilla/websocket/blob/e8629af678b7fe13f35dff5e197de93b4148a909/compression_test.go#L68
#define not_found_7024  -2
#define not_found_7524  -2
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestValidCompressionLevel680)
stop_process:skip
}
