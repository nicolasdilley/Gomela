...
// git_link=https://github.com/dgraph-io/dgraph/blob/6b188f254202f9c38b16c4769b672dd0e9d596ac/ee/vault_ee.go#L28
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype vaultGetKeys28(chan child) {
	...
	run vaultGetKvStore75(client_config_modifyLock,client_modifyLock,child_vaultGetKvStore750);
	child_vaultGetKvStore750?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype vaultGetKvStore75(Mutexdef client_config_modifyLock;Mutexdef client_modifyLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
