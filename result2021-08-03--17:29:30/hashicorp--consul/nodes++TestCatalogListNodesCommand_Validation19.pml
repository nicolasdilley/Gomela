...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/command/catalog/list/nodes/catalog_list_nodes_test.go#L19
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestCatalogListNodesCommand_Validation190)
stop_process:skip
}
