...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/agent/router/manager_test.go#L260
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestServers_NumServers2600 = [1] of {int};
	run TestServers_NumServers260(child_TestServers_NumServers2600);
	run receiver(child_TestServers_NumServers2600)
stop_process:skip
}

proctype TestServers_NumServers260(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
