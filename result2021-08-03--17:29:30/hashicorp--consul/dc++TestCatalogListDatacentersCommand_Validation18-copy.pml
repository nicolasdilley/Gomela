...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/command/catalog/list/dc/catalog_list_datacenters_test.go#L18
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestCatalogListDatacentersCommand_Validation180)
stop_process:skip
}
