...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/agent/rpc/subscribe/subscribe_test.go#L585
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestServer_Subscribe_IntegrationWithBackend_FilterEventsByACLToken585(chan child) {
	...
	run NewServer27(backend_forwardConn_mu,child_NewServer270);
	...
	run NewStateChangeSubscriptionClient618(conn_balancerWrapper_balancerMu,conn_balancerWrapper_mu,conn_blockingpicker_connErrMu,conn_blockingpicker_mu,conn_csMgr_mu,conn_mu,conn_resolverWrapper_pollingMu,conn_resolverWrapper_resolverMu,child_NewStateChangeSubscriptionClient6181);
...
proctype NewServer27(Mutexdef backend_forwardConn_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype NewStateChangeSubscriptionClient618(Mutexdef cc_balancerWrapper_balancerMu;Mutexdef cc_balancerWrapper_mu;Mutexdef cc_blockingpicker_connErrMu;Mutexdef cc_blockingpicker_mu;Mutexdef cc_csMgr_mu;Mutexdef cc_mu;Mutexdef cc_resolverWrapper_pollingMu;Mutexdef cc_resolverWrapper_resolverMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
