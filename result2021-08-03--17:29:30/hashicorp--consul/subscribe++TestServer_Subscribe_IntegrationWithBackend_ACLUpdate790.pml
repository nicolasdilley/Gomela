...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/agent/rpc/subscribe/subscribe_test.go#L790
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run receiver(child_TestServer_Subscribe_IntegrationWithBackend_ACLUpdate7900)
stop_process:skip
}
