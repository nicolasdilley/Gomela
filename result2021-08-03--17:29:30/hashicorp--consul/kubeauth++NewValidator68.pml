...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/agent/consul/authmethod/kubeauth/k8s.go#L68
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_NewValidator680 = [1] of {int};
	run NewValidator68(child_NewValidator680);
	run receiver(child_NewValidator680)
stop_process:skip
}

proctype NewValidator68(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
