...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/master/synthetic_master_test.go#L525
typedef Wgdef {
...
init { 
	chan child_TestAccept5250 = [1] of {int};
	run TestAccept525(child_TestAccept5250);
	run receiver(child_TestAccept5250)
stop_process:skip
}

proctype TestAccept525(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
