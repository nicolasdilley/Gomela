...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/volumemanager/reconciler/reconciler_test.go#L357
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_Test_Run_Positive_VolumeUnmountControllerAttachEnabled3570)
stop_process:skip
}
