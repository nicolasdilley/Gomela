...
proctype findAndRemoveDeletedPods216(Mutexdef dswp_hasAddedPodsLock;Mutexdef dswp_volumePluginMgr_mutex;chan child) {
	...
	int var_podsWithError = -2; // opt var_podsWithError
	int var_runningPods = -2; // opt var_runningPods
	int var_dswp_desiredStateOfWorld_GetVolumesToMount = -2; // opt var_dswp_desiredStateOfWorld_GetVolumesToMount
	

	if
	:: var_dswp_desiredStateOfWorld_GetVolumesToMount-1 != -3 -> 
				for(i : 0.. var_dswp_desiredStateOfWorld_GetVolumesToMount-1) {
			for30: skip;
