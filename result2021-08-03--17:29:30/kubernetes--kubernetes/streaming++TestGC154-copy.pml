...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/cri/streaming/request_cache_test.go#L154
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestGC154(chan child) {
	...
	Mutexdef c_lock;
	int var_maxInFlight = -2; // opt var_maxInFlight
	...
	if
	:: 0 != -2 && var_maxInFlight-1 != -3 -> 
				for(i : 0.. var_maxInFlight-1) {
			for31: skip;
