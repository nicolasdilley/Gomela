...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/images/image_gc_manager_test.go#L258
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFreeSpaceImagesInUseContainersAreIgnored2580 = [1] of {int};
	run TestFreeSpaceImagesInUseContainersAreIgnored258(child_TestFreeSpaceImagesInUseContainersAreIgnored2580);
	run receiver(child_TestFreeSpaceImagesInUseContainersAreIgnored2580)
stop_process:skip
}

proctype TestFreeSpaceImagesInUseContainersAreIgnored258(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run freeSpace332(manager_imageRecordsLock,child_freeSpace3320);
