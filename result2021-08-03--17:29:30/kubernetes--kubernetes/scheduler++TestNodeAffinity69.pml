...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/scheduler/priorities_test.go#L69
typedef Wgdef {
...
init { 
	chan child_TestNodeAffinity690 = [1] of {int};
	run TestNodeAffinity69(child_TestNodeAffinity690);
	run receiver(child_TestNodeAffinity690)
stop_process:skip
}

proctype TestNodeAffinity69(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
