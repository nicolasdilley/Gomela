...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/accessreview_test.go#L57
typedef Wgdef {
...
init { 
	chan child_TestSubjectAccessReview570 = [1] of {int};
	run TestSubjectAccessReview57(child_TestSubjectAccessReview570);
	run receiver(child_TestSubjectAccessReview570)
stop_process:skip
}

proctype TestSubjectAccessReview57(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
