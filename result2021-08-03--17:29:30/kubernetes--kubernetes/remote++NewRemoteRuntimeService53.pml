...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/cri/remote/remote_runtime.go#L53
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_NewRemoteRuntimeService530 = [1] of {int};
	run NewRemoteRuntimeService53(child_NewRemoteRuntimeService530);
	run receiver(child_NewRemoteRuntimeService530)
stop_process:skip
}

proctype NewRemoteRuntimeService53(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
