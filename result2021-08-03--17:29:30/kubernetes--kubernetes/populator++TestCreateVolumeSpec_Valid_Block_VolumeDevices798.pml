...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/volumemanager/populator/desired_state_of_world_populator_test.go#L798
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestCreateVolumeSpec_Valid_Block_VolumeDevices7980 = [1] of {int};
	run TestCreateVolumeSpec_Valid_Block_VolumeDevices798(child_TestCreateVolumeSpec_Valid_Block_VolumeDevices7980);
	run receiver(child_TestCreateVolumeSpec_Valid_Block_VolumeDevices7980)
stop_process:skip
}

proctype TestCreateVolumeSpec_Valid_Block_VolumeDevices798(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
