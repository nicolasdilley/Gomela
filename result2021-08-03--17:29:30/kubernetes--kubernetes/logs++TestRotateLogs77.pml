...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/logs/container_log_manager_test.go#L77
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestRotateLogs770)
stop_process:skip
}
...
proctype rotateLog265(Mutexdef c_mutex;chan child) {
	...
	run removeExcessLogs345(c_mutex,var_logs,child_removeExcessLogs3451);
...
proctype removeExcessLogs345(Mutexdef c_mutex;int var_logs;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	int var_maxRotatedFiles = -2; // opt var_maxRotatedFiles
	goto stop_process;
	stop_process: skip;
	child!0
}
