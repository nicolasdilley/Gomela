...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/pods/pods_test.go#L157
typedef Wgdef {
...
init { 
	chan child_TestPodReadOnlyFilesystem1570 = [1] of {int};
	run TestPodReadOnlyFilesystem157(child_TestPodReadOnlyFilesystem1570);
	run receiver(child_TestPodReadOnlyFilesystem1570)
stop_process:skip
}

proctype TestPodReadOnlyFilesystem157(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
