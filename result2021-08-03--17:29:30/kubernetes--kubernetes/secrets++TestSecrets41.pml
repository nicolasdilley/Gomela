...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/secrets/secrets_test.go#L41
typedef Wgdef {
...
init { 
	chan child_TestSecrets410 = [1] of {int};
	run TestSecrets41(child_TestSecrets410);
	run receiver(child_TestSecrets410)
stop_process:skip
}

proctype TestSecrets41(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
