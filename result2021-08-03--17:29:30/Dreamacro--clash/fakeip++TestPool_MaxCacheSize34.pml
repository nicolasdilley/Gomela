...
// git_link=https://github.com/Dreamacro/clash/blob/baf03b81e36e3c5d8b9a370ebb82dd2b25b4a58d/component/fakeip/pool_test.go#L34
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPool_MaxCacheSize340 = [1] of {int};
	run TestPool_MaxCacheSize34(child_TestPool_MaxCacheSize340);
	run receiver(child_TestPool_MaxCacheSize340)
stop_process:skip
}

proctype TestPool_MaxCacheSize34(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
