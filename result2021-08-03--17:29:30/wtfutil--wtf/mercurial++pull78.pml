...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/mercurial/hg_repo.go#L78
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_pull780 = [1] of {int};
	run pull78(child_pull780);
	run receiver(child_pull780)
stop_process:skip
}

proctype pull78(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
