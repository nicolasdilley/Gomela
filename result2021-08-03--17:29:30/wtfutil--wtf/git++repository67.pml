...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/git/git_repo.go#L67
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_repository670 = [1] of {int};
	run repository67(child_repository670);
	run receiver(child_repository670)
stop_process:skip
}

proctype repository67(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
