...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/git/git_repo.go#L74
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_pull740 = [1] of {int};
	run pull74(child_pull740);
	run receiver(child_pull740)
stop_process:skip
}

proctype pull74(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
