...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/security/wifi.go#L63
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_wifiInfo630 = [1] of {int};
	run wifiInfo63(child_wifiInfo630);
	run receiver(child_wifiInfo630)
stop_process:skip
}

proctype wifiInfo63(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
