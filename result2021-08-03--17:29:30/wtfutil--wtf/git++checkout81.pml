...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/git/git_repo.go#L81
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_checkout810 = [1] of {int};
	run checkout81(child_checkout810);
	run receiver(child_checkout810)
stop_process:skip
}

proctype checkout81(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
