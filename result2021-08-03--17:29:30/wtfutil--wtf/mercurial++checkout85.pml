...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/mercurial/hg_repo.go#L85
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_checkout850 = [1] of {int};
	run checkout85(child_checkout850);
	run receiver(child_checkout850)
stop_process:skip
}

proctype checkout85(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
