...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/security/dns.go#L28
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_dnsLinux280 = [1] of {int};
	run dnsLinux28(child_dnsLinux280);
	run receiver(child_dnsLinux280)
stop_process:skip
}

proctype dnsLinux28(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
