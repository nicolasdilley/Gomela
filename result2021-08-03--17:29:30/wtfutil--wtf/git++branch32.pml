...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/git/git_repo.go#L32
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_branch320 = [1] of {int};
	run branch32(child_branch320);
	run receiver(child_branch320)
stop_process:skip
}

proctype branch32(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
