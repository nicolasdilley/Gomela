...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/console/console_test.go#L242
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestExecute2420 = [1] of {int};
	run TestExecute242(child_TestExecute2420);
	run receiver(child_TestExecute2420)
stop_process:skip
}

proctype TestExecute242(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
