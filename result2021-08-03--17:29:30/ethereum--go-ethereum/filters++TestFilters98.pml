...
proctype NewRangeFilter66(Mutexdef backend_chainFeed_mu;Mutexdef backend_logsFeed_mu;Mutexdef backend_mux_mutex;Mutexdef backend_pendingLogsFeed_mu;Mutexdef backend_rmLogsFeed_mu;Mutexdef backend_txFeed_mu;int var_addresses;int var_topics;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run newFilter108(backend_chainFeed_mu,backend_logsFeed_mu,backend_mux_mutex,backend_pendingLogsFeed_mu,backend_rmLogsFeed_mu,backend_txFeed_mu,child_newFilter1080);
