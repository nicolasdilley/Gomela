...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/eth/downloader/testchain_test.go#L47
typedef Wgdef {
...
proctype init47(chan child) {
	...
	run receiver(child_Anonymousinit51490);
	run Anonymousinit5249(wg,child_Anonymousinit52491);
	run receiver(child_Anonymousinit52491);
	run Anonymousinit5349(wg,child_Anonymousinit53492);
	run receiver(child_Anonymousinit53492);
	wg.wait?0;
	stop_process: skip;
	child!0
}
