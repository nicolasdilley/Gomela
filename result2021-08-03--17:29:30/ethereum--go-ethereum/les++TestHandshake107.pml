...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/les/peer_test.go#L107
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestHandshake107(chan child) {
	...
	run AnonymousTestHandshake133119(errCh1_ch,errCh2_ch,peer1_responseLock,peer1_invalidLock,peer1_fcClient_lock,peer2_fcServer_lock,peer2_vtLock,peer2_nodeValueTracker_lock,child_AnonymousTestHandshake1331190);
	run receiver(child_AnonymousTestHandshake1331190);
	run AnonymousTestHandshake139119(errCh1_ch,errCh2_ch,peer1_responseLock,peer1_invalidLock,peer1_fcClient_lock,peer2_fcServer_lock,peer2_vtLock,peer2_nodeValueTracker_lock,child_AnonymousTestHandshake1391191);
...
proctype AnonymousTestHandshake133119(Chandef errCh1_ch;Chandef errCh2_ch;Mutexdef peer1_responseLock;Mutexdef peer1_invalidLock;Mutexdef peer1_fcClient_lock;Mutexdef peer2_fcServer_lock;Mutexdef peer2_vtLock;Mutexdef peer2_nodeValueTracker_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestHandshake139119(Chandef errCh1_ch;Chandef errCh2_ch;Mutexdef peer1_responseLock;Mutexdef peer1_invalidLock;Mutexdef peer1_fcClient_lock;Mutexdef peer2_fcServer_lock;Mutexdef peer2_vtLock;Mutexdef peer2_nodeValueTracker_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
