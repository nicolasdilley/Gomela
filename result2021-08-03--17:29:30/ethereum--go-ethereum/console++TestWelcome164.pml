...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/console/console_test.go#L164
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestWelcome1640 = [1] of {int};
	run TestWelcome164(child_TestWelcome1640);
	run receiver(child_TestWelcome1640)
stop_process:skip
}

proctype TestWelcome164(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
