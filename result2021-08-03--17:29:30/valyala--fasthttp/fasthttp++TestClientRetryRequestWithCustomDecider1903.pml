...
// git_link=https://github.com/valyala/fasthttp/blob/19fcd408632d6dae8425ae95c6c62a25c823ff81/client_test.go#L1903
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestClientRetryRequestWithCustomDecider19030)
stop_process:skip
}
...
proctype TestClientRetryRequestWithCustomDecider1903(chan child) {
	...
	run Post348(c_mLock,c_TLSConfig_mutex,child_Post3480);
	child_Post3480?0;
...
proctype Post348(Mutexdef c_mLock;Mutexdef c_TLSConfig_mutex;chan child) {
	...
	run clientPostURL936(c_mLock,c_TLSConfig_mutex,child_clientPostURL9360);
