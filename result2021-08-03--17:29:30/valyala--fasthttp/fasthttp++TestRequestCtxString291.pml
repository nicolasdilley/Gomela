...
proctype TestRequestCtxString291(chan child) {
	...
	run String788(ctx_s_mu,child_String7880);
	child_String7880?0;
	run String788(ctx_s_mu,child_String7881);
	child_String7881?0;
	stop_process: skip;
	child!0
}
proctype String788(Mutexdef ctx_s_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run ID793(ctx_s_mu,child_ID7930);
	child_ID7930?0;
	run LocalAddr1107(ctx_s_mu,child_LocalAddr11071);
	child_LocalAddr11071?0;
	run RemoteAddr1093(ctx_s_mu,child_RemoteAddr10932);
	child_RemoteAddr10932?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype ID793(Mutexdef ctx_s_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype LocalAddr1107(Mutexdef ctx_s_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype RemoteAddr1093(Mutexdef ctx_s_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
