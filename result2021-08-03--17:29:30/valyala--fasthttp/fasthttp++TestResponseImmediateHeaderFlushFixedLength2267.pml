...
// git_link=https://github.com/valyala/fasthttp/blob/19fcd408632d6dae8425ae95c6c62a25c823ff81/http_test.go#L2267
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestResponseImmediateHeaderFlushFixedLength2267(chan child) {
	...
	run AnonymousTestResponseImmediateHeaderFlushFixedLength22892274(ch_ch,cb_ch,waitForIt_ch,child_AnonymousTestResponseImmediateHeaderFlushFixedLength228922740);
	run receiver(child_AnonymousTestResponseImmediateHeaderFlushFixedLength228922740);
...
proctype AnonymousTestResponseImmediateHeaderFlushFixedLength22892274(Chandef ch_ch;Chandef cb_ch;Chandef waitForIt_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
