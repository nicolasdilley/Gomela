...
proctype TestRequestCtxWriteString1903(chan child) {
	...
	run WriteString1308(ctx_s_mu,child_WriteString13080);
	child_WriteString13080?0;
	run WriteString1308(ctx_s_mu,child_WriteString13081);
	child_WriteString13081?0;
	stop_process: skip;
	child!0
}
proctype WriteString1308(Mutexdef ctx_s_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
