...
// git_link=https://github.com/valyala/fasthttp/blob/19fcd408632d6dae8425ae95c6c62a25c823ff81/client_test.go#L1847
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestClientIdempotentRequest18470)
stop_process:skip
}
...
proctype TestClientIdempotentRequest1847(chan child) {
	...
	run Get310(c_mLock,c_TLSConfig_mutex,child_Get3100);
	child_Get3100?0;
	run Post348(c_mLock,c_TLSConfig_mutex,child_Post3481);
	child_Post3481?0;
	run Post348(c_mLock,c_TLSConfig_mutex,child_Post3482);
	child_Post3482?0;
	stop_process: skip;
	child!0
}
proctype Get310(Mutexdef c_mLock;Mutexdef c_TLSConfig_mutex;chan child) {
	...
	run clientGetURL841(c_mLock,c_TLSConfig_mutex,child_clientGetURL8410);
...
proctype clientGetURL841(Mutexdef c_mLock;Mutexdef c_TLSConfig_mutex;chan child) {
	...
	run doRequestFollowRedirectsBuffer966(c_mLock,c_TLSConfig_mutex,child_doRequestFollowRedirectsBuffer9660);
...
proctype doRequestFollowRedirectsBuffer966(Mutexdef c_mLock;Mutexdef c_TLSConfig_mutex;chan child) {
	...
	run doRequestFollowRedirects983(c_mLock,c_TLSConfig_mutex,child_doRequestFollowRedirects9830);
...
proctype Post348(Mutexdef c_mLock;Mutexdef c_TLSConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_clientPostURL9361 = [1] of {int};
	run clientPostURL936(c_mLock,c_TLSConfig_mutex,child_clientPostURL9361);
	child_clientPostURL9361?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype clientPostURL936(Mutexdef c_mLock;Mutexdef c_TLSConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
