...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/security/pkg/nodeagent/plugin/providers/google/stsclient/stsclient_test.go#L30
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestGetFederatedToken300)
stop_process:skip
}
