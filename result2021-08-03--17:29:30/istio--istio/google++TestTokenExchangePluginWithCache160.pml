...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/security/pkg/stsservice/tokenmanager/google/tokenexchangeplugin_test.go#L160
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestTokenExchangePluginWithCache1600)
stop_process:skip
}
...
proctype TestTokenExchangePluginWithCache160(chan child) {
	...
	run ExchangeToken112(tmPlugin_mutex,tmPlugin_tokens_mu,child_ExchangeToken1121);
	child_ExchangeToken1121?0;
	run ClearCache532(tmPlugin_mutex,tmPlugin_tokens_mu,child_ClearCache5322);
	child_ClearCache5322?0;
	run ExchangeToken112(tmPlugin_mutex,tmPlugin_tokens_mu,child_ExchangeToken1123);
	child_ExchangeToken1123?0;
	run ExchangeToken112(tmPlugin_mutex,tmPlugin_tokens_mu,child_ExchangeToken1124);
...
proctype ClearCache532(Mutexdef p_mutex;Mutexdef p_tokens_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
