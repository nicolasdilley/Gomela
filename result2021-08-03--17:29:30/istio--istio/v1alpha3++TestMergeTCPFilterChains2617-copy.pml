...
#define not_found_2722  -2 // opt incoming line 1577
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype mergeTCPFilterChains1577(Mutexdef listenerOpts_push_initializeMutex;Mutexdef listenerOpts_push_networksMu;Mutexdef listenerOpts_push_proxyStatusMutex;Mutexdef listenerOpts_service_Mutex;int var_incoming;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	int var_mergedFilterChains = -2; // opt var_mergedFilterChains
	goto stop_process;
	stop_process: skip;
	child!0
}
