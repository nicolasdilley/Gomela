...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/cni/pkg/install-cni/pkg/install/server.go#L25
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_StartServer250)
stop_process:skip
}
...
proctype StartServer25(chan child) {
	...
	run receiver(child_AnonymousStartServer29261);
	goto stop_process;
	stop_process: skip;
	child!0
}
