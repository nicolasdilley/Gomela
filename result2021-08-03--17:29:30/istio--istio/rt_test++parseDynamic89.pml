...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/galley/pkg/config/source/kube/rt/dynamic_test.go#L89
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_parseDynamic890 = [1] of {int};
	run parseDynamic89(child_parseDynamic890);
	run receiver(child_parseDynamic890)
stop_process:skip
}

proctype parseDynamic89(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
