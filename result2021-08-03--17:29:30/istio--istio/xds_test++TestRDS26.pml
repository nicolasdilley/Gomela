...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/pilot/pkg/xds/rds_test.go#L26
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRDS260 = [1] of {int};
	run TestRDS26(child_TestRDS260);
	run receiver(child_TestRDS260)
stop_process:skip
}

proctype TestRDS26(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
