...
// git_link=https://github.com/rancher/rancher/blob/91a6f51f259acd5670ff167d6bcf1916da7406f1/pkg/agent/clean/binding.go#L90
typedef Wgdef {
...
proctype clean90(chan child) {
	...
	run receiver(child_Anonymousclean1211180);
	run Anonymousclean128118(waitGroup,child_Anonymousclean1281181);
	run receiver(child_Anonymousclean1281181);
	waitGroup.wait?0;
	goto stop_process;
	stop_process: skip;
	child!0
