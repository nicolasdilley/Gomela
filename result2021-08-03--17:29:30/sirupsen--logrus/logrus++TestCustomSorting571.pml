...
// git_link=https://github.com/sirupsen/logrus/blob/b50299cfaaa1bca85be76c8984070e846c7abfd2/text_formatter_test.go#L571
...
init { 
	chan child_TestCustomSorting5710 = [1] of {int};
	run TestCustomSorting571(child_TestCustomSorting5710);
	run receiver(child_TestCustomSorting5710)
stop_process:skip
}

proctype TestCustomSorting571(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
