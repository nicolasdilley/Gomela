...
// git_link=https://github.com/sirupsen/logrus/blob/b50299cfaaa1bca85be76c8984070e846c7abfd2/text_formatter_test.go#L299
...
init { 
	chan child_TestNewlineBehavior2990 = [1] of {int};
	run TestNewlineBehavior299(child_TestNewlineBehavior2990);
	run receiver(child_TestNewlineBehavior2990)
stop_process:skip
}

proctype TestNewlineBehavior299(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
