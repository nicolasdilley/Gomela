...
// git_link=https://github.com/kataras/iris/blob/fa175eb84754a45baecc4cd0044249fad05dfe1e/httptest/httptest.go#L150
#define def_var_setters  -2 // opt setters line 150
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run NewInsecure150(def_var_setters,child_NewInsecure1500);
	run receiver(child_NewInsecure1500)
stop_process:skip
}

proctype NewInsecure150(int var_setters;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
