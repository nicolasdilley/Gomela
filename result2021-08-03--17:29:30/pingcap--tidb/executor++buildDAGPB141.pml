...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/admin.go#L141
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_buildDAGPB1410 = [1] of {int};
	run buildDAGPB141(child_buildDAGPB1410);
	run receiver(child_buildDAGPB1410)
stop_process:skip
}

proctype buildDAGPB141(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	Mutexdef sc_mu;
	int var_e_schema_Columns = -2; // opt var_e_schema_Columns
