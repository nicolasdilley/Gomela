...
proctype splitBucket526(chan child) {
	...
	Mutexdef sc_mu;
	int var_bounds = -2; // opt var_bounds
...
proctype refineBucketCount617(Mutexdef sc_mu;Mutexdef sc_RuntimeStatsColl_mu;chan child) {
	...
	int var_b_feedback = -2; // opt var_b_feedback
...
proctype mergeFullyContainedFeedback581(Mutexdef sc_mu;Mutexdef sc_RuntimeStatsColl_mu;chan child) {
	...
	int var_sortedFBs = -2; // opt var_sortedFBs
	int var_b_feedback = -2; // opt var_b_feedback
...
proctype NonOverlappedFeedbacks328(Mutexdef sc_mu;Mutexdef sc_RuntimeStatsColl_mu;int var_fbs;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
