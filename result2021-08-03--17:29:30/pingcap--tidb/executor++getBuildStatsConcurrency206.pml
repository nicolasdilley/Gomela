...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/analyze.go#L206
typedef Wgdef {
...
init { 
	chan child_getBuildStatsConcurrency2060 = [1] of {int};
	run getBuildStatsConcurrency206(child_getBuildStatsConcurrency2060);
	run receiver(child_getBuildStatsConcurrency2060)
stop_process:skip
}

proctype getBuildStatsConcurrency206(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
