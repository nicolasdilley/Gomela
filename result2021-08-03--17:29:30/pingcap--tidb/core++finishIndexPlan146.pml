...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/planner/core/task.go#L146
typedef Wgdef {
...
init { 
	chan child_finishIndexPlan1460 = [1] of {int};
	run finishIndexPlan146(child_finishIndexPlan1460);
	run receiver(child_finishIndexPlan1460)
stop_process:skip
}

proctype finishIndexPlan146(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
