...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/planner/core/task.go#L263
typedef Wgdef {
...
init { 
	chan child_GetCost2630 = [1] of {int};
	run GetCost263(child_GetCost2630);
	run receiver(child_GetCost2630)
stop_process:skip
}

proctype GetCost263(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
