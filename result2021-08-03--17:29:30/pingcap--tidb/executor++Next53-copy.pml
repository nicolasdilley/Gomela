...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/set.go#L53
typedef Wgdef {
...
proctype Next53(chan child) {
	...
	int var_syns = -2; // opt var_syns
	int var_e_vars = -2; // opt var_e_vars
