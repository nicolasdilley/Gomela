...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/store/mockstore/unistore/cophandler/cop_handler_test.go#L445
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_newTestStore4450)
stop_process:skip
}
