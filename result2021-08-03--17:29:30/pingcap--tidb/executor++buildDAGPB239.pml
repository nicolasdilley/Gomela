...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/admin.go#L239
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_buildDAGPB2390 = [1] of {int};
	run buildDAGPB239(child_buildDAGPB2390);
	run receiver(child_buildDAGPB2390)
stop_process:skip
}

proctype buildDAGPB239(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
