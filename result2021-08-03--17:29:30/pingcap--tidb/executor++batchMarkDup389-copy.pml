...
#define def_var_rows  -2 // opt rows line 389
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run batchMarkDup389(def_var_rows,child_batchMarkDup3890);
	run receiver(child_batchMarkDup3890)
stop_process:skip
}

proctype batchMarkDup389(int var_rows;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	Mutexdef sc_mu;
	int var_e_batchKeys = -2; // opt var_e_batchKeys
