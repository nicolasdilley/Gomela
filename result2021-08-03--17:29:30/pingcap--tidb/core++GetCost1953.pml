...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/planner/core/task.go#L1953
typedef Wgdef {
...
init { 
	chan child_GetCost19530 = [1] of {int};
	run GetCost1953(child_GetCost19530);
	run receiver(child_GetCost19530)
stop_process:skip
}

proctype GetCost1953(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
