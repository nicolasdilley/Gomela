...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/table/column.go#L242
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_CastValue2420 = [1] of {int};
	run CastValue242(child_CastValue2420);
	run receiver(child_CastValue2420)
stop_process:skip
}

proctype CastValue242(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
