...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/admin.go#L774
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_buildIdxDAGPB7740 = [1] of {int};
	run buildIdxDAGPB774(child_buildIdxDAGPB7740);
	run receiver(child_buildIdxDAGPB7740)
stop_process:skip
}

proctype buildIdxDAGPB774(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	Mutexdef sc_mu;
	int var_e_columns = -2; // opt var_e_columns
