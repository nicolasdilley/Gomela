...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/table/column.go#L161
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_handleZeroDatetime1610 = [1] of {int};
	run handleZeroDatetime161(child_handleZeroDatetime1610);
	run receiver(child_handleZeroDatetime1610)
stop_process:skip
}

proctype handleZeroDatetime161(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
