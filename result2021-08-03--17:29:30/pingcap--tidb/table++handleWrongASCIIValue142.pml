...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/table/column.go#L142
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_handleWrongASCIIValue1420 = [1] of {int};
	run handleWrongASCIIValue142(child_handleWrongASCIIValue1420);
	run receiver(child_handleWrongASCIIValue1420)
stop_process:skip
}

proctype handleWrongASCIIValue142(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
