...
#define not_found_291  -2 // opt str line 366
#define not_found_372  -2 // opt validFloat line 435
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype getValidIntPrefix366(Mutexdef sc_mu;Mutexdef sc_RuntimeStatsColl_mu;int var_str;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	if
	:: true -> 
		run getValidFloatPrefix665(sc_mu,sc_RuntimeStatsColl_mu,var_str,child_getValidFloatPrefix6650);
	...
	if
	:: true -> 
		run HandleTruncate471(sc_mu,sc_RuntimeStatsColl_mu,child_HandleTruncate4712);
...
proctype getValidFloatPrefix665(Mutexdef sc_mu;Mutexdef sc_RuntimeStatsColl_mu;int var_s;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype floatStrToIntStr435(Mutexdef sc_mu;Mutexdef sc_RuntimeStatsColl_mu;int var_validFloat;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
