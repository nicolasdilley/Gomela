...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/domain/infosync/info.go#L246
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_UpdateTiFlashTableSyncProgress2460)
stop_process:skip
}
