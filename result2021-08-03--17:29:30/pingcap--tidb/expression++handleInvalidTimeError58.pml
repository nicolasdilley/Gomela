...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/expression/errors.go#L58
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_handleInvalidTimeError580 = [1] of {int};
	run handleInvalidTimeError58(child_handleInvalidTimeError580);
	run receiver(child_handleInvalidTimeError580)
stop_process:skip
}

proctype handleInvalidTimeError58(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
