...
proctype getPhysicalPlan299(chan child) {
		...
		:: true -> 
			...
			:: var_cachedVals-1 != -3 -> 
					...
					:: true -> 
						...
						run SetPlanDigest235(stmtCtx_mu,stmtCtx_RuntimeStatsColl_mu,child_SetPlanDigest2350);
			...
			:: else -> 
				...
				:: true -> 
					...
					:: true -> 
						...
						run SetPlanDigest235(stmtCtx_mu,stmtCtx_RuntimeStatsColl_mu,child_SetPlanDigest2351);
	...
	if
	:: true -> 
		run SetPlanDigest235(stmtCtx_mu,stmtCtx_RuntimeStatsColl_mu,child_SetPlanDigest2352);
...
proctype SetPlanDigest235(Mutexdef sc_mu;Mutexdef sc_RuntimeStatsColl_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
