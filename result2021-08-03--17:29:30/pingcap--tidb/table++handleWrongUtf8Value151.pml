...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/table/column.go#L151
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_handleWrongUtf8Value1510 = [1] of {int};
	run handleWrongUtf8Value151(child_handleWrongUtf8Value1510);
	run receiver(child_handleWrongUtf8Value1510)
stop_process:skip
}

proctype handleWrongUtf8Value151(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
