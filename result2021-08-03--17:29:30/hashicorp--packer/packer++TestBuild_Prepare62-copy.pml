...
// git_link=https://github.com/hashicorp/packer/blob/a9c2283ee589b203c0ce16174a5747b7d2053d61/packer/build_test.go#L62
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBuild_Prepare620 = [1] of {int};
	run TestBuild_Prepare62(child_TestBuild_Prepare620);
	run receiver(child_TestBuild_Prepare620)
stop_process:skip
}

proctype TestBuild_Prepare62(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
