...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/plugin6/grpc_provider_test.go#L93
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_GetSchema930 = [1] of {int};
	run TestGRPCProvider_GetSchema93(child_TestGRPCProvider_GetSchema930);
	run receiver(child_TestGRPCProvider_GetSchema930)
stop_process:skip
}

proctype TestGRPCProvider_GetSchema93(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
