...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/command/command_test.go#L956
typedef Wgdef {
...
init { 
	...
	run receiver(child_testServices9560)
stop_process:skip
}
