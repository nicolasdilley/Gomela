...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/builtin/provisioners/local-exec/resource_provisioner_test.go#L168
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestResourceProvider_ApplyCustomEnv1680)
stop_process:skip
}
