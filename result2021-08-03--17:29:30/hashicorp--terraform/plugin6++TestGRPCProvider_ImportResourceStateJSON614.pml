...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/plugin6/grpc_provider_test.go#L614
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ImportResourceStateJSON6140 = [1] of {int};
	run TestGRPCProvider_ImportResourceStateJSON614(child_TestGRPCProvider_ImportResourceStateJSON6140);
	run receiver(child_TestGRPCProvider_ImportResourceStateJSON6140)
stop_process:skip
}

proctype TestGRPCProvider_ImportResourceStateJSON614(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype ImportResourceState500(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_mu;Mutexdef p_PluginClient_l;Mutexdef p_TestServer_mu;chan child) {
	...
	int var_protoResp_ImportedResources = -2; // opt var_protoResp_ImportedResources
