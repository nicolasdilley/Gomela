...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/terraform/evaluate_test.go#L19
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEvaluatorGetTerraformAttr190 = [1] of {int};
	run TestEvaluatorGetTerraformAttr19(child_TestEvaluatorGetTerraformAttr190);
	run receiver(child_TestEvaluatorGetTerraformAttr190)
stop_process:skip
}

proctype TestEvaluatorGetTerraformAttr19(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
