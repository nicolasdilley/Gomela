...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/plugin/grpc_provider_test.go#L607
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ImportResourceStateJSON6070 = [1] of {int};
	run TestGRPCProvider_ImportResourceStateJSON607(child_TestGRPCProvider_ImportResourceStateJSON6070);
	run receiver(child_TestGRPCProvider_ImportResourceStateJSON6070)
stop_process:skip
}

proctype TestGRPCProvider_ImportResourceStateJSON607(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
