...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/plugin6/grpc_provider_test.go#L118
typedef Wgdef {
...
proctype TestGRPCProvider_ValidateResourceConfig118(chan child) {
	...
	run ValidateResourceConfig202(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_mu,p_PluginClient_l,p_TestServer_mu,child_ValidateResourceConfig2020);
	child_ValidateResourceConfig2020?0;
	stop_process: skip;
	child!0
}
proctype ValidateResourceConfig202(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_mu;Mutexdef p_PluginClient_l;Mutexdef p_TestServer_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
