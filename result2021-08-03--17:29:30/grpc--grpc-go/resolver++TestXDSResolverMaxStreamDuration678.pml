...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/resolver/xds_resolver_test.go#L678
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestXDSResolverMaxStreamDuration6780 = [1] of {int};
	run TestXDSResolverMaxStreamDuration678(child_TestXDSResolverMaxStreamDuration6780);
	run receiver(child_TestXDSResolverMaxStreamDuration6780)
stop_process:skip
}

proctype TestXDSResolverMaxStreamDuration678(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
