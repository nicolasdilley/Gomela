...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/credentials/tls/certprovider/distributor_test.go#L34
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestDistributorEmpty34(chan child) {
	...
	run readAndVerifyKeyMaterial148(dist_mu,child_readAndVerifyKeyMaterial1480);
