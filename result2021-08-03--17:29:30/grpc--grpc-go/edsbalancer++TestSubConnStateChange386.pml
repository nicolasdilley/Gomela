...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/balancer/edsbalancer/eds_test.go#L386
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestSubConnStateChange3860 = [1] of {int};
	run TestSubConnStateChange386(child_TestSubConnStateChange3860);
	run receiver(child_TestSubConnStateChange3860)
stop_process:skip
}

proctype TestSubConnStateChange386(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
