...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/resolver/xds_resolver_test.go#L616
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestXDSResolverWRR6160 = [1] of {int};
	run TestXDSResolverWRR616(child_TestXDSResolverWRR6160);
	run receiver(child_TestXDSResolverWRR6160)
stop_process:skip
}

proctype TestXDSResolverWRR616(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
