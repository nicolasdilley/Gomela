...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/resolver/xds_resolver_test.go#L312
#define not_found_32921  -2
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestXDSResolverGoodServiceUpdate3120 = [1] of {int};
	run TestXDSResolverGoodServiceUpdate312(child_TestXDSResolverGoodServiceUpdate3120);
	run receiver(child_TestXDSResolverGoodServiceUpdate3120)
stop_process:skip
}

proctype TestXDSResolverGoodServiceUpdate312(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
