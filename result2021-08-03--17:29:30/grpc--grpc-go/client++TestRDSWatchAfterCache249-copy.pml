...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_route_test.go#L249
#define not_found_283  -2 // opt updates line 136
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRDSWatchAfterCache2490 = [1] of {int};
	run TestRDSWatchAfterCache249(child_TestRDSWatchAfterCache2490);
	run receiver(child_TestRDSWatchAfterCache2490)
stop_process:skip
}

proctype TestRDSWatchAfterCache249(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Close6210 = [1] of {int};
	chan child_WatchRouteConfig2423 = [1] of {int};
	...
	run NewRouteConfigs136(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_283,child_NewRouteConfigs1362);
	child_NewRouteConfigs1362?0;
	run WatchRouteConfig242(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,child_WatchRouteConfig2423);
	child_WatchRouteConfig2423?0;
		defer1: skip;
