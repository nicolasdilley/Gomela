...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_endpoints_test.go#L57
#define not_found_84  -2 // opt updates line 237
#define not_found_90  -2 // opt updates line 237
#define not_found_99  -2 // opt updates line 237
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEndpointsWatch570 = [1] of {int};
	run TestEndpointsWatch57(child_TestEndpointsWatch570);
	run receiver(child_TestEndpointsWatch570)
stop_process:skip
}

proctype TestEndpointsWatch57(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Close6210 = [1] of {int};
	chan child_NewEndpoints2374 = [1] of {int};
	chan child_NewEndpoints2373 = [1] of {int};
	...
	run NewEndpoints237(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_84,child_NewEndpoints2372);
	child_NewEndpoints2372?0;
	run NewEndpoints237(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_90,child_NewEndpoints2373);
	child_NewEndpoints2373?0;
	run NewEndpoints237(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_99,child_NewEndpoints2374);
	child_NewEndpoints2374?0;
		defer1: skip;
...
proctype NewEndpoints237(Mutexdef c_cc_lceMu;Mutexdef c_cc_mu;Mutexdef c_lrsMu;Mutexdef c_mu;Mutexdef c_updateCh_mu;int var_updates;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
