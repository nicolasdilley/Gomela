...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_route_test.go#L39
#define not_found_73  -2 // opt updates line 136
#define not_found_79  -2 // opt updates line 136
#define not_found_88  -2 // opt updates line 136
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRDSWatch390 = [1] of {int};
	run TestRDSWatch39(child_TestRDSWatch390);
	run receiver(child_TestRDSWatch390)
stop_process:skip
}

proctype TestRDSWatch39(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewRouteConfigs136(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_73,child_NewRouteConfigs1362);
	child_NewRouteConfigs1362?0;
	run NewRouteConfigs136(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_79,child_NewRouteConfigs1363);
	child_NewRouteConfigs1363?0;
	run NewRouteConfigs136(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_88,child_NewRouteConfigs1364);
...
proctype NewRouteConfigs136(Mutexdef c_cc_lceMu;Mutexdef c_cc_mu;Mutexdef c_lrsMu;Mutexdef c_mu;Mutexdef c_updateCh_mu;int var_updates;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
