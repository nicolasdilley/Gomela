...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L230
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBindQueryParams2300 = [1] of {int};
	run TestBindQueryParams230(child_TestBindQueryParams2300);
	run receiver(child_TestBindQueryParams2300)
stop_process:skip
}

proctype TestBindQueryParams230(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
