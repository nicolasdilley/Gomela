...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L561
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_testBindOkay5610 = [1] of {int};
	run testBindOkay561(child_testBindOkay5610);
	run receiver(child_testBindOkay5610)
stop_process:skip
}

proctype testBindOkay561(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
