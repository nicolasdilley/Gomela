...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/binder_test.go#L18
#define def_var_pathParams  -2 // opt pathParams line 18
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_createTestContext180 = [1] of {int};
	run createTestContext18(def_var_pathParams,child_createTestContext180);
	run receiver(child_createTestContext180)
stop_process:skip
}

proctype createTestContext18(int var_pathParams;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
