...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L333
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBindUnmarshalTextPtr3330 = [1] of {int};
	run TestBindUnmarshalTextPtr333(child_TestBindUnmarshalTextPtr3330);
	run receiver(child_TestBindUnmarshalTextPtr3330)
stop_process:skip
}

proctype TestBindUnmarshalTextPtr333(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
