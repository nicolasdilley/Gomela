...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1903
#define def_var_api  -2 // opt api line 1903
#define not_found_1908  -2 // opt path line 65
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype testRouterAPI1903(int var_api;chan child) {
	...
	:: var_api-1 != -3 -> 
				for(i : 0.. var_api-1) {
			for10: skip;
			run Add65(r_echo_startupMutex,not_found_1908,child_Add650);
			child_Add650?0;
			for10_end: skip
		};
		for10_exit: skip
	:: else -> 
		...
		:: true -> 
			for117: skip;
			run Add65(r_echo_startupMutex,not_found_1908,child_Add651);
			child_Add651?0;
			for117_end: skip
		:: true -> 
			break
