...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L714
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContext_Validate7140 = [1] of {int};
	run TestContext_Validate714(child_TestContext_Validate7140);
	run receiver(child_TestContext_Validate7140)
stop_process:skip
}

proctype TestContext_Validate714(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
