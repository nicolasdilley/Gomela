...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/binder_go1.15_test.go#L23
#define def_var_pathParams  -2 // opt pathParams line 23
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_createTestContext15230 = [1] of {int};
	run createTestContext1523(def_var_pathParams,child_createTestContext15230);
	run receiver(child_createTestContext15230)
stop_process:skip
}

proctype createTestContext1523(int var_pathParams;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
