...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L598
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_testBindError5980 = [1] of {int};
	run testBindError598(child_testBindError5980);
	run receiver(child_testBindError5980)
stop_process:skip
}

proctype testBindError598(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
