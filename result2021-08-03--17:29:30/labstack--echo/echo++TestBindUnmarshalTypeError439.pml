...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L439
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBindUnmarshalTypeError4390 = [1] of {int};
	run TestBindUnmarshalTypeError439(child_TestBindUnmarshalTypeError4390);
	run receiver(child_TestBindUnmarshalTypeError4390)
stop_process:skip
}

proctype TestBindUnmarshalTypeError439(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
