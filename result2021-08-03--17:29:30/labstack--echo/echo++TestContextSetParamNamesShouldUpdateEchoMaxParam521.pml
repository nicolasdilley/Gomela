...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L521
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextSetParamNamesShouldUpdateEchoMaxParam5210 = [1] of {int};
	run TestContextSetParamNamesShouldUpdateEchoMaxParam521(child_TestContextSetParamNamesShouldUpdateEchoMaxParam5210);
	run receiver(child_TestContextSetParamNamesShouldUpdateEchoMaxParam5210)
stop_process:skip
}

proctype TestContextSetParamNamesShouldUpdateEchoMaxParam521(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
