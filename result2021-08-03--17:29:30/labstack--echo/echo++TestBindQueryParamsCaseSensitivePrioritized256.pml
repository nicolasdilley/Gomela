...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L256
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBindQueryParamsCaseSensitivePrioritized2560 = [1] of {int};
	run TestBindQueryParamsCaseSensitivePrioritized256(child_TestBindQueryParamsCaseSensitivePrioritized2560);
	run receiver(child_TestBindQueryParamsCaseSensitivePrioritized2560)
stop_process:skip
}

proctype TestBindQueryParamsCaseSensitivePrioritized256(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
