...
// git_link=https://github.com/cli/cli/blob/25d79c4e16d54d6f3621517269f07048748a6b97/pkg/cmd/run/download/http_test.go#L59
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_Test_Download590 = [1] of {int};
	run Test_Download59(child_Test_Download590);
	run receiver(child_Test_Download590)
stop_process:skip
}

proctype Test_Download59(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
