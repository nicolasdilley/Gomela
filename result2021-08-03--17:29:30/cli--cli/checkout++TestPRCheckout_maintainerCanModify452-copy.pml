...
// git_link=https://github.com/cli/cli/blob/25d79c4e16d54d6f3621517269f07048748a6b97/pkg/cmd/pr/checkout/checkout_test.go#L452
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPRCheckout_maintainerCanModify4520 = [1] of {int};
	run TestPRCheckout_maintainerCanModify452(child_TestPRCheckout_maintainerCanModify4520);
	run receiver(child_TestPRCheckout_maintainerCanModify4520)
stop_process:skip
}

proctype TestPRCheckout_maintainerCanModify452(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
