...
// git_link=https://github.com/k6io/k6/blob/af1e032ebf949cde092d4a2eddb78528ea0a5864/api/v1/group_test.go#L31
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestNewCheck310)
stop_process:skip
}
...
proctype TestNewCheck31(chan child) {
	...
	run NewCheck211(og_checkMutex,og_groupMutex,child_NewCheck2110);
	child_NewCheck2110?0;
	run NewCheck39(oc_Group_checkMutex,oc_Group_groupMutex,child_NewCheck391);
	child_NewCheck391?0;
	stop_process: skip;
	child!0
}
proctype NewCheck211(Mutexdef group_checkMutex;Mutexdef group_groupMutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
