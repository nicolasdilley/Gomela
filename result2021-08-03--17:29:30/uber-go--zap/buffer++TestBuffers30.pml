...
// git_link=https://github.com/uber-go/zap/blob/7b21229fb3f063275f4f169f8a79ad30aa001c51/buffer/pool_test.go#L30
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestBuffers300)
stop_process:skip
}
...
proctype TestBuffers30(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousTestBuffers37340);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
