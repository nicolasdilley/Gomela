...
// git_link=https://github.com/go-gitea/gitea/blob/ed393779004335a0afcca0dfac48937db41fabd6/modules/git/repo_blob_test.go#L58
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRepository_GetBlob_NoId580 = [1] of {int};
	run TestRepository_GetBlob_NoId58(child_TestRepository_GetBlob_NoId580);
	run receiver(child_TestRepository_GetBlob_NoId580)
stop_process:skip
}

proctype TestRepository_GetBlob_NoId58(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
