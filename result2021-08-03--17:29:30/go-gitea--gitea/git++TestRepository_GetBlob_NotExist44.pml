...
// git_link=https://github.com/go-gitea/gitea/blob/ed393779004335a0afcca0dfac48937db41fabd6/modules/git/repo_blob_test.go#L44
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRepository_GetBlob_NotExist440 = [1] of {int};
	run TestRepository_GetBlob_NotExist44(child_TestRepository_GetBlob_NotExist440);
	run receiver(child_TestRepository_GetBlob_NotExist440)
stop_process:skip
}

proctype TestRepository_GetBlob_NotExist44(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
