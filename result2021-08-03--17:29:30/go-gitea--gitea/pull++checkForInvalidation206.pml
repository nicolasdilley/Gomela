...
// git_link=https://github.com/go-gitea/gitea/blob/ed393779004335a0afcca0dfac48937db41fabd6/services/pull/pull.go#L206
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_checkForInvalidation2060)
stop_process:skip
}
...
proctype checkForInvalidation206(chan child) {
	...
	run receiver(child_AnonymouscheckForInvalidation2152110);
	goto stop_process;
	stop_process: skip;
	child!0
}
