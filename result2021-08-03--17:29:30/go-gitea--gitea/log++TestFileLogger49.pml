...
// git_link=https://github.com/go-gitea/gitea/blob/ed393779004335a0afcca0dfac48937db41fabd6/modules/log/file_test.go#L49
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFileLogger490 = [1] of {int};
	run TestFileLogger49(child_TestFileLogger490);
	run receiver(child_TestFileLogger490)
stop_process:skip
}

proctype TestFileLogger49(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
