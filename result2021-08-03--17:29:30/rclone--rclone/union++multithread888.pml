...
// git_link=https://github.com/rclone/rclone/blob/a223b78872dc7a8713ca2aa4596ae3e30c173cdd/backend/union/union.go#L888
#define def_var_num  ?? // mand num line 888
typedef Wgdef {
...
init { 
	...
	run multithread888(def_var_num,child_multithread8880);
	run receiver(child_multithread8880)
stop_process:skip
}

proctype multithread888(int var_num;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
