...
// git_link=https://github.com/rclone/rclone/blob/a223b78872dc7a8713ca2aa4596ae3e30c173cdd/backend/googlephotos/pattern_test.go#L390
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestPatternYears390(chan child) {
	...
	run years250(f_albums_mu,child_years2500);
	child_years2500?0;
	stop_process: skip;
	child!0
}
proctype years250(Mutexdef f_albums_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
