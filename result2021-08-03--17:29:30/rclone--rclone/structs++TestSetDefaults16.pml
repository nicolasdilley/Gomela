...
// git_link=https://github.com/rclone/rclone/blob/a223b78872dc7a8713ca2aa4596ae3e30c173cdd/lib/structs/structs_test.go#L16
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype SetDefaults44(Mutexdef a_altMu;Mutexdef a_connsPerHostMu;Mutexdef a_idleMu;Mutexdef a_nextProtoOnce_m;Mutexdef a_reqMu;Mutexdef a_TLSClientConfig_mutex;Mutexdef b_altMu;Mutexdef b_connsPerHostMu;Mutexdef b_idleMu;Mutexdef b_nextProtoOnce_m;Mutexdef b_reqMu;Mutexdef b_TLSClientConfig_mutex;chan child) {
	...
	bool state;
	int num_msgs;
	int var_t_NumField = -2; // opt var_t_NumField
	stop_process: skip;
	child!0
}
