...
// git_link=https://github.com/rclone/rclone/blob/a223b78872dc7a8713ca2aa4596ae3e30c173cdd/vfs/dir_test.go#L212
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestDirSetModTime212(chan child) {
	...
	run SetModTime678(dir_modTimeMu,dir_mu,dir_vfs_usageMu,child_SetModTime6780);
	child_SetModTime6780?0;
	run ModTime665(dir_modTimeMu,dir_mu,dir_vfs_usageMu,child_ModTime6651);
	child_ModTime6651?0;
	run SetModTime678(dir_modTimeMu,dir_mu,dir_vfs_usageMu,child_SetModTime6782);
	child_SetModTime6782?0;
	run ModTime665(dir_modTimeMu,dir_mu,dir_vfs_usageMu,child_ModTime6653);
	child_ModTime6653?0;
	run SetModTime678(dir_modTimeMu,dir_mu,dir_vfs_usageMu,child_SetModTime6784);
	child_SetModTime6784?0;
	stop_process: skip;
	child!0
}
proctype SetModTime678(Mutexdef d_modTimeMu;Mutexdef d_mu;Mutexdef d_vfs_usageMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype ModTime665(Mutexdef d_modTimeMu;Mutexdef d_mu;Mutexdef d_vfs_usageMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
