...
// git_link=https://github.com/rclone/rclone/blob/a223b78872dc7a8713ca2aa4596ae3e30c173cdd/cmd/serve/restic/cache_test.go#L37
#define not_found_3925  -2
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype String12(Mutexdef c_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_items = -2; // opt var_c_items
	c_mu.Lock!false;
	c_mu.Unlock!false;
	goto stop_process;
	stop_process: skip;
