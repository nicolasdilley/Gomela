...
proctype TestScrapeLoopAppendExemplarSeries1605(chan child) {
	...
	int var_scrapeText = -2; // opt var_scrapeText
	int var_exemplars = -2; // opt var_exemplars
	int var_samples = -2; // opt var_samples
...
proctype iterDone774(Mutexdef c_metaMtx;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_seriesCur = -2; // opt var_c_seriesCur
	int var_c_metadata = -2; // opt var_c_metadata
	int var_c_droppedSeries = -2; // opt var_c_droppedSeries
	int var_c_series = -2; // opt var_c_series
...
proctype forEachStale859(Mutexdef c_metaMtx;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_seriesPrev = -2; // opt var_c_seriesPrev
	stop_process: skip;
	child!0
}
