...
#define PanSource	"/Users/redfloyd/go/src/github.com/nicolasdilley/gomela/result2021-02-03--12:48:56/tsuru--tsuru/client++DoLimited780.pml"
...
#define _nstates2	25	/* sync_monitor */
#define minseq2	74
#define maxseq2	97
#define _endstate2	24

#define _nstates1	48	/* AsyncChan */
#define minseq1	27
#define maxseq1	73
#define _endstate1	47

#define _nstates0	28	/* :init: */
#define minseq0	0
#define maxseq0	26
...
#define Psync_monitor	((P2 *)this)
typedef struct P2 { /* sync_monitor */
...
#define PAsyncChan	((P1 *)this)
typedef struct P1 { /* AsyncChan */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P0 { /* :init: */
	...
	int limit;
	int n;
	struct Chandef limiter;
	struct Chandef errCh;
} P0;
#define Air0	0
