#define doWriteDeleteWaitLeaveJoin_parallelWriters 1
#define lb_for204_1  -1
#define ub_for204_2  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example639977897/cmd/networkdb-test/dbclient/ndbClient.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int parallelWriters = doWriteDeleteWaitLeaveJoin_parallelWriters;
	bool state = false;
...
for10:		run go_dbclientwriteDeleteUniqueKeys(doneCh)
	};
...
proctype go_dbclientwriteDeleteUniqueKeys(Chandef doneCh) {
	bool closed; 
	int i;
	bool state;
	
	if
	:: lb_for204_1 != -1 && ub_for204_2 != -1 -> 
				for(i : lb_for204_1.. ub_for204_2) {
for11:			do
			:: true -> 
				break
			od
