#define doWriteDeleteUniqueKeys_parallelWriters 3
...
init { 
	...
	int parallelWriters = doWriteDeleteUniqueKeys_parallelWriters;
	bool state = false;
...
for10_exit:	run dbclientwaitWriters(doneCh,parallelWriters,child_dbclientwaitWriters0);
	child_dbclientwaitWriters0?0;
		for(i : 0.. parallelWriters-1) {
for30:		run go_dbclientwriteDeleteUniqueKeys(doneCh)
	};
