#define executeSearch_options_Cores 1
#define executeSearch_targets 3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example725523275/sift.go
typedef Chandef {
	chan sync = [0] of {int};
