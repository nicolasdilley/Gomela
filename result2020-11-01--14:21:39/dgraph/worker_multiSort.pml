#define multiSort_sortVals 0
#define multiSort_r_reply_UidMatrix 3
#define multiSort_ul_Uids 1
#define multiSort_ts_Order 0
#define multiSort_dest_Uids 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example411586957/worker/sort.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10:
		...
		for(i : 0.. r_reply_UidMatrix-1) {
for20:				for(i : 0.. ul_Uids-1) {
for21:
		}
	};
