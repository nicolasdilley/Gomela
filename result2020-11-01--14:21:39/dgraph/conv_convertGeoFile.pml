#define convertGeoFile_fc_Features 0
#define convertGeoFile_f_Properties 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example411586957/dgraph/cmd/conv/conv.go
typedef Chandef {
	chan sync = [0] of {int};
