#define applyMutations_initialSchema  ??
#define applyMutations_initialTypes  ??
#define applyMutations_proposal_Mutations_Schema  ??
#define applyMutations_proposal_Mutations_Types  ??
#define applyMutations_proposal_Mutations_Edges  ??
#define applyMutations_schemaMap  ??
#define applyMutations_edges  ??
#define applyMutations_numGo  ??

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example411586957/worker/draft.go
typedef Chandef {
	chan sync = [0] of {int};
...
for40:			
	...
	:: true;
		...
		for(i : 0.. proposal_Mutations_Edges-1) {
for50:		
		if
		:: true -> 
