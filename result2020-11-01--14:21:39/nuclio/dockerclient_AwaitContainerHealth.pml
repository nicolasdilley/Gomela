#define lb_for387_0  -1
#define ub_for387_1  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example126141555/pkg/dockerclient/shell.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype Anonymous0(Chandef containerHealthy;Chandef timeoutChan) {
	...
	if
	:: lb_for387_0 != -1 && ub_for387_1 != -1 -> 
				for(i : lb_for387_0.. ub_for387_1) {
for10:			
			if
			:: true -> 
