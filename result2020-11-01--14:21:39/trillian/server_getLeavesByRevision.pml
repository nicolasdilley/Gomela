#define getLeavesByRevision_leaves 3
#define getLeavesByRevision_indices 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example444790199/server/map_rpc_server.go
typedef Chandef {
	chan sync = [0] of {int};
