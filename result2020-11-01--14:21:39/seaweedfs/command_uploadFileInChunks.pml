#define uploadFileInChunks_chunkCount 1
#define uploadFileInChunks_worker_options_concurrenctChunks 0
#define uploadFileInChunks_chunks 1
#define lb_for391_3  -1
#define ub_for391_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example683189665/weed/command/filer_copy.go
typedef Chandef {
	chan sync = [0] of {int};
