#define getIndexYaml_initialItemCount 3
#define getIndexYaml_namespaces 1
#define getIndexYaml_mergedIndexFile_PublicKeys 0
#define getIndexYaml_hash 3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example190001440/src/chartserver/handler_repo.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	int mergedIndexFile_PublicKeys = getIndexYaml_mergedIndexFile_PublicKeys;
	Chandef mergeDone;
	Chandef resultChan;
...
for30:		do
	...
	:: true;
		...
		for(i : 0.. mergedIndexFile_PublicKeys-1) {
for40:
	};
		for(i : 0.. hash-1) {
for50:
