...
#define Authenticate_ctx 3
#define authenticateDevice_req_RegisteredKeys 1
#define lb_for123_3  -1
#define ub_for123_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example799795789/pkg/token/token.go
typedef Chandef {
	chan sync = [0] of {int};
