#define NewState_msgQueueSize 0
#define NewState_options 0

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example061657773/test/maverick/consensus/state.go
typedef Chandef {
	chan sync = [0] of {int};
