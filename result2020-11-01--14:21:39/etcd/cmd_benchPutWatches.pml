#define benchPutWatches_watchPutTotal 1
#define benchPutWatches_wk_watches 0
#define benchPutWatches_wc 3
#define benchPutWatches_clients 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example997875907/tools/benchmark/cmd/watch.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10_exit:		for(i : 0.. wk_watches-1) {
