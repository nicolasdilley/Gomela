#define lb_for1412_0  -1
#define ub_for1412_1  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example213061294/server/jetstream_api.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	if
	:: lb_for1412_0 != -1 && ub_for1412_1 != -1 -> 
				for(i : lb_for1412_0.. ub_for1412_1) {
for30:			
			if
			:: true -> 
				break
