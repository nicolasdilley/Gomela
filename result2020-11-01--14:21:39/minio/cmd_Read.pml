#define Read_newBuf 3
#define Read_p_readers 1
#define Read_p_dataBlocks 3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example320658119/cmd/erasure-decode.go
typedef Chandef {
	chan sync = [0] of {int};
