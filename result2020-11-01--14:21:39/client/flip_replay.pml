#define replay_msg_CommitmentComplete_Players 3
#define replay_ret_Players 1
#define replay_players 3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example441703692/go/chat/flip/replay.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10:		
		...
		:: true;
		:: true -> 
						for(i : 0.. msg_CommitmentComplete_Players-1) {
for11:
			};
						for(i : 0.. ret_Players-1) {
for12:
			}
		:: true;
		:: true;
