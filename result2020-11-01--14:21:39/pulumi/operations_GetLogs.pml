...
#define GetLogs_logs 1
#define GetLogs_lastLogs 0

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example759395690/pkg/operations/resources.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run sync_monitor(errch);
		for(i : 0.. ops_resource_Children-1) {
