...
#define RunContext_errors_m 3
#define RunContext_artifacts_m 1
#define RunContext_buildArtifacts 0
#define RunContext_files 3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example120421127/command/build.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
