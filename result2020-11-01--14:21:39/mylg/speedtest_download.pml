#define download_sizeDld 1
#define download_st_cfg_Download_ThreadsPerURL 1
#define download_urls 1
#define lb_for224_3  -1
#define ub_for224_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example333001717/speedtest/speedtest.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
