#define VerifyHeaders_headers 3
#define VerifyHeaders_workers 1
#define lb_for145_2  -1
#define ub_for145_3  -1
#define lb_for153_4  -1
#define ub_for153_5  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example127052982/consensus/ethash/consensus.go
typedef Chandef {
	chan sync = [0] of {int};
