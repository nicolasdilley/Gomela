...
#define lb_for246_4  -1
#define ub_for246_5  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example960382288/drivers/shared/executor/exec_utils.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run go_executorhandleStderr(wg,errCh);
	wg.Wait?0;
	do
	:: errCh.async_rcv?0 -> 
		goto stop_process
...
proctype go_executorhandleStderr(Wgdef wg;Chandef errCh) {
	bool closed; 
	int i;
	bool state;
	do
