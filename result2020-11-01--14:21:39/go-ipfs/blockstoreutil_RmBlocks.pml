#define RmBlocks_cids 0
#define RmBlocks_stillOkay 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example887449413/blocks/blockstoreutil/remove.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	int i;
	int cids = RmBlocks_cids;
	Chandef out;
	int stillOkay = RmBlocks_stillOkay;
	bool state = false;
