#define PureFuncExec_args 3
#define lb_for262_1  -1
#define ub_for262_2  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example822374033/lang/funcs/funcs.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype Anonymous1(Chandef errch;Chandef input;Chandef output;Chandef close1;Chandef close2) {
	...
	:: errch.sync!0 -> 
		...
		break
	od;
stop_process:	close1.closing!true
}
...
for10:		
	...
	:: close1.sync?0 -> 
		...
		break
	od;
stop_process:	close2.closing!true;
	input.closing!true
}
