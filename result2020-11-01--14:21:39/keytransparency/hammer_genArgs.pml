#define genArgs_qps 3
#define genArgs_count 3
#define genArgs_batch 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example743884071/core/client/hammer/hammer.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10_exit:stop_process:	inflightReqs.closing!true
}
