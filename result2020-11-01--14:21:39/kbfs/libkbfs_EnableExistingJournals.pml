#define EnableExistingJournals_fileInfos 1
#define EnableExistingJournals_numWorkers 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example105184738/libkbfs/journal_server.go
typedef Chandef {
	chan sync = [0] of {int};
