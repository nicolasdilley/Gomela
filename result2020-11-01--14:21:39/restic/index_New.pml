#define New_listPackWorkers 3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example793486502/internal/index/index.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	Chandef inputCh;
	Wgdef wg_wg;
	int listPackWorkers = New_listPackWorkers;
	bool state = false;
