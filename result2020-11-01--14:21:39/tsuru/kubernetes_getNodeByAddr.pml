#define getNodeByAddr_nodeList 3
#define getNodeByAddr_n_Status_Addresses 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example261955616/provision/kubernetes/helpers.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
