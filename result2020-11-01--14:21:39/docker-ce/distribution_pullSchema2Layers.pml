#define pullSchema2Layers_layers 1
#define pullSchema2Layers_descriptors 1
#define pullSchema2Layers_downloadedRootFS_DiffIDs 3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example006610631/components/engine/distribution/pull_v2.go
typedef Chandef {
	chan sync = [0] of {int};
...
for20:
	...
	:: true -> 
		...
		:: true;
				...
				for(i : 0.. downloadedRootFS_DiffIDs-1) {
for30:			
			if
			:: true -> 
				goto stop_process
