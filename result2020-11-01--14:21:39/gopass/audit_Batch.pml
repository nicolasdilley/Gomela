#define Batch_maxJobs 3
#define Batch_ctx 0
#define Batch_secrets 3
#define Batch_secret_messages 0
#define audit_errs 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example794724321/internal/audit/audit.go
typedef Chandef {
	chan sync = [0] of {int};
