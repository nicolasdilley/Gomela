#define newServer_listenAddrs 3
#define newServer_cfg_ExternalIPs 1
#define newServer_msgs 0
#define newServer_dbChannels 0
#define newServer_s_currentNodeAnn_Addresses 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example581033907/server.go
typedef Chandef {
	chan sync = [0] of {int};
