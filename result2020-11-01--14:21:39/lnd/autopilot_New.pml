#define New_initialState 3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example581033907/autopilot/agent.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int initialState = New_initialState;
	bool state = false;
	run wgMonitor(a_wg);
