...
#define getPrincipal_rdns_Attributes 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example188875637/pkg/auth/providers/activedirectory/activedirectory_client.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
