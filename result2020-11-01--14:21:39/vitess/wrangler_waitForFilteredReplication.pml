#define waitForFilteredReplication_destinationShards 0
#define waitForFilteredReplication_si_SourceShards 1
#define waitForFilteredReplication_sourcePositions 0
...
proctype Anonymous0() {
	...
	int i;
	bool state;
		for(i : 0.. si_SourceShards-1) {
for11:				for(i : 0.. sourcePositions-1) {
for12:			
			if
			:: true -> 
				break
