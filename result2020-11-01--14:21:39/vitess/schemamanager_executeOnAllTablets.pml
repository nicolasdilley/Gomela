#define executeOnAllTablets_numOfMasterTablets 3
#define executeOnAllTablets_exec_tablets 1
#define executeOnAllTablets_execResult_SuccessShards 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example345111863/go/vt/schemamanager/tablet_executor.go
typedef Chandef {
	chan sync = [0] of {int};
