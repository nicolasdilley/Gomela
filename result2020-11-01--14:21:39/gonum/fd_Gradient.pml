#define Gradient_xcopy  ??
#define Gradient_formula_Stencil  ??
...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example113587139/diff/fd/gradient.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype Anonymous1(Chandef sendChan;Chandef ansChan;Chandef quit) {
	...
	bool state;
		for(i : 0.. x-1) {
for30:				for(i : 0.. formula_Stencil-1) {
for31:			
			if
			:: true -> 
