#define progressTask_mtask_Containers 1
#define progressTask_resources 1
#define progressTask_resTransitions 3
#define progressTask_contTransitions 0
#define lb_for812_4  -1
#define ub_for812_5  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example825738083/agent/engine/docker_task_engine.go
typedef Chandef {
	chan sync = [0] of {int};
