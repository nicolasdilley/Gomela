#define syncNodes_createDiff 3
#define syncNodes_deleteDiff 1
#define syncNodes_batchSize 3
#define syncNodes_pos 0
#define lb_for957_4  -1
#define ub_for957_5  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example808497976/pkg/controller/daemon/daemon_controller.go
typedef Chandef {
	chan sync = [0] of {int};
