#define start_s_healthCheckUrls 0
#define lb_for170_1  -1
#define ub_for170_2  -1
#define lb_for187_3  -1
#define ub_for187_4  -1
#define lb_for59_5  -1
#define ub_for59_6  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example808497976/test/e2e_node/services/server.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	Chandef errCh;
	int s_healthCheckUrls = start_s_healthCheckUrls;
	bool state = false;
...
proctype servicesreadinessCheck(Chandef errCh;int urls;chan child) {
	...
	if
	:: lb_for59_5 != -1 && ub_for59_6 != -1 -> 
				for(i : lb_for59_5.. ub_for59_6) {
for20:			do
			:: errCh.async_rcv?0 -> 
