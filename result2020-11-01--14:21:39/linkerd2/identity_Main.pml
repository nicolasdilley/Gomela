...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example368403073/pkg/admin/admin.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	run Anonymous0(stop,issuerEvent,issuerError);
...
proctype Anonymous0(Chandef stop;Chandef issuerEvent;Chandef issuerError) {
	bool closed; 
	int i;
	bool state;
stop_process:
