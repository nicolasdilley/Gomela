#define NewHandler_config_BufferingSize 0
#define NewHandler_config_Fields_Headers_Names 1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example502194891/pkg/middlewares/accesslog/logger.go
typedef Chandef {
	chan sync = [0] of {int};
