#define ModifyCapacity_p_max 3
#define ModifyCapacity_newAllocs 3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example906491796/service/s3/s3manager/pool.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int newAllocs = ModifyCapacity_newAllocs;
	Chandef p_slices;
	bool state = false;
