#define runTest_numAccounts 3
#define runTest_numGoroutines 0
#define runTest_list_Kv 3

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example998944944/badger/cmd/bank.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
