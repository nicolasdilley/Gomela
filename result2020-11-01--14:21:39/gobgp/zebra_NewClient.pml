...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example042913819/internal/pkg/zebra/zapi.go
typedef Chandef {
	chan sync = [0] of {int};
...
for20:		
	...
	od;
for20_exit:stop_process:	run zebracloseChannel(incoming,child_zebracloseChannel1);
