...
// git_link=https://github.com/minio/minio/blob/e948e7cdf65028f7a8545d1a05c2baea75198bd0/pkg/pubsub/pubsub_test.go#L61
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestPubSub610 = [1] of {int};
	run TestPubSub61(child_TestPubSub610);
	run receiver(child_TestPubSub610)
stop_process:skip
}

proctype TestPubSub61(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
