...
// git_link=https://github.com/minio/minio/blob/e948e7cdf65028f7a8545d1a05c2baea75198bd0/pkg/pubsub/pubsub_test.go#L26
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSubscribe260 = [1] of {int};
	run TestSubscribe26(child_TestSubscribe260);
	run receiver(child_TestSubscribe260)
stop_process:skip
}

proctype TestSubscribe26(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
