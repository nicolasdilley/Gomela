...
// git_link=https://github.com/rclone/rclone/blob/6ef7178ee4465f2361b6e2cf483cef5bbfd9c95c/vfs/vfscache/item.go#L106
typedef Wgdef {
...
init { 
	chan child_Less1060 = [1] of {int};
	run Less106(child_Less1060);
	run receiver(child_Less1060)
stop_process:skip
}

proctype Less106(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
