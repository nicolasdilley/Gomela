...
// git_link=https://github.com/rclone/rclone/blob/6ef7178ee4465f2361b6e2cf483cef5bbfd9c95c/lib/cache/cache_test.go#L56
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestGetFile560 = [1] of {int};
	run TestGetFile56(child_TestGetFile560);
	run receiver(child_TestGetFile560)
stop_process:skip
}

proctype TestGetFile56(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
