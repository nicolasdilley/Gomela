...
proctype NewCoprRPCHandler35(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_CheckStreamTimeoutLoop10220 = [1] of {int};
	Chandef done_ch;
	Chandef ch_ch;
	...
	run CheckStreamTimeoutLoop1022(ch_ch,done_ch,child_CheckStreamTimeoutLoop10220);
	run receiver(child_CheckStreamTimeoutLoop10220);
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype CheckStreamTimeoutLoop1022(Chandef ch_ch;Chandef done_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
