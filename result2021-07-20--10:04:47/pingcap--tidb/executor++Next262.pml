...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/executor.go#L262
typedef Wgdef {
...
init { 
	chan child_Next2620 = [1] of {int};
	run Next262(child_Next2620);
	run receiver(child_Next2620)
stop_process:skip
}

proctype Next262(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
