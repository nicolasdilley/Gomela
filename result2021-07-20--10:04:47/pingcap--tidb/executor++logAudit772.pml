...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/adapter.go#L772
typedef Wgdef {
...
init { 
	chan child_logAudit7720 = [1] of {int};
	run logAudit772(child_logAudit7720);
	run receiver(child_logAudit7720)
stop_process:skip
}

proctype logAudit772(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
