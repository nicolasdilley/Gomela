...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/util/execdetails/execdetails_test.go#L160
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestCopRuntimeStatsForTiFlash1600 = [1] of {int};
	run TestCopRuntimeStatsForTiFlash160(child_TestCopRuntimeStatsForTiFlash1600);
	run receiver(child_TestCopRuntimeStatsForTiFlash1600)
stop_process:skip
}

proctype TestCopRuntimeStatsForTiFlash160(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
