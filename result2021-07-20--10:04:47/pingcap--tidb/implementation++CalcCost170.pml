...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/planner/implementation/datasource.go#L170
typedef Wgdef {
...
init { 
	chan child_CalcCost1700 = [1] of {int};
	run CalcCost170(child_CalcCost1700);
	run receiver(child_CalcCost1700)
stop_process:skip
}

proctype CalcCost170(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
