...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/planner/core/logical_plan_builder.go#L1701
...
init { 
	chan child_getUintFromNode17010 = [1] of {int};
	run getUintFromNode1701(child_getUintFromNode17010);
	run receiver(child_getUintFromNode17010)
stop_process:skip
}

proctype getUintFromNode1701(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
