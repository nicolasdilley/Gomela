...
#define not_found_1199  -2 // opt exprs line 1185
typedef Wgdef {
...
proctype attach2Task1325(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_CanExprsPushDown11980 = [1] of {int};
	...
	:: true -> 
		...
		run CanExprsPushDown1198(sc_mu,sc_RuntimeStatsColl_mu,child_CanExprsPushDown11980);
		child_CanExprsPushDown11980?0;
...
proctype CanExprsPushDown1198(Mutexdef sc_mu;Mutexdef sc_RuntimeStatsColl_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_PushDownExprs11850 = [1] of {int};
	run PushDownExprs1185(sc_mu,sc_RuntimeStatsColl_mu,not_found_1199,child_PushDownExprs11850);
	child_PushDownExprs11850?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype PushDownExprs1185(Mutexdef sc_mu;Mutexdef sc_RuntimeStatsColl_mu;int exprs;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
