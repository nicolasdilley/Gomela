...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/analyze.go#L211
typedef Wgdef {
...
init { 
	chan child_getBuildStatsConcurrency2110 = [1] of {int};
	run getBuildStatsConcurrency211(child_getBuildStatsConcurrency2110);
	run receiver(child_getBuildStatsConcurrency2110)
stop_process:skip
}

proctype getBuildStatsConcurrency211(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
