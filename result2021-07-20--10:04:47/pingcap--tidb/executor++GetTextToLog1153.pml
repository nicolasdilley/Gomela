...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/adapter.go#L1153
typedef Wgdef {
...
init { 
	chan child_GetTextToLog11530 = [1] of {int};
	run GetTextToLog1153(child_GetTextToLog11530);
	run receiver(child_GetTextToLog11530)
stop_process:skip
}

proctype GetTextToLog1153(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
