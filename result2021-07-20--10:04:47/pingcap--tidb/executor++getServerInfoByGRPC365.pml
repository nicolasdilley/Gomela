...
proctype getServerInfoByGRPC365(chan child) {
	...
	goto defer1;
		defer1: skip;
	run Close165(conn_balancerWrapper_balancerMu,conn_balancerWrapper_mu,conn_blockingpicker_mu,conn_csMgr_mu,conn_mu,conn_resolverWrapper_pollingMu,conn_resolverWrapper_resolverMu,child_Close1650);
	child_Close1650?0;
	stop_process: skip;
	child!0
}
proctype Close165(Mutexdef a_balancerWrapper_balancerMu;Mutexdef a_balancerWrapper_mu;Mutexdef a_blockingpicker_mu;Mutexdef a_csMgr_mu;Mutexdef a_mu;Mutexdef a_resolverWrapper_pollingMu;Mutexdef a_resolverWrapper_resolverMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
