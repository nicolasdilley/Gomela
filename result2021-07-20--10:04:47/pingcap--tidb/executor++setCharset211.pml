...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/set.go#L211
typedef Wgdef {
...
init { 
	chan child_setCharset2110 = [1] of {int};
	run setCharset211(child_setCharset2110);
	run receiver(child_setCharset2110)
stop_process:skip
}

proctype setCharset211(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_SetSessionSystemVar2786 = [1] of {int};
	chan child_SetSessionSystemVar2785 = [1] of {int};
	chan child_SetSessionSystemVar2783 = [1] of {int};
	chan child_SetSessionSystemVar2784 = [1] of {int};
	chan child_SetSessionSystemVar2782 = [1] of {int};
	...
	int var_variable_SetCharsetVariablesvariable_SetCharsetVariables = -2; // opt var_variable_SetCharsetVariablesvariable_SetCharsetVariables
	int var_variable_SetNamesVariablesvariable_SetNamesVariables = -2; // opt var_variable_SetNamesVariablesvariable_SetNamesVariables
	...
	:: true -> 
		...
		if
		:: var_variable_SetNamesVariables-1 != -3 -> 
						for(i : 0.. var_variable_SetNamesVariables-1) {
				for10: skip;
		...
		run SetSessionSystemVar278(sessionVars_BinlogClient_wg,sessionVars_SequenceState_mu,sessionVars_TxnCtx_tdmLock,sessionVars_UsersLock,child_SetSessionSystemVar2782);
		child_SetSessionSystemVar2782?0;
		goto stop_process
	:: true;
	fi;
	...
	if
	:: var_variable_SetCharsetVariables-1 != -3 -> 
				for(i : 0.. var_variable_SetCharsetVariables-1) {
			for20: skip;
			run SetSessionSystemVar278(sessionVars_BinlogClient_wg,sessionVars_SequenceState_mu,sessionVars_TxnCtx_tdmLock,sessionVars_UsersLock,child_SetSessionSystemVar2783);
			child_SetSessionSystemVar2783?0;
	...
	:: else -> 
		...
		:: true -> 
			for21: skip;
			run SetSessionSystemVar278(sessionVars_BinlogClient_wg,sessionVars_SequenceState_mu,sessionVars_TxnCtx_tdmLock,sessionVars_UsersLock,child_SetSessionSystemVar2784);
			child_SetSessionSystemVar2784?0;
	...
	run SetSessionSystemVar278(sessionVars_BinlogClient_wg,sessionVars_SequenceState_mu,sessionVars_TxnCtx_tdmLock,sessionVars_UsersLock,child_SetSessionSystemVar2785);
	child_SetSessionSystemVar2785?0;
	...
	run SetSessionSystemVar278(sessionVars_BinlogClient_wg,sessionVars_SequenceState_mu,sessionVars_TxnCtx_tdmLock,sessionVars_UsersLock,child_SetSessionSystemVar2786);
	child_SetSessionSystemVar2786?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
