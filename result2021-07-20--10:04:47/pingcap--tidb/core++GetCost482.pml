...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/planner/core/task.go#L482
typedef Wgdef {
...
init { 
	chan child_GetCost4820 = [1] of {int};
	run GetCost482(child_GetCost4820);
	run receiver(child_GetCost4820)
stop_process:skip
}

proctype GetCost482(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
