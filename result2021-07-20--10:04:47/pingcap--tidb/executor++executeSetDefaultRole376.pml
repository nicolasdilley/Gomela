...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/simple.go#L376
typedef Wgdef {
...
init { 
	chan child_executeSetDefaultRole3760 = [1] of {int};
	run executeSetDefaultRole376(child_executeSetDefaultRole3760);
	run receiver(child_executeSetDefaultRole3760)
stop_process:skip
}

proctype executeSetDefaultRole376(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
