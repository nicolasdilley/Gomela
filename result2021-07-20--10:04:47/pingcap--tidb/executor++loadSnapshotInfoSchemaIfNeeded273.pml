...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/executor/set.go#L273
typedef Wgdef {
...
init { 
	chan child_loadSnapshotInfoSchemaIfNeeded2730 = [1] of {int};
	run loadSnapshotInfoSchemaIfNeeded273(child_loadSnapshotInfoSchemaIfNeeded2730);
	run receiver(child_loadSnapshotInfoSchemaIfNeeded2730)
stop_process:skip
}

proctype loadSnapshotInfoSchemaIfNeeded273(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
