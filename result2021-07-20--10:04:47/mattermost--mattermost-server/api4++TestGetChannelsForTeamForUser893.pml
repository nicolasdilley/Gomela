...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L893
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetChannelsForTeamForUser8930 = [1] of {int};
	run TestGetChannelsForTeamForUser893(child_TestGetChannelsForTeamForUser8930);
	run receiver(child_TestGetChannelsForTeamForUser8930)
stop_process:skip
}

proctype TestGetChannelsForTeamForUser893(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_foundfound = -2; // opt var_foundfound
