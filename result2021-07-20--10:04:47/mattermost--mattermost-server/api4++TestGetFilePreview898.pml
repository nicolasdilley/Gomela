...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/file_test.go#L898
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetFilePreview8980 = [1] of {int};
	run TestGetFilePreview898(child_TestGetFilePreview8980);
	run receiver(child_TestGetFilePreview8980)
stop_process:skip
}

proctype TestGetFilePreview898(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
