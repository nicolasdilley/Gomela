...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/upload_test.go#L93
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUpload930 = [1] of {int};
	run TestGetUpload93(child_TestGetUpload930);
	run receiver(child_TestGetUpload930)
stop_process:skip
}

proctype TestGetUpload93(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
