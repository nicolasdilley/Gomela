...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L842
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetPublicChannelsByIdsForTeam8420 = [1] of {int};
	run TestGetPublicChannelsByIdsForTeam842(child_TestGetPublicChannelsByIdsForTeam8420);
	run receiver(child_TestGetPublicChannelsByIdsForTeam8420)
stop_process:skip
}

proctype TestGetPublicChannelsByIdsForTeam842(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
