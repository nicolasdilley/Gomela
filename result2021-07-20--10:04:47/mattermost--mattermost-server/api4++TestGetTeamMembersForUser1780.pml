...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L1780
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTeamMembersForUser17800 = [1] of {int};
	run TestGetTeamMembersForUser1780(child_TestGetTeamMembersForUser17800);
	run receiver(child_TestGetTeamMembersForUser17800)
stop_process:skip
}

proctype TestGetTeamMembersForUser1780(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_membersmembers = -2; // opt var_membersmembers
