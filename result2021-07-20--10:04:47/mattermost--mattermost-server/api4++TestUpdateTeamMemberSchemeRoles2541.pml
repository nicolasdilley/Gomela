...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L2541
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateTeamMemberSchemeRoles25410 = [1] of {int};
	run TestUpdateTeamMemberSchemeRoles2541(child_TestUpdateTeamMemberSchemeRoles25410);
	run receiver(child_TestUpdateTeamMemberSchemeRoles25410)
stop_process:skip
}

proctype TestUpdateTeamMemberSchemeRoles2541(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
