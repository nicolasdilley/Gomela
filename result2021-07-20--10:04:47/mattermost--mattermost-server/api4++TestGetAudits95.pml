...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/system_test.go#L95
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetAudits950 = [1] of {int};
	run TestGetAudits95(child_TestGetAudits950);
	run receiver(child_TestGetAudits950)
stop_process:skip
}

proctype TestGetAudits95(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
