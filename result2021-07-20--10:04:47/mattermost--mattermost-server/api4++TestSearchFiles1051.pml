...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/file_test.go#L1051
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSearchFiles10510 = [1] of {int};
	run TestSearchFiles1051(child_TestSearchFiles10510);
	run receiver(child_TestSearchFiles10510)
stop_process:skip
}

proctype TestSearchFiles1051(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
