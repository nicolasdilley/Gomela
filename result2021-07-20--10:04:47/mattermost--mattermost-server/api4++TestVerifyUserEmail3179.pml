...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L3179
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestVerifyUserEmail31790 = [1] of {int};
	run TestVerifyUserEmail3179(child_TestVerifyUserEmail31790);
	run receiver(child_TestVerifyUserEmail31790)
stop_process:skip
}

proctype TestVerifyUserEmail3179(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
