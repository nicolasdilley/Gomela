...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L4877
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestLoginLockout48770 = [1] of {int};
	run TestLoginLockout4877(child_TestLoginLockout48770);
	run receiver(child_TestLoginLockout48770)
stop_process:skip
}

proctype TestLoginLockout4877(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
