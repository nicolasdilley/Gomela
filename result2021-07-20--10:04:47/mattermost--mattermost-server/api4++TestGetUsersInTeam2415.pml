...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2415
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUsersInTeam24150 = [1] of {int};
	run TestGetUsersInTeam2415(child_TestGetUsersInTeam24150);
	run receiver(child_TestGetUsersInTeam24150)
stop_process:skip
}

proctype TestGetUsersInTeam2415(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
