...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/plugin_test.go#L367
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestDisableOnRemove3670 = [1] of {int};
	run TestDisableOnRemove367(child_TestDisableOnRemove3670);
	run receiver(child_TestDisableOnRemove3670)
stop_process:skip
}

proctype TestDisableOnRemove367(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
