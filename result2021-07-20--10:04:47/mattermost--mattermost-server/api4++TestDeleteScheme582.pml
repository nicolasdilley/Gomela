...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/scheme_test.go#L582
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestDeleteScheme5820 = [1] of {int};
	run TestDeleteScheme582(child_TestDeleteScheme5820);
	run receiver(child_TestDeleteScheme5820)
stop_process:skip
}

proctype TestDeleteScheme582(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
