...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L2082
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetChannelMembersByIds20820 = [1] of {int};
	run TestGetChannelMembersByIds2082(child_TestGetChannelMembersByIds20820);
	run receiver(child_TestGetChannelMembersByIds20820)
stop_process:skip
}

proctype TestGetChannelMembersByIds2082(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
