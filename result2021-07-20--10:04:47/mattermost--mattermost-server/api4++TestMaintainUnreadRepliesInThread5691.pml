...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L5691
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestMaintainUnreadRepliesInThread56910 = [1] of {int};
	run TestMaintainUnreadRepliesInThread5691(child_TestMaintainUnreadRepliesInThread56910);
	run receiver(child_TestMaintainUnreadRepliesInThread56910)
stop_process:skip
}

proctype TestMaintainUnreadRepliesInThread5691(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_TearDown2920 = [1] of {int};
	chan child_checkThreadListReplies56616 = [1] of {int};
	chan child_checkThreadListReplies56615 = [1] of {int};
	chan child_checkThreadListReplies56614 = [1] of {int};
	chan child_checkThreadListReplies56613 = [1] of {int};
	chan child_checkThreadListReplies56612 = [1] of {int};
	chan child_checkThreadListReplies56611 = [1] of {int};
	Mutexdef rpost_propsMu;
	...
	run mutexMonitor(rpost_propsMu);
	run checkThreadListReplies5661(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_checkThreadListReplies56611);
	child_checkThreadListReplies56611?0;
	run checkThreadListReplies5661(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_checkThreadListReplies56612);
	child_checkThreadListReplies56612?0;
	run checkThreadListReplies5661(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_checkThreadListReplies56613);
	child_checkThreadListReplies56613?0;
	run checkThreadListReplies5661(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_checkThreadListReplies56614);
	child_checkThreadListReplies56614?0;
	run checkThreadListReplies5661(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_checkThreadListReplies56615);
	child_checkThreadListReplies56615?0;
...
proctype checkThreadListReplies5661(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	int var_u_Threadsu_Threads = -2; // opt var_u_Threadsu_Threads
	goto stop_process;
	stop_process: skip;
	child!0
}
