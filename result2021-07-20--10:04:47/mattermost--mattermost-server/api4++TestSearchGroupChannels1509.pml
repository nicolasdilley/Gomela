...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L1509
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSearchGroupChannels15090 = [1] of {int};
	run TestSearchGroupChannels1509(child_TestSearchGroupChannels15090);
	run receiver(child_TestSearchGroupChannels15090)
stop_process:skip
}

proctype TestSearchGroupChannels1509(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
