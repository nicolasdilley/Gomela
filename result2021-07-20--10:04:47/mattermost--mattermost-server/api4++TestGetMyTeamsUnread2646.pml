...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L2646
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetMyTeamsUnread26460 = [1] of {int};
	run TestGetMyTeamsUnread2646(child_TestGetMyTeamsUnread26460);
	run receiver(child_TestGetMyTeamsUnread26460)
stop_process:skip
}

proctype TestGetMyTeamsUnread2646(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
