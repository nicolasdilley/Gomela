...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L4166
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestRootMentionsCount41660 = [1] of {int};
	run TestRootMentionsCount4166(child_TestRootMentionsCount41660);
	run receiver(child_TestRootMentionsCount41660)
stop_process:skip
}

proctype TestRootMentionsCount4166(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
