...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/web/oauth_test.go#L137
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestNilAuthorizeOAuthApp1370 = [1] of {int};
	run TestNilAuthorizeOAuthApp137(child_TestNilAuthorizeOAuthApp1370);
	run receiver(child_TestNilAuthorizeOAuthApp1370)
stop_process:skip
}

proctype TestNilAuthorizeOAuthApp137(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
