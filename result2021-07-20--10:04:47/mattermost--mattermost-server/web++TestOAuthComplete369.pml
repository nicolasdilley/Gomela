...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/web/oauth_test.go#L369
#define not_found_428  -2 // opt data line 694
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestOAuthComplete3690 = [1] of {int};
	run TestOAuthComplete369(child_TestOAuthComplete3690);
	run receiver(child_TestOAuthComplete3690)
stop_process:skip
}

proctype TestOAuthComplete369(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	child_AddPermissionToRole7525?0;
		defer2: skip;
	run RestoreDefaultRolePermissions694(th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,not_found_428,child_RestoreDefaultRolePermissions6943);
