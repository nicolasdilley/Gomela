...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L2170
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestAddTeamMembersDomainConstrained21700 = [1] of {int};
	run TestAddTeamMembersDomainConstrained2170(child_TestAddTeamMembersDomainConstrained21700);
	run receiver(child_TestAddTeamMembersDomainConstrained21700)
stop_process:skip
}

proctype TestAddTeamMembersDomainConstrained2170(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
