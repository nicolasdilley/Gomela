...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/cmd/mattermost/commands/cmdtestlib.go#L62
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_SetupWithStoreMock620 = [1] of {int};
	run SetupWithStoreMock62(child_SetupWithStoreMock620);
	run receiver(child_SetupWithStoreMock620)
stop_process:skip
}

proctype SetupWithStoreMock62(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
