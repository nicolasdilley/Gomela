...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L1679
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTeamMember16790 = [1] of {int};
	run TestGetTeamMember1679(child_TestGetTeamMember16790);
	run receiver(child_TestGetTeamMember16790)
stop_process:skip
}

proctype TestGetTeamMember1679(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
