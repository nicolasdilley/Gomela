...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/system_test.go#L696
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestServerBusy5036960 = [1] of {int};
	run TestServerBusy503696(child_TestServerBusy5036960);
	run receiver(child_TestServerBusy5036960)
stop_process:skip
}

proctype TestServerBusy503696(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
