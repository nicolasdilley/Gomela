...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/post_test.go#L966
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestPinPost9660 = [1] of {int};
	run TestPinPost966(child_TestPinPost9660);
	run receiver(child_TestPinPost9660)
stop_process:skip
}

proctype TestPinPost966(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
