...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2454
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUsersNotInTeam24540 = [1] of {int};
	run TestGetUsersNotInTeam2454(child_TestGetUsersNotInTeam24540);
	run receiver(child_TestGetUsersNotInTeam24540)
stop_process:skip
}

proctype TestGetUsersNotInTeam2454(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
