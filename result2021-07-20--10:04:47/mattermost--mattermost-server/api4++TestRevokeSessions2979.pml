...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2979
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestRevokeSessions29790 = [1] of {int};
	run TestRevokeSessions2979(child_TestRevokeSessions29790);
	run receiver(child_TestRevokeSessions29790)
stop_process:skip
}

proctype TestRevokeSessions2979(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_sessionssessions = -2; // opt var_sessionssessions
