...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/post_test.go#L2550
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestMarkUnreadCausesAutofollow25500 = [1] of {int};
	run TestMarkUnreadCausesAutofollow2550(child_TestMarkUnreadCausesAutofollow25500);
	run receiver(child_TestMarkUnreadCausesAutofollow25500)
stop_process:skip
}

proctype TestMarkUnreadCausesAutofollow2550(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
