...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/emoji_test.go#L478
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetEmojiImage4780 = [1] of {int};
	run TestGetEmojiImage478(child_TestGetEmojiImage4780);
	run receiver(child_TestGetEmojiImage4780)
stop_process:skip
}

proctype TestGetEmojiImage478(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
