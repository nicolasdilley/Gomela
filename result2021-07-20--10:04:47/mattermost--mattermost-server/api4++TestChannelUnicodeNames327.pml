...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L327
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestChannelUnicodeNames3270 = [1] of {int};
	run TestChannelUnicodeNames327(child_TestChannelUnicodeNames3270);
	run receiver(child_TestChannelUnicodeNames3270)
stop_process:skip
}

proctype TestChannelUnicodeNames327(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
