...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/scheme_test.go#L765
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateTeamSchemeWithTeamMembers7650 = [1] of {int};
	run TestUpdateTeamSchemeWithTeamMembers765(child_TestUpdateTeamSchemeWithTeamMembers7650);
	run receiver(child_TestUpdateTeamSchemeWithTeamMembers7650)
stop_process:skip
}

proctype TestUpdateTeamSchemeWithTeamMembers765(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
