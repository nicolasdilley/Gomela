...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L1199
#define not_found_1254  -2 // opt data line 1132
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSearchArchivedChannels11990 = [1] of {int};
	run TestSearchArchivedChannels1199(child_TestSearchArchivedChannels11990);
	run receiver(child_TestSearchArchivedChannels11990)
stop_process:skip
}

proctype TestSearchArchivedChannels1199(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_channelListchannelList = -2; // opt var_channelListchannelList
	...
	child_RemovePermissionFromRole11583?0;
		defer2: skip;
	run RestoreDefaultRolePermissions1132(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,not_found_1254,child_RestoreDefaultRolePermissions11322);
