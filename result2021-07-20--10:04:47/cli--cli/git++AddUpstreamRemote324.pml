...
#define var_branches  -2 // opt branches line 324
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run AddUpstreamRemote324(var_branches,child_AddUpstreamRemote3240);
	run receiver(child_AddUpstreamRemote3240)
stop_process:skip
}

proctype AddUpstreamRemote324(int branches;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
