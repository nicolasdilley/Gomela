...
proctype TestForwardAuthRemoveHopByHopHeaders143(chan child) {
	...
	int var_forward_HopHeadersforward_HopHeaders = -2; // opt var_forward_HopHeadersforward_HopHeaders
	int var_hopHeadershopHeaders = -2; // opt var_hopHeadershopHeaders
