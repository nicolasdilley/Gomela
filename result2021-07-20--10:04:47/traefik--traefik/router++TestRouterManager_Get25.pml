...
// git_link=https://github.com/traefik/traefik/blob/080cf98e512f6fcb93838de76a6aa34ff147dee4/pkg/server/router/router_test.go#L25
typedef Wgdef {
...
init { 
	chan child_TestRouterManager_Get250 = [1] of {int};
	run TestRouterManager_Get25(child_TestRouterManager_Get250);
	run receiver(child_TestRouterManager_Get250)
stop_process:skip
}

proctype TestRouterManager_Get25(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
