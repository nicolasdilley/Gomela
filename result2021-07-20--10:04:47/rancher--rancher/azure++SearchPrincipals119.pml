...
// git_link=https://github.com/rancher/rancher/blob/91a6f51f259acd5670ff167d6bcf1916da7406f1/pkg/auth/providers/azure/azure_provider.go#L119
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_SearchPrincipals1190)
stop_process:skip
}
...
proctype searchUsers314(Mutexdef client_servicePrincipal_refreshLock;chan child) {
	...
	bool state;
	int num_msgs;
	int var_users_Values__users_Values__ = -2; // opt var_users_Values__users_Values__
...
proctype searchGroups330(Mutexdef client_servicePrincipal_refreshLock;chan child) {
	...
	bool state;
	int num_msgs;
	int var_groups_Values__groups_Values__ = -2; // opt var_groups_Values__groups_Values__
