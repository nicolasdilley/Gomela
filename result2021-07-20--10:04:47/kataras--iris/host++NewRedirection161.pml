...
// git_link=https://github.com/kataras/iris/blob/fa175eb84754a45baecc4cd0044249fad05dfe1e/core/host/proxy.go#L161
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_NewRedirection1610 = [1] of {int};
	run NewRedirection161(child_NewRedirection1610);
	run receiver(child_NewRedirection1610)
stop_process:skip
}

proctype NewRedirection161(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
