...
proctype TestTableManager_QueryPages39(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_TestMultiTableQuery800 = [1] of {int};
	...
	run TestMultiTableQuery80(tableManager_wg,tableManager_tablesMtx,child_TestMultiTableQuery800);
	child_TestMultiTableQuery800?0;
	stop_process: skip;
	child!0
}
proctype TestMultiTableQuery80(Wgdef querier_wg;Mutexdef querier_tablesMtx;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
