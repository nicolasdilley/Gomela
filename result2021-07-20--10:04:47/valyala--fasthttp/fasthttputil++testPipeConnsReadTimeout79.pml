...
// git_link=https://github.com/valyala/fasthttp/blob/19fcd408632d6dae8425ae95c6c62a25c823ff81/fasthttputil/pipeconns_test.go#L79
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_testPipeConnsReadTimeout790 = [1] of {int};
	run testPipeConnsReadTimeout79(child_testPipeConnsReadTimeout790);
	run receiver(child_testPipeConnsReadTimeout790)
stop_process:skip
}

proctype testPipeConnsReadTimeout79(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
