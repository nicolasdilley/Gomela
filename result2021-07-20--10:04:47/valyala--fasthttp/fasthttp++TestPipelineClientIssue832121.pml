...
#define var_attempts143  ?? // mand attempts line 143
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype AnonymousTestPipelineClientIssue832142124(Mutexdef ln_lock;Mutexdef client_TLSConfig_mutex;Mutexdef client_connClientsLock;chan child) {
	...
	chan child_Accept14800 = [1] of {int};
	int var_attempts = var_attempts143; // mand var_attempts
		for(i : 0.. var_attempts-1) {
		for10: skip;
		run Accept1480(ln_lock,child_Accept14800);
		child_Accept14800?0;
