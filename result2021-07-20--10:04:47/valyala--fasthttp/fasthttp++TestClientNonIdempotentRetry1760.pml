...
// git_link=https://github.com/valyala/fasthttp/blob/19fcd408632d6dae8425ae95c6c62a25c823ff81/client_test.go#L1760
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestClientNonIdempotentRetry17600)
stop_process:skip
}
...
proctype TestClientNonIdempotentRetry1760(chan child) {
	...
	child_Post3480?0;
	run Get310(c_mLock,c_TLSConfig_mutex,child_Get3101);
	child_Get3101?0;
	stop_process: skip;
	child!0
}
