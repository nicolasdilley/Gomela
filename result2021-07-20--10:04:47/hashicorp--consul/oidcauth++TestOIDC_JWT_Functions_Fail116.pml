...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/internal/go-sso/oidcauth/oidc_test.go#L116
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestOIDC_JWT_Functions_Fail1160)
stop_process:skip
}
...
proctype verifyVanillaJWT68(Mutexdef a_l;chan child) {
	...
	bool state;
	int num_msgs;
	int var_a_parsedJWTPubKeysa_parsedJWTPubKeys = -2; // opt var_a_parsedJWTPubKeysa_parsedJWTPubKeys
