...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/agent/rpc/subscribe/subscribe_test.go#L1020
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_newEventFromSubscription10200)
stop_process:skip
}
