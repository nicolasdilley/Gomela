...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/agent/pool/peek_test.go#L94
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype testPeekForTLS_withTLS94(chan child) {
	...
	run AnonymoustestPeekForTLS_withTLS112112(serverErrCh_ch,clientErrCh_ch,child_AnonymoustestPeekForTLS_withTLS1121120);
...
proctype AnonymoustestPeekForTLS_withTLS112112(Chandef serverErrCh_ch;Chandef clientErrCh_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	:: clientErrCh_ch.sync!false -> 
		...
		defer1: skip;
	run Close35(tlsConn_config_mutex,tlsConn_handshakeMutex,child_Close350);
	child_Close350?0;
	stop_process: skip;
	child!0
}
proctype Close35(Mutexdef sc_config_mutex;Mutexdef sc_handshakeMutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
