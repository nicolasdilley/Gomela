...
// git_link=https://github.com/gohugoio/hugo/blob/64f88f3011de5a510d8e6d6bad8ac4a091b11c0c/common/maps/scratch_test.go#L191
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestScratchGetSortedMapValues1910)
stop_process:skip
}
...
proctype GetSortedMapValues133(Mutexdef c_mu;chan child) {
	...
	int var_unsortedMapunsortedMap = -2; // opt var_unsortedMapunsortedMap
	c_mu.RLock!false;
