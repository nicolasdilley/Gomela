...
proctype DiscoverWithTimeout35(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousDiscoverWithTimeout63373 = [1] of {int};
	...
	run AnonymousDiscoverWithTimeout6337(done_ch,plat_ch,wg,child_AnonymousDiscoverWithTimeout63373);
	run receiver(child_AnonymousDiscoverWithTimeout63373);
	do
...
proctype AnonymousDiscoverWithTimeout6337(Chandef done_ch;Chandef plat_ch;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
