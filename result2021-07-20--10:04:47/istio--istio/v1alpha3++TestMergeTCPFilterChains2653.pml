...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/pilot/pkg/networking/core/v1alpha3/listener_test.go#L2653
#define not_found_2758  -2 // opt incoming line 1577
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestMergeTCPFilterChains26530 = [1] of {int};
	run TestMergeTCPFilterChains2653(child_TestMergeTCPFilterChains26530);
	run receiver(child_TestMergeTCPFilterChains26530)
stop_process:skip
}

proctype TestMergeTCPFilterChains2653(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run mergeTCPFilterChains1577(opts_push_initializeMutex,opts_push_networksMu,opts_push_proxyStatusMutex,opts_service_Mutex,not_found_2758,child_mergeTCPFilterChains15770);
...
proctype mergeTCPFilterChains1577(Mutexdef listenerOpts_push_initializeMutex;Mutexdef listenerOpts_push_networksMu;Mutexdef listenerOpts_push_proxyStatusMutex;Mutexdef listenerOpts_service_Mutex;int incoming;chan child) {
	...
	bool state;
	int num_msgs;
	int var_mergedFilterChainsmergedFilterChains = -2; // opt var_mergedFilterChainsmergedFilterChains
	goto stop_process;
	stop_process: skip;
	child!0
}
