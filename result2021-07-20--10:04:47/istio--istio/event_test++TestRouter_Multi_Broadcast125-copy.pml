...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/pkg/config/event/router_test.go#L125
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouter_Multi_Broadcast1250 = [1] of {int};
	run TestRouter_Multi_Broadcast125(child_TestRouter_Multi_Broadcast1250);
	run receiver(child_TestRouter_Multi_Broadcast1250)
stop_process:skip
}

proctype TestRouter_Multi_Broadcast125(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
