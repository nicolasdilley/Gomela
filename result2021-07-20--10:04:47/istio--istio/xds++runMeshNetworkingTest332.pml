...
proctype runMeshNetworkingTest332(chan child) {
	...
	int var_tt_workloadstt_workloads = -2; // opt var_tt_workloadstt_workloads
	int var_tt_kubeObjectstt_kubeObjects = -2; // opt var_tt_kubeObjectstt_kubeObjects
...
proctype Test393(Mutexdef s_Discovery_adsClientsMutex;Mutexdef s_Discovery_mutex;Mutexdef s_Discovery_updateMutex;Mutexdef s_Listener_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_w_expectationsw_expectations = -2; // opt var_w_expectationsw_expectations
