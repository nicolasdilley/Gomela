...
#define var_nestedScopes  3 // mand nestedScopes line 418
#define not_found_424  -2 // opt scopes line 424
typedef Wgdef {
...
init { 
	...
	run AssignNamesByScope418(var_nestedScopes,child_AssignNamesByScope4180);
