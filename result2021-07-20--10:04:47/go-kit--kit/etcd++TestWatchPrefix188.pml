...
proctype TestWatchPrefix188(chan child) {
	...
	run AnonymousTestWatchPrefix195189(err_ch,event_ch,watchPrefixReturned_ch,ch_ch,child_AnonymousTestWatchPrefix1951891);
...
proctype AnonymousTestWatchPrefix195189(Chandef err_ch;Chandef event_ch;Chandef watchPrefixReturned_ch;Chandef ch_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
