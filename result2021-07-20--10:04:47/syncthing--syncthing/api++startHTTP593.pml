...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/api/api_test.go#L593
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_startHTTP5930 = [1] of {int};
	run startHTTP593(child_startHTTP5930);
	run receiver(child_startHTTP5930)
stop_process:skip
}

proctype startHTTP593(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	Mutexdef m_getMtimeMappingMutex;
	...
	run mutexMonitor(m_getMtimeMappingMutex);
	...
	run New49(m_addConnectionMutex,m_availabilityMutex,m_bringToFrontMutex,m_closedMutex,m_clusterConfigMutex,m_completionMutex,m_connectionMutex,m_connectionStatsMutex,m_currentFolderFileMutex,m_currentGlobalFileMutex,m_currentIgnoresMutex,m_dBSnapshotMutex,m_delayScanMutex,m_deviceStatisticsMutex,m_downloadProgressMutex,m_folderErrorsMutex,m_folderProgressBytesCompletedMutex,m_folderStatisticsMutex,m_getFolderVersionsMutex,m_getHelloMutex,m_getMtimeMappingMutex,m_globalDirectoryTreeMutex,m_indexMutex,m_indexUpdateMutex,m_invocationsMutex,m_loadIgnoresMutex,m_localChangedFolderFilesMutex,m_needFolderFilesMutex,m_numConnectionsMutex,m_onHelloMutex,m_overrideMutex,m_pendingDevicesMutex,m_pendingFoldersMutex,m_remoteNeedFolderFilesMutex,m_requestMutex,m_resetFolderMutex,m_restoreFolderVersionsMutex,m_revertMutex,m_scanFolderMutex,m_scanFolderSubdirsMutex,m_scanFoldersMutex,m_serveMutex,m_setIgnoresMutex,m_startDeadlockDetectorMutex,m_stateMutex,m_usageReportingStatsMutex,m_watchErrorMutex,connections_allAddressesMutex,connections_connectionStatusMutex,connections_externalAddressesMutex,connections_invocationsMutex,connections_listenerStatusMutex,connections_nATTypeMutex,connections_serveMutex,child_New490);
	child_New490?0;
