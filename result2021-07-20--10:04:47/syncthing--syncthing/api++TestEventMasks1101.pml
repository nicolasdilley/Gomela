...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/api/api_test.go#L1101
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEventMasks11010 = [1] of {int};
	run TestEventMasks1101(child_TestEventMasks11010);
	run receiver(child_TestEventMasks11010)
stop_process:skip
}

proctype TestEventMasks1101(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run New103(cfg_configPathMutex,cfg_defaultDeviceMutex,cfg_defaultFolderMutex,cfg_deviceListMutex,cfg_deviceMutex,cfg_devicesMutex,cfg_folderListMutex,cfg_folderMutex,cfg_folderPasswordsMutex,cfg_foldersMutex,cfg_gUIMutex,cfg_ignoredDeviceMutex,cfg_ignoredDevicesMutex,cfg_ignoredFolderMutex,cfg_invocationsMutex,cfg_lDAPMutex,cfg_modifyMutex,cfg_myIDMutex,cfg_optionsMutex,cfg_rawCopyMutex,cfg_removeDeviceMutex,cfg_removeFolderMutex,cfg_requiresRestartMutex,cfg_saveMutex,cfg_serveMutex,cfg_subscribeMutex,cfg_unsubscribeMutex,defSub_invocationsMutex,defSub_maskMutex,defSub_sinceMutex,defSub_invocationsMutex,defSub_maskMutex,defSub_sinceMutex,child_New1030);
	child_New1030?0;
	stop_process: skip;
	child!0
}
proctype New103(Mutexdef cfg_configPathMutex;Mutexdef cfg_defaultDeviceMutex;Mutexdef cfg_defaultFolderMutex;Mutexdef cfg_deviceListMutex;Mutexdef cfg_deviceMutex;Mutexdef cfg_devicesMutex;Mutexdef cfg_folderListMutex;Mutexdef cfg_folderMutex;Mutexdef cfg_folderPasswordsMutex;Mutexdef cfg_foldersMutex;Mutexdef cfg_gUIMutex;Mutexdef cfg_ignoredDeviceMutex;Mutexdef cfg_ignoredDevicesMutex;Mutexdef cfg_ignoredFolderMutex;Mutexdef cfg_invocationsMutex;Mutexdef cfg_lDAPMutex;Mutexdef cfg_modifyMutex;Mutexdef cfg_myIDMutex;Mutexdef cfg_optionsMutex;Mutexdef cfg_rawCopyMutex;Mutexdef cfg_removeDeviceMutex;Mutexdef cfg_removeFolderMutex;Mutexdef cfg_requiresRestartMutex;Mutexdef cfg_saveMutex;Mutexdef cfg_serveMutex;Mutexdef cfg_subscribeMutex;Mutexdef cfg_unsubscribeMutex;Mutexdef defaultSub_invocationsMutex;Mutexdef defaultSub_maskMutex;Mutexdef defaultSub_sinceMutex;Mutexdef diskSub_invocationsMutex;Mutexdef diskSub_maskMutex;Mutexdef diskSub_sinceMutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
