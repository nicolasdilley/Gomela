...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/model/requests_test.go#L689
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRequestRemoteRenameChanged689(chan child) {
	...
	Chandef received_ch;
	Mutexdef fc_mut;
	int var_fc_filesfc_files = -2; // opt var_fc_filesfc_files
	int var_fsfs = -2; // opt var_fsfs
