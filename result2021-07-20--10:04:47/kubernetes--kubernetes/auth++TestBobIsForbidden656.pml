...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/auth_test.go#L656
typedef Wgdef {
...
init { 
	chan child_TestBobIsForbidden6560 = [1] of {int};
	run TestBobIsForbidden656(child_TestBobIsForbidden6560);
	run receiver(child_TestBobIsForbidden6560)
stop_process:skip
}

proctype TestBobIsForbidden656(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
