...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/scheduler/priorities_test.go#L238
typedef Wgdef {
...
init { 
	chan child_TestImageLocality2380 = [1] of {int};
	run TestImageLocality238(child_TestImageLocality2380);
	run receiver(child_TestImageLocality2380)
stop_process:skip
}

proctype TestImageLocality238(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
