...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/auth_test.go#L538
typedef Wgdef {
...
init { 
	chan child_TestAuthModeAlwaysDeny5380 = [1] of {int};
	run TestAuthModeAlwaysDeny538(child_TestAuthModeAlwaysDeny5380);
	run receiver(child_TestAuthModeAlwaysDeny5380)
stop_process:skip
}

proctype TestAuthModeAlwaysDeny538(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
