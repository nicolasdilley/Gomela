...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/dockershim/docker_service_test.go#L153
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestVersion1530)
stop_process:skip
}
...
proctype TestVersion153(chan child) {
	...
	run getDockerVersion341(ds_cleanupInfosLock,ds_network_podsLock,ds_networkReadyLock,child_getDockerVersion3410);
