...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/util/goroutinemap/goroutinemap_test.go#L422
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run receiver(child_Test_NewGoRoutineMap_Positive_WaitWithExpBackoff4220)
stop_process:skip
}
...
proctype Test_NewGoRoutineMap_Positive_WaitWithExpBackoff422(chan child) {
	...
	chan child_AnonymousTest_NewGoRoutineMap_Positive_WaitWithExpBackoff4364351 = [1] of {int};
	...
	run AnonymousTest_NewGoRoutineMap_Positive_WaitWithExpBackoff436435(waitDoneCh_ch,operation1DoneCh_ch,child_AnonymousTest_NewGoRoutineMap_Positive_WaitWithExpBackoff4364351);
	run receiver(child_AnonymousTest_NewGoRoutineMap_Positive_WaitWithExpBackoff4364351);
...
proctype AnonymousTest_NewGoRoutineMap_Positive_WaitWithExpBackoff436435(Chandef waitDoneCh_ch;Chandef operation1DoneCh_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
