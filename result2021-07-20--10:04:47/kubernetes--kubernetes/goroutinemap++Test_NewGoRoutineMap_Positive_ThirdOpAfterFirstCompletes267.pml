...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/util/goroutinemap/goroutinemap_test.go#L267
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run receiver(child_Test_NewGoRoutineMap_Positive_ThirdOpAfterFirstCompletes2670)
stop_process:skip
}
