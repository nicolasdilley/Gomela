...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/auth_test.go#L971
typedef Wgdef {
...
init { 
	chan child_TestNamespaceAuthorization9710 = [1] of {int};
	run TestNamespaceAuthorization971(child_TestNamespaceAuthorization9710);
	run receiver(child_TestNamespaceAuthorization9710)
stop_process:skip
}

proctype TestNamespaceAuthorization971(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
