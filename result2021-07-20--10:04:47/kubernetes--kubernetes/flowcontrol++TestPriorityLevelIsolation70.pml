...
#define var_concurrencyShares110  ?? // mand concurrencyShares line 110
#define var_queueLength110  ?? // mand queueLength line 110
...
proctype TestPriorityLevelIsolation70(chan child) {
	...
	int var_queueLength = var_queueLength110; // mand var_queueLength
	int var_concurrencyShares = var_concurrencyShares110; // mand var_concurrencyShares
...
proctype streamRequests315(Chandef stopCh_ch;int parallel;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
