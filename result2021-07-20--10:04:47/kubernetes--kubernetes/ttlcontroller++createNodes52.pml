...
#define var_endIndex  ?? // mand endIndex line 52
#define var_startIndex  ?? // mand startIndex line 52
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run createNodes52(var_endIndex,var_startIndex,child_createNodes520);
