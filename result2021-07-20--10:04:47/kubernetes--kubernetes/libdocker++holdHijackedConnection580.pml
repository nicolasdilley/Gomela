...
proctype holdHijackedConnection580(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousholdHijackedConnection5895881 = [1] of {int};
	...
	run AnonymousholdHijackedConnection589588(stdinDone_ch,receiveStdout_ch,child_AnonymousholdHijackedConnection5895881);
	run receiver(child_AnonymousholdHijackedConnection5895881);
	do
...
proctype AnonymousholdHijackedConnection589588(Chandef stdinDone_ch;Chandef receiveStdout_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	stdinDone_ch.closing!true;
	stop_process: skip;
	child!0
}
