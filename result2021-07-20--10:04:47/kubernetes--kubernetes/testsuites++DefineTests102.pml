...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/e2e/storage/testsuites/snapshottable.go#L102
typedef Wgdef {
...
init { 
	...
	run receiver(child_DefineTests1020)
stop_process:skip
}
...
proctype DefineTests102(chan child) {
	...
	int var_cleanupStepscleanupSteps = -2; // opt var_cleanupStepscleanupSteps
	int var_volumesInUsevolumesInUse = -2; // opt var_volumesInUsevolumesInUse
