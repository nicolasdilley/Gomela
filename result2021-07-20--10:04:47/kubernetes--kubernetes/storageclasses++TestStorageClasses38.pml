...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/storageclasses/storage_classes_test.go#L38
typedef Wgdef {
...
init { 
	chan child_TestStorageClasses380 = [1] of {int};
	run TestStorageClasses38(child_TestStorageClasses380);
	run receiver(child_TestStorageClasses380)
stop_process:skip
}

proctype TestStorageClasses38(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
