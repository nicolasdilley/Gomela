...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/pods/pods_test.go#L686
typedef Wgdef {
...
init { 
	chan child_TestPodEphemeralContainersDisabled6860 = [1] of {int};
	run TestPodEphemeralContainersDisabled686(child_TestPodEphemeralContainersDisabled6860);
	run receiver(child_TestPodEphemeralContainersDisabled6860)
stop_process:skip
}

proctype TestPodEphemeralContainersDisabled686(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
