...
#define var_endIndex  ?? // mand endIndex line 83
#define var_startIndex  ?? // mand startIndex line 83
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run deleteNodes83(var_endIndex,var_startIndex,child_deleteNodes830);
