...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/accessreview_test.go#L147
typedef Wgdef {
...
init { 
	chan child_TestSelfSubjectAccessReview1470 = [1] of {int};
	run TestSelfSubjectAccessReview147(child_TestSelfSubjectAccessReview1470);
	run receiver(child_TestSelfSubjectAccessReview1470)
stop_process:skip
}

proctype TestSelfSubjectAccessReview147(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
