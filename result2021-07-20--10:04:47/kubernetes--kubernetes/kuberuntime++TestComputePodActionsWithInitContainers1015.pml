...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/kuberuntime/kuberuntime_manager_test.go#L1015
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestComputePodActionsWithInitContainers10150)
stop_process:skip
}
...
proctype computePodActions516(Mutexdef m_logReduction_errorMapLock;chan child) {
	...
	int var_pod_Spec_EphemeralContainerspod_Spec_EphemeralContainers = -2; // opt var_pod_Spec_EphemeralContainerspod_Spec_EphemeralContainers
...
proctype podSandboxChanged458(Mutexdef m_logReduction_errorMapLock;chan child) {
	...
	bool state;
	int num_msgs;
	int var_podStatus_SandboxStatusespodStatus_SandboxStatuses = -2; // opt var_podStatus_SandboxStatusespodStatus_SandboxStatuses
