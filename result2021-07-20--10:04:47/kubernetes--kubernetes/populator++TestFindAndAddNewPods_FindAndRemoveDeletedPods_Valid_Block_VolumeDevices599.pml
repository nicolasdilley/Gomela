...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/volumemanager/populator/desired_state_of_world_populator_test.go#L599
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFindAndAddNewPods_FindAndRemoveDeletedPods_Valid_Block_VolumeDevices5990 = [1] of {int};
	run TestFindAndAddNewPods_FindAndRemoveDeletedPods_Valid_Block_VolumeDevices599(child_TestFindAndAddNewPods_FindAndRemoveDeletedPods_Valid_Block_VolumeDevices5990);
	run receiver(child_TestFindAndAddNewPods_FindAndRemoveDeletedPods_Valid_Block_VolumeDevices5990)
stop_process:skip
}

proctype TestFindAndAddNewPods_FindAndRemoveDeletedPods_Valid_Block_VolumeDevices599(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_volumesToMountvolumesToMount = -2; // opt var_volumesToMountvolumesToMount
