...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/volumemanager/populator/desired_state_of_world_populator_test.go#L158
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFindAndAddNewPods_FindAndRemoveDeletedPods1580 = [1] of {int};
	run TestFindAndAddNewPods_FindAndRemoveDeletedPods158(child_TestFindAndAddNewPods_FindAndRemoveDeletedPods1580);
	run receiver(child_TestFindAndAddNewPods_FindAndRemoveDeletedPods1580)
stop_process:skip
}

proctype TestFindAndAddNewPods_FindAndRemoveDeletedPods158(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
