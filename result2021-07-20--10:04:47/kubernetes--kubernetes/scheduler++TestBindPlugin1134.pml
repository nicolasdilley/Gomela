...
#define var_tests1225  ?? // mand tests line 1225
typedef Wgdef {
...
proctype TestBindPlugin1134(chan child) {
	...
	int var_test_expectInvokeEventstest_expectInvokeEvents = -2; // opt var_test_expectInvokeEventstest_expectInvokeEvents
	int var_tests = var_tests1225; // mand var_tests
