...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/auth_test.go#L762
typedef Wgdef {
...
init { 
	chan child_TestImpersonateIsForbidden7620 = [1] of {int};
	run TestImpersonateIsForbidden762(child_TestImpersonateIsForbidden7620);
	run receiver(child_TestImpersonateIsForbidden7620)
stop_process:skip
}

proctype TestImpersonateIsForbidden762(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
