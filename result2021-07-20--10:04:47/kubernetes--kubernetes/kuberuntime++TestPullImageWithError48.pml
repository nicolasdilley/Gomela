...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/kuberuntime/kuberuntime_image_test.go#L48
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPullImageWithError480 = [1] of {int};
	run TestPullImageWithError48(child_TestPullImageWithError480);
	run receiver(child_TestPullImageWithError480)
stop_process:skip
}

proctype TestPullImageWithError48(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
