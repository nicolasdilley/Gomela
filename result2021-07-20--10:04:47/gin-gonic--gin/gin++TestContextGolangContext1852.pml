...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1852
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextGolangContext18520 = [1] of {int};
	run TestContextGolangContext1852(child_TestContextGolangContext18520);
	run receiver(child_TestContextGolangContext18520)
stop_process:skip
}

proctype TestContextGolangContext1852(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
