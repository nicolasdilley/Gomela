...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1604
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextBindWithYAML16040 = [1] of {int};
	run TestContextBindWithYAML1604(child_TestContextBindWithYAML16040);
	run receiver(child_TestContextBindWithYAML16040)
stop_process:skip
}

proctype TestContextBindWithYAML1604(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
