...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1588
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextBindWithQuery15880 = [1] of {int};
	run TestContextBindWithQuery1588(child_TestContextBindWithQuery15880);
	run receiver(child_TestContextBindWithQuery15880)
stop_process:skip
}

proctype TestContextBindWithQuery1588(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
