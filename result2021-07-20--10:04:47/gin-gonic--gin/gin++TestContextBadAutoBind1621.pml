...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1621
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextBadAutoBind16210 = [1] of {int};
	run TestContextBadAutoBind1621(child_TestContextBadAutoBind16210);
	run receiver(child_TestContextBadAutoBind16210)
stop_process:skip
}

proctype TestContextBadAutoBind1621(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
