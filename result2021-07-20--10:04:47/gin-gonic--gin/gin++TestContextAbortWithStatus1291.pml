...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1291
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextAbortWithStatus12910 = [1] of {int};
	run TestContextAbortWithStatus1291(child_TestContextAbortWithStatus12910);
	run receiver(child_TestContextAbortWithStatus12910)
stop_process:skip
}

proctype TestContextAbortWithStatus1291(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
