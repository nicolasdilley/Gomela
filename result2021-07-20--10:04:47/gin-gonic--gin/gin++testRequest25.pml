...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/gin_integration_test.go#L25
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_testRequest250 = [1] of {int};
	run testRequest25(child_testRequest250);
	run receiver(child_testRequest250)
stop_process:skip
}

proctype testRequest25(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
