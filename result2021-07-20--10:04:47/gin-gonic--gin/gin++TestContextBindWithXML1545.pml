...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1545
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextBindWithXML15450 = [1] of {int};
	run TestContextBindWithXML1545(child_TestContextBindWithXML15450);
	run receiver(child_TestContextBindWithXML15450)
stop_process:skip
}

proctype TestContextBindWithXML1545(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
