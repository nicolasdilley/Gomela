...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1514
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextAutoBindJSON15140 = [1] of {int};
	run TestContextAutoBindJSON1514(child_TestContextAutoBindJSON15140);
	run receiver(child_TestContextAutoBindJSON15140)
stop_process:skip
}

proctype TestContextAutoBindJSON1514(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
