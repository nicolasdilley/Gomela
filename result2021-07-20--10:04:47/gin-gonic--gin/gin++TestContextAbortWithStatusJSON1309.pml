...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1309
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextAbortWithStatusJSON13090 = [1] of {int};
	run TestContextAbortWithStatusJSON1309(child_TestContextAbortWithStatusJSON13090);
	run receiver(child_TestContextAbortWithStatusJSON13090)
stop_process:skip
}

proctype TestContextAbortWithStatusJSON1309(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
