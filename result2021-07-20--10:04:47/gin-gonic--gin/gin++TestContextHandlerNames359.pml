...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L359
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype HandlerNames133(Mutexdef c_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_handlersc_handlers = -2; // opt var_c_handlersc_handlers
	goto stop_process;
	stop_process: skip;
	child!0
}
