...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1091
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextHeaders10910 = [1] of {int};
	run TestContextHeaders1091(child_TestContextHeaders10910);
	run receiver(child_TestContextHeaders10910)
stop_process:skip
}

proctype TestContextHeaders1091(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
