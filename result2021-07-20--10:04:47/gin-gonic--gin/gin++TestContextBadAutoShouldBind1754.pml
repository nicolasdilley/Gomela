...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1754
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextBadAutoShouldBind17540 = [1] of {int};
	run TestContextBadAutoShouldBind1754(child_TestContextBadAutoShouldBind17540);
	run receiver(child_TestContextBadAutoShouldBind17540)
stop_process:skip
}

proctype TestContextBadAutoShouldBind1754(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
