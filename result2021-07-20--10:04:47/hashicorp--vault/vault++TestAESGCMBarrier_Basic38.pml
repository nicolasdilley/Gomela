...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/barrier_aes_gcm_test.go#L38
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype testBarrier13(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run Get812(b_cacheLock,b_l,child_Get8121);
	child_Get8121?0;
	run List896(b_cacheLock,b_l,child_List8962);
	child_List8962?0;
	run Put780(b_cacheLock,b_l,child_Put7803);
	child_Put7803?0;
	run Get812(b_cacheLock,b_l,child_Get8124);
	child_Get8124?0;
	run List896(b_cacheLock,b_l,child_List8965);
	child_List8965?0;
	run Delete882(b_cacheLock,b_l,child_Delete8826);
	child_Delete8826?0;
	run Delete882(b_cacheLock,b_l,child_Delete8827);
	child_Delete8827?0;
	run Get812(b_cacheLock,b_l,child_Get8128);
	child_Get8128?0;
	run List896(b_cacheLock,b_l,child_List8969);
	child_List8969?0;
	run Put780(b_cacheLock,b_l,child_Put78010);
	child_Put78010?0;
	run Seal534(b_cacheLock,b_l,child_Seal53411);
	child_Seal53411?0;
	run Get812(b_cacheLock,b_l,child_Get81212);
	child_Get81212?0;
	run Unseal422(b_cacheLock,b_l,child_Unseal42213);
	child_Unseal42213?0;
	run Get812(b_cacheLock,b_l,child_Get81214);
	child_Get81214?0;
	run Delete882(b_cacheLock,b_l,child_Delete88215);
	child_Delete88215?0;
	run Seal534(b_cacheLock,b_l,child_Seal53416);
	child_Seal53416?0;
	run Unseal422(b_cacheLock,b_l,child_Unseal42217);
	child_Unseal42217?0;
	stop_process: skip;
	child!0
}
proctype testInitAndUnseal139(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run Initialized127(b_cacheLock,b_l,child_Initialized1270);
	child_Initialized1270?0;
	run Sealed289(b_cacheLock,b_l,child_Sealed2891);
	child_Sealed2891?0;
	run Seal534(b_cacheLock,b_l,child_Seal5342);
	child_Seal5342?0;
	run Put780(b_cacheLock,b_l,child_Put7803);
	child_Put7803?0;
	run Get812(b_cacheLock,b_l,child_Get8124);
	child_Get8124?0;
	run Delete882(b_cacheLock,b_l,child_Delete8825);
	child_Delete8825?0;
	run List896(b_cacheLock,b_l,child_List8966);
	child_List8966?0;
	run GenerateKey274(b_cacheLock,b_l,child_GenerateKey2747);
	child_GenerateKey2747?0;
	run KeyLength283(b_cacheLock,b_l,child_KeyLength2838);
	child_KeyLength2838?0;
	run Unseal422(b_cacheLock,b_l,child_Unseal4229);
	child_Unseal4229?0;
	run Initialize153(b_cacheLock,b_l,child_Initialize15310);
	child_Initialize15310?0;
	run Initialize153(b_cacheLock,b_l,child_Initialize15311);
	child_Initialize15311?0;
	run Initialized127(b_cacheLock,b_l,child_Initialized12712);
	child_Initialized12712?0;
	run Sealed289(b_cacheLock,b_l,child_Sealed28913);
	child_Sealed28913?0;
	run Unseal422(b_cacheLock,b_l,child_Unseal42214);
	child_Unseal42214?0;
	run Unseal422(b_cacheLock,b_l,child_Unseal42215);
	child_Unseal42215?0;
	run Sealed289(b_cacheLock,b_l,child_Sealed28916);
	child_Sealed28916?0;
	run VerifyMaster297(b_cacheLock,b_l,child_VerifyMaster29717);
...
proctype Sealed289(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype putInternal798(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run encryptTracked1123(b_cacheLock,b_l,child_encryptTracked11234);
...
proctype encryptTracked1123(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run encrypt960(b_cacheLock,b_l,child_encrypt9604);
	child_encrypt9604?0;
...
proctype Get812(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run lockSwitchedGet816(b_cacheLock,b_l,child_lockSwitchedGet8164);
...
proctype lockSwitchedGet816(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run aeadForTerm909(b_cacheLock,b_l,child_aeadForTerm9094);
...
proctype List896(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype Unseal422(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run aeadFromKey944(b_cacheLock,b_l,child_aeadFromKey9449);
	...
	:: true -> 
		...
		run recoverKeyring359(b_cacheLock,b_l,child_recoverKeyring35911);
	...
	run decrypt1013(b_cacheLock,b_l,child_decrypt101312);
	...
	run persistKeyring210(b_cacheLock,b_l,child_persistKeyring21013);
...
proctype persistKeyring210(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run aeadFromKey944(b_cacheLock,b_l,child_aeadFromKey94413);
	...
	run encrypt960(b_cacheLock,b_l,child_encrypt96014);
	...
	run aeadFromKey944(b_cacheLock,b_l,child_aeadFromKey94415);
	...
	run encryptTracked1123(b_cacheLock,b_l,child_encryptTracked112316);
...
proctype Initialize153(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run KeyLength283(b_cacheLock,b_l,child_KeyLength28310);
	...
	run Initialized127(b_cacheLock,b_l,child_Initialized12711);
	...
	run GenerateKey274(b_cacheLock,b_l,child_GenerateKey27412);
	...
	:: true -> 
		...
		run putInternal798(b_cacheLock,b_l,child_putInternal79815);
