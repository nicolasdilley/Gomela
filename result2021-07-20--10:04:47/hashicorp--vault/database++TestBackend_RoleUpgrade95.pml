...
proctype TestBackend_RoleUpgrade95(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_Role1663 = [1] of {int};
	chan child_Put9232 = [1] of {int};
	chan child_Role1661 = [1] of {int};
	...
	child_Put9230?0;
	run Role166(backend_credRotationQueue_lock,storage_once_m,child_Role1661);
	child_Role1661?0;
	run Put923(storage_once_m,child_Put9232);
	child_Put9232?0;
	run Role166(backend_credRotationQueue_lock,storage_once_m,child_Role1663);
	child_Role1663?0;
	stop_process: skip;
	child!0
}
...
proctype Role166(Mutexdef b_credRotationQueue_lock;Mutexdef s_once_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_roleAtPath1741 = [1] of {int};
	run roleAtPath174(b_credRotationQueue_lock,s_once_m,child_roleAtPath1741);
	child_roleAtPath1741?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype roleAtPath174(Mutexdef b_credRotationQueue_lock;Mutexdef s_once_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
