...
proctype TestRaft_Chunking_AppliedIndex185(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_Get11856 = [1] of {int};
	chan child_Get11855 = [1] of {int};
	chan child_AppliedIndex9344 = [1] of {int};
	chan child_Put12113 = [1] of {int};
	chan child_Put12112 = [1] of {int};
	chan child_AppliedIndex9341 = [1] of {int};
	...
	child_Put12110?0;
	run AppliedIndex934(raft_autopilot_execLock,raft_autopilot_stateLock,raft_followerStates_l,raft_fsm_l,raft_l,raft_raft_confReloadMu,raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_observersLock,raft_raft_shutdownLock,raft_streamLayer_closeLock,child_AppliedIndex9341);
	child_AppliedIndex9341?0;
	...
	run AppliedIndex934(raft_autopilot_execLock,raft_autopilot_stateLock,raft_followerStates_l,raft_fsm_l,raft_l,raft_raft_confReloadMu,raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_observersLock,raft_raft_shutdownLock,raft_streamLayer_closeLock,child_AppliedIndex9344);
	child_AppliedIndex9344?0;
	...
	:: 0 != -2 && 10-1 != -3 -> 
				for(i : 0.. 10-1) {
			for21: skip;
			run Get1185(raft_autopilot_execLock,raft_autopilot_stateLock,raft_followerStates_l,raft_fsm_l,raft_l,raft_raft_confReloadMu,raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_observersLock,raft_raft_shutdownLock,raft_streamLayer_closeLock,child_Get11856);
			child_Get11856?0;
			for21_end: skip
		};
		for21_exit: skip
	:: else -> 
		...
		:: true -> 
			for20: skip;
			run Get1185(raft_autopilot_execLock,raft_autopilot_stateLock,raft_followerStates_l,raft_fsm_l,raft_l,raft_raft_confReloadMu,raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_observersLock,raft_raft_shutdownLock,raft_streamLayer_closeLock,child_Get11855);
			child_Get11855?0;
			for20_end: skip
		:: true -> 
			break
...
proctype AppliedIndex934(Mutexdef b_autopilot_execLock;Mutexdef b_autopilot_stateLock;Mutexdef b_followerStates_l;Mutexdef b_fsm_l;Mutexdef b_l;Mutexdef b_raft_confReloadMu;Mutexdef b_raft_lastContactLock;Mutexdef b_raft_leaderLock;Mutexdef b_raft_observersLock;Mutexdef b_raft_shutdownLock;Mutexdef b_streamLayer_closeLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
