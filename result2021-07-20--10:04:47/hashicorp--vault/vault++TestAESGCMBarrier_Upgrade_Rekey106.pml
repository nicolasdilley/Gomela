...
proctype testBarrier_Upgrade_Rekey509(Mutexdef b1_cacheLock;Mutexdef b1_l;Mutexdef b2_cacheLock;Mutexdef b2_l;chan child) {
	...
	child_Unseal4223?0;
	run GenerateKey274(b1_cacheLock,b1_l,child_GenerateKey2744);
	child_GenerateKey2744?0;
	run Rekey724(b1_cacheLock,b1_l,child_Rekey7245);
	child_Rekey7245?0;
	run ReloadMasterKey374(b2_cacheLock,b2_l,child_ReloadMasterKey3746);
	child_ReloadMasterKey3746?0;
	run ReloadKeyring312(b2_cacheLock,b2_l,child_ReloadKeyring3127);
...
proctype Rekey724(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	b_l.Lock!false;
	run updateMasterKeyCommon765(b_cacheLock,b_l,child_updateMasterKeyCommon7655);
...
proctype updateMasterKeyCommon765(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	run KeyLength283(b_cacheLock,b_l,child_KeyLength2835);
...
proctype ReloadMasterKey374(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Get812(b_cacheLock,b_l,child_Get8126);
	child_Get8126?0;
