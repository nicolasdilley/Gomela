...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/barrier_aes_gcm_test.go#L265
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestAESGCMBarrier_Integrity2650 = [1] of {int};
	run TestAESGCMBarrier_Integrity265(child_TestAESGCMBarrier_Integrity2650);
	run receiver(child_TestAESGCMBarrier_Integrity2650)
stop_process:skip
}

proctype TestAESGCMBarrier_Integrity265(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
