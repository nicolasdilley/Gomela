...
proctype TestRaft_Snapshot_Loading57(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_Snapshot7423 = [1] of {int};
	...
	:: 0 != -2 && 1000-1 != -3 -> 
				for(i : 0.. 1000-1) {
			for11: skip;
			run Put1211(raft_autopilot_execLock,raft_autopilot_stateLock,raft_followerStates_l,raft_fsm_l,raft_l,raft_raft_confReloadMu,raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_observersLock,raft_raft_shutdownLock,raft_streamLayer_closeLock,child_Put12111);
			child_Put12111?0;
			for11_end: skip
		};
		for11_exit: skip
	...
	run AnonymousTestRaft_Snapshot_Loading7558(raft_l,raft_fsm_l,raft_raft_confReloadMu,raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_shutdownLock,raft_raft_observersLock,raft_streamLayer_closeLock,raft_autopilot_stateLock,raft_autopilot_execLock,raft_followerStates_l,readCloser_p_wrMu,writeCloser_p_wrMu,metaReadCloser_p_wrMu,metaWriteCloser_p_wrMu,child_AnonymousTestRaft_Snapshot_Loading75582);
	run receiver(child_AnonymousTestRaft_Snapshot_Loading75582);
	run Snapshot742(raft_raft_confReloadMu,raft_raft_lastContactLock,raft_raft_leaderLock,raft_raft_observersLock,raft_raft_shutdownLock,child_Snapshot7423);
...
proctype writeTo698(Mutexdef f_l;Mutexdef metaSink_p_wrMu;Mutexdef sink_p_wrMu;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_CloseWithError5744 = [1] of {int};
	...
	f_l.RLock!false;
	run CloseWithError574(sink_p_wrMu,child_CloseWithError5744);
...
proctype CloseWithError574(Mutexdef d_p_wrMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
