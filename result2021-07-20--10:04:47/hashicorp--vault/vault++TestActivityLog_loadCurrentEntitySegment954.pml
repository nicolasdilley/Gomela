...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/activity_log_test.go#L954
typedef Wgdef {
...
init { 
	chan child_TestActivityLog_loadCurrentEntitySegment9540 = [1] of {int};
	run TestActivityLog_loadCurrentEntitySegment954(child_TestActivityLog_loadCurrentEntitySegment9540);
	run receiver(child_TestActivityLog_loadCurrentEntitySegment9540)
stop_process:skip
}

proctype TestActivityLog_loadCurrentEntitySegment954(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_resetEntitiesInMemory9359 = [1] of {int};
	chan child_GetActiveEntities408 = [1] of {int};
	chan child_GetCurrentEntities557 = [1] of {int};
	chan child_GetEntitySequenceNumber1806 = [1] of {int};
	chan child_GetStartTimestamp1525 = [1] of {int};
	chan child_GetCountByNamespaceID1734 = [1] of {int};
	chan child_loadCurrentEntitySegment5483 = [1] of {int};
	chan child_resetEntitiesInMemory93516 = [1] of {int};
	chan child_GetActiveEntities4015 = [1] of {int};
	chan child_GetCurrentEntities5514 = [1] of {int};
	chan child_GetEntitySequenceNumber18013 = [1] of {int};
	chan child_GetStartTimestamp15212 = [1] of {int};
	chan child_GetCountByNamespaceID17311 = [1] of {int};
	chan child_loadCurrentEntitySegment54810 = [1] of {int};
	chan child_WriteToStorage631 = [1] of {int};
	chan child_WriteToStorage632 = [1] of {int};
	chan child_SetTokenCount1660 = [1] of {int};
	...
	:: else -> 
		...
		:: true -> 
			for11: skip;
			run WriteToStorage63(core_rollback_inflightAll,core_activityLog_fragmentLock,core_activityLog_l,core_allLoggersLock,core_auditLock,core_authLock,core_clusterParamsLock,core_expiration_pendingLock,core_expiration_restoreModeLock,core_expiration_restoreRequestLock,core_generateRootLock,core_identityStore_groupLock,core_identityStore_lock,core_identityStore_oidcLock,core_leaderParamsLock,core_metricsMutex,core_mountsLock,core_pendingRaftPeers_mu,core_pluginCatalog_lock,core_policyStore_modifyLock,core_quotaManager_lock,core_raftFollowerStates_l,core_rekeyLock,core_reloadFuncsLock,core_requestForwardingConnectionLock,core_rollback_inflightLock,core_rollback_shutdownLock,core_router_l,core_rpcClientConn_mu,core_systemBackend_mfaLock,core_systemBarrierView_readOnlyErrLock,core_tokenStore_saltLock,core_uiConfig_l,core_unsealWithStoredKeysLock,child_WriteToStorage632);
			child_WriteToStorage632?0;
			for11_end: skip
		:: true -> 
			break
		od;
	...
	:: var_testCases-1 != -3 -> 
				for(i : 0.. var_testCases-1) {
			for20: skip;
			run loadCurrentEntitySegment548(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_loadCurrentEntitySegment5483);
			child_loadCurrentEntitySegment5483?0;
			run GetCountByNamespaceID173(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_GetCountByNamespaceID1734);
			child_GetCountByNamespaceID1734?0;
			run GetStartTimestamp152(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_GetStartTimestamp1525);
			child_GetStartTimestamp1525?0;
			run GetEntitySequenceNumber180(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_GetEntitySequenceNumber1806);
			child_GetEntitySequenceNumber1806?0;
			run GetCurrentEntities55(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_GetCurrentEntities557);
			child_GetCurrentEntities557?0;
			run GetActiveEntities40(core_rollback_inflightAll,core_activityLog_fragmentLock,core_activityLog_l,core_allLoggersLock,core_auditLock,core_authLock,core_clusterParamsLock,core_expiration_pendingLock,core_expiration_restoreModeLock,core_expiration_restoreRequestLock,core_generateRootLock,core_identityStore_groupLock,core_identityStore_lock,core_identityStore_oidcLock,core_leaderParamsLock,core_metricsMutex,core_mountsLock,core_pendingRaftPeers_mu,core_pluginCatalog_lock,core_policyStore_modifyLock,core_quotaManager_lock,core_raftFollowerStates_l,core_rekeyLock,core_reloadFuncsLock,core_requestForwardingConnectionLock,core_rollback_inflightLock,core_rollback_shutdownLock,core_router_l,core_rpcClientConn_mu,core_systemBackend_mfaLock,core_systemBarrierView_readOnlyErrLock,core_tokenStore_saltLock,core_uiConfig_l,core_unsealWithStoredKeysLock,child_GetActiveEntities408);
			child_GetActiveEntities408?0;
			run resetEntitiesInMemory935(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_resetEntitiesInMemory9359);
			child_resetEntitiesInMemory9359?0;
			for20_end: skip
		};
		for20_exit: skip
	:: else -> 
		...
		:: true -> 
			for25: skip;
			run loadCurrentEntitySegment548(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_loadCurrentEntitySegment54810);
			child_loadCurrentEntitySegment54810?0;
			run GetCountByNamespaceID173(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_GetCountByNamespaceID17311);
			child_GetCountByNamespaceID17311?0;
			run GetStartTimestamp152(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_GetStartTimestamp15212);
			child_GetStartTimestamp15212?0;
			run GetEntitySequenceNumber180(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_GetEntitySequenceNumber18013);
			child_GetEntitySequenceNumber18013?0;
			run GetCurrentEntities55(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_GetCurrentEntities5514);
			child_GetCurrentEntities5514?0;
			run GetActiveEntities40(core_rollback_inflightAll,core_activityLog_fragmentLock,core_activityLog_l,core_allLoggersLock,core_auditLock,core_authLock,core_clusterParamsLock,core_expiration_pendingLock,core_expiration_restoreModeLock,core_expiration_restoreRequestLock,core_generateRootLock,core_identityStore_groupLock,core_identityStore_lock,core_identityStore_oidcLock,core_leaderParamsLock,core_metricsMutex,core_mountsLock,core_pendingRaftPeers_mu,core_pluginCatalog_lock,core_policyStore_modifyLock,core_quotaManager_lock,core_raftFollowerStates_l,core_rekeyLock,core_reloadFuncsLock,core_requestForwardingConnectionLock,core_rollback_inflightLock,core_rollback_shutdownLock,core_router_l,core_rpcClientConn_mu,core_systemBackend_mfaLock,core_systemBarrierView_readOnlyErrLock,core_tokenStore_saltLock,core_uiConfig_l,core_unsealWithStoredKeysLock,child_GetActiveEntities4015);
			child_GetActiveEntities4015?0;
			run resetEntitiesInMemory935(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_resetEntitiesInMemory93516);
			child_resetEntitiesInMemory93516?0;
			for25_end: skip
		:: true -> 
			break
		od;
...
proctype SetTokenCount166(Mutexdef a_core_allLoggersLock;Mutexdef a_core_auditLock;Mutexdef a_core_authLock;Mutexdef a_core_clusterParamsLock;Mutexdef a_core_generateRootLock;Mutexdef a_core_leaderParamsLock;Mutexdef a_core_metricsMutex;Mutexdef a_core_mountsLock;Mutexdef a_core_rekeyLock;Mutexdef a_core_reloadFuncsLock;Mutexdef a_core_requestForwardingConnectionLock;Mutexdef a_core_unsealWithStoredKeysLock;Mutexdef a_fragmentLock;Mutexdef a_l;Mutexdef a_view_readOnlyErrLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype loadCurrentEntitySegment548(Mutexdef a_core_allLoggersLock;Mutexdef a_core_auditLock;Mutexdef a_core_authLock;Mutexdef a_core_clusterParamsLock;Mutexdef a_core_generateRootLock;Mutexdef a_core_leaderParamsLock;Mutexdef a_core_metricsMutex;Mutexdef a_core_mountsLock;Mutexdef a_core_rekeyLock;Mutexdef a_core_reloadFuncsLock;Mutexdef a_core_requestForwardingConnectionLock;Mutexdef a_core_unsealWithStoredKeysLock;Mutexdef a_fragmentLock;Mutexdef a_l;Mutexdef a_view_readOnlyErrLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Get573 = [1] of {int};
	int var_out_Entitiesout_Entities = -2; // opt var_out_Entitiesout_Entities
...
proctype GetStartTimestamp152(Mutexdef a_core_allLoggersLock;Mutexdef a_core_auditLock;Mutexdef a_core_authLock;Mutexdef a_core_clusterParamsLock;Mutexdef a_core_generateRootLock;Mutexdef a_core_leaderParamsLock;Mutexdef a_core_metricsMutex;Mutexdef a_core_mountsLock;Mutexdef a_core_rekeyLock;Mutexdef a_core_reloadFuncsLock;Mutexdef a_core_requestForwardingConnectionLock;Mutexdef a_core_unsealWithStoredKeysLock;Mutexdef a_fragmentLock;Mutexdef a_l;Mutexdef a_view_readOnlyErrLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype GetEntitySequenceNumber180(Mutexdef a_core_allLoggersLock;Mutexdef a_core_auditLock;Mutexdef a_core_authLock;Mutexdef a_core_clusterParamsLock;Mutexdef a_core_generateRootLock;Mutexdef a_core_leaderParamsLock;Mutexdef a_core_metricsMutex;Mutexdef a_core_mountsLock;Mutexdef a_core_rekeyLock;Mutexdef a_core_reloadFuncsLock;Mutexdef a_core_requestForwardingConnectionLock;Mutexdef a_core_unsealWithStoredKeysLock;Mutexdef a_fragmentLock;Mutexdef a_l;Mutexdef a_view_readOnlyErrLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype GetCurrentEntities55(Mutexdef a_core_allLoggersLock;Mutexdef a_core_auditLock;Mutexdef a_core_authLock;Mutexdef a_core_clusterParamsLock;Mutexdef a_core_generateRootLock;Mutexdef a_core_leaderParamsLock;Mutexdef a_core_metricsMutex;Mutexdef a_core_mountsLock;Mutexdef a_core_rekeyLock;Mutexdef a_core_reloadFuncsLock;Mutexdef a_core_requestForwardingConnectionLock;Mutexdef a_core_unsealWithStoredKeysLock;Mutexdef a_fragmentLock;Mutexdef a_l;Mutexdef a_view_readOnlyErrLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype GetActiveEntities40(Wgdef c_rollback_inflightAll;Mutexdef c_activityLog_fragmentLock;Mutexdef c_activityLog_l;Mutexdef c_allLoggersLock;Mutexdef c_auditLock;Mutexdef c_authLock;Mutexdef c_clusterParamsLock;Mutexdef c_expiration_pendingLock;Mutexdef c_expiration_restoreModeLock;Mutexdef c_expiration_restoreRequestLock;Mutexdef c_generateRootLock;Mutexdef c_identityStore_groupLock;Mutexdef c_identityStore_lock;Mutexdef c_identityStore_oidcLock;Mutexdef c_leaderParamsLock;Mutexdef c_metricsMutex;Mutexdef c_mountsLock;Mutexdef c_pendingRaftPeers_mu;Mutexdef c_pluginCatalog_lock;Mutexdef c_policyStore_modifyLock;Mutexdef c_quotaManager_lock;Mutexdef c_raftFollowerStates_l;Mutexdef c_rekeyLock;Mutexdef c_reloadFuncsLock;Mutexdef c_requestForwardingConnectionLock;Mutexdef c_rollback_inflightLock;Mutexdef c_rollback_shutdownLock;Mutexdef c_router_l;Mutexdef c_rpcClientConn_mu;Mutexdef c_systemBackend_mfaLock;Mutexdef c_systemBarrierView_readOnlyErrLock;Mutexdef c_tokenStore_saltLock;Mutexdef c_uiConfig_l;Mutexdef c_unsealWithStoredKeysLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	int var_c_activityLog_activeEntitiesc_activityLog_activeEntities = -2; // opt var_c_activityLog_activeEntitiesc_activityLog_activeEntities
	c_activityLog_fragmentLock.RLock!false;
	c_activityLog_fragmentLock.RUnlock!false;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype resetEntitiesInMemory935(Mutexdef a_core_allLoggersLock;Mutexdef a_core_auditLock;Mutexdef a_core_authLock;Mutexdef a_core_clusterParamsLock;Mutexdef a_core_generateRootLock;Mutexdef a_core_leaderParamsLock;Mutexdef a_core_metricsMutex;Mutexdef a_core_mountsLock;Mutexdef a_core_rekeyLock;Mutexdef a_core_reloadFuncsLock;Mutexdef a_core_requestForwardingConnectionLock;Mutexdef a_core_unsealWithStoredKeysLock;Mutexdef a_fragmentLock;Mutexdef a_l;Mutexdef a_view_readOnlyErrLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	a_l.Lock!false;
	a_fragmentLock.Lock!false;
		defer2: skip;
	a_fragmentLock.Unlock!false;
		defer1: skip;
	a_l.Unlock!false;
	stop_process: skip;
	child!0
