...
proctype TestBackend_CreateParseVerifyRoleTag29(chan child) {
	...
	run role239(b_configMutex,b_denyListMutex,b_roleMutex,storage_once_m,child_role2390);
	child_role2390?0;
	...
	run role239(b_configMutex,b_denyListMutex,b_roleMutex,storage_once_m,child_role2392);
	child_role2392?0;
	stop_process: skip;
	child!0
}
...
proctype parseAndVerifyRoleTagValue293(Mutexdef b_configMutex;Mutexdef b_denyListMutex;Mutexdef b_roleMutex;Mutexdef s_once_m;chan child) {
	...
	run role239(b_configMutex,b_denyListMutex,b_roleMutex,s_once_m,child_role2391);
	child_role2391?0;
