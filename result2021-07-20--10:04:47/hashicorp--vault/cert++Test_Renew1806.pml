...
proctype pathCertWrite270(Mutexdef b_crlUpdateMutex;chan child) {
	...
	int var_parsedL0L_ExtKeyUsageparsedL0L_ExtKeyUsage = -2; // opt var_parsedL0L_ExtKeyUsageparsedL0L_ExtKeyUsage
...
proctype verifyCredentials171(Mutexdef b_crlUpdateMutex;chan child) {
	...
	int var_trustedChainstrustedChains = -2; // opt var_trustedChainstrustedChains
	int var_trust_Certificatestrust_Certificates = -2; // opt var_trust_Certificatestrust_Certificates
	int var_trustedtrusted = -2; // opt var_trustedtrusted
	int var_trustedNonCAstrustedNonCAs = -2; // opt var_trustedNonCAstrustedNonCAs
...
proctype loadTrustedCerts413(Mutexdef b_crlUpdateMutex;chan child) {
	...
	int var_parsedparsed = -2; // opt var_parsedparsed
...
proctype checkForChainInCRLs467(Mutexdef b_crlUpdateMutex;int chain;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_findSerialInCRLs842 = [1] of {int};
	chan child_findSerialInCRLs843 = [1] of {int};
	...
	:: var_chain-1 != -3 -> 
				for(i : 0.. var_chain-1) {
			for31: skip;
			run findSerialInCRLs84(b_crlUpdateMutex,child_findSerialInCRLs842);
			child_findSerialInCRLs842?0;
	...
	:: else -> 
		...
		:: true -> 
			for34: skip;
			run findSerialInCRLs84(b_crlUpdateMutex,child_findSerialInCRLs843);
			child_findSerialInCRLs843?0;
...
proctype findSerialInCRLs84(Mutexdef b_crlUpdateMutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	int var_b_crlsb_crls = -2; // opt var_b_crlsb_crls
...
proctype matchesNames259(Mutexdef b_crlUpdateMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int var_clientCert_EmailAddressesclientCert_EmailAddresses = -2; // opt var_clientCert_EmailAddressesclientCert_EmailAddresses
	int var_clientCert_DNSNamesclientCert_DNSNames = -2; // opt var_clientCert_DNSNamesclientCert_DNSNames
	int var_config_Entry_AllowedNamesconfig_Entry_AllowedNames = -2; // opt var_config_Entry_AllowedNamesconfig_Entry_AllowedNames
...
proctype matchesCommonName288(Mutexdef b_crlUpdateMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int var_config_Entry_AllowedCommonNamesconfig_Entry_AllowedCommonNames = -2; // opt var_config_Entry_AllowedCommonNamesconfig_Entry_AllowedCommonNames
...
proctype matchesDNSSANs305(Mutexdef b_crlUpdateMutex;chan child) {
	...
	int num_msgs;
	int var_clientCert_DNSNamesclientCert_DNSNames = -2; // opt var_clientCert_DNSNamesclientCert_DNSNames
	int var_config_Entry_AllowedDNSSANsconfig_Entry_AllowedDNSSANs = -2; // opt var_config_Entry_AllowedDNSSANsconfig_Entry_AllowedDNSSANs
...
proctype matchesEmailSANs324(Mutexdef b_crlUpdateMutex;chan child) {
	...
	int num_msgs;
	int var_clientCert_EmailAddressesclientCert_EmailAddresses = -2; // opt var_clientCert_EmailAddressesclientCert_EmailAddresses
	int var_config_Entry_AllowedEmailSANsconfig_Entry_AllowedEmailSANs = -2; // opt var_config_Entry_AllowedEmailSANsconfig_Entry_AllowedEmailSANs
...
proctype matchesURISANs343(Mutexdef b_crlUpdateMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int var_clientCert_URIsclientCert_URIs = -2; // opt var_clientCert_URIsclientCert_URIs
	int var_config_Entry_AllowedURISANsconfig_Entry_AllowedURISANs = -2; // opt var_config_Entry_AllowedURISANsconfig_Entry_AllowedURISANs
...
proctype matchesOrganizationalUnits361(Mutexdef b_crlUpdateMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int var_clientCert_Subject_OrganizationalUnitclientCert_Subject_OrganizationalUnit = -2; // opt var_clientCert_Subject_OrganizationalUnitclientCert_Subject_OrganizationalUnit
	int var_config_Entry_AllowedOrganizationalUnitsconfig_Entry_AllowedOrganizationalUnits = -2; // opt var_config_Entry_AllowedOrganizationalUnitsconfig_Entry_AllowedOrganizationalUnits
...
proctype matchesCertificateExtensions381(Mutexdef b_crlUpdateMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int var_config_Entry_RequiredExtensionsconfig_Entry_RequiredExtensions = -2; // opt var_config_Entry_RequiredExtensionsconfig_Entry_RequiredExtensions
	int var_clientCert_ExtensionsclientCert_Extensions = -2; // opt var_clientCert_ExtensionsclientCert_Extensions
