...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/plugins/database/mongodb/mongodb_test.go#L366
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_createDBUser3660)
stop_process:skip
}
