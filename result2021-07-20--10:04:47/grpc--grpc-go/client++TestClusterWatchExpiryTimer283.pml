...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_cluster_test.go#L283
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestClusterWatchExpiryTimer2830 = [1] of {int};
	run TestClusterWatchExpiryTimer283(child_TestClusterWatchExpiryTimer2830);
	run receiver(child_TestClusterWatchExpiryTimer2830)
stop_process:skip
}

proctype TestClusterWatchExpiryTimer283(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
