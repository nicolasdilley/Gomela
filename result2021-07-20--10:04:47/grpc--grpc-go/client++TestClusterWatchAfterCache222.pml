...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_cluster_test.go#L222
#define not_found_249  -2 // opt updates line 178
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestClusterWatchAfterCache2220 = [1] of {int};
	run TestClusterWatchAfterCache222(child_TestClusterWatchAfterCache2220);
	run receiver(child_TestClusterWatchAfterCache2220)
stop_process:skip
}

proctype TestClusterWatchAfterCache222(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_249,child_NewClusters1782);
