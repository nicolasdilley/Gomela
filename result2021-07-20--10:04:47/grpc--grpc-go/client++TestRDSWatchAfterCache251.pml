...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_route_test.go#L251
#define not_found_285  -2 // opt updates line 136
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRDSWatchAfterCache2510 = [1] of {int};
	run TestRDSWatchAfterCache251(child_TestRDSWatchAfterCache2510);
	run receiver(child_TestRDSWatchAfterCache2510)
stop_process:skip
}

proctype TestRDSWatchAfterCache251(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewRouteConfigs136(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_285,child_NewRouteConfigs1362);
