...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/client_test.go#L154
#define not_found_189  -2 // opt updates line 178
#define not_found_195  -2 // opt updates line 178
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestWatchCallAnotherWatch1540 = [1] of {int};
	run TestWatchCallAnotherWatch154(child_TestWatchCallAnotherWatch1540);
	run receiver(child_TestWatchCallAnotherWatch1540)
stop_process:skip
}

proctype TestWatchCallAnotherWatch154(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_189,child_NewClusters1782);
	child_NewClusters1782?0;
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_195,child_NewClusters1783);
