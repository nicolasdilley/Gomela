...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_endpoints_test.go#L241
#define not_found_268  -2 // opt updates line 237
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEndpointsWatchAfterCache2410 = [1] of {int};
	run TestEndpointsWatchAfterCache241(child_TestEndpointsWatchAfterCache2410);
	run receiver(child_TestEndpointsWatchAfterCache2410)
stop_process:skip
}

proctype TestEndpointsWatchAfterCache241(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewEndpoints237(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_268,child_NewEndpoints2372);
