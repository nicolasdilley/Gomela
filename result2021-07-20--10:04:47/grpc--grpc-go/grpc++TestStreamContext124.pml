...
proctype TestStreamContext124(chan child) {
	...
	chan child_NewContextWithServerTransportStream16200 = [1] of {int};
	...
	run NewContextWithServerTransportStream1620(expectedStream_buf_mu,expectedStream_ct_mu,expectedStream_fc_mu,expectedStream_hdrMu,child_NewContextWithServerTransportStream16200);
	child_NewContextWithServerTransportStream16200?0;
...
proctype NewContextWithServerTransportStream1620(Mutexdef stream_buf_mu;Mutexdef stream_ct_mu;Mutexdef stream_fc_mu;Mutexdef stream_hdrMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
