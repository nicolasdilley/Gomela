...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_cluster_test.go#L370
#define not_found_407  -2 // opt updates line 178
#define not_found_419  -2 // opt updates line 178
#define not_found_432  -2 // opt updates line 178
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestClusterResourceRemoved3700 = [1] of {int};
	run TestClusterResourceRemoved370(child_TestClusterResourceRemoved3700);
	run receiver(child_TestClusterResourceRemoved3700)
stop_process:skip
}

proctype TestClusterResourceRemoved370(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_407,child_NewClusters1783);
	child_NewClusters1783?0;
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_419,child_NewClusters1784);
	child_NewClusters1784?0;
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_432,child_NewClusters1785);
