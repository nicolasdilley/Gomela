...
proctype performOneRPC566(chan child) {
	...
	run Write290(s_buf_mu,s_ct_mu,s_fc_mu,s_hdrMu,child_Write2900);
	child_Write2900?0;
	...
	:: true -> 
		...
		child_Read4611?0;
		run Read461(s_buf_mu,s_ct_mu,s_fc_mu,s_hdrMu,child_Read4612);
		child_Read4612?0
	:: true;
	fi;
	stop_process: skip;
...
proctype Write290(Mutexdef s_buf_mu;Mutexdef s_ct_mu;Mutexdef s_fc_mu;Mutexdef s_hdrMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_updateHeaderSent3000 = [1] of {int};
	run updateHeaderSent300(s_buf_mu,s_ct_mu,s_fc_mu,s_hdrMu,child_updateHeaderSent3000);
	child_updateHeaderSent3000?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype updateHeaderSent300(Mutexdef s_buf_mu;Mutexdef s_ct_mu;Mutexdef s_fc_mu;Mutexdef s_hdrMu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
