...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_cluster_test.go#L41
#define not_found_68  -2 // opt updates line 178
#define not_found_74  -2 // opt updates line 178
#define not_found_84  -2 // opt updates line 178
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestClusterWatch410 = [1] of {int};
	run TestClusterWatch41(child_TestClusterWatch410);
	run receiver(child_TestClusterWatch410)
stop_process:skip
}

proctype TestClusterWatch41(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_68,child_NewClusters1782);
	child_NewClusters1782?0;
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_74,child_NewClusters1783);
	child_NewClusters1783?0;
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_84,child_NewClusters1784);
