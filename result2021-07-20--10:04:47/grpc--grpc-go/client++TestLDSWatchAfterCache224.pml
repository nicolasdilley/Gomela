...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_listener_test.go#L224
#define not_found_251  -2 // opt updates line 77
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestLDSWatchAfterCache2240 = [1] of {int};
	run TestLDSWatchAfterCache224(child_TestLDSWatchAfterCache2240);
	run receiver(child_TestLDSWatchAfterCache2240)
stop_process:skip
}

proctype TestLDSWatchAfterCache224(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewListeners77(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_251,child_NewListeners772);
