...
proctype TestLookupDeadlineExceeded95(chan child) {
	...
	run newRLSClient55(cc_balancerWrapper_balancerMu,cc_balancerWrapper_mu,cc_blockingpicker_mu,cc_csMgr_mu,cc_lceMu,cc_mu,cc_resolverWrapper_resolverMu,cc_safeConfigSelector_mu,child_newRLSClient550);
	child_newRLSClient550?0;
	stop_process: skip;
	child!0
}
proctype newRLSClient55(Mutexdef cc_balancerWrapper_balancerMu;Mutexdef cc_balancerWrapper_mu;Mutexdef cc_blockingpicker_mu;Mutexdef cc_csMgr_mu;Mutexdef cc_lceMu;Mutexdef cc_mu;Mutexdef cc_resolverWrapper_resolverMu;Mutexdef cc_safeConfigSelector_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
