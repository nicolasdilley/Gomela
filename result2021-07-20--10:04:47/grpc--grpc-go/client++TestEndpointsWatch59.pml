...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_endpoints_test.go#L59
#define not_found_86  -2 // opt updates line 237
#define not_found_92  -2 // opt updates line 237
#define not_found_101  -2 // opt updates line 237
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEndpointsWatch590 = [1] of {int};
	run TestEndpointsWatch59(child_TestEndpointsWatch590);
	run receiver(child_TestEndpointsWatch590)
stop_process:skip
}

proctype TestEndpointsWatch59(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewEndpoints237(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_86,child_NewEndpoints2372);
	child_NewEndpoints2372?0;
	run NewEndpoints237(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_92,child_NewEndpoints2373);
	child_NewEndpoints2373?0;
	run NewEndpoints237(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_101,child_NewEndpoints2374);
