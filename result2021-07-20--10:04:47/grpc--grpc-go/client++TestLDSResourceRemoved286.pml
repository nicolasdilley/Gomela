...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_listener_test.go#L286
#define not_found_322  -2 // opt updates line 77
#define not_found_334  -2 // opt updates line 77
#define not_found_347  -2 // opt updates line 77
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestLDSResourceRemoved2860 = [1] of {int};
	run TestLDSResourceRemoved286(child_TestLDSResourceRemoved2860);
	run receiver(child_TestLDSResourceRemoved2860)
stop_process:skip
}

proctype TestLDSResourceRemoved286(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewListeners77(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_322,child_NewListeners773);
	child_NewListeners773?0;
	run NewListeners77(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_334,child_NewListeners774);
	child_NewListeners774?0;
	run NewListeners77(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_347,child_NewListeners775);
