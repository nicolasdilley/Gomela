...
// git_link=https://github.com/dgraph-io/dgraph/blob/6b188f254202f9c38b16c4769b672dd0e9d596ac/worker/worker_test.go#L311
#define not_found_314  -2 // opt uids line 207
#define not_found_331  -2 // opt uids line 207
#define not_found_352  -2 // opt uids line 207
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestProcessTaskIndex3110 = [1] of {int};
	run TestProcessTaskIndex311(child_TestProcessTaskIndex3110);
	run receiver(child_TestProcessTaskIndex3110)
stop_process:skip
}

proctype TestProcessTaskIndex311(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run runQuery207(dg_jwtMutex,not_found_314,child_runQuery2070);
	...
	run runQuery207(dg_jwtMutex,not_found_331,child_runQuery2073);
	...
	run runQuery207(dg_jwtMutex,not_found_352,child_runQuery2078);
