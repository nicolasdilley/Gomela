...
// git_link=https://github.com/dgraph-io/dgraph/blob/6b188f254202f9c38b16c4769b672dd0e9d596ac/tlstest/zero_https/all_routes_tls/all_routes_tls_test.go#L75
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestZeroWithAllRoutesTLSWithTLSClient75(chan child) {
	...
	int var_testCasesHttpstestCasesHttps = -2; // opt var_testCasesHttpstestCasesHttps
