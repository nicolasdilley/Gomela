...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L926
#define not_found_930  -2 // opt path line 83
#define not_found_931  -2 // opt path line 83
#define not_found_932  -2 // opt path line 83
#define not_found_933  -2 // opt path line 83
#define not_found_934  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouteMultiLevelBacktracking29260 = [1] of {int};
	run TestRouteMultiLevelBacktracking2926(child_TestRouteMultiLevelBacktracking29260);
	run receiver(child_TestRouteMultiLevelBacktracking29260)
stop_process:skip
}

proctype TestRouteMultiLevelBacktracking2926(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_930,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_931,child_Add831);
	child_Add831?0;
	run Add83(r_echo_startupMutex,not_found_932,child_Add832);
	child_Add832?0;
	run Add83(r_echo_startupMutex,not_found_933,child_Add833);
	child_Add833?0;
	run Add83(r_echo_startupMutex,not_found_934,child_Add834);
	child_Add834?0;
	stop_process: skip;
	child!0
}
