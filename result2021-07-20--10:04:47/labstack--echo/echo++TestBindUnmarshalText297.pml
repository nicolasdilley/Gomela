...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L297
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBindUnmarshalText2970 = [1] of {int};
	run TestBindUnmarshalText297(child_TestBindUnmarshalText2970);
	run receiver(child_TestBindUnmarshalText2970)
stop_process:skip
}

proctype TestBindUnmarshalText297(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
