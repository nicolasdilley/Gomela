...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L243
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBindQueryParamsCaseInsensitive2430 = [1] of {int};
	run TestBindQueryParamsCaseInsensitive243(child_TestBindQueryParamsCaseInsensitive2430);
	run receiver(child_TestBindQueryParamsCaseInsensitive2430)
stop_process:skip
}

proctype TestBindQueryParamsCaseInsensitive243(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
