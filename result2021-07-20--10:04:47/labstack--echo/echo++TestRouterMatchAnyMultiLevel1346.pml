...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1346
#define not_found_1351  -2 // opt path line 83
#define not_found_1352  -2 // opt path line 83
#define not_found_1353  -2 // opt path line 83
#define not_found_1354  -2 // opt path line 83
#define not_found_1355  -2 // opt path line 83
#define not_found_1356  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterMatchAnyMultiLevel13460 = [1] of {int};
	run TestRouterMatchAnyMultiLevel1346(child_TestRouterMatchAnyMultiLevel13460);
	run receiver(child_TestRouterMatchAnyMultiLevel13460)
stop_process:skip
}

proctype TestRouterMatchAnyMultiLevel1346(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_1351,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_1352,child_Add831);
	child_Add831?0;
	run Add83(r_echo_startupMutex,not_found_1353,child_Add832);
	child_Add832?0;
	run Add83(r_echo_startupMutex,not_found_1354,child_Add833);
	child_Add833?0;
	run Add83(r_echo_startupMutex,not_found_1355,child_Add834);
	child_Add834?0;
	run Add83(r_echo_startupMutex,not_found_1356,child_Add835);
	child_Add835?0;
	stop_process: skip;
	child!0
}
