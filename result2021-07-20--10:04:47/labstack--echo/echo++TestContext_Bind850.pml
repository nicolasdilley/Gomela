...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L850
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContext_Bind8500 = [1] of {int};
	run TestContext_Bind850(child_TestContext_Bind8500);
	run receiver(child_TestContext_Bind8500)
stop_process:skip
}

proctype TestContext_Bind850(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
