...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1572
#define not_found_1577  -2 // opt path line 83
#define not_found_1578  -2 // opt path line 83
#define not_found_1579  -2 // opt path line 83
#define not_found_1580  -2 // opt path line 83
#define not_found_1581  -2 // opt path line 83
#define not_found_1582  -2 // opt path line 83
#define not_found_1583  -2 // opt path line 83
#define not_found_1584  -2 // opt path line 83
#define not_found_1585  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterPriority15720 = [1] of {int};
	run TestRouterPriority1572(child_TestRouterPriority15720);
	run receiver(child_TestRouterPriority15720)
stop_process:skip
}

proctype TestRouterPriority1572(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_1577,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_1578,child_Add831);
	child_Add831?0;
	run Add83(r_echo_startupMutex,not_found_1579,child_Add832);
	child_Add832?0;
	run Add83(r_echo_startupMutex,not_found_1580,child_Add833);
	child_Add833?0;
	run Add83(r_echo_startupMutex,not_found_1581,child_Add834);
	child_Add834?0;
	run Add83(r_echo_startupMutex,not_found_1582,child_Add835);
	child_Add835?0;
	run Add83(r_echo_startupMutex,not_found_1583,child_Add836);
	child_Add836?0;
	run Add83(r_echo_startupMutex,not_found_1584,child_Add837);
	child_Add837?0;
	run Add83(r_echo_startupMutex,not_found_1585,child_Add838);
	child_Add838?0;
	stop_process: skip;
	child!0
}
