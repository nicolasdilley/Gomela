...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1812
#define not_found_1816  -2 // opt path line 83
#define not_found_1817  -2 // opt path line 83
#define not_found_1818  -2 // opt path line 83
#define not_found_1819  -2 // opt path line 83
#define not_found_1820  -2 // opt path line 83
#define not_found_1821  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterStaticDynamicConflict18120 = [1] of {int};
	run TestRouterStaticDynamicConflict1812(child_TestRouterStaticDynamicConflict18120);
	run receiver(child_TestRouterStaticDynamicConflict18120)
stop_process:skip
}

proctype TestRouterStaticDynamicConflict1812(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_1816,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_1817,child_Add831);
	child_Add831?0;
	run Add83(r_echo_startupMutex,not_found_1818,child_Add832);
	child_Add832?0;
	run Add83(r_echo_startupMutex,not_found_1819,child_Add833);
	child_Add833?0;
	run Add83(r_echo_startupMutex,not_found_1820,child_Add834);
	child_Add834?0;
	run Add83(r_echo_startupMutex,not_found_1821,child_Add835);
	child_Add835?0;
	stop_process: skip;
	child!0
}
