...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1121
#define not_found_1126  -2 // opt path line 83
#define not_found_1127  -2 // opt path line 83
#define not_found_1128  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterMatchAny11210 = [1] of {int};
	run TestRouterMatchAny1121(child_TestRouterMatchAny11210);
	run receiver(child_TestRouterMatchAny11210)
stop_process:skip
}

proctype TestRouterMatchAny1121(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_1126,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_1127,child_Add831);
	child_Add831?0;
	run Add83(r_echo_startupMutex,not_found_1128,child_Add832);
	child_Add832?0;
	stop_process: skip;
	child!0
}
