...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1197
#define not_found_1202  -2 // opt path line 83
#define not_found_1206  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterMatchAnyPrefixIssue11970 = [1] of {int};
	run TestRouterMatchAnyPrefixIssue1197(child_TestRouterMatchAnyPrefixIssue11970);
	run receiver(child_TestRouterMatchAnyPrefixIssue11970)
stop_process:skip
}

proctype TestRouterMatchAnyPrefixIssue1197(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_1202,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_1206,child_Add831);
	child_Add831?0;
	stop_process: skip;
	child!0
}
