...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L607
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextFormFile6070 = [1] of {int};
	run TestContextFormFile607(child_TestContextFormFile6070);
	run receiver(child_TestContextFormFile6070)
stop_process:skip
}

proctype TestContextFormFile607(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
