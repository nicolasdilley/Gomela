...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L216
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBindForm2160 = [1] of {int};
	run TestBindForm216(child_TestBindForm2160);
	run receiver(child_TestBindForm2160)
stop_process:skip
}

proctype TestBindForm216(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
