...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1752
#define not_found_1757  -2 // opt path line 83
#define not_found_1758  -2 // opt path line 83
#define not_found_1759  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterParamNames17520 = [1] of {int};
	run TestRouterParamNames1752(child_TestRouterParamNames17520);
	run receiver(child_TestRouterParamNames17520)
stop_process:skip
}

proctype TestRouterParamNames1752(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_1757,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_1758,child_Add831);
	child_Add831?0;
	run Add83(r_echo_startupMutex,not_found_1759,child_Add832);
	child_Add832?0;
	stop_process: skip;
	child!0
}
