...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1889
#define not_found_1894  -2 // opt path line 83
#define not_found_1895  -2 // opt path line 83
#define not_found_1896  -2 // opt path line 83
#define not_found_1897  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterParamBacktraceNotFound18890 = [1] of {int};
	run TestRouterParamBacktraceNotFound1889(child_TestRouterParamBacktraceNotFound18890);
	run receiver(child_TestRouterParamBacktraceNotFound18890)
stop_process:skip
}

proctype TestRouterParamBacktraceNotFound1889(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_1894,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_1895,child_Add831);
	child_Add831?0;
	run Add83(r_echo_startupMutex,not_found_1896,child_Add832);
	child_Add832?0;
	run Add83(r_echo_startupMutex,not_found_1897,child_Add833);
	child_Add833?0;
	stop_process: skip;
	child!0
}
