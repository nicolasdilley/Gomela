...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L726
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContext_QueryString7260 = [1] of {int};
	run TestContext_QueryString726(child_TestContext_QueryString7260);
	run receiver(child_TestContext_QueryString7260)
stop_process:skip
}

proctype TestContext_QueryString726(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
