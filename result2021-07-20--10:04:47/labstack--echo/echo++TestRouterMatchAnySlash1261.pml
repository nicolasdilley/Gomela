...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1261
#define not_found_1266  -2 // opt path line 83
#define not_found_1267  -2 // opt path line 83
#define not_found_1268  -2 // opt path line 83
#define not_found_1269  -2 // opt path line 83
#define not_found_1270  -2 // opt path line 83
#define not_found_1271  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterMatchAnySlash12610 = [1] of {int};
	run TestRouterMatchAnySlash1261(child_TestRouterMatchAnySlash12610);
	run receiver(child_TestRouterMatchAnySlash12610)
stop_process:skip
}

proctype TestRouterMatchAnySlash1261(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_1266,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_1267,child_Add831);
	child_Add831?0;
	run Add83(r_echo_startupMutex,not_found_1268,child_Add832);
	child_Add832?0;
	run Add83(r_echo_startupMutex,not_found_1269,child_Add833);
	child_Add833?0;
	run Add83(r_echo_startupMutex,not_found_1270,child_Add834);
	child_Add834?0;
	run Add83(r_echo_startupMutex,not_found_1271,child_Add835);
	child_Add835?0;
	stop_process: skip;
	child!0
}
