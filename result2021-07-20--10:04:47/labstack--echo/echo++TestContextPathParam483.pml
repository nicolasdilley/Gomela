...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L483
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextPathParam4830 = [1] of {int};
	run TestContextPathParam483(child_TestContextPathParam4830);
	run receiver(child_TestContextPathParam4830)
stop_process:skip
}

proctype TestContextPathParam483(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
