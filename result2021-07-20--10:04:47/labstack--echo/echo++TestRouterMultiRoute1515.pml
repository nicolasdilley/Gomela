...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1515
#define not_found_1520  -2 // opt path line 83
#define not_found_1521  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterMultiRoute15150 = [1] of {int};
	run TestRouterMultiRoute1515(child_TestRouterMultiRoute15150);
	run receiver(child_TestRouterMultiRoute15150)
stop_process:skip
}

proctype TestRouterMultiRoute1515(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_1520,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_1521,child_Add831);
	child_Add831?0;
	stop_process: skip;
	child!0
}
