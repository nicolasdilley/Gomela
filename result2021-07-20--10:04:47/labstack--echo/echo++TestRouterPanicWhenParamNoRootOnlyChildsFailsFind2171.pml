...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L2171
#define not_found_2175  -2 // opt path line 83
#define not_found_2176  -2 // opt path line 83
#define not_found_2177  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterPanicWhenParamNoRootOnlyChildsFailsFind21710 = [1] of {int};
	run TestRouterPanicWhenParamNoRootOnlyChildsFailsFind2171(child_TestRouterPanicWhenParamNoRootOnlyChildsFailsFind21710);
	run receiver(child_TestRouterPanicWhenParamNoRootOnlyChildsFailsFind21710)
stop_process:skip
}

proctype TestRouterPanicWhenParamNoRootOnlyChildsFailsFind2171(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_2175,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_2176,child_Add831);
	child_Add831?0;
	run Add83(r_echo_startupMutex,not_found_2177,child_Add832);
	child_Add832?0;
	stop_process: skip;
	child!0
}
