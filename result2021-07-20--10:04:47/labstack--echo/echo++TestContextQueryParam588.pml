...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L588
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextQueryParam5880 = [1] of {int};
	run TestContextQueryParam588(child_TestContextQueryParam5880);
	run receiver(child_TestContextQueryParam5880)
stop_process:skip
}

proctype TestContextQueryParam588(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
