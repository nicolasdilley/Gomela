...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L626
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextMultipartForm6260 = [1] of {int};
	run TestContextMultipartForm626(child_TestContextMultipartForm6260);
	run receiver(child_TestContextMultipartForm6260)
stop_process:skip
}

proctype TestContextMultipartForm626(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
