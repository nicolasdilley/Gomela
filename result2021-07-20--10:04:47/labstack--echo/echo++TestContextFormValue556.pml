...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L556
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextFormValue5560 = [1] of {int};
	run TestContextFormValue556(child_TestContextFormValue5560);
	run receiver(child_TestContextFormValue5560)
stop_process:skip
}

proctype TestContextFormValue556(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
