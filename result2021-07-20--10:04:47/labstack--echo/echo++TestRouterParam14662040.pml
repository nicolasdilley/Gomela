...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L2040
#define not_found_2044  -2 // opt path line 83
#define not_found_2045  -2 // opt path line 83
#define not_found_2046  -2 // opt path line 83
#define not_found_2047  -2 // opt path line 83
#define not_found_2048  -2 // opt path line 83
#define not_found_2049  -2 // opt path line 83
#define not_found_2051  -2 // opt path line 83
#define not_found_2052  -2 // opt path line 83
#define not_found_2053  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterParam146620400 = [1] of {int};
	run TestRouterParam14662040(child_TestRouterParam146620400);
	run receiver(child_TestRouterParam146620400)
stop_process:skip
}

proctype TestRouterParam14662040(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Add838 = [1] of {int};
	chan child_Add837 = [1] of {int};
	chan child_Add836 = [1] of {int};
	...
	run Add83(r_echo_startupMutex,not_found_2044,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_2045,child_Add831);
	child_Add831?0;
	run Add83(r_echo_startupMutex,not_found_2046,child_Add832);
	child_Add832?0;
	run Add83(r_echo_startupMutex,not_found_2047,child_Add833);
	child_Add833?0;
	run Add83(r_echo_startupMutex,not_found_2048,child_Add834);
	child_Add834?0;
	run Add83(r_echo_startupMutex,not_found_2049,child_Add835);
	child_Add835?0;
	run Add83(r_echo_startupMutex,not_found_2051,child_Add836);
	child_Add836?0;
	run Add83(r_echo_startupMutex,not_found_2052,child_Add837);
	child_Add837?0;
	run Add83(r_echo_startupMutex,not_found_2053,child_Add838);
	child_Add838?0;
	stop_process: skip;
	child!0
}
