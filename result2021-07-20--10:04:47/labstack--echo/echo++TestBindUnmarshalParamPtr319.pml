...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L319
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBindUnmarshalParamPtr3190 = [1] of {int};
	run TestBindUnmarshalParamPtr319(child_TestBindUnmarshalParamPtr3190);
	run receiver(child_TestBindUnmarshalParamPtr3190)
stop_process:skip
}

proctype TestBindUnmarshalParamPtr319(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
