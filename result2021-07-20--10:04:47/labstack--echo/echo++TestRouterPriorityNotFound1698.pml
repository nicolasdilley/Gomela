...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1698
#define not_found_1703  -2 // opt path line 83
#define not_found_1704  -2 // opt path line 83
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRouterPriorityNotFound16980 = [1] of {int};
	run TestRouterPriorityNotFound1698(child_TestRouterPriorityNotFound16980);
	run receiver(child_TestRouterPriorityNotFound16980)
stop_process:skip
}

proctype TestRouterPriorityNotFound1698(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run Add83(r_echo_startupMutex,not_found_1703,child_Add830);
	child_Add830?0;
	run Add83(r_echo_startupMutex,not_found_1704,child_Add831);
	child_Add831?0;
	stop_process: skip;
	child!0
}
