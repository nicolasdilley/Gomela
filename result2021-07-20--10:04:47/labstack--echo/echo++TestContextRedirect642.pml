...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L642
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextRedirect6420 = [1] of {int};
	run TestContextRedirect642(child_TestContextRedirect6420);
	run receiver(child_TestContextRedirect6420)
stop_process:skip
}

proctype TestContextRedirect642(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
