...
// git_link=https://github.com/kubernetes/kops/blob/e3fbc2ad043e58cfdcf934e015ef8d5d9e42273e/protokube/pkg/gossip/memberlist/gossip.go#L48
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype NewMemberlistGossiper48(chan child) {
	...
	int var_initialPeersinitialPeers = -2; // opt var_initialPeersinitialPeers
