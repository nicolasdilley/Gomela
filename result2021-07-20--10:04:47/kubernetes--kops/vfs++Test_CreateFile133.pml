...
// git_link=https://github.com/kubernetes/kops/blob/e3fbc2ad043e58cfdcf934e015ef8d5d9e42273e/util/pkg/vfs/vaultfs_test.go#L133
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Test_CreateFile133(chan child) {
	...
	run CreateFile84(p_vaultClient_modifyLock,child_CreateFile841);
	child_CreateFile841?0;
	run CreateFile84(p_vaultClient_modifyLock,child_CreateFile842);
...
proctype CreateFile84(Mutexdef p_vaultClient_modifyLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run ReadFile93(p_vaultClient_modifyLock,child_ReadFile931);
	child_ReadFile931?0;
	

	if
	:: true -> 
		run WriteFile66(p_vaultClient_modifyLock,child_WriteFile662);
