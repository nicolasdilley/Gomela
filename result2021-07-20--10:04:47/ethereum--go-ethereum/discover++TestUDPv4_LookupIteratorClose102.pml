...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/p2p/discover/v4_lookup_test.go#L102
#define not_found_112  -2 // opt nodes line 111
...
init { 
	chan child_TestUDPv4_LookupIteratorClose1020 = [1] of {int};
	run TestUDPv4_LookupIteratorClose102(child_TestUDPv4_LookupIteratorClose1020);
	run receiver(child_TestUDPv4_LookupIteratorClose1020)
stop_process:skip
}

proctype TestUDPv4_LookupIteratorClose102(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run fillTable111(test_table_mutex,not_found_112,child_fillTable1111);
...
proctype addReplacement570(Mutexdef tab_mutex;chan child) {
	...
	int var_b_replacementsb_replacements = -2; // opt var_b_replacementsb_replacements
