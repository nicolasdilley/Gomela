...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/accounts/keystore/account_cache_test.go#L227
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestCacheFind227(chan child) {
	...
	int var_accsaccs = -2; // opt var_accsaccs
...
proctype find161(Mutexdef ac_fileC_mu;Mutexdef ac_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_matchesmatches = -2; // opt var_matchesmatches
