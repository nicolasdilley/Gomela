...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/console/console_test.go#L189
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEvaluate1890 = [1] of {int};
	run TestEvaluate189(child_TestEvaluate1890);
	run receiver(child_TestEvaluate1890)
stop_process:skip
}

proctype TestEvaluate189(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
