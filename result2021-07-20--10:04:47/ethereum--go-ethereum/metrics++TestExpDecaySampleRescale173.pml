...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/metrics/sample_test.go#L173
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestExpDecaySampleRescale173(chan child) {
	...
	Mutexdef s_mutex;
	int var_s_values_Values__s_values_Values__ = -2; // opt var_s_values_Values__s_values_Values__
