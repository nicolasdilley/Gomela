...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/eth/tracers/api.go#L733
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TraceCall7330 = [1] of {int};
	run TraceCall733(child_TraceCall7330);
	run receiver(child_TraceCall7330)
stop_process:skip
}

proctype TraceCall733(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
