...
// git_link=https://github.com/go-gitea/gitea/blob/ed393779004335a0afcca0dfac48937db41fabd6/modules/git/repo_stats_test.go#L15
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestRepository_GetCodeActivityStats150)
stop_process:skip
}
...
proctype GetCodeActivityStats37(Mutexdef repo_tagCache_lock;chan child) {
	...
	bool state;
	int num_msgs;
	int var_authorsauthors = -2; // opt var_authorsauthors
