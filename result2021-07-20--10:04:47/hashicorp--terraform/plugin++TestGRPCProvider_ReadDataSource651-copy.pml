...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/plugin/grpc_provider_test.go#L651
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ReadDataSource6510 = [1] of {int};
	run TestGRPCProvider_ReadDataSource651(child_TestGRPCProvider_ReadDataSource6510);
	run receiver(child_TestGRPCProvider_ReadDataSource6510)
stop_process:skip
}

proctype TestGRPCProvider_ReadDataSource651(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run ReadDataSource538(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_mu,p_PluginClient_l,p_TestServer_mu,child_ReadDataSource5380);
	child_ReadDataSource5380?0;
	stop_process: skip;
	child!0
}
proctype ReadDataSource538(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_mu;Mutexdef p_PluginClient_l;Mutexdef p_TestServer_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run getDatasourceSchema102(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_mu,p_PluginClient_l,p_TestServer_mu,child_getDatasourceSchema1020);
...
proctype getDatasourceSchema102(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_mu;Mutexdef p_PluginClient_l;Mutexdef p_TestServer_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
