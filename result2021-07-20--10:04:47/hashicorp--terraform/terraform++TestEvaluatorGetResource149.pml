...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/terraform/evaluate_test.go#L149
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEvaluatorGetResource1490 = [1] of {int};
	run TestEvaluatorGetResource149(child_TestEvaluatorGetResource1490);
	run receiver(child_TestEvaluatorGetResource1490)
stop_process:skip
}

proctype TestEvaluatorGetResource149(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
