...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/plugin6/grpc_provider_test.go#L352
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestGRPCProvider_PlanResourceChange3520)
stop_process:skip
}
...
proctype PlanResourceChange378(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_mu;Mutexdef p_PluginClient_l;Mutexdef p_TestServer_mu;chan child) {
	...
	int var_protoResp_RequiresReplaceprotoResp_RequiresReplace = -2; // opt var_protoResp_RequiresReplaceprotoResp_RequiresReplace
...
proctype AttributePathToPath82(Wgdef ap_PluginClient_clientWaitGroup;Wgdef ap_PluginClient_stderrWaitGroup;Wgdef ap_TestServer_serveWG;Mutexdef ap_mu;Mutexdef ap_PluginClient_l;Mutexdef ap_TestServer_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_ap_Stepsap_Steps = -2; // opt var_ap_Stepsap_Steps
	goto stop_process;
	stop_process: skip;
	child!0
}
