...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/states/remote/state_test.go#L441
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestWriteStateForMigrationWithForcePushClient4410 = [1] of {int};
	run TestWriteStateForMigrationWithForcePushClient441(child_TestWriteStateForMigrationWithForcePushClient4410);
	run receiver(child_TestWriteStateForMigrationWithForcePushClient4410)
stop_process:skip
}

proctype TestWriteStateForMigrationWithForcePushClient441(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
