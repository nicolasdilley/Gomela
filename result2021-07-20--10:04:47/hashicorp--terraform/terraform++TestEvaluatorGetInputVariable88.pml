...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/terraform/evaluate_test.go#L88
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEvaluatorGetInputVariable880 = [1] of {int};
	run TestEvaluatorGetInputVariable88(child_TestEvaluatorGetInputVariable880);
	run receiver(child_TestEvaluatorGetInputVariable880)
stop_process:skip
}

proctype TestEvaluatorGetInputVariable88(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
