...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/terraform/evaluate_test.go#L43
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEvaluatorGetPathAttr430 = [1] of {int};
	run TestEvaluatorGetPathAttr43(child_TestEvaluatorGetPathAttr430);
	run receiver(child_TestEvaluatorGetPathAttr430)
stop_process:skip
}

proctype TestEvaluatorGetPathAttr43(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
