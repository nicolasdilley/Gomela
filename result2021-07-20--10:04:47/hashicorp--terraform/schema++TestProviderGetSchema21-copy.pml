...
proctype GetSchema204(Mutexdef p_stopMu;Mutexdef p_stopOnce_m;chan child) {
	...
	bool state;
	int num_msgs;
	int var_req_DataSourcesreq_DataSources = -2; // opt var_req_DataSourcesreq_DataSources
	int var_req_ResourceTypesreq_ResourceTypes = -2; // opt var_req_ResourceTypesreq_ResourceTypes
	goto stop_process;
	stop_process: skip;
	child!0
}
