...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/internal/legacy/helper/schema/provisioner_test.go#L260
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run receiver(child_TestProvisionerStop_apply2600)
stop_process:skip
}
...
proctype TestProvisionerStop_apply260(chan child) {
	...
	run AnonymousTestProvisionerStop_apply299298(doneCh_ch,p_stopOnce_m,state_mu,child_AnonymousTestProvisionerStop_apply2992980);
	run receiver(child_AnonymousTestProvisionerStop_apply2992980);
	do
...
proctype AnonymousTestProvisionerStop_apply299298(Chandef doneCh_ch;Mutexdef p_stopOnce_m;Mutexdef state_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype Apply130(Mutexdef p_stopOnce_m;Mutexdef s_mu;chan child) {
	...
	int var_s_Ephemeral_ConnInfos_Ephemeral_ConnInfo = -2; // opt var_s_Ephemeral_ConnInfos_Ephemeral_ConnInfo
