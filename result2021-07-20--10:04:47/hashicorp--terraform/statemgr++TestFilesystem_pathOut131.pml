...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/states/statemgr/filesystem_test.go#L131
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFilesystem_pathOut1310 = [1] of {int};
	run TestFilesystem_pathOut131(child_TestFilesystem_pathOut1310);
	run receiver(child_TestFilesystem_pathOut1310)
stop_process:skip
}

proctype TestFilesystem_pathOut131(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
