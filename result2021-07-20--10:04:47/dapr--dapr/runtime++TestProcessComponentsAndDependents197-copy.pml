...
// git_link=https://github.com/dapr/dapr/blob/ab83d3535478699a2f2707d9ed9008f78c155d6d/pkg/runtime/runtime_test.go#L197
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestProcessComponentsAndDependents1970 = [1] of {int};
	run TestProcessComponentsAndDependents197(child_TestProcessComponentsAndDependents1970);
	run receiver(child_TestProcessComponentsAndDependents1970)
stop_process:skip
}

proctype TestProcessComponentsAndDependents197(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
