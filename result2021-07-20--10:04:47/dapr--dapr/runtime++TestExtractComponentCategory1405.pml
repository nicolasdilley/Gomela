...
// git_link=https://github.com/dapr/dapr/blob/ab83d3535478699a2f2707d9ed9008f78c155d6d/pkg/runtime/runtime_test.go#L1405
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestExtractComponentCategory14050 = [1] of {int};
	run TestExtractComponentCategory1405(child_TestExtractComponentCategory14050);
	run receiver(child_TestExtractComponentCategory14050)
stop_process:skip
}

proctype TestExtractComponentCategory1405(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
