...
// git_link=https://github.com/dapr/dapr/blob/ab83d3535478699a2f2707d9ed9008f78c155d6d/pkg/runtime/runtime_test.go#L1622
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestOnNewPublishedMessage16220 = [1] of {int};
	run TestOnNewPublishedMessage1622(child_TestOnNewPublishedMessage16220);
	run receiver(child_TestOnNewPublishedMessage16220)
stop_process:skip
}

proctype TestOnNewPublishedMessage1622(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
