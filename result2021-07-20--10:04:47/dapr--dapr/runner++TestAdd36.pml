...
// git_link=https://github.com/dapr/dapr/blob/ab83d3535478699a2f2707d9ed9008f78c155d6d/tests/runner/testresource_test.go#L36
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestAdd36(chan child) {
	...
	int var_resource_resourcesresource_resources = -2; // opt var_resource_resourcesresource_resources
