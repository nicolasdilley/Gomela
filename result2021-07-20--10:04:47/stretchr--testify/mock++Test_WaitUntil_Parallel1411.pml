...
// git_link=https://github.com/stretchr/testify/blob/6241f9ab994219cafb009b160a20acf4a62063aa/mock/mock_test.go#L1411
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype Test_WaitUntil_Parallel1411(chan child) {
	...
	run AnonymousTest_WaitUntil_Parallel14291417(ch2_ch,ch1_ch,child_AnonymousTest_WaitUntil_Parallel142914172);
...
proctype AnonymousTest_WaitUntil_Parallel14291417(Chandef ch2_ch;Chandef ch1_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
