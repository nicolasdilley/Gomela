...
// git_link=https://github.com/beego/beego/blob/511714d616c8da2a9562c2d0130096f4c7c6b169/server/web/context/input_test.go#L156
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestParams1560)
stop_process:skip
}
...
proctype SetParam309(Mutexdef input_dataLock;chan child) {
	...
	bool state;
	int num_msgs;
	int var_input_pnamesinput_pnames = -2; // opt var_input_pnamesinput_pnames
	stop_process: skip;
	child!0
}
