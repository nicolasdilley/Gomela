...
// git_link=https://github.com/beego/beego/blob/511714d616c8da2a9562c2d0130096f4c7c6b169/client/cache/cache_test.go#L29
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestCacheIncr290)
stop_process:skip
}
...
proctype TestCacheIncr29(chan child) {
	...
	wg.update!10;
		...
		run receiver(child_AnonymousTestCacheIncr38350);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
