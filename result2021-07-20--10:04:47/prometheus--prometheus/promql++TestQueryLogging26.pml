...
// git_link=https://github.com/prometheus/prometheus/blob/27b78c336e436e9eed8b55ab0b162b888ec641d8/promql/query_logger_test.go#L26
#define not_found_34  -2 // opt maxConcurrent line 169
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestQueryLogging26(chan child) {
	...
	run generateIndices169(queryLogger_getNextIndex_ch,not_found_34,child_generateIndices1690);
