...
// git_link=https://github.com/prometheus/prometheus/blob/27b78c336e436e9eed8b55ab0b162b888ec641d8/discovery/triton/triton.go#L142
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_New1420 = [1] of {int};
	run New142(child_New1420);
	run receiver(child_New1420)
stop_process:skip
}

proctype New142(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
