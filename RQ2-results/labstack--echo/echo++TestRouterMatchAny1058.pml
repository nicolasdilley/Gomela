#define not_found_1063  -2
#define not_found_1064  -2
#define not_found_1065  -2

// https://github.com/labstack/echo/blob/master/router_test.go#L1058
typedef Mutexdef {
	chan Lock = [0] of {bool};
