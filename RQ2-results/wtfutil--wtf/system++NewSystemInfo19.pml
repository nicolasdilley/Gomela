...
// https://github.com/wtfutil/wtf/blob/master/modules/system/system_info.go#L19
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_NewSystemInfo190 = [1] of {int};
	run NewSystemInfo19(child_NewSystemInfo190)
stop_process:skip
}

proctype NewSystemInfo19(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
