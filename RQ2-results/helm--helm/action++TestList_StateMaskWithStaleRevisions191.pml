...
// https://github.com/helm/helm/blob/master/pkg/action/list_test.go#L191
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestList_StateMaskWithStaleRevisions1910 = [1] of {int};
	run TestList_StateMaskWithStaleRevisions191(child_TestList_StateMaskWithStaleRevisions1910)
stop_process:skip
}

proctype TestList_StateMaskWithStaleRevisions191(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
