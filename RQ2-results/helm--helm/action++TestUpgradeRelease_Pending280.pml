...
// https://github.com/helm/helm/blob/master/pkg/action/upgrade_test.go#L280
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestUpgradeRelease_Pending2800 = [1] of {int};
	run TestUpgradeRelease_Pending280(child_TestUpgradeRelease_Pending2800)
stop_process:skip
}

proctype TestUpgradeRelease_Pending280(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
