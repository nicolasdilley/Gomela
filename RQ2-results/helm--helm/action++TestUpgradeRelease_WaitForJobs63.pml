...
// https://github.com/helm/helm/blob/master/pkg/action/upgrade_test.go#L63
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestUpgradeRelease_WaitForJobs630 = [1] of {int};
	run TestUpgradeRelease_WaitForJobs63(child_TestUpgradeRelease_WaitForJobs630)
stop_process:skip
}

proctype TestUpgradeRelease_WaitForJobs63(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
