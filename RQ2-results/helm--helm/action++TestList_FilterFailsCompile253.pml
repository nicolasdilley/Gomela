...
// https://github.com/helm/helm/blob/master/pkg/action/list_test.go#L253
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestList_FilterFailsCompile2530 = [1] of {int};
	run TestList_FilterFailsCompile253(child_TestList_FilterFailsCompile2530)
stop_process:skip
}

proctype TestList_FilterFailsCompile253(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
