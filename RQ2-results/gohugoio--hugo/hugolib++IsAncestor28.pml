...
// https://github.com/gohugoio/hugo/blob/master/hugolib/page__tree.go#L28
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_IsAncestor280 = [1] of {int};
	run IsAncestor28(child_IsAncestor280)
stop_process:skip
}

proctype IsAncestor28(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
