...
// https://github.com/moby/moby/blob/master/daemon/logs_test.go#L9
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestMergeAndVerifyLogConfigNilConfig90 = [1] of {int};
	run TestMergeAndVerifyLogConfigNilConfig9(child_TestMergeAndVerifyLogConfigNilConfig90)
stop_process:skip
}

proctype TestMergeAndVerifyLogConfigNilConfig9(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_mergeAndVerifyLogConfig1770 = [1] of {int};
