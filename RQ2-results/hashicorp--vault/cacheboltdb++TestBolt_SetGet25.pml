...
// https://github.com/hashicorp/vault/blob/master/command/agent/cache/cacheboltdb/bolt_test.go#L25
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestBolt_SetGet25(chan child) {
	...
	run GetByType190(b_db_freelistLoad_m,b_db_batchMu,b_db_batch_start_m,b_db_rwlock,b_db_metalock,b_db_mmaplock,b_db_statlock,child_GetByType1900);
