...
// https://github.com/hashicorp/vault/blob/master/helper/mfa/duo/duo_test.go#L71
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestDuoHandlerSuccess710 = [1] of {int};
	run TestDuoHandlerSuccess71(child_TestDuoHandlerSuccess710)
stop_process:skip
}

proctype TestDuoHandlerSuccess71(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
