...
// https://github.com/hashicorp/vault/blob/master/physical/raft/raft_test.go#L447
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRaft_Backend_Performance447(chan child) {
	...
	run applyConfigSettings587(b_l,b_fsm_l,b_fsm_db_freelistLoad_m,b_fsm_db_batchMu,b_fsm_db_batch_start_m,b_fsm_db_rwlock,b_fsm_db_metalock,b_fsm_db_mmaplock,b_fsm_db_statlock,b_raft_lastContactLock,b_raft_leaderLock,b_raft_shutdownLock,b_raft_observersLock,b_streamLayer_closeLock,b_autopilot_stateLock,b_autopilot_leaderLock_mu,b_autopilot_execLock,b_followerStates_l,child_applyConfigSettings5871);
	child_applyConfigSettings5871?0;
	run applyConfigSettings587(b_l,b_fsm_l,b_fsm_db_freelistLoad_m,b_fsm_db_batchMu,b_fsm_db_batch_start_m,b_fsm_db_rwlock,b_fsm_db_metalock,b_fsm_db_mmaplock,b_fsm_db_statlock,b_raft_lastContactLock,b_raft_leaderLock,b_raft_shutdownLock,b_raft_observersLock,b_streamLayer_closeLock,b_autopilot_stateLock,b_autopilot_leaderLock_mu,b_autopilot_execLock,b_followerStates_l,child_applyConfigSettings5872);
