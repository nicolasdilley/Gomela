...
// https://github.com/hashicorp/vault/blob/master/vault/barrier_aes_gcm_test.go#L90
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestAESGCMBarrier_Upgrade90(chan child) {
	...
	run testBarrier_Upgrade438(b1_l,b1_cacheLock,b1_l,b1_cacheLock,child_testBarrier_Upgrade4380);
	child_testBarrier_Upgrade4380?0;
	stop_process: skip;
	child!0
}
proctype testBarrier_Upgrade438(Mutexdef b1_l;Mutexdef b1_cacheLock;Mutexdef b2_l;Mutexdef b2_cacheLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	child_Unseal4223?0;
	run Rotate548(b1_l,b1_cacheLock,child_Rotate5484);
	child_Rotate5484?0;
	run CreateUpgrade592(b1_l,b1_cacheLock,child_CreateUpgrade5925);
	child_CreateUpgrade5925?0;
	run CheckUpgrade637(b2_l,b2_cacheLock,child_CheckUpgrade6376);
	child_CheckUpgrade6376?0;
	run CheckUpgrade637(b2_l,b2_cacheLock,child_CheckUpgrade6377);
	child_CheckUpgrade6377?0;
	run Rotate548(b1_l,b1_cacheLock,child_Rotate5488);
	child_Rotate5488?0;
	run CreateUpgrade592(b1_l,b1_cacheLock,child_CreateUpgrade5929);
	child_CreateUpgrade5929?0;
	run DestroyUpgrade631(b1_l,b1_cacheLock,child_DestroyUpgrade63110);
	child_DestroyUpgrade63110?0;
	run CheckUpgrade637(b2_l,b2_cacheLock,child_CheckUpgrade63711);
...
proctype Rotate548(Mutexdef b_l;Mutexdef b_cacheLock;chan child) {
	...
	run GenerateKey274(b_l,b_cacheLock,child_GenerateKey2744);
	...
	run persistKeyring210(b_l,b_cacheLock,child_persistKeyring2105);
...
proctype CreateUpgrade592(Mutexdef b_l;Mutexdef b_cacheLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run aeadForTerm909(b_l,b_cacheLock,child_aeadForTerm9095);
...
proctype CheckUpgrade637(Mutexdef b_l;Mutexdef b_cacheLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype DestroyUpgrade631(Mutexdef b_l;Mutexdef b_cacheLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Delete88210 = [1] of {int};
	run Delete882(b_l,b_cacheLock,child_Delete88210);
	child_Delete88210?0;
	goto stop_process;
	stop_process: skip;
	child!0
