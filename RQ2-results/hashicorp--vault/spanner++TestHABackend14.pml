...
// https://github.com/hashicorp/vault/blob/master/physical/spanner/spanner_ha_test.go#L14
typedef Wgdef {
...
proctype TestHABackend14(chan child) {
	...
	run testCleanup14(client_idleSessions_hc_waitWorkers,client_sc_mu,client_sc_logger_mu,client_idleSessions_mu,client_idleSessions_sc_mu,client_idleSessions_sc_logger_mu,client_idleSessions_hc_mu,client_idleSessions_hc_once_m,client_idleSessions_mw_mu,client_logger_mu,client_qo_Options_state_atomicMessageInfo_initMu,child_testCleanup142);
	child_testCleanup142?0;
	stop_process: skip;
		run testCleanup14(client_idleSessions_hc_waitWorkers,client_sc_mu,client_sc_logger_mu,client_idleSessions_mu,client_idleSessions_sc_mu,client_idleSessions_sc_logger_mu,client_idleSessions_hc_mu,client_idleSessions_hc_once_m,client_idleSessions_mw_mu,client_logger_mu,client_qo_Options_state_atomicMessageInfo_initMu,child_testCleanup143);
