...
// https://github.com/pingcap/tidb/blob/master/executor/benchmark_test.go#L1226
typedef Wgdef {
...
init { 
	chan child_defaultIndexJoinTestCase12260 = [1] of {int};
	run defaultIndexJoinTestCase1226(child_defaultIndexJoinTestCase12260)
stop_process:skip
}

proctype defaultIndexJoinTestCase1226(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
