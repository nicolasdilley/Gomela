...
// https://github.com/pingcap/tidb/blob/master/executor/benchmark_test.go#L836
typedef Wgdef {
...
init { 
	chan child_defaultHashJoinTestCase8360 = [1] of {int};
	run defaultHashJoinTestCase836(child_defaultHashJoinTestCase8360)
stop_process:skip
}

proctype defaultHashJoinTestCase836(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
