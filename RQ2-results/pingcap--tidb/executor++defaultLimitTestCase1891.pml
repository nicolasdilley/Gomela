...
// https://github.com/pingcap/tidb/blob/master/executor/benchmark_test.go#L1891
typedef Wgdef {
...
init { 
	chan child_defaultLimitTestCase18910 = [1] of {int};
	run defaultLimitTestCase1891(child_defaultLimitTestCase18910)
stop_process:skip
}

proctype defaultLimitTestCase1891(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
