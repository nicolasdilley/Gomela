...
// https://github.com/prometheus/prometheus/blob/master/discovery/moby/docker_test.go#L27
typedef Wgdef {
...
init { 
	chan child_TestDockerSDRefresh270 = [1] of {int};
	run TestDockerSDRefresh27(child_TestDockerSDRefresh270)
stop_process:skip
}

proctype TestDockerSDRefresh27(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
