...
// https://github.com/prometheus/prometheus/blob/master/discovery/consul/consul_test.go#L52
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestConfiguredServiceWithTag52(chan child) {
	...
	run shouldWatch236(consulDiscovery_client_config_Transport_idleMu,consulDiscovery_client_config_Transport_reqMu,consulDiscovery_client_config_Transport_altMu,consulDiscovery_client_config_Transport_connsPerHostMu,consulDiscovery_client_config_Transport_TLSClientConfig_mutex,consulDiscovery_client_config_Transport_nextProtoOnce_m,child_shouldWatch2362);
	child_shouldWatch2362?0;
	run shouldWatch236(consulDiscovery_client_config_Transport_idleMu,consulDiscovery_client_config_Transport_reqMu,consulDiscovery_client_config_Transport_altMu,consulDiscovery_client_config_Transport_connsPerHostMu,consulDiscovery_client_config_Transport_TLSClientConfig_mutex,consulDiscovery_client_config_Transport_nextProtoOnce_m,child_shouldWatch2363);
