...
// https://github.com/prometheus/prometheus/blob/master/discovery/openstack/hypervisor_test.go#L49
typedef Wgdef {
...
init { 
	chan child_TestOpenstackSDHypervisorRefresh490 = [1] of {int};
	run TestOpenstackSDHypervisorRefresh49(child_TestOpenstackSDHypervisorRefresh490)
stop_process:skip
}

proctype TestOpenstackSDHypervisorRefresh49(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
