...
// https://github.com/prometheus/prometheus/blob/master/discovery/moby/services_test.go#L318
typedef Wgdef {
...
init { 
	chan child_TestDockerSwarmSDServicesRefreshWithFilters3180 = [1] of {int};
	run TestDockerSwarmSDServicesRefreshWithFilters318(child_TestDockerSwarmSDServicesRefreshWithFilters3180)
stop_process:skip
}

proctype TestDockerSwarmSDServicesRefreshWithFilters318(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
