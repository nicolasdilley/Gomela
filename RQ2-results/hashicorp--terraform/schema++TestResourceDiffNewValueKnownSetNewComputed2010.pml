...
// https://github.com/hashicorp/terraform/blob/master/internal/legacy/helper/schema/resource_diff_test.go#L2010
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestResourceDiffNewValueKnownSetNewComputed2010(chan child) {
	...
	run NewValueKnown419(d_state_mu,d_diff_mu,d_newWriter_lock,d_newWriter_once_m,child_NewValueKnown4191);
...
proctype NewValueKnown419(Mutexdef d_state_mu;Mutexdef d_diff_mu;Mutexdef d_newWriter_lock;Mutexdef d_newWriter_once_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
