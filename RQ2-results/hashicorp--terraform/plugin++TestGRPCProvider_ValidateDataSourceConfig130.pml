...
// https://github.com/hashicorp/terraform/blob/master/plugin/grpc_provider_test.go#L130
typedef Wgdef {
...
proctype TestGRPCProvider_ValidateDataSourceConfig130(chan child) {
	...
	run ValidateDataResourceConfig227(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_PluginClient_config_Cmd_Process_sigMu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_mu,p_TestServer_quit_o_m,p_TestServer_done_o_m,p_TestServer_channelzRemoveOnce_m,p_mu,child_ValidateDataResourceConfig2270);
