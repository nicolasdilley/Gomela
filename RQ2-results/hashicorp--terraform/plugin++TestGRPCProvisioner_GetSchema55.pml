...
// https://github.com/hashicorp/terraform/blob/master/plugin/grpc_provisioner_test.go#L55
typedef Wgdef {
...
proctype TestGRPCProvisioner_GetSchema55(chan child) {
	...
	run GetSchema51(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_PluginClient_config_Cmd_Process_sigMu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_mu,child_GetSchema510);
	child_GetSchema510?0;
	stop_process: skip;
	child!0
}
proctype GetSchema51(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Mutexdef p_PluginClient_config_Cmd_Process_sigMu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
