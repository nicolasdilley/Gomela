...
// https://github.com/hashicorp/terraform/blob/master/plugin/grpc_provider_test.go#L313
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ReadEmptyJSON3130 = [1] of {int};
	run TestGRPCProvider_ReadEmptyJSON313(child_TestGRPCProvider_ReadEmptyJSON3130)
stop_process:skip
}

proctype TestGRPCProvider_ReadEmptyJSON313(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
