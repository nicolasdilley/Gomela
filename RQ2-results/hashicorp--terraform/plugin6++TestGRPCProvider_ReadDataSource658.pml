...
// https://github.com/hashicorp/terraform/blob/master/plugin6/grpc_provider_test.go#L658
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ReadDataSource6580 = [1] of {int};
	run TestGRPCProvider_ReadDataSource658(child_TestGRPCProvider_ReadDataSource6580)
stop_process:skip
}

proctype TestGRPCProvider_ReadDataSource658(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype getDatasourceSchema109(Wgdef p_TestServer_serveWG;Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Mutexdef p_PluginClient_config_Cmd_Process_sigMu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
