...
// https://github.com/hashicorp/terraform/blob/master/plugin6/grpc_provider_test.go#L691
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ReadDataSourceJSON6910 = [1] of {int};
	run TestGRPCProvider_ReadDataSourceJSON691(child_TestGRPCProvider_ReadDataSourceJSON6910)
stop_process:skip
}

proctype TestGRPCProvider_ReadDataSourceJSON691(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_ReadDataSource5340 = [1] of {int};
	Mutexdef p_mu;
...
proctype ReadDataSource534(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Mutexdef p_PluginClient_config_Cmd_Process_sigMu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_mu;chan child) {
	...
	run getDatasourceSchema109(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_PluginClient_config_Cmd_Process_sigMu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_mu,p_TestServer_quit_o_m,p_TestServer_done_o_m,p_TestServer_channelzRemoveOnce_m,p_mu,child_getDatasourceSchema1090);
	child_getDatasourceSchema1090?0;
	run getProviderMetaSchema120(p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_PluginClient_clientWaitGroup,p_PluginClient_config_Cmd_Process_sigMu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_mu,p_TestServer_quit_o_m,p_TestServer_done_o_m,p_TestServer_channelzRemoveOnce_m,p_mu,child_getProviderMetaSchema1201);
	...
	run decodeDynamicValue602(protoResp_State_state_atomicMessageInfo_initMu,child_decodeDynamicValue6022);
