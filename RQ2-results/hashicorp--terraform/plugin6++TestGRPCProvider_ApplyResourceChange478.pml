...
// https://github.com/hashicorp/terraform/blob/master/plugin6/grpc_provider_test.go#L478
typedef Wgdef {
...
init { 
	chan child_TestGRPCProvider_ApplyResourceChange4780 = [1] of {int};
	run TestGRPCProvider_ApplyResourceChange478(child_TestGRPCProvider_ApplyResourceChange4780)
stop_process:skip
}

proctype TestGRPCProvider_ApplyResourceChange478(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
