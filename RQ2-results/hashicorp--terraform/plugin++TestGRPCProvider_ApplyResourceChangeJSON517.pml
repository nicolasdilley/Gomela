...
// https://github.com/hashicorp/terraform/blob/master/plugin/grpc_provider_test.go#L517
typedef Wgdef {
...
proctype ApplyResourceChange444(Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Wgdef p_PluginClient_clientWaitGroup;Mutexdef p_PluginClient_config_Cmd_Process_sigMu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_mu;chan child) {
	...
	run getResourceSchema91(p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_PluginClient_clientWaitGroup,p_PluginClient_config_Cmd_Process_sigMu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_mu,p_TestServer_quit_o_m,p_TestServer_done_o_m,p_TestServer_channelzRemoveOnce_m,p_mu,child_getResourceSchema910);
	child_getResourceSchema910?0;
	run getProviderMetaSchema113(p_PluginClient_stderrWaitGroup,p_TestServer_serveWG,p_PluginClient_clientWaitGroup,p_PluginClient_config_Cmd_Process_sigMu,p_PluginClient_config_TLSConfig_mutex,p_PluginClient_l,p_PluginClient_process_sigMu,p_TestServer_mu,p_TestServer_quit_o_m,p_TestServer_done_o_m,p_TestServer_channelzRemoveOnce_m,p_mu,child_getProviderMetaSchema1131);
...
proctype getResourceSchema91(Wgdef p_PluginClient_stderrWaitGroup;Wgdef p_TestServer_serveWG;Wgdef p_PluginClient_clientWaitGroup;Mutexdef p_PluginClient_config_Cmd_Process_sigMu;Mutexdef p_PluginClient_config_TLSConfig_mutex;Mutexdef p_PluginClient_l;Mutexdef p_PluginClient_process_sigMu;Mutexdef p_TestServer_mu;Mutexdef p_TestServer_quit_o_m;Mutexdef p_TestServer_done_o_m;Mutexdef p_TestServer_channelzRemoveOnce_m;Mutexdef p_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
