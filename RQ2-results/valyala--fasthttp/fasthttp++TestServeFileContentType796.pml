...
// https://github.com/valyala/fasthttp/blob/master/fs_test.go#L796
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestServeFileContentType7960 = [1] of {int};
	run TestServeFileContentType796(child_TestServeFileContentType7960)
stop_process:skip
}

proctype TestServeFileContentType796(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
