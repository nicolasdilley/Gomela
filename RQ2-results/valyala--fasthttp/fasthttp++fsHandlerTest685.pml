#define filenames685  -2

// https://github.com/valyala/fasthttp/blob/master/fs_test.go#L685
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_fsHandlerTest6850 = [1] of {int};
	run fsHandlerTest685(filenames685,child_fsHandlerTest6850)
stop_process:skip
}

proctype fsHandlerTest685(int filenames;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
