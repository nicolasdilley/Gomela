...
// https://github.com/valyala/fasthttp/blob/master/fs_test.go#L26
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestNewVHostPathRewriter260 = [1] of {int};
	run TestNewVHostPathRewriter26(child_TestNewVHostPathRewriter260)
stop_process:skip
}

proctype TestNewVHostPathRewriter26(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
