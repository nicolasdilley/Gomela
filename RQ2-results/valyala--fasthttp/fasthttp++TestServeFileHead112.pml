...
// https://github.com/valyala/fasthttp/blob/master/fs_test.go#L112
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestServeFileHead1120 = [1] of {int};
	run TestServeFileHead112(child_TestServeFileHead1120)
stop_process:skip
}

proctype TestServeFileHead112(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
