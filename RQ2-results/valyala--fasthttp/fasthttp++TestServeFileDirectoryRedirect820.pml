...
// https://github.com/valyala/fasthttp/blob/master/fs_test.go#L820
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestServeFileDirectoryRedirect8200 = [1] of {int};
	run TestServeFileDirectoryRedirect820(child_TestServeFileDirectoryRedirect8200)
stop_process:skip
}

proctype TestServeFileDirectoryRedirect820(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
