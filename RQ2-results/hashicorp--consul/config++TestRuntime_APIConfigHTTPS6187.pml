...
// https://github.com/hashicorp/consul/blob/master/agent/config/runtime_test.go#L6187
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRuntime_APIConfigHTTPS61870 = [1] of {int};
	run TestRuntime_APIConfigHTTPS6187(child_TestRuntime_APIConfigHTTPS61870)
stop_process:skip
}

proctype TestRuntime_APIConfigHTTPS6187(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
