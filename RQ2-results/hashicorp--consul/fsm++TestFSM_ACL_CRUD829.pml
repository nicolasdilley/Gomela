...
// https://github.com/hashicorp/consul/blob/master/agent/consul/fsm/commands_oss_test.go#L829
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestFSM_ACL_CRUD829(chan child) {
	...
	child_Apply1181?0;
	run Apply118(fsm_stateLock,fsm_state_db_db_writer,fsm_state_lockDelay_lock,child_Apply1182);
	child_Apply1182?0;
	run Apply118(fsm_stateLock,fsm_state_db_db_writer,fsm_state_lockDelay_lock,child_Apply1183);
	child_Apply1183?0;
	stop_process: skip;
	child!0
}
