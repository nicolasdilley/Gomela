...
// https://github.com/rancher/rancher/blob/master/pkg/catalogv2/http/client.go#L12
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_HelmClient120 = [1] of {int};
	run HelmClient12(child_HelmClient120)
stop_process:skip
}

proctype HelmClient12(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
