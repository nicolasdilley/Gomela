...
// https://github.com/goharbor/harbor/blob/master/src/jobservice/hook/hook_client.go#L45
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_NewClient450 = [1] of {int};
	run NewClient45(child_NewClient450)
stop_process:skip
}

proctype NewClient45(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
