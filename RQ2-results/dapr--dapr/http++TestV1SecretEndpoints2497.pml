...
// https://github.com/dapr/dapr/blob/master/pkg/http/api_test.go#L2497
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestV1SecretEndpoints24970 = [1] of {int};
	run TestV1SecretEndpoints2497(child_TestV1SecretEndpoints24970)
stop_process:skip
}

proctype TestV1SecretEndpoints2497(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
