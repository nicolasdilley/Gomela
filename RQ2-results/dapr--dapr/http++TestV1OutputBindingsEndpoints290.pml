...
// https://github.com/dapr/dapr/blob/master/pkg/http/api_test.go#L290
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestV1OutputBindingsEndpoints2900 = [1] of {int};
	run TestV1OutputBindingsEndpoints290(child_TestV1OutputBindingsEndpoints2900)
stop_process:skip
}

proctype TestV1OutputBindingsEndpoints290(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
