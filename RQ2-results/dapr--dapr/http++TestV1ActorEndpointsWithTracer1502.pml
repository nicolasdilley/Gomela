...
// https://github.com/dapr/dapr/blob/master/pkg/http/api_test.go#L1502
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestV1ActorEndpointsWithTracer15020 = [1] of {int};
	run TestV1ActorEndpointsWithTracer1502(child_TestV1ActorEndpointsWithTracer15020)
stop_process:skip
}

proctype TestV1ActorEndpointsWithTracer1502(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
