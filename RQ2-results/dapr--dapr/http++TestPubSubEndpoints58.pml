...
// https://github.com/dapr/dapr/blob/master/pkg/http/api_test.go#L58
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPubSubEndpoints580 = [1] of {int};
	run TestPubSubEndpoints58(child_TestPubSubEndpoints580)
stop_process:skip
}

proctype TestPubSubEndpoints58(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
