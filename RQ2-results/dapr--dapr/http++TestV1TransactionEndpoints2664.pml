...
// https://github.com/dapr/dapr/blob/master/pkg/http/api_test.go#L2664
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestV1TransactionEndpoints26640 = [1] of {int};
	run TestV1TransactionEndpoints2664(child_TestV1TransactionEndpoints26640)
stop_process:skip
}

proctype TestV1TransactionEndpoints2664(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
