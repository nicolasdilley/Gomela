...
// https://github.com/istio/istio/blob/master/pilot/pkg/security/authn/v1beta1/policy_applier_test.go#L50
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestJwtFilter500 = [1] of {int};
	run TestJwtFilter50(child_TestJwtFilter500)
stop_process:skip
}

proctype TestJwtFilter50(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
