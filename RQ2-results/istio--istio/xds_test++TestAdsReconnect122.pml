...
// https://github.com/istio/istio/blob/master/pilot/pkg/xds/ads_test.go#L122
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestAdsReconnect122(chan child) {
	...
	Mutexdef ads2_conn_firstResolveEvent_o_m;
	Mutexdef ads2_conn_balancerWrapper_mu;
	Mutexdef ads2_conn_balancerWrapper_done_o_m;
	Mutexdef ads2_conn_balancerWrapper_scBuffer_mu;
	Mutexdef ads2_conn_balancerWrapper_balancerMu;
	Mutexdef ads2_conn_resolverWrapper_pollingMu;
	Mutexdef ads2_conn_resolverWrapper_done_o_m;
	Mutexdef ads2_conn_resolverWrapper_resolverMu;
	Mutexdef ads2_conn_mu;
	Mutexdef ads2_conn_safeConfigSelector_mu;
	Mutexdef ads2_conn_blockingpicker_mu;
	Mutexdef ads2_conn_csMgr_mu;
	...
	run mutexMonitor(ads2_conn_csMgr_mu);
	run mutexMonitor(ads2_conn_blockingpicker_mu);
	run mutexMonitor(ads2_conn_safeConfigSelector_mu);
	run mutexMonitor(ads2_conn_mu);
	run mutexMonitor(ads2_conn_resolverWrapper_resolverMu);
	run mutexMonitor(ads2_conn_resolverWrapper_done_o_m);
	run mutexMonitor(ads2_conn_resolverWrapper_pollingMu);
	run mutexMonitor(ads2_conn_balancerWrapper_balancerMu);
	run mutexMonitor(ads2_conn_balancerWrapper_scBuffer_mu);
	run mutexMonitor(ads2_conn_balancerWrapper_done_o_m);
	run mutexMonitor(ads2_conn_balancerWrapper_mu);
	run mutexMonitor(ads2_conn_firstResolveEvent_o_m);
