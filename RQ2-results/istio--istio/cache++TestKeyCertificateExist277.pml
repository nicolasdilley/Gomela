...
// https://github.com/istio/istio/blob/master/security/pkg/nodeagent/cache/secretcache_test.go#L277
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestKeyCertificateExist277(chan child) {
	...
	:: testCases-1 != -3 -> 
				for(i : 0.. testCases-1) {
			for10: skip;
			run keyCertificateExist376(sc_cache_mu,sc_generateMutex,sc_certWatcher_mu,sc_certMutex,sc_outputMutex,sc_configTrustBundleMutex,child_keyCertificateExist3760);
	...
	:: else -> 
		...
		:: true -> 
			for11: skip;
			run keyCertificateExist376(sc_cache_mu,sc_generateMutex,sc_certWatcher_mu,sc_certMutex,sc_outputMutex,sc_configTrustBundleMutex,child_keyCertificateExist3761);
...
proctype keyCertificateExist376(Mutexdef sc_cache_mu;Mutexdef sc_generateMutex;Mutexdef sc_certWatcher_mu;Mutexdef sc_certMutex;Mutexdef sc_outputMutex;Mutexdef sc_configTrustBundleMutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
