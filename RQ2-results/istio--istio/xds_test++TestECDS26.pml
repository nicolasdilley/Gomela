...
// https://github.com/istio/istio/blob/master/pilot/pkg/xds/ecds_test.go#L26
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestECDS26(chan child) {
	...
	bool state;
	int num_msgs;
	Mutexdef ec_TypedConfig_state_atomicMessageInfo_initMu;
	Mutexdef ec_state_atomicMessageInfo_initMu;
	...
	run mutexMonitor(ec_state_atomicMessageInfo_initMu);
	run mutexMonitor(ec_TypedConfig_state_atomicMessageInfo_initMu);
