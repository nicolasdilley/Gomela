...
// https://github.com/kubernetes/kops/blob/master/pkg/validation/validate_cluster_test.go#L71
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run testValidate71(groups71,child_testValidate710)
stop_process:skip
}

proctype testValidate71(int groups;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
