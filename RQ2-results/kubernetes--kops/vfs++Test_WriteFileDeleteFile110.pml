...
// https://github.com/kubernetes/kops/blob/master/util/pkg/vfs/vaultfs_test.go#L110
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Test_WriteFileDeleteFile110(chan child) {
	...
	run WriteFile66(p_vaultClient_modifyLock,p_vaultClient_config_modifyLock,p_vaultClient_config_Limiter_mu,child_WriteFile661);
	child_WriteFile661?0;
	run Remove109(p_vaultClient_modifyLock,p_vaultClient_config_modifyLock,p_vaultClient_config_Limiter_mu,child_Remove1092);
	child_Remove1092?0;
	run ReadFile93(p_vaultClient_modifyLock,p_vaultClient_config_modifyLock,p_vaultClient_config_Limiter_mu,child_ReadFile933);
	child_ReadFile933?0;
	stop_process: skip;
	child!0
}
...
proctype Remove109(Mutexdef p_vaultClient_modifyLock;Mutexdef p_vaultClient_config_modifyLock;Mutexdef p_vaultClient_config_Limiter_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype ReadFile93(Mutexdef p_vaultClient_modifyLock;Mutexdef p_vaultClient_config_modifyLock;Mutexdef p_vaultClient_config_Limiter_mu;chan child) {
	...
	run dataPath221(p_vaultClient_modifyLock,p_vaultClient_config_modifyLock,p_vaultClient_config_Limiter_mu,child_dataPath2213);
