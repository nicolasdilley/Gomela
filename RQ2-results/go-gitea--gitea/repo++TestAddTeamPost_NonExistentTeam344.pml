...
// https://github.com/go-gitea/gitea/blob/master/routers/repo/settings_test.go#L344
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestAddTeamPost_NonExistentTeam3440 = [1] of {int};
	run TestAddTeamPost_NonExistentTeam344(child_TestAddTeamPost_NonExistentTeam3440)
stop_process:skip
}

proctype TestAddTeamPost_NonExistentTeam344(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
