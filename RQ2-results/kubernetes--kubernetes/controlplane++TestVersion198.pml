...
// https://github.com/kubernetes/kubernetes/blob/master/pkg/controlplane/instance_test.go#L198
typedef Wgdef {
...
proctype TestVersion198(chan child) {
	...
	Mutexdef s_GenericAPIServer_Handler_GoRestfulContainer_ServeMux_mu;
	...
	run mutexMonitor(s_GenericAPIServer_Handler_GoRestfulContainer_ServeMux_mu);
