...
// https://github.com/kubernetes/kubernetes/blob/master/pkg/kubelet/dockershim/docker_sandbox_test.go#L247
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestHostNetworkPluginInvocation2470 = [1] of {int};
	run TestHostNetworkPluginInvocation247(child_TestHostNetworkPluginInvocation2470)
stop_process:skip
}

proctype TestHostNetworkPluginInvocation247(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
