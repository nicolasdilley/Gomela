#define numRelists283  1

// https://github.com/kubernetes/kubernetes/blob/master/pkg/kubelet/pleg/generic_test.go#L283
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run testReportMissingPods283(numRelists283,child_testReportMissingPods2830)
stop_process:skip
}

proctype testReportMissingPods283(int numRelists;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
