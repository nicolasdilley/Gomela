#define TestPriorityLevelIsolation_concurrencyShares  1
#define TestPriorityLevelIsolation_queueLength  0
#define not_found_110  1
#define not_found_117  0

// https://github.com/kubernetes/kubernetes/blob/master/test/integration/apiserver/flowcontrol/concurrency_test.go#L70
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestPriorityLevelIsolation70(chan child) {
	...
	int concurrencyShares = TestPriorityLevelIsolation_concurrencyShares;
	int queueLength = TestPriorityLevelIsolation_queueLength;
