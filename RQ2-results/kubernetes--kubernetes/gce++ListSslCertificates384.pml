...
// https://github.com/kubernetes/kubernetes/blob/master/test/e2e/framework/providers/gce/ingress.go#L384
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype ListSslCertificates384(chan child) {
	...
	run ListSslCertificates384(gceCloud_ClusterID_idLock,gceCloud_subnetworkURLAndIsLegacyNetworkInitializer_m,gceCloud_computeNodeTagLock,gceCloud_nodeZonesLock,gceCloud_sharedResourceLock,child_ListSslCertificates3840);
