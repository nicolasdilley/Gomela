...
// https://github.com/kubernetes/kubernetes/blob/master/test/integration/auth/rbac_test.go#L696
typedef Wgdef {
...
init { 
	chan child_TestDiscoveryUpgradeBootstrapping6960 = [1] of {int};
	run TestDiscoveryUpgradeBootstrapping696(child_TestDiscoveryUpgradeBootstrapping6960)
stop_process:skip
}

proctype TestDiscoveryUpgradeBootstrapping696(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
