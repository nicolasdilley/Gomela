...
// https://github.com/kubernetes/kubernetes/blob/master/pkg/volume/awsebs/aws_util.go#L53
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype DeleteVolume53(chan child) {
	...
	run DeleteDisk274(cloud_instanceCache_mutex,cloud_attachingMutex,child_DeleteDisk2740);
...
proctype DeleteDisk274(Mutexdef testcase_instanceCache_mutex;Mutexdef testcase_attachingMutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
