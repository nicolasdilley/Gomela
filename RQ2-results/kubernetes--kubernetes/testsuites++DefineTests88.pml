...
// https://github.com/kubernetes/kubernetes/blob/master/test/e2e/storage/testsuites/volumelimits.go#L88
typedef Wgdef {
...
proctype DefineTests88(chan child) {
	...
	Mutexdef l_resource_Config_Framework_flakeReport_lock;
	Wgdef l_resource_Config_Framework_logsSizeVerifier_wg;
	Mutexdef l_resource_Config_Framework_logsSizeVerifier_data_lock;
	Wgdef l_resource_Config_Framework_logsSizeWaitGroup;
	Wgdef l_resource_Config_Framework_gatherer_workerWg;
	...
	run wgMonitor(l_resource_Config_Framework_gatherer_workerWg);
	run wgMonitor(l_resource_Config_Framework_logsSizeWaitGroup);
	run mutexMonitor(l_resource_Config_Framework_logsSizeVerifier_data_lock);
	run wgMonitor(l_resource_Config_Framework_logsSizeVerifier_wg);
	run mutexMonitor(l_resource_Config_Framework_flakeReport_lock);
