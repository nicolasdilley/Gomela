...
// https://github.com/kubernetes/kubernetes/blob/master/pkg/controlplane/instance_test.go#L169
typedef Wgdef {
...
init { 
	chan child_TestCertificatesRestStorageStrategies1690 = [1] of {int};
	run TestCertificatesRestStorageStrategies169(child_TestCertificatesRestStorageStrategies1690)
stop_process:skip
}

proctype TestCertificatesRestStorageStrategies169(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
