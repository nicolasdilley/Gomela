...
// https://github.com/jaegertracing/jaeger/blob/master/cmd/query/app/server_test.go#L547
typedef Wgdef {
...
init { 
	chan child_TestServerBadHostPort5470 = [1] of {int};
	run TestServerBadHostPort547(child_TestServerBadHostPort5470)
stop_process:skip
}

proctype TestServerBadHostPort547(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
