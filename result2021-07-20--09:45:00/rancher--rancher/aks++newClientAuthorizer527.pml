...
// git_link=https://github.com/rancher/rancher/blob/91a6f51f259acd5670ff167d6bcf1916da7406f1/pkg/kontainer-engine/drivers/aks/aks_driver.go#L527
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_newClientAuthorizer5270)
stop_process:skip
}
