...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/states/statemgr/filesystem_test.go#L29
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestFilesystemRace290)
stop_process:skip
}
...
proctype TestFilesystemRace29(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousTestFilesystemRace39360);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
