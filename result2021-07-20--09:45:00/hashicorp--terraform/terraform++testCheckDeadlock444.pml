...
proctype testCheckDeadlock444(chan child) {
	...
	run AnonymoustestCheckDeadlock448447(done_ch,timeout_ch,child_AnonymoustestCheckDeadlock4484470);
...
proctype AnonymoustestCheckDeadlock448447(Chandef done_ch;Chandef timeout_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
