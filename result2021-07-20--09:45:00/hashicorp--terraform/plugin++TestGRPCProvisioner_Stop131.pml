...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/plugin/grpc_provisioner_test.go#L131
typedef Wgdef {
...
proctype TestGRPCProvisioner_Stop131(chan child) {
	...
	run Stop157(p_PluginClient_clientWaitGroup,p_PluginClient_stderrWaitGroup,p_mu,p_PluginClient_l,child_Stop1570);
	child_Stop1570?0;
	stop_process: skip;
	child!0
}
proctype Stop157(Wgdef p_PluginClient_clientWaitGroup;Wgdef p_PluginClient_stderrWaitGroup;Mutexdef p_mu;Mutexdef p_PluginClient_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
