...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/plugin/grpc_provider_test.go#L345
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestGRPCProvider_PlanResourceChange3450)
stop_process:skip
}
