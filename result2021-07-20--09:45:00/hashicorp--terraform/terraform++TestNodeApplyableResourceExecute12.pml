...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/terraform/node_resource_apply_test.go#L12
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestNodeApplyableResourceExecute120 = [1] of {int};
	run TestNodeApplyableResourceExecute12(child_TestNodeApplyableResourceExecute120);
	run receiver(child_TestNodeApplyableResourceExecute120)
stop_process:skip
}

proctype TestNodeApplyableResourceExecute12(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
