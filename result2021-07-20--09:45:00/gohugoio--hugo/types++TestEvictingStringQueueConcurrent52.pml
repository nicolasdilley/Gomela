...
// git_link=https://github.com/gohugoio/hugo/blob/64f88f3011de5a510d8e6d6bad8ac4a091b11c0c/common/types/evictingqueue_test.go#L52
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestEvictingStringQueueConcurrent520)
stop_process:skip
}
...
proctype TestEvictingStringQueueConcurrent52(chan child) {
	...
	run mutexMonitor(queue_mu);
		...
		run receiver(child_AnonymousTestEvictingStringQueueConcurrent60530);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
