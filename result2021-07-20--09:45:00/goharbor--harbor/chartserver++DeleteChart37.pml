...
#define var_qSize64  ?? // mand qSize line 64
#define var_allVersions67  ?? // mand allVersions line 67
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype DeleteChart37(chan child) {
	...
	int var_allVersions = var_allVersions67; // mand var_allVersions
	int var_qSize = var_qSize64; // mand var_qSize
