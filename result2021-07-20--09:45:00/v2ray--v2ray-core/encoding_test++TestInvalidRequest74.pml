...
// git_link=https://github.com/v2ray/v2ray-core/blob/5dffca84234a74da9e8174f1e0b0af3dfb2a58ce/proxy/vmess/encoding/encoding_test.go#L74
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestInvalidRequest740 = [1] of {int};
	run TestInvalidRequest74(child_TestInvalidRequest740);
	run receiver(child_TestInvalidRequest740)
stop_process:skip
}

proctype TestInvalidRequest74(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
