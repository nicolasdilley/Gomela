...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L724
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContext_QueryString7240 = [1] of {int};
	run TestContext_QueryString724(child_TestContext_QueryString7240);
	run receiver(child_TestContext_QueryString7240)
stop_process:skip
}

proctype TestContext_QueryString724(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
