...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L269
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestBindUnmarshalParam2690 = [1] of {int};
	run TestBindUnmarshalParam269(child_TestBindUnmarshalParam2690);
	run receiver(child_TestBindUnmarshalParam2690)
stop_process:skip
}

proctype TestBindUnmarshalParam269(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
