...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/echo_test.go#L324
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEchoWrapHandler3240 = [1] of {int};
	run TestEchoWrapHandler324(child_TestEchoWrapHandler3240);
	run receiver(child_TestEchoWrapHandler3240)
stop_process:skip
}

proctype TestEchoWrapHandler324(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
