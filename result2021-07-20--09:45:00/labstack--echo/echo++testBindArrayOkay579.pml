...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L579
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_testBindArrayOkay5790 = [1] of {int};
	run testBindArrayOkay579(child_testBindArrayOkay5790);
	run receiver(child_testBindArrayOkay5790)
stop_process:skip
}

proctype testBindArrayOkay579(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
