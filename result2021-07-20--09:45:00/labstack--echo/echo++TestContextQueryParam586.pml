...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L586
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextQueryParam5860 = [1] of {int};
	run TestContextQueryParam586(child_TestContextQueryParam5860);
	run receiver(child_TestContextQueryParam5860)
stop_process:skip
}

proctype TestContextQueryParam586(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
