...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/bind_test.go#L164
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestToMultipleFields1640 = [1] of {int};
	run TestToMultipleFields164(child_TestToMultipleFields1640);
	run receiver(child_TestToMultipleFields1640)
stop_process:skip
}

proctype TestToMultipleFields164(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
