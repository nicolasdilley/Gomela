...
proctype TestWatchPrefix188(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousTestWatchPrefix1951911 = [1] of {int};
	Chandef ch_ch;
	...
	run AnonymousTestWatchPrefix195191(watchPrefixReturned_ch,ch_ch,err_ch,event_ch,child_AnonymousTestWatchPrefix1951911);
	run receiver(child_AnonymousTestWatchPrefix1951911);
...
proctype AnonymousTestWatchPrefix195191(Chandef watchPrefixReturned_ch;Chandef ch_ch;Chandef err_ch;Chandef event_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
