...
// git_link=https://github.com/valyala/fasthttp/blob/19fcd408632d6dae8425ae95c6c62a25c823ff81/fs_test.go#L480
#define var_concurrency496  ?? // mand concurrency line 496
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestFSCompressConcurrent480(chan child) {
	...
	Mutexdef fs_once_m;
	Chandef stop_ch;
	int var_concurrency = var_concurrency496; // mand var_concurrency
	...
	:: else -> 
		...
		for10: skip;
		run AnonymousTestFSCompressConcurrent498483(stop_ch,ch_ch,fs_once_m,child_AnonymousTestFSCompressConcurrent4984831);
		run receiver(child_AnonymousTestFSCompressConcurrent4984831);
		for10_end: skip
	};
	for10_exit: skip;
...
proctype AnonymousTestFSCompressConcurrent498483(Chandef stop_ch;Chandef ch_ch;Mutexdef fs_once_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
