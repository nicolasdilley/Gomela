...
// git_link=https://github.com/fyne-io/fyne/blob/9b5a176fe1dc80beae72a3074d0d5cd2b409637c/internal/preferences_test.go#L79
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPrefs_Int790 = [1] of {int};
	run TestPrefs_Int79(child_TestPrefs_Int790);
	run receiver(child_TestPrefs_Int790)
stop_process:skip
}

proctype TestPrefs_Int79(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
