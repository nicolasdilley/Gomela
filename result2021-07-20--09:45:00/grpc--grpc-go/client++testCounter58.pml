...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/requests_counter_test.go#L58
#define var_test_numRequests61  ?? // mand test.numRequests line 61
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype testCounter58(chan child) {
	...
	int var_test_numRequests = var_test_numRequests61; // mand var_test_numRequests
