...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_cluster_test.go#L368
#define not_found_405  -2 // opt updates line 178
#define not_found_417  -2 // opt updates line 178
#define not_found_430  -2 // opt updates line 178
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestClusterResourceRemoved3680 = [1] of {int};
	run TestClusterResourceRemoved368(child_TestClusterResourceRemoved3680);
	run receiver(child_TestClusterResourceRemoved3680)
stop_process:skip
}

proctype TestClusterResourceRemoved368(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Close6210 = [1] of {int};
	chan child_NewClusters1785 = [1] of {int};
	chan child_NewClusters1784 = [1] of {int};
	chan child_NewClusters1783 = [1] of {int};
	chan child_WatchCluster2652 = [1] of {int};
	...
	run WatchCluster265(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,child_WatchCluster2652);
	child_WatchCluster2652?0;
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_405,child_NewClusters1783);
	child_NewClusters1783?0;
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_417,child_NewClusters1784);
	child_NewClusters1784?0;
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_430,child_NewClusters1785);
	child_NewClusters1785?0;
		defer1: skip;
...
proctype NewClusters178(Mutexdef c_cc_lceMu;Mutexdef c_cc_mu;Mutexdef c_lrsMu;Mutexdef c_mu;Mutexdef c_updateCh_mu;int updates;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	int var_c_cdsCachec_cdsCache = -2; // opt var_c_cdsCachec_cdsCache
