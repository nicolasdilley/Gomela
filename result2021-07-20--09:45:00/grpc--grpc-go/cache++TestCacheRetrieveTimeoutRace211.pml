...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/internal/cache/timeoutCache_test.go#L211
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run receiver(child_TestCacheRetrieveTimeoutRace2110)
stop_process:skip
}
...
proctype TestCacheRetrieveTimeoutRace211(chan child) {
	...
	run AnonymousTestCacheRetrieveTimeoutRace215214(done_ch,c_mu,child_AnonymousTestCacheRetrieveTimeoutRace2152140);
	run receiver(child_AnonymousTestCacheRetrieveTimeoutRace2152140);
	do
	:: true -> 
		break
...
proctype AnonymousTestCacheRetrieveTimeoutRace215214(Chandef done_ch;Mutexdef c_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
