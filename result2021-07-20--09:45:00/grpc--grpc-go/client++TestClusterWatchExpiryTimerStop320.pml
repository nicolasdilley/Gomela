...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_cluster_test.go#L320
#define not_found_347  -2 // opt updates line 178
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestClusterWatchExpiryTimerStop3200 = [1] of {int};
	run TestClusterWatchExpiryTimerStop320(child_TestClusterWatchExpiryTimerStop3200);
	run receiver(child_TestClusterWatchExpiryTimerStop3200)
stop_process:skip
}

proctype TestClusterWatchExpiryTimerStop320(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_347,child_NewClusters1782);
