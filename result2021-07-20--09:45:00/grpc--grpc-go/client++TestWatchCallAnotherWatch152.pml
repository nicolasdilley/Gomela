...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/client_test.go#L152
#define not_found_187  -2 // opt updates line 178
#define not_found_193  -2 // opt updates line 178
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestWatchCallAnotherWatch1520 = [1] of {int};
	run TestWatchCallAnotherWatch152(child_TestWatchCallAnotherWatch1520);
	run receiver(child_TestWatchCallAnotherWatch1520)
stop_process:skip
}

proctype TestWatchCallAnotherWatch152(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_187,child_NewClusters1782);
	child_NewClusters1782?0;
	run NewClusters178(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_193,child_NewClusters1783);
