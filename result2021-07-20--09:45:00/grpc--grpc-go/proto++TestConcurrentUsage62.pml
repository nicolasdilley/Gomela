...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/encoding/proto/proto_test.go#L62
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestConcurrentUsage620)
stop_process:skip
}
...
proctype TestConcurrentUsage62(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousTestConcurrentUsage82770);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
