...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/client/watchers_listener_test.go#L37
#define not_found_64  -2 // opt updates line 77
#define not_found_70  -2 // opt updates line 77
#define not_found_80  -2 // opt updates line 77
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestLDSWatch370 = [1] of {int};
	run TestLDSWatch37(child_TestLDSWatch370);
	run receiver(child_TestLDSWatch370)
stop_process:skip
}

proctype TestLDSWatch37(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run NewListeners77(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_64,child_NewListeners772);
	child_NewListeners772?0;
	run NewListeners77(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_70,child_NewListeners773);
	child_NewListeners773?0;
	run NewListeners77(client_cc_lceMu,client_cc_mu,client_lrsMu,client_mu,client_updateCh_mu,not_found_80,child_NewListeners774);
