...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L1691
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextShouldBindHeader16910 = [1] of {int};
	run TestContextShouldBindHeader1691(child_TestContextShouldBindHeader16910);
	run receiver(child_TestContextShouldBindHeader16910)
stop_process:skip
}

proctype TestContextShouldBindHeader1691(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
