...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L700
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextRenderJSONP7000 = [1] of {int};
	run TestContextRenderJSONP700(child_TestContextRenderJSONP7000);
	run receiver(child_TestContextRenderJSONP7000)
stop_process:skip
}

proctype TestContextRenderJSONP700(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
