...
// git_link=https://github.com/k6io/k6/blob/af1e032ebf949cde092d4a2eddb78528ea0a5864/lib/netext/httpext/tracer_test.go#L255
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestTracerError2550)
stop_process:skip
}
