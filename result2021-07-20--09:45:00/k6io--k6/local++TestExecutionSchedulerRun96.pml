...
// git_link=https://github.com/k6io/k6/blob/af1e032ebf949cde092d4a2eddb78528ea0a5864/core/local/local_test.go#L96
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestExecutionSchedulerRun96(chan child) {
	...
	run AnonymousTestExecutionSchedulerRun102101(err_ch,execScheduler_initProgress_mutex,execScheduler_state_pauseStateLock,child_AnonymousTestExecutionSchedulerRun1021010);
	run receiver(child_AnonymousTestExecutionSchedulerRun1021010);
...
proctype AnonymousTestExecutionSchedulerRun102101(Chandef err_ch;Mutexdef execScheduler_initProgress_mutex;Mutexdef execScheduler_state_pauseStateLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
