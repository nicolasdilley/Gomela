...
proctype TestConfig52(chan child) {
	...
	Mutexdef cfg_lock;
	int var_invalidKeysinvalidKeys = -2; // opt var_invalidKeysinvalidKeys
	int var_requiredKeysrequiredKeys = -2; // opt var_requiredKeysrequiredKeys
	int var_expectedErrorsexpectedErrors = -2; // opt var_expectedErrorsexpectedErrors
