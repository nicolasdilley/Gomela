...
// git_link=https://github.com/hashicorp/packer/blob/a9c2283ee589b203c0ce16174a5747b7d2053d61/packer/plugin_client.go#L76
#define var_managedClients83  ?? // mand managedClients line 83
typedef Wgdef {
...
proctype CleanupClients76(chan child) {
	...
	Wgdef wg;
	int var_managedClients = var_managedClients83; // mand var_managedClients
	run wgMonitor(wg);
