...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/agent/consul/stream/event_publisher_test.go#L477
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestEventPublisher_Unsubscribe_ClosesSubscription4770)
stop_process:skip
}
