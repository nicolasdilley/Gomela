...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/tlsutil/config_test.go#L929
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestConfigurator_OutgoingRPCConfig9290)
stop_process:skip
}
