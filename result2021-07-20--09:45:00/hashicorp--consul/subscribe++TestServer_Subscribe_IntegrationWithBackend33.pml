...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/agent/rpc/subscribe/subscribe_test.go#L33
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestServer_Subscribe_IntegrationWithBackend330 = [1] of {int};
	run TestServer_Subscribe_IntegrationWithBackend33(child_TestServer_Subscribe_IntegrationWithBackend330);
	run receiver(child_TestServer_Subscribe_IntegrationWithBackend330)
stop_process:skip
}

proctype TestServer_Subscribe_IntegrationWithBackend33(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
