...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/console/console_test.go#L287
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPrettyError2870 = [1] of {int};
	run TestPrettyError287(child_TestPrettyError2870);
	run receiver(child_TestPrettyError2870)
stop_process:skip
}

proctype TestPrettyError287(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
