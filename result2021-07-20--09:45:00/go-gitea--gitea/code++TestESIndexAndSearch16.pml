...
// git_link=https://github.com/go-gitea/gitea/blob/ed393779004335a0afcca0dfac48937db41fabd6/modules/indexer/code/elastic_search_test.go#L16
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype testIndexer20(Mutexdef indexer_client_connsMu;Mutexdef indexer_client_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_resres = -2; // opt var_resres
	int var_keywordskeywords = -2; // opt var_keywordskeywords
	stop_process: skip;
	child!0
}
