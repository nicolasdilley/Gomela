...
proctype testBarrier_Rotate252(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	...
	child_Unseal4222?0;
	run ActiveKeyInfo703(b_cacheLock,b_l,child_ActiveKeyInfo7033);
	child_ActiveKeyInfo7033?0;
	run Put780(b_cacheLock,b_l,child_Put7804);
	child_Put7804?0;
	run Rotate548(b_cacheLock,b_l,child_Rotate5485);
	child_Rotate5485?0;
	run ActiveKeyInfo703(b_cacheLock,b_l,child_ActiveKeyInfo7036);
	child_ActiveKeyInfo7036?0;
	run Put780(b_cacheLock,b_l,child_Put7807);
	child_Put7807?0;
...
proctype ActiveKeyInfo703(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
