...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/activity_log_test.go#L775
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestActivityLog_getLastEntitySegmentNumber7750)
stop_process:skip
}
...
proctype TestActivityLog_getLastEntitySegmentNumber775(chan child) {
	...
	int var_pathspaths = -2; // opt var_pathspaths
	...
	:: else -> 
		...
		:: true -> 
			for23: skip;
			run getLastEntitySegmentNumber432(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_getLastEntitySegmentNumber4323);
...
proctype getLastEntitySegmentNumber432(Mutexdef a_core_allLoggersLock;Mutexdef a_core_auditLock;Mutexdef a_core_authLock;Mutexdef a_core_clusterParamsLock;Mutexdef a_core_generateRootLock;Mutexdef a_core_leaderParamsLock;Mutexdef a_core_metricsMutex;Mutexdef a_core_mountsLock;Mutexdef a_core_rekeyLock;Mutexdef a_core_reloadFuncsLock;Mutexdef a_core_requestForwardingConnectionLock;Mutexdef a_core_unsealWithStoredKeysLock;Mutexdef a_fragmentLock;Mutexdef a_l;Mutexdef a_view_readOnlyErrLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_List532 = [1] of {int};
	int var_pp = -2; // opt var_pp
