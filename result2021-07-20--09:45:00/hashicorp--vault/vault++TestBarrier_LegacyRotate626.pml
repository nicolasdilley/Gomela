...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/barrier_aes_gcm_test.go#L626
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestBarrier_LegacyRotate6260)
stop_process:skip
}
...
proctype TestBarrier_LegacyRotate626(chan child) {
	...
	child_Unseal4222?0;
	run persistKeyring210(b1_cacheLock,b1_l,child_persistKeyring2103);
	child_persistKeyring2103?0;
	run Seal534(b1_cacheLock,b1_l,child_Seal5344);
	child_Seal5344?0;
	run Unseal422(b1_cacheLock,b1_l,child_Unseal4225);
	child_Unseal4225?0;
	run CheckBarrierAutoRotate1141(b1_cacheLock,b1_l,child_CheckBarrierAutoRotate11416);
...
proctype CheckBarrierAutoRotate1141(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	if
	:: true -> 
		run RotationConfig91(b_cacheLock,b_l,child_RotationConfig916);
		...
		if
		:: true -> 
			run encryptions1214(b_cacheLock,b_l,child_encryptions12147);
	...
	if
	:: true -> 
		run persistEncryptions1190(b_cacheLock,b_l,child_persistEncryptions11908);
...
proctype RotationConfig91(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype encryptions1214(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype persistEncryptions1190(Mutexdef b_cacheLock;Mutexdef b_l;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	:: true -> 
		...
		if
		:: true -> 
			run persistKeyring210(b_cacheLock,b_l,child_persistKeyring2108);
