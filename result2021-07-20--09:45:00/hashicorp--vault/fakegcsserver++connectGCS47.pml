...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/helper/testhelpers/fakegcsserver/fake-gcs-server.go#L47
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_connectGCS470)
stop_process:skip
}
