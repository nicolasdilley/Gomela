...
#define not_found_270  -2 // opt txns line 1214
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRaft_TransactionalBackend_LargeValue253(chan child) {
	...
	chan child_Transaction12140 = [1] of {int};
	...
	run Transaction1214(b_autopilot_execLock,b_autopilot_stateLock,b_followerStates_l,b_fsm_l,b_l,b_raft_lastContactLock,b_raft_leaderLock,b_raft_observersLock,b_raft_shutdownLock,b_streamLayer_closeLock,not_found_270,child_Transaction12140);
	child_Transaction12140?0;
...
proctype Transaction1214(Mutexdef b_autopilot_execLock;Mutexdef b_autopilot_stateLock;Mutexdef b_followerStates_l;Mutexdef b_fsm_l;Mutexdef b_l;Mutexdef b_raft_lastContactLock;Mutexdef b_raft_leaderLock;Mutexdef b_raft_observersLock;Mutexdef b_raft_shutdownLock;Mutexdef b_streamLayer_closeLock;int txns;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
