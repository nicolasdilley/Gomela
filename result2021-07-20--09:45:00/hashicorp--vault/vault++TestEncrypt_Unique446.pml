...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/barrier_aes_gcm_test.go#L446
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEncrypt_Unique4460 = [1] of {int};
	run TestEncrypt_Unique446(child_TestEncrypt_Unique4460);
	run receiver(child_TestEncrypt_Unique4460)
stop_process:skip
}

proctype TestEncrypt_Unique446(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
