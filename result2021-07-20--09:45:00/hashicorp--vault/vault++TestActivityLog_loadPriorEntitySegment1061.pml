...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/activity_log_test.go#L1061
typedef Wgdef {
...
init { 
	chan child_TestActivityLog_loadPriorEntitySegment10610 = [1] of {int};
	run TestActivityLog_loadPriorEntitySegment1061(child_TestActivityLog_loadPriorEntitySegment10610);
	run receiver(child_TestActivityLog_loadPriorEntitySegment10610)
stop_process:skip
}

proctype TestActivityLog_loadPriorEntitySegment1061(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_GetActiveEntities404 = [1] of {int};
	chan child_loadPriorEntitySegment5173 = [1] of {int};
	chan child_GetActiveEntities406 = [1] of {int};
	chan child_loadPriorEntitySegment5175 = [1] of {int};
	chan child_WriteToStorage631 = [1] of {int};
	chan child_WriteToStorage632 = [1] of {int};
	chan child_SetEnable1870 = [1] of {int};
	...
	:: var_testCases-1 != -3 -> 
			...
			run loadPriorEntitySegment517(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_loadPriorEntitySegment5173);
			child_loadPriorEntitySegment5173?0;
			run GetActiveEntities40(core_rollback_inflightAll,core_activityLog_fragmentLock,core_activityLog_l,core_allLoggersLock,core_auditLock,core_authLock,core_clusterParamsLock,core_expiration_pendingLock,core_expiration_restoreModeLock,core_expiration_restoreRequestLock,core_generateRootLock,core_identityStore_groupLock,core_identityStore_lock,core_identityStore_oidcLock,core_leaderParamsLock,core_metricsMutex,core_mountsLock,core_pendingRaftPeers_mu,core_pluginCatalog_lock,core_policyStore_modifyLock,core_quotaManager_lock,core_raftFollowerStates_l,core_rekeyLock,core_reloadFuncsLock,core_requestForwardingConnectionLock,core_rollback_inflightLock,core_rollback_shutdownLock,core_router_l,core_rpcClientConn_mu,core_systemBackend_mfaLock,core_systemBarrierView_readOnlyErrLock,core_tokenStore_saltLock,core_uiConfig_l,core_unsealWithStoredKeysLock,child_GetActiveEntities404);
			child_GetActiveEntities404?0;
			for20_end: skip
		};
		for20_exit: skip
	:: else -> 
		...
		:: true -> 
			...
			run loadPriorEntitySegment517(a_core_allLoggersLock,a_core_auditLock,a_core_authLock,a_core_clusterParamsLock,a_core_generateRootLock,a_core_leaderParamsLock,a_core_metricsMutex,a_core_mountsLock,a_core_rekeyLock,a_core_reloadFuncsLock,a_core_requestForwardingConnectionLock,a_core_unsealWithStoredKeysLock,a_fragmentLock,a_l,a_view_readOnlyErrLock,child_loadPriorEntitySegment5175);
			child_loadPriorEntitySegment5175?0;
			run GetActiveEntities40(core_rollback_inflightAll,core_activityLog_fragmentLock,core_activityLog_l,core_allLoggersLock,core_auditLock,core_authLock,core_clusterParamsLock,core_expiration_pendingLock,core_expiration_restoreModeLock,core_expiration_restoreRequestLock,core_generateRootLock,core_identityStore_groupLock,core_identityStore_lock,core_identityStore_oidcLock,core_leaderParamsLock,core_metricsMutex,core_mountsLock,core_pendingRaftPeers_mu,core_pluginCatalog_lock,core_policyStore_modifyLock,core_quotaManager_lock,core_raftFollowerStates_l,core_rekeyLock,core_reloadFuncsLock,core_requestForwardingConnectionLock,core_rollback_inflightLock,core_rollback_shutdownLock,core_router_l,core_rpcClientConn_mu,core_systemBackend_mfaLock,core_systemBarrierView_readOnlyErrLock,core_tokenStore_saltLock,core_uiConfig_l,core_unsealWithStoredKeysLock,child_GetActiveEntities406);
			child_GetActiveEntities406?0;
			for25_end: skip
		:: true -> 
			break
		od;
...
proctype SetEnable187(Mutexdef a_core_allLoggersLock;Mutexdef a_core_auditLock;Mutexdef a_core_authLock;Mutexdef a_core_clusterParamsLock;Mutexdef a_core_generateRootLock;Mutexdef a_core_leaderParamsLock;Mutexdef a_core_metricsMutex;Mutexdef a_core_mountsLock;Mutexdef a_core_rekeyLock;Mutexdef a_core_reloadFuncsLock;Mutexdef a_core_requestForwardingConnectionLock;Mutexdef a_core_unsealWithStoredKeysLock;Mutexdef a_fragmentLock;Mutexdef a_l;Mutexdef a_view_readOnlyErrLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype loadPriorEntitySegment517(Mutexdef a_core_allLoggersLock;Mutexdef a_core_auditLock;Mutexdef a_core_authLock;Mutexdef a_core_clusterParamsLock;Mutexdef a_core_generateRootLock;Mutexdef a_core_leaderParamsLock;Mutexdef a_core_metricsMutex;Mutexdef a_core_mountsLock;Mutexdef a_core_rekeyLock;Mutexdef a_core_reloadFuncsLock;Mutexdef a_core_requestForwardingConnectionLock;Mutexdef a_core_unsealWithStoredKeysLock;Mutexdef a_fragmentLock;Mutexdef a_l;Mutexdef a_view_readOnlyErrLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
