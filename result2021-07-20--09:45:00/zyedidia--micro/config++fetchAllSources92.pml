...
proctype fetchAllSources92(int count;chan child) {
	...
	for10_exit: skip;
	run AnonymousfetchAllSources10796(results_ch,wgDone,wgQuery,child_AnonymousfetchAllSources107962);
...
proctype AnonymousfetchAllSources10796(Chandef results_ch;Wgdef wgDone;Wgdef wgQuery;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
