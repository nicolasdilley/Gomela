...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/statistics/scalar.go#L175
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_enumRangeValues1750)
stop_process:skip
}
...
proctype enumRangeValues175(chan child) {
	...
	int var_int64_0_int64_0_ = -2; // opt var_int64_0_int64_0_
	int var_remainingremaining = -2; // opt var_remainingremaining
