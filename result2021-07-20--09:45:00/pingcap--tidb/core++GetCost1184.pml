...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/planner/core/task.go#L1184
typedef Wgdef {
...
init { 
	chan child_GetCost11840 = [1] of {int};
	run GetCost1184(child_GetCost11840);
	run receiver(child_GetCost11840)
stop_process:skip
}

proctype GetCost1184(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
