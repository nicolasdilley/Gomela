...
proctype getPhysicalPlan299(chan child) {
	...
	int var_cachedVal_TblInfo2UnionScancachedVal_TblInfo2UnionScan = -2; // opt var_cachedVal_TblInfo2UnionScancachedVal_TblInfo2UnionScan
	int var_cachedValscachedVals = -2; // opt var_cachedValscachedVals
	int var_e_UsingVarse_UsingVars = -2; // opt var_e_UsingVarse_UsingVars
