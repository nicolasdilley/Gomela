...
proctype Load145(Mutexdef cfg_EtcdClient_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_tiPlugins_pluginsLkindLLiL_SysVarstiPlugins_pluginsLkindLLiL_SysVars = -2; // opt var_tiPlugins_pluginsLkindLLiL_SysVarstiPlugins_pluginsLkindLLiL_SysVars
	int var_tiPlugins_pluginstiPlugins_plugins = -2; // opt var_tiPlugins_pluginstiPlugins_plugins
	int var_cfg_Pluginscfg_Plugins = -2; // opt var_cfg_Pluginscfg_Plugins
	int var_cfg_EnvVersioncfg_EnvVersion = -2; // opt var_cfg_EnvVersioncfg_EnvVersion
	goto stop_process;
	stop_process: skip;
	child!0
}
