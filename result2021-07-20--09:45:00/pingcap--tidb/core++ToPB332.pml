...
proctype ToPB332(chan child) {
	...
	Mutexdef sc_mu;
	int var_p_EqualConditionsp_EqualConditions = -2; // opt var_p_EqualConditionsp_EqualConditions
	int var_p_RightJoinKeysp_RightJoinKeys = -2; // opt var_p_RightJoinKeysp_RightJoinKeys
	int var_p_LeftJoinKeysp_LeftJoinKeys = -2; // opt var_p_LeftJoinKeysp_LeftJoinKeys
