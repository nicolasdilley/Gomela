...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/planner/core/task.go#L1784
typedef Wgdef {
...
init { 
	chan child_GetCost17840 = [1] of {int};
	run GetCost1784(child_GetCost17840);
	run receiver(child_GetCost17840)
stop_process:skip
}

proctype GetCost1784(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
