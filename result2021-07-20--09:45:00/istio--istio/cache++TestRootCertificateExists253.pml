...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/security/pkg/nodeagent/cache/secretcache_test.go#L253
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestRootCertificateExists2530)
stop_process:skip
}
...
proctype TestRootCertificateExists253(chan child) {
	...
	:: var_testCases-1 != -3 -> 
			...
			for10: skip;
			run rootCertificateExist366(sc_cache_mu,sc_certMutex,sc_certWatcher_mu,sc_configTrustBundleMutex,sc_generateMutex,sc_outputMutex,child_rootCertificateExist3660);
	...
	:: else -> 
		...
		:: true -> 
			for11: skip;
			run rootCertificateExist366(sc_cache_mu,sc_certMutex,sc_certWatcher_mu,sc_configTrustBundleMutex,sc_generateMutex,sc_outputMutex,child_rootCertificateExist3661);
...
proctype rootCertificateExist366(Mutexdef sc_cache_mu;Mutexdef sc_certMutex;Mutexdef sc_certWatcher_mu;Mutexdef sc_configTrustBundleMutex;Mutexdef sc_generateMutex;Mutexdef sc_outputMutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
