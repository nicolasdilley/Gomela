...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/pkg/config/event/buffer_test.go#L65
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestBuffer_DoubleProcess650)
stop_process:skip
}
...
proctype TestBuffer_DoubleProcess65(chan child) {
	...
	run receiver(child_AnonymousTestBuffer_DoubleProcess78690);
	run AnonymousTestBuffer_DoubleProcess8469(acc_mu,b_mu,child_AnonymousTestBuffer_DoubleProcess84691);
	run receiver(child_AnonymousTestBuffer_DoubleProcess84691);
	stop_process: skip;
	child!0
}
