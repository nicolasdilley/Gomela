...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/pilot/pkg/serviceregistry/serviceentry/servicediscovery_test.go#L144
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype maybeRefreshIndexes639(Mutexdef s_storeMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int var_wleswles = -2; // opt var_wleswles
	int var_entriesentries = -2; // opt var_entriesentries
	int var_s_workloadInstancesByIPs_workloadInstancesByIP = -2; // opt var_s_workloadInstancesByIPs_workloadInstancesByIP
	int var_s_store_ServiceEntries__s_store_ServiceEntries__ = -2; // opt var_s_store_ServiceEntries__s_store_ServiceEntries__
