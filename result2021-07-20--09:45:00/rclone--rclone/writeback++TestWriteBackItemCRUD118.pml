...
// git_link=https://github.com/rclone/rclone/blob/6ef7178ee4465f2361b6e2cf483cef5bbfd9c95c/vfs/vfscache/writeback/writeback_test.go#L118
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype checkOnHeap83(Mutexdef wb_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_wb_itemswb_items = -2; // opt var_wb_itemswb_items
	wb_mu.Lock!false;
		defer1: skip;
	wb_mu.Unlock!false;
	stop_process: skip;
