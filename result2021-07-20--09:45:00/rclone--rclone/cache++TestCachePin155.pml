...
// git_link=https://github.com/rclone/rclone/blob/6ef7178ee4465f2361b6e2cf483cef5bbfd9c95c/lib/cache/cache_test.go#L155
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestCachePin1550)
stop_process:skip
}
...
proctype cacheExpire201(Mutexdef c_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_cachec_cache = -2; // opt var_c_cachec_cache
	c_mu.Lock!false;
		defer1: skip;
	c_mu.Unlock!false;
	stop_process: skip;
