...
// git_link=https://github.com/kubernetes/minikube/blob/ce01c06fef829245cf1b940ca59cc55f4fc9c658/hack/update/github.go#L213
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_GHReleases2130)
stop_process:skip
}
...
proctype GHReleases213(chan child) {
	...
	int var_rlsrls = -2; // opt var_rlsrls
