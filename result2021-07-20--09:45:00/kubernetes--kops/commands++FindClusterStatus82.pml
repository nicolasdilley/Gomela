...
// git_link=https://github.com/kubernetes/kops/blob/e3fbc2ad043e58cfdcf934e015ef8d5d9e42273e/pkg/commands/status_discovery.go#L82
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype FindClusterStatus82(chan child) {
	...
	if
	:: true -> 
		run FindClusterStatus82(doCloud_Client_ratemtx,child_FindClusterStatus820);
		child_FindClusterStatus820?0;
		goto stop_process
	:: true;
	fi;
	goto stop_process;
