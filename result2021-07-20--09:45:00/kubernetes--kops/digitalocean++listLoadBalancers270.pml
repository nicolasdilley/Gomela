...
// git_link=https://github.com/kubernetes/kops/blob/e3fbc2ad043e58cfdcf934e015ef8d5d9e42273e/pkg/resources/digitalocean/resources.go#L270
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_listLoadBalancers2700)
stop_process:skip
}
...
proctype listLoadBalancers270(chan child) {
	...
	int var_lb_DropletIDslb_DropletIDs = -2; // opt var_lb_DropletIDslb_DropletIDs
	int var_lbslbs = -2; // opt var_lbslbs
