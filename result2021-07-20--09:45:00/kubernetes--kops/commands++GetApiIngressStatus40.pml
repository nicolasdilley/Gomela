...
// git_link=https://github.com/kubernetes/kops/blob/e3fbc2ad043e58cfdcf934e015ef8d5d9e42273e/pkg/commands/status_discovery.go#L40
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype GetApiIngressStatus40(chan child) {
	...
	if
	:: true -> 
		run GetApiIngressStatus40(doCloud_Client_ratemtx,child_GetApiIngressStatus400);
		child_GetApiIngressStatus400?0;
		goto stop_process
	:: true;
	fi;
	goto stop_process;
