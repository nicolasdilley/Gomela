...
proctype Render117(chan child) {
	...
	int num_msgs;
	Mutexdef __mutex;
	int var_method_Type_NumIn__method_Type_NumIn__ = -2; // opt var_method_Type_NumIn__method_Type_NumIn__
	int var_vType_NumMethod__vType_NumMethod__ = -2; // opt var_vType_NumMethod__vType_NumMethod__
	int var_lineslines = -2; // opt var_lineslines
	int var_changeListchangeList = -2; // opt var_changeListchangeList
