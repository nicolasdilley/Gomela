...
// git_link=https://github.com/prometheus/prometheus/blob/27b78c336e436e9eed8b55ab0b162b888ec641d8/scrape/scrape_test.go#L1605
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestScrapeLoopAppendExemplarSeries16050)
stop_process:skip
}
...
proctype TestScrapeLoopAppendExemplarSeries1605(chan child) {
	...
	int var_scrapeTextscrapeText = -2; // opt var_scrapeTextscrapeText
	int var_exemplarsexemplars = -2; // opt var_exemplarsexemplars
...
proctype iterDone774(Mutexdef c_metaMtx;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_seriesCurc_seriesCur = -2; // opt var_c_seriesCurc_seriesCur
	int var_c_metadatac_metadata = -2; // opt var_c_metadatac_metadata
	int var_c_droppedSeriesc_droppedSeries = -2; // opt var_c_droppedSeriesc_droppedSeries
	int var_c_seriesc_series = -2; // opt var_c_seriesc_series
...
proctype forEachStale859(Mutexdef c_metaMtx;chan child) {
	...
	bool state;
	int num_msgs;
	int var_c_seriesPrevc_seriesPrev = -2; // opt var_c_seriesPrevc_seriesPrev
	stop_process: skip;
	child!0
}
