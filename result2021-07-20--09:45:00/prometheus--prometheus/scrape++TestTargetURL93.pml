...
// git_link=https://github.com/prometheus/prometheus/blob/27b78c336e436e9eed8b55ab0b162b888ec641d8/scrape/target_test.go#L93
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype URL200(Mutexdef t_mtx;chan child) {
	...
	bool state;
	int num_msgs;
	int var_t_labelst_labels = -2; // opt var_t_labelst_labels
	int var_t_paramst_params = -2; // opt var_t_paramst_params
	goto stop_process;
	stop_process: skip;
	child!0
}
