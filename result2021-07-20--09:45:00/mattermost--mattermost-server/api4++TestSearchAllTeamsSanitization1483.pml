...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L1483
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSearchAllTeamsSanitization14830 = [1] of {int};
	run TestSearchAllTeamsSanitization1483(child_TestSearchAllTeamsSanitization14830);
	run receiver(child_TestSearchAllTeamsSanitization14830)
stop_process:skip
}

proctype TestSearchAllTeamsSanitization1483(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
