...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L1086
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetAllChannelsWithCount10860 = [1] of {int};
	run TestGetAllChannelsWithCount1086(child_TestGetAllChannelsWithCount10860);
	run receiver(child_TestGetAllChannelsWithCount10860)
stop_process:skip
}

proctype TestGetAllChannelsWithCount1086(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
