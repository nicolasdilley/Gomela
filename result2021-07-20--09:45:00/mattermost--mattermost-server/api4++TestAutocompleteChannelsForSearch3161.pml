...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L3161
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestAutocompleteChannelsForSearch31610 = [1] of {int};
	run TestAutocompleteChannelsForSearch3161(child_TestAutocompleteChannelsForSearch31610);
	run receiver(child_TestAutocompleteChannelsForSearch31610)
stop_process:skip
}

proctype TestAutocompleteChannelsForSearch3161(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_TearDown2920 = [1] of {int};
	chan child_CreateUserWithClient4936 = [1] of {int};
	chan child_CreateUserWithClient4935 = [1] of {int};
	chan child_CreateUserWithClient4934 = [1] of {int};
	chan child_CreateUserWithClient4933 = [1] of {int};
	chan child_LoginBasicWithClient7252 = [1] of {int};
	chan child_LoginSystemAdminWithClient7611 = [1] of {int};
	...
	int var_tc_expectedExcludestc_expectedExcludes = -2; // opt var_tc_expectedExcludestc_expectedExcludes
	int var_tc_expectedIncludestc_expectedIncludes = -2; // opt var_tc_expectedIncludestc_expectedIncludes
	int var_channelschannels = -2; // opt var_channelschannels
	...
	run LoginSystemAdminWithClient761(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginSystemAdminWithClient7611);
	child_LoginSystemAdminWithClient7611?0;
	...
	run CreateUserWithClient493(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateUserWithClient4933);
	child_CreateUserWithClient4933?0;
	run CreateUserWithClient493(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateUserWithClient4934);
	child_CreateUserWithClient4934?0;
	run CreateUserWithClient493(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateUserWithClient4935);
	child_CreateUserWithClient4935?0;
