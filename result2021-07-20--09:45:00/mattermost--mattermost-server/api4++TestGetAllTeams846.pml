...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L846
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetAllTeams8460 = [1] of {int};
	run TestGetAllTeams846(child_TestGetAllTeams8460);
	run receiver(child_TestGetAllTeams8460)
stop_process:skip
}

proctype TestGetAllTeams846(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_tc_Permissionstc_Permissions = -2; // opt var_tc_Permissionstc_Permissions
