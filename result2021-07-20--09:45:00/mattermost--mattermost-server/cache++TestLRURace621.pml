...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/services/cache/lru_test.go#L621
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestLRURace6210)
stop_process:skip
}
...
proctype TestLRURace621(chan child) {
	...
	run receiver(child_AnonymousTestLRURace6326270);
	run AnonymousTestLRURace639627(wg,child_AnonymousTestLRURace6396271);
	run receiver(child_AnonymousTestLRURace6396271);
	wg.wait?0;
	stop_process: skip;
	child!0
}
