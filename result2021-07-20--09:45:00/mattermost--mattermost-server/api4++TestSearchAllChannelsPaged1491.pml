...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L1491
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestSearchAllChannelsPaged14910 = [1] of {int};
	run TestSearchAllChannelsPaged1491(child_TestSearchAllChannelsPaged14910);
	run receiver(child_TestSearchAllChannelsPaged14910)
stop_process:skip
}

proctype TestSearchAllChannelsPaged1491(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
