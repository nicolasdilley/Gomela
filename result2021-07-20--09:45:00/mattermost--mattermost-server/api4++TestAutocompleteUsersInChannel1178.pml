...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L1178
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestAutocompleteUsersInChannel11780 = [1] of {int};
	run TestAutocompleteUsersInChannel1178(child_TestAutocompleteUsersInChannel11780);
	run receiver(child_TestAutocompleteUsersInChannel11780)
stop_process:skip
}

proctype TestAutocompleteUsersInChannel1178(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
