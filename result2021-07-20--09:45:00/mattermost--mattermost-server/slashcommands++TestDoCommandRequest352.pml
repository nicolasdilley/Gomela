...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/app/slashcommands/command_test.go#L352
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestDoCommandRequest3520 = [1] of {int};
	run TestDoCommandRequest352(child_TestDoCommandRequest3520);
	run receiver(child_TestDoCommandRequest3520)
stop_process:skip
}

proctype TestDoCommandRequest352(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
