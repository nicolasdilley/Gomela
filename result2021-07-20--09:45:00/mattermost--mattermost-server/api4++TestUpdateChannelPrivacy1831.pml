...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L1831
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateChannelPrivacy18310 = [1] of {int};
	run TestUpdateChannelPrivacy1831(child_TestUpdateChannelPrivacy18310);
	run receiver(child_TestUpdateChannelPrivacy18310)
stop_process:skip
}

proctype TestUpdateChannelPrivacy1831(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_TearDown2920 = [1] of {int};
	chan child_LoginTeamAdmin7133 = [1] of {int};
	chan child_CreatePublicChannel5862 = [1] of {int};
	chan child_CreatePrivateChannel5901 = [1] of {int};
	...
	run CreatePrivateChannel590(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreatePrivateChannel5901);
	child_CreatePrivateChannel5901?0;
	run CreatePublicChannel586(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreatePublicChannel5862);
	child_CreatePublicChannel5862?0;
	run LoginTeamAdmin713(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginTeamAdmin7133);
	child_LoginTeamAdmin7133?0;
		defer1: skip;
...
proctype CreatePublicChannel586(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_CreateChannelWithClient5942 = [1] of {int};
	run CreateChannelWithClient594(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_CreateChannelWithClient5942);
	child_CreateChannelWithClient5942?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype LoginTeamAdmin713(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_LoginTeamAdminWithClient7433 = [1] of {int};
	run LoginTeamAdminWithClient743(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginTeamAdminWithClient7433);
	child_LoginTeamAdminWithClient7433?0;
	stop_process: skip;
	child!0
}
proctype LoginTeamAdminWithClient743(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
