...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/web/webhook_test.go#L19
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestIncomingWebhook190 = [1] of {int};
	run TestIncomingWebhook19(child_TestIncomingWebhook190);
	run receiver(child_TestIncomingWebhook190)
stop_process:skip
}

proctype TestIncomingWebhook19(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
