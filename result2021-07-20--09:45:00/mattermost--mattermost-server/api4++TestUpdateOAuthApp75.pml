...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/oauth_test.go#L75
#define not_found_84  -2 // opt data line 1132
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateOAuthApp750 = [1] of {int};
	run TestUpdateOAuthApp75(child_TestUpdateOAuthApp750);
	run receiver(child_TestUpdateOAuthApp750)
stop_process:skip
}

proctype TestUpdateOAuthApp75(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_LoginBasic7058 = [1] of {int};
	chan child_AddPermissionToRole11907 = [1] of {int};
	chan child_RemovePermissionFromRole11586 = [1] of {int};
	chan child_LoginBasic7055 = [1] of {int};
	chan child_LoginBasic27094 = [1] of {int};
	...
	int var_updatedApp_CallbackUrlsupdatedApp_CallbackUrls = -2; // opt var_updatedApp_CallbackUrlsupdatedApp_CallbackUrls
	...
	run LoginBasic2709(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginBasic27094);
	child_LoginBasic27094?0;
	run LoginBasic705(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginBasic7055);
	child_LoginBasic7055?0;
	run RemovePermissionFromRole1158(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_RemovePermissionFromRole11586);
	child_RemovePermissionFromRole11586?0;
	...
	run LoginBasic705(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginBasic7058);
	child_LoginBasic7058?0;
		defer2: skip;
	run RestoreDefaultRolePermissions1132(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,not_found_84,child_RestoreDefaultRolePermissions11322);
...
proctype LoginBasic2709(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_LoginBasic2WithClient7344 = [1] of {int};
	run LoginBasic2WithClient734(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginBasic2WithClient7344);
	child_LoginBasic2WithClient7344?0;
	stop_process: skip;
	child!0
}
...
proctype LoginBasic705(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_LoginBasicWithClient7255 = [1] of {int};
	run LoginBasicWithClient725(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginBasicWithClient7255);
	child_LoginBasicWithClient7255?0;
	stop_process: skip;
	child!0
}
