...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2371
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUsersWithoutTeam23710 = [1] of {int};
	run TestGetUsersWithoutTeam2371(child_TestGetUsersWithoutTeam23710);
	run receiver(child_TestGetUsersWithoutTeam23710)
stop_process:skip
}

proctype TestGetUsersWithoutTeam2371(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
