...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L5084
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetKnownUsers50840 = [1] of {int};
	run TestGetKnownUsers5084(child_TestGetKnownUsers50840);
	run receiver(child_TestGetKnownUsers50840)
stop_process:skip
}

proctype TestGetKnownUsers5084(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_TearDown2920 = [1] of {int};
	chan child_LinkUserToTeam7819 = [1] of {int};
	chan child_LinkUserToTeam7818 = [1] of {int};
	chan child_LinkUserToTeam7817 = [1] of {int};
	chan child_LinkUserToTeam7816 = [1] of {int};
	...
	run LinkUserToTeam781(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LinkUserToTeam7816);
	child_LinkUserToTeam7816?0;
	run LinkUserToTeam781(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LinkUserToTeam7817);
	child_LinkUserToTeam7817?0;
	run LinkUserToTeam781(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LinkUserToTeam7818);
	child_LinkUserToTeam7818?0;
	run LinkUserToTeam781(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LinkUserToTeam7819);
	child_LinkUserToTeam7819?0;
		defer1: skip;
