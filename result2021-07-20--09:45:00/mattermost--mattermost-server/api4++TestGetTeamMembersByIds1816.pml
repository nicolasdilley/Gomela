...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L1816
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTeamMembersByIds18160 = [1] of {int};
	run TestGetTeamMembersByIds1816(child_TestGetTeamMembersByIds18160);
	run receiver(child_TestGetTeamMembersByIds18160)
stop_process:skip
}

proctype TestGetTeamMembersByIds1816(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
