...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L2422
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTeamStats24220 = [1] of {int};
	run TestGetTeamStats2422(child_TestGetTeamStats24220);
	run receiver(child_TestGetTeamStats24220)
stop_process:skip
}

proctype TestGetTeamStats2422(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_UpdateActiveUser7701 = [1] of {int};
	...
	run UpdateActiveUser770(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_UpdateActiveUser7701);
	child_UpdateActiveUser7701?0;
...
proctype UpdateActiveUser770(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
