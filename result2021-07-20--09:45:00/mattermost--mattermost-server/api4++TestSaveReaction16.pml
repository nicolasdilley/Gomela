...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/reaction_test.go#L16
...
init { 
	chan child_TestSaveReaction160 = [1] of {int};
	run TestSaveReaction16(child_TestSaveReaction160);
	run receiver(child_TestSaveReaction160)
stop_process:skip
}

proctype TestSaveReaction16(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
