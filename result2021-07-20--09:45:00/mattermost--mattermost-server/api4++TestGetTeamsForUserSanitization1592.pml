...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L1592
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTeamsForUserSanitization15920 = [1] of {int};
	run TestGetTeamsForUserSanitization1592(child_TestGetTeamsForUserSanitization15920);
	run receiver(child_TestGetTeamsForUserSanitization15920)
stop_process:skip
}

proctype TestGetTeamsForUserSanitization1592(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_rteamsrteams = -2; // opt var_rteamsrteams
