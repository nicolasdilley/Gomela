...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/store/storetest/channel_store_categories.go#L2048
typedef Wgdef {
...
init { 
	...
	run receiver(child_testSidebarCategoryDeadlock20480)
stop_process:skip
}
...
proctype testSidebarCategoryDeadlock2048(chan child) {
	...
	run receiver(child_AnonymoustestSidebarCategoryDeadlock208320800);
	run AnonymoustestSidebarCategoryDeadlock21012080(wg,child_AnonymoustestSidebarCategoryDeadlock210120801);
	run receiver(child_AnonymoustestSidebarCategoryDeadlock210120801);
	wg.wait?0;
	stop_process: skip;
	child!0
}
