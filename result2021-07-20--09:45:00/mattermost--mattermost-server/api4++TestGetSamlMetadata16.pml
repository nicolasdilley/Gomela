...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/saml_test.go#L16
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetSamlMetadata160 = [1] of {int};
	run TestGetSamlMetadata16(child_TestGetSamlMetadata160);
	run receiver(child_TestGetSamlMetadata160)
stop_process:skip
}

proctype TestGetSamlMetadata16(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
