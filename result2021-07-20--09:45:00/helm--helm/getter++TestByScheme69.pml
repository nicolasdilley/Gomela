...
// git_link=https://github.com/helm/helm/blob/43853ea772e779b617b011a8d4e69205636fa4f9/pkg/getter/getter_test.go#L69
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestByScheme690)
stop_process:skip
}
...
proctype collectPlugins33(Mutexdef settings_config_lock;chan child) {
	...
	bool state;
	int num_msgs;
	int var_plugin_Metadata_Downloadersplugin_Metadata_Downloaders = -2; // opt var_plugin_Metadata_Downloadersplugin_Metadata_Downloaders
	int var_pluginsplugins = -2; // opt var_pluginsplugins
