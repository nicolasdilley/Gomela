...
#define var_posts  -2 // opt posts line 121
#define var_files  -2 // opt files line 121
#define not_found_384  -2 // opt pairs line 245
#define not_found_160  -2 // opt data line 513
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run sendFcgi121(var_posts,var_files,child_sendFcgi1210);
