...
// git_link=https://github.com/dgraph-io/dgraph/blob/6b188f254202f9c38b16c4769b672dd0e9d596ac/upgrade/change_v20.03.0.go#L50
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_upgradeACLRules500)
stop_process:skip
}
...
proctype upgradeACLRules50(chan child) {
	...
	int var_rsrs = -2; // opt var_rsrs
	int var_groupsgroups = -2; // opt var_groupsgroups
