...
// git_link=https://github.com/dgraph-io/dgraph/blob/6b188f254202f9c38b16c4769b672dd0e9d596ac/worker/draft.go#L273
typedef Wgdef {
...
init { 
	...
	run receiver(child_GetOngoingTasks2730)
stop_process:skip
}
...
proctype GetOngoingTasks273(chan child) {
	...
	int var_n_opsn_ops = -2; // opt var_n_opsn_ops
