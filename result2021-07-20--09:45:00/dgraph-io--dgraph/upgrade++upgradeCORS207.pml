...
// git_link=https://github.com/dgraph-io/dgraph/blob/6b188f254202f9c38b16c4769b672dd0e9d596ac/upgrade/change_v21.03.0.go#L207
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_upgradeCORS2070)
stop_process:skip
}
...
proctype dropDeprecated128(Mutexdef dg_jwtMutex;chan child) {
	...
	int var_deprecatedTypesdeprecatedTypes = -2; // opt var_deprecatedTypesdeprecatedTypes
	int var_deprecatedPredsdeprecatedPreds = -2; // opt var_deprecatedPredsdeprecatedPreds
	...
	if
	:: var_deprecatedPreds-1 != -3 -> 
				for(i : 0.. var_deprecatedPreds-1) {
			for40: skip;
	...
	if
	:: var_deprecatedTypes-1 != -3 -> 
				for(i : 0.. var_deprecatedTypes-1) {
			for50: skip;
