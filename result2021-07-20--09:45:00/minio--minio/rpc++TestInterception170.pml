...
// git_link=https://github.com/minio/minio/blob/e948e7cdf65028f7a8545d1a05c2baea75198bd0/pkg/rpc/server_test.go#L170
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestInterception1700)
stop_process:skip
}
...
proctype register57(Mutexdef m_mutex;chan child) {
	...
	bool state;
	int num_msgs;
	int var_s_rcvrType_NumMethod__s_rcvrType_NumMethod__ = -2; // opt var_s_rcvrType_NumMethod__s_rcvrType_NumMethod__
...
proctype ServeHTTP154(Mutexdef s_services_mutex;chan child) {
	...
	int var_s_codecss_codecs = -2; // opt var_s_codecss_codecs
