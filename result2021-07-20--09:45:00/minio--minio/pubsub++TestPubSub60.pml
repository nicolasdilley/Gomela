...
// git_link=https://github.com/minio/minio/blob/e948e7cdf65028f7a8545d1a05c2baea75198bd0/pkg/pubsub/pubsub_test.go#L60
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype Subscribe55(Chandef subCh_ch;Chandef doneCh_ch;chan child) {
	...
	run AnonymousSubscribe6355(doneCh_ch,subCh_ch,child_AnonymousSubscribe63550);
	run receiver(child_AnonymousSubscribe63550);
	stop_process: skip;
	child!0
}
proctype AnonymousSubscribe6355(Chandef doneCh_ch;Chandef subCh_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
