...
// git_link=https://github.com/minio/minio/blob/e948e7cdf65028f7a8545d1a05c2baea75198bd0/cmd/http/dial_dnscache_test.go#L43
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestDialContextWithDNSCache430)
stop_process:skip
}
