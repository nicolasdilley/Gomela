...
#define var_numIterations  -2 // opt numIterations line 220
#define var_numReaders  ?? // mand numReaders line 220
#define ub_for232_2  ??
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run HammerRWMutex220(var_numIterations,var_numReaders,child_HammerRWMutex2200);
