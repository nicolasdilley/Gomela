...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/master/synthetic_master_test.go#L603
typedef Wgdef {
...
init { 
	chan child_TestMasterService6030 = [1] of {int};
	run TestMasterService603(child_TestMasterService6030);
	run receiver(child_TestMasterService6030)
stop_process:skip
}

proctype TestMasterService603(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_svcList_ItemssvcList_Items = -2; // opt var_svcList_ItemssvcList_Items
