...
proctype TestRotateLogs77(chan child) {
	...
	Mutexdef c_mutex;
	int var_testLogstestLogs = -2; // opt var_testLogstestLogs
...
proctype cleanupUnusedLogs302(Mutexdef c_mutex;chan child) {
	...
	bool state;
	int num_msgs;
	int var_unusedunused = -2; // opt var_unusedunused
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype removeExcessLogs345(Mutexdef c_mutex;int logs;chan child) {
	...
	bool state;
	int num_msgs;
	int var_maxRotatedFilesmaxRotatedFiles = -2; // opt var_maxRotatedFilesmaxRotatedFiles
	goto stop_process;
	stop_process: skip;
	child!0
}
