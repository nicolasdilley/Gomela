...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/defaulttolerationseconds/defaulttolerationseconds_test.go#L33
typedef Wgdef {
...
init { 
	chan child_TestAdmission330 = [1] of {int};
	run TestAdmission33(child_TestAdmission330);
	run receiver(child_TestAdmission330)
stop_process:skip
}

proctype TestAdmission33(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	int var_tolerationstolerations = -2; // opt var_tolerationstolerations
