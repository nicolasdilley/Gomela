...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/master/synthetic_master_test.go#L432
typedef Wgdef {
...
init { 
	chan child_TestAutoscalingGroupBackwardCompatibility4320 = [1] of {int};
	run TestAutoscalingGroupBackwardCompatibility432(child_TestAutoscalingGroupBackwardCompatibility4320);
	run receiver(child_TestAutoscalingGroupBackwardCompatibility4320)
stop_process:skip
}

proctype TestAutoscalingGroupBackwardCompatibility432(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
