...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/master/synthetic_master_test.go#L477
typedef Wgdef {
...
init { 
	chan child_TestAppsGroupBackwardCompatibility4770 = [1] of {int};
	run TestAppsGroupBackwardCompatibility477(child_TestAppsGroupBackwardCompatibility4770);
	run receiver(child_TestAppsGroupBackwardCompatibility4770)
stop_process:skip
}

proctype TestAppsGroupBackwardCompatibility477(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
