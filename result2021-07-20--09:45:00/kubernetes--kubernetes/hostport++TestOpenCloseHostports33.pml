...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/dockershim/network/hostport/hostport_manager_test.go#L33
#define not_found_222  -2 // opt hostportMappings line 322
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestOpenCloseHostports33(chan child) {
	...
	Mutexdef manager_mu;
	int var_closePortCasesclosePortCases = -2; // opt var_closePortCasesclosePortCases
	int var_tc_podPortMapping_PortMappingstc_podPortMapping_PortMappings = -2; // opt var_tc_podPortMapping_PortMappingstc_podPortMapping_PortMappings
	int var_mappingmapping = -2; // opt var_mappingmapping
	int var_openPortCasesopenPortCases = -2; // opt var_openPortCasesopenPortCases
...
proctype openHostports282(Mutexdef hm_mu;chan child) {
	...
	int var_portsports = -2; // opt var_portsports
	int var_podPortMapping_PortMappingspodPortMapping_PortMappings = -2; // opt var_podPortMapping_PortMappingspodPortMapping_PortMappings
