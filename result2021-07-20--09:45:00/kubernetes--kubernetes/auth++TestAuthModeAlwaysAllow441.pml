...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/auth_test.go#L441
typedef Wgdef {
...
init { 
	chan child_TestAuthModeAlwaysAllow4410 = [1] of {int};
	run TestAuthModeAlwaysAllow441(child_TestAuthModeAlwaysAllow4410);
	run receiver(child_TestAuthModeAlwaysAllow4410)
stop_process:skip
}

proctype TestAuthModeAlwaysAllow441(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
