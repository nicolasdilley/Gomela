...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/volumemanager/populator/desired_state_of_world_populator_test.go#L88
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestFindAndAddNewPods_WithReprocessPodAndVolumeRetrievalError880 = [1] of {int};
	run TestFindAndAddNewPods_WithReprocessPodAndVolumeRetrievalError88(child_TestFindAndAddNewPods_WithReprocessPodAndVolumeRetrievalError880);
	run receiver(child_TestFindAndAddNewPods_WithReprocessPodAndVolumeRetrievalError880)
stop_process:skip
}

proctype TestFindAndAddNewPods_WithReprocessPodAndVolumeRetrievalError88(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_podPreviouslyProcessed4455 = [1] of {int};
	chan child_findAndAddNewPods1904 = [1] of {int};
	chan child_ReprocessPod1533 = [1] of {int};
	chan child_pluginPVOmittingClient532 = [1] of {int};
	...
	run pluginPVOmittingClient53(dswp_hasAddedPodsLock,dswp_volumePluginMgr_mutex,child_pluginPVOmittingClient532);
	child_pluginPVOmittingClient532?0;
	run ReprocessPod153(dswp_hasAddedPodsLock,dswp_volumePluginMgr_mutex,child_ReprocessPod1533);
	child_ReprocessPod1533?0;
	run findAndAddNewPods190(dswp_hasAddedPodsLock,dswp_volumePluginMgr_mutex,child_findAndAddNewPods1904);
	child_findAndAddNewPods1904?0;
	run podPreviouslyProcessed445(dswp_hasAddedPodsLock,dswp_volumePluginMgr_mutex,child_podPreviouslyProcessed4455);
	child_podPreviouslyProcessed4455?0;
	stop_process: skip;
	child!0
}
proctype findAndAddNewPods190(Mutexdef dswp_hasAddedPodsLock;Mutexdef dswp_volumePluginMgr_mutex;chan child) {
	...
	int var_dswp_podManager_GetPods__dswp_podManager_GetPods__ = -2; // opt var_dswp_podManager_GetPods__dswp_podManager_GetPods__
	int var_dswp_actualStateOfWorld_GetMountedVolumes__dswp_actualStateOfWorld_GetMountedVolumes__ = -2; // opt var_dswp_actualStateOfWorld_GetMountedVolumes__dswp_actualStateOfWorld_GetMountedVolumes__
	

	if
	:: var_dswp_podManager_GetPods__-1 != -3 -> 
				for(i : 0.. var_dswp_podManager_GetPods__-1) {
			for20: skip;
...
proctype processPodVolumes307(Mutexdef dswp_hasAddedPodsLock;Mutexdef dswp_volumePluginMgr_mutex;chan child) {
	...
	chan child_podPreviouslyProcessed4451 = [1] of {int};
	int var_pod_Spec_Volumespod_Spec_Volumes = -2; // opt var_pod_Spec_Volumespod_Spec_Volumes
	...
	if
	:: var_pod_Spec_Volumes-1 != -3 -> 
				for(i : 0.. var_pod_Spec_Volumes-1) {
			for21: skip;
...
proctype ReprocessPod153(Mutexdef dswp_hasAddedPodsLock;Mutexdef dswp_volumePluginMgr_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_markPodProcessingFailed4543 = [1] of {int};
	run markPodProcessingFailed454(dswp_hasAddedPodsLock,dswp_volumePluginMgr_mutex,child_markPodProcessingFailed4543);
	child_markPodProcessingFailed4543?0;
	stop_process: skip;
	child!0
}
proctype markPodProcessingFailed454(Mutexdef dswp_hasAddedPodsLock;Mutexdef dswp_volumePluginMgr_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
