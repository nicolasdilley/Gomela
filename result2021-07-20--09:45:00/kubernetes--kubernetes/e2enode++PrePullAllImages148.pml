...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/e2e_node/image_list.go#L148
#define var_images160  ?? // mand images line 160
#define var_parallelImagePullCount176  ?? // mand parallelImagePullCount line 176
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype PrePullAllImages148(chan child) {
	...
	Wgdef wg;
	Chandef imageCh_ch;
	int var_parallelImagePullCount = var_parallelImagePullCount176; // mand var_parallelImagePullCount
	int var_images = var_images160; // mand var_images
