...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/credentialprovider/azure/azure_credentials_test.go#L42
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype Test42(chan child) {
	...
	int var_resultresult = -2; // opt var_resultresult
...
proctype Provide246(Mutexdef a_servicePrincipalToken_refreshLock;chan child) {
	...
	int var_containerRegistryUrlscontainerRegistryUrls = -2; // opt var_containerRegistryUrlscontainerRegistryUrls
