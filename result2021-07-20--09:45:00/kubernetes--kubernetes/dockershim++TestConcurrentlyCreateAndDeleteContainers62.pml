...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/dockershim/docker_container_test.go#L62
#define var_configs80  ?? // mand configs line 80
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestConcurrentlyCreateAndDeleteContainers62(chan child) {
	...
	int var_configs = var_configs80; // mand var_configs
	...
	run AnonymousTestConcurrentlyCreateAndDeleteContainers8980(containerIDs_ch,deletionWg,creationWg,ds_network_podsLock,ds_networkReadyLock,ds_cleanupInfosLock,child_AnonymousTestConcurrentlyCreateAndDeleteContainers89800);
...
proctype AnonymousTestConcurrentlyCreateAndDeleteContainers8980(Chandef containerIDs_ch;Wgdef deletionWg;Wgdef creationWg;Mutexdef ds_network_podsLock;Mutexdef ds_networkReadyLock;Mutexdef ds_cleanupInfosLock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype CreateContainer109(Mutexdef ds_cleanupInfosLock;Mutexdef ds_network_podsLock;Mutexdef ds_networkReadyLock;chan child) {
	...
	int var_config_Devicesconfig_Devices = -2; // opt var_config_Devicesconfig_Devices
