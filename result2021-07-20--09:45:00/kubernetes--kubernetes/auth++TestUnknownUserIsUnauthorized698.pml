...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/auth_test.go#L698
typedef Wgdef {
...
init { 
	chan child_TestUnknownUserIsUnauthorized6980 = [1] of {int};
	run TestUnknownUserIsUnauthorized698(child_TestUnknownUserIsUnauthorized6980);
	run receiver(child_TestUnknownUserIsUnauthorized6980)
stop_process:skip
}

proctype TestUnknownUserIsUnauthorized698(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
