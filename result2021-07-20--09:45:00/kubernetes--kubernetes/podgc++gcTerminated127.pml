...
#define var_pods  -2 // opt pods line 127
#define var_deleteCount146  ?? // mand deleteCount line 146
typedef Wgdef {
...
init { 
	...
	run gcTerminated127(var_pods,child_gcTerminated1270);
...
proctype gcTerminated127(int pods;chan child) {
	...
	Wgdef wait;
	int var_deleteCount = var_deleteCount146; // mand var_deleteCount
