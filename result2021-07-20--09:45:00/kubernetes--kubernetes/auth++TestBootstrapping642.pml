...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/rbac_test.go#L642
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestBootstrapping6420)
stop_process:skip
}
...
proctype TestBootstrapping642(chan child) {
	...
	int var_clusterRoles_ItemsclusterRoles_Items = -2; // opt var_clusterRoles_ItemsclusterRoles_Items
