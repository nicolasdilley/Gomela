...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/e2e/framework/providers/gce/ingress.go#L177
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_GetGlobalAddress1770)
stop_process:skip
}
...
proctype GetGlobalAddress177(chan child) {
	...
	run GetGlobalAddress177(gceCloud_ClusterID_idLock,gceCloud_computeNodeTagLock,gceCloud_nodeZonesLock,gceCloud_sharedResourceLock,gceCloud_subnetworkURLAndIsLegacyNetworkInitializer_m,child_GetGlobalAddress1770);
