...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/namespace/ns_conditions_test.go#L167
typedef Wgdef {
...
init { 
	chan child_namespaceLifecycleSetup1670 = [1] of {int};
	run namespaceLifecycleSetup167(child_namespaceLifecycleSetup1670);
	run receiver(child_namespaceLifecycleSetup1670)
stop_process:skip
}

proctype namespaceLifecycleSetup167(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
