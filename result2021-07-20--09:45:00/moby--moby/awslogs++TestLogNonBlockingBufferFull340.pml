...
proctype TestLogNonBlockingBufferFull340(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousTestLogNonBlockingBufferFull3503490 = [1] of {int};
	Chandef started_ch;
	Chandef errorCh_ch;
	...
	run AnonymousTestLogNonBlockingBufferFull350349(started_ch,stream_messages_ch,errorCh_ch,stream_lock,child_AnonymousTestLogNonBlockingBufferFull3503490);
	run receiver(child_AnonymousTestLogNonBlockingBufferFull3503490);
...
proctype AnonymousTestLogNonBlockingBufferFull350349(Chandef started_ch;Chandef stream_messages_ch;Chandef errorCh_ch;Mutexdef stream_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
