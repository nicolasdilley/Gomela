...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/registry/resumable/resumablerequestreader_test.go#L154
typedef Wgdef {
...
init { 
	chan child_TestResumableRequestReaderWithServerDoesntSupportByteRanges1540 = [1] of {int};
	run TestResumableRequestReaderWithServerDoesntSupportByteRanges154(child_TestResumableRequestReaderWithServerDoesntSupportByteRanges1540);
	run receiver(child_TestResumableRequestReaderWithServerDoesntSupportByteRanges1540)
stop_process:skip
}

proctype TestResumableRequestReaderWithServerDoesntSupportByteRanges154(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
