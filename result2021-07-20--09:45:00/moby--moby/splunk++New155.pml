...
#define var_streamChannelSize279  ?? // mand streamChannelSize line 279
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype New155(chan child) {
	...
	int var_attrsattrs = -2; // opt var_attrsattrs
	int var_streamChannelSize = var_streamChannelSize279; // mand var_streamChannelSize
