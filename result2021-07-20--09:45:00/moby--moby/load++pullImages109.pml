...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/testutil/fixtures/load/frozen.go#L109
#define var_images  ?? // mand images line 109
#define var_pullRefs126  ?? // mand pullRefs line 126
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	...
	run pullImages109(var_images,child_pullImages1090);
...
proctype pullImages109(int images;chan child) {
	...
	Chandef chErr_ch;
	Wgdef wg;
	int var_pullRefs = var_pullRefs126; // mand var_pullRefs
