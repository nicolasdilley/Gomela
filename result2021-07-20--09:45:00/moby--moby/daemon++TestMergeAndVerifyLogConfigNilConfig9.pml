...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/daemon/logs_test.go#L9
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestMergeAndVerifyLogConfigNilConfig90)
stop_process:skip
}
...
proctype TestMergeAndVerifyLogConfigNilConfig9(chan child) {
	...
	run mergeAndVerifyLogConfig177(d_attachableNetworkLock_mu,d_containerdCli_connMu,d_EventsService_mu,d_linkIndex_mu,d_mdDB_batchMu,d_mdDB_metalock,d_mdDB_mmaplock,d_mdDB_rwlock,d_mdDB_statlock,d_pluginManager_mu,d_pluginManager_muGC,d_statsCollector_m,child_mergeAndVerifyLogConfig1770);
	child_mergeAndVerifyLogConfig1770?0;
	stop_process: skip;
	child!0
}
proctype mergeAndVerifyLogConfig177(Mutexdef daemon_attachableNetworkLock_mu;Mutexdef daemon_containerdCli_connMu;Mutexdef daemon_EventsService_mu;Mutexdef daemon_linkIndex_mu;Mutexdef daemon_mdDB_batchMu;Mutexdef daemon_mdDB_metalock;Mutexdef daemon_mdDB_mmaplock;Mutexdef daemon_mdDB_rwlock;Mutexdef daemon_mdDB_statlock;Mutexdef daemon_pluginManager_mu;Mutexdef daemon_pluginManager_muGC;Mutexdef daemon_statsCollector_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	int var_daemon_defaultLogConfig_Configdaemon_defaultLogConfig_Config = -2; // opt var_daemon_defaultLogConfig_Configdaemon_defaultLogConfig_Config
	goto stop_process;
	stop_process: skip;
	child!0
}
