...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/registry/resumable/resumablerequestreader_test.go#L231
typedef Wgdef {
...
init { 
	chan child_TestResumableRequestReaderWithInitialResponse2310 = [1] of {int};
	run TestResumableRequestReaderWithInitialResponse231(child_TestResumableRequestReaderWithInitialResponse2310);
	run receiver(child_TestResumableRequestReaderWithInitialResponse2310)
stop_process:skip
}

proctype TestResumableRequestReaderWithInitialResponse231(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
