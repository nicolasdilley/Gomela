...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example081150050/internal/app/master/inspectors/container/probes/http/custom_probe.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	Wgdef probe_workers;
	int probe_maxConcurrentCrawlers = 5;
	...
	:: true;
		...
		for(i : 1.. inspector_ContainerInfo_NetworkSettings_Ports) {
for10:
	};
	
	if
	:: true -> 
				for(i : 1.. probe_TargetPorts) {
for20:
		}
	:: true -> 
