#define lb_for639_0  -1
#define ub_for639_1  -1
#define lb_for703_2  -1
#define ub_for703_3  -1
#define lb_for710_4  -1
#define ub_for710_5  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example143435086/router/sleeve.go
typedef Chandef {
	chan sync = [0] of {int};
...
loop:		
	if
	:: lb_for639_0 != -1 && ub_for639_1 != -1 -> 
				for(i : lb_for639_0.. ub_for639_1) {
for10:			do
			:: true;
			:: true;
			:: true;
