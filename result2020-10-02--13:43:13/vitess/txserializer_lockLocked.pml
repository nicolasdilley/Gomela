...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example862180471/go/vt/vttablet/tabletserver/txserializer/tx_serializer.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	int txs_concurrentTransactions = 5;
	bool state = false;
	int i;
