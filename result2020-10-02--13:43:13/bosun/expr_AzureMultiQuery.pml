...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example223574958/cmd/bosun/expr/azure.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	Chandef reqCh;
	Chandef errCh;
	int e_AzureMonitor[prefix]_Concurrency = 5;
	int i;
