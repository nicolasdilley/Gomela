...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example418644638/host/cli/bootstrap.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	if
	:: true -> 
		chan child_clirunBootstrapBackup0 = [0] of {int};
		run clirunBootstrapBackup(ch,child_clirunBootstrapBackup0);
		child_clirunBootstrapBackup0?0
	fi;
