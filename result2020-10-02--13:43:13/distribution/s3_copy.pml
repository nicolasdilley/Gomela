...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example015981641/registry/storage/driver/s3-aws/s3.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Chandef errChan;
	int completedParts = 5;
	int numParts = 5;
	bool state = false;
	Chandef limiter;
	int d_MultipartCopyMaxConcurrency = 5;
	int i;
