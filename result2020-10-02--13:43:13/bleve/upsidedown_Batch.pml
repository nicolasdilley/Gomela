#define lb_for871_0  -1
#define ub_for871_1  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example803157744/index/upsidedown/upsidedown.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10:
	...
	if
	:: lb_for871_0 != -1 && ub_for871_1 != -1 -> 
				for(i : lb_for871_0.. ub_for871_1) {
for40:			
			if
