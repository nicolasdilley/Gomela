...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example103916151/server/match_handler.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	int config_GetMatch_DeferredQueueSize = 5;
	Chandef mh_inputCh;
	int i;
	Chandef mh_joinAttemptCh;
	int config_GetMatch_CallQueueSize = 5;
	Chandef deferredCh;
	Chandef mh_callCh;
	Chandef mh_stopCh;
	int config_GetMatch_InputQueueSize = 5;
	int config_GetMatch_JoinAttemptQueueSize = 5;
	bool state = false;
