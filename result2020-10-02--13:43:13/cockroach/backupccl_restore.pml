#define lb_for569_0  -1
#define ub_for569_1  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example672862733/pkg/ccl/backupccl/restore_job.go
typedef Chandef {
	chan sync = [0] of {int};
...
for30:
	...
	if
	:: lb_for569_0 != -1 && ub_for569_1 != -1 -> 
				for(i : lb_for569_0.. ub_for569_1) {
for40:
		}
	:: else -> 
		do
