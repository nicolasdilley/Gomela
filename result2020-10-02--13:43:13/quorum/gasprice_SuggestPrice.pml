...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example933794056/eth/gasprice/gasprice.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10_exit:		for(i : lb_for113_2.. ub_for113_3) {
for20:		
		if
		:: ch.async_rcv?0;
		:: ch.sync?0;
