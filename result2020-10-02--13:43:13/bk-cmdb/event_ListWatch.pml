...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example245838319/src/storage/stream/event/list_watch.go
typedef Chandef {
	chan sync = [0] of {int};
...
for20:		do
		...
		if
		:: lb_for94_6 != -1 && ub_for94_7 != -1 -> 
						for(i : lb_for94_6.. ub_for94_7) {
for21:				
				if
				:: true -> 
					break
