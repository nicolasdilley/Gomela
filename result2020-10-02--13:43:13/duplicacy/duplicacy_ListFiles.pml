...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example593946979/src/duplicacy_gcdstorage.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	if
	:: lb_for444_0 != -1 && ub_for444_1 != -1 -> 
				for(i : lb_for444_0.. ub_for444_1) {
for10:
		}
	:: else -> 
		do
