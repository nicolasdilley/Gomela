#define lb_for401_0  -1
#define ub_for401_1  -1
#define lb_for411_2  -1
#define ub_for411_3  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example148026338/pkg/store/proxy.go
typedef Chandef {
	chan sync = [0] of {int};
