...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example582296028/aws/services/manual_services.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Wgdef wg;
	int groups_Groups = 5;
	int policies_PolicyNames = 5;
	int i;
	Chandef errc;
	int attached_AttachedPolicies = 5;
	int output_AttachedPolicies = 5;
	bool state = false;
	run wgMonitor(wg);
