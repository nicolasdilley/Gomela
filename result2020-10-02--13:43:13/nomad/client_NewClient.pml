...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example190109984/client/client.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	chan child_clientnewHeartbeatStop1 = [0] of {int};
	...
	chan child_clientNewFingerprintManager0 = [0] of {int};
	int i;
	...
	run clientNewFingerprintManager(c_shutdownCh,child_clientNewFingerprintManager0);
	child_clientNewFingerprintManager0?0;
	...
	run clientnewHeartbeatStop(c_shutdownCh,child_clientnewHeartbeatStop1);
	child_clientnewHeartbeatStop1?0;
