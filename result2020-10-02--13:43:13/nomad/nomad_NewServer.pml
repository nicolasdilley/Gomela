...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example190109984/nomad/server.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: 256 > 0 -> 
		s_eventCh.size = 256;
		run emptyChan(s_eventCh)
	:: else -> 
		run sync_monitor(s_eventCh)
	fi;
	...
	run ssetupSerf(s_eventCh,child_ssetupSerf0);
	child_ssetupSerf0?0;
