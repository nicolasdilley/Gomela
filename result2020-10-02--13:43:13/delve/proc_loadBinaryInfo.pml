#define lb_for1526_0  -1
#define ub_for1526_1  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example253919370/pkg/proc/bininfo.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
...
proctype go_biloadDebugInfoMaps(Wgdef wg) {
	...
	if
	:: lb_for1526_0 != -1 && ub_for1526_1 != -1 -> 
				for(i : lb_for1526_0.. ub_for1526_1) {
for10:			
			if
			:: true -> 
				break
