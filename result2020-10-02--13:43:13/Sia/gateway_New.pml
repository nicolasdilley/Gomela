...
#define lb_for81_2  -1
#define ub_for81_3  -1
#define lb_for289_4  -1
#define ub_for289_5  -1
#define lb_for202_6  -1
#define ub_for202_7  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example104754984/modules/gateway/gateway.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	if
	:: true -> 
				for(i : 1.. modules_BootstrapPeers) {
for10:
		}
	:: true;
	fi;
