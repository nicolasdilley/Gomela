...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example942100504/test/e2e_node/image_list.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Chandef imageCh;
	int maxImagePullRetries = 5;
	int images = 5;
	bool state = false;
	Wgdef wg;
	int parallelImagePullCount = 5;
	int i;
