#define lb_for502_0  -1
#define ub_for502_1  -1
#define lb_for63_2  -1
#define ub_for63_3  -1
#define lb_for51_4  -1
#define ub_for51_5  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example029177523/archive/src/github.com/miekg/dns/zscan.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype go_dnszlexer(Chandef c) {
	...
	if
	:: lb_for502_0 != -1 && ub_for502_1 != -1 -> 
				for(i : lb_for502_0.. ub_for502_1) {
for10:			
			if
			:: true -> 
...
proctype dnsendingToString(Chandef c;chan child) {
	...
	if
	:: lb_for51_4 != -1 && ub_for51_5 != -1 -> 
				for(i : lb_for51_4.. ub_for51_5) {
for23:			
			if
			:: true -> 
				goto stop_process
