...
#define lb_for62_2  -1
#define ub_for62_3  -1
#define lb_for1466_4  -1
#define ub_for1466_5  -1
#define lb_for1498_6  -1
#define ub_for1498_7  -1
#define lb_for1080_8  -1
#define ub_for1080_9  -1
#define lb_for201_10  -1
#define ub_for201_11  -1
#define lb_for1335_12  -1
#define ub_for1335_13  -1
#define lb_for1400_14  -1
#define ub_for1400_15  -1
#define lb_for1554_16  -1
#define ub_for1554_17  -1
#define lb_for225_18  -1
#define ub_for225_19  -1
#define lb_for251_20  -1
#define ub_for251_21  -1
#define lb_for1141_22  -1
#define ub_for1141_23  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example218841169/github.com/miekg/dns/zscan.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype dnssetEUI48(Chandef c;chan child) {
	...
	if
	:: lb_for1466_4 != -1 && ub_for1466_5 != -1 -> 
				for(i : lb_for1466_4.. ub_for1466_5) {
for24:			
			if
			:: true -> 
				goto stop_process
...
proctype dnssetEUI64(Chandef c;chan child) {
	...
	if
	:: lb_for1498_6 != -1 && ub_for1498_7 != -1 -> 
				for(i : lb_for1498_6.. ub_for1498_7) {
for25:			
			if
			:: true -> 
				goto stop_process
...
Altitude:		
	...
	if
	:: lb_for1080_8 != -1 && ub_for1080_9 != -1 -> 
				for(i : lb_for1080_8.. ub_for1080_9) {
for26:			
...
proctype dnsendingToString(Chandef c;chan child) {
	...
	if
	:: lb_for201_10 != -1 && ub_for201_11 != -1 -> 
				for(i : lb_for201_10.. ub_for201_11) {
for27:			
...
proctype dnssetNSEC(Chandef c;chan child) {
	...
	if
	:: lb_for1335_12 != -1 && ub_for1335_13 != -1 -> 
				for(i : lb_for1335_12.. ub_for1335_13) {
for28:			
...
proctype dnssetNSEC3(Chandef c;chan child) {
	...
	if
	:: lb_for1400_14 != -1 && ub_for1400_15 != -1 -> 
				for(i : lb_for1400_14.. ub_for1400_15) {
for29:			
...
proctype dnssetWKS(Chandef c;chan child) {
	...
	if
	:: lb_for1554_16 != -1 && ub_for1554_17 != -1 -> 
				for(i : lb_for1554_16.. ub_for1554_17) {
for210:			
...
proctype dnsendingToTxtSlice(Chandef c;chan child) {
	...
	:: true -> 
		...
		if
		:: lb_for225_18 != -1 && ub_for225_19 != -1 -> 
						for(i : lb_for225_18.. ub_for225_19) {
for211:				
...
for211_exit:		
	...
	:: true -> 
		...
		if
		:: lb_for251_20 != -1 && ub_for251_21 != -1 -> 
						for(i : lb_for251_20.. ub_for251_21) {
for212:				
				if
				:: c.async_rcv?0;
				:: c.sync?0;
...
proctype dnssetHIP(Chandef c;chan child) {
	...
	if
	:: lb_for1141_22 != -1 && ub_for1141_23 != -1 -> 
				for(i : lb_for1141_22.. ub_for1141_23) {
for213:			
