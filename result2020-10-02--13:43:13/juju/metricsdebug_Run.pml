...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example529324227/cmd/juju/metricsdebug/collectmetrics.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	if
	:: runResults > 0 -> 
		resultChannel.size = runResults;
		run emptyChan(resultChannel)
	:: else -> 
