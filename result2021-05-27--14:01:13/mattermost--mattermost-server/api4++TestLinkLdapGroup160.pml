...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/ldap_test.go#L160
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestLinkLdapGroup1600 = [1] of {int};
	run TestLinkLdapGroup160(child_TestLinkLdapGroup1600);
	run receiver(child_TestLinkLdapGroup1600)
stop_process:skip
}

proctype TestLinkLdapGroup160(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
