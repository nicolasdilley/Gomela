...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/web/web_test.go#L255
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPublicFilesRequest2550 = [1] of {int};
	run TestPublicFilesRequest255(child_TestPublicFilesRequest2550);
	run receiver(child_TestPublicFilesRequest2550)
stop_process:skip
}

proctype TestPublicFilesRequest255(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
