...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/web/oauth_test.go#L51
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestAuthorizeOAuthApp510 = [1] of {int};
	run TestAuthorizeOAuthApp51(child_TestAuthorizeOAuthApp510);
	run receiver(child_TestAuthorizeOAuthApp510)
stop_process:skip
}

proctype TestAuthorizeOAuthApp51(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
