...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L1579
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetUsersByUsernames15790 = [1] of {int};
	run TestGetUsersByUsernames1579(child_TestGetUsersByUsernames15790);
	run receiver(child_TestGetUsersByUsernames15790)
stop_process:skip
}

proctype TestGetUsersByUsernames1579(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
