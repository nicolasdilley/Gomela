...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L5898
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestReadThreads58980 = [1] of {int};
	run TestReadThreads5898(child_TestReadThreads58980);
	run receiver(child_TestReadThreads58980)
stop_process:skip
}

proctype TestReadThreads5898(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
