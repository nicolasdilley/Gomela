...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L232
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTeamUnread2320 = [1] of {int};
	run TestGetTeamUnread232(child_TestGetTeamUnread2320);
	run receiver(child_TestGetTeamUnread2320)
stop_process:skip
}

proctype TestGetTeamUnread232(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
