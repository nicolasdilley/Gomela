...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/file_test.go#L795
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetFileThumbnail7950 = [1] of {int};
	run TestGetFileThumbnail795(child_TestGetFileThumbnail7950);
	run receiver(child_TestGetFileThumbnail7950)
stop_process:skip
}

proctype TestGetFileThumbnail795(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
