...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/system_test.go#L190
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGenerateSupportPacket1900 = [1] of {int};
	run TestGenerateSupportPacket190(child_TestGenerateSupportPacket1900);
	run receiver(child_TestGenerateSupportPacket1900)
stop_process:skip
}

proctype TestGenerateSupportPacket190(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
