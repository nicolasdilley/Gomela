...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_test.go#L3527
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestChannelMembersMinusGroupMembers35270 = [1] of {int};
	run TestChannelMembersMinusGroupMembers3527(child_TestChannelMembersMinusGroupMembers35270);
	run receiver(child_TestChannelMembersMinusGroupMembers35270)
stop_process:skip
}

proctype TestChannelMembersMinusGroupMembers3527(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
