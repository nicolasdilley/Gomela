...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/channel_category_test.go#L15
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestCreateCategoryForTeamForUser150 = [1] of {int};
	run TestCreateCategoryForTeamForUser15(child_TestCreateCategoryForTeamForUser150);
	run receiver(child_TestCreateCategoryForTeamForUser150)
stop_process:skip
}

proctype TestCreateCategoryForTeamForUser15(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
