...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L1605
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestGetTotalUsersStat16050 = [1] of {int};
	run TestGetTotalUsersStat1605(child_TestGetTotalUsersStat16050);
	run receiver(child_TestGetTotalUsersStat16050)
stop_process:skip
}

proctype TestGetTotalUsersStat1605(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
