...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/web/web_test.go#L169
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestStaticFilesRequest1690 = [1] of {int};
	run TestStaticFilesRequest169(child_TestStaticFilesRequest1690);
	run receiver(child_TestStaticFilesRequest1690)
stop_process:skip
}

proctype TestStaticFilesRequest169(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
