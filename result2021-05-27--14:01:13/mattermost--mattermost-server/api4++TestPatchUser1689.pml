...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L1689
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestPatchUser16890 = [1] of {int};
	run TestPatchUser1689(child_TestPatchUser16890);
	run receiver(child_TestPatchUser16890)
stop_process:skip
}

proctype TestPatchUser1689(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_GenerateTestEmail8053 = [1] of {int};
	chan child_GenerateTestEmail8052 = [1] of {int};
	...
	run GenerateTestEmail805(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_GenerateTestEmail8052);
	child_GenerateTestEmail8052?0;
	run GenerateTestEmail805(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_GenerateTestEmail8053);
	child_GenerateTestEmail8053?0;
...
proctype GenerateTestEmail805(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
