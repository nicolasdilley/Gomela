...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/team_test.go#L739
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestRegenerateTeamInviteId7390 = [1] of {int};
	run TestRegenerateTeamInviteId739(child_TestRegenerateTeamInviteId7390);
	run receiver(child_TestRegenerateTeamInviteId7390)
stop_process:skip
}

proctype TestRegenerateTeamInviteId739(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
