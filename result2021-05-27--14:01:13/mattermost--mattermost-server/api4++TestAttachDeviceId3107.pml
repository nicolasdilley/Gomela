...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L3107
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestAttachDeviceId31070 = [1] of {int};
	run TestAttachDeviceId3107(child_TestAttachDeviceId31070);
	run receiver(child_TestAttachDeviceId31070)
stop_process:skip
}

proctype TestAttachDeviceId3107(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
