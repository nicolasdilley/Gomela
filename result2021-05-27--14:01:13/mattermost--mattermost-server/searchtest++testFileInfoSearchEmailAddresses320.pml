...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/store/searchtest/file_info_layer.go#L320
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_testFileInfoSearchEmailAddresses3200)
stop_process:skip
}
