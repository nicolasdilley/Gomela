...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/brand_test.go#L31
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUploadBrandImage310 = [1] of {int};
	run TestUploadBrandImage31(child_TestUploadBrandImage310);
	run receiver(child_TestUploadBrandImage310)
stop_process:skip
}

proctype TestUploadBrandImage31(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
