...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/cmd/mattermost/commands/command.go#L189
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_showCommandCmdF1890 = [1] of {int};
	run showCommandCmdF189(child_showCommandCmdF1890);
	run receiver(child_showCommandCmdF1890)
stop_process:skip
}

proctype showCommandCmdF189(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_getCommandFromCommandArg370 = [1] of {int};
	...
	run getCommandFromCommandArg37(a_srv_featureFlagSynchronizerMutex,a_srv_metricsLock,a_srv_PluginsLock,a_srv_pluginCommandsLock,a_srv_uploadLockMapMut,child_getCommandFromCommandArg370);
	child_getCommandFromCommandArg370?0;
...
proctype getCommandFromCommandArg37(Mutexdef a_srv_featureFlagSynchronizerMutex;Mutexdef a_srv_metricsLock;Mutexdef a_srv_PluginsLock;Mutexdef a_srv_pluginCommandsLock;Mutexdef a_srv_uploadLockMapMut;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
