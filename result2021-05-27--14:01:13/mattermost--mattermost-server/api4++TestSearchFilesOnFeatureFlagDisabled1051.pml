...
init { 
	chan child_TestSearchFilesOnFeatureFlagDisabled10510 = [1] of {int};
	run TestSearchFilesOnFeatureFlagDisabled1051(child_TestSearchFilesOnFeatureFlagDisabled10510);
	run receiver(child_TestSearchFilesOnFeatureFlagDisabled10510)
stop_process:skip
}

proctype TestSearchFilesOnFeatureFlagDisabled1051(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
