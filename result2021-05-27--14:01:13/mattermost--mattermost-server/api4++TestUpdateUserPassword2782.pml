...
// git_link=https://github.com/mattermost/mattermost-server/blob/5c16de58a02099df38e1e8486df148d1b798460a/api4/user_test.go#L2782
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
init { 
	chan child_TestUpdateUserPassword27820 = [1] of {int};
	run TestUpdateUserPassword2782(child_TestUpdateUserPassword27820);
	run receiver(child_TestUpdateUserPassword27820)
stop_process:skip
}

proctype TestUpdateUserPassword2782(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	chan child_LoginBasic27091 = [1] of {int};
	...
	run LoginBasic2709(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginBasic27091);
	child_LoginBasic27091?0;
...
proctype LoginBasic2709(Mutexdef th_BasicPost_propsMu;Mutexdef th_ConfigStore_configLock;Mutexdef th_Server_featureFlagSynchronizerMutex;Mutexdef th_Server_metricsLock;Mutexdef th_Server_PluginsLock;Mutexdef th_Server_pluginCommandsLock;Mutexdef th_Server_uploadLockMapMut;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_LoginBasic2WithClient7341 = [1] of {int};
	run LoginBasic2WithClient734(th_BasicPost_propsMu,th_ConfigStore_configLock,th_Server_featureFlagSynchronizerMutex,th_Server_metricsLock,th_Server_PluginsLock,th_Server_pluginCommandsLock,th_Server_uploadLockMapMut,child_LoginBasic2WithClient7341);
	child_LoginBasic2WithClient7341?0;
	stop_process: skip;
	child!0
}
