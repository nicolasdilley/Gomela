...
// git_link=https://github.com/sirupsen/logrus/blob/b50299cfaaa1bca85be76c8984070e846c7abfd2/logrus_test.go#L570
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestLoggingRace5700)
stop_process:skip
}
...
proctype TestLoggingRace570(chan child) {
	...
	wg.update!100;
		...
		run receiver(child_AnonymousTestLoggingRace5775730);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
