...
// git_link=https://github.com/uber-go/zap/blob/7b21229fb3f063275f4f169f8a79ad30aa001c51/field_test.go#L42
typedef Wgdef {
...
init { 
	...
	run receiver(child_assertCanBeReused420)
stop_process:skip
}
...
proctype assertCanBeReused42(chan child) {
	...
	run wgMonitor(wg);
		...
		run receiver(child_AnonymousassertCanBeReused51430);
		for10_end: skip
	};
	for10_exit: skip;
	wg.wait?0;
