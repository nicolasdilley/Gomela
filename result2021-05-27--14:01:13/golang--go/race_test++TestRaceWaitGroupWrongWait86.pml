...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/runtime/race/testdata/waitgroup_test.go#L86
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestRaceWaitGroupWrongWait86(chan child) {
	...
	run wgMonitor(wg);
	run AnonymousTestRaceWaitGroupWrongWait9187(c,wg,child_AnonymousTestRaceWaitGroupWrongWait91870);
	run receiver(child_AnonymousTestRaceWaitGroupWrongWait91870);
	run AnonymousTestRaceWaitGroupWrongWait9887(c,wg,child_AnonymousTestRaceWaitGroupWrongWait98871);
...
proctype AnonymousTestRaceWaitGroupWrongWait9187(Chandef c;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestRaceWaitGroupWrongWait9887(Chandef c;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
