...
proctype TestNoRaceWaitGroupConcurrentAdd345(chan child) {
	...
	run wgMonitor(wg);
		for(i : 0.. 4-1) {
		for10: skip;
		run AnonymousTestNoRaceWaitGroupConcurrentAdd350347(waiting,wg,child_AnonymousTestNoRaceWaitGroupConcurrentAdd3503470);
...
proctype AnonymousTestNoRaceWaitGroupConcurrentAdd350347(Chandef waiting;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
