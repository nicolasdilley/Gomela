...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/go/types/eval_test.go#L73
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEvalArith730 = [1] of {int};
	run TestEvalArith73(child_TestEvalArith730);
	run receiver(child_TestEvalArith730)
stop_process:skip
}

proctype TestEvalArith73(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
