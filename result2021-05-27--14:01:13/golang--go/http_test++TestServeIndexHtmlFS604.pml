...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/http/fs_test.go#L604
typedef Wgdef {
...
init { 
	chan child_TestServeIndexHtmlFS6040 = [1] of {int};
	run TestServeIndexHtmlFS604(child_TestServeIndexHtmlFS6040);
	run receiver(child_TestServeIndexHtmlFS6040)
stop_process:skip
}

proctype TestServeIndexHtmlFS604(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
