...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/runtime/race/testdata/chan_test.go#L619
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestNoRaceChanMutex619(chan child) {
	...
	run AnonymousTestNoRaceChanMutex624620(done,mtx,child_AnonymousTestNoRaceChanMutex6246200);
...
proctype AnonymousTestNoRaceChanMutex624620(Chandef done;Chandef mtx;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
