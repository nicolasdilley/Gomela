...
proctype TestNoRaceSelect358(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousTestNoRaceSelect364610 = [1] of {int};
	Chandef c1;
	Chandef c;
	Chandef compl;
	...
	run sync_monitor(c1);
	run AnonymousTestNoRaceSelect36461(compl,c,c1,child_AnonymousTestNoRaceSelect364610);
	run receiver(child_AnonymousTestNoRaceSelect364610);
...
proctype AnonymousTestNoRaceSelect36461(Chandef compl;Chandef c;Chandef c1;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
