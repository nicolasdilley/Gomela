...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/tcpsock_test.go#L473
...
proctype TestTCPReadWriteAllocs473(chan child) {
	...
	run AnonymousTestTCPReadWriteAllocs489488(errc,child_AnonymousTestTCPReadWriteAllocs4894880);
	...
	run sync_monitor(ch);
	run AnonymousTestTCPReadWriteAllocs522488(errc,ch,child_AnonymousTestTCPReadWriteAllocs5224881);
...
proctype AnonymousTestTCPReadWriteAllocs489488(Chandef errc;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestTCPReadWriteAllocs522488(Chandef errc;Chandef ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
