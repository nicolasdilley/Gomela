...
proctype doRequest21(chan child) {
	...
	chan child_AnonymousdoRequest37261 = [1] of {int};
	Chandef done;
	Chandef ch;
	...
	if
	:: true -> 
		run AnonymousdoRequest3026(ch,done,child_AnonymousdoRequest30260);
		run receiver(child_AnonymousdoRequest30260)
	:: true -> 
		run AnonymousdoRequest3726(ch,done,child_AnonymousdoRequest37261);
		run receiver(child_AnonymousdoRequest37261)
	fi;
...
proctype AnonymousdoRequest3026(Chandef ch;Chandef done;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousdoRequest3726(Chandef ch;Chandef done;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
