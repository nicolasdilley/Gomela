...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/go/types/eval_test.go#L59
#define not_found_Typ6122  -2
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEvalBasic590 = [1] of {int};
	run TestEvalBasic59(child_TestEvalBasic590);
	run receiver(child_TestEvalBasic590)
stop_process:skip
}

proctype TestEvalBasic59(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	if
	:: not_found_Typ6122-1 != -3 -> 
				for(i : 0.. not_found_Typ6122-1) {
			for10: skip;
