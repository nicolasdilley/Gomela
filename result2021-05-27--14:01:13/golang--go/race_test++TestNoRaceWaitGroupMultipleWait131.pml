...
proctype TestNoRaceWaitGroupMultipleWait131(chan child) {
	...
	run wgMonitor(wg);
	run AnonymousTestNoRaceWaitGroupMultipleWait134132(c,wg,child_AnonymousTestNoRaceWaitGroupMultipleWait1341320);
	run receiver(child_AnonymousTestNoRaceWaitGroupMultipleWait1341320);
	run AnonymousTestNoRaceWaitGroupMultipleWait138132(c,wg,child_AnonymousTestNoRaceWaitGroupMultipleWait1381321);
...
proctype AnonymousTestNoRaceWaitGroupMultipleWait134132(Chandef c;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestNoRaceWaitGroupMultipleWait138132(Chandef c;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
