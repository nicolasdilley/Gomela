...
proctype AnonymousTestTransportTLSHandshakeTimeout31893186(Chandef testdonec;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	if
	:: testdonec.deq?state,num_msgs;
	:: testdonec.sync?state -> 
		testdonec.rcving!false
	fi;
	stop_process: skip;
	child!0
}
