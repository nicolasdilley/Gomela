...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/runtime/race/testdata/waitgroup_test.go#L166
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestNoRaceWaitGroupMultipleWait3166(chan child) {
	...
	wg.update!3;
		for(i : 0.. 3-1) {
		for10: skip;
		run AnonymousTestNoRaceWaitGroupMultipleWait3173173(done,wg,child_AnonymousTestNoRaceWaitGroupMultipleWait31731730);
	...
	for10_exit: skip;
		for(i : 0.. 3-1) {
		for20: skip;
		run AnonymousTestNoRaceWaitGroupMultipleWait3179169(done,wg,child_AnonymousTestNoRaceWaitGroupMultipleWait31791692);
...
proctype AnonymousTestNoRaceWaitGroupMultipleWait3173173(Chandef done;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestNoRaceWaitGroupMultipleWait3179169(Chandef done;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
