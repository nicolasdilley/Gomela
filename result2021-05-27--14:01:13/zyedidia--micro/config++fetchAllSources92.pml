...
proctype fetchAllSources92(int count;chan child) {
	...
	wgDone.update!1;
		for(i : 0.. count-1) {
		for10: skip;
		run AnonymousfetchAllSources102102(results,wgQuery,wgDone,child_AnonymousfetchAllSources1021020);
...
proctype AnonymousfetchAllSources102102(Chandef results;Wgdef wgQuery;Wgdef wgDone;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
