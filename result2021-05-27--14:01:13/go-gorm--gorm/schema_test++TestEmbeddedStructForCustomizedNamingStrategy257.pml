...
// git_link=https://github.com/go-gorm/gorm/blob/70e93e73d8c739a81e27b0cb73aa5513cafb63e0/schema/schema_test.go#L257
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEmbeddedStructForCustomizedNamingStrategy2570 = [1] of {int};
	run TestEmbeddedStructForCustomizedNamingStrategy257(child_TestEmbeddedStructForCustomizedNamingStrategy2570);
	run receiver(child_TestEmbeddedStructForCustomizedNamingStrategy2570)
stop_process:skip
}

proctype TestEmbeddedStructForCustomizedNamingStrategy257(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
