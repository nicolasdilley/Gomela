...
#define relations11  -2 // opt relations11
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype checkSchemaRelation123(Mutexdef s_cacheStore_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int r_References = -2; // opt r_References
	int relation_References = -2; // opt relation_References
	int relation_JoinTable_Fields = -2; // opt relation_JoinTable_Fields
	stop_process: skip;
	child!0
}
