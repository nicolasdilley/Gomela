...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/expression/builtin_cast.go#L221
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_getFunction2210 = [1] of {int};
	run getFunction221(child_getFunction2210);
	run receiver(child_getFunction2210)
stop_process:skip
}

proctype getFunction221(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
