...
#define not_found_356  -2 // opt not_found_356
#define not_found_361  -2 // opt not_found_361
#define not_found_365  -2 // opt not_found_365
#define not_found_369  -2 // opt not_found_369
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype ToPB332(chan child) {
	...
	Mutexdef sc_mu;
	int p_EqualConditions = -2; // opt p_EqualConditions
	int p_RightJoinKeys = -2; // opt p_RightJoinKeys
	int p_LeftJoinKeys = -2; // opt p_LeftJoinKeys
