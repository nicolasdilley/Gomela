...
// git_link=https://github.com/pingcap/tidb/blob/207ce344cbb044ffb1b2681f1ba320a154979f6d/planner/core/task.go#L419
typedef Wgdef {
...
init { 
	chan child_GetCost4190 = [1] of {int};
	run GetCost419(child_GetCost4190);
	run receiver(child_GetCost4190)
stop_process:skip
}

proctype GetCost419(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
