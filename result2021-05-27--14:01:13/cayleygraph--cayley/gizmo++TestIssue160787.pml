...
// git_link=https://github.com/cayleygraph/cayley/blob/2d53d0ab1147d1464f6a83509a0ac21750f02bd4/query/gizmo/gizmo_test.go#L787
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestIssue160787(chan child) {
	...
	run Execute282(ses_ns_mu,ses_sch_rulesForTypeMu,child_Execute2820);
	child_Execute2820?0;
		stop_process: skip;
	stop_process: skip;
	child!0
