...
// git_link=https://github.com/goharbor/harbor/blob/f8171cdf6e914a08ace62508eabef81ceacfe5a2/src/pkg/task/execution.go#L288
...
proctype StopAndWait288(chan child) {
	...
	run AnonymousStopAndWait294291(errChan,lock,child_AnonymousStopAndWait2942910);
...
proctype AnonymousStopAndWait294291(Chandef errChan;Mutexdef lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
