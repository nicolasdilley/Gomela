...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/agent/auto-config/auto_encrypt_test.go#L196
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestAutoEncrypt_InitialCerts1960)
stop_process:skip
}
