...
// git_link=https://github.com/hashicorp/consul/blob/8d6cbe72813779f60ac24d119cc311c21003f4ce/command/snapshot/inspect/snapshot_inspect_test.go#L41
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestSnapshotInspectCommand_Validation410)
stop_process:skip
}
