...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/terraform/context_input_test.go#L154
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContext2Input_providerOnce1540 = [1] of {int};
	run TestContext2Input_providerOnce154(child_TestContext2Input_providerOnce1540);
	run receiver(child_TestContext2Input_providerOnce1540)
stop_process:skip
}

proctype TestContext2Input_providerOnce154(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
