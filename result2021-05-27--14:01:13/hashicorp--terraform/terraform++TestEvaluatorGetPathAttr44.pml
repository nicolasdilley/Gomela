...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/terraform/evaluate_test.go#L44
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEvaluatorGetPathAttr440 = [1] of {int};
	run TestEvaluatorGetPathAttr44(child_TestEvaluatorGetPathAttr440);
	run receiver(child_TestEvaluatorGetPathAttr440)
stop_process:skip
}

proctype TestEvaluatorGetPathAttr44(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
