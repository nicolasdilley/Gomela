...
// git_link=https://github.com/hashicorp/terraform/blob/c63c06d3c4d09a1bf1a1adc20216503e0cc2f881/terraform/node_resource_plan_test.go#L12
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestNodePlannableResourceExecute120 = [1] of {int};
	run TestNodePlannableResourceExecute12(child_TestNodePlannableResourceExecute120);
	run receiver(child_TestNodePlannableResourceExecute120)
stop_process:skip
}

proctype TestNodePlannableResourceExecute12(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
