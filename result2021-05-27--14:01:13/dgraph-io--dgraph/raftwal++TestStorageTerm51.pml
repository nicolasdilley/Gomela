...
// git_link=https://github.com/dgraph-io/dgraph/blob/6b188f254202f9c38b16c4769b672dd0e9d596ac/raftwal/storage_test.go#L51
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestStorageTerm510 = [1] of {int};
	run TestStorageTerm51(child_TestStorageTerm510);
	run receiver(child_TestStorageTerm510)
stop_process:skip
}

proctype TestStorageTerm51(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Term2231 = [1] of {int};
	chan child_Term2232 = [1] of {int};
...
proctype Term223(Mutexdef w_lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
