...
// git_link=https://github.com/rclone/rclone/blob/6ef7178ee4465f2361b6e2cf483cef5bbfd9c95c/backend/zoho/zoho.go#L208
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_setupRoot2080)
stop_process:skip
}
...
proctype setupRoot208(chan child) {
	...
	Mutexdef authSrv_mu;
	Mutexdef __mu;
	int workspaces = -2; // opt workspaces
