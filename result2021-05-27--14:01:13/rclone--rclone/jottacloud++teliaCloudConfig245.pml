...
// git_link=https://github.com/rclone/rclone/blob/6ef7178ee4465f2361b6e2cf483cef5bbfd9c95c/backend/jottacloud/jottacloud.go#L245
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_teliaCloudConfig2450)
stop_process:skip
}
...
proctype setupMountpoint521(Mutexdef srv_mu;Mutexdef apiSrv_mu;chan child) {
	...
	int dev_MountPoints = -2; // opt dev_MountPoints
	int acc_Devices = -2; // opt acc_Devices
