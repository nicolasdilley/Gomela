...
// git_link=https://github.com/rclone/rclone/blob/6ef7178ee4465f2361b6e2cf483cef5bbfd9c95c/backend/drive/drive.go#L953
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_configTeamDrive9530)
stop_process:skip
}
...
proctype configTeamDrive953(chan child) {
	...
	int teamDrives = -2; // opt teamDrives
