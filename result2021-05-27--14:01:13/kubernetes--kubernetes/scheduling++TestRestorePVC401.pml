...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/controller/volume/scheduling/scheduler_assume_cache_test.go#L401
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRestorePVC4010 = [1] of {int};
	run TestRestorePVC401(child_TestRestorePVC4010);
	run receiver(child_TestRestorePVC4010)
stop_process:skip
}

proctype TestRestorePVC401(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
