...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/accessreview_test.go#L231
typedef Wgdef {
...
init { 
	chan child_TestLocalSubjectAccessReview2310 = [1] of {int};
	run TestLocalSubjectAccessReview231(child_TestLocalSubjectAccessReview2310);
	run receiver(child_TestLocalSubjectAccessReview2310)
stop_process:skip
}

proctype TestLocalSubjectAccessReview231(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
