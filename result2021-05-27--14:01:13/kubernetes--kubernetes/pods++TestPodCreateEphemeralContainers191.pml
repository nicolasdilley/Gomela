...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/pods/pods_test.go#L191
typedef Wgdef {
...
init { 
	chan child_TestPodCreateEphemeralContainers1910 = [1] of {int};
	run TestPodCreateEphemeralContainers191(child_TestPodCreateEphemeralContainers1910);
	run receiver(child_TestPodCreateEphemeralContainers1910)
stop_process:skip
}

proctype TestPodCreateEphemeralContainers191(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
