...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/configmap/configmap_test.go#L35
typedef Wgdef {
...
init { 
	chan child_TestConfigMap350 = [1] of {int};
	run TestConfigMap35(child_TestConfigMap350);
	run receiver(child_TestConfigMap350)
stop_process:skip
}

proctype TestConfigMap35(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
