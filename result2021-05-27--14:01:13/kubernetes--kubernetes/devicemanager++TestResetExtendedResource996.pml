...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/cm/devicemanager/manager_test.go#L996
typedef Wgdef {
...
proctype TestResetExtendedResource996(chan child) {
	...
	run ShouldResetExtendedResourceCapacity1086(testManager_server_serveWG,testManager_wg,testManager_mutex,testManager_server_mu,child_ShouldResetExtendedResourceCapacity10861);
...
proctype writeCheckpoint573(Wgdef m_server_serveWG;Wgdef m_wg;Mutexdef m_mutex;Mutexdef m_server_mu;chan child) {
	...
	bool state;
	int num_msgs;
	int m_healthyDevices = -2; // opt m_healthyDevices
	m_mutex.Lock!false;
...
proctype ShouldResetExtendedResourceCapacity1086(Wgdef m_server_serveWG;Wgdef m_wg;Mutexdef m_mutex;Mutexdef m_server_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
