...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/e2e/framework/providers/gce/gce.go#L365
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_SetInstanceTags3650 = [1] of {int};
	run SetInstanceTags365(child_SetInstanceTags3650);
	run receiver(child_SetInstanceTags3650)
stop_process:skip
}

proctype SetInstanceTags365(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
