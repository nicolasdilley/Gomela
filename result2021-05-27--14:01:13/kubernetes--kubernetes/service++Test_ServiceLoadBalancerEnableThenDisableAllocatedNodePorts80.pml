...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/service/loadbalancer_test.go#L80
typedef Wgdef {
...
init { 
	chan child_Test_ServiceLoadBalancerEnableThenDisableAllocatedNodePorts800 = [1] of {int};
	run Test_ServiceLoadBalancerEnableThenDisableAllocatedNodePorts80(child_Test_ServiceLoadBalancerEnableThenDisableAllocatedNodePorts800);
	run receiver(child_Test_ServiceLoadBalancerEnableThenDisableAllocatedNodePorts800)
stop_process:skip
}

proctype Test_ServiceLoadBalancerEnableThenDisableAllocatedNodePorts80(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
