...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/kubelet/cloudresource/cloud_request_manager_test.go#L84
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestNodeAddressesUsesLastSuccess840)
stop_process:skip
}
...
proctype TestNodeAddressesUsesLastSuccess84(chan child) {
	...
	run NewSyncManager56(cloud_addCallLock,cloud_addressesMux,cloud_Lock,child_NewSyncManager560);
	child_NewSyncManager560?0;
	stop_process: skip;
	child!0
}
proctype NewSyncManager56(Mutexdef cloud_addCallLock;Mutexdef cloud_addressesMux;Mutexdef cloud_Lock;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
