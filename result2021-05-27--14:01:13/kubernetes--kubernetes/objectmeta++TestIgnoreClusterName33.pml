...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/objectmeta/objectmeta_test.go#L33
typedef Wgdef {
...
init { 
	chan child_TestIgnoreClusterName330 = [1] of {int};
	run TestIgnoreClusterName33(child_TestIgnoreClusterName330);
	run receiver(child_TestIgnoreClusterName330)
stop_process:skip
}

proctype TestIgnoreClusterName33(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
