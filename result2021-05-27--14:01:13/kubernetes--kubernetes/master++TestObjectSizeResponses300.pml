...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/master/synthetic_master_test.go#L300
typedef Wgdef {
...
init { 
	chan child_TestObjectSizeResponses3000 = [1] of {int};
	run TestObjectSizeResponses300(child_TestObjectSizeResponses3000);
	run receiver(child_TestObjectSizeResponses3000)
stop_process:skip
}

proctype TestObjectSizeResponses300(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
