...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/auth_test.go#L1069
typedef Wgdef {
...
init { 
	chan child_TestKindAuthorization10690 = [1] of {int};
	run TestKindAuthorization1069(child_TestKindAuthorization10690);
	run receiver(child_TestKindAuthorization10690)
stop_process:skip
}

proctype TestKindAuthorization1069(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
