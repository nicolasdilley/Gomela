...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/master/synthetic_master_test.go#L351
typedef Wgdef {
...
init { 
	chan child_TestWatchSucceedsWithoutArgs3510 = [1] of {int};
	run TestWatchSucceedsWithoutArgs351(child_TestWatchSucceedsWithoutArgs3510);
	run receiver(child_TestWatchSucceedsWithoutArgs3510)
stop_process:skip
}

proctype TestWatchSucceedsWithoutArgs351(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
