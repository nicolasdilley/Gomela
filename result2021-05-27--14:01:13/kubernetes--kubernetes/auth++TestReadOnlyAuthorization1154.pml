...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/auth/auth_test.go#L1154
typedef Wgdef {
...
init { 
	chan child_TestReadOnlyAuthorization11540 = [1] of {int};
	run TestReadOnlyAuthorization1154(child_TestReadOnlyAuthorization11540);
	run receiver(child_TestReadOnlyAuthorization11540)
stop_process:skip
}

proctype TestReadOnlyAuthorization1154(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
