...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/apimachinery/watch_timeout_test.go#L38
typedef Wgdef {
...
init { 
	chan child_TestWatchClientTimeout380 = [1] of {int};
	run TestWatchClientTimeout38(child_TestWatchClientTimeout380);
	run receiver(child_TestWatchClientTimeout380)
stop_process:skip
}

proctype TestWatchClientTimeout38(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
