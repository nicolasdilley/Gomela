...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/master/synthetic_master_test.go#L114
typedef Wgdef {
...
init { 
	chan child_TestEmptyList1140 = [1] of {int};
	run TestEmptyList114(child_TestEmptyList1140);
	run receiver(child_TestEmptyList1140)
stop_process:skip
}

proctype TestEmptyList114(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
