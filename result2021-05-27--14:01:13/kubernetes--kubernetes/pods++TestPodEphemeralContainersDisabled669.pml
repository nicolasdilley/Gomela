...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/pods/pods_test.go#L669
typedef Wgdef {
...
init { 
	chan child_TestPodEphemeralContainersDisabled6690 = [1] of {int};
	run TestPodEphemeralContainersDisabled669(child_TestPodEphemeralContainersDisabled6690);
	run receiver(child_TestPodEphemeralContainersDisabled6690)
stop_process:skip
}

proctype TestPodEphemeralContainersDisabled669(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
