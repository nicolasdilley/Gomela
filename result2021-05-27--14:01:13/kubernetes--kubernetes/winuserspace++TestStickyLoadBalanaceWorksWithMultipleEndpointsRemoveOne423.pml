...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/pkg/proxy/winuserspace/roundrobin_test.go#L423
...
proctype OnEndpointsUpdate241(Mutexdef lb_lock;chan child) {
	...
	:: portsToEndpoints-1 != -3 -> 
			...
			if
			:: true -> 
				run updateAffinityMap194(lb_lock,not_found_261,child_updateAffinityMap1948);
