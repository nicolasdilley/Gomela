...
// git_link=https://github.com/kubernetes/kubernetes/blob/0277cff2682d5a0d3c6fa2109f7f82e8db3f2ed8/test/integration/metrics/metrics_test.go#L90
typedef Wgdef {
...
proctype TestApiserverMetrics90(chan child) {
	...
	run scrapeMetrics39(s_wg,s_Config_mu,s_mu,s_TLS_mutex,child_scrapeMetrics390);
	child_scrapeMetrics390?0;
		stop_process: skip;
	stop_process: skip;
	child!0
}
proctype scrapeMetrics39(Wgdef s_wg;Mutexdef s_Config_mu;Mutexdef s_mu;Mutexdef s_TLS_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
