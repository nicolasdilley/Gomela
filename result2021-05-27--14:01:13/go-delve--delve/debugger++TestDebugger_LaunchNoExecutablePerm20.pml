...
// git_link=https://github.com/go-delve/delve/blob/9ed4ba0c49d916bf128ecf69fcc109235aeed075/service/debugger/debugger_unix_test.go#L20
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestDebugger_LaunchNoExecutablePerm200 = [1] of {int};
	run TestDebugger_LaunchNoExecutablePerm20(child_TestDebugger_LaunchNoExecutablePerm200);
	run receiver(child_TestDebugger_LaunchNoExecutablePerm200)
stop_process:skip
}

proctype TestDebugger_LaunchNoExecutablePerm20(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
