...
// git_link=https://github.com/grafana/loki/blob/aa544a9dffdb8e78f7d7ed8edafce466d333b0a8/clients/pkg/logentry/stages/pack_test.go#L43
#define not_found_46  -2 // opt not_found_46
#define not_found_35  -2 // opt not_found_35
#define not_found_63  -2 // opt not_found_63
...
proctype TestPackPipeline43(chan child) {
	...
	run NewPipeline27(registry_mtx,not_found_46,child_NewPipeline270);
	child_NewPipeline270?0;
	stop_process: skip;
	child!0
}
proctype NewPipeline27(Mutexdef registerer_mtx;int stgs;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
