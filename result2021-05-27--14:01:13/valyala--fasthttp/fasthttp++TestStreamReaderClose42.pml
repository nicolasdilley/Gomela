...
// git_link=https://github.com/valyala/fasthttp/blob/19fcd408632d6dae8425ae95c6c62a25c823ff81/stream_test.go#L42
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestStreamReaderClose42(chan child) {
	...
	od;
	for10_exit: skip;
	run AnonymousTestStreamReaderClose9046(ch,child_AnonymousTestStreamReaderClose90460);
...
proctype AnonymousTestStreamReaderClose9046(Chandef ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
