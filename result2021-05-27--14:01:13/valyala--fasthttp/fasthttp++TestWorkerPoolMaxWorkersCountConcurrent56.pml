...
// git_link=https://github.com/valyala/fasthttp/blob/19fcd408632d6dae8425ae95c6c62a25c823ff81/workerpool_test.go#L56
#define TestWorkerPoolMaxWorkersCountConcurrent_concurrency  ??
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype TestWorkerPoolMaxWorkersCountConcurrent56(chan child) {
	...
	Chandef ch;
	int concurrency = TestWorkerPoolMaxWorkersCountConcurrent_concurrency; // mand concurrency
	...
	:: else -> 
		...
		for10: skip;
		run AnonymousTestWorkerPoolMaxWorkersCountConcurrent6260(ch,child_AnonymousTestWorkerPoolMaxWorkersCountConcurrent62600);
...
proctype AnonymousTestWorkerPoolMaxWorkersCountConcurrent6260(Chandef ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
