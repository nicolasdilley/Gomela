...
// git_link=https://github.com/syncthing/syncthing/blob/87a0eecc31a0a5eeef1d0da510f4d5832e022e1f/lib/db/backend/leveldb_open.go#L39
typedef Wgdef {
...
init { 
	chan child_OpenLevelDB390 = [1] of {int};
	run OpenLevelDB39(child_OpenLevelDB390);
	run receiver(child_OpenLevelDB390)
stop_process:skip
}

proctype OpenLevelDB39(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
