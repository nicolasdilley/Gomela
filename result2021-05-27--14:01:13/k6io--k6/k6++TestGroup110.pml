...
proctype TestGroup110(chan child) {
	...
	run WithState31(state_Samples,state_CookieJar_mu,state_Group_checkMutex,state_Group_groupMutex,state_RPSLimit_mu,state_TLSConfig_mutex,child_WithState310);
...
proctype WithState31(Chandef state_Samples;Mutexdef state_CookieJar_mu;Mutexdef state_Group_checkMutex;Mutexdef state_Group_groupMutex;Mutexdef state_RPSLimit_mu;Mutexdef state_TLSConfig_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
