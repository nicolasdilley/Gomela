...
// git_link=https://github.com/gin-gonic/gin/blob/5452a1d3ef0982ffea95fb9e88e5425b0928c431/context_test.go#L767
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextRenderIndentedJSON7670 = [1] of {int};
	run TestContextRenderIndentedJSON767(child_TestContextRenderIndentedJSON7670);
	run receiver(child_TestContextRenderIndentedJSON7670)
stop_process:skip
}

proctype TestContextRenderIndentedJSON767(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
