...
// git_link=https://github.com/hashicorp/packer/blob/a9c2283ee589b203c0ce16174a5747b7d2053d61/builder/digitalocean/wait.go#L113
typedef Chandef {
	chan sync = [0] of {bool};
	chan enq = [0] of {int};
...
proctype waitForActionState113(chan child) {
	...
	run AnonymouswaitForActionState120116(done,result,child_AnonymouswaitForActionState1201160);
...
proctype AnonymouswaitForActionState120116(Chandef done;Chandef result;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
