...
// git_link=https://github.com/hashicorp/packer/blob/a9c2283ee589b203c0ce16174a5747b7d2053d61/packer/provisioner_test.go#L112
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestPausedProvisionerProvision112(chan child) {
	...
	run Provision146(ui_l,comm_StartCmd_m,child_Provision1460);
	child_Provision1460?0;
	stop_process: skip;
	child!0
}
proctype Provision146(Mutexdef ui_l;Mutexdef comm_StartCmd_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	od;
	for10_exit: skip;
	run Provision34(ui_l,comm_StartCmd_m,child_Provision341);
