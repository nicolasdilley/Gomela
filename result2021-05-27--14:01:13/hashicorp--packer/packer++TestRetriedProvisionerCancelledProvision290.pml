...
// git_link=https://github.com/hashicorp/packer/blob/a9c2283ee589b203c0ce16174a5747b7d2053d61/packer/provisioner_test.go#L290
...
init { 
	chan child_TestRetriedProvisionerCancelledProvision2900 = [1] of {int};
	run TestRetriedProvisionerCancelledProvision290(child_TestRetriedProvisionerCancelledProvision2900);
	run receiver(child_TestRetriedProvisionerCancelledProvision2900)
stop_process:skip
}

proctype TestRetriedProvisionerCancelledProvision290(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype Provision172(Mutexdef ui_l;Mutexdef comm_StartCmd_m;chan child) {
	...
	run Provision34(ui_l,comm_StartCmd_m,child_Provision340);
	...
	:: 0 != -2 && ub_for183_2 != -2 -> 
			...
			child_Say473?0;
			run Provision34(ui_l,comm_StartCmd_m,child_Provision344);
...
proctype Provision34(Mutexdef ui_l;Mutexdef comm_StartCmd_m;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
