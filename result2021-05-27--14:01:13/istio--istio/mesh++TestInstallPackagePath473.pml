...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/operator/cmd/mesh/manifest-generate_test.go#L473
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestInstallPackagePath4730)
stop_process:skip
}
