...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/galley/pkg/config/source/kube/inmemory/kubesource_test.go#L244
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestKubeSource_NonStringKey2440 = [1] of {int};
	run TestKubeSource_NonStringKey244(child_TestKubeSource_NonStringKey2440);
	run receiver(child_TestKubeSource_NonStringKey2440)
stop_process:skip
}

proctype TestKubeSource_NonStringKey244(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
