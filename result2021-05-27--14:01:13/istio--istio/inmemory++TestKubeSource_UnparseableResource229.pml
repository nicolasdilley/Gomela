...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/galley/pkg/config/source/kube/inmemory/kubesource_test.go#L229
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestKubeSource_UnparseableResource2290 = [1] of {int};
	run TestKubeSource_UnparseableResource229(child_TestKubeSource_UnparseableResource2290);
	run receiver(child_TestKubeSource_UnparseableResource2290)
stop_process:skip
}

proctype TestKubeSource_UnparseableResource229(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
