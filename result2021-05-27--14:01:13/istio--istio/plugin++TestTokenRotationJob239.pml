...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/security/pkg/credentialfetcher/plugin/gce_test.go#L239
typedef Wgdef {
...
init { 
	...
	run receiver(child_TestTokenRotationJob2390)
stop_process:skip
}
