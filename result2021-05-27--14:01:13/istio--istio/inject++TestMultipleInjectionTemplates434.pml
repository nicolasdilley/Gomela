...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/pkg/kube/inject/inject_test.go#L434
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestMultipleInjectionTemplates434(chan child) {
	...
	run runWebhook555(webhook_mu,child_runWebhook5551);
