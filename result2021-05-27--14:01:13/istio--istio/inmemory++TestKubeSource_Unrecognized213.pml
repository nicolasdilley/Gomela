...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/galley/pkg/config/source/kube/inmemory/kubesource_test.go#L213
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestKubeSource_Unrecognized2130 = [1] of {int};
	run TestKubeSource_Unrecognized213(child_TestKubeSource_Unrecognized2130);
	run receiver(child_TestKubeSource_Unrecognized2130)
stop_process:skip
}

proctype TestKubeSource_Unrecognized213(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
