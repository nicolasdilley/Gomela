...
// git_link=https://github.com/istio/istio/blob/9a5df21188426a6a7dd7d7503e01330a79db8a48/pkg/webhooks/validation/controller/controller_test.go#L244
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype updateValidatingWebhookConfiguration350(Mutexdef c_injectedMu;chan child) {
	...
	bool state;
	int num_msgs;
	int updated_Webhooks = -2; // opt updated_Webhooks
