...
proctype TestScrapeLoopAppendExemplarSeries1605(chan child) {
	...
	int scrapeText = -2; // opt scrapeText
	int exemplars = -2; // opt exemplars
	int samples = -2; // opt samples
...
proctype iterDone774(Mutexdef c_metaMtx;chan child) {
	...
	bool state;
	int num_msgs;
	int c_seriesCur = -2; // opt c_seriesCur
	int c_metadata = -2; // opt c_metadata
	int c_droppedSeries = -2; // opt c_droppedSeries
	int c_series = -2; // opt c_series
...
proctype forEachStale859(Mutexdef c_metaMtx;chan child) {
	...
	bool state;
	int num_msgs;
	int c_seriesPrev = -2; // opt c_seriesPrev
	stop_process: skip;
	child!0
}
