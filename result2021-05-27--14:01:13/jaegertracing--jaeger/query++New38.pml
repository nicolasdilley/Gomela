...
// git_link=https://github.com/jaegertracing/jaeger/blob/12bba8c9b91cf4a29d314934bc08f4a80e43c042/cmd/anonymizer/app/query/query.go#L38
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_New380 = [1] of {int};
	run New38(child_New380);
	run receiver(child_New380)
stop_process:skip
}

proctype New38(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
