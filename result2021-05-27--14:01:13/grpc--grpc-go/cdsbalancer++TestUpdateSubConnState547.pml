...
// git_link=https://github.com/grpc/grpc-go/blob/ebd6aba6754d073a696e5727158cd0c917ce1019/xds/internal/balancer/cdsbalancer/cdsbalancer_test.go#L547
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestUpdateSubConnState547(chan child) {
	...
	run UpdateSubConnState485(cdsB_updateCh_mu,cdsB_xdsHI_mu,child_UpdateSubConnState4852);
