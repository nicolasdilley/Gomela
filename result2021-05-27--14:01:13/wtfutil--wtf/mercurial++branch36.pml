...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/mercurial/hg_repo.go#L36
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_branch360 = [1] of {int};
	run branch36(child_branch360);
	run receiver(child_branch360)
stop_process:skip
}

proctype branch36(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
