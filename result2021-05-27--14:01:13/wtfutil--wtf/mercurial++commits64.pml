...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/mercurial/hg_repo.go#L64
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_commits640 = [1] of {int};
	run commits64(child_commits640);
	run receiver(child_commits640)
stop_process:skip
}

proctype commits64(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
