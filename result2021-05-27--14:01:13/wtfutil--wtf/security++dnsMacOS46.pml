...
// git_link=https://github.com/wtfutil/wtf/blob/91942b68f203aa95e43dfa637165f0136a9343da/modules/security/dns.go#L46
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_dnsMacOS460 = [1] of {int};
	run dnsMacOS46(child_dnsMacOS460);
	run receiver(child_dnsMacOS460)
stop_process:skip
}

proctype dnsMacOS46(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
