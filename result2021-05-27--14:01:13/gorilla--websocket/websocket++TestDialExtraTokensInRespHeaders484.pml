...
// git_link=https://github.com/gorilla/websocket/blob/e8629af678b7fe13f35dff5e197de93b4148a909/client_server_test.go#L484
typedef Wgdef {
...
init { 
	chan child_TestDialExtraTokensInRespHeaders4840 = [1] of {int};
	run TestDialExtraTokensInRespHeaders484(child_TestDialExtraTokensInRespHeaders4840);
	run receiver(child_TestDialExtraTokensInRespHeaders4840)
stop_process:skip
}

proctype TestDialExtraTokensInRespHeaders484(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
