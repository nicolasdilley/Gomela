...
// git_link=https://github.com/gorilla/websocket/blob/e8629af678b7fe13f35dff5e197de93b4148a909/client_server_test.go#L420
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestDialBadOrigin4200)
stop_process:skip
}
