...
// git_link=https://github.com/traefik/traefik/blob/080cf98e512f6fcb93838de76a6aa34ff147dee4/pkg/server/server_entrypoint_tcp.go#L503
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_createHTTPServer5030)
stop_process:skip
}
...
proctype createHTTPServer503(chan child) {
	...
	run receiver(child_AnonymouscreateHTTPServer5305041);
	goto stop_process;
	stop_process: skip;
	child!0
}
