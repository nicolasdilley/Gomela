...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/daemon/logger/splunk/splunk_test.go#L574
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRawFormatWithLabels5740 = [1] of {int};
	run TestRawFormatWithLabels574(child_TestRawFormatWithLabels5740);
	run receiver(child_TestRawFormatWithLabels5740)
stop_process:skip
}

proctype TestRawFormatWithLabels574(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
