...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/registry/resumable/resumablerequestreader_test.go#L180
typedef Wgdef {
...
init { 
	chan child_TestResumableRequestReaderWithZeroTotalSize1800 = [1] of {int};
	run TestResumableRequestReaderWithZeroTotalSize180(child_TestResumableRequestReaderWithZeroTotalSize1800);
	run receiver(child_TestResumableRequestReaderWithZeroTotalSize1800)
stop_process:skip
}

proctype TestResumableRequestReaderWithZeroTotalSize180(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
