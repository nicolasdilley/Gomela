...
// git_link=https://github.com/moby/moby/blob/5a82cee6d499e51bc903a743e4f0f205adb161a9/pkg/ioutils/bytespipe_test.go#L11
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestBytesPipeRead110)
stop_process:skip
}
