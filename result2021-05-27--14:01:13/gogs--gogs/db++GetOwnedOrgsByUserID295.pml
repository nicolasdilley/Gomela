...
// git_link=https://github.com/gogs/gogs/blob/509a392272a2ba2bde9d64bf5a55a58d0eadccc4/internal/db/org.go#L295
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype GetOwnedOrgsByUserID295(chan child) {
	...
	run getOwnedOrgsByUserID288(sess_db_reflectCacheMutex,sess_engine_cacherLock,sess_engine_mutex,child_getOwnedOrgsByUserID2880);
	child_getOwnedOrgsByUserID2880?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
proctype getOwnedOrgsByUserID288(Mutexdef sess_db_reflectCacheMutex;Mutexdef sess_engine_cacherLock;Mutexdef sess_engine_mutex;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
