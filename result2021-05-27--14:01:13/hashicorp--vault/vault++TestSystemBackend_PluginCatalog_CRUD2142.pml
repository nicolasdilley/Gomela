...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/logical_system_test.go#L2142
typedef Wgdef {
...
init { 
	chan child_TestSystemBackend_PluginCatalog_CRUD21420 = [1] of {int};
	run TestSystemBackend_PluginCatalog_CRUD2142(child_TestSystemBackend_PluginCatalog_CRUD21420);
	run receiver(child_TestSystemBackend_PluginCatalog_CRUD21420)
stop_process:skip
}

proctype TestSystemBackend_PluginCatalog_CRUD2142(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
