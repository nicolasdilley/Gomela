...
proctype deleteTestGroup498(chan child) {
	...
	int listGroupPoliciesOutput_PolicyNames = -2; // opt listGroupPoliciesOutput_PolicyNames
	int getGroupsOutput_AttachedPolicies = -2; // opt getGroupsOutput_AttachedPolicies
