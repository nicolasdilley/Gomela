...
// git_link=https://github.com/hashicorp/vault/blob/f8f289712a3d37115090591602a2b92503fb3a13/vault/external_tests/raft/raft_test.go#L120
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestRaft_Retry_Join1200 = [1] of {int};
	run TestRaft_Retry_Join120(child_TestRaft_Retry_Join1200);
	run receiver(child_TestRaft_Retry_Join1200)
stop_process:skip
}

proctype TestRaft_Retry_Join120(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
