...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/trie/stacktrie_test.go#L13
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestSizeBug130 = [1] of {int};
	run TestSizeBug13(child_TestSizeBug130);
	run receiver(child_TestSizeBug130)
stop_process:skip
}

proctype TestSizeBug13(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_Hash5012 = [1] of {int};
	chan child_Hash5011 = [1] of {int};
	...
	run Hash501(nt_db_lock,child_Hash5011);
	child_Hash5011?0;
...
proctype delete368(Mutexdef t_db_lock;chan child) {
	...
	chan child_resolveHash4915 = [1] of {int};
	int n_Children = -2; // opt n_Children
...
proctype Hash501(Mutexdef t_db_lock;chan child) {
	...
	bool state;
	int num_msgs;
	chan child_hashRoot5561 = [1] of {int};
	run hashRoot556(t_db_lock,child_hashRoot5561);
	child_hashRoot5561?0;
	goto stop_process;
	stop_process: skip;
	child!0
}
