...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/trie/stacktrie_test.go#L106
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestUpdateVariableKeys1060 = [1] of {int};
	run TestUpdateVariableKeys106(child_TestUpdateVariableKeys1060);
	run receiver(child_TestUpdateVariableKeys1060)
stop_process:skip
}

proctype TestUpdateVariableKeys106(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
