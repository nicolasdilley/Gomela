...
// git_link=https://github.com/ethereum/go-ethereum/blob/b8040a430e34117f121c67e8deee4a5e889e8372/console/console_test.go#L256
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestPrettyPrint2560 = [1] of {int};
	run TestPrettyPrint256(child_TestPrettyPrint2560);
	run receiver(child_TestPrettyPrint2560)
stop_process:skip
}

proctype TestPrettyPrint256(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
