...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/echo_test.go#L339
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestEchoWrapMiddleware3390 = [1] of {int};
	run TestEchoWrapMiddleware339(child_TestEchoWrapMiddleware3390);
	run receiver(child_TestEchoWrapMiddleware3390)
stop_process:skip
}

proctype TestEchoWrapMiddleware339(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
