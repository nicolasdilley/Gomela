...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1826
#define not_found_1831  -2 // opt not_found_1831
#define not_found_1832  -2 // opt not_found_1832
#define not_found_1833  -2 // opt not_found_1833
#define not_found_1834  -2 // opt not_found_1834
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterParamBacktraceNotFound1826(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_1831,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_1832,child_Add651);
	child_Add651?0;
	run Add65(r_echo_startupMutex,not_found_1833,child_Add652);
	child_Add652?0;
	run Add65(r_echo_startupMutex,not_found_1834,child_Add653);
	child_Add653?0;
	stop_process: skip;
	child!0
}
