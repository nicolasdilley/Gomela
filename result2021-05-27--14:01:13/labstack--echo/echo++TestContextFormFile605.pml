...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/context_test.go#L605
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestContextFormFile6050 = [1] of {int};
	run TestContextFormFile605(child_TestContextFormFile6050);
	run receiver(child_TestContextFormFile6050)
stop_process:skip
}

proctype TestContextFormFile605(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
