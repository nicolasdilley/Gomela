...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1622
#define not_found_1626  -2 // opt not_found_1626
#define not_found_1629  -2 // opt not_found_1629
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterIssue13481622(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_1626,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_1629,child_Add651);
	child_Add651?0;
	stop_process: skip;
	child!0
}
