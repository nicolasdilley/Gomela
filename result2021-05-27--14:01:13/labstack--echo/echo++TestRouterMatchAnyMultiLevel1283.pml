...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1283
#define not_found_1288  -2 // opt not_found_1288
#define not_found_1289  -2 // opt not_found_1289
#define not_found_1290  -2 // opt not_found_1290
#define not_found_1291  -2 // opt not_found_1291
#define not_found_1292  -2 // opt not_found_1292
#define not_found_1293  -2 // opt not_found_1293
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterMatchAnyMultiLevel1283(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_1288,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_1289,child_Add651);
	child_Add651?0;
	run Add65(r_echo_startupMutex,not_found_1290,child_Add652);
	child_Add652?0;
	run Add65(r_echo_startupMutex,not_found_1291,child_Add653);
	child_Add653?0;
	run Add65(r_echo_startupMutex,not_found_1292,child_Add654);
	child_Add654?0;
	run Add65(r_echo_startupMutex,not_found_1293,child_Add655);
	child_Add655?0;
	stop_process: skip;
	child!0
}
