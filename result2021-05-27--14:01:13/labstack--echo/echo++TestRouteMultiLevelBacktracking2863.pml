...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L863
#define not_found_867  -2 // opt not_found_867
#define not_found_868  -2 // opt not_found_868
#define not_found_869  -2 // opt not_found_869
#define not_found_870  -2 // opt not_found_870
#define not_found_871  -2 // opt not_found_871
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouteMultiLevelBacktracking2863(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_867,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_868,child_Add651);
	child_Add651?0;
	run Add65(r_echo_startupMutex,not_found_869,child_Add652);
	child_Add652?0;
	run Add65(r_echo_startupMutex,not_found_870,child_Add653);
	child_Add653?0;
	run Add65(r_echo_startupMutex,not_found_871,child_Add654);
	child_Add654?0;
	stop_process: skip;
	child!0
}
