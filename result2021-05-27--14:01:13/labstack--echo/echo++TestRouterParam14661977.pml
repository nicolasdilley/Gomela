...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1977
#define not_found_1981  -2 // opt not_found_1981
#define not_found_1982  -2 // opt not_found_1982
#define not_found_1983  -2 // opt not_found_1983
#define not_found_1984  -2 // opt not_found_1984
#define not_found_1985  -2 // opt not_found_1985
#define not_found_1986  -2 // opt not_found_1986
#define not_found_1988  -2 // opt not_found_1988
#define not_found_1989  -2 // opt not_found_1989
#define not_found_1990  -2 // opt not_found_1990
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterParam14661977(chan child) {
	...
	int tc_expectParam = -2; // opt tc_expectParam
	...
	run Add65(r_echo_startupMutex,not_found_1981,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_1982,child_Add651);
	child_Add651?0;
	run Add65(r_echo_startupMutex,not_found_1983,child_Add652);
	child_Add652?0;
	run Add65(r_echo_startupMutex,not_found_1984,child_Add653);
	child_Add653?0;
	run Add65(r_echo_startupMutex,not_found_1985,child_Add654);
	child_Add654?0;
	run Add65(r_echo_startupMutex,not_found_1986,child_Add655);
	child_Add655?0;
	run Add65(r_echo_startupMutex,not_found_1988,child_Add656);
	child_Add656?0;
	run Add65(r_echo_startupMutex,not_found_1989,child_Add657);
	child_Add657?0;
	run Add65(r_echo_startupMutex,not_found_1990,child_Add658);
	child_Add658?0;
	stop_process: skip;
	child!0
}
...
proctype insert103(Mutexdef r_echo_startupMutex;chan child) {
	...
	bool state;
	int num_msgs;
	int currentNode_staticChildren = -2; // opt currentNode_staticChildren
	stop_process: skip;
	child!0
}
