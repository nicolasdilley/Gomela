...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1509
#define not_found_1514  -2 // opt not_found_1514
#define not_found_1515  -2 // opt not_found_1515
#define not_found_1516  -2 // opt not_found_1516
#define not_found_1517  -2 // opt not_found_1517
#define not_found_1518  -2 // opt not_found_1518
#define not_found_1519  -2 // opt not_found_1519
#define not_found_1520  -2 // opt not_found_1520
#define not_found_1521  -2 // opt not_found_1521
#define not_found_1522  -2 // opt not_found_1522
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterPriority1509(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_1514,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_1515,child_Add651);
	child_Add651?0;
	run Add65(r_echo_startupMutex,not_found_1516,child_Add652);
	child_Add652?0;
	run Add65(r_echo_startupMutex,not_found_1517,child_Add653);
	child_Add653?0;
	run Add65(r_echo_startupMutex,not_found_1518,child_Add654);
	child_Add654?0;
	run Add65(r_echo_startupMutex,not_found_1519,child_Add655);
	child_Add655?0;
	run Add65(r_echo_startupMutex,not_found_1520,child_Add656);
	child_Add656?0;
	run Add65(r_echo_startupMutex,not_found_1521,child_Add657);
	child_Add657?0;
	run Add65(r_echo_startupMutex,not_found_1522,child_Add658);
	child_Add658?0;
	stop_process: skip;
	child!0
}
