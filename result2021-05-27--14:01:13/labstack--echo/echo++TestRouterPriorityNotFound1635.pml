...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1635
#define not_found_1640  -2 // opt not_found_1640
#define not_found_1641  -2 // opt not_found_1641
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterPriorityNotFound1635(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_1640,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_1641,child_Add651);
	child_Add651?0;
	stop_process: skip;
	child!0
}
