...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1198
#define not_found_1203  -2 // opt not_found_1203
#define not_found_1204  -2 // opt not_found_1204
#define not_found_1205  -2 // opt not_found_1205
#define not_found_1206  -2 // opt not_found_1206
#define not_found_1207  -2 // opt not_found_1207
#define not_found_1208  -2 // opt not_found_1208
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterMatchAnySlash1198(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_1203,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_1204,child_Add651);
	child_Add651?0;
	run Add65(r_echo_startupMutex,not_found_1205,child_Add652);
	child_Add652?0;
	run Add65(r_echo_startupMutex,not_found_1206,child_Add653);
	child_Add653?0;
	run Add65(r_echo_startupMutex,not_found_1207,child_Add654);
	child_Add654?0;
	run Add65(r_echo_startupMutex,not_found_1208,child_Add655);
	child_Add655?0;
	stop_process: skip;
	child!0
}
