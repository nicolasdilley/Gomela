...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1452
#define not_found_1457  -2 // opt not_found_1457
#define not_found_1458  -2 // opt not_found_1458
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterMultiRoute1452(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_1457,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_1458,child_Add651);
	child_Add651?0;
	stop_process: skip;
	child!0
}
