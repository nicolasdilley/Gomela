...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L2108
#define not_found_2112  -2 // opt not_found_2112
#define not_found_2113  -2 // opt not_found_2113
#define not_found_2114  -2 // opt not_found_2114
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterPanicWhenParamNoRootOnlyChildsFailsFind2108(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_2112,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_2113,child_Add651);
	child_Add651?0;
	run Add65(r_echo_startupMutex,not_found_2114,child_Add652);
	child_Add652?0;
	stop_process: skip;
	child!0
}
