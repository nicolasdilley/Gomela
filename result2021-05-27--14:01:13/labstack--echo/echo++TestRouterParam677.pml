...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L677
#define not_found_681  -2 // opt not_found_681
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterParam677(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_681,child_Add650);
	child_Add650?0;
	stop_process: skip;
	child!0
}
