...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1689
#define not_found_1694  -2 // opt not_found_1694
#define not_found_1695  -2 // opt not_found_1695
#define not_found_1696  -2 // opt not_found_1696
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterParamNames1689(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_1694,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_1695,child_Add651);
	child_Add651?0;
	run Add65(r_echo_startupMutex,not_found_1696,child_Add652);
	child_Add652?0;
	stop_process: skip;
	child!0
}
