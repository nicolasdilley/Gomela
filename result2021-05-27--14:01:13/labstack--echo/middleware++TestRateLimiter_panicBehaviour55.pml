...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/middleware/rate_limiter_test.go#L55
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	...
	run receiver(child_TestRateLimiter_panicBehaviour550)
stop_process:skip
}
