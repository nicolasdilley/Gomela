...
// git_link=https://github.com/labstack/echo/blob/643066594d00891e3151c7ed87244bfeddcd57b9/router_test.go#L1134
#define not_found_1139  -2 // opt not_found_1139
#define not_found_1143  -2 // opt not_found_1143
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestRouterMatchAnyPrefixIssue1134(chan child) {
	...
	run Add65(r_echo_startupMutex,not_found_1139,child_Add650);
	child_Add650?0;
	run Add65(r_echo_startupMutex,not_found_1143,child_Add651);
	child_Add651?0;
	stop_process: skip;
	child!0
}
