...
// https://github.com/moby/moby/blob/master/registry/endpoint_test.go#L51
typedef Wgdef {
...
init { 
	chan child_TestValidateEndpoint510 = [1] of {int};
	run TestValidateEndpoint51(child_TestValidateEndpoint510)
stop_process:skip
}

proctype TestValidateEndpoint51(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
