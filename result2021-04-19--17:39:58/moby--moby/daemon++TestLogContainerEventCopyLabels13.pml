...
// https://github.com/moby/moby/blob/master/daemon/events_test.go#L13
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestLogContainerEventCopyLabels130 = [1] of {int};
	run TestLogContainerEventCopyLabels13(child_TestLogContainerEventCopyLabels130)
stop_process:skip
}

proctype TestLogContainerEventCopyLabels13(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	chan child_LogContainerEvent280 = [1] of {int};
