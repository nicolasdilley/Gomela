...
// https://github.com/moby/moby/blob/master/daemon/events_test.go#L44
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestLogContainerEventWithAttributes440 = [1] of {int};
	run TestLogContainerEventWithAttributes44(child_TestLogContainerEventWithAttributes440)
stop_process:skip
}

proctype TestLogContainerEventWithAttributes44(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
