#define processRange_rmdses  60
#define processRange_numWorkers  60
#define processRange_irmds  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example695274255/go/kbfs/libkbfs/md_ops.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Chandef rmdsChan;
	int irmds = processRange_irmds;
	int rmdses = processRange_rmdses;
	bool state = false;
	Chandef irmdChan;
	int numWorkers = processRange_numWorkers;
	int i;
