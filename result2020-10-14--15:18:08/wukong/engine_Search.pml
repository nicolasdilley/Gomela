#define Search_querySegments  60
#define Search_request_Tokens  60
#define Search_engine_initOptions_NumShards  60
#define Search_rankerOutput_docs  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example274862495/engine/engine.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int rankerOutput_docs = Search_rankerOutput_docs;
	int request_Tokens = Search_request_Tokens;
	bool state = false;
	int querySegments = Search_querySegments;
