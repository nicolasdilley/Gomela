#define preSetup_protocol_MaxSessionUnprocessedPackets  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example445228338/session.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: 1 > 0 -> 
		...
		run emptyChan(s_sendingScheduled)
	:: else -> 
