#define purgeFileIdsForOneVolume_locations  60
#define purgeFileIdsForOneVolume_results  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example692657136/weed/shell/command_volume_fsck.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Wgdef wg;
	bool state = false;
	int results = purgeFileIdsForOneVolume_results;
	Chandef resultChan;
