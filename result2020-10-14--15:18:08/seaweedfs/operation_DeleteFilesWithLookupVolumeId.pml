#define DeleteFilesWithLookupVolumeId_fileIds  60
#define DeleteFilesWithLookupVolumeId_lookupResults  60
#define DeleteFilesWithLookupVolumeId_result_Locations  60
#define DeleteFilesWithLookupVolumeId_server_to_fileIds  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example692657136/weed/operation/delete_content.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10:
	...
	:: true;
		...
		for(i : 1.. lookupResults) {
for20:				for(i : 1.. result_Locations) {
for21:
		}
	};
