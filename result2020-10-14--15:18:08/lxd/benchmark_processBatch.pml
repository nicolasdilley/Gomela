#define processBatch_batches  60
#define processBatch_batchSize  60
#define processBatch_remainder  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example232910342/lxd-benchmark/benchmark/batch.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
