#define CollectMetrics_serrs  60
#define CollectMetrics_allTags  60
#define CollectMetrics_nsTags  60
#define CollectMetrics_pluginToMetricMap  60
#define CollectMetrics_pmt_metricTypes  60
#define CollectMetrics_m  60
...
init { 
	int allTags = CollectMetrics_allTags;
	Chandef cMetrics;
	int m = CollectMetrics_m;
	Wgdef wg;
	int pluginToMetricMap = CollectMetrics_pluginToMetricMap;
	bool state = false;
	Chandef cError;
	int serrs = CollectMetrics_serrs;
	int nsTags = CollectMetrics_nsTags;
	int pmt_metricTypes = CollectMetrics_pmt_metricTypes;
	int i;
