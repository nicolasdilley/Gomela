#define HitMap_cfg_NumCheckers  60
#define lb_for376_1  -1
#define ub_for376_2  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example497603182/testonly/internal/hammer/hammer.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Chandef errs;
	bool state = false;
	int cfg_NumCheckers = HitMap_cfg_NumCheckers;
	Wgdef wg;
	Chandef done;
	int i;
