...
#define goListDriver_restPatterns  60
#define goListDriver_modifiedPkgs  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example971953206/go/packages/golist.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
