#define ListConsumerGroups_brokers  60
#define ListConsumerGroups_response_Groups  60
#define ListConsumerGroups_groupMap  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example171052263/admin.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Chandef groupMaps;
	int response_Groups = ListConsumerGroups_response_Groups;
	Wgdef wg;
	int i;
	Chandef errChan;
	int brokers = ListConsumerGroups_brokers;
	int groupMap = ListConsumerGroups_groupMap;
	bool state = false;
