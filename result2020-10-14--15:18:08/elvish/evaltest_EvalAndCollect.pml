#define EvalAndCollect_texts  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example028686157/pkg/eval/evaltest/evaltest.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	Chandef outCh;
	Wgdef wg;
	int texts = EvalAndCollect_texts;
	bool state = false;
	run wgMonitor(wg);
	wg.Add!3;
