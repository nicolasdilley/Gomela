#define NewLoadBalancer_nc  60
#define NewLoadBalancer_cnt_NetworkSettings_Networks  60
#define NewLoadBalancer_retries  60
#define NewLoadBalancer_proxyContainers  60
#define NewLoadBalancer_proxyNetworks  60
#define lb_for150_5  -1
#define ub_for150_6  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example649742247/ext/lb/lb.go
typedef Chandef {
	chan sync = [0] of {int};
...
for20:		
		...
		:: proxyNetworkCleanupChan.sync?0;
				...
				for(i : 1.. nc) {
for21:						for(i : 1.. cnt_NetworkSettings_Networks) {
for22:				
				if
				:: true -> 
			...
			:: true -> 
				...
				:: errChan.sync!0 -> 
					errChan.sending?0
						...
						for(i : 1.. proxyContainers) {
for31:								for(i : 1.. proxyNetworks) {
for32:
				}
			};
