#define AzureMultiQuery_nResources  60
#define AzureMultiQuery_e_AzureMonitor[prefix]_Concurrency  60
#define AzureMultiQuery_resources_Resources  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example035891773/cmd/bosun/expr/azure.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	int resources_Resources = AzureMultiQuery_resources_Resources;
	Chandef resCh;
	Wgdef wg;
