#define newGracefulManager_numberOfServersToCreate  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example647550706/modules/graceful/manager_unix.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
