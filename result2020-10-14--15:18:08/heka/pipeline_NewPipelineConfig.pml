#define NewPipelineConfig_globals_PluginChanSize  60
#define NewPipelineConfig_globals_PoolSize  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example135409139/pipeline/config.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: globals_PoolSize > 0 -> 
		...
		run emptyChan(config_inputRecycleChan)
	:: else -> 
	...
	:: globals_PoolSize > 0 -> 
		...
		run emptyChan(config_injectRecycleChan)
	:: else -> 
	...
	:: 1 > 0 -> 
		...
		run emptyChan(config_reportRecycleChan)
	:: else -> 
