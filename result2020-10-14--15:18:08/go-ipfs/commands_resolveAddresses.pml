#define resolveAddresses_addrs  60
#define resolveAddresses_raddrs  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example793515396/core/commands/swarm.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	Wgdef wg;
	Chandef maddrC;
	int raddrs = resolveAddresses_raddrs;
	bool state = false;
	run wgMonitor(wg);
