#define newBlockRetrievalQueue_workerQueueSize  60
#define newBlockRetrievalQueue_numWorkers  60
#define newBlockRetrievalQueue_numPrefetchWorkers  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example093354317/libkbfs/block_retrieval_queue.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: workerQueueSize > 0 -> 
		...
		run emptyChan(prefetchWorkerCh)
	:: else -> 
