#define fetchAllSources_count  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example009822430/internal/config/plugin_installer.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10_exit:	run Anonymous1(results);
