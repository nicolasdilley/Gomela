#define txnPutFunc_totalClients  60
#define txnPutFunc_clients  60
#define txnPutFunc_txnPutTotal  60
#define txnPutFunc_txnPutOpsPerTxn  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example136822689/tools/benchmark/cmd/txn_put.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int i;
	int txnPutTotal = txnPutFunc_txnPutTotal;
	Chandef requests;
	int clients = txnPutFunc_clients;
	int txnPutOpsPerTxn = txnPutFunc_txnPutOpsPerTxn;
	bool state = false;
