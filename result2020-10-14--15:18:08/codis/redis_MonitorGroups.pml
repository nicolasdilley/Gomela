#define MonitorGroups_groups  60
#define MonitorGroups_sentinels  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example067562080/pkg/utils/redis/sentinel.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	int groups = MonitorGroups_groups;
	Chandef exit;
	int i;
	Chandef results;
