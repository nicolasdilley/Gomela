#define Open_opt_NumMemtables  60
#define Open_db_imm  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example386370723/publisher.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10:			
	...
	run wgMonitor(replayCloser_waiting);
