#define runTest_numAccounts  60
#define runTest_numGoroutines  60
#define runTest_list_Kv  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example386370723/badger/cmd/bank.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
...
init { 
	Wgdef wg;
	int list_Kv = runTest_list_Kv;
	int numAccounts = runTest_numAccounts;
	bool state = false;
	Wgdef subWg;
