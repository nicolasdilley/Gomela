#define Batch_maxJobs  60
#define Batch_ctx  60
#define Batch_secrets  60
#define Batch_secret_messages  60
#define audit_errs  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example231472432/internal/audit/audit.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	Chandef checked;
	int secrets = Batch_secrets;
	Chandef pending;
	Chandef done;
	int ctx = Batch_ctx;
	int secret_messages = Batch_secret_messages;
	bool state = false;
