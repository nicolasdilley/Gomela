#define readSheetsFromZipFile_workbook_DefinedNames_DefinedName  60
#define readSheetsFromZipFile_workbook_Sheets_Sheet  60
#define readSheetsFromZipFile_sheetCount  60
#define readSheetsFromZipFile_workbookSheets  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example148000205/lib.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: true;
		...
		for(i : 1.. workbook_DefinedNames_DefinedName) {
for10:
	};
