#define processFileActions_fileActions  60
#define processFileActions_conflictActions  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example486918119/main.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int conflictActions = processFileActions_conflictActions;
	bool state = false;
