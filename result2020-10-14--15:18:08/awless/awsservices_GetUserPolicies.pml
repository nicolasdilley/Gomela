#define GetUserPolicies_policies_PolicyNames  60
#define GetUserPolicies_attached_AttachedPolicies  60
#define GetUserPolicies_groups_Groups  60
#define GetUserPolicies_output_AttachedPolicies  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example337839709/aws/services/manual_services.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype Anonymous1(Chandef errc;Wgdef wg) {
	...
	:: true;
		...
		for(i : 1.. attached_AttachedPolicies) {
for20:
	};
	wg.Add!-1;
stop_process:
...
proctype Anonymous2(Chandef errc;Wgdef wg) {
	...
	:: true;
		...
		for(i : 1.. output_AttachedPolicies) {
for31:
	};
stop_process:
}
