#define loadAllRefs_fileRefs  60
#define loadAllRefs_e_Shapes  60
#define loadAllRefs_allRefs  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example337839709/gen/aws/generators/paramsdoc.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Wgdef wg;
	int i;
	int e_Shapes = loadAllRefs_e_Shapes;
	Chandef entriesC;
	int fileRefs = loadAllRefs_fileRefs;
	int allRefs = loadAllRefs_allRefs;
	bool state = false;
