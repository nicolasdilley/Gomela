#define start_s_healthCheckUrls  60
...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example603064843/test/e2e_node/services/server.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype servicesreadinessCheck(Chandef errCh;int urls;chan child) {
	...
	if
	:: lb_for48_5 != -1 && ub_for48_6 != -1 -> 
				for(i : lb_for48_5.. ub_for48_6) {
for20:			do
			:: errCh.async_rcv?0 -> 
