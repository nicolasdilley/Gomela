#define TryExec_ctx  60
#define receiveFromRunner_meta_Http_Headers  60
#define lb_for376_2  -1
#define ub_for376_3  -1
#define lb_for464_4  -1
#define ub_for464_5  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example863960509/api/agent/runner_client.go
typedef Chandef {
	chan sync = [0] of {int};
