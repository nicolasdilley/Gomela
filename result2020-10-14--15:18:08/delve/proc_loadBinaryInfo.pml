#define loadDebugInfoMaps_cu_ranges  60
#define loadDebugInfoMaps_bi_Functions  60
#define loadDebugInfoMaps_image_compileUnits  60
#define loadDebugInfoMaps_cu_lineInfo_FileNames  60
#define lb_for1526_4  -1
#define ub_for1526_5  -1
#define loadSymbolName_symSecs  60
#define setGStructOffsetElf_symbols  60
#define setGStructOffsetElf_exe_Progs  60
#define loadDebugInfoMaps_cu_ranges  60
#define loadDebugInfoMaps_bi_Functions  60
#define loadDebugInfoMaps_image_compileUnits  60
#define loadDebugInfoMaps_cu_lineInfo_FileNames  60
...
// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example594756892/pkg/proc/bininfo.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
