#define ParseSpecFiles_limit  60
#define ParseSpecFiles_r_parseResult_ParseErrors  60
#define lb_for58_2  -1
#define ub_for58_3  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example058759064/parser/parse.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: piChan.is_closed?state -> 
		...
		:: else -> 
			...
			if
			:: true -> 
								for(i : 1.. r_parseResult_ParseErrors) {
for21:
				}
			:: true;
			fi
