#define NewFixedPoolWorkerAllocator_workers  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example733665210/pkg/processor/worker/allocator.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: workers > 0 -> 
		...
		run emptyChan(newFixedPool_workerChan)
	:: else -> 
