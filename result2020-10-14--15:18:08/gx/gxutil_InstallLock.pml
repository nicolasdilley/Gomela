#define InstallLock_maxWorkers  60
#define lb_for201_1  -1
#define ub_for201_2  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example613985978/gxutil/pm.go
typedef Chandef {
	chan sync = [0] of {int};
...
for20:		
		...
		chan child_pminstallLock0 = [0] of {int};
		run pminstallLock(workers,child_pminstallLock0);
		child_pminstallLock0?0;
...
proctype pminstallLock(Chandef workers;chan child) {
	bool closed; 
	int i;
	bool state;
	do
