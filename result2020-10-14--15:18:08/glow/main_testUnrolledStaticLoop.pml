#define testUnrolledStaticLoop_limit  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example331774114/examples/word_count/word_count.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int limit = testUnrolledStaticLoop_limit;
	bool state = false;
	run sync_monitor(ch);
...
for10_exit:	run sync_monitor(outChannel);
	run wgMonitor(wg);
