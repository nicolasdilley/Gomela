#define SuggestPrice_gpo_checkBlocks  60
#define lb_for106_1  -1
#define ub_for106_2  -1
#define getBlockPrices_txs  60
#define lb_for113_4  -1
#define ub_for113_5  -1
#define getBlockPrices_txs  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example991245137/eth/gasprice/gasprice.go
typedef Chandef {
	chan sync = [0] of {int};
