#define ListTasks_ListTaskWorkers  60
#define ListTasks_TaskGatherers  60
#define lb_for103_2  -1
#define ub_for103_3  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example798243311/chronograf/.kapacitor/kapa_client.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	int TaskGatherers = ListTasks_TaskGatherers;
	Chandef done;
	Chandef optChan;
	Wgdef gatherWg;
	bool state = false;
	Chandef taskChan;
	Wgdef wg;
	int ListTaskWorkers = ListTasks_ListTaskWorkers;
	int i;
...
for20:		run go_pfetchFromKapacitor(optChan,wg,taskChan,done)
	};
...
proctype go_pfetchFromKapacitor(Chandef optChan;Wgdef wg;Chandef taskChan;Chandef done) {
	bool closed; 
	int i;
	bool state;
	do
