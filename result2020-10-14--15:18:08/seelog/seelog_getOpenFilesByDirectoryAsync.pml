#define getOpenFilesByDirectoryAsync_n  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example208033576/internals_fsutils.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	wg.Add!n;
		for(i : 0.. n-1) {
for10:		run Anonymous0(dirFilesChan,wg)
	};
