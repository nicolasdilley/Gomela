#define LineReaderToChannel_parts  60
#define lb_for153_1  -1
#define ub_for153_2  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example249045290/util/exec_util.go
typedef Chandef {
	chan sync = [0] of {int};
...
proctype go_utilLineReaderToChannel(Wgdef wg) {
	...
	if
	:: lb_for153_1 != -1 && ub_for153_2 != -1 -> 
				for(i : lb_for153_1.. ub_for153_2) {
for10:						for(i : 1.. parts) {
for11:
			}
		}
