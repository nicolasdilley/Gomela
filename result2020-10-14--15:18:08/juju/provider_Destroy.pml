#define deleteClusterScopeResourcesModelTeardown_tasks  60
#define lb_for264_1  -1
#define ub_for264_2  -1
#define lb_for502_3  -1
#define ub_for502_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example131217544/caas/kubernetes/provider/k8s.go
typedef Chandef {
	chan sync = [0] of {int};
