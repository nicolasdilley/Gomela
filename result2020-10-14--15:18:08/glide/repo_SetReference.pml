#define SetReference_concurrentWorkers  60
#define SetReference_conf_Imports  60
#define SetReference_conf_DevImports  60
#define lb_for29_3  -1
#define ub_for29_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example052397796/repo/set_reference.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10_exit:		for(i : 1.. conf_Imports) {
for20:		
		if
		:: true -> 
			wg.Add!1;
