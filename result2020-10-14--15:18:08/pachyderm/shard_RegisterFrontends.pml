#define RegisterFrontends_frontends  60
#define lb_for616_1  -1
#define ub_for616_2  -1
#define lb_for102_3  -1
#define ub_for102_4  -1
#define lb_for206_5  -1
#define ub_for206_6  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example113178465/src/client/pkg/shard/sharder.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int frontends = RegisterFrontends_frontends;
	bool state = false;
