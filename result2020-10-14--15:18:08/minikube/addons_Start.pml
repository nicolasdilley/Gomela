#define Start_assets_Addons  60
#define Start_additional  60
#define Start_toEnable  60
#define Start_toEnableList  60
#define Start_enabledAddons  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example382380821/pkg/addons/addons.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
