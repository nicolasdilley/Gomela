#define convertGeoFile_fc_Features  60
#define convertGeoFile_f_Properties  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example897304492/dgraph/cmd/conv/conv.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	Chandef chb;
	bool state = false;
	int f_Properties = convertGeoFile_f_Properties;
	Chandef che;
	int fc_Features = convertGeoFile_fc_Features;
	int i;
