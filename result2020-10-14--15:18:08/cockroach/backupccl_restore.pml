#define restore_tables  60
#define restore_importSpans  60
#define lb_for569_2  -1
#define ub_for569_3  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example543475193/pkg/ccl/backupccl/restore_job.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int importSpans = restore_importSpans;
	chan child_backupccldistRestore0 = [0] of {int};
	bool state = false;
	Chandef progCh;
	int tables = restore_tables;
	int i;
...
for30:
	...
	if
	:: lb_for569_2 != -1 && ub_for569_3 != -1 -> 
				for(i : lb_for569_2.. ub_for569_3) {
for40:
		}
	:: else -> 
		do
