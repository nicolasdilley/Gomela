#define lockLocked_txs_concurrentTransactions  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example994420206/go/vt/vttablet/tabletserver/txserializer/tx_serializer.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: true -> 
		...
		:: txs_concurrentTransactions > 0 -> 
			...
			run emptyChan(q_availableSlots)
		:: else -> 
