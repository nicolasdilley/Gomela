#define DoPostActionWithCookie_model_PostActionRetainPropKeys  60
#define DoPostActionWithCookie_retain  60
#define DoPostActionWithCookie_remove  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example437804699/app/integration_action.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: true -> 
		...
		:: true;
				...
				for(i : 1.. model_PostActionRetainPropKeys) {
for10:
		}
	:: true -> 
