#define waitForDependencies_urls  60
#define waitForDependencies_headers  60
#define lb_for122_2  -1
#define ub_for122_3  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example287150334/main.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int headers = waitForDependencies_headers;
	bool state = false;
