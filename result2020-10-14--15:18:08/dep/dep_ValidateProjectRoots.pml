#define ValidateProjectRoots_m_Constraints  60
#define ValidateProjectRoots_m_Ovr  60
#define ValidateProjectRoots_m_PruneOptions_PerProjectOptions  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example937228125/manifest.go
typedef Chandef {
	chan sync = [0] of {int};
...
for20:		wg.Add!1
		...
		for(i : 1.. m_PruneOptions_PerProjectOptions) {
for30:		wg.Add!1
	};
	wg.Wait?0;
