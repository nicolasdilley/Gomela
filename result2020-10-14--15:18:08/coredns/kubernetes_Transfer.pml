#define Transfer_serviceList  60
#define Transfer_svc_Ports  60
#define Transfer_endpointsList  60
#define Transfer_ep_Subsets  60
#define Transfer_eps_Addresses  60
#define Transfer_eps_Ports  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example035914154/plugin/kubernetes/xfr.go
typedef Chandef {
	chan sync = [0] of {int};
...
for11:					
			...
			:: true;
						...
						for(i : 1.. endpointsList) {
for12:								for(i : 1.. ep_Subsets) {
for13:										for(i : 1.. eps_Addresses) {
