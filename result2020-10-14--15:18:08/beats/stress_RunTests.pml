#define RunTests_config_Generate_Worker  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example462716832/libbeat/publisher/pipeline/stress/run.go
typedef Wgdef {
	chan Add = [0] of {int};
	chan Wait = [0] of {int};
	int Counter = 0;}
