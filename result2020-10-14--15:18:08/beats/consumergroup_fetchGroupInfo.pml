#define fetchGroupInfo_assignments  60
#define fetchGroupInfo_topics  60
#define fetchGroupInfo_partitions  60
#define fetchGroupInfo_ret_off_Blocks  60
#define lb_for105_4  -1
#define ub_for105_5  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example462716832/metricbeat/module/kafka/consumergroup/query.go
typedef Chandef {
	chan sync = [0] of {int};
