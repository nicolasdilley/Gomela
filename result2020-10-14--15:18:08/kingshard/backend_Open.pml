#define Open_db_maxConnNum  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example995068371/backend/db.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	:: db_maxConnNum > 0 -> 
		...
		run emptyChan(db_cacheConns)
	:: else -> 
		run sync_monitor(db_cacheConns)
	fi;
	
	if
	:: 0 != -1 && db_maxConnNum-1 != -1 -> 
