#define Apply_PushRetries  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example301818811/actor/pushaction/apply.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int PushRetries = Apply_PushRetries;
	bool state = false;
