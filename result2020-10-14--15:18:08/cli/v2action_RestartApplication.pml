#define RestartApplication_warnings  60
#define lb_for355_1  -1
#define ub_for355_2  -1
#define lb_for379_3  -1
#define ub_for379_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example301818811/actor/v2action/application.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int i;
	Chandef allWarnings;
	int warnings = RestartApplication_warnings;
	bool state = false;
...
proctype actorpollStartup(Chandef allWarnings;chan child) {
	...
	if
	:: lb_for379_3 != -1 && ub_for379_4 != -1 -> 
				for(i : lb_for379_3.. ub_for379_4) {
for40:						for(i : 1.. warnings) {
for41:				
				if
				:: allWarnings.async_send!0;
				:: allWarnings.sync!0 -> 
