#define GetStreamingLogs_logMessages  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example301818811/actor/sharedaction/logging.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int logMessages = GetStreamingLogs_logMessages;
	bool state = false;
