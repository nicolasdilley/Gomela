#define Refresh_bc_workers  60
#define Refresh_cache_Nodes  60
#define Refresh_partial  60
#define Refresh_centrality  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example653067025/autopilot/betweenness_centrality.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10_exit:		for(i : 1.. cache_Nodes) {
for20:		
		if
		:: work.async_send!0;
		:: work.sync!0 -> 
