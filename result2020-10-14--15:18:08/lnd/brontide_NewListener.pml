#define NewListener_defaultHandshakes  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example653067025/brontide/listener.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	bool state = false;
	int defaultHandshakes = NewListener_defaultHandshakes;
	...
	:: 1000 > 0 -> 
		...
		run emptyChan(brontideListener_handshakeSema)
	:: else -> 
	...
	if
	:: 0 != -1 && defaultHandshakes-1 != -1 -> 
				for(i : 0.. defaultHandshakes-1) {
for10:			
			if
