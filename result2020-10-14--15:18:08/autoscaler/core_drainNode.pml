#define drainNode_toEvict  60
#define drainNode_pods  60
#define drainNode_evictionResults  60
#define lb_for1233_3  -1
#define ub_for1233_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example697563773/cluster-autoscaler/core/scale_down.go
typedef Chandef {
	chan sync = [0] of {int};
...
for30:
	...
	if
	:: lb_for1233_3 != -1 && ub_for1233_4 != -1 -> 
				for(i : lb_for1233_3.. ub_for1233_4) {
for40:						for(i : 1.. pods) {
for41:				
				if
				:: true -> 
