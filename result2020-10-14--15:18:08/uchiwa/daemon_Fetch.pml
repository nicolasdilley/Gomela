#define fetchStashes_stashes  60
#define lb_for279_1  -1
#define ub_for279_2  -1
#define fetchSilenced_silenced  60
#define lb_for305_4  -1
#define ub_for305_5  -1
#define fetchChecks_checks  60
#define lb_for330_7  -1
#define ub_for330_8  -1
#define fetchClients_clients  60
#define lb_for358_10  -1
#define ub_for358_11  -1
#define fetchEvents_events  60
#define lb_for386_13  -1
#define ub_for386_14  -1
#define lb_for412_15  -1
#define ub_for412_16  -1
#define fetchAggregates_aggregates  60
#define lb_for434_18  -1
#define ub_for434_19  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example791345209/uchiwa/daemon/daemon.go
typedef Chandef {
	chan sync = [0] of {int};
