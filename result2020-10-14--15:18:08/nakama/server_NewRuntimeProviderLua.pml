#define NewRuntimeProviderLua_config_GetRuntime_MaxCount  60
#define NewRuntimeProviderLua_config_GetRuntime_MinCount  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example166156640/server/runtime_lua.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	int config_GetRuntime_MinCount = NewRuntimeProviderLua_config_GetRuntime_MinCount;
	...
	:: config_GetRuntime_MaxCount > 0 -> 
		...
		run emptyChan(runtimeProviderLua_poolCh)
	:: else -> 
	...
	:: true -> 
		...
		if
		:: 0 != -1 && config_GetRuntime_MinCount-1 != -1 -> 
