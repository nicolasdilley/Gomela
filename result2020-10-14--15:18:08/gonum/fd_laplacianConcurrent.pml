#define laplacianConcurrent_evals  60
#define laplacianConcurrent_nWorkers  60
#define laplacianConcurrent_n  60
#define laplacianConcurrent_stencil  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example422881738/diff/fd/laplacian.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	int stencil = laplacianConcurrent_stencil;
	bool state = false;
