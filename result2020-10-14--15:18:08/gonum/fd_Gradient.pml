#define Gradient_xcopy  60
#define Gradient_formula_Stencil  60
#define Gradient_evals  60
#define Gradient_nWorkers  60
#define Gradient_x  60
#define Gradient_dst  60
#define lb_for92_6  -1
#define ub_for92_7  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example422881738/diff/fd/gradient.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	int formula_Stencil = Gradient_formula_Stencil;
	Chandef sendChan;
	int dst = Gradient_dst;
	Chandef quit;
	int nWorkers = Gradient_nWorkers;
	bool state = false;
	Chandef ansChan;
	int xcopy = Gradient_xcopy;
