#define enableAPIs_list_Services  60
#define enableAPIs_requiredServices  60
#define enableAPIs_gerr_Errors  60
#define lb_for390_3  -1
#define ub_for390_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example077723975/pkg/deploy/gce/deploy.go
typedef Chandef {
	chan sync = [0] of {int};
