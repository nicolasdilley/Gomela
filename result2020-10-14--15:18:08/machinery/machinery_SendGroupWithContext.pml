#define SendGroupWithContext_group_Tasks  60
#define SendGroupWithContext_sendConcurrency  60

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example846698130/v1/server.go
typedef Chandef {
	chan sync = [0] of {int};
