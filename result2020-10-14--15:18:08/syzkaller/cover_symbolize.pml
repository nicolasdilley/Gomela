#define symbolize_procs  60
#define lb_for685_1  -1
#define ub_for685_2  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example093510574/pkg/cover/report.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10_exit:	
	if
	:: lb_for685_1 != -1 && ub_for685_2 != -1 -> 
				for(i : lb_for685_1.. ub_for685_2) {
for20:			
			if
			:: pcchan.async_send!0;
			:: pcchan.sync!0 -> 
