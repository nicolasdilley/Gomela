...
init { 
	run go_MakeRequests(requestSet114)
stop_process:skip
}

proctype go_MakeRequests(int requestSet) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	Chandef replies;
	int batchRequest_Requests=3;
...
proctype go_Anonymous1(Chandef replies) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype go_Anonymous2(Chandef replies) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
