...
proctype go_Anonymous2(Chandef flights) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype go_Anonymous3(Chandef flights) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype go_Anonymous4(Chandef flights) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
