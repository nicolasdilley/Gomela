...
// https://github.com/astaxie/beego/blob/093f976365585855010941376432ce45287f63c4/server/web/server.go#L83
typedef Chandef {
...
proctype go_Anonymous4(Chandef endRunning) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
