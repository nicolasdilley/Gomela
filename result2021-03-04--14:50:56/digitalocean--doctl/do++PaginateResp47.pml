...
proctype go_PaginateResp() {
	...
	run wgMonitor(wg);
		...
		for10: skip;
		wg.Add!1;
		run go_Anonymous1(fetchChan,wg);
		for10_end: skip
	};
	for10_exit: skip;
...
proctype go_Anonymous1(Chandef fetchChan;Wgdef wg) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype go_Anonymous2(Chandef fetchChan;Wgdef wg) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
