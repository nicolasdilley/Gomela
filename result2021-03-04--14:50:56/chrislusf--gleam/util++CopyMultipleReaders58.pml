...
init { 
	run go_CopyMultipleReaders(readers58)
stop_process:skip
}

proctype go_CopyMultipleReaders(int readers) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	for10_exit: skip;
	wg.Add!1;
	run go_Anonymous3(writerChan,errChan,wg);
...
proctype go_Anonymous2(Chandef writerChan;Chandef errChan;Wgdef wg) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype go_Anonymous3(Chandef writerChan;Chandef errChan;Wgdef wg) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
