...
// https://github.com/kubernetes/client-go/blob/fc034b4b7616a76e021660b265df0211e060f6b6/tools/portforward/portforward.go#L324
typedef Chandef {
...
init { 
	run go_handleConnection()
stop_process:skip
}

proctype go_handleConnection() {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	run go_Anonymous3(errorChan,localError,remoteDone);
	do
...
proctype go_Anonymous1(Chandef errorChan) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype go_Anonymous3(Chandef errorChan;Chandef localError;Chandef remoteDone) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
