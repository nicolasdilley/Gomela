...
init { 
	run go_laplacianConcurrent(evals91,nWorkers91)
stop_process:skip
}

proctype go_laplacianConcurrent(int evals;int nWorkers) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
	...
	:: true -> 
		originWG.Add!1;
		run go_Anonymous1(send,ans,originWG)
	:: true;
	fi;
	...
	for10_exit: skip;
	run go_Anonymous4(send,ans,originWG,workerWG);
	do
	:: true -> 
...
proctype go_Anonymous1(Chandef send;Chandef ans;Wgdef originWG) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype go_Anonymous3(Chandef send;Chandef ans;Wgdef originWG;Wgdef workerWG) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype go_Anonymous4(Chandef send;Chandef ans;Wgdef originWG;Wgdef workerWG) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
