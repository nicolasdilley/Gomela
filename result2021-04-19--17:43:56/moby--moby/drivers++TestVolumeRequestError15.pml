...
// https://github.com/moby/moby/blob/master/volume/drivers/proxy_test.go#L15
typedef Wgdef {
...
init { 
	chan child_TestVolumeRequestError150 = [1] of {int};
	run TestVolumeRequestError15(child_TestVolumeRequestError150)
stop_process:skip
}

proctype TestVolumeRequestError15(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
