...
// https://github.com/moby/moby/blob/master/daemon/events/events_test.go#L169
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
proctype TestLoadBufferedEvents169(chan child) {
	...
	run loadBufferedEvents133(events_mu,child_loadBufferedEvents1330);
	child_loadBufferedEvents1330?0;
	stop_process: skip;
	child!0
}
proctype loadBufferedEvents133(Mutexdef e_mu;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
