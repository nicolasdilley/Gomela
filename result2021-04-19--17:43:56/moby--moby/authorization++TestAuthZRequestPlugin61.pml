...
// https://github.com/moby/moby/blob/master/pkg/authorization/authz_unix_test.go#L61
typedef Wgdef {
...
init { 
	chan child_TestAuthZRequestPlugin610 = [1] of {int};
	run TestAuthZRequestPlugin61(child_TestAuthZRequestPlugin610)
stop_process:skip
}

proctype TestAuthZRequestPlugin61(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
