#define scan_numSlices  5
#define scan_numChunks  5
#define scan_slices  5
#define scan_chunks  5
#define scan_allMatches  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example686055232/src/matcher.go
typedef Chandef {
	chan sync = [0] of {int};
