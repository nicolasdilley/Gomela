#define loadEntities_existing  5
#define loadEntities_consts_ExpirationRestoreWorkerCount  5
#define loadEntities_bucket_Items  5
#define lb_for207_3  -1
#define ub_for207_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example621927734/vault/identity_store_util.go
typedef Chandef {
	chan sync = [0] of {int};
