#define Read_newBuf  5
#define Read_p_readers  5
#define Read_p_dataBlocks  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example255495480/cmd/erasure-decode.go
typedef Chandef {
	chan sync = [0] of {int};
