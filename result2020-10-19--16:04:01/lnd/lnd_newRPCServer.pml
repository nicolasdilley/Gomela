#define newRPCServer_registeredSubServers  5
#define newRPCServer_subServerPerms  5
#define newRPCServer_subServerPerm  5
#define newRPCServer_listeners  5
#define newRPCServer_extSubserver_Permissions  5
#define newRPCServer_subServers  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example776713684/rpcserver.go
typedef Chandef {
	chan sync = [0] of {int};
...
for10:		
		...
		for(i : 1.. subServerPerms) {
for20:				for(i : 1.. subServerPerm) {
for21:			
			if
			:: true -> 
				goto stop_process
...
for30:		
		if
		:: true -> 
						for(i : 1.. extSubserver_Permissions) {
for31:				
				if
				:: true -> 
					goto stop_process
