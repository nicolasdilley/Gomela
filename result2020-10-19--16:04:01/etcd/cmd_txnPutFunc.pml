#define txnPutFunc_totalClients  5
#define txnPutFunc_clients  5
#define txnPutFunc_txnPutTotal  5
#define txnPutFunc_txnPutOpsPerTxn  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example134145316/tools/benchmark/cmd/txn_put.go
typedef Chandef {
	chan sync = [0] of {int};
