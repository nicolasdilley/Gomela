#define leaseKeepaliveFunc_clients  5
#define leaseKeepaliveFunc_leaseKeepaliveTotal  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example134145316/tools/benchmark/cmd/lease.go
typedef Chandef {
	chan sync = [0] of {int};
