#define putFunc_totalClients  5
#define putFunc_clients  5
#define putFunc_putTotal  5
#define lb_for122_3  -1
#define ub_for122_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example134145316/tools/benchmark/cmd/put.go
typedef Chandef {
	chan sync = [0] of {int};
