#define stmFunc_totalClients  5
#define stmFunc_clients  5
#define stmFunc_stmTotal  5
#define stmFunc_kset  5
#define lb_for123_4  -1
#define ub_for123_5  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example134145316/tools/benchmark/cmd/stm.go
typedef Chandef {
	chan sync = [0] of {int};
