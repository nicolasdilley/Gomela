#define restoreIntoIndex_restoreChunkKeys  5
#define restoreIntoIndex_kiCache  5

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example134145316/mvcc/kvstore.go
typedef Chandef {
	chan sync = [0] of {int};
