#define SetReference_concurrentWorkers  5
#define SetReference_conf_Imports  5
#define SetReference_conf_DevImports  5
#define lb_for29_3  -1
#define ub_for29_4  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example506870542/repo/set_reference.go
typedef Chandef {
	chan sync = [0] of {int};
