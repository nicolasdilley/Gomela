#define walk_fs_Config_Checkers  5
#define walk_jobs  5
#define lb_for384_2  -1
#define ub_for384_3  -1

// /var/folders/28/gltwgskn4998yb1_d73qtg8h0000gn/T/clone-example032656846/fs/walk/walk.go
typedef Chandef {
	chan sync = [0] of {int};
...
init { 
	...
	Chandef errs;
	Wgdef traversing;
	int fs_Config_Checkers = walk_fs_Config_Checkers;
	Wgdef wg;
	Chandef in;
	Chandef quit;
	int jobs = walk_jobs;
