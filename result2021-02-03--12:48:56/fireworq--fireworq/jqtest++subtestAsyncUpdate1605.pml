...
// https://github.com/fireworq/fireworq/blob/64920523abd7128a2ae5a7bc4f0676fb92133322/test/jobqueue/jobqueue.go#L605
typedef Chandef {
...
proctype go_Anonymous2(Chandef done;Chandef job) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
