...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/http/transport_test.go#L4001
typedef Wgdef {
...
init { 
	chan child_TestTransportDialCancelRace40010 = [1] of {int};
	run TestTransportDialCancelRace4001(child_TestTransportDialCancelRace40010);
	run receiver(child_TestTransportDialCancelRace40010)
stop_process:skip
}

proctype TestTransportDialCancelRace4001(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
