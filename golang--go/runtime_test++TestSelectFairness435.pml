...
proctype TestSelectFairness435(chan child) {
	...
	run wgMonitor(wg);
	wg.update!1;
	run AnonymousTestSelectFairness452440(c1_ch,c2_ch,c3_ch,c4_ch,out_ch,done_ch,wg,child_AnonymousTestSelectFairness4524400);
...
proctype AnonymousTestSelectFairness452440(Chandef c1_ch;Chandef c2_ch;Chandef c3_ch;Chandef c4_ch;Chandef out_ch;Chandef done_ch;Wgdef wg;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
