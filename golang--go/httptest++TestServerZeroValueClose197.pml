...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/http/httptest/server_test.go#L197
typedef Wgdef {
...
init { 
	chan child_TestServerZeroValueClose1970 = [1] of {int};
	run TestServerZeroValueClose197(child_TestServerZeroValueClose1970);
	run receiver(child_TestServerZeroValueClose1970)
stop_process:skip
}

proctype TestServerZeroValueClose197(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
