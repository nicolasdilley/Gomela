...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/http/fs_test.go#L329
typedef Wgdef {
...
init { 
	chan child_TestFileServerSortsNames3290 = [1] of {int};
	run TestFileServerSortsNames329(child_TestFileServerSortsNames3290);
	run receiver(child_TestFileServerSortsNames3290)
stop_process:skip
}

proctype TestFileServerSortsNames329(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
