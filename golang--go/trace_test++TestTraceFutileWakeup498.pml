...
proctype TestTraceFutileWakeup498(chan child) {
	...
	chan child_AnonymousTestTraceFutileWakeup5235091 = [1] of {int};
	...
	run wgMonitor(done);
		...
		run AnonymousTestTraceFutileWakeup523509(c1_ch,c2_ch,c0_ch,done,child_AnonymousTestTraceFutileWakeup5235091);
		run receiver(child_AnonymousTestTraceFutileWakeup5235091);
		...
		run AnonymousTestTraceFutileWakeup540508(c0_ch,c1_ch,c2_ch,done,child_AnonymousTestTraceFutileWakeup5405083);
...
proctype AnonymousTestTraceFutileWakeup523509(Chandef c1_ch;Chandef c2_ch;Chandef c0_ch;Wgdef done;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestTraceFutileWakeup540508(Chandef c0_ch;Chandef c1_ch;Chandef c2_ch;Wgdef done;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
