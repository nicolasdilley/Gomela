...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/dnsclient_unix_test.go#L1580
typedef Mutexdef {
	chan Lock = [0] of {bool};
...
init { 
	chan child_TestDNSDialTCP15800 = [1] of {int};
	run TestDNSDialTCP1580(child_TestDNSDialTCP15800);
	run receiver(child_TestDNSDialTCP15800)
stop_process:skip
}

proctype TestDNSDialTCP1580(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
