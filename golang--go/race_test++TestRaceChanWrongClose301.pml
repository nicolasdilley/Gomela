...
proctype TestRaceChanWrongClose301(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousTestRaceChanWrongClose3153061 = [1] of {int};
	...
	run AnonymousTestRaceChanWrongClose315306(done_ch,c_ch,child_AnonymousTestRaceChanWrongClose3153061);
	run receiver(child_AnonymousTestRaceChanWrongClose3153061);
...
proctype AnonymousTestRaceChanWrongClose315306(Chandef done_ch;Chandef c_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
