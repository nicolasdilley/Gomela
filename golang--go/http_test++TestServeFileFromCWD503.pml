...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/http/fs_test.go#L503
typedef Wgdef {
...
init { 
	chan child_TestServeFileFromCWD5030 = [1] of {int};
	run TestServeFileFromCWD503(child_TestServeFileFromCWD5030);
	run receiver(child_TestServeFileFromCWD5030)
stop_process:skip
}

proctype TestServeFileFromCWD503(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
