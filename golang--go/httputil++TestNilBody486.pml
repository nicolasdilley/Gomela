...
// git_link=https://github.com/golang/go/blob/138d2c9b88d9e3d5adcebf9cb7c356b43d6a9782/net/http/httputil/reverseproxy_test.go#L486
typedef Wgdef {
...
init { 
	chan child_TestNilBody4860 = [1] of {int};
	run TestNilBody486(child_TestNilBody4860);
	run receiver(child_TestNilBody4860)
stop_process:skip
}

proctype TestNilBody486(chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
