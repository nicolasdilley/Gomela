...
proctype TestRaceForTest386(chan child) {
	...
	run AnonymousTestRaceForTest390387(done_ch,c_ch,child_AnonymousTestRaceForTest3903870);
...
proctype AnonymousTestRaceForTest390387(Chandef done_ch;Chandef c_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
