...
proctype TestMaxStackSize956(chan child) {
	...
	Wgdef wg;
	int var_HuffmanOnly = TestMaxStackSize_HuffmanOnly; // mand var_HuffmanOnly
	int var_BestCompression = TestMaxStackSize_BestCompression; // mand var_BestCompression
	run wgMonitor(wg);
