...
proctype TestConcurrentRange115(chan child) {
	...
	Mutexdef m_mu;
	int var_itersiters = -2; // opt var_itersiters
	int var_int64_runtime_GOMAXPROCS_0__ = TestConcurrentRange_int64_runtime_GOMAXPROCS_0__; // mand var_int64_runtime_GOMAXPROCS_0__
	int var_int64_1_int64_1_ = -2; // opt var_int64_1_int64_1_
	int var_mapSizemapSize = -2; // opt var_mapSizemapSize
	...
	run wgMonitor(wg);
		for(i : 0.. var_int64_runtime_GOMAXPROCS_0__-1) {
		for20: skip;
		wg.update!1;
		run AnonymousTestConcurrentRange132132(done_ch,wg,m_mu,mapSize,int64_1_,child_AnonymousTestConcurrentRange1321322);
...
proctype AnonymousTestConcurrentRange132132(Chandef done_ch;Wgdef wg;Mutexdef m_mu;int mapSize;int int64_1_;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype Range78(Mutexdef m_mu;chan child) {
	...
	int var_m_dirtym_dirty = -2; // opt var_m_dirtym_dirty
	m_mu.RLock!false;
	m_mu.RUnlock!false;
