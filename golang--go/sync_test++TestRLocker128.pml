...
proctype TestRLocker128(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousTestRLocker1351320 = [1] of {int};
	Chandef rlocked_ch;
	Chandef wlocked_ch;
	Mutexdef wl;
	...
	run AnonymousTestRLocker135132(rlocked_ch,wlocked_ch,wl,n,child_AnonymousTestRLocker1351320);
	run receiver(child_AnonymousTestRLocker1351320);
...
proctype AnonymousTestRLocker135132(Chandef rlocked_ch;Chandef wlocked_ch;Mutexdef wl;int n;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
