...
proctype TestSelectDuplicateChannel682(chan child) {
	...
	bool state;
	int num_msgs;
	chan child_AnonymousTestSelectDuplicateChannel7016861 = [1] of {int};
	...
	run AnonymousTestSelectDuplicateChannel690685(c_ch,d_ch,e_ch,child_AnonymousTestSelectDuplicateChannel6906850);
	run receiver(child_AnonymousTestSelectDuplicateChannel6906850);
	run AnonymousTestSelectDuplicateChannel701686(d_ch,e_ch,c_ch,child_AnonymousTestSelectDuplicateChannel7016861);
	run receiver(child_AnonymousTestSelectDuplicateChannel7016861);
...
proctype AnonymousTestSelectDuplicateChannel690685(Chandef c_ch;Chandef d_ch;Chandef e_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
...
proctype AnonymousTestSelectDuplicateChannel701686(Chandef d_ch;Chandef e_ch;Chandef c_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
