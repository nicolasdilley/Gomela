...
proctype TestRaceChanSendSelectClose350(chan child) {
	...
	run AnonymousTestRaceChanSendSelectClose354351(compl_ch,c_ch,c1_ch,child_AnonymousTestRaceChanSendSelectClose3543510);
...
proctype AnonymousTestRaceChanSendSelectClose354351(Chandef compl_ch;Chandef c_ch;Chandef c1_ch;chan child) {
	bool closed; 
	int i;
	bool state;
	int num_msgs;
